...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "SBPA":{temp:29,conditions:[],intensity:null},"SBCT":{temp:23,conditions:[],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:25,conditions:[],intensity:null},"SAEZ":{temp:24,conditions:[],intensity:null},"SABE":{temp:24,conditions:[],intensity:null},"SACO":{temp:24,conditions:[],intensity:null},"SAME":{temp:27,conditions:[],intensity:null},"SLLP":{temp:11,conditions:[],intensity:null},"SLVR":{temp:25,conditions:[],intensity:null},
  ...
  "LEZL":{temp:15,conditions:[],intensity:null},"GCLP":{temp:18,conditions:[],intensity:null},"GCTS":{temp:16,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:16,conditions:[],intensity:null},"LPPT":{temp:16,conditions:[],intensity:null},"LPPR":{temp:14,conditions:["rain"],intensity:null},"LPFR":{temp:16,conditions:[],intensity:null},"LPMA":{temp:16,conditions:[],intensity:null},"LIRF":{temp:11,conditions:[],intensity:null},
  "LIMC":{temp:4,conditions:["fog"],intensity:null},"LIME":{temp:4,conditions:["fog"],intensity:null},"LIPZ":{temp:7,conditions:[],intensity:null},"LIRN":{temp:11,conditions:[],intensity:null},"LIML":{temp:4,conditions:[],intensity:null},"LIPE":{temp:6,conditions:[],intensity:null},"LICC":{temp:13,conditions:[],intensity:null},"LICJ":{temp:14,conditions:[],intensity:null},"LIRA":{temp:9,conditions:[],intensity:null},"LIRP":{temp:8,conditions:[],intensity:null},
  ...
  "LSGG":{temp:3,conditions:[],intensity:null},"LSZB":{temp:3,conditions:[],intensity:null},"LOWW":{temp:2,conditions:[],intensity:null},"LOWS":{temp:-1,conditions:[],intensity:null},"LOWG":{temp:2,conditions:[],intensity:null},"LOWI":{temp:1,conditions:[],intensity:null},"LKPR":{temp:0,conditions:[],intensity:null},"EPWA":{temp:-1,conditions:[],intensity:null},"EPKK":{temp:0,conditions:[],intensity:null},"EPGD":{temp:-6,conditions:["snow"],intensity:null},
  ...
  "GMMX":{temp:13,conditions:[],intensity:null},"GMTT":{temp:17,conditions:[],intensity:null},"GMFF":{temp:15,conditions:[],intensity:null},"GMAD":{temp:15,conditions:[],intensity:null},"DAAG":{temp:14,conditions:[],intensity:null},"DAOO":{temp:17,conditions:[],intensity:null},"DTTA":{temp:14,conditions:[],intensity:null},"DTMB":{temp:14,conditions:[],intensity:null},"DTTJ":{temp:19,conditions:[],intensity:null},"HECA":{temp:13,conditions:[],intensity:null},
  ...
  "ZYTX":{temp:-18,conditions:[],intensity:null},"ZSAM":{temp:9,conditions:[],intensity:null},"ZGKL":{temp:9,conditions:[],intensity:null},"ZSNJ":{temp:3,conditions:[],intensity:null},"ZSHC":{temp:5,conditions:[],intensity:null},"ZPPP":{temp:6,conditions:[],intensity:null},"ZBTJ":{temp:-4,conditions:[],intensity:null},"VMMC":{temp:16,conditions:[],intensity:null},"RJTT":{temp:3,conditions:[],intensity:null},"RJAA":{temp:1,conditions:[],intensity:null},
  "RJBB":{temp:5,conditions:[],intensity:null},"RJOO":{temp:2,conditions:[],intensity:null},"RJCC":{temp:-6,conditions:[],intensity:null},"RJFF":{temp:4,conditions:[],intensity:null},"RJGG":{temp:4,conditions:[],intensity:null},"ROAH":{temp:16,conditions:[],intensity:null},"RJSS":{temp:-1,conditions:[],intensity:null},"RJSN":{temp:2,conditions:[],intensity:null},"RJOK":{temp:3,conditions:[],intensity:null},"RKSI":{temp:-6,conditions:[],intensity:null},
  ...
  "RCKH":{temp:18,conditions:[],intensity:null},"RCNN":{temp:15,conditions:[],intensity:null},"YSSY":{temp:25,conditions:[],intensity:null},"YMML":{temp:18,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:23,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:24,conditions:[],intensity:null},"YBCS":{temp:26,conditions:[],intensity:null},"YSCB":{temp:26,conditions:[],intensity:null},
  "YMHB":{temp:16,conditions:[],intensity:null},"NZAA":{temp:23,conditions:[],intensity:null},"NZWN":{temp:20,conditions:[],intensity:null},"NZCH":{temp:19,conditions:[],intensity:null},"NZQN":{temp:18,conditions:[],intensity:null},"NZDN":{temp:16,conditions:[],intensity:null},"NFFN":{temp:29,conditions:[],intensity:null},"NWWW":{temp:30,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:29,conditions:["thunderstorm"],intensity:null},
