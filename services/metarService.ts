...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:2,conditions:["fog"],intensity:null},"KLAX":{temp:17,conditions:[],intensity:null},"KORD":{temp:-14,conditions:[],intensity:null},"KDFW":{temp:-7,conditions:[],intensity:null},"KDEN":{temp:-10,conditions:["snow"],intensity:null},"KJFK":{temp:-5,conditions:["snow"],intensity:null},"KSFO":{temp:12,conditions:[],intensity:null},"KSEA":{temp:5,conditions:[],intensity:null},"KLAS":{temp:15,conditions:[],intensity:null},"KMCO":{temp:27,conditions:[],intensity:null},
  "KEWR":{temp:-8,conditions:["snow"],intensity:null},"KMIA":{temp:24,conditions:[],intensity:null},"KPHX":{temp:18,conditions:[],intensity:null},"KIAH":{temp:-2,conditions:[],intensity:null},"KBOS":{temp:-4,conditions:["snow"],intensity:null},"KMSP":{temp:-17,conditions:[],intensity:null},"KFLL":{temp:24,conditions:[],intensity:null},"KDTW":{temp:-11,conditions:["snow"],intensity:null},"KPHL":{temp:-6,conditions:["freezing"],intensity:null},"KLGA":{temp:-5,conditions:["snow"],intensity:null},
  ...
  "KAUS":{temp:-5,conditions:[],intensity:null},"KBNA":{temp:-9,conditions:[],intensity:null},"KRDU":{temp:-6,conditions:["freezing"],intensity:null},"KCLT":{temp:-3,conditions:["freezing"],intensity:null},"KSMF":{temp:10,conditions:[],intensity:null},"KSJC":{temp:15,conditions:[],intensity:null},"KOAK":{temp:13,conditions:[],intensity:null},"KCLE":{temp:-9,conditions:["snow"],intensity:null},"KMKE":{temp:-14,conditions:[],intensity:null},"KPIT":{temp:-6,conditions:["snow"],intensity:null},
  "KIND":{temp:-12,conditions:[],intensity:null},"KCVG":{temp:-10,conditions:[],intensity:null},"KMCI":{temp:-12,conditions:[],intensity:null},"KSAT":{temp:-2,conditions:[],intensity:null},"KHOU":{temp:-2,conditions:[],intensity:null},"KDAL":{temp:-7,conditions:[],intensity:null},"KMDW":{temp:-12,conditions:[],intensity:null},"PANC":{temp:-6,conditions:[],intensity:null},"PAFA":{temp:-18,conditions:[],intensity:null},"CYYZ":{temp:-14,conditions:["snow"],intensity:null},
  "CYVR":{temp:5,conditions:[],intensity:null},"CYUL":{temp:-18,conditions:["snow"],intensity:null},"CYYC":{temp:0,conditions:[],intensity:null},"CYEG":{temp:-5,conditions:[],intensity:null},"CYOW":{temp:-19,conditions:["snow"],intensity:null},"CYWG":{temp:-28,conditions:[],intensity:null},"CYHZ":{temp:-16,conditions:[],intensity:null},"CYQB":{temp:-22,conditions:[],intensity:null},"CYYJ":{temp:5,conditions:[],intensity:null},"CYLW":{temp:-4,conditions:[],intensity:null},
  "CYXE":{temp:-23,conditions:[],intensity:null},"CYQR":{temp:-24,conditions:[],intensity:null},"CYZF":{temp:-23,conditions:[],intensity:null},"CYXY":{temp:-13,conditions:[],intensity:null},"CYQT":{temp:-23,conditions:[],intensity:null},"CYYT":{temp:-10,conditions:[],intensity:null},"MMMX":{temp:22,conditions:[],intensity:null},"MMUN":{temp:26,conditions:[],intensity:null},"MMGL":{temp:21,conditions:[],intensity:null},"MMMY":{temp:9,conditions:[],intensity:null},
  "MMTJ":{temp:17,conditions:[],intensity:null},"MMSM":{temp:28,conditions:[],intensity:null},"MMMD":{temp:30,conditions:[],intensity:null},"MMCZ":{temp:27,conditions:[],intensity:null},"MMSD":{temp:21,conditions:[],intensity:null},"MGGT":{temp:21,conditions:[],intensity:null},"MSLP":{temp:28,conditions:[],intensity:null},"MHTG":{temp:26,conditions:[],intensity:null},"MNMG":{temp:29,conditions:[],intensity:null},"MROC":{temp:25,conditions:[],intensity:null},
  "MPTO":{temp:28,conditions:[],intensity:null},"MKJP":{temp:26,conditions:[],intensity:null},"TNCM":{temp:26,conditions:[],intensity:null},"TBPB":{temp:26,conditions:[],intensity:null},"TTPP":{temp:27,conditions:[],intensity:null},"MWCR":{temp:27,conditions:[],intensity:null},"MUHA":{temp:24,conditions:[],intensity:null},"MDSD":{temp:27,conditions:[],intensity:null},"MDPP":{temp:26,conditions:[],intensity:null},"MTPP":{temp:29,conditions:[],intensity:null},
  ...
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:19,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:17,conditions:[],intensity:null},"SAEZ":{temp:27,conditions:[],intensity:null},"SABE":{temp:26,conditions:[],intensity:null},"SACO":{temp:27,conditions:[],intensity:null},"SAME":{temp:24,conditions:[],intensity:null},"SLLP":{temp:10,conditions:[],intensity:null},"SLVR":{temp:27,conditions:[],intensity:null},
  ...
  "ENZV":{temp:-2,conditions:[],intensity:null},"ENTC":{temp:-2,conditions:["snow"],intensity:null},"EFOU":{temp:-7,conditions:["snow"],intensity:null},"EFRO":{temp:-13,conditions:[],intensity:null},"LGAV":{temp:14,conditions:[],intensity:null},"LGTS":{temp:12,conditions:[],intensity:null},"LGIR":{temp:16,conditions:[],intensity:null},"LGKR":{temp:16,conditions:[],intensity:null},"LGRP":{temp:16,conditions:[],intensity:null},"LGSR":{temp:17,conditions:[],intensity:null},
  "LGMK":{temp:17,conditions:[],intensity:null},"LTFM":{temp:10,conditions:[],intensity:null},"LTBA":{temp:11,conditions:[],intensity:null},"LTFJ":{temp:10,conditions:[],intensity:null},"LTAI":{temp:13,conditions:[],intensity:null},"LTAC":{temp:2,conditions:["fog"],intensity:null},"LTBJ":{temp:12,conditions:[],intensity:null},"LTBS":{temp:14,conditions:[],intensity:null},"LTFE":{temp:16,conditions:[],intensity:null},"LCLK":{temp:12,conditions:[],intensity:null},
  ...
  "ZSSS":{temp:10,conditions:[],intensity:null},"ZGGG":{temp:10,conditions:[],intensity:null},"VHHH":{temp:19,conditions:[],intensity:null},"ZGSZ":{temp:17,conditions:[],intensity:null},"ZUUU":{temp:4,conditions:[],intensity:null},"ZUCK":{temp:6,conditions:[],intensity:null},"ZHCC":{temp:0,conditions:[],intensity:null},"ZLXY":{temp:0,conditions:["fog"],intensity:null},"ZWSH":{temp:-15,conditions:[],intensity:null},"ZYHB":{temp:-20,conditions:[],intensity:null},
  "ZYTX":{temp:-16,conditions:[],intensity:null},"ZSAM":{temp:15,conditions:[],intensity:null},"ZGKL":{temp:10,conditions:["fog"],intensity:null},"ZSNJ":{temp:5,conditions:[],intensity:null},"ZSHC":{temp:9,conditions:[],intensity:null},"ZPPP":{temp:4,conditions:[],intensity:null},"ZBTJ":{temp:-5,conditions:[],intensity:null},"VMMC":{temp:16,conditions:[],intensity:null},"RJTT":{temp:2,conditions:[],intensity:null},"RJAA":{temp:0,conditions:[],intensity:null},
  "RJBB":{temp:3,conditions:[],intensity:null},"RJOO":{temp:1,conditions:[],intensity:null},"RJCC":{temp:-13,conditions:[],intensity:null},"RJFF":{temp:1,conditions:[],intensity:null},"RJGG":{temp:3,conditions:[],intensity:null},"ROAH":{temp:19,conditions:[],intensity:null},"RJSS":{temp:-1,conditions:[],intensity:null},"RJSN":{temp:0,conditions:[],intensity:null},"RJOK":{temp:2,conditions:[],intensity:null},"RKSI":{temp:-5,conditions:[],intensity:null},
  "RKSS":{temp:-9,conditions:[],intensity:null},"RKPK":{temp:-5,conditions:[],intensity:null},"RKPC":{temp:2,conditions:[],intensity:null},"RKTN":{temp:-8,conditions:[],intensity:null},"ZKPY":{temp:-12,conditions:[],intensity:null},"WSSS":{temp:24,conditions:[],intensity:null},"WMKK":{temp:22,conditions:[],intensity:null},"WMKP":{temp:28,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:24,conditions:["fog"],intensity:null},
  "VTBS":{temp:22,conditions:[],intensity:null},"VTBD":{temp:20,conditions:[],intensity:null},"VTSP":{temp:25,conditions:[],intensity:null},"VTCC":{temp:20,conditions:[],intensity:null},"VTSS":{temp:25,conditions:[],intensity:null},"VTUK":{temp:22,conditions:[],intensity:null},"VVNB":{temp:16,conditions:[],intensity:null},"VVTS":{temp:21,conditions:[],intensity:null},"VVDN":{temp:17,conditions:[],intensity:null},"VVCR":{temp:19,conditions:[],intensity:null},
  "VDPP":{temp:20,conditions:[],intensity:null},"VDSR":{temp:19,conditions:[],intensity:null},"VLVT":{temp:17,conditions:["fog"],intensity:null},"VLLB":{temp:15,conditions:[],intensity:null},"VYYY":{temp:20,conditions:[],intensity:null},"VYMD":{temp:18,conditions:[],intensity:null},"VGHS":{temp:14,conditions:[],intensity:null},"VGCG":{temp:19,conditions:[],intensity:null},"VECC":{temp:17,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  ...
  "RCKH":{temp:19,conditions:[],intensity:null},"RCNN":{temp:18,conditions:[],intensity:null},"YSSY":{temp:23,conditions:[],intensity:null},"YMML":{temp:19,conditions:[],intensity:null},"YBBN":{temp:28,conditions:[],intensity:null},"YPPH":{temp:20,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:30,conditions:[],intensity:null},"YBCS":{temp:27,conditions:[],intensity:null},"YSCB":{temp:23,conditions:[],intensity:null},
