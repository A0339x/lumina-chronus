...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "TJSJ":{temp:20,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:21,conditions:["fog"],intensity:null},"SBGL":{temp:25,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:22,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:26,conditions:[],intensity:null},
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:18,conditions:["fog"],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:15,conditions:[],intensity:null},"SAEZ":{temp:26,conditions:[],intensity:null},"SABE":{temp:25,conditions:[],intensity:null},"SACO":{temp:21,conditions:[],intensity:null},"SAME":{temp:20,conditions:[],intensity:null},"SLLP":{temp:6,conditions:[],intensity:null},"SLVR":{temp:23,conditions:[],intensity:null},
  "SPJC":{temp:22,conditions:[],intensity:null},"SEQM":{temp:11,conditions:[],intensity:null},"SEGU":{temp:24,conditions:[],intensity:null},"SKBO":{temp:12,conditions:[],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:22,conditions:["rain"],intensity:null},"SKRG":{temp:14,conditions:[],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:23,conditions:[],intensity:null},
  ...
  "LEZL":{temp:15,conditions:[],intensity:null},"GCLP":{temp:17,conditions:[],intensity:null},"GCTS":{temp:16,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:17,conditions:[],intensity:null},"LPPT":{temp:15,conditions:[],intensity:null},"LPPR":{temp:14,conditions:["rain"],intensity:null},"LPFR":{temp:16,conditions:[],intensity:null},"LPMA":{temp:16,conditions:[],intensity:null},"LIRF":{temp:11,conditions:[],intensity:null},
  ...
  "LIMF":{temp:6,conditions:[],intensity:null},"LIEO":{temp:12,conditions:[],intensity:null},"LIEE":{temp:12,conditions:[],intensity:null},"EHAM":{temp:1,conditions:[],intensity:null},"EHRD":{temp:1,conditions:[],intensity:null},"EHEH":{temp:0,conditions:[],intensity:null},"EBBR":{temp:0,conditions:[],intensity:null},"EBCI":{temp:0,conditions:[],intensity:null},"ELLX":{temp:2,conditions:[],intensity:null},"LSZH":{temp:5,conditions:[],intensity:null},
  "LSGG":{temp:6,conditions:[],intensity:null},"LSZB":{temp:5,conditions:[],intensity:null},"LOWW":{temp:2,conditions:["fog"],intensity:null},"LOWS":{temp:2,conditions:[],intensity:null},"LOWG":{temp:1,conditions:["fog"],intensity:null},"LOWI":{temp:1,conditions:["fog"],intensity:null},"LKPR":{temp:2,conditions:[],intensity:null},"EPWA":{temp:1,conditions:[],intensity:null},"EPKK":{temp:4,conditions:[],intensity:null},"EPGD":{temp:-4,conditions:[],intensity:null},
  "EPWR":{temp:6,conditions:[],intensity:null},"EPPO":{temp:0,conditions:[],intensity:null},"EKCH":{temp:-1,conditions:[],intensity:null},"ESSA":{temp:-4,conditions:[],intensity:null},"ENGM":{temp:-9,conditions:[],intensity:null},"EFHK":{temp:-8,conditions:[],intensity:null},"BIKF":{temp:3,conditions:[],intensity:null},"ESGG":{temp:-4,conditions:[],intensity:null},"ESMS":{temp:-1,conditions:[],intensity:null},"ENBR":{temp:-3,conditions:[],intensity:null},
  "ENZV":{temp:-2,conditions:[],intensity:null},"ENTC":{temp:-4,conditions:[],intensity:null},"EFOU":{temp:-13,conditions:[],intensity:null},"EFRO":{temp:-12,conditions:[],intensity:null},"LGAV":{temp:14,conditions:[],intensity:null},"LGTS":{temp:15,conditions:[],intensity:null},"LGIR":{temp:16,conditions:[],intensity:null},"LGKR":{temp:12,conditions:[],intensity:null},"LGRP":{temp:17,conditions:[],intensity:null},"LGSR":{temp:15,conditions:[],intensity:null},
  ...
  "LCPH":{temp:18,conditions:[],intensity:null},"LHBP":{temp:3,conditions:["fog"],intensity:null},"LROP":{temp:4,conditions:["rain"],intensity:null},"LBSF":{temp:8,conditions:[],intensity:null},"LYBE":{temp:6,conditions:[],intensity:null},"LDZA":{temp:3,conditions:[],intensity:null},"LDDU":{temp:11,conditions:[],intensity:null},"LDSP":{temp:12,conditions:[],intensity:null},"LJLJ":{temp:4,conditions:["fog"],intensity:null},"LWSK":{temp:10,conditions:["fog"],intensity:null},
  ...
  "OIAW":{temp:16,conditions:[],intensity:null},"OIKK":{temp:4,conditions:[],intensity:null},"OICC":{temp:10,conditions:[],intensity:null},"LLBG":{temp:23,conditions:[],intensity:null},"OLBA":{temp:20,conditions:[],intensity:null},"OJAM":{temp:16,conditions:[],intensity:null},"ORBI":{temp:16,conditions:[],intensity:null},"ORER":{temp:12,conditions:[],intensity:null},"GMMN":{temp:15,conditions:[],intensity:null},"GMME":{temp:16,conditions:[],intensity:null},
  "GMMX":{temp:12,conditions:[],intensity:null},"GMTT":{temp:16,conditions:[],intensity:null},"GMFF":{temp:14,conditions:[],intensity:null},"GMAD":{temp:14,conditions:[],intensity:null},"DAAG":{temp:14,conditions:[],intensity:null},"DAOO":{temp:17,conditions:[],intensity:null},"DTTA":{temp:14,conditions:[],intensity:null},"DTMB":{temp:14,conditions:[],intensity:null},"DTTJ":{temp:16,conditions:[],intensity:null},"HECA":{temp:23,conditions:[],intensity:null},
  ...
  "GABS":{temp:27,conditions:[],intensity:null},"GVNP":{temp:23,conditions:[],intensity:null},"GBYD":{temp:29,conditions:[],intensity:null},"GLRB":{temp:30,conditions:[],intensity:null},"DXXX":{temp:31,conditions:[],intensity:null},"DBBB":{temp:32,conditions:[],intensity:null},"HKJK":{temp:28,conditions:[],intensity:null},"HKMO":{temp:34,conditions:[],intensity:null},"HTDA":{temp:33,conditions:[],intensity:null},"HTKJ":{temp:32,conditions:[],intensity:null},
  "HUEN":{temp:31,conditions:[],intensity:null},"HRYR":{temp:29,conditions:[],intensity:null},"HAAB":{temp:24,conditions:[],intensity:null},"HDAM":{temp:29,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:27,conditions:[],intensity:null},"FMEE":{temp:28,conditions:[],intensity:null},"FIMP":{temp:29,conditions:[],intensity:null},"FMCH":{temp:28,conditions:[],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  "FSIA":{temp:29,conditions:[],intensity:null},"FKKD":{temp:30,conditions:[],intensity:null},"FKYS":{temp:29,conditions:[],intensity:null},"FOOL":{temp:30,conditions:[],intensity:null},"FZAA":{temp:31,conditions:[],intensity:null},"FCBB":{temp:29,conditions:[],intensity:null},"FLLK":{temp:27,conditions:[],intensity:null},"FVHA":{temp:27,conditions:[],intensity:null},"FLLS":{temp:27,conditions:[],intensity:null},"FYWH":{temp:28,conditions:[],intensity:null},
  "FBSK":{temp:31,conditions:[],intensity:null},"FAOR":{temp:26,conditions:[],intensity:null},"FACT":{temp:27,conditions:[],intensity:null},"FALE":{temp:34,conditions:[],intensity:null},"FAPE":{temp:29,conditions:[],intensity:null},"FQMA":{temp:31,conditions:[],intensity:null},"FWKI":{temp:25,conditions:[],intensity:null},"ZBAA":{temp:1,conditions:[],intensity:null},"ZBAD":{temp:1,conditions:[],intensity:null},"ZSPD":{temp:7,conditions:[],intensity:null},
  "ZSSS":{temp:7,conditions:[],intensity:null},"ZGGG":{temp:21,conditions:[],intensity:null},"VHHH":{temp:20,conditions:[],intensity:null},"ZGSZ":{temp:20,conditions:[],intensity:null},"ZUUU":{temp:11,conditions:[],intensity:null},"ZUCK":{temp:9,conditions:[],intensity:null},"ZHCC":{temp:5,conditions:[],intensity:null},"ZLXY":{temp:4,conditions:[],intensity:null},"ZWSH":{temp:-9,conditions:[],intensity:null},"ZYHB":{temp:-16,conditions:[],intensity:null},
  "ZYTX":{temp:-10,conditions:[],intensity:null},"ZSAM":{temp:18,conditions:[],intensity:null},"ZGKL":{temp:9,conditions:[],intensity:null},"ZSNJ":{temp:5,conditions:[],intensity:null},"ZSHC":{temp:7,conditions:[],intensity:null},"ZPPP":{temp:13,conditions:[],intensity:null},"ZBTJ":{temp:1,conditions:[],intensity:null},"VMMC":{temp:20,conditions:[],intensity:null},"RJTT":{temp:5,conditions:[],intensity:null},"RJAA":{temp:2,conditions:[],intensity:null},
  "RJBB":{temp:5,conditions:[],intensity:null},"RJOO":{temp:2,conditions:[],intensity:null},"RJCC":{temp:-8,conditions:[],intensity:null},"RJFF":{temp:6,conditions:[],intensity:null},"RJGG":{temp:4,conditions:[],intensity:null},"ROAH":{temp:20,conditions:[],intensity:null},"RJSS":{temp:1,conditions:[],intensity:null},"RJSN":{temp:3,conditions:[],intensity:null},"RJOK":{temp:5,conditions:[],intensity:null},"RKSI":{temp:0,conditions:[],intensity:null},
  ...
  "VTBS":{temp:31,conditions:[],intensity:null},"VTBD":{temp:30,conditions:[],intensity:null},"VTSP":{temp:29,conditions:[],intensity:null},"VTCC":{temp:27,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:27,conditions:[],intensity:null},"VVNB":{temp:20,conditions:[],intensity:null},"VVTS":{temp:28,conditions:[],intensity:null},"VVDN":{temp:20,conditions:[],intensity:null},"VVCR":{temp:24,conditions:[],intensity:null},
  ...
  "VCBI":{temp:27,conditions:[],intensity:null},"WIII":{temp:28,conditions:[],intensity:null},"WADD":{temp:28,conditions:[],intensity:null},"WARR":{temp:28,conditions:[],intensity:null},"WIHH":{temp:28,conditions:[],intensity:null},"WIMM":{temp:29,conditions:[],intensity:null},"WIBB":{temp:27,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:23,conditions:["thunderstorm"],intensity:null},"WASS":{temp:28,conditions:[],intensity:null},
  ...
  "VOMM":{temp:26,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:28,conditions:[],intensity:null},"VAAH":{temp:28,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:30,conditions:[],intensity:null},"VOTP":{temp:28,conditions:[],intensity:null},"VIAR":{temp:15,conditions:[],intensity:null},"VIJP":{temp:20,conditions:[],intensity:null},"VELR":{temp:17,conditions:[],intensity:null},
  "VOCL":{temp:29,conditions:[],intensity:null},"VOTV":{temp:29,conditions:[],intensity:null},"VEPT":{temp:24,conditions:[],intensity:null},"VNKT":{temp:19,conditions:[],intensity:null},"OPKC":{temp:22,conditions:[],intensity:null},"OPLA":{temp:17,conditions:[],intensity:null},"OPIS":{temp:13,conditions:[],intensity:null},"RCTP":{temp:18,conditions:[],intensity:null},"RCSS":{temp:17,conditions:[],intensity:null},"RCMQ":{temp:18,conditions:[],intensity:null},
  "RCKH":{temp:22,conditions:[],intensity:null},"RCNN":{temp:20,conditions:[],intensity:null},"YSSY":{temp:19,conditions:[],intensity:null},"YMML":{temp:24,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:20,conditions:[],intensity:null},"YPAD":{temp:29,conditions:[],intensity:null},"YBCG":{temp:25,conditions:[],intensity:null},"YBCS":{temp:25,conditions:[],intensity:null},"YSCB":{temp:19,conditions:[],intensity:null},
  ...
  "NIUE":{temp:27,conditions:["thunderstorm"],intensity:null},"PGSN":{temp:26,conditions:[],intensity:null},"PGUM":{temp:27,conditions:[],intensity:null},"PHOG":{temp:23,conditions:[],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:20,conditions:["fog"],intensity:null}
};
