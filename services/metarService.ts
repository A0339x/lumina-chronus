...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "MPTO":{temp:24,conditions:[],intensity:null},"MKJP":{temp:20,conditions:[],intensity:null},"TNCM":{temp:26,conditions:[],intensity:null},"TBPB":{temp:26,conditions:[],intensity:null},"TTPP":{temp:26,conditions:[],intensity:null},"MWCR":{temp:26,conditions:[],intensity:null},"MUHA":{temp:18,conditions:["fog"],intensity:null},"MDSD":{temp:23,conditions:[],intensity:null},"MDPP":{temp:24,conditions:[],intensity:null},"MTPP":{temp:25,conditions:[],intensity:null},
  "TJSJ":{temp:20,conditions:["fog"],intensity:null},"TIST":{temp:25,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:20,conditions:["fog"],intensity:null},"SBGL":{temp:27,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:20,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:25,conditions:[],intensity:null},
  "SBPA":{temp:24,conditions:["fog"],intensity:null},"SBCT":{temp:19,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:16,conditions:[],intensity:null},"SAEZ":{temp:21,conditions:[],intensity:null},"SABE":{temp:23,conditions:[],intensity:null},"SACO":{temp:18,conditions:[],intensity:null},"SAME":{temp:18,conditions:[],intensity:null},"SLLP":{temp:2,conditions:["fog"],intensity:null},"SLVR":{temp:22,conditions:[],intensity:null},
  ...
  "SGAS":{temp:22,conditions:[],intensity:null},"SBBV":{temp:25,conditions:[],intensity:null},"SMJP":{temp:23,conditions:[],intensity:null},"SYCJ":{temp:23,conditions:[],intensity:null},"EGLL":{temp:0,conditions:["fog"],intensity:null},"EGKK":{temp:-1,conditions:["fog"],intensity:null},"EGSS":{temp:1,conditions:[],intensity:null},"EGLC":{temp:3,conditions:["fog"],intensity:null},"EGCC":{temp:1,conditions:[],intensity:null},"EGBB":{temp:0,conditions:[],intensity:null},
  "EGPH":{temp:4,conditions:[],intensity:null},"EGPF":{temp:3,conditions:[],intensity:null},"EGGW":{temp:0,conditions:["fog"],intensity:null},"EGNX":{temp:1,conditions:[],intensity:null},"EGNT":{temp:2,conditions:[],intensity:null},"EGGP":{temp:2,conditions:[],intensity:null},"EGHI":{temp:0,conditions:["fog"],intensity:null},"EGGD":{temp:2,conditions:[],intensity:null},"EGPD":{temp:3,conditions:[],intensity:null},"EGAA":{temp:3,conditions:[],intensity:null},
  "EIDW":{temp:5,conditions:[],intensity:null},"EICK":{temp:6,conditions:[],intensity:null},"EINN":{temp:5,conditions:[],intensity:null},"LFPG":{temp:9,conditions:[],intensity:null},"LFPO":{temp:9,conditions:[],intensity:null},"LFML":{temp:13,conditions:[],intensity:null},"LFLL":{temp:11,conditions:[],intensity:null},"LFMN":{temp:12,conditions:[],intensity:null},"LFBD":{temp:9,conditions:[],intensity:null},"LFBO":{temp:5,conditions:["fog"],intensity:null},
  "LFRS":{temp:8,conditions:[],intensity:null},"LFSB":{temp:2,conditions:[],intensity:null},"LFPB":{temp:9,conditions:[],intensity:null},"EDDF":{temp:8,conditions:[],intensity:null},"EDDM":{temp:5,conditions:[],intensity:null},"EDDB":{temp:5,conditions:[],intensity:null},"EDDL":{temp:8,conditions:[],intensity:null},"EDDH":{temp:4,conditions:[],intensity:null},"EDDK":{temp:9,conditions:[],intensity:null},"EDDS":{temp:8,conditions:[],intensity:null},
  "EDDW":{temp:5,conditions:[],intensity:null},"EDDN":{temp:3,conditions:[],intensity:null},"EDDV":{temp:8,conditions:[],intensity:null},"EDDP":{temp:7,conditions:[],intensity:null},"LEMD":{temp:8,conditions:[],intensity:null},"LEBL":{temp:11,conditions:[],intensity:null},"LEPA":{temp:12,conditions:["fog"],intensity:null},"LEMG":{temp:13,conditions:[],intensity:null},"LEVC":{temp:7,conditions:["fog"],intensity:null},"LEAL":{temp:10,conditions:[],intensity:null},
  "LEZL":{temp:12,conditions:[],intensity:null},"GCLP":{temp:18,conditions:[],intensity:null},"GCTS":{temp:14,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:16,conditions:[],intensity:null},"LPPT":{temp:11,conditions:[],intensity:null},"LPPR":{temp:11,conditions:["fog"],intensity:null},"LPFR":{temp:12,conditions:[],intensity:null},"LPMA":{temp:15,conditions:[],intensity:null},"LIRF":{temp:14,conditions:[],intensity:null},
  "LIMC":{temp:5,conditions:[],intensity:null},"LIME":{temp:4,conditions:["fog"],intensity:null},"LIPZ":{temp:5,conditions:[],intensity:null},"LIRN":{temp:12,conditions:[],intensity:null},"LIML":{temp:5,conditions:[],intensity:null},"LIPE":{temp:6,conditions:[],intensity:null},"LICC":{temp:15,conditions:[],intensity:null},"LICJ":{temp:15,conditions:[],intensity:null},"LIRA":{temp:13,conditions:[],intensity:null},"LIRP":{temp:11,conditions:[],intensity:null},
  "LIMF":{temp:4,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:9,conditions:["fog"],intensity:null},"EHAM":{temp:6,conditions:[],intensity:null},"EHRD":{temp:5,conditions:[],intensity:null},"EHEH":{temp:7,conditions:[],intensity:null},"EBBR":{temp:7,conditions:[],intensity:null},"EBCI":{temp:8,conditions:[],intensity:null},"ELLX":{temp:7,conditions:[],intensity:null},"LSZH":{temp:0,conditions:["fog"],intensity:null},
  "LSGG":{temp:6,conditions:[],intensity:null},"LSZB":{temp:2,conditions:["fog"],intensity:null},"LOWW":{temp:-2,conditions:[],intensity:null},"LOWS":{temp:5,conditions:[],intensity:null},"LOWG":{temp:-2,conditions:["fog"],intensity:null},"LOWI":{temp:1,conditions:[],intensity:null},"LKPR":{temp:1,conditions:[],intensity:null},"EPWA":{temp:-5,conditions:[],intensity:null},"EPKK":{temp:-2,conditions:[],intensity:null},"EPGD":{temp:-4,conditions:[],intensity:null},
  "EPWR":{temp:2,conditions:[],intensity:null},"EPPO":{temp:2,conditions:[],intensity:null},"EKCH":{temp:5,conditions:[],intensity:null},"ESSA":{temp:1,conditions:[],intensity:null},"ENGM":{temp:0,conditions:["snow"],intensity:null},"EFHK":{temp:-5,conditions:[],intensity:null},"BIKF":{temp:-1,conditions:[],intensity:null},"ESGG":{temp:2,conditions:[],intensity:null},"ESMS":{temp:3,conditions:[],intensity:null},"ENBR":{temp:3,conditions:[],intensity:null},
  "ENZV":{temp:4,conditions:[],intensity:null},"ENTC":{temp:-4,conditions:[],intensity:null},"EFOU":{temp:-11,conditions:[],intensity:null},"EFRO":{temp:-14,conditions:[],intensity:null},"LGAV":{temp:12,conditions:[],intensity:null},"LGTS":{temp:8,conditions:[],intensity:null},"LGIR":{temp:15,conditions:[],intensity:null},"LGKR":{temp:11,conditions:[],intensity:null},"LGRP":{temp:13,conditions:[],intensity:null},"LGSR":{temp:14,conditions:[],intensity:null},
  "LGMK":{temp:13,conditions:[],intensity:null},"LTFM":{temp:6,conditions:[],intensity:null},"LTBA":{temp:7,conditions:[],intensity:null},"LTFJ":{temp:6,conditions:[],intensity:null},"LTAI":{temp:13,conditions:[],intensity:null},"LTAC":{temp:-3,conditions:[],intensity:null},"LTBJ":{temp:6,conditions:[],intensity:null},"LTBS":{temp:13,conditions:[],intensity:null},"LTFE":{temp:11,conditions:[],intensity:null},"LCLK":{temp:13,conditions:[],intensity:null},
  "LCPH":{temp:15,conditions:[],intensity:null},"LHBP":{temp:-5,conditions:[],intensity:null},"LROP":{temp:-2,conditions:[],intensity:null},"LBSF":{temp:4,conditions:[],intensity:null},"LYBE":{temp:5,conditions:[],intensity:null},"LDZA":{temp:9,conditions:[],intensity:null},"LDDU":{temp:10,conditions:[],intensity:null},"LDSP":{temp:11,conditions:[],intensity:null},"LJLJ":{temp:2,conditions:["fog"],intensity:null},"LWSK":{temp:2,conditions:[],intensity:null},
  "LATI":{temp:10,conditions:[],intensity:null},"UKBB":{temp:-11,conditions:[],intensity:null},"UKLL":{temp:-4,conditions:[],intensity:null},"UUEE":{temp:-5,conditions:[],intensity:null},"UUDD":{temp:-7,conditions:[],intensity:null},"UUWW":{temp:-7,conditions:[],intensity:null},"ULLI":{temp:-10,conditions:[],intensity:null},"UWWW":{temp:-8,conditions:[],intensity:null},"USSS":{temp:-28,conditions:[],intensity:null},"UNNT":{temp:-28,conditions:[],intensity:null},
  "UUOB":{temp:-15,conditions:[],intensity:null},"UHWW":{temp:-13,conditions:[],intensity:null},"UEEE":{temp:-33,conditions:[],intensity:null},"OMDB":{temp:24,conditions:[],intensity:null},"OMDW":{temp:27,conditions:[],intensity:null},"OMAA":{temp:27,conditions:[],intensity:null},"OMSJ":{temp:27,conditions:[],intensity:null},"OTHH":{temp:25,conditions:[],intensity:null},"OERK":{temp:19,conditions:[],intensity:null},"OEJN":{temp:27,conditions:[],intensity:null},
  "OEDF":{temp:20,conditions:[],intensity:null},"OEMA":{temp:20,conditions:[],intensity:null},"OKBK":{temp:20,conditions:[],intensity:null},"OBBI":{temp:20,conditions:[],intensity:null},"OOMS":{temp:27,conditions:[],intensity:null},"OYAA":{temp:21,conditions:[],intensity:null},"OIIE":{temp:12,conditions:[],intensity:null},"OIII":{temp:9,conditions:[],intensity:null},"OISS":{temp:12,conditions:[],intensity:null},"OIKB":{temp:22,conditions:[],intensity:null},
  "OIAW":{temp:20,conditions:[],intensity:null},"OIKK":{temp:15,conditions:[],intensity:null},"OICC":{temp:5,conditions:["snow"],intensity:null},"LLBG":{temp:17,conditions:[],intensity:null},"OLBA":{temp:14,conditions:[],intensity:null},"OJAM":{temp:9,conditions:[],intensity:null},"ORBI":{temp:14,conditions:[],intensity:null},"ORER":{temp:9,conditions:[],intensity:null},"GMMN":{temp:12,conditions:[],intensity:null},"GMME":{temp:13,conditions:[],intensity:null},
  "GMMX":{temp:11,conditions:["fog"],intensity:null},"GMTT":{temp:13,conditions:["thunderstorm"],intensity:null},"GMFF":{temp:12,conditions:[],intensity:null},"GMAD":{temp:12,conditions:["fog"],intensity:null},"DAAG":{temp:15,conditions:[],intensity:null},"DAOO":{temp:11,conditions:[],intensity:null},"DTTA":{temp:11,conditions:[],intensity:null},"DTMB":{temp:15,conditions:[],intensity:null},"DTTJ":{temp:15,conditions:[],intensity:null},"HECA":{temp:16,conditions:[],intensity:null},
  "HEGN":{temp:18,conditions:[],intensity:null},"HESH":{temp:18,conditions:[],intensity:null},"HEBA":{temp:19,conditions:[],intensity:null},"HEAX":{temp:16,conditions:[],intensity:null},"HLLT":{temp:16,conditions:[],intensity:null},"DNMM":{temp:31,conditions:[],intensity:null},"DNAA":{temp:31,conditions:[],intensity:null},"DGAA":{temp:30,conditions:[],intensity:null},"DIAP":{temp:29,conditions:[],intensity:null},"GOBD":{temp:22,conditions:[],intensity:null},
  "GABS":{temp:24,conditions:[],intensity:null},"GVNP":{temp:22,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:28,conditions:[],intensity:null},"DXXX":{temp:30,conditions:[],intensity:null},"DBBB":{temp:31,conditions:[],intensity:null},"HKJK":{temp:24,conditions:[],intensity:null},"HKMO":{temp:34,conditions:[],intensity:null},"HTDA":{temp:31,conditions:[],intensity:null},"HTKJ":{temp:30,conditions:[],intensity:null},
  "HUEN":{temp:28,conditions:[],intensity:null},"HRYR":{temp:26,conditions:[],intensity:null},"HAAB":{temp:22,conditions:[],intensity:null},"HDAM":{temp:28,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:27,conditions:[],intensity:null},"FMEE":{temp:30,conditions:["thunderstorm"],intensity:null},"FIMP":{temp:26,conditions:[],intensity:null},"FMCH":{temp:29,conditions:["thunderstorm"],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  "FSIA":{temp:26,conditions:[],intensity:null},"FKKD":{temp:30,conditions:[],intensity:null},"FKYS":{temp:28,conditions:[],intensity:null},"FOOL":{temp:27,conditions:[],intensity:null},"FZAA":{temp:28,conditions:[],intensity:null},"FCBB":{temp:26,conditions:[],intensity:null},"FLLK":{temp:25,conditions:[],intensity:null},"FVHA":{temp:21,conditions:[],intensity:null},"FLLS":{temp:25,conditions:[],intensity:null},"FYWH":{temp:27,conditions:[],intensity:null},
  ...
  "ZSSS":{temp:15,conditions:[],intensity:null},"ZGGG":{temp:21,conditions:[],intensity:null},"VHHH":{temp:20,conditions:[],intensity:null},"ZGSZ":{temp:19,conditions:[],intensity:null},"ZUUU":{temp:17,conditions:[],intensity:null},"ZUCK":{temp:13,conditions:[],intensity:null},"ZHCC":{temp:13,conditions:[],intensity:null},"ZLXY":{temp:13,conditions:[],intensity:null},"ZWSH":{temp:-5,conditions:[],intensity:null},"ZYHB":{temp:-18,conditions:[],intensity:null},
  "ZYTX":{temp:-3,conditions:[],intensity:null},"ZSAM":{temp:19,conditions:[],intensity:null},"ZGKL":{temp:18,conditions:[],intensity:null},"ZSNJ":{temp:15,conditions:[],intensity:null},"ZSHC":{temp:18,conditions:[],intensity:null},"ZPPP":{temp:14,conditions:[],intensity:null},"ZBTJ":{temp:1,conditions:[],intensity:null},"VMMC":{temp:19,conditions:[],intensity:null},"RJTT":{temp:7,conditions:[],intensity:null},"RJAA":{temp:5,conditions:[],intensity:null},
  "RJBB":{temp:9,conditions:[],intensity:null},"RJOO":{temp:4,conditions:[],intensity:null},"RJCC":{temp:-8,conditions:[],intensity:null},"RJFF":{temp:7,conditions:[],intensity:null},"RJGG":{temp:7,conditions:[],intensity:null},"ROAH":{temp:19,conditions:[],intensity:null},"RJSS":{temp:0,conditions:[],intensity:null},"RJSN":{temp:3,conditions:[],intensity:null},"RJOK":{temp:7,conditions:[],intensity:null},"RKSI":{temp:2,conditions:[],intensity:null},
  "RKSS":{temp:0,conditions:[],intensity:null},"RKPK":{temp:4,conditions:[],intensity:null},"RKPC":{temp:9,conditions:[],intensity:null},"RKTN":{temp:0,conditions:[],intensity:null},"ZKPY":{temp:-4,conditions:[],intensity:null},"WSSS":{temp:28,conditions:[],intensity:null},"WMKK":{temp:31,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:27,conditions:[],intensity:null},"WBGG":{temp:26,conditions:[],intensity:null},
  "VTBS":{temp:31,conditions:[],intensity:null},"VTBD":{temp:31,conditions:[],intensity:null},"VTSP":{temp:30,conditions:[],intensity:null},"VTCC":{temp:28,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:24,conditions:[],intensity:null},"VVTS":{temp:30,conditions:[],intensity:null},"VVDN":{temp:22,conditions:[],intensity:null},"VVCR":{temp:25,conditions:[],intensity:null},
  ...
  "VCBI":{temp:27,conditions:[],intensity:null},"WIII":{temp:27,conditions:[],intensity:null},"WADD":{temp:28,conditions:["thunderstorm"],intensity:null},"WARR":{temp:28,conditions:[],intensity:null},"WIHH":{temp:27,conditions:["thunderstorm"],intensity:null},"WIMM":{temp:30,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:24,conditions:[],intensity:null},"WASS":{temp:28,conditions:[],intensity:null},
  ...
  "RCKH":{temp:22,conditions:[],intensity:null},"RCNN":{temp:21,conditions:[],intensity:null},"YSSY":{temp:21,conditions:[],intensity:null},"YMML":{temp:21,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:32,conditions:[],intensity:null},"YPAD":{temp:21,conditions:[],intensity:null},"YBCG":{temp:22,conditions:[],intensity:null},"YBCS":{temp:26,conditions:[],intensity:null},"YSCB":{temp:21,conditions:["thunderstorm"],intensity:null},
  ...
  "NIUE":{temp:25,conditions:["rain"],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:23,conditions:[],intensity:null},"PHKO":{temp:27,conditions:[],intensity:null},"PHLH":{temp:18,conditions:[],intensity:null}
};
