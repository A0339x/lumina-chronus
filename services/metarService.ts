...
// Last updated: 2026-01-01T14:40:53.973Z
...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:5,condition:null},"KLAX":{temp:15,condition:"rain"},"KORD":{temp:-11,condition:null},"KDFW":{temp:7,condition:null},"KDEN":{temp:4,condition:null},"KJFK":{temp:-4,condition:null},"KSFO":{temp:11,condition:null},"KSEA":{temp:2,condition:"fog"},"KLAS":{temp:8,condition:null},"KMCO":{temp:10,condition:null},
  "KEWR":{temp:-4,condition:null},"KMIA":{temp:13,condition:null},"KPHX":{temp:14,condition:null},"KIAH":{temp:7,condition:null},"KBOS":{temp:-4,condition:null},"KMSP":{temp:-15,condition:null},"KFLL":{temp:14,condition:null},"KDTW":{temp:-11,condition:null},"KPHL":{temp:-3,condition:null},"KLGA":{temp:-4,condition:null},
  "KBWI":{temp:-1,condition:null},"KSLC":{temp:1,condition:null},"KDCA":{temp:-1,condition:null},"KIAD":{temp:-2,condition:null},"KSAN":{temp:17,condition:null},"KTPA":{temp:10,condition:null},"KPDX":{temp:4,condition:null},"KSTL":{temp:0,condition:null},"KHNL":{temp:23,condition:null},"KMEM":{temp:6,condition:null},
  "KAUS":{temp:6,condition:null},"KBNA":{temp:3,condition:null},"KRDU":{temp:6,condition:null},"KCLT":{temp:6,condition:null},"KSMF":{temp:8,condition:null},"KSJC":{temp:11,condition:null},"KOAK":{temp:11,condition:null},"KCLE":{temp:-11,condition:null},"KMKE":{temp:-12,condition:null},"KPIT":{temp:-10,condition:null},
  "KIND":{temp:-5,condition:null},"KCVG":{temp:-4,condition:null},"KMCI":{temp:-1,condition:null},"KSAT":{temp:7,condition:null},"KHOU":{temp:8,condition:null},"KDAL":{temp:7,condition:null},"KMDW":{temp:-11,condition:null},"PANC":{temp:-9,condition:null},"PAFA":{temp:-37,condition:null},"CYYZ":{temp:-13,condition:null},
  "CYVR":{temp:3,condition:"fog"},"CYUL":{temp:-12,condition:null},"CYYC":{temp:-3,condition:null},"CYEG":{temp:-8,condition:"snow"},"CYOW":{temp:-16,condition:null},"CYWG":{temp:-19,condition:null},"CYHZ":{temp:1,condition:null},"CYQB":{temp:-8,condition:null},"CYYJ":{temp:3,condition:"fog"},"CYLW":{temp:-3,condition:null},
  "CYXE":{temp:-21,condition:null},"CYQR":{temp:-14,condition:null},"CYZF":{temp:-32,condition:null},"CYXY":{temp:-25,condition:null},"CYQT":{temp:-25,condition:null},"CYYT":{temp:2,condition:null},"MMMX":{temp:9,condition:null},"MMUN":{temp:20,condition:null},"MMGL":{temp:14,condition:null},"MMMY":{temp:11,condition:null},
  "MMTJ":{temp:16,condition:null},"MMSM":{temp:26,condition:null},"MMMD":{temp:20,condition:null},"MMCZ":{temp:20,condition:null},"MMSD":{temp:21,condition:null},"MGGT":{temp:15,condition:null},"MSLP":{temp:27,condition:null},"MHTG":{temp:21,condition:null},"MNMG":{temp:25,condition:null},"MROC":{temp:26,condition:null},
  "MPTO":{temp:28,condition:null},"MKJP":{temp:28,condition:null},"TNCM":{temp:26,condition:null},"TBPB":{temp:27,condition:null},"TTPP":{temp:30,condition:null},"MWCR":{temp:22,condition:null},"MUHA":{temp:19,condition:null},"MDSD":{temp:25,condition:null},"MDPP":{temp:26,condition:null},"MTPP":{temp:27,condition:null},
  "TJSJ":{temp:27,condition:null},"TIST":{temp:26,condition:null},"TLPL":{temp:28,condition:null},"TAPA":{temp:27,condition:null},"SBGR":{temp:30,condition:null},"SBGL":{temp:37,condition:null},"SBBR":{temp:28,condition:null},"SBCF":{temp:30,condition:null},"SBSV":{temp:29,condition:null},"SBRF":{temp:32,condition:null},
  "SBPA":{temp:32,condition:null},"SBCT":{temp:26,condition:null},"SBFZ":{temp:32,condition:null},"SCEL":{temp:28,condition:null},"SAEZ":{temp:25,condition:null},"SABE":{temp:25,condition:null},"SACO":{temp:32,condition:null},"SAME":{temp:30,condition:null},"SLLP":{temp:12,condition:null},"SLVR":{temp:27,condition:null},
  "SPJC":{temp:19,condition:null},"SEQM":{temp:15,condition:null},"SEGU":{temp:26,condition:null},"SKBO":{temp:15,condition:null},"SKMR":{temp:29,condition:null},"SKCL":{temp:23,condition:null},"SKMD":{temp:26,condition:null},"SKRG":{temp:17,condition:null},"SVMI":{temp:27,condition:null},"SUMU":{temp:26,condition:null},
  "SGAS":{temp:28,condition:null},"SBBV":{temp:31,condition:null},"SMJP":{temp:29,condition:null},"SYCJ":{temp:27,condition:null},"EGLL":{temp:6,condition:null},"EGKK":{temp:5,condition:null},"EGSS":{temp:5,condition:null},"EGLC":{temp:6,condition:null},"EGCC":{temp:6,condition:null},"EGBB":{temp:6,condition:null},
  "EGPH":{temp:4,condition:null},"EGPF":{temp:5,condition:null},"EGGW":{temp:5,condition:null},"EGNX":{temp:6,condition:null},"EGNT":{temp:3,condition:null},"EGGP":{temp:7,condition:null},"EGHI":{temp:7,condition:null},"EGGD":{temp:5,condition:null},"EGPD":{temp:2,condition:null},"EGAA":{temp:5,condition:null},
  "EIDW":{temp:6,condition:null},"EICK":{temp:7,condition:null},"EINN":{temp:8,condition:null},"LFPG":{temp:4,condition:null},"LFPO":{temp:4,condition:null},"LFML":{temp:10,condition:null},"LFLL":{temp:3,condition:null},"LFMN":{temp:12,condition:null},"LFBD":{temp:4,condition:null},"LFBO":{temp:4,condition:null},
  "LFRS":{temp:3,condition:null},"LFSB":{temp:1,condition:null},"LFPB":{temp:5,condition:null},"EDDF":{temp:3,condition:null},"EDDM":{temp:2,condition:null},"EDDB":{temp:2,condition:"snow"},"EDDL":{temp:3,condition:null},"EDDH":{temp:3,condition:null},"EDDK":{temp:3,condition:null},"EDDS":{temp:2,condition:null},
  "EDDW":{temp:3,condition:null},"EDDN":{temp:1,condition:null},"EDDV":{temp:3,condition:null},"EDDP":{temp:3,condition:null},"LEMD":{temp:7,condition:null},"LEBL":{temp:12,condition:null},"LEPA":{temp:13,condition:null},"LEMG":{temp:15,condition:null},"LEVC":{temp:14,condition:null},"LEAL":{temp:14,condition:null},
  ...
  "LIMC":{temp:4,condition:null},"LIME":{temp:3,condition:null},"LIPZ":{temp:4,condition:null},"LIRN":{temp:10,condition:null},"LIML":{temp:4,condition:null},"LIPE":{temp:7,condition:null},"LICC":{temp:12,condition:null},"LICJ":{temp:14,condition:null},"LIRA":{temp:10,condition:null},"LIRP":{temp:7,condition:null},
  "LIMF":{temp:4,condition:null},"LIEO":{temp:14,condition:null},"LIEE":{temp:14,condition:null},"EHAM":{temp:6,condition:null},"EHRD":{temp:6,condition:null},"EHEH":{temp:4,condition:null},"EBBR":{temp:4,condition:null},"EBCI":{temp:3,condition:null},"ELLX":{temp:0,condition:null},"LSZH":{temp:1,condition:null},
  "LSGG":{temp:5,condition:null},"LSZB":{temp:1,condition:null},"LOWW":{temp:4,condition:null},"LOWS":{temp:-1,condition:null},"LOWG":{temp:1,condition:null},"LOWI":{temp:1,condition:null},"LKPR":{temp:0,condition:null},"EPWA":{temp:1,condition:null},"EPKK":{temp:1,condition:null},"EPGD":{temp:0,condition:"snow"},
  "EPWR":{temp:1,condition:null},"EPPO":{temp:1,condition:null},"EKCH":{temp:5,condition:null},"ESSA":{temp:1,condition:null},"ENGM":{temp:-2,condition:null},"EFHK":{temp:-12,condition:null},"BIKF":{temp:4,condition:null},"ESGG":{temp:2,condition:null},"ESMS":{temp:3,condition:null},"ENBR":{temp:2,condition:null},
  "ENZV":{temp:6,condition:null},"ENTC":{temp:-14,condition:null},"EFOU":{temp:-18,condition:null},"EFRO":{temp:-17,condition:null},"LGAV":{temp:6,condition:null},"LGTS":{temp:5,condition:null},"LGIR":{temp:9,condition:null},"LGKR":{temp:9,condition:null},"LGRP":{temp:7,condition:null},"LGSR":{temp:8,condition:null},
  "LGMK":{temp:7,condition:null},"LTFM":{temp:0,condition:null},"LTBA":{temp:2,condition:null},"LTFJ":{temp:1,condition:null},"LTAI":{temp:7,condition:null},"LTAC":{temp:-5,condition:null},"LTBJ":{temp:2,condition:null},"LTBS":{temp:9,condition:null},"LTFE":{temp:5,condition:null},"LCLK":{temp:14,condition:null},
  "LCPH":{temp:13,condition:null},"LHBP":{temp:2,condition:null},"LROP":{temp:-1,condition:null},"LBSF":{temp:0,condition:null},"LYBE":{temp:4,condition:null},"LDZA":{temp:6,condition:null},"LDDU":{temp:6,condition:null},"LDSP":{temp:8,condition:null},"LJLJ":{temp:3,condition:null},"LWSK":{temp:2,condition:null},
  "LATI":{temp:6,condition:null},"UKBB":{temp:-12,condition:null},"UKLL":{temp:-2,condition:null},"UUEE":{temp:-12,condition:null},"UUDD":{temp:-11,condition:null},"UUWW":{temp:-12,condition:null},"ULLI":{temp:-10,condition:null},"UWWW":{temp:-10,condition:null},"USSS":{temp:-11,condition:"snow"},"UNNT":{temp:-9,condition:null},
  "UUOB":{temp:-30,condition:null},"UHWW":{temp:-14,condition:null},"UEEE":{temp:-26,condition:"snow"},"OMDB":{temp:21,condition:null},"OMDW":{temp:20,condition:null},"OMAA":{temp:21,condition:null},"OMSJ":{temp:20,condition:null},"OTHH":{temp:19,condition:null},"OERK":{temp:21,condition:null},"OEJN":{temp:28,condition:null},
  "OEDF":{temp:20,condition:null},"OEMA":{temp:24,condition:null},"OKBK":{temp:18,condition:null},"OBBI":{temp:20,condition:null},"OOMS":{temp:22,condition:null},"OYAA":{temp:17,condition:null},"OIIE":{temp:6,condition:null},"OIII":{temp:6,condition:null},"OISS":{temp:10,condition:null},"OIKB":{temp:20,condition:null},
  "OIAW":{temp:15,condition:null},"OIKK":{temp:10,condition:null},"OICC":{temp:7,condition:null},"LLBG":{temp:15,condition:null},"OLBA":{temp:15,condition:"thunderstorm"},"OJAM":{temp:12,condition:null},"ORBI":{temp:15,condition:null},"ORER":{temp:7,condition:null},"GMMN":{temp:23,condition:null},"GMME":{temp:22,condition:null},
  "GMMX":{temp:23,condition:null},"GMTT":{temp:18,condition:null},"GMFF":{temp:18,condition:null},"GMAD":{temp:26,condition:null},"DAAG":{temp:17,condition:null},"DAOO":{temp:17,condition:null},"DTTA":{temp:17,condition:null},"DTMB":{temp:16,condition:null},"DTTJ":{temp:16,condition:null},"HECA":{temp:19,condition:null},
  "HEGN":{temp:22,condition:null},"HESH":{temp:21,condition:null},"HEBA":{temp:23,condition:null},"HEAX":{temp:16,condition:null},"HLLT":{temp:16,condition:null},"DNMM":{temp:33,condition:null},"DNAA":{temp:37,condition:null},"DGAA":{temp:31,condition:null},"DIAP":{temp:29,condition:"thunderstorm"},"GOBD":{temp:33,condition:null},
  "GABS":{temp:35,condition:null},"GVNP":{temp:29,condition:null},"GBYD":{temp:29,condition:null},"GLRB":{temp:28,condition:null},"DXXX":{temp:32,condition:null},"DBBB":{temp:32,condition:null},"HKJK":{temp:22,condition:null},"HKMO":{temp:30,condition:null},"HTDA":{temp:29,condition:null},"HTKJ":{temp:26,condition:null},
  "HUEN":{temp:25,condition:null},"HRYR":{temp:27,condition:null},"HAAB":{temp:20,condition:null},"HDAM":{temp:26,condition:null},"HCMM":{temp:28,condition:null},"OYSN":{temp:23,condition:null},"FMEE":{temp:25,condition:null},"FIMP":{temp:22,condition:null},"FMCH":{temp:30,condition:null},"FMMI":{temp:22,condition:"thunderstorm"},
  "FSIA":{temp:28,condition:null},"FKKD":{temp:29,condition:null},"FKYS":{temp:30,condition:null},"FOOL":{temp:28,condition:"thunderstorm"},"FZAA":{temp:29,condition:null},"FCBB":{temp:27,condition:null},"FLLK":{temp:27,condition:null},"FVHA":{temp:27,condition:null},"FLLS":{temp:26,condition:null},"FYWH":{temp:28,condition:null},
  "FBSK":{temp:32,condition:null},"FAOR":{temp:23,condition:null},"FACT":{temp:26,condition:null},"FALE":{temp:23,condition:null},"FAPE":{temp:25,condition:null},"FQMA":{temp:31,condition:null},"FWKI":{temp:22,condition:"thunderstorm"},"ZBAA":{temp:-5,condition:null},"ZBAD":{temp:-7,condition:null},"ZSPD":{temp:5,condition:null},
  "ZSSS":{temp:3,condition:null},"ZGGG":{temp:12,condition:null},"VHHH":{temp:16,condition:null},"ZGSZ":{temp:15,condition:null},"ZUUU":{temp:7,condition:null},"ZUCK":{temp:9,condition:null},"ZHCC":{temp:0,condition:null},"ZLXY":{temp:0,condition:null},"ZWSH":{temp:-12,condition:null},"ZYHB":{temp:-21,condition:null},
  "ZYTX":{temp:-16,condition:null},"ZSAM":{temp:13,condition:null},"ZGKL":{temp:5,condition:null},"ZSNJ":{temp:1,condition:null},"ZSHC":{temp:4,condition:null},"ZPPP":{temp:8,condition:null},"ZBTJ":{temp:-5,condition:null},"VMMC":{temp:16,condition:null},"RJTT":{temp:6,condition:null},"RJAA":{temp:3,condition:null},
  "RJBB":{temp:7,condition:null},"RJOO":{temp:3,condition:null},"RJCC":{temp:-13,condition:null},"RJFF":{temp:4,condition:null},"RJGG":{temp:6,condition:null},"ROAH":{temp:18,condition:null},"RJSS":{temp:0,condition:null},"RJSN":{temp:2,condition:null},"RJOK":{temp:4,condition:null},"RKSI":{temp:-7,condition:null},
  "RKSS":{temp:-11,condition:null},"RKPK":{temp:-5,condition:null},"RKPC":{temp:4,condition:null},"RKTN":{temp:-8,condition:null},"ZKPY":{temp:-14,condition:null},"WSSS":{temp:26,condition:null},"WMKK":{temp:26,condition:null},"WMKP":{temp:28,condition:null},"WBKK":{temp:28,condition:"thunderstorm"},"WBGG":{temp:24,condition:"fog"},
  "VTBS":{temp:27,condition:null},"VTBD":{temp:26,condition:null},"VTSP":{temp:28,condition:null},"VTCC":{temp:21,condition:null},"VTSS":{temp:26,condition:null},"VTUK":{temp:25,condition:null},"VVNB":{temp:18,condition:null},"VVTS":{temp:24,condition:null},"VVDN":{temp:18,condition:null},"VVCR":{temp:21,condition:null},
  "VDPP":{temp:25,condition:null},"VDSR":{temp:23,condition:null},"VLVT":{temp:21,condition:null},"VLLB":{temp:20,condition:null},"VYYY":{temp:24,condition:null},"VYMD":{temp:20,condition:null},"VGHS":{temp:16,condition:null},"VGCG":{temp:20,condition:null},"VECC":{temp:17,condition:null},"VRMM":{temp:27,condition:null},
  "VCBI":{temp:26,condition:null},"WIII":{temp:25,condition:null},"WADD":{temp:29,condition:null},"WARR":{temp:26,condition:null},"WIHH":{temp:27,condition:null},"WIMM":{temp:26,condition:null},"WIBB":{temp:28,condition:"thunderstorm"},"WAFF":{temp:27,condition:null},"WICC":{temp:23,condition:null},"WASS":{temp:28,condition:null},
  "RPLL":{temp:27,condition:null},"RPLC":{temp:24,condition:"thunderstorm"},"RPVM":{temp:25,condition:"fog"},"RPVD":{temp:25,condition:"thunderstorm"},"RPVK":{temp:23,condition:"fog"},"WBSB":{temp:25,condition:"thunderstorm"},"WBLL":{temp:27,condition:"thunderstorm"},"VIDP":{temp:14,condition:null},"VABB":{temp:25,condition:null},"VOBL":{temp:22,condition:null},
  "VOMM":{temp:24,condition:null},"VEBS":{temp:17,condition:null},"VOHY":{temp:21,condition:null},"VAAH":{temp:22,condition:null},"VOCI":{temp:28,condition:null},"VAGO":{temp:26,condition:null},"VOTP":{temp:24,condition:null},"VIAR":{temp:13,condition:null},"VIJP":{temp:17,condition:null},"VELR":{temp:11,condition:null},
  "VOCL":{temp:27,condition:null},"VOTV":{temp:27,condition:null},"VEPT":{temp:15,condition:null},"VNKT":{temp:11,condition:null},"OPKC":{temp:22,condition:null},"OPLA":{temp:13,condition:null},"OPIS":{temp:11,condition:null},"RCTP":{temp:15,condition:null},"RCSS":{temp:15,condition:null},"RCMQ":{temp:15,condition:null},
  "RCKH":{temp:18,condition:null},"RCNN":{temp:17,condition:null},"YSSY":{temp:14,condition:null},"YMML":{temp:14,condition:null},"YBBN":{temp:23,condition:null},"YPPH":{temp:27,condition:null},"YPAD":{temp:19,condition:null},"YBCG":{temp:20,condition:null},"YBCS":{temp:24,condition:null},"YSCB":{temp:12,condition:null},
  "YMHB":{temp:14,condition:null},"NZAA":{temp:19,condition:null},"NZWN":{temp:17,condition:null},"NZCH":{temp:14,condition:null},"NZQN":{temp:14,condition:null},"NZDN":{temp:12,condition:null},"NFFN":{temp:26,condition:null},"NWWW":{temp:25,condition:null},"NTAA":{temp:27,condition:null},"NSFA":{temp:28,condition:null},
