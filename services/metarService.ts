...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:-1,conditions:[],intensity:null},"KLAX":{temp:15,conditions:[],intensity:null},"KORD":{temp:-11,conditions:[],intensity:null},"KDFW":{temp:6,conditions:[],intensity:null},"KDEN":{temp:2,conditions:[],intensity:null},"KJFK":{temp:4,conditions:[],intensity:null},"KSFO":{temp:9,conditions:[],intensity:null},"KSEA":{temp:8,conditions:[],intensity:null},"KLAS":{temp:12,conditions:[],intensity:null},"KMCO":{temp:14,conditions:[],intensity:null},
  "KEWR":{temp:5,conditions:[],intensity:null},"KMIA":{temp:18,conditions:[],intensity:null},"KPHX":{temp:18,conditions:[],intensity:null},"KIAH":{temp:9,conditions:[],intensity:null},"KBOS":{temp:5,conditions:[],intensity:null},"KMSP":{temp:-12,conditions:[],intensity:null},"KFLL":{temp:17,conditions:[],intensity:null},"KDTW":{temp:-12,conditions:[],intensity:null},"KPHL":{temp:6,conditions:[],intensity:null},"KLGA":{temp:5,conditions:[],intensity:null},
  "KBWI":{temp:6,conditions:[],intensity:null},"KSLC":{temp:-3,conditions:[],intensity:null},"KDCA":{temp:7,conditions:[],intensity:null},"KIAD":{temp:6,conditions:[],intensity:null},"KSAN":{temp:14,conditions:[],intensity:null},"KTPA":{temp:16,conditions:[],intensity:null},"KPDX":{temp:5,conditions:[],intensity:null},"KSTL":{temp:-5,conditions:[],intensity:null},"KHNL":{temp:25,conditions:[],intensity:null},"KMEM":{temp:0,conditions:[],intensity:null},
  "KAUS":{temp:8,conditions:[],intensity:null},"KBNA":{temp:-2,conditions:[],intensity:null},"KRDU":{temp:8,conditions:[],intensity:null},"KCLT":{temp:4,conditions:[],intensity:null},"KSMF":{temp:5,conditions:["fog"],intensity:null},"KSJC":{temp:8,conditions:[],intensity:null},"KOAK":{temp:8,conditions:[],intensity:null},"KCLE":{temp:-9,conditions:["snow"],intensity:null},"KMKE":{temp:-9,conditions:[],intensity:null},"KPIT":{temp:-5,conditions:[],intensity:null},
  "KIND":{temp:-8,conditions:[],intensity:null},"KCVG":{temp:-7,conditions:[],intensity:null},"KMCI":{temp:-7,conditions:[],intensity:null},"KSAT":{temp:8,conditions:[],intensity:null},"KHOU":{temp:10,conditions:[],intensity:null},"KDAL":{temp:5,conditions:[],intensity:null},"KMDW":{temp:-11,conditions:[],intensity:null},"PANC":{temp:-3,conditions:[],intensity:null},"PAFA":{temp:-30,conditions:[],intensity:null},"CYYZ":{temp:-11,conditions:["snow"],intensity:null},
  ...
  "SBPA":{temp:27,conditions:[],intensity:null},"SBCT":{temp:18,conditions:["fog"],intensity:null},"SBFZ":{temp:25,conditions:[],intensity:null},"SCEL":{temp:12,conditions:[],intensity:null},"SAEZ":{temp:24,conditions:[],intensity:null},"SABE":{temp:24,conditions:[],intensity:null},"SACO":{temp:20,conditions:[],intensity:null},"SAME":{temp:21,conditions:[],intensity:null},"SLLP":{temp:4,conditions:["fog"],intensity:null},"SLVR":{temp:23,conditions:[],intensity:null},
  "SPJC":{temp:21,conditions:[],intensity:null},"SEQM":{temp:11,conditions:["fog"],intensity:null},"SEGU":{temp:24,conditions:[],intensity:null},"SKBO":{temp:10,conditions:[],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:22,conditions:[],intensity:null},"SKRG":{temp:13,conditions:[],intensity:null},"SVMI":{temp:27,conditions:[],intensity:null},"SUMU":{temp:23,conditions:[],intensity:null},
  ...
  "LSGG":{temp:6,conditions:[],intensity:null},"LSZB":{temp:2,conditions:["fog"],intensity:null},"LOWW":{temp:-2,conditions:["fog"],intensity:null},"LOWS":{temp:1,conditions:[],intensity:null},"LOWG":{temp:-6,conditions:[],intensity:null},"LOWI":{temp:-2,conditions:["fog"],intensity:null},"LKPR":{temp:2,conditions:[],intensity:null},"EPWA":{temp:1,conditions:[],intensity:null},"EPKK":{temp:-2,conditions:[],intensity:null},"EPGD":{temp:-1,conditions:[],intensity:null},
  "EPWR":{temp:0,conditions:["fog"],intensity:null},"EPPO":{temp:-1,conditions:["fog"],intensity:null},"EKCH":{temp:2,conditions:[],intensity:null},"ESSA":{temp:1,conditions:[],intensity:null},"ENGM":{temp:-4,conditions:[],intensity:null},"EFHK":{temp:-6,conditions:["snow"],intensity:null},"BIKF":{temp:1,conditions:[],intensity:null},"ESGG":{temp:2,conditions:[],intensity:null},"ESMS":{temp:0,conditions:[],intensity:null},"ENBR":{temp:5,conditions:[],intensity:null},
  "ENZV":{temp:4,conditions:[],intensity:null},"ENTC":{temp:-5,conditions:[],intensity:null},"EFOU":{temp:-7,conditions:[],intensity:null},"EFRO":{temp:-9,conditions:[],intensity:null},"LGAV":{temp:5,conditions:[],intensity:null},"LGTS":{temp:1,conditions:[],intensity:null},"LGIR":{temp:11,conditions:[],intensity:null},"LGKR":{temp:11,conditions:[],intensity:null},"LGRP":{temp:12,conditions:[],intensity:null},"LGSR":{temp:14,conditions:[],intensity:null},
  "LGMK":{temp:13,conditions:[],intensity:null},"LTFM":{temp:8,conditions:[],intensity:null},"LTBA":{temp:9,conditions:[],intensity:null},"LTFJ":{temp:7,conditions:[],intensity:null},"LTAI":{temp:8,conditions:[],intensity:null},"LTAC":{temp:-1,conditions:[],intensity:null},"LTBJ":{temp:3,conditions:[],intensity:null},"LTBS":{temp:8,conditions:[],intensity:null},"LTFE":{temp:9,conditions:[],intensity:null},"LCLK":{temp:9,conditions:[],intensity:null},
  "LCPH":{temp:12,conditions:[],intensity:null},"LHBP":{temp:-5,conditions:["fog"],intensity:null},"LROP":{temp:-2,conditions:["fog"],intensity:null},"LBSF":{temp:-2,conditions:["fog"],intensity:null},"LYBE":{temp:3,conditions:[],intensity:null},"LDZA":{temp:0,conditions:["fog"],intensity:null},"LDDU":{temp:9,conditions:[],intensity:null},"LDSP":{temp:11,conditions:[],intensity:null},"LJLJ":{temp:-1,conditions:[],intensity:null},"LWSK":{temp:-1,conditions:["fog"],intensity:null},
  ...
  "HUEN":{temp:24,conditions:[],intensity:null},"HRYR":{temp:21,conditions:[],intensity:null},"HAAB":{temp:17,conditions:[],intensity:null},"HDAM":{temp:24,conditions:[],intensity:null},"HCMM":{temp:29,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:30,conditions:[],intensity:null},"FIMP":{temp:25,conditions:[],intensity:null},"FMCH":{temp:31,conditions:[],intensity:null},"FMMI":{temp:23,conditions:[],intensity:null},
  ...
  "ZSSS":{temp:20,conditions:[],intensity:null},"ZGGG":{temp:25,conditions:[],intensity:null},"VHHH":{temp:21,conditions:[],intensity:null},"ZGSZ":{temp:21,conditions:[],intensity:null},"ZUUU":{temp:16,conditions:[],intensity:null},"ZUCK":{temp:14,conditions:[],intensity:null},"ZHCC":{temp:18,conditions:[],intensity:null},"ZLXY":{temp:13,conditions:[],intensity:null},"ZWSH":{temp:-9,conditions:[],intensity:null},"ZYHB":{temp:-16,conditions:[],intensity:null},
  "ZYTX":{temp:-6,conditions:[],intensity:null},"ZSAM":{temp:20,conditions:[],intensity:null},"ZGKL":{temp:19,conditions:[],intensity:null},"ZSNJ":{temp:19,conditions:[],intensity:null},"ZSHC":{temp:20,conditions:[],intensity:null},"ZPPP":{temp:14,conditions:[],intensity:null},"ZBTJ":{temp:8,conditions:[],intensity:null},"VMMC":{temp:23,conditions:[],intensity:null},"RJTT":{temp:10,conditions:[],intensity:null},"RJAA":{temp:10,conditions:[],intensity:null},
  ...
  "VCBI":{temp:27,conditions:[],intensity:null},"WIII":{temp:29,conditions:[],intensity:null},"WADD":{temp:28,conditions:[],intensity:null},"WARR":{temp:29,conditions:["thunderstorm"],intensity:null},"WIHH":{temp:27,conditions:[],intensity:null},"WIMM":{temp:31,conditions:[],intensity:null},"WIBB":{temp:27,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:26,conditions:[],intensity:null},"WASS":{temp:30,conditions:[],intensity:null},
  "RPLL":{temp:27,conditions:[],intensity:null},"RPLC":{temp:27,conditions:[],intensity:null},"RPVM":{temp:27,conditions:[],intensity:null},"RPVD":{temp:29,conditions:[],intensity:null},"RPVK":{temp:26,conditions:[],intensity:null},"WBSB":{temp:26,conditions:[],intensity:null},"WBLL":{temp:27,conditions:["thunderstorm"],intensity:null},"VIDP":{temp:12,conditions:[],intensity:null},"VABB":{temp:25,conditions:[],intensity:null},"VOBL":{temp:27,conditions:[],intensity:null},
  "VOMM":{temp:29,conditions:[],intensity:null},"VEBS":{temp:23,conditions:[],intensity:null},"VOHY":{temp:28,conditions:[],intensity:null},"VAAH":{temp:26,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:32,conditions:[],intensity:null},"VOTP":{temp:28,conditions:[],intensity:null},"VIAR":{temp:10,conditions:[],intensity:null},"VIJP":{temp:21,conditions:[],intensity:null},"VELR":{temp:19,conditions:[],intensity:null},
  "VOCL":{temp:31,conditions:[],intensity:null},"VOTV":{temp:28,conditions:[],intensity:null},"VEPT":{temp:20,conditions:[],intensity:null},"VNKT":{temp:18,conditions:[],intensity:null},"OPKC":{temp:24,conditions:[],intensity:null},"OPLA":{temp:12,conditions:[],intensity:null},"OPIS":{temp:14,conditions:[],intensity:null},"RCTP":{temp:21,conditions:[],intensity:null},"RCSS":{temp:21,conditions:[],intensity:null},"RCMQ":{temp:22,conditions:[],intensity:null},
  ...
  "YMHB":{temp:17,conditions:[],intensity:null},"NZAA":{temp:22,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:14,conditions:[],intensity:null},"NZQN":{temp:14,conditions:[],intensity:null},"NZDN":{temp:12,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:32,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
