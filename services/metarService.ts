...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KIND":{temp:10,conditions:[],intensity:null},"KCVG":{temp:10,conditions:[],intensity:null},"KMCI":{temp:18,conditions:[],intensity:null},"KSAT":{temp:24,conditions:[],intensity:null},"KHOU":{temp:25,conditions:[],intensity:null},"KDAL":{temp:20,conditions:[],intensity:null},"KMDW":{temp:3,conditions:[],intensity:null},"PANC":{temp:-15,conditions:[],intensity:null},"PAFA":{temp:-27,conditions:[],intensity:null},"CYYZ":{temp:2,conditions:[],intensity:null},
  "CYVR":{temp:4,conditions:[],intensity:null},"CYUL":{temp:-2,conditions:[],intensity:null},"CYYC":{temp:1,conditions:[],intensity:null},"CYEG":{temp:-8,conditions:[],intensity:null},"CYOW":{temp:-1,conditions:[],intensity:null},"CYWG":{temp:-3,conditions:[],intensity:null},"CYHZ":{temp:2,conditions:[],intensity:null},"CYQB":{temp:-3,conditions:[],intensity:null},"CYYJ":{temp:5,conditions:[],intensity:null},"CYLW":{temp:4,conditions:[],intensity:null},
  "CYXE":{temp:-12,conditions:[],intensity:null},"CYQR":{temp:-5,conditions:[],intensity:null},"CYZF":{temp:-30,conditions:[],intensity:null},"CYXY":{temp:-9,conditions:[],intensity:null},"CYQT":{temp:1,conditions:[],intensity:null},"CYYT":{temp:1,conditions:[],intensity:null},"MMMX":{temp:23,conditions:[],intensity:null},"MMUN":{temp:28,conditions:[],intensity:null},"MMGL":{temp:25,conditions:[],intensity:null},"MMMY":{temp:27,conditions:[],intensity:null},
  ...
  "SBPA":{temp:34,conditions:[],intensity:null},"SBCT":{temp:27,conditions:[],intensity:null},"SBFZ":{temp:28,conditions:[],intensity:null},"SCEL":{temp:27,conditions:[],intensity:null},"SAEZ":{temp:25,conditions:[],intensity:null},"SABE":{temp:27,conditions:[],intensity:null},"SACO":{temp:30,conditions:[],intensity:null},"SAME":{temp:30,conditions:[],intensity:null},"SLLP":{temp:19,conditions:[],intensity:null},"SLVR":{temp:30,conditions:[],intensity:null},
  ...
  "LFRS":{temp:6,conditions:[],intensity:null},"LFSB":{temp:-3,conditions:[],intensity:null},"LFPB":{temp:2,conditions:[],intensity:null},"EDDF":{temp:-3,conditions:[],intensity:null},"EDDM":{temp:-9,conditions:[],intensity:null},"EDDB":{temp:-8,conditions:[],intensity:null},"EDDL":{temp:-1,conditions:["snow"],intensity:null},"EDDH":{temp:-2,conditions:[],intensity:null},"EDDK":{temp:-1,conditions:["snow"],intensity:null},"EDDS":{temp:-4,conditions:[],intensity:null},
  ...
  "ENZV":{temp:-9,conditions:[],intensity:null},"ENTC":{temp:-9,conditions:[],intensity:null},"EFOU":{temp:-19,conditions:[],intensity:null},"EFRO":{temp:-25,conditions:[],intensity:null},"LGAV":{temp:17,conditions:[],intensity:null},"LGTS":{temp:17,conditions:[],intensity:null},"LGIR":{temp:19,conditions:[],intensity:null},"LGKR":{temp:15,conditions:["thunderstorm"],intensity:null},"LGRP":{temp:17,conditions:[],intensity:null},"LGSR":{temp:19,conditions:[],intensity:null},
  "LGMK":{temp:18,conditions:[],intensity:null},"LTFM":{temp:14,conditions:[],intensity:null},"LTBA":{temp:14,conditions:[],intensity:null},"LTFJ":{temp:15,conditions:[],intensity:null},"LTAI":{temp:16,conditions:[],intensity:null},"LTAC":{temp:2,conditions:["fog"],intensity:null},"LTBJ":{temp:15,conditions:[],intensity:null},"LTBS":{temp:17,conditions:[],intensity:null},"LTFE":{temp:17,conditions:[],intensity:null},"LCLK":{temp:14,conditions:[],intensity:null},
