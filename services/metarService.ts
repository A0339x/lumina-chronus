...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EPWR":{temp:11,conditions:[],intensity:null},"EPPO":{temp:9,conditions:[],intensity:null},"EKCH":{temp:6,conditions:[],intensity:null},"ESSA":{temp:4,conditions:[],intensity:null},"ENGM":{temp:2,conditions:[],intensity:null},"EFHK":{temp:1,conditions:[],intensity:null},"BIKF":{temp:-2,conditions:[],intensity:null},"ESGG":{temp:2,conditions:[],intensity:null},"ESMS":{temp:5,conditions:[],intensity:null},"ENBR":{temp:2,conditions:[],intensity:null},
  "ENZV":{temp:4,conditions:[],intensity:null},"ENTC":{temp:3,conditions:[],intensity:null},"EFOU":{temp:-2,conditions:[],intensity:null},"EFRO":{temp:-6,conditions:[],intensity:null},"LGAV":{temp:12,conditions:[],intensity:null},"LGTS":{temp:12,conditions:[],intensity:null},"LGIR":{temp:14,conditions:[],intensity:null},"LGKR":{temp:15,conditions:[],intensity:null},"LGRP":{temp:17,conditions:[],intensity:null},"LGSR":{temp:14,conditions:[],intensity:null},
