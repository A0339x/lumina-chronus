...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:-1,conditions:[],intensity:null},"KLAX":{temp:11,conditions:["fog"],intensity:null},"KORD":{temp:-16,conditions:["snow"],intensity:null},"KDFW":{temp:-11,conditions:[],intensity:null},"KDEN":{temp:-13,conditions:[],intensity:null},"KJFK":{temp:-10,conditions:[],intensity:null},"KSFO":{temp:7,conditions:[],intensity:null},"KSEA":{temp:-2,conditions:[],intensity:null},"KLAS":{temp:4,conditions:[],intensity:null},"KMCO":{temp:17,conditions:[],intensity:null},
  "KEWR":{temp:-11,conditions:["snow"],intensity:null},"KMIA":{temp:22,conditions:[],intensity:null},"KPHX":{temp:9,conditions:[],intensity:null},"KIAH":{temp:1,conditions:[],intensity:null},"KBOS":{temp:-15,conditions:[],intensity:null},"KMSP":{temp:-24,conditions:[],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:-12,conditions:["snow"],intensity:null},"KPHL":{temp:-10,conditions:["snow"],intensity:null},"KLGA":{temp:-9,conditions:[],intensity:null},
  "KBWI":{temp:-9,conditions:["snow"],intensity:null},"KSLC":{temp:-7,conditions:[],intensity:null},"KDCA":{temp:-9,conditions:["snow"],intensity:null},"KIAD":{temp:-10,conditions:["snow"],intensity:null},"KSAN":{temp:11,conditions:["fog"],intensity:null},"KTPA":{temp:19,conditions:[],intensity:null},"KPDX":{temp:-4,conditions:[],intensity:null},"KSTL":{temp:-14,conditions:["snow"],intensity:null},"KHNL":{temp:22,conditions:["fog"],intensity:null},"KMEM":{temp:-7,conditions:["freezing"],intensity:null},
  "KAUS":{temp:-6,conditions:[],intensity:null},"KBNA":{temp:-1,conditions:["freezing"],intensity:null},"KRDU":{temp:-8,conditions:["snow"],intensity:null},"KCLT":{temp:-7,conditions:[],intensity:null},"KSMF":{temp:3,conditions:[],intensity:null},"KSJC":{temp:4,conditions:[],intensity:null},"KOAK":{temp:5,conditions:[],intensity:null},"KCLE":{temp:-11,conditions:["snow"],intensity:null},"KMKE":{temp:-16,conditions:[],intensity:null},"KPIT":{temp:-11,conditions:["snow"],intensity:null},
  "KIND":{temp:-13,conditions:["snow"],intensity:null},"KCVG":{temp:-11,conditions:["snow"],intensity:null},"KMCI":{temp:-18,conditions:[],intensity:null},"KSAT":{temp:-4,conditions:[],intensity:null},"KHOU":{temp:1,conditions:["rain"],intensity:null},"KDAL":{temp:-10,conditions:[],intensity:null},"KMDW":{temp:-14,conditions:[],intensity:null},"PANC":{temp:-5,conditions:[],intensity:null},"PAFA":{temp:-16,conditions:[],intensity:null},"CYYZ":{temp:-12,conditions:[],intensity:null},
  "CYVR":{temp:-3,conditions:[],intensity:null},"CYUL":{temp:-22,conditions:[],intensity:null},"CYYC":{temp:-20,conditions:[],intensity:null},"CYEG":{temp:-21,conditions:[],intensity:null},"CYOW":{temp:-28,conditions:[],intensity:null},"CYWG":{temp:-36,conditions:[],intensity:null},"CYHZ":{temp:-19,conditions:[],intensity:null},"CYQB":{temp:-29,conditions:[],intensity:null},"CYYJ":{temp:0,conditions:[],intensity:null},"CYLW":{temp:-9,conditions:[],intensity:null},
  "CYXE":{temp:-41,conditions:[],intensity:null},"CYQR":{temp:-36,conditions:[],intensity:null},"CYZF":{temp:-18,conditions:[],intensity:null},"CYXY":{temp:-11,conditions:[],intensity:null},"CYQT":{temp:-27,conditions:[],intensity:null},"CYYT":{temp:-12,conditions:[],intensity:null},"MMMX":{temp:11,conditions:[],intensity:null},"MMUN":{temp:22,conditions:[],intensity:null},"MMGL":{temp:12,conditions:[],intensity:null},"MMMY":{temp:7,conditions:[],intensity:null},
  "MMTJ":{temp:8,conditions:[],intensity:null},"MMSM":{temp:26,conditions:[],intensity:null},"MMMD":{temp:21,conditions:[],intensity:null},"MMCZ":{temp:26,conditions:[],intensity:null},"MMSD":{temp:13,conditions:[],intensity:null},"MGGT":{temp:14,conditions:[],intensity:null},"MSLP":{temp:21,conditions:[],intensity:null},"MHTG":{temp:17,conditions:[],intensity:null},"MNMG":{temp:23,conditions:[],intensity:null},"MROC":{temp:18,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:21,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:21,conditions:[],intensity:null},"SBGL":{temp:25,conditions:[],intensity:null},"SBBR":{temp:21,conditions:[],intensity:null},"SBCF":{temp:22,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null},
  "SBPA":{temp:24,conditions:[],intensity:null},"SBCT":{temp:18,conditions:[],intensity:null},"SBFZ":{temp:28,conditions:[],intensity:null},"SCEL":{temp:15,conditions:[],intensity:null},"SAEZ":{temp:26,conditions:[],intensity:null},"SABE":{temp:24,conditions:[],intensity:null},"SACO":{temp:22,conditions:[],intensity:null},"SAME":{temp:21,conditions:[],intensity:null},"SLLP":{temp:5,conditions:["fog"],intensity:null},"SLVR":{temp:24,conditions:[],intensity:null},
  "SPJC":{temp:22,conditions:[],intensity:null},"SEQM":{temp:10,conditions:["fog"],intensity:null},"SEGU":{temp:23,conditions:[],intensity:null},"SKBO":{temp:11,conditions:["fog"],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:22,conditions:[],intensity:null},"SKRG":{temp:13,conditions:["fog"],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:22,conditions:[],intensity:null},
  "SGAS":{temp:26,conditions:[],intensity:null},"SBBV":{temp:26,conditions:[],intensity:null},"SMJP":{temp:25,conditions:[],intensity:null},"SYCJ":{temp:24,conditions:["fog"],intensity:null},"EGLL":{temp:8,conditions:[],intensity:null},"EGKK":{temp:8,conditions:[],intensity:null},"EGSS":{temp:5,conditions:[],intensity:null},"EGLC":{temp:7,conditions:[],intensity:null},"EGCC":{temp:7,conditions:[],intensity:null},"EGBB":{temp:7,conditions:[],intensity:null},
  ...
  "EIDW":{temp:8,conditions:[],intensity:null},"EICK":{temp:4,conditions:["fog"],intensity:null},"EINN":{temp:5,conditions:[],intensity:null},"LFPG":{temp:6,conditions:[],intensity:null},"LFPO":{temp:7,conditions:[],intensity:null},"LFML":{temp:9,conditions:[],intensity:null},"LFLL":{temp:6,conditions:[],intensity:null},"LFMN":{temp:11,conditions:[],intensity:null},"LFBD":{temp:9,conditions:[],intensity:null},"LFBO":{temp:9,conditions:[],intensity:null},
  "LFRS":{temp:7,conditions:[],intensity:null},"LFSB":{temp:4,conditions:[],intensity:null},"LFPB":{temp:7,conditions:[],intensity:null},"EDDF":{temp:0,conditions:[],intensity:null},"EDDM":{temp:-2,conditions:[],intensity:null},"EDDB":{temp:-2,conditions:[],intensity:null},"EDDL":{temp:3,conditions:[],intensity:null},"EDDH":{temp:-1,conditions:[],intensity:null},"EDDK":{temp:2,conditions:[],intensity:null},"EDDS":{temp:-1,conditions:[],intensity:null},
  "EDDW":{temp:0,conditions:[],intensity:null},"EDDN":{temp:0,conditions:[],intensity:null},"EDDV":{temp:-1,conditions:[],intensity:null},"EDDP":{temp:-1,conditions:[],intensity:null},"LEMD":{temp:9,conditions:[],intensity:null},"LEBL":{temp:12,conditions:[],intensity:null},"LEPA":{temp:15,conditions:[],intensity:null},"LEMG":{temp:14,conditions:[],intensity:null},"LEVC":{temp:15,conditions:[],intensity:null},"LEAL":{temp:15,conditions:[],intensity:null},
  "LEZL":{temp:13,conditions:[],intensity:null},"GCLP":{temp:18,conditions:[],intensity:null},"GCTS":{temp:17,conditions:[],intensity:null},"GCLA":{temp:18,conditions:[],intensity:null},"GCFV":{temp:18,conditions:[],intensity:null},"LPPT":{temp:14,conditions:[],intensity:null},"LPPR":{temp:13,conditions:[],intensity:null},"LPFR":{temp:15,conditions:[],intensity:null},"LPMA":{temp:17,conditions:[],intensity:null},"LIRF":{temp:11,conditions:[],intensity:null},
  "LIMC":{temp:5,conditions:[],intensity:null},"LIME":{temp:6,conditions:[],intensity:null},"LIPZ":{temp:8,conditions:[],intensity:null},"LIRN":{temp:11,conditions:[],intensity:null},"LIML":{temp:6,conditions:[],intensity:null},"LIPE":{temp:7,conditions:[],intensity:null},"LICC":{temp:15,conditions:[],intensity:null},"LICJ":{temp:12,conditions:[],intensity:null},"LIRA":{temp:11,conditions:[],intensity:null},"LIRP":{temp:10,conditions:[],intensity:null},
  "LIMF":{temp:6,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:12,conditions:[],intensity:null},"EHAM":{temp:2,conditions:[],intensity:null},"EHRD":{temp:2,conditions:[],intensity:null},"EHEH":{temp:3,conditions:[],intensity:null},"EBBR":{temp:6,conditions:[],intensity:null},"EBCI":{temp:5,conditions:[],intensity:null},"ELLX":{temp:0,conditions:[],intensity:null},"LSZH":{temp:4,conditions:[],intensity:null},
  "LSGG":{temp:4,conditions:[],intensity:null},"LSZB":{temp:4,conditions:[],intensity:null},"LOWW":{temp:2,conditions:[],intensity:null},"LOWS":{temp:-3,conditions:["fog"],intensity:null},"LOWG":{temp:0,conditions:["freezing"],intensity:null},"LOWI":{temp:6,conditions:[],intensity:null},"LKPR":{temp:0,conditions:[],intensity:null},"EPWA":{temp:-5,conditions:[],intensity:null},"EPKK":{temp:1,conditions:["fog"],intensity:null},"EPGD":{temp:-6,conditions:[],intensity:null},
  "EPWR":{temp:0,conditions:[],intensity:null},"EPPO":{temp:-3,conditions:[],intensity:null},"EKCH":{temp:1,conditions:[],intensity:null},"ESSA":{temp:-3,conditions:[],intensity:null},"ENGM":{temp:-5,conditions:[],intensity:null},"EFHK":{temp:-8,conditions:[],intensity:null},"BIKF":{temp:3,conditions:[],intensity:null},"ESGG":{temp:-3,conditions:[],intensity:null},"ESMS":{temp:0,conditions:[],intensity:null},"ENBR":{temp:-2,conditions:[],intensity:null},
  "ENZV":{temp:0,conditions:[],intensity:null},"ENTC":{temp:-2,conditions:[],intensity:null},"EFOU":{temp:-9,conditions:[],intensity:null},"EFRO":{temp:-13,conditions:["snow"],intensity:null},"LGAV":{temp:16,conditions:[],intensity:null},"LGTS":{temp:12,conditions:[],intensity:null},"LGIR":{temp:18,conditions:[],intensity:null},"LGKR":{temp:17,conditions:[],intensity:null},"LGRP":{temp:18,conditions:[],intensity:null},"LGSR":{temp:18,conditions:[],intensity:null},
  "LGMK":{temp:17,conditions:[],intensity:null},"LTFM":{temp:15,conditions:[],intensity:null},"LTBA":{temp:14,conditions:[],intensity:null},"LTFJ":{temp:15,conditions:[],intensity:null},"LTAI":{temp:14,conditions:[],intensity:null},"LTAC":{temp:9,conditions:[],intensity:null},"LTBJ":{temp:16,conditions:[],intensity:null},"LTBS":{temp:16,conditions:[],intensity:null},"LTFE":{temp:17,conditions:[],intensity:null},"LCLK":{temp:17,conditions:[],intensity:null},
  "LCPH":{temp:18,conditions:[],intensity:null},"LHBP":{temp:2,conditions:[],intensity:null},"LROP":{temp:1,conditions:["fog"],intensity:null},"LBSF":{temp:3,conditions:[],intensity:null},"LYBE":{temp:10,conditions:[],intensity:null},"LDZA":{temp:5,conditions:[],intensity:null},"LDDU":{temp:15,conditions:[],intensity:null},"LDSP":{temp:14,conditions:[],intensity:null},"LJLJ":{temp:3,conditions:["rain"],intensity:null},"LWSK":{temp:8,conditions:[],intensity:null},
  "LATI":{temp:17,conditions:[],intensity:null},"UKBB":{temp:-9,conditions:[],intensity:null},"UKLL":{temp:0,conditions:[],intensity:null},"UUEE":{temp:-18,conditions:[],intensity:null},"UUDD":{temp:-21,conditions:[],intensity:null},"UUWW":{temp:-20,conditions:[],intensity:null},"ULLI":{temp:-12,conditions:[],intensity:null},"UWWW":{temp:-22,conditions:[],intensity:null},"USSS":{temp:-18,conditions:[],intensity:null},"UNNT":{temp:-25,conditions:[],intensity:null},
  "UUOB":{temp:-21,conditions:[],intensity:null},"UHWW":{temp:-13,conditions:[],intensity:null},"UEEE":{temp:-31,conditions:[],intensity:null},"OMDB":{temp:23,conditions:[],intensity:null},"OMDW":{temp:24,conditions:[],intensity:null},"OMAA":{temp:24,conditions:[],intensity:null},"OMSJ":{temp:24,conditions:[],intensity:null},"OTHH":{temp:24,conditions:[],intensity:null},"OERK":{temp:16,conditions:[],intensity:null},"OEJN":{temp:30,conditions:[],intensity:null},
  "OEDF":{temp:20,conditions:[],intensity:null},"OEMA":{temp:22,conditions:[],intensity:null},"OKBK":{temp:16,conditions:[],intensity:null},"OBBI":{temp:20,conditions:[],intensity:null},"OOMS":{temp:28,conditions:[],intensity:null},"OYAA":{temp:21,conditions:[],intensity:null},"OIIE":{temp:9,conditions:[],intensity:null},"OIII":{temp:8,conditions:[],intensity:null},"OISS":{temp:1,conditions:["snow"],intensity:null},"OIKB":{temp:16,conditions:[],intensity:null},
  "OIAW":{temp:15,conditions:[],intensity:null},"OIKK":{temp:4,conditions:[],intensity:null},"OICC":{temp:8,conditions:[],intensity:null},"LLBG":{temp:21,conditions:[],intensity:null},"OLBA":{temp:18,conditions:[],intensity:null},"OJAM":{temp:14,conditions:[],intensity:null},"ORBI":{temp:16,conditions:[],intensity:null},"ORER":{temp:12,conditions:[],intensity:null},"GMMN":{temp:14,conditions:[],intensity:null},"GMME":{temp:14,conditions:[],intensity:null},
  "GMMX":{temp:12,conditions:[],intensity:null},"GMTT":{temp:14,conditions:[],intensity:null},"GMFF":{temp:12,conditions:[],intensity:null},"GMAD":{temp:14,conditions:[],intensity:null},"DAAG":{temp:14,conditions:[],intensity:null},"DAOO":{temp:12,conditions:[],intensity:null},"DTTA":{temp:13,conditions:[],intensity:null},"DTMB":{temp:14,conditions:[],intensity:null},"DTTJ":{temp:14,conditions:[],intensity:null},"HECA":{temp:23,conditions:[],intensity:null},
  "HEGN":{temp:22,conditions:[],intensity:null},"HESH":{temp:22,conditions:[],intensity:null},"HEBA":{temp:24,conditions:[],intensity:null},"HEAX":{temp:21,conditions:[],intensity:null},"HLLT":{temp:16,conditions:[],intensity:null},"DNMM":{temp:32,conditions:[],intensity:null},"DNAA":{temp:36,conditions:[],intensity:null},"DGAA":{temp:32,conditions:[],intensity:null},"DIAP":{temp:32,conditions:[],intensity:null},"GOBD":{temp:24,conditions:[],intensity:null},
  "GABS":{temp:27,conditions:[],intensity:null},"GVNP":{temp:23,conditions:[],intensity:null},"GBYD":{temp:29,conditions:[],intensity:null},"GLRB":{temp:31,conditions:[],intensity:null},"DXXX":{temp:33,conditions:[],intensity:null},"DBBB":{temp:34,conditions:[],intensity:null},"HKJK":{temp:29,conditions:[],intensity:null},"HKMO":{temp:34,conditions:[],intensity:null},"HTDA":{temp:33,conditions:[],intensity:null},"HTKJ":{temp:33,conditions:[],intensity:null},
  "HUEN":{temp:29,conditions:[],intensity:null},"HRYR":{temp:29,conditions:[],intensity:null},"HAAB":{temp:24,conditions:[],intensity:null},"HDAM":{temp:28,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:25,conditions:[],intensity:null},"FMEE":{temp:29,conditions:[],intensity:null},"FIMP":{temp:29,conditions:[],intensity:null},"FMCH":{temp:28,conditions:[],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:30,conditions:[],intensity:null},"FKYS":{temp:28,conditions:[],intensity:null},"FOOL":{temp:28,conditions:[],intensity:null},"FZAA":{temp:33,conditions:[],intensity:null},"FCBB":{temp:30,conditions:[],intensity:null},"FLLK":{temp:27,conditions:[],intensity:null},"FVHA":{temp:26,conditions:[],intensity:null},"FLLS":{temp:28,conditions:[],intensity:null},"FYWH":{temp:29,conditions:[],intensity:null},
  "FBSK":{temp:30,conditions:[],intensity:null},"FAOR":{temp:27,conditions:[],intensity:null},"FACT":{temp:26,conditions:[],intensity:null},"FALE":{temp:29,conditions:[],intensity:null},"FAPE":{temp:28,conditions:[],intensity:null},"FQMA":{temp:32,conditions:[],intensity:null},"FWKI":{temp:26,conditions:[],intensity:null},"ZBAA":{temp:-2,conditions:[],intensity:null},"ZBAD":{temp:-2,conditions:[],intensity:null},"ZSPD":{temp:9,conditions:[],intensity:null},
  "ZSSS":{temp:9,conditions:[],intensity:null},"ZGGG":{temp:17,conditions:[],intensity:null},"VHHH":{temp:20,conditions:[],intensity:null},"ZGSZ":{temp:19,conditions:[],intensity:null},"ZUUU":{temp:9,conditions:[],intensity:null},"ZUCK":{temp:8,conditions:[],intensity:null},"ZHCC":{temp:1,conditions:[],intensity:null},"ZLXY":{temp:3,conditions:[],intensity:null},"ZWSH":{temp:-12,conditions:[],intensity:null},"ZYHB":{temp:-20,conditions:[],intensity:null},
  "ZYTX":{temp:-13,conditions:[],intensity:null},"ZSAM":{temp:17,conditions:[],intensity:null},"ZGKL":{temp:10,conditions:[],intensity:null},"ZSNJ":{temp:8,conditions:[],intensity:null},"ZSHC":{temp:11,conditions:[],intensity:null},"ZPPP":{temp:13,conditions:[],intensity:null},"ZBTJ":{temp:-4,conditions:[],intensity:null},"VMMC":{temp:18,conditions:[],intensity:null},"RJTT":{temp:3,conditions:[],intensity:null},"RJAA":{temp:1,conditions:[],intensity:null},
  "RJBB":{temp:4,conditions:[],intensity:null},"RJOO":{temp:1,conditions:[],intensity:null},"RJCC":{temp:-8,conditions:[],intensity:null},"RJFF":{temp:2,conditions:[],intensity:null},"RJGG":{temp:3,conditions:[],intensity:null},"ROAH":{temp:17,conditions:[],intensity:null},"RJSS":{temp:-2,conditions:[],intensity:null},"RJSN":{temp:0,conditions:["snow"],intensity:null},"RJOK":{temp:3,conditions:[],intensity:null},"RKSI":{temp:-3,conditions:[],intensity:null},
  "RKSS":{temp:-7,conditions:[],intensity:null},"RKPK":{temp:-1,conditions:[],intensity:null},"RKPC":{temp:2,conditions:[],intensity:null},"RKTN":{temp:-6,conditions:[],intensity:null},"ZKPY":{temp:-10,conditions:[],intensity:null},"WSSS":{temp:27,conditions:[],intensity:null},"WMKK":{temp:29,conditions:[],intensity:null},"WMKP":{temp:28,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:26,conditions:[],intensity:null},
  "VTBS":{temp:31,conditions:[],intensity:null},"VTBD":{temp:30,conditions:[],intensity:null},"VTSP":{temp:30,conditions:[],intensity:null},"VTCC":{temp:26,conditions:[],intensity:null},"VTSS":{temp:27,conditions:[],intensity:null},"VTUK":{temp:27,conditions:[],intensity:null},"VVNB":{temp:18,conditions:[],intensity:null},"VVTS":{temp:28,conditions:[],intensity:null},"VVDN":{temp:19,conditions:[],intensity:null},"VVCR":{temp:23,conditions:[],intensity:null},
  "VDPP":{temp:28,conditions:[],intensity:null},"VDSR":{temp:27,conditions:[],intensity:null},"VLVT":{temp:24,conditions:[],intensity:null},"VLLB":{temp:24,conditions:[],intensity:null},"VYYY":{temp:29,conditions:[],intensity:null},"VYMD":{temp:26,conditions:[],intensity:null},"VGHS":{temp:24,conditions:[],intensity:null},"VGCG":{temp:22,conditions:[],intensity:null},"VECC":{temp:25,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  "VCBI":{temp:27,conditions:[],intensity:null},"WIII":{temp:28,conditions:[],intensity:null},"WADD":{temp:29,conditions:[],intensity:null},"WARR":{temp:29,conditions:[],intensity:null},"WIHH":{temp:28,conditions:[],intensity:null},"WIMM":{temp:28,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:23,conditions:[],intensity:null},"WASS":{temp:27,conditions:[],intensity:null},
  "RPLL":{temp:26,conditions:[],intensity:null},"RPLC":{temp:23,conditions:[],intensity:null},"RPVM":{temp:25,conditions:[],intensity:null},"RPVD":{temp:24,conditions:[],intensity:null},"RPVK":{temp:22,conditions:[],intensity:null},"WBSB":{temp:26,conditions:[],intensity:null},"WBLL":{temp:28,conditions:[],intensity:null},"VIDP":{temp:16,conditions:[],intensity:null},"VABB":{temp:24,conditions:[],intensity:null},"VOBL":{temp:25,conditions:[],intensity:null},
  "VOMM":{temp:25,conditions:[],intensity:null},"VEBS":{temp:25,conditions:[],intensity:null},"VOHY":{temp:28,conditions:[],intensity:null},"VAAH":{temp:26,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:29,conditions:[],intensity:null},"VOTP":{temp:27,conditions:[],intensity:null},"VIAR":{temp:18,conditions:[],intensity:null},"VIJP":{temp:18,conditions:[],intensity:null},"VELR":{temp:16,conditions:[],intensity:null},
  "VOCL":{temp:29,conditions:[],intensity:null},"VOTV":{temp:27,conditions:[],intensity:null},"VEPT":{temp:23,conditions:[],intensity:null},"VNKT":{temp:17,conditions:[],intensity:null},"OPKC":{temp:21,conditions:[],intensity:null},"OPLA":{temp:18,conditions:[],intensity:null},"OPIS":{temp:15,conditions:[],intensity:null},"RCTP":{temp:18,conditions:[],intensity:null},"RCSS":{temp:19,conditions:[],intensity:null},"RCMQ":{temp:17,conditions:[],intensity:null},
  "RCKH":{temp:21,conditions:[],intensity:null},"RCNN":{temp:19,conditions:[],intensity:null},"YSSY":{temp:24,conditions:[],intensity:null},"YMML":{temp:16,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:22,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:24,conditions:[],intensity:null},"YBCS":{temp:24,conditions:[],intensity:null},"YSCB":{temp:30,conditions:[],intensity:null},
  "YMHB":{temp:15,conditions:[],intensity:null},"NZAA":{temp:18,conditions:[],intensity:null},"NZWN":{temp:16,conditions:[],intensity:null},"NZCH":{temp:14,conditions:[],intensity:null},"NZQN":{temp:13,conditions:[],intensity:null},"NZDN":{temp:12,conditions:[],intensity:null},"NFFN":{temp:26,conditions:[],intensity:null},"NWWW":{temp:27,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:29,conditions:["thunderstorm"],intensity:null},
  "NIUE":{temp:28,conditions:["thunderstorm"],intensity:null},"PGSN":{temp:26,conditions:[],intensity:null},"PGUM":{temp:27,conditions:["thunderstorm"],intensity:null},"PHOG":{temp:24,conditions:[],intensity:null},"PHKO":{temp:27,conditions:[],intensity:null},"PHLH":{temp:18,conditions:[],intensity:null}
};
