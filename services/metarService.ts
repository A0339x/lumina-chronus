...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:-5,conditions:[],intensity:null},"KLAX":{temp:26,conditions:[],intensity:null},"KORD":{temp:-4,conditions:[],intensity:null},"KDFW":{temp:-3,conditions:[],intensity:null},"KDEN":{temp:12,conditions:[],intensity:null},"KJFK":{temp:-6,conditions:[],intensity:null},"KSFO":{temp:14,conditions:[],intensity:null},"KSEA":{temp:13,conditions:[],intensity:null},"KLAS":{temp:18,conditions:[],intensity:null},"KMCO":{temp:12,conditions:[],intensity:null},
  ...
  "KBWI":{temp:-6,conditions:[],intensity:null},"KSLC":{temp:7,conditions:[],intensity:null},"KDCA":{temp:-5,conditions:[],intensity:null},"KIAD":{temp:-7,conditions:[],intensity:null},"KSAN":{temp:24,conditions:[],intensity:null},"KTPA":{temp:11,conditions:[],intensity:null},"KPDX":{temp:13,conditions:[],intensity:null},"KSTL":{temp:-8,conditions:[],intensity:null},"KHNL":{temp:24,conditions:[],intensity:null},"KMEM":{temp:-5,conditions:[],intensity:null},
  "KAUS":{temp:5,conditions:[],intensity:null},"KBNA":{temp:-6,conditions:[],intensity:null},"KRDU":{temp:-6,conditions:[],intensity:null},"KCLT":{temp:-7,conditions:["snow"],intensity:null},"KSMF":{temp:9,conditions:[],intensity:null},"KSJC":{temp:14,conditions:[],intensity:null},"KOAK":{temp:14,conditions:[],intensity:null},"KCLE":{temp:-11,conditions:[],intensity:null},"KMKE":{temp:-4,conditions:[],intensity:null},"KPIT":{temp:-10,conditions:[],intensity:null},
  "KIND":{temp:-7,conditions:[],intensity:null},"KCVG":{temp:-9,conditions:[],intensity:null},"KMCI":{temp:-8,conditions:[],intensity:null},"KSAT":{temp:9,conditions:[],intensity:null},"KHOU":{temp:7,conditions:[],intensity:null},"KDAL":{temp:-2,conditions:[],intensity:null},"KMDW":{temp:-4,conditions:["snow"],intensity:null},"PANC":{temp:1,conditions:[],intensity:null},"PAFA":{temp:-13,conditions:[],intensity:null},"CYYZ":{temp:-11,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:29,conditions:[],intensity:null},"TIST":{temp:27,conditions:[],intensity:null},"TLPL":{temp:28,conditions:[],intensity:null},"TAPA":{temp:27,conditions:[],intensity:null},"SBGR":{temp:27,conditions:[],intensity:null},"SBGL":{temp:30,conditions:[],intensity:null},"SBBR":{temp:26,conditions:[],intensity:null},"SBCF":{temp:25,conditions:[],intensity:null},"SBSV":{temp:30,conditions:[],intensity:null},"SBRF":{temp:30,conditions:[],intensity:null},
  "SBPA":{temp:26,conditions:[],intensity:null},"SBCT":{temp:27,conditions:[],intensity:null},"SBFZ":{temp:30,conditions:[],intensity:null},"SCEL":{temp:26,conditions:[],intensity:null},"SAEZ":{temp:31,conditions:[],intensity:null},"SABE":{temp:29,conditions:[],intensity:null},"SACO":{temp:29,conditions:[],intensity:null},"SAME":{temp:23,conditions:[],intensity:null},"SLLP":{temp:16,conditions:[],intensity:null},"SLVR":{temp:32,conditions:[],intensity:null},
  ...
  "EDDW":{temp:-1,conditions:[],intensity:null},"EDDN":{temp:2,conditions:[],intensity:null},"EDDV":{temp:-1,conditions:[],intensity:null},"EDDP":{temp:-3,conditions:[],intensity:null},"LEMD":{temp:8,conditions:[],intensity:null},"LEBL":{temp:12,conditions:[],intensity:null},"LEPA":{temp:13,conditions:[],intensity:null},"LEMG":{temp:14,conditions:[],intensity:null},"LEVC":{temp:13,conditions:[],intensity:null},"LEAL":{temp:15,conditions:[],intensity:null},
  "LEZL":{temp:12,conditions:[],intensity:null},"GCLP":{temp:19,conditions:[],intensity:null},"GCTS":{temp:19,conditions:[],intensity:null},"GCLA":{temp:18,conditions:[],intensity:null},"GCFV":{temp:18,conditions:[],intensity:null},"LPPT":{temp:13,conditions:[],intensity:null},"LPPR":{temp:12,conditions:[],intensity:null},"LPFR":{temp:14,conditions:[],intensity:null},"LPMA":{temp:16,conditions:[],intensity:null},"LIRF":{temp:11,conditions:[],intensity:null},
  ...
  "LIMF":{temp:4,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:11,conditions:[],intensity:null},"EHAM":{temp:7,conditions:[],intensity:null},"EHRD":{temp:6,conditions:[],intensity:null},"EHEH":{temp:7,conditions:[],intensity:null},"EBBR":{temp:8,conditions:[],intensity:null},"EBCI":{temp:6,conditions:[],intensity:null},"ELLX":{temp:4,conditions:[],intensity:null},"LSZH":{temp:2,conditions:[],intensity:null},
  "LSGG":{temp:3,conditions:[],intensity:null},"LSZB":{temp:1,conditions:[],intensity:null},"LOWW":{temp:0,conditions:[],intensity:null},"LOWS":{temp:0,conditions:[],intensity:null},"LOWG":{temp:1,conditions:[],intensity:null},"LOWI":{temp:1,conditions:[],intensity:null},"LKPR":{temp:-2,conditions:[],intensity:null},"EPWA":{temp:-11,conditions:[],intensity:null},"EPKK":{temp:-8,conditions:[],intensity:null},"EPGD":{temp:-11,conditions:[],intensity:null},
  "EPWR":{temp:-7,conditions:[],intensity:null},"EPPO":{temp:-9,conditions:[],intensity:null},"EKCH":{temp:-2,conditions:[],intensity:null},"ESSA":{temp:-5,conditions:[],intensity:null},"ENGM":{temp:-8,conditions:[],intensity:null},"EFHK":{temp:-18,conditions:[],intensity:null},"BIKF":{temp:1,conditions:[],intensity:null},"ESGG":{temp:-4,conditions:[],intensity:null},"ESMS":{temp:-4,conditions:[],intensity:null},"ENBR":{temp:-1,conditions:[],intensity:null},
  ...
  "LCPH":{temp:16,conditions:[],intensity:null},"LHBP":{temp:1,conditions:[],intensity:null},"LROP":{temp:-1,conditions:[],intensity:null},"LBSF":{temp:4,conditions:[],intensity:null},"LYBE":{temp:4,conditions:[],intensity:null},"LDZA":{temp:4,conditions:[],intensity:null},"LDDU":{temp:8,conditions:[],intensity:null},"LDSP":{temp:8,conditions:[],intensity:null},"LJLJ":{temp:4,conditions:[],intensity:null},"LWSK":{temp:5,conditions:["fog"],intensity:null},
  "LATI":{temp:7,conditions:[],intensity:null},"UKBB":{temp:-13,conditions:[],intensity:null},"UKLL":{temp:-12,conditions:[],intensity:null},"UUEE":{temp:-20,conditions:[],intensity:null},"UUDD":{temp:-19,conditions:[],intensity:null},"UUWW":{temp:-19,conditions:[],intensity:null},"ULLI":{temp:-20,conditions:[],intensity:null},"UWWW":{temp:-7,conditions:[],intensity:null},"USSS":{temp:-14,conditions:[],intensity:null},"UNNT":{temp:-11,conditions:[],intensity:null},
  ...
  "FSIA":{temp:27,conditions:[],intensity:null},"FKKD":{temp:28,conditions:[],intensity:null},"FKYS":{temp:24,conditions:[],intensity:null},"FOOL":{temp:26,conditions:[],intensity:null},"FZAA":{temp:27,conditions:[],intensity:null},"FCBB":{temp:25,conditions:[],intensity:null},"FLLK":{temp:21,conditions:[],intensity:null},"FVHA":{temp:21,conditions:[],intensity:null},"FLLS":{temp:21,conditions:[],intensity:null},"FYWH":{temp:23,conditions:[],intensity:null},
  ...
  "YMHB":{temp:14,conditions:[],intensity:null},"NZAA":{temp:19,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:15,conditions:[],intensity:null},"NZQN":{temp:9,conditions:[],intensity:null},"NZDN":{temp:11,conditions:[],intensity:null},"NFFN":{temp:27,conditions:[],intensity:null},"NWWW":{temp:28,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
  "NIUE":{temp:27,conditions:["rain"],intensity:null},"PGSN":{temp:26,conditions:[],intensity:null},"PGUM":{temp:27,conditions:[],intensity:null},"PHOG":{temp:25,conditions:[],intensity:null},"PHKO":{temp:27,conditions:[],intensity:null},"PHLH":{temp:20,conditions:[],intensity:null}
};
