...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KBWI":{temp:-2,condition:null,intensity:null},"KSLC":{temp:2,condition:null,intensity:null},"KDCA":{temp:-1,condition:null,intensity:null},"KIAD":{temp:-2,condition:null,intensity:null},"KSAN":{temp:17,condition:null,intensity:null},"KTPA":{temp:16,condition:null,intensity:null},"KPDX":{temp:4,condition:null,intensity:null},"KSTL":{temp:1,condition:null,intensity:null},"KHNL":{temp:23,condition:null,intensity:null},"KMEM":{temp:11,condition:null,intensity:null},
  "KAUS":{temp:14,condition:null,intensity:null},"KBNA":{temp:6,condition:null,intensity:null},"KRDU":{temp:10,condition:null,intensity:null},"KCLT":{temp:11,condition:null,intensity:null},"KSMF":{temp:8,condition:null,intensity:null},"KSJC":{temp:11,condition:null,intensity:null},"KOAK":{temp:11,condition:null,intensity:null},"KCLE":{temp:-10,condition:null,intensity:null},"KMKE":{temp:-11,condition:null,intensity:null},"KPIT":{temp:-9,condition:null,intensity:null},
  "KIND":{temp:-4,condition:null,intensity:null},"KCVG":{temp:-3,condition:null,intensity:null},"KMCI":{temp:0,condition:null,intensity:null},"KSAT":{temp:16,condition:null,intensity:null},"KHOU":{temp:17,condition:null,intensity:null},"KDAL":{temp:12,condition:null,intensity:null},"KMDW":{temp:-9,condition:null,intensity:null},"PANC":{temp:-10,condition:null,intensity:null},"PAFA":{temp:-36,condition:null,intensity:null},"CYYZ":{temp:-10,condition:null,intensity:null},
  "CYVR":{temp:4,condition:"fog",intensity:null},"CYUL":{temp:-13,condition:null,intensity:null},"CYYC":{temp:-2,condition:null,intensity:null},"CYEG":{temp:-8,condition:"snow",intensity:"light"},"CYOW":{temp:-15,condition:null,intensity:null},"CYWG":{temp:-19,condition:null,intensity:null},"CYHZ":{temp:1,condition:null,intensity:null},"CYQB":{temp:-8,condition:null,intensity:null},"CYYJ":{temp:4,condition:null,intensity:null},"CYLW":{temp:-3,condition:null,intensity:null},
  "CYXE":{temp:-21,condition:null,intensity:null},"CYQR":{temp:-15,condition:null,intensity:null},"CYZF":{temp:-34,condition:null,intensity:null},"CYXY":{temp:-24,condition:null,intensity:null},"CYQT":{temp:-19,condition:null,intensity:null},"CYYT":{temp:2,condition:null,intensity:null},"MMMX":{temp:15,condition:null,intensity:null},"MMUN":{temp:24,condition:null,intensity:null},"MMGL":{temp:19,condition:null,intensity:null},"MMMY":{temp:18,condition:null,intensity:null},
  "MMTJ":{temp:17,condition:null,intensity:null},"MMSM":{temp:28,condition:null,intensity:null},"MMMD":{temp:23,condition:null,intensity:null},"MMCZ":{temp:22,condition:null,intensity:null},"MMSD":{temp:26,condition:null,intensity:null},"MGGT":{temp:17,condition:null,intensity:null},"MSLP":{temp:30,condition:null,intensity:null},"MHTG":{temp:23,condition:null,intensity:null},"MNMG":{temp:28,condition:null,intensity:null},"MROC":{temp:27,condition:null,intensity:null},
  "MPTO":{temp:29,condition:null,intensity:null},"MKJP":{temp:30,condition:null,intensity:null},"TNCM":{temp:26,condition:null,intensity:null},"TBPB":{temp:28,condition:null,intensity:null},"TTPP":{temp:31,condition:null,intensity:null},"MWCR":{temp:23,condition:null,intensity:null},"MUHA":{temp:21,condition:null,intensity:null},"MDSD":{temp:26,condition:null,intensity:null},"MDPP":{temp:26,condition:"thunderstorm",intensity:null},"MTPP":{temp:28,condition:null,intensity:null},
  "TJSJ":{temp:28,condition:null,intensity:null},"TIST":{temp:27,condition:null,intensity:null},"TLPL":{temp:29,condition:null,intensity:null},"TAPA":{temp:27,condition:null,intensity:null},"SBGR":{temp:31,condition:null,intensity:null},"SBGL":{temp:39,condition:null,intensity:null},"SBBR":{temp:29,condition:null,intensity:null},"SBCF":{temp:31,condition:null,intensity:null},"SBSV":{temp:29,condition:null,intensity:null},"SBRF":{temp:32,condition:null,intensity:null},
  "SBPA":{temp:33,condition:null,intensity:null},"SBCT":{temp:26,condition:"thunderstorm",intensity:null},"SBFZ":{temp:32,condition:null,intensity:null},"SCEL":{temp:29,condition:null,intensity:null},"SAEZ":{temp:30,condition:null,intensity:null},"SABE":{temp:29,condition:null,intensity:null},"SACO":{temp:34,condition:null,intensity:null},"SAME":{temp:32,condition:null,intensity:null},"SLLP":{temp:15,condition:null,intensity:null},"SLVR":{temp:30,condition:null,intensity:null},
  "SPJC":{temp:19,condition:null,intensity:null},"SEQM":{temp:17,condition:null,intensity:null},"SEGU":{temp:30,condition:null,intensity:null},"SKBO":{temp:18,condition:null,intensity:null},"SKMR":{temp:31,condition:null,intensity:null},"SKCL":{temp:25,condition:null,intensity:null},"SKMD":{temp:28,condition:null,intensity:null},"SKRG":{temp:20,condition:null,intensity:null},"SVMI":{temp:27,condition:null,intensity:null},"SUMU":{temp:27,condition:null,intensity:null},
  "SGAS":{temp:31,condition:null,intensity:null},"SBBV":{temp:32,condition:null,intensity:null},"SMJP":{temp:31,condition:null,intensity:null},"SYCJ":{temp:29,condition:null,intensity:null},"EGLL":{temp:5,condition:null,intensity:null},"EGKK":{temp:5,condition:null,intensity:null},"EGSS":{temp:5,condition:null,intensity:null},"EGLC":{temp:6,condition:null,intensity:null},"EGCC":{temp:5,condition:null,intensity:null},"EGBB":{temp:5,condition:null,intensity:null},
  "EGPH":{temp:3,condition:null,intensity:null},"EGPF":{temp:4,condition:null,intensity:null},"EGGW":{temp:4,condition:null,intensity:null},"EGNX":{temp:5,condition:null,intensity:null},"EGNT":{temp:3,condition:null,intensity:null},"EGGP":{temp:6,condition:null,intensity:null},"EGHI":{temp:6,condition:null,intensity:null},"EGGD":{temp:5,condition:null,intensity:null},"EGPD":{temp:1,condition:null,intensity:null},"EGAA":{temp:4,condition:null,intensity:null},
  "EIDW":{temp:5,condition:null,intensity:null},"EICK":{temp:5,condition:null,intensity:null},"EINN":{temp:6,condition:null,intensity:null},"LFPG":{temp:4,condition:null,intensity:null},"LFPO":{temp:3,condition:null,intensity:null},"LFML":{temp:9,condition:null,intensity:null},"LFLL":{temp:1,condition:null,intensity:null},"LFMN":{temp:11,condition:null,intensity:null},"LFBD":{temp:3,condition:null,intensity:null},"LFBO":{temp:4,condition:null,intensity:null},
  "LFRS":{temp:2,condition:null,intensity:null},"LFSB":{temp:0,condition:null,intensity:null},"LFPB":{temp:4,condition:null,intensity:null},"EDDF":{temp:2,condition:null,intensity:null},"EDDM":{temp:0,condition:null,intensity:null},"EDDB":{temp:2,condition:null,intensity:null},"EDDL":{temp:3,condition:null,intensity:null},"EDDH":{temp:3,condition:null,intensity:null},"EDDK":{temp:3,condition:null,intensity:null},"EDDS":{temp:1,condition:null,intensity:null},
  "EDDW":{temp:3,condition:null,intensity:null},"EDDN":{temp:0,condition:"snow",intensity:"light"},"EDDV":{temp:2,condition:null,intensity:null},"EDDP":{temp:2,condition:null,intensity:null},"LEMD":{temp:6,condition:null,intensity:null},"LEBL":{temp:11,condition:null,intensity:null},"LEPA":{temp:13,condition:null,intensity:null},"LEMG":{temp:15,condition:null,intensity:null},"LEVC":{temp:13,condition:null,intensity:null},"LEAL":{temp:13,condition:null,intensity:null},
  ...
  "LIMC":{temp:3,condition:null,intensity:null},"LIME":{temp:3,condition:null,intensity:null},"LIPZ":{temp:4,condition:null,intensity:null},"LIRN":{temp:9,condition:null,intensity:null},"LIML":{temp:4,condition:null,intensity:null},"LIPE":{temp:5,condition:null,intensity:null},"LICC":{temp:12,condition:null,intensity:null},"LICJ":{temp:13,condition:null,intensity:null},"LIRA":{temp:9,condition:null,intensity:null},"LIRP":{temp:5,condition:null,intensity:null},
  "LIMF":{temp:3,condition:null,intensity:null},"LIEO":{temp:11,condition:null,intensity:null},"LIEE":{temp:13,condition:null,intensity:null},"EHAM":{temp:5,condition:null,intensity:null},"EHRD":{temp:6,condition:null,intensity:null},"EHEH":{temp:4,condition:null,intensity:null},"EBBR":{temp:4,condition:null,intensity:null},"EBCI":{temp:3,condition:null,intensity:null},"ELLX":{temp:0,condition:null,intensity:null},"LSZH":{temp:0,condition:null,intensity:null},
  "LSGG":{temp:3,condition:null,intensity:null},"LSZB":{temp:2,condition:null,intensity:null},"LOWW":{temp:2,condition:null,intensity:null},"LOWS":{temp:-3,condition:null,intensity:null},"LOWG":{temp:-3,condition:null,intensity:null},"LOWI":{temp:-1,condition:null,intensity:null},"LKPR":{temp:0,condition:null,intensity:null},"EPWA":{temp:1,condition:null,intensity:null},"EPKK":{temp:0,condition:null,intensity:null},"EPGD":{temp:0,condition:"snow",intensity:"light"},
  ...
  "ENZV":{temp:3,condition:null,intensity:null},"ENTC":{temp:-14,condition:null,intensity:null},"EFOU":{temp:-19,condition:null,intensity:null},"EFRO":{temp:-17,condition:null,intensity:null},"LGAV":{temp:4,condition:null,intensity:null},"LGTS":{temp:3,condition:null,intensity:null},"LGIR":{temp:8,condition:null,intensity:null},"LGKR":{temp:8,condition:null,intensity:null},"LGRP":{temp:7,condition:null,intensity:null},"LGSR":{temp:8,condition:null,intensity:null},
  "LGMK":{temp:7,condition:null,intensity:null},"LTFM":{temp:-1,condition:null,intensity:null},"LTBA":{temp:0,condition:null,intensity:null},"LTFJ":{temp:0,condition:null,intensity:null},"LTAI":{temp:6,condition:null,intensity:null},"LTAC":{temp:-6,condition:null,intensity:null},"LTBJ":{temp:1,condition:null,intensity:null},"LTBS":{temp:8,condition:null,intensity:null},"LTFE":{temp:4,condition:null,intensity:null},"LCLK":{temp:12,condition:null,intensity:null},
  "LCPH":{temp:12,condition:null,intensity:null},"LHBP":{temp:1,condition:null,intensity:null},"LROP":{temp:-2,condition:null,intensity:null},"LBSF":{temp:-2,condition:null,intensity:null},"LYBE":{temp:2,condition:null,intensity:null},"LDZA":{temp:5,condition:null,intensity:null},"LDDU":{temp:5,condition:null,intensity:null},"LDSP":{temp:7,condition:null,intensity:null},"LJLJ":{temp:1,condition:null,intensity:null},"LWSK":{temp:0,condition:null,intensity:null},
  "LATI":{temp:3,condition:null,intensity:null},"UKBB":{temp:-13,condition:null,intensity:null},"UKLL":{temp:-3,condition:null,intensity:null},"UUEE":{temp:-14,condition:null,intensity:null},"UUDD":{temp:-13,condition:null,intensity:null},"UUWW":{temp:-13,condition:null,intensity:null},"ULLI":{temp:-11,condition:null,intensity:null},"UWWW":{temp:-12,condition:null,intensity:null},"USSS":{temp:-12,condition:null,intensity:null},"UNNT":{temp:-11,condition:null,intensity:null},
  "UUOB":{temp:-28,condition:null,intensity:null},"UHWW":{temp:-14,condition:null,intensity:null},"UEEE":{temp:-24,condition:"snow",intensity:"light"},"OMDB":{temp:21,condition:null,intensity:null},"OMDW":{temp:18,condition:null,intensity:null},"OMAA":{temp:20,condition:null,intensity:null},"OMSJ":{temp:19,condition:null,intensity:null},"OTHH":{temp:16,condition:null,intensity:null},"OERK":{temp:19,condition:null,intensity:null},"OEJN":{temp:25,condition:null,intensity:null},
  "OEDF":{temp:17,condition:null,intensity:null},"OEMA":{temp:20,condition:null,intensity:null},"OKBK":{temp:15,condition:null,intensity:null},"OBBI":{temp:20,condition:null,intensity:null},"OOMS":{temp:21,condition:null,intensity:null},"OYAA":{temp:14,condition:null,intensity:null},"OIIE":{temp:5,condition:null,intensity:null},"OIII":{temp:4,condition:null,intensity:null},"OISS":{temp:7,condition:null,intensity:null},"OIKB":{temp:18,condition:null,intensity:null},
  "OIAW":{temp:13,condition:null,intensity:null},"OIKK":{temp:7,condition:null,intensity:null},"OICC":{temp:5,condition:null,intensity:null},"LLBG":{temp:15,condition:null,intensity:null},"OLBA":{temp:15,condition:null,intensity:null},"OJAM":{temp:11,condition:null,intensity:null},"ORBI":{temp:13,condition:null,intensity:null},"ORER":{temp:6,condition:null,intensity:null},"GMMN":{temp:22,condition:null,intensity:null},"GMME":{temp:22,condition:null,intensity:null},
  "GMMX":{temp:22,condition:null,intensity:null},"GMTT":{temp:17,condition:null,intensity:null},"GMFF":{temp:17,condition:null,intensity:null},"GMAD":{temp:25,condition:null,intensity:null},"DAAG":{temp:15,condition:null,intensity:null},"DAOO":{temp:17,condition:null,intensity:null},"DTTA":{temp:16,condition:null,intensity:null},"DTMB":{temp:15,condition:null,intensity:null},"DTTJ":{temp:15,condition:null,intensity:null},"HECA":{temp:17,condition:null,intensity:null},
  "HEGN":{temp:20,condition:null,intensity:null},"HESH":{temp:19,condition:null,intensity:null},"HEBA":{temp:20,condition:null,intensity:null},"HEAX":{temp:15,condition:null,intensity:null},"HLLT":{temp:15,condition:null,intensity:null},"DNMM":{temp:31,condition:null,intensity:null},"DNAA":{temp:35,condition:null,intensity:null},"DGAA":{temp:29,condition:null,intensity:null},"DIAP":{temp:29,condition:null,intensity:null},"GOBD":{temp:31,condition:null,intensity:null},
  "GABS":{temp:34,condition:null,intensity:null},"GVNP":{temp:27,condition:null,intensity:null},"GBYD":{temp:28,condition:null,intensity:null},"GLRB":{temp:27,condition:"thunderstorm",intensity:null},"DXXX":{temp:31,condition:null,intensity:null},"DBBB":{temp:31,condition:null,intensity:null},"HKJK":{temp:20,condition:null,intensity:null},"HKMO":{temp:28,condition:null,intensity:null},"HTDA":{temp:28,condition:null,intensity:null},"HTKJ":{temp:25,condition:null,intensity:null},
  "HUEN":{temp:23,condition:null,intensity:null},"HRYR":{temp:25,condition:null,intensity:null},"HAAB":{temp:17,condition:null,intensity:null},"HDAM":{temp:24,condition:null,intensity:null},"HCMM":{temp:26,condition:null,intensity:null},"OYSN":{temp:22,condition:null,intensity:null},"FMEE":{temp:25,condition:null,intensity:null},"FIMP":{temp:21,condition:null,intensity:null},"FMCH":{temp:29,condition:null,intensity:null},"FMMI":{temp:21,condition:null,intensity:null},
  "FSIA":{temp:27,condition:null,intensity:null},"FKKD":{temp:28,condition:null,intensity:null},"FKYS":{temp:27,condition:null,intensity:null},"FOOL":{temp:27,condition:null,intensity:null},"FZAA":{temp:27,condition:null,intensity:null},"FCBB":{temp:26,condition:null,intensity:null},"FLLK":{temp:24,condition:null,intensity:null},"FVHA":{temp:25,condition:null,intensity:null},"FLLS":{temp:24,condition:null,intensity:null},"FYWH":{temp:27,condition:null,intensity:null},
  "FBSK":{temp:29,condition:null,intensity:null},"FAOR":{temp:22,condition:null,intensity:null},"FACT":{temp:24,condition:null,intensity:null},"FALE":{temp:22,condition:null,intensity:null},"FAPE":{temp:23,condition:null,intensity:null},"FQMA":{temp:26,condition:null,intensity:null},"FWKI":{temp:20,condition:null,intensity:null},"ZBAA":{temp:-7,condition:null,intensity:null},"ZBAD":{temp:-7,condition:null,intensity:null},"ZSPD":{temp:4,condition:null,intensity:null},
  "ZSSS":{temp:2,condition:null,intensity:null},"ZGGG":{temp:12,condition:null,intensity:null},"VHHH":{temp:16,condition:null,intensity:null},"ZGSZ":{temp:15,condition:null,intensity:null},"ZUUU":{temp:6,condition:null,intensity:null},"ZUCK":{temp:8,condition:null,intensity:null},"ZHCC":{temp:-1,condition:null,intensity:null},"ZLXY":{temp:-1,condition:null,intensity:null},"ZWSH":{temp:-12,condition:null,intensity:null},"ZYHB":{temp:-22,condition:null,intensity:null},
  "ZYTX":{temp:-16,condition:null,intensity:null},"ZSAM":{temp:12,condition:null,intensity:null},"ZGKL":{temp:5,condition:null,intensity:null},"ZSNJ":{temp:0,condition:null,intensity:null},"ZSHC":{temp:4,condition:null,intensity:null},"ZPPP":{temp:7,condition:null,intensity:null},"ZBTJ":{temp:-6,condition:null,intensity:null},"VMMC":{temp:15,condition:null,intensity:null},"RJTT":{temp:5,condition:null,intensity:null},"RJAA":{temp:3,condition:null,intensity:null},
  "RJBB":{temp:7,condition:null,intensity:null},"RJOO":{temp:2,condition:null,intensity:null},"RJCC":{temp:-11,condition:null,intensity:null},"RJFF":{temp:3,condition:null,intensity:null},"RJGG":{temp:5,condition:null,intensity:null},"ROAH":{temp:18,condition:null,intensity:null},"RJSS":{temp:0,condition:null,intensity:null},"RJSN":{temp:2,condition:null,intensity:null},"RJOK":{temp:3,condition:null,intensity:null},"RKSI":{temp:-8,condition:null,intensity:null},
  "RKSS":{temp:-12,condition:null,intensity:null},"RKPK":{temp:-5,condition:null,intensity:null},"RKPC":{temp:3,condition:null,intensity:null},"RKTN":{temp:-8,condition:null,intensity:null},"ZKPY":{temp:-14,condition:null,intensity:null},"WSSS":{temp:26,condition:null,intensity:null},"WMKK":{temp:26,condition:"thunderstorm",intensity:null},"WMKP":{temp:28,condition:null,intensity:null},"WBKK":{temp:28,condition:"thunderstorm",intensity:null},"WBGG":{temp:23,condition:"fog",intensity:null},
  ...
  "VDPP":{temp:25,condition:null,intensity:null},"VDSR":{temp:23,condition:null,intensity:null},"VLVT":{temp:20,condition:null,intensity:null},"VLLB":{temp:18,condition:null,intensity:null},"VYYY":{temp:22,condition:null,intensity:null},"VYMD":{temp:20,condition:null,intensity:null},"VGHS":{temp:15,condition:null,intensity:null},"VGCG":{temp:19,condition:null,intensity:null},"VECC":{temp:16,condition:null,intensity:null},"VRMM":{temp:27,condition:null,intensity:null},
  "VCBI":{temp:26,condition:"thunderstorm",intensity:null},"WIII":{temp:25,condition:null,intensity:null},"WADD":{temp:29,condition:null,intensity:null},"WARR":{temp:27,condition:null,intensity:null},"WIHH":{temp:27,condition:null,intensity:null},"WIMM":{temp:26,condition:"thunderstorm",intensity:null},"WIBB":{temp:27,condition:null,intensity:null},"WAFF":{temp:27,condition:null,intensity:null},"WICC":{temp:22,condition:null,intensity:null},"WASS":{temp:28,condition:null,intensity:null},
  "RPLL":{temp:27,condition:null,intensity:null},"RPLC":{temp:24,condition:null,intensity:null},"RPVM":{temp:25,condition:"fog",intensity:null},"RPVD":{temp:25,condition:"thunderstorm",intensity:null},"RPVK":{temp:23,condition:"fog",intensity:null},"WBSB":{temp:25,condition:"thunderstorm",intensity:null},"WBLL":{temp:27,condition:"thunderstorm",intensity:null},"VIDP":{temp:13,condition:null,intensity:null},"VABB":{temp:25,condition:null,intensity:null},"VOBL":{temp:20,condition:null,intensity:null},
  "VOMM":{temp:24,condition:null,intensity:null},"VEBS":{temp:16,condition:null,intensity:null},"VOHY":{temp:20,condition:null,intensity:null},"VAAH":{temp:21,condition:null,intensity:null},"VOCI":{temp:28,condition:null,intensity:null},"VAGO":{temp:25,condition:null,intensity:null},"VOTP":{temp:23,condition:null,intensity:null},"VIAR":{temp:12,condition:"fog",intensity:null},"VIJP":{temp:15,condition:null,intensity:null},"VELR":{temp:10,condition:null,intensity:null},
  ...
  "RCKH":{temp:18,condition:null,intensity:null},"RCNN":{temp:16,condition:null,intensity:null},"YSSY":{temp:15,condition:null,intensity:null},"YMML":{temp:14,condition:null,intensity:null},"YBBN":{temp:23,condition:null,intensity:null},"YPPH":{temp:27,condition:null,intensity:null},"YPAD":{temp:19,condition:null,intensity:null},"YBCG":{temp:19,condition:"fog",intensity:null},"YBCS":{temp:23,condition:"fog",intensity:null},"YSCB":{temp:12,condition:null,intensity:null},
  "YMHB":{temp:14,condition:null,intensity:null},"NZAA":{temp:19,condition:null,intensity:null},"NZWN":{temp:17,condition:null,intensity:null},"NZCH":{temp:14,condition:null,intensity:null},"NZQN":{temp:14,condition:null,intensity:null},"NZDN":{temp:12,condition:null,intensity:null},"NFFN":{temp:26,condition:null,intensity:null},"NWWW":{temp:26,condition:null,intensity:null},"NTAA":{temp:27,condition:null,intensity:null},"NSFA":{temp:28,condition:null,intensity:null},
