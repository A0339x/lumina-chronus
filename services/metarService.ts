...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:15,conditions:[],intensity:null},"KLAX":{temp:16,conditions:[],intensity:null},"KORD":{temp:0,conditions:[],intensity:null},"KDFW":{temp:17,conditions:[],intensity:null},"KDEN":{temp:13,conditions:[],intensity:null},"KJFK":{temp:1,conditions:[],intensity:null},"KSFO":{temp:12,conditions:[],intensity:null},"KSEA":{temp:9,conditions:[],intensity:null},"KLAS":{temp:25,conditions:[],intensity:null},"KMCO":{temp:19,conditions:[],intensity:null},
  "KEWR":{temp:1,conditions:[],intensity:null},"KMIA":{temp:21,conditions:[],intensity:null},"KPHX":{temp:26,conditions:[],intensity:null},"KIAH":{temp:18,conditions:[],intensity:null},"KBOS":{temp:0,conditions:[],intensity:null},"KMSP":{temp:1,conditions:[],intensity:null},"KFLL":{temp:21,conditions:[],intensity:null},"KDTW":{temp:-3,conditions:[],intensity:null},"KPHL":{temp:4,conditions:[],intensity:null},"KLGA":{temp:1,conditions:[],intensity:null},
  "KBWI":{temp:3,conditions:[],intensity:null},"KSLC":{temp:15,conditions:[],intensity:null},"KDCA":{temp:6,conditions:[],intensity:null},"KIAD":{temp:4,conditions:[],intensity:null},"KSAN":{temp:16,conditions:[],intensity:null},"KTPA":{temp:17,conditions:[],intensity:null},"KPDX":{temp:12,conditions:[],intensity:null},"KSTL":{temp:8,conditions:[],intensity:null},"KHNL":{temp:24,conditions:[],intensity:null},"KMEM":{temp:14,conditions:[],intensity:null},
  "KAUS":{temp:17,conditions:[],intensity:null},"KBNA":{temp:10,conditions:[],intensity:null},"KRDU":{temp:10,conditions:[],intensity:null},"KCLT":{temp:12,conditions:[],intensity:null},"KSMF":{temp:17,conditions:[],intensity:null},"KSJC":{temp:14,conditions:[],intensity:null},"KOAK":{temp:12,conditions:[],intensity:null},"KCLE":{temp:-2,conditions:[],intensity:null},"KMKE":{temp:-1,conditions:[],intensity:null},"KPIT":{temp:-1,conditions:[],intensity:null},
  "KIND":{temp:3,conditions:[],intensity:null},"KCVG":{temp:3,conditions:[],intensity:null},"KMCI":{temp:12,conditions:[],intensity:null},"KSAT":{temp:19,conditions:[],intensity:null},"KHOU":{temp:19,conditions:[],intensity:null},"KDAL":{temp:16,conditions:[],intensity:null},"KMDW":{temp:0,conditions:[],intensity:null},"PANC":{temp:5,conditions:[],intensity:null},"PAFA":{temp:5,conditions:[],intensity:null},"CYYZ":{temp:-5,conditions:[],intensity:null},
  "CYVR":{temp:7,conditions:[],intensity:null},"CYUL":{temp:-5,conditions:[],intensity:null},"CYYC":{temp:-1,conditions:[],intensity:null},"CYEG":{temp:-1,conditions:[],intensity:null},"CYOW":{temp:-6,conditions:[],intensity:null},"CYWG":{temp:-2,conditions:[],intensity:null},"CYHZ":{temp:1,conditions:["snow"],intensity:null},"CYQB":{temp:-8,conditions:[],intensity:null},"CYYJ":{temp:7,conditions:[],intensity:null},"CYLW":{temp:7,conditions:[],intensity:null},
  "CYXE":{temp:-5,conditions:["snow"],intensity:null},"CYQR":{temp:2,conditions:[],intensity:null},"CYZF":{temp:-6,conditions:[],intensity:null},"CYXY":{temp:-1,conditions:[],intensity:null},"CYQT":{temp:-5,conditions:[],intensity:null},"CYYT":{temp:-3,conditions:[],intensity:null},"MMMX":{temp:17,conditions:[],intensity:null},"MMUN":{temp:22,conditions:[],intensity:null},"MMGL":{temp:22,conditions:[],intensity:null},"MMMY":{temp:19,conditions:[],intensity:null},
  "MMTJ":{temp:15,conditions:[],intensity:null},"MMSM":{temp:27,conditions:[],intensity:null},"MMMD":{temp:23,conditions:[],intensity:null},"MMCZ":{temp:25,conditions:[],intensity:null},"MMSD":{temp:25,conditions:[],intensity:null},"MGGT":{temp:18,conditions:[],intensity:null},"MSLP":{temp:27,conditions:[],intensity:null},"MHTG":{temp:23,conditions:[],intensity:null},"MNMG":{temp:29,conditions:[],intensity:null},"MROC":{temp:23,conditions:[],intensity:null},
  "MPTO":{temp:26,conditions:[],intensity:null},"MKJP":{temp:25,conditions:[],intensity:null},"TNCM":{temp:27,conditions:[],intensity:null},"TBPB":{temp:27,conditions:[],intensity:null},"TTPP":{temp:27,conditions:[],intensity:null},"MWCR":{temp:27,conditions:[],intensity:null},"MUHA":{temp:23,conditions:[],intensity:null},"MDSD":{temp:26,conditions:["thunderstorm"],intensity:null},"MDPP":{temp:26,conditions:[],intensity:null},"MTPP":{temp:26,conditions:[],intensity:null},
  "TJSJ":{temp:25,conditions:[],intensity:null},"TIST":{temp:27,conditions:[],intensity:null},"TLPL":{temp:27,conditions:[],intensity:null},"TAPA":{temp:26,conditions:[],intensity:null},"SBGR":{temp:22,conditions:[],intensity:null},"SBGL":{temp:26,conditions:[],intensity:null},"SBBR":{temp:21,conditions:[],intensity:null},"SBCF":{temp:20,conditions:[],intensity:null},"SBSV":{temp:25,conditions:[],intensity:null},"SBRF":{temp:24,conditions:[],intensity:null}
};
