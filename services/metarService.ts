...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EPWR":{temp:15,conditions:[],intensity:null},"EPPO":{temp:14,conditions:[],intensity:null},"EKCH":{temp:6,conditions:[],intensity:null},"ESSA":{temp:4,conditions:[],intensity:null},"ENGM":{temp:0,conditions:[],intensity:null},"EFHK":{temp:4,conditions:[],intensity:null},"BIKF":{temp:-1,conditions:[],intensity:null},"ESGG":{temp:6,conditions:[],intensity:null},"ESMS":{temp:7,conditions:[],intensity:null},"ENBR":{temp:5,conditions:[],intensity:null},
  "ENZV":{temp:6,conditions:[],intensity:null},"ENTC":{temp:3,conditions:[],intensity:null},"EFOU":{temp:-1,conditions:[],intensity:null},"EFRO":{temp:-4,conditions:[],intensity:null},"LGAV":{temp:11,conditions:[],intensity:null},"LGTS":{temp:13,conditions:[],intensity:null},"LGIR":{temp:13,conditions:[],intensity:null},"LGKR":{temp:16,conditions:[],intensity:null},"LGRP":{temp:15,conditions:[],intensity:null},"LGSR":{temp:13,conditions:[],intensity:null},
