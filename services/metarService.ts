...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KEWR":{temp:2,conditions:[],intensity:null},"KMIA":{temp:25,conditions:[],intensity:null},"KPHX":{temp:21,conditions:[],intensity:null},"KIAH":{temp:18,conditions:[],intensity:null},"KBOS":{temp:2,conditions:[],intensity:null},"KMSP":{temp:-4,conditions:[],intensity:null},"KFLL":{temp:24,conditions:[],intensity:null},"KDTW":{temp:-1,conditions:[],intensity:null},"KPHL":{temp:2,conditions:[],intensity:null},"KLGA":{temp:3,conditions:[],intensity:null},
  "KBWI":{temp:2,conditions:[],intensity:null},"KSLC":{temp:5,conditions:[],intensity:null},"KDCA":{temp:3,conditions:[],intensity:null},"KIAD":{temp:1,conditions:[],intensity:null},"KSAN":{temp:22,conditions:[],intensity:null},"KTPA":{temp:20,conditions:[],intensity:null},"KPDX":{temp:11,conditions:[],intensity:null},"KSTL":{temp:2,conditions:[],intensity:null},"KHNL":{temp:27,conditions:[],intensity:null},"KMEM":{temp:6,conditions:[],intensity:null},
  "KAUS":{temp:17,conditions:[],intensity:null},"KBNA":{temp:3,conditions:[],intensity:null},"KRDU":{temp:6,conditions:[],intensity:null},"KCLT":{temp:5,conditions:[],intensity:null},"KSMF":{temp:13,conditions:[],intensity:null},"KSJC":{temp:16,conditions:[],intensity:null},"KOAK":{temp:14,conditions:[],intensity:null},"KCLE":{temp:-2,conditions:[],intensity:null},"KMKE":{temp:-1,conditions:[],intensity:null},"KPIT":{temp:-2,conditions:[],intensity:null},
  "KIND":{temp:-2,conditions:[],intensity:null},"KCVG":{temp:-2,conditions:[],intensity:null},"KMCI":{temp:4,conditions:[],intensity:null},"KSAT":{temp:17,conditions:[],intensity:null},"KHOU":{temp:18,conditions:[],intensity:null},"KDAL":{temp:13,conditions:[],intensity:null},"KMDW":{temp:-1,conditions:[],intensity:null},"PANC":{temp:-9,conditions:[],intensity:null},"PAFA":{temp:-23,conditions:[],intensity:null},"CYYZ":{temp:-5,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:26,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:26,conditions:[],intensity:null},"SBGR":{temp:27,conditions:[],intensity:null},"SBGL":{temp:32,conditions:[],intensity:null},"SBBR":{temp:23,conditions:[],intensity:null},"SBCF":{temp:25,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:26,conditions:[],intensity:null},
  "SBPA":{temp:27,conditions:[],intensity:null},"SBCT":{temp:23,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:24,conditions:[],intensity:null},"SAEZ":{temp:28,conditions:[],intensity:null},"SABE":{temp:27,conditions:[],intensity:null},"SACO":{temp:27,conditions:[],intensity:null},"SAME":{temp:29,conditions:[],intensity:null},"SLLP":{temp:14,conditions:[],intensity:null},"SLVR":{temp:22,conditions:[],intensity:null},
  ...
  "LFRS":{temp:12,conditions:[],intensity:null},"LFSB":{temp:0,conditions:[],intensity:null},"LFPB":{temp:4,conditions:[],intensity:null},"EDDF":{temp:-1,conditions:[],intensity:null},"EDDM":{temp:-10,conditions:[],intensity:null},"EDDB":{temp:-11,conditions:[],intensity:null},"EDDL":{temp:-1,conditions:[],intensity:null},"EDDH":{temp:-8,conditions:[],intensity:null},"EDDK":{temp:-1,conditions:[],intensity:null},"EDDS":{temp:-2,conditions:[],intensity:null},
  ...
  "LEZL":{temp:8,conditions:[],intensity:null},"GCLP":{temp:17,conditions:[],intensity:null},"GCTS":{temp:15,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:15,conditions:[],intensity:null},"LPPT":{temp:13,conditions:[],intensity:null},"LPPR":{temp:13,conditions:[],intensity:null},"LPFR":{temp:9,conditions:[],intensity:null},"LPMA":{temp:13,conditions:[],intensity:null},"LIRF":{temp:6,conditions:[],intensity:null},
  ...
  "GMMX":{temp:8,conditions:["fog"],intensity:null},"GMTT":{temp:9,conditions:[],intensity:null},"GMFF":{temp:8,conditions:[],intensity:null},"GMAD":{temp:9,conditions:[],intensity:null},"DAAG":{temp:9,conditions:[],intensity:null},"DAOO":{temp:8,conditions:[],intensity:null},"DTTA":{temp:11,conditions:[],intensity:null},"DTMB":{temp:10,conditions:[],intensity:null},"DTTJ":{temp:14,conditions:[],intensity:null},"HECA":{temp:13,conditions:[],intensity:null},
  ...
  "ZYTX":{temp:-8,conditions:[],intensity:null},"ZSAM":{temp:8,conditions:[],intensity:null},"ZGKL":{temp:8,conditions:[],intensity:null},"ZSNJ":{temp:1,conditions:[],intensity:null},"ZSHC":{temp:2,conditions:[],intensity:null},"ZPPP":{temp:6,conditions:[],intensity:null},"ZBTJ":{temp:-6,conditions:[],intensity:null},"VMMC":{temp:14,conditions:[],intensity:null},"RJTT":{temp:2,conditions:[],intensity:null},"RJAA":{temp:1,conditions:[],intensity:null},
  ...
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:16,conditions:[],intensity:null},"YSSY":{temp:19,conditions:[],intensity:null},"YMML":{temp:15,conditions:[],intensity:null},"YBBN":{temp:25,conditions:[],intensity:null},"YPPH":{temp:25,conditions:[],intensity:null},"YPAD":{temp:18,conditions:[],intensity:null},"YBCG":{temp:23,conditions:[],intensity:null},"YBCS":{temp:26,conditions:[],intensity:null},"YSCB":{temp:17,conditions:[],intensity:null},
  "YMHB":{temp:15,conditions:[],intensity:null},"NZAA":{temp:24,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:15,conditions:[],intensity:null},"NZQN":{temp:13,conditions:[],intensity:null},"NZDN":{temp:11,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:31,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
