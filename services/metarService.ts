...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:-1,conditions:["fog"],intensity:null},"KLAX":{temp:9,conditions:[],intensity:null},"KORD":{temp:-14,conditions:["snow"],intensity:null},"KDFW":{temp:-11,conditions:[],intensity:null},"KDEN":{temp:-14,conditions:[],intensity:null},"KJFK":{temp:-11,conditions:["snow"],intensity:null},"KSFO":{temp:7,conditions:[],intensity:null},"KSEA":{temp:-3,conditions:[],intensity:null},"KLAS":{temp:3,conditions:[],intensity:null},"KMCO":{temp:18,conditions:["fog"],intensity:null},
  "KEWR":{temp:-12,conditions:["snow"],intensity:null},"KMIA":{temp:22,conditions:[],intensity:null},"KPHX":{temp:8,conditions:[],intensity:null},"KIAH":{temp:0,conditions:[],intensity:null},"KBOS":{temp:-14,conditions:[],intensity:null},"KMSP":{temp:-24,conditions:[],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:-12,conditions:["snow"],intensity:null},"KPHL":{temp:-11,conditions:["snow"],intensity:null},"KLGA":{temp:-11,conditions:["snow"],intensity:null},
  "KBWI":{temp:-9,conditions:["snow"],intensity:null},"KSLC":{temp:-7,conditions:[],intensity:null},"KDCA":{temp:-8,conditions:["snow"],intensity:null},"KIAD":{temp:-10,conditions:["snow"],intensity:null},"KSAN":{temp:10,conditions:[],intensity:null},"KTPA":{temp:19,conditions:[],intensity:null},"KPDX":{temp:-4,conditions:["fog"],intensity:null},"KSTL":{temp:-14,conditions:["snow"],intensity:null},"KHNL":{temp:22,conditions:["fog"],intensity:null},"KMEM":{temp:-8,conditions:[],intensity:null},
  "KAUS":{temp:-6,conditions:[],intensity:null},"KBNA":{temp:0,conditions:["freezing"],intensity:null},"KRDU":{temp:-7,conditions:["snow"],intensity:null},"KCLT":{temp:-7,conditions:["snow"],intensity:null},"KSMF":{temp:4,conditions:[],intensity:null},"KSJC":{temp:4,conditions:[],intensity:null},"KOAK":{temp:5,conditions:[],intensity:null},"KCLE":{temp:-12,conditions:["snow"],intensity:null},"KMKE":{temp:-15,conditions:[],intensity:null},"KPIT":{temp:-11,conditions:["snow"],intensity:null},
  "KIND":{temp:-13,conditions:["snow"],intensity:null},"KCVG":{temp:-11,conditions:["snow"],intensity:null},"KMCI":{temp:-17,conditions:[],intensity:null},"KSAT":{temp:-4,conditions:[],intensity:null},"KHOU":{temp:1,conditions:[],intensity:null},"KDAL":{temp:-10,conditions:[],intensity:null},"KMDW":{temp:-13,conditions:["snow"],intensity:null},"PANC":{temp:-5,conditions:[],intensity:null},"PAFA":{temp:-16,conditions:[],intensity:null},"CYYZ":{temp:-11,conditions:[],intensity:null},
  "CYVR":{temp:-3,conditions:[],intensity:null},"CYUL":{temp:-24,conditions:[],intensity:null},"CYYC":{temp:-19,conditions:[],intensity:null},"CYEG":{temp:-20,conditions:[],intensity:null},"CYOW":{temp:-25,conditions:[],intensity:null},"CYWG":{temp:-35,conditions:[],intensity:null},"CYHZ":{temp:-19,conditions:[],intensity:null},"CYQB":{temp:-29,conditions:[],intensity:null},"CYYJ":{temp:0,conditions:[],intensity:null},"CYLW":{temp:-10,conditions:[],intensity:null},
  "CYXE":{temp:-39,conditions:[],intensity:null},"CYQR":{temp:-37,conditions:[],intensity:null},"CYZF":{temp:-18,conditions:[],intensity:null},"CYXY":{temp:-12,conditions:[],intensity:null},"CYQT":{temp:-28,conditions:[],intensity:null},"CYYT":{temp:-11,conditions:[],intensity:null},"MMMX":{temp:11,conditions:[],intensity:null},"MMUN":{temp:22,conditions:[],intensity:null},"MMGL":{temp:12,conditions:[],intensity:null},"MMMY":{temp:7,conditions:[],intensity:null},
  ...
  "SBPA":{temp:26,conditions:[],intensity:null},"SBCT":{temp:21,conditions:[],intensity:null},"SBFZ":{temp:29,conditions:[],intensity:null},"SCEL":{temp:17,conditions:[],intensity:null},"SAEZ":{temp:28,conditions:[],intensity:null},"SABE":{temp:26,conditions:[],intensity:null},"SACO":{temp:26,conditions:[],intensity:null},"SAME":{temp:23,conditions:[],intensity:null},"SLLP":{temp:8,conditions:[],intensity:null},"SLVR":{temp:27,conditions:[],intensity:null},
  "SPJC":{temp:22,conditions:[],intensity:null},"SEQM":{temp:11,conditions:["fog"],intensity:null},"SEGU":{temp:23,conditions:[],intensity:null},"SKBO":{temp:11,conditions:["fog"],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:22,conditions:[],intensity:null},"SKRG":{temp:14,conditions:["fog"],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:24,conditions:[],intensity:null},
  ...
  "EDDW":{temp:0,conditions:[],intensity:null},"EDDN":{temp:1,conditions:[],intensity:null},"EDDV":{temp:-1,conditions:[],intensity:null},"EDDP":{temp:0,conditions:[],intensity:null},"LEMD":{temp:11,conditions:[],intensity:null},"LEBL":{temp:14,conditions:[],intensity:null},"LEPA":{temp:15,conditions:[],intensity:null},"LEMG":{temp:15,conditions:[],intensity:null},"LEVC":{temp:17,conditions:[],intensity:null},"LEAL":{temp:17,conditions:[],intensity:null},
  "LEZL":{temp:14,conditions:[],intensity:null},"GCLP":{temp:19,conditions:[],intensity:null},"GCTS":{temp:18,conditions:[],intensity:null},"GCLA":{temp:19,conditions:[],intensity:null},"GCFV":{temp:19,conditions:[],intensity:null},"LPPT":{temp:14,conditions:[],intensity:null},"LPPR":{temp:14,conditions:[],intensity:null},"LPFR":{temp:15,conditions:[],intensity:null},"LPMA":{temp:17,conditions:[],intensity:null},"LIRF":{temp:12,conditions:[],intensity:null},
  "LIMC":{temp:6,conditions:[],intensity:null},"LIME":{temp:7,conditions:[],intensity:null},"LIPZ":{temp:8,conditions:[],intensity:null},"LIRN":{temp:12,conditions:[],intensity:null},"LIML":{temp:7,conditions:[],intensity:null},"LIPE":{temp:8,conditions:[],intensity:null},"LICC":{temp:15,conditions:[],intensity:null},"LICJ":{temp:13,conditions:[],intensity:null},"LIRA":{temp:12,conditions:[],intensity:null},"LIRP":{temp:11,conditions:[],intensity:null},
  "LIMF":{temp:7,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:12,conditions:[],intensity:null},"EHAM":{temp:3,conditions:[],intensity:null},"EHRD":{temp:3,conditions:[],intensity:null},"EHEH":{temp:4,conditions:[],intensity:null},"EBBR":{temp:7,conditions:[],intensity:null},"EBCI":{temp:6,conditions:[],intensity:null},"ELLX":{temp:1,conditions:[],intensity:null},"LSZH":{temp:5,conditions:[],intensity:null},
  "LSGG":{temp:5,conditions:[],intensity:null},"LSZB":{temp:4,conditions:[],intensity:null},"LOWW":{temp:3,conditions:[],intensity:null},"LOWS":{temp:-2,conditions:[],intensity:null},"LOWG":{temp:0,conditions:[],intensity:null},"LOWI":{temp:6,conditions:[],intensity:null},"LKPR":{temp:0,conditions:[],intensity:null},"EPWA":{temp:-4,conditions:[],intensity:null},"EPKK":{temp:1,conditions:["fog"],intensity:null},"EPGD":{temp:-5,conditions:[],intensity:null},
  "EPWR":{temp:0,conditions:[],intensity:null},"EPPO":{temp:-2,conditions:[],intensity:null},"EKCH":{temp:1,conditions:[],intensity:null},"ESSA":{temp:-3,conditions:[],intensity:null},"ENGM":{temp:-5,conditions:[],intensity:null},"EFHK":{temp:-8,conditions:[],intensity:null},"BIKF":{temp:4,conditions:[],intensity:null},"ESGG":{temp:-3,conditions:[],intensity:null},"ESMS":{temp:1,conditions:[],intensity:null},"ENBR":{temp:-1,conditions:[],intensity:null},
  "ENZV":{temp:0,conditions:[],intensity:null},"ENTC":{temp:-2,conditions:[],intensity:null},"EFOU":{temp:-8,conditions:[],intensity:null},"EFRO":{temp:-12,conditions:["snow"],intensity:null},"LGAV":{temp:16,conditions:[],intensity:null},"LGTS":{temp:13,conditions:[],intensity:null},"LGIR":{temp:18,conditions:[],intensity:null},"LGKR":{temp:17,conditions:[],intensity:null},"LGRP":{temp:18,conditions:[],intensity:null},"LGSR":{temp:18,conditions:[],intensity:null},
  "LGMK":{temp:17,conditions:[],intensity:null},"LTFM":{temp:15,conditions:[],intensity:null},"LTBA":{temp:14,conditions:[],intensity:null},"LTFJ":{temp:15,conditions:[],intensity:null},"LTAI":{temp:14,conditions:[],intensity:null},"LTAC":{temp:9,conditions:[],intensity:null},"LTBJ":{temp:16,conditions:[],intensity:null},"LTBS":{temp:17,conditions:[],intensity:null},"LTFE":{temp:18,conditions:[],intensity:null},"LCLK":{temp:17,conditions:[],intensity:null},
  "LCPH":{temp:17,conditions:[],intensity:null},"LHBP":{temp:3,conditions:[],intensity:null},"LROP":{temp:1,conditions:["fog"],intensity:null},"LBSF":{temp:5,conditions:[],intensity:null},"LYBE":{temp:12,conditions:[],intensity:null},"LDZA":{temp:5,conditions:[],intensity:null},"LDDU":{temp:15,conditions:[],intensity:null},"LDSP":{temp:14,conditions:[],intensity:null},"LJLJ":{temp:4,conditions:["rain"],intensity:null},"LWSK":{temp:10,conditions:[],intensity:null},
  "LATI":{temp:18,conditions:[],intensity:null},"UKBB":{temp:-9,conditions:[],intensity:null},"UKLL":{temp:1,conditions:[],intensity:null},"UUEE":{temp:-17,conditions:[],intensity:null},"UUDD":{temp:-19,conditions:[],intensity:null},"UUWW":{temp:-18,conditions:[],intensity:null},"ULLI":{temp:-13,conditions:[],intensity:null},"UWWW":{temp:-21,conditions:[],intensity:null},"USSS":{temp:-18,conditions:[],intensity:null},"UNNT":{temp:-26,conditions:[],intensity:null},
  "UUOB":{temp:-21,conditions:[],intensity:null},"UHWW":{temp:-13,conditions:[],intensity:null},"UEEE":{temp:-32,conditions:[],intensity:null},"OMDB":{temp:23,conditions:[],intensity:null},"OMDW":{temp:24,conditions:[],intensity:null},"OMAA":{temp:24,conditions:[],intensity:null},"OMSJ":{temp:24,conditions:[],intensity:null},"OTHH":{temp:23,conditions:[],intensity:null},"OERK":{temp:15,conditions:[],intensity:null},"OEJN":{temp:29,conditions:[],intensity:null},
  "OEDF":{temp:20,conditions:[],intensity:null},"OEMA":{temp:23,conditions:[],intensity:null},"OKBK":{temp:16,conditions:[],intensity:null},"OBBI":{temp:19,conditions:[],intensity:null},"OOMS":{temp:28,conditions:[],intensity:null},"OYAA":{temp:21,conditions:[],intensity:null},"OIIE":{temp:9,conditions:[],intensity:null},"OIII":{temp:8,conditions:[],intensity:null},"OISS":{temp:1,conditions:["snow"],intensity:null},"OIKB":{temp:15,conditions:[],intensity:null},
  "OIAW":{temp:15,conditions:[],intensity:null},"OIKK":{temp:4,conditions:[],intensity:null},"OICC":{temp:9,conditions:[],intensity:null},"LLBG":{temp:21,conditions:[],intensity:null},"OLBA":{temp:18,conditions:[],intensity:null},"OJAM":{temp:15,conditions:[],intensity:null},"ORBI":{temp:16,conditions:[],intensity:null},"ORER":{temp:12,conditions:[],intensity:null},"GMMN":{temp:15,conditions:[],intensity:null},"GMME":{temp:16,conditions:[],intensity:null},
  "GMMX":{temp:15,conditions:[],intensity:null},"GMTT":{temp:14,conditions:[],intensity:null},"GMFF":{temp:13,conditions:[],intensity:null},"GMAD":{temp:16,conditions:[],intensity:null},"DAAG":{temp:15,conditions:[],intensity:null},"DAOO":{temp:15,conditions:[],intensity:null},"DTTA":{temp:14,conditions:[],intensity:null},"DTMB":{temp:15,conditions:[],intensity:null},"DTTJ":{temp:15,conditions:[],intensity:null},"HECA":{temp:23,conditions:[],intensity:null},
  "HEGN":{temp:22,conditions:[],intensity:null},"HESH":{temp:22,conditions:[],intensity:null},"HEBA":{temp:25,conditions:[],intensity:null},"HEAX":{temp:21,conditions:[],intensity:null},"HLLT":{temp:16,conditions:[],intensity:null},"DNMM":{temp:34,conditions:[],intensity:null},"DNAA":{temp:37,conditions:[],intensity:null},"DGAA":{temp:33,conditions:[],intensity:null},"DIAP":{temp:33,conditions:[],intensity:null},"GOBD":{temp:26,conditions:[],intensity:null},
  "GABS":{temp:29,conditions:[],intensity:null},"GVNP":{temp:24,conditions:[],intensity:null},"GBYD":{temp:31,conditions:[],intensity:null},"GLRB":{temp:32,conditions:[],intensity:null},"DXXX":{temp:35,conditions:[],intensity:null},"DBBB":{temp:35,conditions:[],intensity:null},"HKJK":{temp:28,conditions:[],intensity:null},"HKMO":{temp:31,conditions:[],intensity:null},"HTDA":{temp:32,conditions:[],intensity:null},"HTKJ":{temp:33,conditions:[],intensity:null},
  "HUEN":{temp:27,conditions:["rain"],intensity:null},"HRYR":{temp:29,conditions:[],intensity:null},"HAAB":{temp:24,conditions:[],intensity:null},"HDAM":{temp:27,conditions:[],intensity:null},"HCMM":{temp:31,conditions:[],intensity:null},"OYSN":{temp:25,conditions:[],intensity:null},"FMEE":{temp:29,conditions:[],intensity:null},"FIMP":{temp:28,conditions:[],intensity:null},"FMCH":{temp:28,conditions:[],intensity:null},"FMMI":{temp:25,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:30,conditions:[],intensity:null},"FKYS":{temp:29,conditions:[],intensity:null},"FOOL":{temp:28,conditions:[],intensity:null},"FZAA":{temp:34,conditions:[],intensity:null},"FCBB":{temp:31,conditions:[],intensity:null},"FLLK":{temp:26,conditions:[],intensity:null},"FVHA":{temp:25,conditions:[],intensity:null},"FLLS":{temp:28,conditions:[],intensity:null},"FYWH":{temp:29,conditions:[],intensity:null},
  "FBSK":{temp:31,conditions:[],intensity:null},"FAOR":{temp:27,conditions:[],intensity:null},"FACT":{temp:26,conditions:[],intensity:null},"FALE":{temp:29,conditions:[],intensity:null},"FAPE":{temp:27,conditions:[],intensity:null},"FQMA":{temp:32,conditions:[],intensity:null},"FWKI":{temp:26,conditions:[],intensity:null},"ZBAA":{temp:-3,conditions:[],intensity:null},"ZBAD":{temp:-4,conditions:[],intensity:null},"ZSPD":{temp:9,conditions:[],intensity:null},
  "ZSSS":{temp:9,conditions:[],intensity:null},"ZGGG":{temp:15,conditions:[],intensity:null},"VHHH":{temp:20,conditions:[],intensity:null},"ZGSZ":{temp:19,conditions:[],intensity:null},"ZUUU":{temp:8,conditions:[],intensity:null},"ZUCK":{temp:7,conditions:[],intensity:null},"ZHCC":{temp:0,conditions:[],intensity:null},"ZLXY":{temp:2,conditions:[],intensity:null},"ZWSH":{temp:-14,conditions:[],intensity:null},"ZYHB":{temp:-21,conditions:[],intensity:null},
  "ZYTX":{temp:-14,conditions:[],intensity:null},"ZSAM":{temp:17,conditions:[],intensity:null},"ZGKL":{temp:10,conditions:[],intensity:null},"ZSNJ":{temp:7,conditions:[],intensity:null},"ZSHC":{temp:10,conditions:[],intensity:null},"ZPPP":{temp:11,conditions:[],intensity:null},"ZBTJ":{temp:-4,conditions:[],intensity:null},"VMMC":{temp:17,conditions:[],intensity:null},"RJTT":{temp:2,conditions:[],intensity:null},"RJAA":{temp:0,conditions:[],intensity:null},
  "RJBB":{temp:4,conditions:[],intensity:null},"RJOO":{temp:1,conditions:[],intensity:null},"RJCC":{temp:-8,conditions:[],intensity:null},"RJFF":{temp:2,conditions:[],intensity:null},"RJGG":{temp:3,conditions:[],intensity:null},"ROAH":{temp:17,conditions:[],intensity:null},"RJSS":{temp:-2,conditions:[],intensity:null},"RJSN":{temp:0,conditions:["snow"],intensity:null},"RJOK":{temp:2,conditions:[],intensity:null},"RKSI":{temp:-4,conditions:[],intensity:null},
  "RKSS":{temp:-8,conditions:[],intensity:null},"RKPK":{temp:-3,conditions:[],intensity:null},"RKPC":{temp:2,conditions:[],intensity:null},"RKTN":{temp:-7,conditions:[],intensity:null},"ZKPY":{temp:-11,conditions:[],intensity:null},"WSSS":{temp:26,conditions:[],intensity:null},"WMKK":{temp:27,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:25,conditions:[],intensity:null},
  "VTBS":{temp:29,conditions:[],intensity:null},"VTBD":{temp:29,conditions:[],intensity:null},"VTSP":{temp:29,conditions:[],intensity:null},"VTCC":{temp:24,conditions:[],intensity:null},"VTSS":{temp:27,conditions:[],intensity:null},"VTUK":{temp:26,conditions:[],intensity:null},"VVNB":{temp:17,conditions:[],intensity:null},"VVTS":{temp:25,conditions:[],intensity:null},"VVDN":{temp:19,conditions:[],intensity:null},"VVCR":{temp:22,conditions:[],intensity:null},
  "VDPP":{temp:26,conditions:[],intensity:null},"VDSR":{temp:25,conditions:[],intensity:null},"VLVT":{temp:23,conditions:[],intensity:null},"VLLB":{temp:21,conditions:[],intensity:null},"VYYY":{temp:26,conditions:[],intensity:null},"VYMD":{temp:24,conditions:[],intensity:null},"VGHS":{temp:21,conditions:[],intensity:null},"VGCG":{temp:22,conditions:[],intensity:null},"VECC":{temp:23,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  "VCBI":{temp:27,conditions:[],intensity:null},"WIII":{temp:27,conditions:[],intensity:null},"WADD":{temp:28,conditions:[],intensity:null},"WARR":{temp:28,conditions:[],intensity:null},"WIHH":{temp:27,conditions:[],intensity:null},"WIMM":{temp:27,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:23,conditions:[],intensity:null},"WASS":{temp:27,conditions:[],intensity:null},
  "RPLL":{temp:25,conditions:[],intensity:null},"RPLC":{temp:22,conditions:[],intensity:null},"RPVM":{temp:25,conditions:[],intensity:null},"RPVD":{temp:24,conditions:[],intensity:null},"RPVK":{temp:21,conditions:[],intensity:null},"WBSB":{temp:26,conditions:[],intensity:null},"WBLL":{temp:28,conditions:[],intensity:null},"VIDP":{temp:14,conditions:[],intensity:null},"VABB":{temp:24,conditions:[],intensity:null},"VOBL":{temp:23,conditions:[],intensity:null},
  "VOMM":{temp:25,conditions:[],intensity:null},"VEBS":{temp:23,conditions:[],intensity:null},"VOHY":{temp:26,conditions:[],intensity:null},"VAAH":{temp:24,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:28,conditions:[],intensity:null},"VOTP":{temp:25,conditions:[],intensity:null},"VIAR":{temp:16,conditions:[],intensity:null},"VIJP":{temp:16,conditions:[],intensity:null},"VELR":{temp:14,conditions:[],intensity:null},
  ...
  "RCKH":{temp:21,conditions:[],intensity:null},"RCNN":{temp:18,conditions:[],intensity:null},"YSSY":{temp:23,conditions:[],intensity:null},"YMML":{temp:16,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:22,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:24,conditions:[],intensity:null},"YBCS":{temp:24,conditions:[],intensity:null},"YSCB":{temp:25,conditions:[],intensity:null},
  "YMHB":{temp:14,conditions:[],intensity:null},"NZAA":{temp:17,conditions:[],intensity:null},"NZWN":{temp:16,conditions:[],intensity:null},"NZCH":{temp:14,conditions:[],intensity:null},"NZQN":{temp:13,conditions:[],intensity:null},"NZDN":{temp:11,conditions:[],intensity:null},"NFFN":{temp:26,conditions:[],intensity:null},"NWWW":{temp:27,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:29,conditions:["thunderstorm"],intensity:null},
  "NIUE":{temp:27,conditions:["thunderstorm"],intensity:null},"PGSN":{temp:26,conditions:[],intensity:null},"PGUM":{temp:27,conditions:["thunderstorm"],intensity:null},"PHOG":{temp:23,conditions:[],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:18,conditions:[],intensity:null}
};
