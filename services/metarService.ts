...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KEWR":{temp:4,conditions:[],intensity:null},"KMIA":{temp:26,conditions:[],intensity:null},"KPHX":{temp:21,conditions:[],intensity:null},"KIAH":{temp:18,conditions:[],intensity:null},"KBOS":{temp:3,conditions:[],intensity:null},"KMSP":{temp:-4,conditions:[],intensity:null},"KFLL":{temp:25,conditions:[],intensity:null},"KDTW":{temp:0,conditions:[],intensity:null},"KPHL":{temp:3,conditions:[],intensity:null},"KLGA":{temp:4,conditions:[],intensity:null},
  "KBWI":{temp:4,conditions:[],intensity:null},"KSLC":{temp:5,conditions:[],intensity:null},"KDCA":{temp:4,conditions:[],intensity:null},"KIAD":{temp:3,conditions:[],intensity:null},"KSAN":{temp:22,conditions:[],intensity:null},"KTPA":{temp:20,conditions:[],intensity:null},"KPDX":{temp:11,conditions:[],intensity:null},"KSTL":{temp:3,conditions:[],intensity:null},"KHNL":{temp:27,conditions:[],intensity:null},"KMEM":{temp:7,conditions:[],intensity:null},
  "KAUS":{temp:18,conditions:[],intensity:null},"KBNA":{temp:4,conditions:[],intensity:null},"KRDU":{temp:7,conditions:[],intensity:null},"KCLT":{temp:6,conditions:[],intensity:null},"KSMF":{temp:12,conditions:[],intensity:null},"KSJC":{temp:15,conditions:[],intensity:null},"KOAK":{temp:13,conditions:[],intensity:null},"KCLE":{temp:-3,conditions:[],intensity:null},"KMKE":{temp:0,conditions:[],intensity:null},"KPIT":{temp:-2,conditions:[],intensity:null},
  ...
  "MMTJ":{temp:23,conditions:[],intensity:null},"MMSM":{temp:28,conditions:[],intensity:null},"MMMD":{temp:27,conditions:[],intensity:null},"MMCZ":{temp:27,conditions:[],intensity:null},"MMSD":{temp:24,conditions:[],intensity:null},"MGGT":{temp:20,conditions:[],intensity:null},"MSLP":{temp:34,conditions:[],intensity:null},"MHTG":{temp:27,conditions:[],intensity:null},"MNMG":{temp:30,conditions:[],intensity:null},"MROC":{temp:28,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:27,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:27,conditions:[],intensity:null},"TAPA":{temp:26,conditions:[],intensity:null},"SBGR":{temp:29,conditions:[],intensity:null},"SBGL":{temp:33,conditions:[],intensity:null},"SBBR":{temp:25,conditions:[],intensity:null},"SBCF":{temp:27,conditions:[],intensity:null},"SBSV":{temp:27,conditions:[],intensity:null},"SBRF":{temp:26,conditions:[],intensity:null},
  "SBPA":{temp:27,conditions:[],intensity:null},"SBCT":{temp:23,conditions:["thunderstorm"],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:26,conditions:[],intensity:null},"SAEZ":{temp:32,conditions:[],intensity:null},"SABE":{temp:29,conditions:[],intensity:null},"SACO":{temp:29,conditions:[],intensity:null},"SAME":{temp:31,conditions:[],intensity:null},"SLLP":{temp:16,conditions:[],intensity:null},"SLVR":{temp:23,conditions:[],intensity:null},
  ...
  "LATI":{temp:1,conditions:[],intensity:null},"UKBB":{temp:-14,conditions:[],intensity:null},"UKLL":{temp:-4,conditions:["snow"],intensity:null},"UUEE":{temp:-5,conditions:[],intensity:null},"UUDD":{temp:-4,conditions:[],intensity:null},"UUWW":{temp:-4,conditions:[],intensity:null},"ULLI":{temp:-9,conditions:[],intensity:null},"UWWW":{temp:-9,conditions:[],intensity:null},"USSS":{temp:-12,conditions:[],intensity:null},"UNNT":{temp:-18,conditions:[],intensity:null},
  ...
  "GMMX":{temp:10,conditions:[],intensity:null},"GMTT":{temp:10,conditions:[],intensity:null},"GMFF":{temp:9,conditions:[],intensity:null},"GMAD":{temp:11,conditions:[],intensity:null},"DAAG":{temp:9,conditions:[],intensity:null},"DAOO":{temp:9,conditions:[],intensity:null},"DTTA":{temp:11,conditions:[],intensity:null},"DTMB":{temp:11,conditions:[],intensity:null},"DTTJ":{temp:14,conditions:[],intensity:null},"HECA":{temp:14,conditions:[],intensity:null},
  ...
  "GABS":{temp:22,conditions:[],intensity:null},"GVNP":{temp:19,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:28,conditions:[],intensity:null},"DBBB":{temp:27,conditions:[],intensity:null},"HKJK":{temp:18,conditions:[],intensity:null},"HKMO":{temp:25,conditions:[],intensity:null},"HTDA":{temp:26,conditions:[],intensity:null},"HTKJ":{temp:22,conditions:[],intensity:null},
  ...
  "FSIA":{temp:26,conditions:[],intensity:null},"FKKD":{temp:28,conditions:[],intensity:null},"FKYS":{temp:23,conditions:[],intensity:null},"FOOL":{temp:26,conditions:[],intensity:null},"FZAA":{temp:26,conditions:[],intensity:null},"FCBB":{temp:24,conditions:[],intensity:null},"FLLK":{temp:20,conditions:[],intensity:null},"FVHA":{temp:19,conditions:[],intensity:null},"FLLS":{temp:21,conditions:[],intensity:null},"FYWH":{temp:21,conditions:[],intensity:null},
  "FBSK":{temp:23,conditions:[],intensity:null},"FAOR":{temp:17,conditions:[],intensity:null},"FACT":{temp:22,conditions:[],intensity:null},"FALE":{temp:21,conditions:[],intensity:null},"FAPE":{temp:22,conditions:[],intensity:null},"FQMA":{temp:23,conditions:[],intensity:null},"FWKI":{temp:19,conditions:[],intensity:null},"ZBAA":{temp:-9,conditions:[],intensity:null},"ZBAD":{temp:-9,conditions:[],intensity:null},"ZSPD":{temp:3,conditions:[],intensity:null},
  ...
  "VTBS":{temp:19,conditions:[],intensity:null},"VTBD":{temp:18,conditions:[],intensity:null},"VTSP":{temp:24,conditions:[],intensity:null},"VTCC":{temp:17,conditions:[],intensity:null},"VTSS":{temp:24,conditions:[],intensity:null},"VTUK":{temp:22,conditions:[],intensity:null},"VVNB":{temp:12,conditions:[],intensity:null},"VVTS":{temp:23,conditions:[],intensity:null},"VVDN":{temp:15,conditions:[],intensity:null},"VVCR":{temp:19,conditions:[],intensity:null},
  "VDPP":{temp:21,conditions:[],intensity:null},"VDSR":{temp:17,conditions:[],intensity:null},"VLVT":{temp:11,conditions:[],intensity:null},"VLLB":{temp:10,conditions:["fog"],intensity:null},"VYYY":{temp:20,conditions:[],intensity:null},"VYMD":{temp:19,conditions:[],intensity:null},"VGHS":{temp:13,conditions:[],intensity:null},"VGCG":{temp:19,conditions:[],intensity:null},"VECC":{temp:13,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
