...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KEWR":{temp:-15,conditions:[],intensity:null},"KMIA":{temp:11,conditions:[],intensity:null},"KPHX":{temp:15,conditions:[],intensity:null},"KIAH":{temp:11,conditions:["fog"],intensity:null},"KBOS":{temp:-16,conditions:[],intensity:null},"KMSP":{temp:-4,conditions:[],intensity:null},"KFLL":{temp:10,conditions:[],intensity:null},"KDTW":{temp:-15,conditions:[],intensity:null},"KPHL":{temp:-14,conditions:[],intensity:null},"KLGA":{temp:-16,conditions:[],intensity:null},
  "KBWI":{temp:-14,conditions:[],intensity:null},"KSLC":{temp:3,conditions:[],intensity:null},"KDCA":{temp:-10,conditions:[],intensity:null},"KIAD":{temp:-10,conditions:[],intensity:null},"KSAN":{temp:12,conditions:[],intensity:null},"KTPA":{temp:6,conditions:[],intensity:null},"KPDX":{temp:9,conditions:[],intensity:null},"KSTL":{temp:-2,conditions:[],intensity:null},"KHNL":{temp:20,conditions:[],intensity:null},"KMEM":{temp:0,conditions:[],intensity:null},
  "KAUS":{temp:10,conditions:[],intensity:null},"KBNA":{temp:-2,conditions:[],intensity:null},"KRDU":{temp:-5,conditions:[],intensity:null},"KCLT":{temp:-5,conditions:[],intensity:null},"KSMF":{temp:7,conditions:[],intensity:null},"KSJC":{temp:9,conditions:["fog"],intensity:null},"KOAK":{temp:9,conditions:["fog"],intensity:null},"KCLE":{temp:-19,conditions:[],intensity:null},"KMKE":{temp:-8,conditions:[],intensity:null},"KPIT":{temp:-18,conditions:[],intensity:null},
  "KIND":{temp:-7,conditions:[],intensity:null},"KCVG":{temp:-9,conditions:[],intensity:null},"KMCI":{temp:4,conditions:[],intensity:null},"KSAT":{temp:11,conditions:[],intensity:null},"KHOU":{temp:11,conditions:["fog"],intensity:null},"KDAL":{temp:11,conditions:[],intensity:null},"KMDW":{temp:-7,conditions:[],intensity:null},"PANC":{temp:-1,conditions:[],intensity:null},"PAFA":{temp:-24,conditions:[],intensity:null},"CYYZ":{temp:-24,conditions:[],intensity:null},
  "CYVR":{temp:5,conditions:[],intensity:null},"CYUL":{temp:-21,conditions:[],intensity:null},"CYYC":{temp:7,conditions:[],intensity:null},"CYEG":{temp:0,conditions:[],intensity:null},"CYOW":{temp:-25,conditions:[],intensity:null},"CYWG":{temp:-5,conditions:[],intensity:null},"CYHZ":{temp:-8,conditions:[],intensity:null},"CYQB":{temp:-19,conditions:[],intensity:null},"CYYJ":{temp:6,conditions:[],intensity:null},"CYLW":{temp:4,conditions:[],intensity:null},
  "CYXE":{temp:-1,conditions:["fog"],intensity:null},"CYQR":{temp:-1,conditions:["fog"],intensity:null},"CYZF":{temp:-23,conditions:[],intensity:null},"CYXY":{temp:-5,conditions:[],intensity:null},"CYQT":{temp:-16,conditions:[],intensity:null},"CYYT":{temp:-2,conditions:[],intensity:null},"MMMX":{temp:6,conditions:[],intensity:null},"MMUN":{temp:15,conditions:[],intensity:null},"MMGL":{temp:14,conditions:[],intensity:null},"MMMY":{temp:15,conditions:[],intensity:null},
  "MMTJ":{temp:12,conditions:[],intensity:null},"MMSM":{temp:26,conditions:[],intensity:null},"MMMD":{temp:15,conditions:[],intensity:null},"MMCZ":{temp:20,conditions:[],intensity:null},"MMSD":{temp:24,conditions:[],intensity:null},"MGGT":{temp:10,conditions:[],intensity:null},"MSLP":{temp:22,conditions:[],intensity:null},"MHTG":{temp:15,conditions:[],intensity:null},"MNMG":{temp:21,conditions:[],intensity:null},"MROC":{temp:22,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:22,conditions:[],intensity:null},"TIST":{temp:24,conditions:[],intensity:null},"TLPL":{temp:25,conditions:[],intensity:null},"TAPA":{temp:24,conditions:[],intensity:null},"SBGR":{temp:20,conditions:[],intensity:null},"SBGL":{temp:25,conditions:[],intensity:null},"SBBR":{temp:19,conditions:[],intensity:null},"SBCF":{temp:20,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:25,conditions:["fog"],intensity:null},
  "SBPA":{temp:21,conditions:[],intensity:null},"SBCT":{temp:18,conditions:[],intensity:null},"SBFZ":{temp:24,conditions:[],intensity:null},"SCEL":{temp:15,conditions:[],intensity:null},"SAEZ":{temp:20,conditions:[],intensity:null},"SABE":{temp:20,conditions:[],intensity:null},"SACO":{temp:16,conditions:[],intensity:null},"SAME":{temp:19,conditions:[],intensity:null},"SLLP":{temp:4,conditions:["fog"],intensity:null},"SLVR":{temp:22,conditions:["fog"],intensity:null},
  "SPJC":{temp:21,conditions:["fog"],intensity:null},"SEQM":{temp:9,conditions:["fog"],intensity:null},"SEGU":{temp:23,conditions:["fog"],intensity:null},"SKBO":{temp:12,conditions:[],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:22,conditions:[],intensity:null},"SKRG":{temp:13,conditions:[],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:16,conditions:[],intensity:null},
  ...
  "EIDW":{temp:7,conditions:[],intensity:null},"EICK":{temp:6,conditions:[],intensity:null},"EINN":{temp:4,conditions:["fog"],intensity:null},"LFPG":{temp:7,conditions:[],intensity:null},"LFPO":{temp:7,conditions:[],intensity:null},"LFML":{temp:10,conditions:[],intensity:null},"LFLL":{temp:3,conditions:["fog"],intensity:null},"LFMN":{temp:11,conditions:[],intensity:null},"LFBD":{temp:9,conditions:[],intensity:null},"LFBO":{temp:8,conditions:[],intensity:null},
  "LFRS":{temp:7,conditions:[],intensity:null},"LFSB":{temp:2,conditions:["fog"],intensity:null},"LFPB":{temp:7,conditions:[],intensity:null},"EDDF":{temp:3,conditions:[],intensity:null},"EDDM":{temp:4,conditions:[],intensity:null},"EDDB":{temp:1,conditions:[],intensity:null},"EDDL":{temp:7,conditions:[],intensity:null},"EDDH":{temp:1,conditions:[],intensity:null},"EDDK":{temp:6,conditions:[],intensity:null},"EDDS":{temp:1,conditions:["fog"],intensity:null},
  "EDDW":{temp:1,conditions:[],intensity:null},"EDDN":{temp:5,conditions:[],intensity:null},"EDDV":{temp:1,conditions:[],intensity:null},"EDDP":{temp:1,conditions:[],intensity:null},"LEMD":{temp:8,conditions:[],intensity:null},"LEBL":{temp:12,conditions:[],intensity:null},"LEPA":{temp:14,conditions:[],intensity:null},"LEMG":{temp:13,conditions:[],intensity:null},"LEVC":{temp:13,conditions:[],intensity:null},"LEAL":{temp:14,conditions:[],intensity:null},
  "LEZL":{temp:11,conditions:[],intensity:null},"GCLP":{temp:17,conditions:[],intensity:null},"GCTS":{temp:16,conditions:[],intensity:null},"GCLA":{temp:16,conditions:[],intensity:null},"GCFV":{temp:17,conditions:[],intensity:null},"LPPT":{temp:12,conditions:[],intensity:null},"LPPR":{temp:11,conditions:[],intensity:null},"LPFR":{temp:13,conditions:[],intensity:null},"LPMA":{temp:16,conditions:[],intensity:null},"LIRF":{temp:13,conditions:[],intensity:null},
  ...
  "LIMF":{temp:8,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:14,conditions:[],intensity:null},"EHAM":{temp:7,conditions:[],intensity:null},"EHRD":{temp:8,conditions:[],intensity:null},"EHEH":{temp:7,conditions:[],intensity:null},"EBBR":{temp:10,conditions:[],intensity:null},"EBCI":{temp:8,conditions:[],intensity:null},"ELLX":{temp:4,conditions:[],intensity:null},"LSZH":{temp:3,conditions:["fog"],intensity:null},
  "LSGG":{temp:5,conditions:[],intensity:null},"LSZB":{temp:3,conditions:["fog"],intensity:null},"LOWW":{temp:6,conditions:[],intensity:null},"LOWS":{temp:3,conditions:["fog"],intensity:null},"LOWG":{temp:6,conditions:[],intensity:null},"LOWI":{temp:5,conditions:[],intensity:null},"LKPR":{temp:3,conditions:[],intensity:null},"EPWA":{temp:-2,conditions:[],intensity:null},"EPKK":{temp:1,conditions:[],intensity:null},"EPGD":{temp:-3,conditions:["snow"],intensity:null},
  ...
  "ENZV":{temp:2,conditions:[],intensity:null},"ENTC":{temp:-2,conditions:[],intensity:null},"EFOU":{temp:-13,conditions:[],intensity:null},"EFRO":{temp:-16,conditions:[],intensity:null},"LGAV":{temp:16,conditions:[],intensity:null},"LGTS":{temp:13,conditions:[],intensity:null},"LGIR":{temp:19,conditions:[],intensity:null},"LGKR":{temp:14,conditions:[],intensity:null},"LGRP":{temp:19,conditions:[],intensity:null},"LGSR":{temp:18,conditions:[],intensity:null},
  "LGMK":{temp:17,conditions:[],intensity:null},"LTFM":{temp:10,conditions:[],intensity:null},"LTBA":{temp:11,conditions:["thunderstorm"],intensity:null},"LTFJ":{temp:12,conditions:[],intensity:null},"LTAI":{temp:17,conditions:[],intensity:null},"LTAC":{temp:9,conditions:[],intensity:null},"LTBJ":{temp:13,conditions:[],intensity:null},"LTBS":{temp:17,conditions:[],intensity:null},"LTFE":{temp:18,conditions:[],intensity:null},"LCLK":{temp:20,conditions:[],intensity:null},
  "LCPH":{temp:19,conditions:[],intensity:null},"LHBP":{temp:6,conditions:[],intensity:null},"LROP":{temp:6,conditions:["fog"],intensity:null},"LBSF":{temp:7,conditions:[],intensity:null},"LYBE":{temp:8,conditions:[],intensity:null},"LDZA":{temp:8,conditions:[],intensity:null},"LDDU":{temp:11,conditions:[],intensity:null},"LDSP":{temp:13,conditions:[],intensity:null},"LJLJ":{temp:3,conditions:["fog"],intensity:null},"LWSK":{temp:10,conditions:[],intensity:null},
  "LATI":{temp:13,conditions:[],intensity:null},"UKBB":{temp:-6,conditions:[],intensity:null},"UKLL":{temp:-2,conditions:["snow"],intensity:null},"UUEE":{temp:-13,conditions:[],intensity:null},"UUDD":{temp:-12,conditions:[],intensity:null},"UUWW":{temp:-12,conditions:[],intensity:null},"ULLI":{temp:-7,conditions:[],intensity:null},"UWWW":{temp:-10,conditions:[],intensity:null},"USSS":{temp:-4,conditions:[],intensity:null},"UNNT":{temp:-12,conditions:[],intensity:null},
  ...
  "OEDF":{temp:26,conditions:[],intensity:null},"OEMA":{temp:25,conditions:[],intensity:null},"OKBK":{temp:27,conditions:[],intensity:null},"OBBI":{temp:22,conditions:[],intensity:null},"OOMS":{temp:28,conditions:[],intensity:null},"OYAA":{temp:22,conditions:[],intensity:null},"OIIE":{temp:7,conditions:[],intensity:null},"OIII":{temp:7,conditions:[],intensity:null},"OISS":{temp:14,conditions:[],intensity:null},"OIKB":{temp:23,conditions:[],intensity:null},
  "OIAW":{temp:22,conditions:[],intensity:null},"OIKK":{temp:14,conditions:[],intensity:null},"OICC":{temp:11,conditions:[],intensity:null},"LLBG":{temp:26,conditions:[],intensity:null},"OLBA":{temp:23,conditions:[],intensity:null},"OJAM":{temp:21,conditions:[],intensity:null},"ORBI":{temp:21,conditions:[],intensity:null},"ORER":{temp:14,conditions:[],intensity:null},"GMMN":{temp:15,conditions:[],intensity:null},"GMME":{temp:16,conditions:[],intensity:null},
  "GMMX":{temp:14,conditions:[],intensity:null},"GMTT":{temp:14,conditions:[],intensity:null},"GMFF":{temp:12,conditions:[],intensity:null},"GMAD":{temp:16,conditions:[],intensity:null},"DAAG":{temp:14,conditions:[],intensity:null},"DAOO":{temp:13,conditions:[],intensity:null},"DTTA":{temp:15,conditions:[],intensity:null},"DTMB":{temp:15,conditions:[],intensity:null},"DTTJ":{temp:17,conditions:[],intensity:null},"HECA":{temp:28,conditions:[],intensity:null},
  "HEGN":{temp:25,conditions:[],intensity:null},"HESH":{temp:24,conditions:[],intensity:null},"HEBA":{temp:26,conditions:[],intensity:null},"HEAX":{temp:27,conditions:[],intensity:null},"HLLT":{temp:18,conditions:[],intensity:null},"DNMM":{temp:31,conditions:[],intensity:null},"DNAA":{temp:33,conditions:[],intensity:null},"DGAA":{temp:30,conditions:[],intensity:null},"DIAP":{temp:29,conditions:[],intensity:null},"GOBD":{temp:23,conditions:[],intensity:null},
  "GABS":{temp:25,conditions:[],intensity:null},"GVNP":{temp:23,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:28,conditions:[],intensity:null},"DXXX":{temp:32,conditions:[],intensity:null},"DBBB":{temp:32,conditions:[],intensity:null},"HKJK":{temp:24,conditions:[],intensity:null},"HKMO":{temp:33,conditions:[],intensity:null},"HTDA":{temp:31,conditions:[],intensity:null},"HTKJ":{temp:28,conditions:[],intensity:null},
  "HUEN":{temp:26,conditions:[],intensity:null},"HRYR":{temp:24,conditions:[],intensity:null},"HAAB":{temp:23,conditions:[],intensity:null},"HDAM":{temp:29,conditions:[],intensity:null},"HCMM":{temp:31,conditions:[],intensity:null},"OYSN":{temp:30,conditions:[],intensity:null},"FMEE":{temp:29,conditions:[],intensity:null},"FIMP":{temp:30,conditions:[],intensity:null},"FMCH":{temp:29,conditions:[],intensity:null},"FMMI":{temp:27,conditions:[],intensity:null},
  "FSIA":{temp:29,conditions:[],intensity:null},"FKKD":{temp:28,conditions:[],intensity:null},"FKYS":{temp:27,conditions:[],intensity:null},"FOOL":{temp:28,conditions:[],intensity:null},"FZAA":{temp:27,conditions:[],intensity:null},"FCBB":{temp:26,conditions:[],intensity:null},"FLLK":{temp:24,conditions:[],intensity:null},"FVHA":{temp:26,conditions:[],intensity:null},"FLLS":{temp:25,conditions:[],intensity:null},"FYWH":{temp:25,conditions:[],intensity:null},
  "FBSK":{temp:31,conditions:[],intensity:null},"FAOR":{temp:26,conditions:[],intensity:null},"FACT":{temp:28,conditions:[],intensity:null},"FALE":{temp:33,conditions:[],intensity:null},"FAPE":{temp:24,conditions:[],intensity:null},"FQMA":{temp:34,conditions:[],intensity:null},"FWKI":{temp:22,conditions:[],intensity:null},"ZBAA":{temp:3,conditions:[],intensity:null},"ZBAD":{temp:3,conditions:[],intensity:null},"ZSPD":{temp:3,conditions:[],intensity:null},
  ...
  "ZYTX":{temp:-8,conditions:[],intensity:null},"ZSAM":{temp:12,conditions:[],intensity:null},"ZGKL":{temp:7,conditions:[],intensity:null},"ZSNJ":{temp:3,conditions:[],intensity:null},"ZSHC":{temp:4,conditions:[],intensity:null},"ZPPP":{temp:9,conditions:[],intensity:null},"ZBTJ":{temp:3,conditions:[],intensity:null},"VMMC":{temp:17,conditions:[],intensity:null},"RJTT":{temp:1,conditions:[],intensity:null},"RJAA":{temp:-1,conditions:[],intensity:null},
  ...
  "VTBS":{temp:30,conditions:[],intensity:null},"VTBD":{temp:29,conditions:["thunderstorm"],intensity:null},"VTSP":{temp:29,conditions:[],intensity:null},"VTCC":{temp:32,conditions:[],intensity:null},"VTSS":{temp:29,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:14,conditions:[],intensity:null},"VVTS":{temp:31,conditions:[],intensity:null},"VVDN":{temp:20,conditions:[],intensity:null},"VVCR":{temp:27,conditions:[],intensity:null},
  ...
  "VOMM":{temp:31,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:30,conditions:[],intensity:null},"VAAH":{temp:32,conditions:[],intensity:null},"VOCI":{temp:29,conditions:[],intensity:null},"VAGO":{temp:31,conditions:[],intensity:null},"VOTP":{temp:31,conditions:[],intensity:null},"VIAR":{temp:22,conditions:[],intensity:null},"VIJP":{temp:28,conditions:[],intensity:null},"VELR":{temp:19,conditions:[],intensity:null},
  ...
  "RCKH":{temp:17,conditions:[],intensity:null},"RCNN":{temp:14,conditions:[],intensity:null},"YSSY":{temp:21,conditions:[],intensity:null},"YMML":{temp:24,conditions:[],intensity:null},"YBBN":{temp:25,conditions:[],intensity:null},"YPPH":{temp:32,conditions:[],intensity:null},"YPAD":{temp:23,conditions:[],intensity:null},"YBCG":{temp:22,conditions:[],intensity:null},"YBCS":{temp:25,conditions:[],intensity:null},"YSCB":{temp:20,conditions:[],intensity:null},
  "YMHB":{temp:18,conditions:[],intensity:null},"NZAA":{temp:19,conditions:[],intensity:null},"NZWN":{temp:16,conditions:[],intensity:null},"NZCH":{temp:13,conditions:[],intensity:null},"NZQN":{temp:13,conditions:[],intensity:null},"NZDN":{temp:11,conditions:[],intensity:null},"NFFN":{temp:27,conditions:[],intensity:null},"NWWW":{temp:30,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
