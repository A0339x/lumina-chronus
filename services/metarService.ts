...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LATI":{temp:8,conditions:[],intensity:null},"UKBB":{temp:-5,conditions:[],intensity:null},"UKLL":{temp:1,conditions:["fog"],intensity:null},"UUEE":{temp:-11,conditions:["snow"],intensity:null},"UUDD":{temp:-11,conditions:[],intensity:null},"UUWW":{temp:-11,conditions:[],intensity:null},"ULLI":{temp:-12,conditions:[],intensity:null},"UWWW":{temp:-25,conditions:[],intensity:null},"USSS":{temp:-21,conditions:[],intensity:null},"UNNT":{temp:-22,conditions:[],intensity:null},
  ...
  "GMMX":{temp:9,conditions:[],intensity:null},"GMTT":{temp:15,conditions:[],intensity:null},"GMFF":{temp:8,conditions:[],intensity:null},"GMAD":{temp:11,conditions:[],intensity:null},"DAAG":{temp:14,conditions:[],intensity:null},"DAOO":{temp:15,conditions:[],intensity:null},"DTTA":{temp:11,conditions:[],intensity:null},"DTMB":{temp:10,conditions:[],intensity:null},"DTTJ":{temp:15,conditions:[],intensity:null},"HECA":{temp:12,conditions:[],intensity:null},
