...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:-2,conditions:[],intensity:null},"KLAX":{temp:11,conditions:[],intensity:null},"KORD":{temp:-17,conditions:[],intensity:null},"KDFW":{temp:-1,conditions:[],intensity:null},"KDEN":{temp:-4,conditions:[],intensity:null},"KJFK":{temp:-11,conditions:[],intensity:null},"KSFO":{temp:11,conditions:[],intensity:null},"KSEA":{temp:6,conditions:[],intensity:null},"KLAS":{temp:5,conditions:[],intensity:null},"KMCO":{temp:2,conditions:[],intensity:null},
  "KEWR":{temp:-13,conditions:[],intensity:null},"KMIA":{temp:9,conditions:[],intensity:null},"KPHX":{temp:9,conditions:[],intensity:null},"KIAH":{temp:0,conditions:[],intensity:null},"KBOS":{temp:-13,conditions:[],intensity:null},"KMSP":{temp:-17,conditions:[],intensity:null},"KFLL":{temp:9,conditions:[],intensity:null},"KDTW":{temp:-17,conditions:[],intensity:null},"KPHL":{temp:-12,conditions:[],intensity:null},"KLGA":{temp:-14,conditions:[],intensity:null},
  "KBWI":{temp:-13,conditions:[],intensity:null},"KSLC":{temp:-3,conditions:[],intensity:null},"KDCA":{temp:-13,conditions:[],intensity:null},"KIAD":{temp:-12,conditions:[],intensity:null},"KSAN":{temp:9,conditions:[],intensity:null},"KTPA":{temp:2,conditions:[],intensity:null},"KPDX":{temp:5,conditions:[],intensity:null},"KSTL":{temp:-15,conditions:[],intensity:null},"KHNL":{temp:22,conditions:["fog"],intensity:null},"KMEM":{temp:-4,conditions:["fog"],intensity:null},
  ...
  "CYVR":{temp:7,conditions:[],intensity:null},"CYUL":{temp:-21,conditions:[],intensity:null},"CYYC":{temp:-5,conditions:[],intensity:null},"CYEG":{temp:-9,conditions:[],intensity:null},"CYOW":{temp:-23,conditions:[],intensity:null},"CYWG":{temp:-25,conditions:[],intensity:null},"CYHZ":{temp:-17,conditions:[],intensity:null},"CYQB":{temp:-24,conditions:[],intensity:null},"CYYJ":{temp:6,conditions:[],intensity:null},"CYLW":{temp:-2,conditions:[],intensity:null},
  "CYXE":{temp:-16,conditions:[],intensity:null},"CYQR":{temp:-17,conditions:[],intensity:null},"CYZF":{temp:-24,conditions:[],intensity:null},"CYXY":{temp:1,conditions:[],intensity:null},"CYQT":{temp:-20,conditions:[],intensity:null},"CYYT":{temp:-6,conditions:[],intensity:null},"MMMX":{temp:10,conditions:[],intensity:null},"MMUN":{temp:19,conditions:[],intensity:null},"MMGL":{temp:14,conditions:[],intensity:null},"MMMY":{temp:4,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:18,conditions:["fog"],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:24,conditions:[],intensity:null},"SBGR":{temp:22,conditions:[],intensity:null},"SBGL":{temp:25,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:20,conditions:[],intensity:null},"SBSV":{temp:25,conditions:[],intensity:null},"SBRF":{temp:26,conditions:[],intensity:null},
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:18,conditions:["fog"],intensity:null},"SBFZ":{temp:25,conditions:[],intensity:null},"SCEL":{temp:16,conditions:[],intensity:null},"SAEZ":{temp:18,conditions:[],intensity:null},"SABE":{temp:20,conditions:[],intensity:null},"SACO":{temp:17,conditions:["fog"],intensity:null},"SAME":{temp:19,conditions:[],intensity:null},"SLLP":{temp:4,conditions:["fog"],intensity:null},"SLVR":{temp:23,conditions:[],intensity:null},
  ...
  "SGAS":{temp:26,conditions:[],intensity:null},"SBBV":{temp:25,conditions:[],intensity:null},"SMJP":{temp:23,conditions:[],intensity:null},"SYCJ":{temp:23,conditions:[],intensity:null},"EGLL":{temp:5,conditions:["fog"],intensity:null},"EGKK":{temp:5,conditions:["fog"],intensity:null},"EGSS":{temp:3,conditions:["fog"],intensity:null},"EGLC":{temp:5,conditions:[],intensity:null},"EGCC":{temp:4,conditions:[],intensity:null},"EGBB":{temp:3,conditions:[],intensity:null},
  "EGPH":{temp:2,conditions:["fog"],intensity:null},"EGPF":{temp:5,conditions:[],intensity:null},"EGGW":{temp:3,conditions:["fog"],intensity:null},"EGNX":{temp:3,conditions:["fog"],intensity:null},"EGNT":{temp:3,conditions:["fog"],intensity:null},"EGGP":{temp:4,conditions:[],intensity:null},"EGHI":{temp:5,conditions:["fog"],intensity:null},"EGGD":{temp:5,conditions:[],intensity:null},"EGPD":{temp:6,conditions:[],intensity:null},"EGAA":{temp:7,conditions:[],intensity:null},
  "EIDW":{temp:8,conditions:[],intensity:null},"EICK":{temp:8,conditions:[],intensity:null},"EINN":{temp:6,conditions:[],intensity:null},"LFPG":{temp:4,conditions:["fog"],intensity:null},"LFPO":{temp:4,conditions:["fog"],intensity:null},"LFML":{temp:9,conditions:[],intensity:null},"LFLL":{temp:6,conditions:[],intensity:null},"LFMN":{temp:10,conditions:[],intensity:null},"LFBD":{temp:8,conditions:[],intensity:null},"LFBO":{temp:6,conditions:[],intensity:null},
  "LFRS":{temp:6,conditions:[],intensity:null},"LFSB":{temp:5,conditions:[],intensity:null},"LFPB":{temp:4,conditions:["fog"],intensity:null},"EDDF":{temp:3,conditions:[],intensity:null},"EDDM":{temp:3,conditions:[],intensity:null},"EDDB":{temp:0,conditions:[],intensity:null},"EDDL":{temp:5,conditions:[],intensity:null},"EDDH":{temp:0,conditions:[],intensity:null},"EDDK":{temp:5,conditions:[],intensity:null},"EDDS":{temp:3,conditions:[],intensity:null},
  "EDDW":{temp:0,conditions:[],intensity:null},"EDDN":{temp:2,conditions:[],intensity:null},"EDDV":{temp:-1,conditions:[],intensity:null},"EDDP":{temp:0,conditions:[],intensity:null},"LEMD":{temp:1,conditions:["snow"],intensity:null},"LEBL":{temp:10,conditions:[],intensity:null},"LEPA":{temp:13,conditions:[],intensity:null},"LEMG":{temp:16,conditions:[],intensity:null},"LEVC":{temp:9,conditions:[],intensity:null},"LEAL":{temp:10,conditions:[],intensity:null},
  "LEZL":{temp:16,conditions:[],intensity:null},"GCLP":{temp:19,conditions:[],intensity:null},"GCTS":{temp:18,conditions:[],intensity:null},"GCLA":{temp:19,conditions:[],intensity:null},"GCFV":{temp:19,conditions:[],intensity:null},"LPPT":{temp:14,conditions:[],intensity:null},"LPPR":{temp:9,conditions:[],intensity:null},"LPFR":{temp:17,conditions:[],intensity:null},"LPMA":{temp:18,conditions:[],intensity:null},"LIRF":{temp:14,conditions:[],intensity:null},
  "LIMC":{temp:5,conditions:[],intensity:null},"LIME":{temp:5,conditions:[],intensity:null},"LIPZ":{temp:8,conditions:[],intensity:null},"LIRN":{temp:13,conditions:["rain"],intensity:null},"LIML":{temp:6,conditions:[],intensity:null},"LIPE":{temp:8,conditions:[],intensity:null},"LICC":{temp:14,conditions:[],intensity:null},"LICJ":{temp:16,conditions:[],intensity:null},"LIRA":{temp:13,conditions:[],intensity:null},"LIRP":{temp:13,conditions:[],intensity:null},
  "LIMF":{temp:4,conditions:[],intensity:null},"LIEO":{temp:13,conditions:[],intensity:null},"LIEE":{temp:15,conditions:[],intensity:null},"EHAM":{temp:4,conditions:[],intensity:null},"EHRD":{temp:5,conditions:["fog"],intensity:null},"EHEH":{temp:4,conditions:[],intensity:null},"EBBR":{temp:4,conditions:[],intensity:null},"EBCI":{temp:5,conditions:["fog"],intensity:null},"ELLX":{temp:4,conditions:[],intensity:null},"LSZH":{temp:3,conditions:["fog"],intensity:null},
  "LSGG":{temp:3,conditions:[],intensity:null},"LSZB":{temp:2,conditions:[],intensity:null},"LOWW":{temp:2,conditions:[],intensity:null},"LOWS":{temp:2,conditions:[],intensity:null},"LOWG":{temp:3,conditions:[],intensity:null},"LOWI":{temp:8,conditions:[],intensity:null},"LKPR":{temp:0,conditions:[],intensity:null},"EPWA":{temp:1,conditions:[],intensity:null},"EPKK":{temp:2,conditions:[],intensity:null},"EPGD":{temp:-2,conditions:["snow"],intensity:null},
  "EPWR":{temp:1,conditions:[],intensity:null},"EPPO":{temp:-2,conditions:[],intensity:null},"EKCH":{temp:-1,conditions:[],intensity:null},"ESSA":{temp:-6,conditions:[],intensity:null},"ENGM":{temp:-8,conditions:[],intensity:null},"EFHK":{temp:-9,conditions:[],intensity:null},"BIKF":{temp:3,conditions:[],intensity:null},"ESGG":{temp:-3,conditions:[],intensity:null},"ESMS":{temp:-1,conditions:[],intensity:null},"ENBR":{temp:-4,conditions:[],intensity:null},
  "ENZV":{temp:-3,conditions:[],intensity:null},"ENTC":{temp:-6,conditions:[],intensity:null},"EFOU":{temp:-19,conditions:[],intensity:null},"EFRO":{temp:-20,conditions:[],intensity:null},"LGAV":{temp:15,conditions:[],intensity:null},"LGTS":{temp:12,conditions:[],intensity:null},"LGIR":{temp:17,conditions:[],intensity:null},"LGKR":{temp:13,conditions:[],intensity:null},"LGRP":{temp:16,conditions:[],intensity:null},"LGSR":{temp:17,conditions:[],intensity:null},
  ...
  "LCPH":{temp:15,conditions:[],intensity:null},"LHBP":{temp:3,conditions:[],intensity:null},"LROP":{temp:5,conditions:[],intensity:null},"LBSF":{temp:2,conditions:["fog"],intensity:null},"LYBE":{temp:7,conditions:[],intensity:null},"LDZA":{temp:6,conditions:[],intensity:null},"LDDU":{temp:11,conditions:[],intensity:null},"LDSP":{temp:12,conditions:[],intensity:null},"LJLJ":{temp:5,conditions:[],intensity:null},"LWSK":{temp:3,conditions:[],intensity:null},
  ...
  "OEDF":{temp:21,conditions:[],intensity:null},"OEMA":{temp:27,conditions:[],intensity:null},"OKBK":{temp:22,conditions:[],intensity:null},"OBBI":{temp:18,conditions:[],intensity:null},"OOMS":{temp:24,conditions:[],intensity:null},"OYAA":{temp:21,conditions:[],intensity:null},"OIIE":{temp:10,conditions:[],intensity:null},"OIII":{temp:10,conditions:[],intensity:null},"OISS":{temp:12,conditions:[],intensity:null},"OIKB":{temp:20,conditions:[],intensity:null},
  "OIAW":{temp:21,conditions:[],intensity:null},"OIKK":{temp:12,conditions:[],intensity:null},"OICC":{temp:11,conditions:[],intensity:null},"LLBG":{temp:15,conditions:[],intensity:null},"OLBA":{temp:16,conditions:[],intensity:null},"OJAM":{temp:12,conditions:[],intensity:null},"ORBI":{temp:19,conditions:[],intensity:null},"ORER":{temp:14,conditions:[],intensity:null},"GMMN":{temp:16,conditions:[],intensity:null},"GMME":{temp:17,conditions:[],intensity:null},
  "GMMX":{temp:15,conditions:[],intensity:null},"GMTT":{temp:17,conditions:[],intensity:null},"GMFF":{temp:16,conditions:[],intensity:null},"GMAD":{temp:16,conditions:[],intensity:null},"DAAG":{temp:15,conditions:[],intensity:null},"DAOO":{temp:17,conditions:[],intensity:null},"DTTA":{temp:17,conditions:[],intensity:null},"DTMB":{temp:17,conditions:[],intensity:null},"DTTJ":{temp:19,conditions:[],intensity:null},"HECA":{temp:19,conditions:[],intensity:null},
  "HEGN":{temp:21,conditions:[],intensity:null},"HESH":{temp:23,conditions:[],intensity:null},"HEBA":{temp:22,conditions:[],intensity:null},"HEAX":{temp:17,conditions:[],intensity:null},"HLLT":{temp:23,conditions:[],intensity:null},"DNMM":{temp:31,conditions:[],intensity:null},"DNAA":{temp:33,conditions:[],intensity:null},"DGAA":{temp:30,conditions:[],intensity:null},"DIAP":{temp:30,conditions:[],intensity:null},"GOBD":{temp:23,conditions:[],intensity:null},
  "GABS":{temp:26,conditions:[],intensity:null},"GVNP":{temp:24,conditions:[],intensity:null},"GBYD":{temp:29,conditions:[],intensity:null},"GLRB":{temp:30,conditions:[],intensity:null},"DXXX":{temp:31,conditions:[],intensity:null},"DBBB":{temp:32,conditions:[],intensity:null},"HKJK":{temp:26,conditions:[],intensity:null},"HKMO":{temp:35,conditions:[],intensity:null},"HTDA":{temp:31,conditions:[],intensity:null},"HTKJ":{temp:32,conditions:[],intensity:null},
  "HUEN":{temp:22,conditions:[],intensity:null},"HRYR":{temp:26,conditions:[],intensity:null},"HAAB":{temp:24,conditions:[],intensity:null},"HDAM":{temp:27,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:29,conditions:[],intensity:null},"FIMP":{temp:26,conditions:[],intensity:null},"FMCH":{temp:29,conditions:["thunderstorm"],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:30,conditions:[],intensity:null},"FKYS":{temp:26,conditions:[],intensity:null},"FOOL":{temp:28,conditions:[],intensity:null},"FZAA":{temp:28,conditions:[],intensity:null},"FCBB":{temp:28,conditions:[],intensity:null},"FLLK":{temp:27,conditions:[],intensity:null},"FVHA":{temp:27,conditions:[],intensity:null},"FLLS":{temp:27,conditions:[],intensity:null},"FYWH":{temp:26,conditions:[],intensity:null},
  "FBSK":{temp:33,conditions:[],intensity:null},"FAOR":{temp:26,conditions:[],intensity:null},"FACT":{temp:24,conditions:[],intensity:null},"FALE":{temp:30,conditions:[],intensity:null},"FAPE":{temp:24,conditions:[],intensity:null},"FQMA":{temp:31,conditions:[],intensity:null},"FWKI":{temp:24,conditions:[],intensity:null},"ZBAA":{temp:-1,conditions:[],intensity:null},"ZBAD":{temp:-1,conditions:[],intensity:null},"ZSPD":{temp:6,conditions:[],intensity:null},
  "ZSSS":{temp:6,conditions:[],intensity:null},"ZGGG":{temp:19,conditions:[],intensity:null},"VHHH":{temp:19,conditions:[],intensity:null},"ZGSZ":{temp:21,conditions:[],intensity:null},"ZUUU":{temp:12,conditions:[],intensity:null},"ZUCK":{temp:11,conditions:[],intensity:null},"ZHCC":{temp:6,conditions:[],intensity:null},"ZLXY":{temp:5,conditions:[],intensity:null},"ZWSH":{temp:-7,conditions:[],intensity:null},"ZYHB":{temp:-17,conditions:[],intensity:null},
  "ZYTX":{temp:-11,conditions:[],intensity:null},"ZSAM":{temp:14,conditions:[],intensity:null},"ZGKL":{temp:11,conditions:[],intensity:null},"ZSNJ":{temp:7,conditions:[],intensity:null},"ZSHC":{temp:7,conditions:[],intensity:null},"ZPPP":{temp:16,conditions:[],intensity:null},"ZBTJ":{temp:-2,conditions:[],intensity:null},"VMMC":{temp:19,conditions:[],intensity:null},"RJTT":{temp:5,conditions:[],intensity:null},"RJAA":{temp:4,conditions:[],intensity:null},
  ...
  "RKSS":{temp:-6,conditions:[],intensity:null},"RKPK":{temp:-1,conditions:[],intensity:null},"RKPC":{temp:2,conditions:[],intensity:null},"RKTN":{temp:-4,conditions:[],intensity:null},"ZKPY":{temp:-11,conditions:[],intensity:null},"WSSS":{temp:28,conditions:[],intensity:null},"WMKK":{temp:29,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:27,conditions:["thunderstorm"],intensity:null},"WBGG":{temp:27,conditions:[],intensity:null},
  "VTBS":{temp:32,conditions:[],intensity:null},"VTBD":{temp:31,conditions:[],intensity:null},"VTSP":{temp:31,conditions:[],intensity:null},"VTCC":{temp:29,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:27,conditions:[],intensity:null},"VVNB":{temp:22,conditions:[],intensity:null},"VVTS":{temp:30,conditions:[],intensity:null},"VVDN":{temp:20,conditions:[],intensity:null},"VVCR":{temp:25,conditions:[],intensity:null},
  ...
  "VOMM":{temp:28,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:29,conditions:[],intensity:null},"VAAH":{temp:27,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:29,conditions:[],intensity:null},"VOTP":{temp:29,conditions:[],intensity:null},"VIAR":{temp:17,conditions:[],intensity:null},"VIJP":{temp:20,conditions:[],intensity:null},"VELR":{temp:17,conditions:[],intensity:null},
  ...
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:18,conditions:[],intensity:null},"YSSY":{temp:21,conditions:[],intensity:null},"YMML":{temp:18,conditions:[],intensity:null},"YBBN":{temp:24,conditions:[],intensity:null},"YPPH":{temp:26,conditions:[],intensity:null},"YPAD":{temp:23,conditions:[],intensity:null},"YBCG":{temp:20,conditions:[],intensity:null},"YBCS":{temp:24,conditions:[],intensity:null},"YSCB":{temp:25,conditions:[],intensity:null},
  "YMHB":{temp:17,conditions:[],intensity:null},"NZAA":{temp:21,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:15,conditions:[],intensity:null},"NZQN":{temp:16,conditions:[],intensity:null},"NZDN":{temp:15,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:28,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
