...
// Last updated: 2026-01-01T14:56:30.298Z
// Coverage: 476 airports, 23 with active weather
...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:6,condition:null,intensity:null},"KLAX":{temp:15,condition:null,intensity:null},"KORD":{temp:-11,condition:null,intensity:null},"KDFW":{temp:8,condition:null,intensity:null},"KDEN":{temp:4,condition:null,intensity:null},"KJFK":{temp:-4,condition:null,intensity:null},"KSFO":{temp:11,condition:null,intensity:null},"KSEA":{temp:2,condition:"fog",intensity:null},"KLAS":{temp:8,condition:null,intensity:null},"KMCO":{temp:11,condition:null,intensity:null},
  "KEWR":{temp:-4,condition:null,intensity:null},"KMIA":{temp:13,condition:null,intensity:null},"KPHX":{temp:14,condition:null,intensity:null},"KIAH":{temp:8,condition:null,intensity:null},"KBOS":{temp:-4,condition:null,intensity:null},"KMSP":{temp:-15,condition:null,intensity:null},"KFLL":{temp:14,condition:null,intensity:null},"KDTW":{temp:-10,condition:null,intensity:null},"KPHL":{temp:-3,condition:null,intensity:null},"KLGA":{temp:-4,condition:null,intensity:null},
  "KBWI":{temp:-1,condition:null,intensity:null},"KSLC":{temp:1,condition:null,intensity:null},"KDCA":{temp:-1,condition:null,intensity:null},"KIAD":{temp:-2,condition:null,intensity:null},"KSAN":{temp:17,condition:null,intensity:null},"KTPA":{temp:11,condition:null,intensity:null},"KPDX":{temp:4,condition:null,intensity:null},"KSTL":{temp:0,condition:null,intensity:null},"KHNL":{temp:23,condition:null,intensity:null},"KMEM":{temp:6,condition:null,intensity:null},
  "KAUS":{temp:7,condition:null,intensity:null},"KBNA":{temp:3,condition:null,intensity:null},"KRDU":{temp:7,condition:null,intensity:null},"KCLT":{temp:7,condition:null,intensity:null},"KSMF":{temp:8,condition:null,intensity:null},"KSJC":{temp:11,condition:null,intensity:null},"KOAK":{temp:11,condition:null,intensity:null},"KCLE":{temp:-10,condition:null,intensity:null},"KMKE":{temp:-12,condition:null,intensity:null},"KPIT":{temp:-10,condition:null,intensity:null},
  "KIND":{temp:-5,condition:null,intensity:null},"KCVG":{temp:-4,condition:null,intensity:null},"KMCI":{temp:-1,condition:null,intensity:null},"KSAT":{temp:8,condition:null,intensity:null},"KHOU":{temp:10,condition:null,intensity:null},"KDAL":{temp:8,condition:null,intensity:null},"KMDW":{temp:-11,condition:null,intensity:null},"PANC":{temp:-9,condition:null,intensity:null},"PAFA":{temp:-37,condition:null,intensity:null},"CYYZ":{temp:-12,condition:null,intensity:null},
  "CYVR":{temp:3,condition:"fog",intensity:null},"CYUL":{temp:-12,condition:null,intensity:null},"CYYC":{temp:-3,condition:null,intensity:null},"CYEG":{temp:-8,condition:"snow",intensity:null},"CYOW":{temp:-16,condition:null,intensity:null},"CYWG":{temp:-20,condition:null,intensity:null},"CYHZ":{temp:1,condition:null,intensity:null},"CYQB":{temp:-8,condition:"snow",intensity:"light"},"CYYJ":{temp:3,condition:"fog",intensity:null},"CYLW":{temp:-4,condition:null,intensity:null},
  "CYXE":{temp:-22,condition:null,intensity:null},"CYQR":{temp:-14,condition:null,intensity:null},"CYZF":{temp:-32,condition:null,intensity:null},"CYXY":{temp:-25,condition:null,intensity:null},"CYQT":{temp:-25,condition:null,intensity:null},"CYYT":{temp:2,condition:null,intensity:null},"MMMX":{temp:10,condition:null,intensity:null},"MMUN":{temp:21,condition:null,intensity:null},"MMGL":{temp:15,condition:null,intensity:null},"MMMY":{temp:12,condition:null,intensity:null},
  "MMTJ":{temp:16,condition:null,intensity:null},"MMSM":{temp:26,condition:null,intensity:null},"MMMD":{temp:21,condition:null,intensity:null},"MMCZ":{temp:21,condition:null,intensity:null},"MMSD":{temp:21,condition:null,intensity:null},"MGGT":{temp:15,condition:null,intensity:null},"MSLP":{temp:27,condition:null,intensity:null},"MHTG":{temp:22,condition:null,intensity:null},"MNMG":{temp:26,condition:null,intensity:null},"MROC":{temp:26,condition:null,intensity:null},
  "MPTO":{temp:28,condition:null,intensity:null},"MKJP":{temp:28,condition:null,intensity:null},"TNCM":{temp:26,condition:null,intensity:null},"TBPB":{temp:27,condition:null,intensity:null},"TTPP":{temp:31,condition:null,intensity:null},"MWCR":{temp:23,condition:null,intensity:null},"MUHA":{temp:20,condition:null,intensity:null},"MDSD":{temp:25,condition:null,intensity:null},"MDPP":{temp:26,condition:null,intensity:null},"MTPP":{temp:27,condition:null,intensity:null},
  "TJSJ":{temp:27,condition:null,intensity:null},"TIST":{temp:26,condition:null,intensity:null},"TLPL":{temp:29,condition:null,intensity:null},"TAPA":{temp:27,condition:null,intensity:null},"SBGR":{temp:30,condition:null,intensity:null},"SBGL":{temp:37,condition:null,intensity:null},"SBBR":{temp:28,condition:null,intensity:null},"SBCF":{temp:30,condition:null,intensity:null},"SBSV":{temp:29,condition:null,intensity:null},"SBRF":{temp:32,condition:null,intensity:null},
  "SBPA":{temp:32,condition:null,intensity:null},"SBCT":{temp:27,condition:null,intensity:null},"SBFZ":{temp:32,condition:null,intensity:null},"SCEL":{temp:28,condition:null,intensity:null},"SAEZ":{temp:26,condition:null,intensity:null},"SABE":{temp:26,condition:null,intensity:null},"SACO":{temp:33,condition:null,intensity:null},"SAME":{temp:31,condition:null,intensity:null},"SLLP":{temp:13,condition:null,intensity:null},"SLVR":{temp:27,condition:null,intensity:null},
  "SPJC":{temp:19,condition:null,intensity:null},"SEQM":{temp:15,condition:null,intensity:null},"SEGU":{temp:27,condition:null,intensity:null},"SKBO":{temp:16,condition:null,intensity:null},"SKMR":{temp:30,condition:null,intensity:null},"SKCL":{temp:23,condition:null,intensity:null},"SKMD":{temp:26,condition:null,intensity:null},"SKRG":{temp:17,condition:null,intensity:null},"SVMI":{temp:27,condition:null,intensity:null},"SUMU":{temp:26,condition:null,intensity:null},
  "SGAS":{temp:28,condition:null,intensity:null},"SBBV":{temp:31,condition:null,intensity:null},"SMJP":{temp:30,condition:null,intensity:null},"SYCJ":{temp:28,condition:null,intensity:null},"EGLL":{temp:6,condition:null,intensity:null},"EGKK":{temp:5,condition:null,intensity:null},"EGSS":{temp:5,condition:null,intensity:null},"EGLC":{temp:6,condition:null,intensity:null},"EGCC":{temp:6,condition:null,intensity:null},"EGBB":{temp:6,condition:null,intensity:null},
  "EGPH":{temp:4,condition:null,intensity:null},"EGPF":{temp:4,condition:null,intensity:null},"EGGW":{temp:5,condition:null,intensity:null},"EGNX":{temp:6,condition:null,intensity:null},"EGNT":{temp:3,condition:null,intensity:null},"EGGP":{temp:7,condition:null,intensity:null},"EGHI":{temp:7,condition:null,intensity:null},"EGGD":{temp:5,condition:null,intensity:null},"EGPD":{temp:2,condition:null,intensity:null},"EGAA":{temp:5,condition:null,intensity:null},
  "EIDW":{temp:6,condition:null,intensity:null},"EICK":{temp:7,condition:null,intensity:null},"EINN":{temp:8,condition:null,intensity:null},"LFPG":{temp:4,condition:null,intensity:null},"LFPO":{temp:4,condition:null,intensity:null},"LFML":{temp:10,condition:null,intensity:null},"LFLL":{temp:3,condition:null,intensity:null},"LFMN":{temp:12,condition:null,intensity:null},"LFBD":{temp:4,condition:null,intensity:null},"LFBO":{temp:4,condition:null,intensity:null},
  "LFRS":{temp:3,condition:null,intensity:null},"LFSB":{temp:1,condition:null,intensity:null},"LFPB":{temp:5,condition:null,intensity:null},"EDDF":{temp:3,condition:null,intensity:null},"EDDM":{temp:2,condition:null,intensity:null},"EDDB":{temp:2,condition:"snow",intensity:null},"EDDL":{temp:3,condition:null,intensity:null},"EDDH":{temp:3,condition:null,intensity:null},"EDDK":{temp:3,condition:null,intensity:null},"EDDS":{temp:2,condition:null,intensity:null},
  "EDDW":{temp:3,condition:null,intensity:null},"EDDN":{temp:1,condition:null,intensity:null},"EDDV":{temp:3,condition:null,intensity:null},"EDDP":{temp:2,condition:null,intensity:null},"LEMD":{temp:7,condition:null,intensity:null},"LEBL":{temp:12,condition:null,intensity:null},"LEPA":{temp:14,condition:null,intensity:null},"LEMG":{temp:15,condition:null,intensity:null},"LEVC":{temp:14,condition:null,intensity:null},"LEAL":{temp:14,condition:null,intensity:null},
  "LEZL":{temp:14,condition:null,intensity:null},"GCLP":{temp:22,condition:null,intensity:null},"GCTS":{temp:18,condition:null,intensity:null},"GCLA":{temp:19,condition:null,intensity:null},"GCFV":{temp:23,condition:null,intensity:null},"LPPT":{temp:13,condition:null,intensity:null},"LPPR":{temp:10,condition:null,intensity:null},"LPFR":{temp:17,condition:null,intensity:null},"LPMA":{temp:17,condition:null,intensity:null},"LIRF":{temp:11,condition:null,intensity:null},
  "LIMC":{temp:4,condition:null,intensity:null},"LIME":{temp:3,condition:null,intensity:null},"LIPZ":{temp:4,condition:null,intensity:null},"LIRN":{temp:10,condition:null,intensity:null},"LIML":{temp:4,condition:null,intensity:null},"LIPE":{temp:7,condition:null,intensity:null},"LICC":{temp:12,condition:null,intensity:null},"LICJ":{temp:14,condition:null,intensity:null},"LIRA":{temp:9,condition:null,intensity:null},"LIRP":{temp:7,condition:null,intensity:null},
  "LIMF":{temp:4,condition:null,intensity:null},"LIEO":{temp:14,condition:null,intensity:null},"LIEE":{temp:14,condition:null,intensity:null},"EHAM":{temp:6,condition:null,intensity:null},"EHRD":{temp:6,condition:null,intensity:null},"EHEH":{temp:4,condition:null,intensity:null},"EBBR":{temp:4,condition:null,intensity:null},"EBCI":{temp:3,condition:null,intensity:null},"ELLX":{temp:0,condition:null,intensity:null},"LSZH":{temp:1,condition:null,intensity:null},
  "LSGG":{temp:5,condition:null,intensity:null},"LSZB":{temp:1,condition:null,intensity:null},"LOWW":{temp:4,condition:null,intensity:null},"LOWS":{temp:-1,condition:null,intensity:null},"LOWG":{temp:0,condition:null,intensity:null},"LOWI":{temp:0,condition:null,intensity:null},"LKPR":{temp:0,condition:null,intensity:null},"EPWA":{temp:1,condition:null,intensity:null},"EPKK":{temp:0,condition:null,intensity:null},"EPGD":{temp:0,condition:"snow",intensity:"light"},
  "EPWR":{temp:1,condition:null,intensity:null},"EPPO":{temp:1,condition:null,intensity:null},"EKCH":{temp:5,condition:null,intensity:null},"ESSA":{temp:1,condition:null,intensity:null},"ENGM":{temp:-3,condition:null,intensity:null},"EFHK":{temp:-12,condition:null,intensity:null},"BIKF":{temp:4,condition:null,intensity:null},"ESGG":{temp:2,condition:null,intensity:null},"ESMS":{temp:3,condition:null,intensity:null},"ENBR":{temp:2,condition:null,intensity:null},
  "ENZV":{temp:6,condition:null,intensity:null},"ENTC":{temp:-14,condition:null,intensity:null},"EFOU":{temp:-18,condition:null,intensity:null},"EFRO":{temp:-17,condition:null,intensity:null},"LGAV":{temp:5,condition:null,intensity:null},"LGTS":{temp:4,condition:null,intensity:null},"LGIR":{temp:9,condition:null,intensity:null},"LGKR":{temp:9,condition:null,intensity:null},"LGRP":{temp:7,condition:null,intensity:null},"LGSR":{temp:8,condition:null,intensity:null},
  "LGMK":{temp:7,condition:null,intensity:null},"LTFM":{temp:0,condition:null,intensity:null},"LTBA":{temp:1,condition:null,intensity:null},"LTFJ":{temp:1,condition:null,intensity:null},"LTAI":{temp:7,condition:null,intensity:null},"LTAC":{temp:-5,condition:null,intensity:null},"LTBJ":{temp:2,condition:null,intensity:null},"LTBS":{temp:9,condition:null,intensity:null},"LTFE":{temp:5,condition:null,intensity:null},"LCLK":{temp:14,condition:null,intensity:null},
  "LCPH":{temp:13,condition:null,intensity:null},"LHBP":{temp:2,condition:null,intensity:null},"LROP":{temp:-1,condition:null,intensity:null},"LBSF":{temp:0,condition:null,intensity:null},"LYBE":{temp:4,condition:null,intensity:null},"LDZA":{temp:5,condition:null,intensity:null},"LDDU":{temp:6,condition:null,intensity:null},"LDSP":{temp:7,condition:null,intensity:null},"LJLJ":{temp:2,condition:null,intensity:null},"LWSK":{temp:2,condition:null,intensity:null},
  "LATI":{temp:6,condition:null,intensity:null},"UKBB":{temp:-12,condition:null,intensity:null},"UKLL":{temp:-2,condition:null,intensity:null},"UUEE":{temp:-12,condition:null,intensity:null},"UUDD":{temp:-11,condition:null,intensity:null},"UUWW":{temp:-12,condition:null,intensity:null},"ULLI":{temp:-11,condition:null,intensity:null},"UWWW":{temp:-10,condition:null,intensity:null},"USSS":{temp:-11,condition:"snow",intensity:null},"UNNT":{temp:-10,condition:null,intensity:null},
  "UUOB":{temp:-30,condition:null,intensity:null},"UHWW":{temp:-14,condition:null,intensity:null},"UEEE":{temp:-26,condition:"snow",intensity:"light"},"OMDB":{temp:21,condition:null,intensity:null},"OMDW":{temp:19,condition:null,intensity:null},"OMAA":{temp:20,condition:null,intensity:null},"OMSJ":{temp:20,condition:null,intensity:null},"OTHH":{temp:19,condition:null,intensity:null},"OERK":{temp:21,condition:null,intensity:null},"OEJN":{temp:27,condition:null,intensity:null},
  "OEDF":{temp:19,condition:null,intensity:null},"OEMA":{temp:23,condition:null,intensity:null},"OKBK":{temp:17,condition:null,intensity:null},"OBBI":{temp:20,condition:null,intensity:null},"OOMS":{temp:22,condition:null,intensity:null},"OYAA":{temp:16,condition:null,intensity:null},"OIIE":{temp:6,condition:null,intensity:null},"OIII":{temp:6,condition:null,intensity:null},"OISS":{temp:9,condition:null,intensity:null},"OIKB":{temp:20,condition:null,intensity:null},
  "OIAW":{temp:15,condition:null,intensity:null},"OIKK":{temp:9,condition:null,intensity:null},"OICC":{temp:7,condition:null,intensity:null},"LLBG":{temp:15,condition:null,intensity:null},"OLBA":{temp:15,condition:"thunderstorm",intensity:null},"OJAM":{temp:12,condition:null,intensity:null},"ORBI":{temp:15,condition:null,intensity:null},"ORER":{temp:7,condition:null,intensity:null},"GMMN":{temp:23,condition:null,intensity:null},"GMME":{temp:22,condition:null,intensity:null},
  "GMMX":{temp:23,condition:null,intensity:null},"GMTT":{temp:18,condition:null,intensity:null},"GMFF":{temp:18,condition:null,intensity:null},"GMAD":{temp:26,condition:null,intensity:null},"DAAG":{temp:17,condition:null,intensity:null},"DAOO":{temp:17,condition:null,intensity:null},"DTTA":{temp:17,condition:null,intensity:null},"DTMB":{temp:16,condition:null,intensity:null},"DTTJ":{temp:16,condition:null,intensity:null},"HECA":{temp:19,condition:null,intensity:null},
  "HEGN":{temp:22,condition:null,intensity:null},"HESH":{temp:21,condition:null,intensity:null},"HEBA":{temp:23,condition:null,intensity:null},"HEAX":{temp:16,condition:null,intensity:null},"HLLT":{temp:16,condition:null,intensity:null},"DNMM":{temp:33,condition:null,intensity:null},"DNAA":{temp:37,condition:null,intensity:null},"DGAA":{temp:31,condition:null,intensity:null},"DIAP":{temp:29,condition:"thunderstorm",intensity:null},"GOBD":{temp:33,condition:null,intensity:null},
  "GABS":{temp:35,condition:null,intensity:null},"GVNP":{temp:28,condition:null,intensity:null},"GBYD":{temp:29,condition:null,intensity:null},"GLRB":{temp:28,condition:null,intensity:null},"DXXX":{temp:32,condition:null,intensity:null},"DBBB":{temp:32,condition:null,intensity:null},"HKJK":{temp:22,condition:null,intensity:null},"HKMO":{temp:30,condition:null,intensity:null},"HTDA":{temp:28,condition:null,intensity:null},"HTKJ":{temp:26,condition:null,intensity:null},
  "HUEN":{temp:25,condition:null,intensity:null},"HRYR":{temp:26,condition:null,intensity:null},"HAAB":{temp:19,condition:null,intensity:null},"HDAM":{temp:25,condition:null,intensity:null},"HCMM":{temp:28,condition:null,intensity:null},"OYSN":{temp:22,condition:null,intensity:null},"FMEE":{temp:25,condition:null,intensity:null},"FIMP":{temp:22,condition:null,intensity:null},"FMCH":{temp:30,condition:null,intensity:null},"FMMI":{temp:22,condition:"thunderstorm",intensity:"light"},
  "FSIA":{temp:28,condition:null,intensity:null},"FKKD":{temp:29,condition:null,intensity:null},"FKYS":{temp:30,condition:null,intensity:null},"FOOL":{temp:27,condition:"thunderstorm",intensity:null},"FZAA":{temp:29,condition:null,intensity:null},"FCBB":{temp:27,condition:null,intensity:null},"FLLK":{temp:27,condition:null,intensity:null},"FVHA":{temp:27,condition:null,intensity:null},"FLLS":{temp:26,condition:null,intensity:null},"FYWH":{temp:28,condition:null,intensity:null},
  "FBSK":{temp:31,condition:null,intensity:null},"FAOR":{temp:23,condition:null,intensity:null},"FACT":{temp:25,condition:null,intensity:null},"FALE":{temp:22,condition:null,intensity:null},"FAPE":{temp:25,condition:null,intensity:null},"FQMA":{temp:31,condition:null,intensity:null},"FWKI":{temp:21,condition:"thunderstorm",intensity:null},"ZBAA":{temp:-5,condition:null,intensity:null},"ZBAD":{temp:-7,condition:null,intensity:null},"ZSPD":{temp:5,condition:null,intensity:null},
  "ZSSS":{temp:3,condition:null,intensity:null},"ZGGG":{temp:12,condition:null,intensity:null},"VHHH":{temp:16,condition:null,intensity:null},"ZGSZ":{temp:15,condition:null,intensity:null},"ZUUU":{temp:7,condition:null,intensity:null},"ZUCK":{temp:9,condition:null,intensity:null},"ZHCC":{temp:0,condition:null,intensity:null},"ZLXY":{temp:0,condition:null,intensity:null},"ZWSH":{temp:-12,condition:null,intensity:null},"ZYHB":{temp:-22,condition:null,intensity:null},
  "ZYTX":{temp:-16,condition:null,intensity:null},"ZSAM":{temp:12,condition:null,intensity:null},"ZGKL":{temp:5,condition:null,intensity:null},"ZSNJ":{temp:1,condition:null,intensity:null},"ZSHC":{temp:4,condition:null,intensity:null},"ZPPP":{temp:7,condition:null,intensity:null},"ZBTJ":{temp:-5,condition:null,intensity:null},"VMMC":{temp:15,condition:null,intensity:null},"RJTT":{temp:5,condition:null,intensity:null},"RJAA":{temp:3,condition:null,intensity:null},
  ...
  "RKSS":{temp:-11,condition:null,intensity:null},"RKPK":{temp:-5,condition:null,intensity:null},"RKPC":{temp:4,condition:null,intensity:null},"RKTN":{temp:-8,condition:null,intensity:null},"ZKPY":{temp:-14,condition:null,intensity:null},"WSSS":{temp:26,condition:null,intensity:null},"WMKK":{temp:26,condition:null,intensity:null},"WMKP":{temp:28,condition:null,intensity:null},"WBKK":{temp:28,condition:"thunderstorm",intensity:null},"WBGG":{temp:24,condition:"fog",intensity:null},
  "VTBS":{temp:27,condition:null,intensity:null},"VTBD":{temp:26,condition:null,intensity:null},"VTSP":{temp:28,condition:null,intensity:null},"VTCC":{temp:21,condition:null,intensity:null},"VTSS":{temp:26,condition:null,intensity:null},"VTUK":{temp:25,condition:null,intensity:null},"VVNB":{temp:17,condition:null,intensity:null},"VVTS":{temp:24,condition:null,intensity:null},"VVDN":{temp:18,condition:null,intensity:null},"VVCR":{temp:20,condition:null,intensity:null},
  "VDPP":{temp:25,condition:null,intensity:null},"VDSR":{temp:23,condition:null,intensity:null},"VLVT":{temp:21,condition:null,intensity:null},"VLLB":{temp:20,condition:null,intensity:null},"VYYY":{temp:24,condition:null,intensity:null},"VYMD":{temp:20,condition:null,intensity:null},"VGHS":{temp:15,condition:null,intensity:null},"VGCG":{temp:20,condition:null,intensity:null},"VECC":{temp:17,condition:null,intensity:null},"VRMM":{temp:27,condition:null,intensity:null},
  "VCBI":{temp:26,condition:null,intensity:null},"WIII":{temp:25,condition:null,intensity:null},"WADD":{temp:29,condition:null,intensity:null},"WARR":{temp:26,condition:null,intensity:null},"WIHH":{temp:27,condition:null,intensity:null},"WIMM":{temp:26,condition:null,intensity:null},"WIBB":{temp:28,condition:"thunderstorm",intensity:null},"WAFF":{temp:27,condition:null,intensity:null},"WICC":{temp:23,condition:null,intensity:null},"WASS":{temp:28,condition:null,intensity:null},
  "RPLL":{temp:27,condition:null,intensity:null},"RPLC":{temp:24,condition:"thunderstorm",intensity:null},"RPVM":{temp:25,condition:"fog",intensity:null},"RPVD":{temp:25,condition:"thunderstorm",intensity:null},"RPVK":{temp:23,condition:"fog",intensity:null},"WBSB":{temp:25,condition:"thunderstorm",intensity:null},"WBLL":{temp:27,condition:"thunderstorm",intensity:null},"VIDP":{temp:14,condition:null,intensity:null},"VABB":{temp:25,condition:null,intensity:null},"VOBL":{temp:21,condition:null,intensity:null},
  "VOMM":{temp:24,condition:null,intensity:null},"VEBS":{temp:17,condition:null,intensity:null},"VOHY":{temp:21,condition:null,intensity:null},"VAAH":{temp:22,condition:null,intensity:null},"VOCI":{temp:28,condition:null,intensity:null},"VAGO":{temp:26,condition:null,intensity:null},"VOTP":{temp:24,condition:null,intensity:null},"VIAR":{temp:13,condition:null,intensity:null},"VIJP":{temp:17,condition:null,intensity:null},"VELR":{temp:11,condition:null,intensity:null},
  "VOCL":{temp:27,condition:null,intensity:null},"VOTV":{temp:27,condition:null,intensity:null},"VEPT":{temp:15,condition:null,intensity:null},"VNKT":{temp:11,condition:null,intensity:null},"OPKC":{temp:22,condition:null,intensity:null},"OPLA":{temp:13,condition:null,intensity:null},"OPIS":{temp:11,condition:null,intensity:null},"RCTP":{temp:15,condition:null,intensity:null},"RCSS":{temp:15,condition:null,intensity:null},"RCMQ":{temp:15,condition:null,intensity:null},
  "RCKH":{temp:18,condition:null,intensity:null},"RCNN":{temp:17,condition:null,intensity:null},"YSSY":{temp:14,condition:null,intensity:null},"YMML":{temp:14,condition:null,intensity:null},"YBBN":{temp:23,condition:null,intensity:null},"YPPH":{temp:27,condition:null,intensity:null},"YPAD":{temp:19,condition:null,intensity:null},"YBCG":{temp:19,condition:null,intensity:null},"YBCS":{temp:24,condition:null,intensity:null},"YSCB":{temp:12,condition:null,intensity:null},
