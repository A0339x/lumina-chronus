...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:32,conditions:[],intensity:null},"KLAX":{temp:19,conditions:[],intensity:null},"KORD":{temp:30,conditions:["thunderstorm"],intensity:null},"KDFW":{temp:32,conditions:[],intensity:null},"KDEN":{temp:23,conditions:[],intensity:null},"KJFK":{temp:29,conditions:[],intensity:null},"KSFO":{temp:18,conditions:[],intensity:null},"KSEA":{temp:14,conditions:[],intensity:null},"KLAS":{temp:26,conditions:[],intensity:null},"KMCO":{temp:33,conditions:["thunderstorm"],intensity:null},
  "KEWR":{temp:31,conditions:[],intensity:null},"KMIA":{temp:33,conditions:["thunderstorm"],intensity:null},"KPHX":{temp:32,conditions:[],intensity:null},"KIAH":{temp:31,conditions:["thunderstorm"],intensity:null},"KBOS":{temp:23,conditions:[],intensity:null},"KMSP":{temp:31,conditions:["thunderstorm"],intensity:null},"KFLL":{temp:32,conditions:["thunderstorm"],intensity:null},"KDTW":{temp:30,conditions:[],intensity:null},"KPHL":{temp:28,conditions:[],intensity:null},"KLGA":{temp:30,conditions:[],intensity:null},
  "KBWI":{temp:27,conditions:[],intensity:null},"KSLC":{temp:14,conditions:[],intensity:null},"KDCA":{temp:27,conditions:[],intensity:null},"KIAD":{temp:26,conditions:[],intensity:null},"KSAN":{temp:20,conditions:[],intensity:null},"KTPA":{temp:34,conditions:["thunderstorm"],intensity:null},"KPDX":{temp:15,conditions:[],intensity:null},"KSTL":{temp:31,conditions:["thunderstorm"],intensity:null},"KHNL":{temp:23,conditions:[],intensity:null},"KMEM":{temp:31,conditions:[],intensity:null},
  "KAUS":{temp:31,conditions:["thunderstorm"],intensity:null},"KBNA":{temp:30,conditions:["thunderstorm"],intensity:null},"KRDU":{temp:28,conditions:[],intensity:null},"KCLT":{temp:30,conditions:[],intensity:null},"KSMF":{temp:19,conditions:[],intensity:null},"KSJC":{temp:17,conditions:[],intensity:null},"KOAK":{temp:17,conditions:[],intensity:null},"KCLE":{temp:30,conditions:[],intensity:null},"KMKE":{temp:30,conditions:["thunderstorm"],intensity:null},"KPIT":{temp:26,conditions:[],intensity:null},
  "KIND":{temp:29,conditions:["thunderstorm"],intensity:null},"KCVG":{temp:30,conditions:["thunderstorm"],intensity:null},"KMCI":{temp:31,conditions:[],intensity:null},"KSAT":{temp:30,conditions:[],intensity:null},"KHOU":{temp:33,conditions:["thunderstorm"],intensity:null},"KDAL":{temp:29,conditions:[],intensity:null},"KMDW":{temp:31,conditions:["thunderstorm"],intensity:null},"PANC":{temp:13,conditions:[],intensity:null},"PAFA":{temp:13,conditions:[],intensity:null},"CYYZ":{temp:26,conditions:[],intensity:null},
  "CYVR":{temp:16,conditions:[],intensity:null},"CYUL":{temp:27,conditions:[],intensity:null},"CYYC":{temp:15,conditions:[],intensity:null},"CYEG":{temp:20,conditions:[],intensity:null},"CYOW":{temp:27,conditions:[],intensity:null},"CYWG":{temp:23,conditions:[],intensity:null},"CYHZ":{temp:19,conditions:[],intensity:null},"CYQB":{temp:23,conditions:[],intensity:null},"CYYJ":{temp:16,conditions:[],intensity:null},"CYLW":{temp:20,conditions:[],intensity:null},
  "CYXE":{temp:16,conditions:[],intensity:null},"CYQR":{temp:18,conditions:[],intensity:null},"CYZF":{temp:24,conditions:[],intensity:null},"CYXY":{temp:10,conditions:[],intensity:null},"CYQT":{temp:17,conditions:[],intensity:null},"CYYT":{temp:19,conditions:[],intensity:null},"MMMX":{temp:18,conditions:[],intensity:null},"MMUN":{temp:31,conditions:["thunderstorm"],intensity:null},"MMGL":{temp:22,conditions:[],intensity:null},"MMMY":{temp:30,conditions:[],intensity:null},
  "MMTJ":{temp:19,conditions:[],intensity:null},"MMSM":{temp:33,conditions:[],intensity:null},"MMMD":{temp:31,conditions:[],intensity:null},"MMCZ":{temp:31,conditions:[],intensity:null},"MMSD":{temp:35,conditions:[],intensity:null},"MGGT":{temp:23,conditions:[],intensity:null},"MSLP":{temp:34,conditions:[],intensity:null},"MHTG":{temp:26,conditions:[],intensity:null},"MNMG":{temp:32,conditions:[],intensity:null},"MROC":{temp:29,conditions:[],intensity:null},
  "MPTO":{temp:33,conditions:[],intensity:null},"MKJP":{temp:32,conditions:[],intensity:null},"TNCM":{temp:28,conditions:[],intensity:null},"TBPB":{temp:29,conditions:[],intensity:null},"TTPP":{temp:28,conditions:["thunderstorm"],intensity:null},"MWCR":{temp:31,conditions:["thunderstorm"],intensity:null},"MUHA":{temp:32,conditions:[],intensity:null},"MDSD":{temp:28,conditions:["thunderstorm"],intensity:null},"MDPP":{temp:31,conditions:["thunderstorm"],intensity:null},"MTPP":{temp:35,conditions:[],intensity:null},
  "TJSJ":{temp:29,conditions:["thunderstorm"],intensity:null},"TIST":{temp:27,conditions:["thunderstorm"],intensity:null},"TLPL":{temp:28,conditions:["thunderstorm"],intensity:null},"TAPA":{temp:30,conditions:[],intensity:null},"SBGR":{temp:25,conditions:[],intensity:null},"SBGL":{temp:28,conditions:[],intensity:null},"SBBR":{temp:23,conditions:[],intensity:null},"SBCF":{temp:24,conditions:[],intensity:null},"SBSV":{temp:27,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null},
  "SBPA":{temp:16,conditions:[],intensity:null},"SBCT":{temp:20,conditions:["thunderstorm"],intensity:null},"SBFZ":{temp:28,conditions:[],intensity:null},"SCEL":{temp:16,conditions:[],intensity:null},"SAEZ":{temp:12,conditions:[],intensity:null},"SABE":{temp:13,conditions:[],intensity:null},"SACO":{temp:13,conditions:[],intensity:null},"SAME":{temp:10,conditions:[],intensity:null},"SLLP":{temp:12,conditions:[],intensity:null},"SLVR":{temp:22,conditions:[],intensity:null},
  "SPJC":{temp:24,conditions:[],intensity:null},"SEQM":{temp:21,conditions:[],intensity:null},"SEGU":{temp:29,conditions:[],intensity:null},"SKBO":{temp:17,conditions:[],intensity:null},"SKMR":{temp:33,conditions:[],intensity:null},"SKCL":{temp:27,conditions:[],intensity:null},"SKMD":{temp:29,conditions:[],intensity:null},"SKRG":{temp:22,conditions:[],intensity:null},"SVMI":{temp:32,conditions:[],intensity:null},"SUMU":{temp:13,conditions:[],intensity:null},
  "SGAS":{temp:18,conditions:[],intensity:null},"SBBV":{temp:31,conditions:[],intensity:null},"SMJP":{temp:32,conditions:[],intensity:null},"SYCJ":{temp:29,conditions:[],intensity:null},"EGLL":{temp:23,conditions:[],intensity:null},"EGKK":{temp:22,conditions:[],intensity:null},"EGSS":{temp:22,conditions:[],intensity:null},"EGLC":{temp:24,conditions:[],intensity:null},"EGCC":{temp:20,conditions:[],intensity:null},"EGBB":{temp:21,conditions:[],intensity:null},
  "EGPH":{temp:18,conditions:[],intensity:null},"EGPF":{temp:16,conditions:[],intensity:null},"EGGW":{temp:21,conditions:[],intensity:null},"EGNX":{temp:21,conditions:[],intensity:null},"EGNT":{temp:19,conditions:[],intensity:null},"EGGP":{temp:20,conditions:[],intensity:null},"EGHI":{temp:21,conditions:[],intensity:null},"EGGD":{temp:18,conditions:[],intensity:null},"EGPD":{temp:19,conditions:[],intensity:null},"EGAA":{temp:18,conditions:[],intensity:null},
  "EIDW":{temp:19,conditions:[],intensity:null},"EICK":{temp:14,conditions:[],intensity:null},"EINN":{temp:16,conditions:[],intensity:null},"LFPG":{temp:26,conditions:[],intensity:null},"LFPO":{temp:27,conditions:[],intensity:null},"LFML":{temp:37,conditions:[],intensity:null},"LFLL":{temp:31,conditions:[],intensity:null},"LFMN":{temp:31,conditions:[],intensity:null},"LFBD":{temp:29,conditions:[],intensity:null},"LFBO":{temp:29,conditions:[],intensity:null},
  "LFRS":{temp:28,conditions:[],intensity:null},"LFSB":{temp:29,conditions:[],intensity:null},"LFPB":{temp:27,conditions:[],intensity:null},"EDDF":{temp:27,conditions:[],intensity:null},"EDDM":{temp:29,conditions:[],intensity:null},"EDDB":{temp:24,conditions:[],intensity:null},"EDDL":{temp:30,conditions:[],intensity:null},"EDDH":{temp:24,conditions:[],intensity:null},"EDDK":{temp:30,conditions:[],intensity:null},"EDDS":{temp:27,conditions:[],intensity:null},
  "EDDW":{temp:25,conditions:[],intensity:null},"EDDN":{temp:27,conditions:[],intensity:null},"EDDV":{temp:26,conditions:[],intensity:null},"EDDP":{temp:23,conditions:[],intensity:null},"LEMD":{temp:34,conditions:[],intensity:null},"LEBL":{temp:31,conditions:[],intensity:null},"LEPA":{temp:32,conditions:[],intensity:null},"LEMG":{temp:28,conditions:[],intensity:null},"LEVC":{temp:32,conditions:[],intensity:null},"LEAL":{temp:30,conditions:[],intensity:null},
  "LEZL":{temp:39,conditions:[],intensity:null},"GCLP":{temp:29,conditions:[],intensity:null},"GCTS":{temp:26,conditions:[],intensity:null},"GCLA":{temp:28,conditions:[],intensity:null},"GCFV":{temp:31,conditions:[],intensity:null},"LPPT":{temp:28,conditions:[],intensity:null},"LPPR":{temp:24,conditions:[],intensity:null},"LPFR":{temp:27,conditions:[],intensity:null},"LPMA":{temp:23,conditions:[],intensity:null},"LIRF":{temp:30,conditions:[],intensity:null},
  "LIMC":{temp:27,conditions:[],intensity:null},"LIME":{temp:27,conditions:[],intensity:null},"LIPZ":{temp:35,conditions:[],intensity:null},"LIRN":{temp:33,conditions:[],intensity:null},"LIML":{temp:24,conditions:["thunderstorm"],intensity:null},"LIPE":{temp:38,conditions:[],intensity:null},"LICC":{temp:30,conditions:[],intensity:null},"LICJ":{temp:31,conditions:[],intensity:null},"LIRA":{temp:33,conditions:[],intensity:null},"LIRP":{temp:32,conditions:[],intensity:null},
  "LIMF":{temp:27,conditions:[],intensity:null},"LIEO":{temp:33,conditions:[],intensity:null},"LIEE":{temp:34,conditions:[],intensity:null},"EHAM":{temp:24,conditions:[],intensity:null},"EHRD":{temp:22,conditions:[],intensity:null},"EHEH":{temp:27,conditions:[],intensity:null},"EBBR":{temp:27,conditions:[],intensity:null},"EBCI":{temp:25,conditions:[],intensity:null},"ELLX":{temp:28,conditions:[],intensity:null},"LSZH":{temp:30,conditions:[],intensity:null},
  "LSGG":{temp:30,conditions:[],intensity:null},"LSZB":{temp:28,conditions:[],intensity:null},"LOWW":{temp:31,conditions:[],intensity:null},"LOWS":{temp:31,conditions:[],intensity:null},"LOWG":{temp:34,conditions:[],intensity:null},"LOWI":{temp:23,conditions:[],intensity:null},"LKPR":{temp:27,conditions:[],intensity:null},"EPWA":{temp:36,conditions:[],intensity:null},"EPKK":{temp:29,conditions:[],intensity:null},"EPGD":{temp:26,conditions:[],intensity:null},
  "EPWR":{temp:32,conditions:[],intensity:null},"EPPO":{temp:28,conditions:[],intensity:null},"EKCH":{temp:27,conditions:[],intensity:null},"ESSA":{temp:28,conditions:[],intensity:null},"ENGM":{temp:26,conditions:[],intensity:null},"EFHK":{temp:26,conditions:[],intensity:null},"BIKF":{temp:11,conditions:[],intensity:null},"ESGG":{temp:22,conditions:[],intensity:null},"ESMS":{temp:25,conditions:[],intensity:null},"ENBR":{temp:16,conditions:[],intensity:null},
  "ENZV":{temp:16,conditions:[],intensity:null},"ENTC":{temp:12,conditions:[],intensity:null},"EFOU":{temp:22,conditions:[],intensity:null},"EFRO":{temp:21,conditions:[],intensity:null},"LGAV":{temp:29,conditions:[],intensity:null},"LGTS":{temp:33,conditions:[],intensity:null},"LGIR":{temp:26,conditions:[],intensity:null},"LGKR":{temp:33,conditions:[],intensity:null},"LGRP":{temp:29,conditions:[],intensity:null},"LGSR":{temp:28,conditions:[],intensity:null},
  "LGMK":{temp:25,conditions:[],intensity:null},"LTFM":{temp:26,conditions:[],intensity:null},"LTBA":{temp:29,conditions:[],intensity:null},"LTFJ":{temp:28,conditions:[],intensity:null},"LTAI":{temp:30,conditions:[],intensity:null},"LTAC":{temp:27,conditions:[],intensity:null},"LTBJ":{temp:34,conditions:[],intensity:null},"LTBS":{temp:29,conditions:[],intensity:null},"LTFE":{temp:32,conditions:[],intensity:null},"LCLK":{temp:32,conditions:[],intensity:null},
  "LCPH":{temp:29,conditions:[],intensity:null},"LHBP":{temp:40,conditions:[],intensity:null},"LROP":{temp:35,conditions:[],intensity:null},"LBSF":{temp:32,conditions:[],intensity:null},"LYBE":{temp:38,conditions:[],intensity:null},"LDZA":{temp:29,conditions:[],intensity:null},"LDDU":{temp:31,conditions:[],intensity:null},"LDSP":{temp:35,conditions:[],intensity:null},"LJLJ":{temp:34,conditions:[],intensity:null},"LWSK":{temp:35,conditions:[],intensity:null},
  "LATI":{temp:34,conditions:[],intensity:null},"UKBB":{temp:32,conditions:[],intensity:null},"UKLL":{temp:32,conditions:[],intensity:null},"UUEE":{temp:19,conditions:[],intensity:null},"UUDD":{temp:19,conditions:[],intensity:null},"UUWW":{temp:18,conditions:[],intensity:null},"ULLI":{temp:21,conditions:[],intensity:null},"UWWW":{temp:18,conditions:[],intensity:null},"USSS":{temp:16,conditions:[],intensity:null},"UNNT":{temp:25,conditions:[],intensity:null},
  "UUOB":{temp:16,conditions:[],intensity:null},"UHWW":{temp:15,conditions:[],intensity:null},"UEEE":{temp:20,conditions:[],intensity:null},"OMDB":{temp:33,conditions:[],intensity:null},"OMDW":{temp:33,conditions:[],intensity:null},"OMAA":{temp:34,conditions:[],intensity:null},"OMSJ":{temp:33,conditions:[],intensity:null},"OTHH":{temp:38,conditions:[],intensity:null},"OERK":{temp:38,conditions:[],intensity:null},"OEJN":{temp:34,conditions:[],intensity:null},
  "OEDF":{temp:38,conditions:[],intensity:null},"OEMA":{temp:40,conditions:[],intensity:null},"OKBK":{temp:42,conditions:[],intensity:null},"OBBI":{temp:34,conditions:[],intensity:null},"OOMS":{temp:35,conditions:[],intensity:null},"OYAA":{temp:26,conditions:[],intensity:null},"OIIE":{temp:33,conditions:[],intensity:null},"OIII":{temp:32,conditions:[],intensity:null},"OISS":{temp:32,conditions:[],intensity:null},"OIKB":{temp:34,conditions:[],intensity:null},
  "OIAW":{temp:42,conditions:[],intensity:null},"OIKK":{temp:33,conditions:[],intensity:null},"OICC":{temp:31,conditions:[],intensity:null},"LLBG":{temp:28,conditions:[],intensity:null},"OLBA":{temp:28,conditions:[],intensity:null},"OJAM":{temp:29,conditions:[],intensity:null},"ORBI":{temp:39,conditions:[],intensity:null},"ORER":{temp:39,conditions:[],intensity:null},"GMMN":{temp:31,conditions:[],intensity:null},"GMME":{temp:30,conditions:[],intensity:null},
  "GMMX":{temp:42,conditions:[],intensity:null},"GMTT":{temp:28,conditions:[],intensity:null},"GMFF":{temp:35,conditions:[],intensity:null},"GMAD":{temp:32,conditions:[],intensity:null},"DAAG":{temp:29,conditions:[],intensity:null},"DAOO":{temp:28,conditions:[],intensity:null},"DTTA":{temp:31,conditions:[],intensity:null},"DTMB":{temp:31,conditions:[],intensity:null},"DTTJ":{temp:35,conditions:[],intensity:null},"HECA":{temp:36,conditions:[],intensity:null},
  "HEGN":{temp:34,conditions:[],intensity:null},"HESH":{temp:36,conditions:[],intensity:null},"HEBA":{temp:40,conditions:[],intensity:null},"HEAX":{temp:26,conditions:[],intensity:null},"HLLT":{temp:29,conditions:[],intensity:null},"DNMM":{temp:25,conditions:[],intensity:null},"DNAA":{temp:25,conditions:["thunderstorm"],intensity:null},"DGAA":{temp:26,conditions:[],intensity:null},"DIAP":{temp:26,conditions:[],intensity:null},"GOBD":{temp:30,conditions:[],intensity:null},
  "GABS":{temp:29,conditions:[],intensity:null},"GVNP":{temp:30,conditions:[],intensity:null},"GBYD":{temp:25,conditions:["thunderstorm"],intensity:null},"GLRB":{temp:25,conditions:[],intensity:null},"DXXX":{temp:26,conditions:[],intensity:null},"DBBB":{temp:26,conditions:[],intensity:null},"HKJK":{temp:21,conditions:[],intensity:null},"HKMO":{temp:25,conditions:[],intensity:null},"HTDA":{temp:24,conditions:[],intensity:null},"HTKJ":{temp:20,conditions:[],intensity:null},
  "HUEN":{temp:23,conditions:[],intensity:null},"HRYR":{temp:25,conditions:[],intensity:null},"HAAB":{temp:18,conditions:[],intensity:null},"HDAM":{temp:35,conditions:[],intensity:null},"HCMM":{temp:26,conditions:[],intensity:null},"OYSN":{temp:27,conditions:[],intensity:null},"FMEE":{temp:22,conditions:[],intensity:null},"FIMP":{temp:18,conditions:[],intensity:null},"FMCH":{temp:25,conditions:[],intensity:null},"FMMI":{temp:13,conditions:[],intensity:null},
  "FSIA":{temp:25,conditions:[],intensity:null},"FKKD":{temp:27,conditions:[],intensity:null},"FKYS":{temp:26,conditions:[],intensity:null},"FOOL":{temp:26,conditions:[],intensity:null},"FZAA":{temp:28,conditions:[],intensity:null},"FCBB":{temp:29,conditions:[],intensity:null},"FLLK":{temp:21,conditions:[],intensity:null},"FVHA":{temp:17,conditions:[],intensity:null},"FLLS":{temp:19,conditions:[],intensity:null},"FYWH":{temp:19,conditions:[],intensity:null},
  "FBSK":{temp:18,conditions:[],intensity:null},"FAOR":{temp:15,conditions:[],intensity:null},"FACT":{temp:11,conditions:[],intensity:null},"FALE":{temp:20,conditions:[],intensity:null},"FAPE":{temp:13,conditions:[],intensity:null},"FQMA":{temp:23,conditions:[],intensity:null},"FWKI":{temp:18,conditions:[],intensity:null},"ZBAA":{temp:21,conditions:[],intensity:null},"ZBAD":{temp:21,conditions:[],intensity:null},"ZSPD":{temp:24,conditions:[],intensity:null},
  "ZSSS":{temp:25,conditions:[],intensity:null},"ZGGG":{temp:26,conditions:[],intensity:null},"VHHH":{temp:27,conditions:[],intensity:null},"ZGSZ":{temp:26,conditions:[],intensity:null},"ZUUU":{temp:23,conditions:[],intensity:null},"ZUCK":{temp:21,conditions:[],intensity:null},"ZHCC":{temp:27,conditions:[],intensity:null},"ZLXY":{temp:26,conditions:[],intensity:null},"ZWSH":{temp:25,conditions:[],intensity:null},"ZYHB":{temp:19,conditions:[],intensity:null},
  "ZYTX":{temp:21,conditions:[],intensity:null},"ZSAM":{temp:27,conditions:[],intensity:null},"ZGKL":{temp:25,conditions:[],intensity:null},"ZSNJ":{temp:26,conditions:[],intensity:null},"ZSHC":{temp:25,conditions:[],intensity:null},"ZPPP":{temp:17,conditions:[],intensity:null},"ZBTJ":{temp:22,conditions:[],intensity:null},"VMMC":{temp:28,conditions:[],intensity:null},"RJTT":{temp:22,conditions:[],intensity:null},"RJAA":{temp:21,conditions:[],intensity:null},
  "RJBB":{temp:24,conditions:[],intensity:null},"RJOO":{temp:23,conditions:[],intensity:null},"RJCC":{temp:15,conditions:[],intensity:null},"RJFF":{temp:22,conditions:[],intensity:null},"RJGG":{temp:23,conditions:[],intensity:null},"ROAH":{temp:27,conditions:["thunderstorm"],intensity:null},"RJSS":{temp:19,conditions:[],intensity:null},"RJSN":{temp:20,conditions:[],intensity:null},"RJOK":{temp:23,conditions:[],intensity:null},"RKSI":{temp:22,conditions:[],intensity:null},
  "RKSS":{temp:21,conditions:[],intensity:null},"RKPK":{temp:20,conditions:[],intensity:null},"RKPC":{temp:20,conditions:[],intensity:null},"RKTN":{temp:20,conditions:[],intensity:null},"ZKPY":{temp:20,conditions:[],intensity:null},"WSSS":{temp:26,conditions:[],intensity:null},"WMKK":{temp:25,conditions:[],intensity:null},"WMKP":{temp:26,conditions:[],intensity:null},"WBKK":{temp:26,conditions:[],intensity:null},"WBGG":{temp:26,conditions:[],intensity:null},
  "VTBS":{temp:28,conditions:[],intensity:null},"VTBD":{temp:28,conditions:[],intensity:null},"VTSP":{temp:28,conditions:[],intensity:null},"VTCC":{temp:26,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:26,conditions:["thunderstorm"],intensity:null},"VVTS":{temp:26,conditions:[],intensity:null},"VVDN":{temp:29,conditions:[],intensity:null},"VVCR":{temp:28,conditions:[],intensity:null},
  "VDPP":{temp:27,conditions:[],intensity:null},"VDSR":{temp:28,conditions:[],intensity:null},"VLVT":{temp:26,conditions:["thunderstorm"],intensity:null},"VLLB":{temp:26,conditions:[],intensity:null},"VYYY":{temp:26,conditions:[],intensity:null},"VYMD":{temp:28,conditions:[],intensity:null},"VGHS":{temp:29,conditions:[],intensity:null},"VGCG":{temp:26,conditions:[],intensity:null},"VECC":{temp:28,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  "VCBI":{temp:27,conditions:[],intensity:null},"WIII":{temp:27,conditions:[],intensity:null},"WADD":{temp:25,conditions:[],intensity:null},"WARR":{temp:25,conditions:[],intensity:null},"WIHH":{temp:28,conditions:[],intensity:null},"WIMM":{temp:25,conditions:[],intensity:null},"WIBB":{temp:29,conditions:[],intensity:null},"WAFF":{temp:24,conditions:[],intensity:null},"WICC":{temp:22,conditions:[],intensity:null},"WASS":{temp:25,conditions:[],intensity:null},
  "RPLL":{temp:27,conditions:[],intensity:null},"RPLC":{temp:25,conditions:[],intensity:null},"RPVM":{temp:26,conditions:[],intensity:null},"RPVD":{temp:25,conditions:[],intensity:null},"RPVK":{temp:25,conditions:[],intensity:null},"WBSB":{temp:27,conditions:[],intensity:null},"WBLL":{temp:30,conditions:[],intensity:null},"VIDP":{temp:34,conditions:[],intensity:null},"VABB":{temp:26,conditions:["thunderstorm"],intensity:null},"VOBL":{temp:21,conditions:[],intensity:null},
  "VOMM":{temp:29,conditions:[],intensity:null},"VEBS":{temp:28,conditions:[],intensity:null},"VOHY":{temp:26,conditions:[],intensity:null},"VAAH":{temp:32,conditions:[],intensity:null},"VOCI":{temp:26,conditions:[],intensity:null},"VAGO":{temp:24,conditions:["thunderstorm"],intensity:null},"VOTP":{temp:26,conditions:[],intensity:null},"VIAR":{temp:32,conditions:[],intensity:null},"VIJP":{temp:32,conditions:[],intensity:null},"VELR":{temp:23,conditions:[],intensity:null},
  "VOCL":{temp:23,conditions:[],intensity:null},"VOTV":{temp:25,conditions:[],intensity:null},"VEPT":{temp:29,conditions:[],intensity:null},"VNKT":{temp:22,conditions:[],intensity:null},"OPKC":{temp:29,conditions:[],intensity:null},"OPLA":{temp:35,conditions:[],intensity:null},"OPIS":{temp:33,conditions:["thunderstorm"],intensity:null},"RCTP":{temp:26,conditions:[],intensity:null},"RCSS":{temp:27,conditions:[],intensity:null},"RCMQ":{temp:25,conditions:[],intensity:null},
  "RCKH":{temp:27,conditions:[],intensity:null},"RCNN":{temp:26,conditions:[],intensity:null},"YSSY":{temp:12,conditions:[],intensity:null},"YMML":{temp:13,conditions:[],intensity:null},"YBBN":{temp:18,conditions:[],intensity:null},"YPPH":{temp:12,conditions:["thunderstorm"],intensity:null},"YPAD":{temp:12,conditions:[],intensity:null},"YBCG":{temp:14,conditions:[],intensity:null},"YBCS":{temp:21,conditions:[],intensity:null},"YSCB":{temp:6,conditions:[],intensity:null},
  "YMHB":{temp:11,conditions:[],intensity:null},"NZAA":{temp:8,conditions:[],intensity:null},"NZWN":{temp:8,conditions:[],intensity:null},"NZCH":{temp:6,conditions:[],intensity:null},"NZQN":{temp:2,conditions:[],intensity:null},"NZDN":{temp:1,conditions:[],intensity:null},"NFFN":{temp:19,conditions:[],intensity:null},"NWWW":{temp:15,conditions:[],intensity:null},"NTAA":{temp:22,conditions:[],intensity:null},"NSFA":{temp:24,conditions:[],intensity:null},
  "NIUE":{temp:22,conditions:[],intensity:null},"PGSN":{temp:26,conditions:[],intensity:null},"PGUM":{temp:27,conditions:[],intensity:null},"PHOG":{temp:25,conditions:[],intensity:null},"PHKO":{temp:24,conditions:[],intensity:null},"PHLH":{temp:23,conditions:[],intensity:null}
};
