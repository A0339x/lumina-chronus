...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KEWR":{temp:-11,conditions:[],intensity:null},"KMIA":{temp:25,conditions:[],intensity:null},"KPHX":{temp:26,conditions:[],intensity:null},"KIAH":{temp:22,conditions:[],intensity:null},"KBOS":{temp:-5,conditions:[],intensity:null},"KMSP":{temp:-4,conditions:[],intensity:null},"KFLL":{temp:25,conditions:[],intensity:null},"KDTW":{temp:-7,conditions:[],intensity:null},"KPHL":{temp:-10,conditions:[],intensity:null},"KLGA":{temp:-11,conditions:[],intensity:null},
  "KBWI":{temp:-8,conditions:[],intensity:null},"KSLC":{temp:12,conditions:[],intensity:null},"KDCA":{temp:-7,conditions:[],intensity:null},"KIAD":{temp:-7,conditions:[],intensity:null},"KSAN":{temp:19,conditions:[],intensity:null},"KTPA":{temp:21,conditions:[],intensity:null},"KPDX":{temp:9,conditions:[],intensity:null},"KSTL":{temp:3,conditions:[],intensity:null},"KHNL":{temp:23,conditions:[],intensity:null},"KMEM":{temp:11,conditions:[],intensity:null},
  "KAUS":{temp:25,conditions:[],intensity:null},"KBNA":{temp:6,conditions:[],intensity:null},"KRDU":{temp:2,conditions:[],intensity:null},"KCLT":{temp:8,conditions:[],intensity:null},"KSMF":{temp:14,conditions:[],intensity:null},"KSJC":{temp:13,conditions:[],intensity:null},"KOAK":{temp:13,conditions:[],intensity:null},"KCLE":{temp:-10,conditions:[],intensity:null},"KMKE":{temp:-6,conditions:[],intensity:null},"KPIT":{temp:-10,conditions:[],intensity:null},
  "KIND":{temp:-4,conditions:[],intensity:null},"KCVG":{temp:-6,conditions:[],intensity:null},"KMCI":{temp:8,conditions:[],intensity:null},"KSAT":{temp:27,conditions:[],intensity:null},"KHOU":{temp:23,conditions:[],intensity:null},"KDAL":{temp:19,conditions:[],intensity:null},"KMDW":{temp:-4,conditions:[],intensity:null},"PANC":{temp:-1,conditions:[],intensity:null},"PAFA":{temp:-14,conditions:[],intensity:null},"CYYZ":{temp:-15,conditions:[],intensity:null},
  "CYVR":{temp:10,conditions:["rain"],intensity:null},"CYUL":{temp:-15,conditions:[],intensity:null},"CYYC":{temp:15,conditions:[],intensity:null},"CYEG":{temp:1,conditions:[],intensity:null},"CYOW":{temp:-18,conditions:[],intensity:null},"CYWG":{temp:-7,conditions:[],intensity:null},"CYHZ":{temp:-2,conditions:[],intensity:null},"CYQB":{temp:-7,conditions:[],intensity:null},"CYYJ":{temp:9,conditions:[],intensity:null},"CYLW":{temp:7,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:26,conditions:[],intensity:null},"TIST":{temp:27,conditions:[],intensity:null},"TLPL":{temp:28,conditions:[],intensity:null},"TAPA":{temp:26,conditions:[],intensity:null},"SBGR":{temp:26,conditions:[],intensity:null},"SBGL":{temp:29,conditions:["thunderstorm"],intensity:null},"SBBR":{temp:25,conditions:[],intensity:null},"SBCF":{temp:27,conditions:[],intensity:null},"SBSV":{temp:29,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null},
  "SBPA":{temp:23,conditions:[],intensity:null},"SBCT":{temp:26,conditions:[],intensity:null},"SBFZ":{temp:29,conditions:[],intensity:null},"SCEL":{temp:31,conditions:[],intensity:null},"SAEZ":{temp:30,conditions:[],intensity:null},"SABE":{temp:30,conditions:[],intensity:null},"SACO":{temp:28,conditions:[],intensity:null},"SAME":{temp:28,conditions:[],intensity:null},"SLLP":{temp:17,conditions:[],intensity:null},"SLVR":{temp:29,conditions:[],intensity:null},
  ...
  "LFRS":{temp:9,conditions:[],intensity:null},"LFSB":{temp:6,conditions:[],intensity:null},"LFPB":{temp:9,conditions:[],intensity:null},"EDDF":{temp:4,conditions:["fog"],intensity:null},"EDDM":{temp:4,conditions:["fog"],intensity:null},"EDDB":{temp:1,conditions:[],intensity:null},"EDDL":{temp:9,conditions:[],intensity:null},"EDDH":{temp:1,conditions:[],intensity:null},"EDDK":{temp:6,conditions:[],intensity:null},"EDDS":{temp:5,conditions:[],intensity:null},
  "EDDW":{temp:2,conditions:[],intensity:null},"EDDN":{temp:5,conditions:["fog"],intensity:null},"EDDV":{temp:1,conditions:["fog"],intensity:null},"EDDP":{temp:1,conditions:[],intensity:null},"LEMD":{temp:5,conditions:[],intensity:null},"LEBL":{temp:12,conditions:[],intensity:null},"LEPA":{temp:13,conditions:[],intensity:null},"LEMG":{temp:14,conditions:[],intensity:null},"LEVC":{temp:12,conditions:[],intensity:null},"LEAL":{temp:14,conditions:[],intensity:null},
  ...
  "LIMC":{temp:7,conditions:[],intensity:null},"LIME":{temp:8,conditions:[],intensity:null},"LIPZ":{temp:8,conditions:["fog"],intensity:null},"LIRN":{temp:11,conditions:[],intensity:null},"LIML":{temp:9,conditions:[],intensity:null},"LIPE":{temp:10,conditions:[],intensity:null},"LICC":{temp:14,conditions:[],intensity:null},"LICJ":{temp:13,conditions:[],intensity:null},"LIRA":{temp:11,conditions:[],intensity:null},"LIRP":{temp:10,conditions:[],intensity:null},
  "LIMF":{temp:6,conditions:[],intensity:null},"LIEO":{temp:12,conditions:[],intensity:null},"LIEE":{temp:12,conditions:[],intensity:null},"EHAM":{temp:9,conditions:[],intensity:null},"EHRD":{temp:9,conditions:[],intensity:null},"EHEH":{temp:8,conditions:[],intensity:null},"EBBR":{temp:9,conditions:[],intensity:null},"EBCI":{temp:8,conditions:[],intensity:null},"ELLX":{temp:5,conditions:[],intensity:null},"LSZH":{temp:5,conditions:[],intensity:null},
  ...
  "GMMX":{temp:13,conditions:[],intensity:null},"GMTT":{temp:15,conditions:["thunderstorm"],intensity:null},"GMFF":{temp:13,conditions:[],intensity:null},"GMAD":{temp:15,conditions:[],intensity:null},"DAAG":{temp:12,conditions:[],intensity:null},"DAOO":{temp:14,conditions:[],intensity:null},"DTTA":{temp:13,conditions:[],intensity:null},"DTMB":{temp:12,conditions:[],intensity:null},"DTTJ":{temp:14,conditions:[],intensity:null},"HECA":{temp:21,conditions:[],intensity:null},
  ...
  "GABS":{temp:24,conditions:[],intensity:null},"GVNP":{temp:22,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:28,conditions:[],intensity:null},"DBBB":{temp:28,conditions:[],intensity:null},"HKJK":{temp:20,conditions:[],intensity:null},"HKMO":{temp:26,conditions:[],intensity:null},"HTDA":{temp:26,conditions:[],intensity:null},"HTKJ":{temp:22,conditions:[],intensity:null},
  ...
  "RJBB":{temp:4,conditions:[],intensity:null},"RJOO":{temp:1,conditions:[],intensity:null},"RJCC":{temp:-13,conditions:[],intensity:null},"RJFF":{temp:0,conditions:[],intensity:null},"RJGG":{temp:5,conditions:[],intensity:null},"ROAH":{temp:14,conditions:[],intensity:null},"RJSS":{temp:-4,conditions:[],intensity:null},"RJSN":{temp:-1,conditions:[],intensity:null},"RJOK":{temp:2,conditions:[],intensity:null},"RKSI":{temp:-10,conditions:[],intensity:null},
