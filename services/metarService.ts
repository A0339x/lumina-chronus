...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KEWR":{temp:-1,conditions:[],intensity:null},"KMIA":{temp:21,conditions:[],intensity:null},"KPHX":{temp:9,conditions:[],intensity:null},"KIAH":{temp:7,conditions:[],intensity:null},"KBOS":{temp:0,conditions:[],intensity:null},"KMSP":{temp:5,conditions:[],intensity:null},"KFLL":{temp:21,conditions:[],intensity:null},"KDTW":{temp:-1,conditions:[],intensity:null},"KPHL":{temp:-1,conditions:[],intensity:null},"KLGA":{temp:0,conditions:[],intensity:null},
  "KBWI":{temp:-2,conditions:[],intensity:null},"KSLC":{temp:-5,conditions:["fog"],intensity:null},"KDCA":{temp:-1,conditions:[],intensity:null},"KIAD":{temp:-3,conditions:[],intensity:null},"KSAN":{temp:9,conditions:[],intensity:null},"KTPA":{temp:13,conditions:[],intensity:null},"KPDX":{temp:1,conditions:[],intensity:null},"KSTL":{temp:8,conditions:[],intensity:null},"KHNL":{temp:20,conditions:[],intensity:null},"KMEM":{temp:2,conditions:[],intensity:null},
  "KAUS":{temp:10,conditions:[],intensity:null},"KBNA":{temp:0,conditions:[],intensity:null},"KRDU":{temp:-1,conditions:[],intensity:null},"KCLT":{temp:-1,conditions:[],intensity:null},"KSMF":{temp:3,conditions:["fog"],intensity:null},"KSJC":{temp:3,conditions:["fog"],intensity:null},"KOAK":{temp:5,conditions:[],intensity:null},"KCLE":{temp:0,conditions:[],intensity:null},"KMKE":{temp:2,conditions:[],intensity:null},"KPIT":{temp:-1,conditions:[],intensity:null},
  ...
  "CYXE":{temp:-2,conditions:[],intensity:null},"CYQR":{temp:-1,conditions:[],intensity:null},"CYZF":{temp:-15,conditions:[],intensity:null},"CYXY":{temp:-4,conditions:[],intensity:null},"CYQT":{temp:0,conditions:[],intensity:null},"CYYT":{temp:-1,conditions:[],intensity:null},"MMMX":{temp:7,conditions:[],intensity:null},"MMUN":{temp:21,conditions:[],intensity:null},"MMGL":{temp:13,conditions:[],intensity:null},"MMMY":{temp:7,conditions:[],intensity:null},
  ...
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:22,conditions:[],intensity:null},"SBFZ":{temp:29,conditions:[],intensity:null},"SCEL":{temp:19,conditions:[],intensity:null},"SAEZ":{temp:27,conditions:[],intensity:null},"SABE":{temp:27,conditions:[],intensity:null},"SACO":{temp:21,conditions:[],intensity:null},"SAME":{temp:20,conditions:[],intensity:null},"SLLP":{temp:5,conditions:[],intensity:null},"SLVR":{temp:24,conditions:[],intensity:null},
  ...
  "EDDW":{temp:5,conditions:[],intensity:null},"EDDN":{temp:6,conditions:[],intensity:null},"EDDV":{temp:6,conditions:[],intensity:null},"EDDP":{temp:4,conditions:[],intensity:null},"LEMD":{temp:9,conditions:[],intensity:null},"LEBL":{temp:15,conditions:[],intensity:null},"LEPA":{temp:17,conditions:[],intensity:null},"LEMG":{temp:14,conditions:[],intensity:null},"LEVC":{temp:13,conditions:[],intensity:null},"LEAL":{temp:14,conditions:[],intensity:null},
  ...
  "LSGG":{temp:6,conditions:[],intensity:null},"LSZB":{temp:4,conditions:[],intensity:null},"LOWW":{temp:-1,conditions:[],intensity:null},"LOWS":{temp:3,conditions:[],intensity:null},"LOWG":{temp:3,conditions:[],intensity:null},"LOWI":{temp:-1,conditions:[],intensity:null},"LKPR":{temp:2,conditions:[],intensity:null},"EPWA":{temp:-4,conditions:[],intensity:null},"EPKK":{temp:-4,conditions:["snow"],intensity:null},"EPGD":{temp:-4,conditions:[],intensity:null},
  ...
  "GMMX":{temp:16,conditions:[],intensity:null},"GMTT":{temp:17,conditions:[],intensity:null},"GMFF":{temp:16,conditions:[],intensity:null},"GMAD":{temp:20,conditions:[],intensity:null},"DAAG":{temp:18,conditions:[],intensity:null},"DAOO":{temp:17,conditions:[],intensity:null},"DTTA":{temp:14,conditions:[],intensity:null},"DTMB":{temp:16,conditions:[],intensity:null},"DTTJ":{temp:16,conditions:[],intensity:null},"HECA":{temp:16,conditions:[],intensity:null},
  "HEGN":{temp:19,conditions:[],intensity:null},"HESH":{temp:19,conditions:[],intensity:null},"HEBA":{temp:20,conditions:[],intensity:null},"HEAX":{temp:16,conditions:[],intensity:null},"HLLT":{temp:18,conditions:[],intensity:null},"DNMM":{temp:34,conditions:[],intensity:null},"DNAA":{temp:33,conditions:[],intensity:null},"DGAA":{temp:31,conditions:[],intensity:null},"DIAP":{temp:31,conditions:[],intensity:null},"GOBD":{temp:26,conditions:[],intensity:null},
  ...
  "HUEN":{temp:27,conditions:[],intensity:null},"HRYR":{temp:24,conditions:[],intensity:null},"HAAB":{temp:22,conditions:[],intensity:null},"HDAM":{temp:29,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:25,conditions:[],intensity:null},"FMEE":{temp:28,conditions:["thunderstorm"],intensity:null},"FIMP":{temp:26,conditions:[],intensity:null},"FMCH":{temp:30,conditions:["thunderstorm"],intensity:null},"FMMI":{temp:24,conditions:[],intensity:null},
  ...
  "ZSSS":{temp:9,conditions:[],intensity:null},"ZGGG":{temp:18,conditions:[],intensity:null},"VHHH":{temp:20,conditions:[],intensity:null},"ZGSZ":{temp:18,conditions:[],intensity:null},"ZUUU":{temp:10,conditions:[],intensity:null},"ZUCK":{temp:12,conditions:[],intensity:null},"ZHCC":{temp:10,conditions:[],intensity:null},"ZLXY":{temp:8,conditions:[],intensity:null},"ZWSH":{temp:-3,conditions:[],intensity:null},"ZYHB":{temp:-22,conditions:[],intensity:null},
  "ZYTX":{temp:-12,conditions:[],intensity:null},"ZSAM":{temp:15,conditions:[],intensity:null},"ZGKL":{temp:13,conditions:[],intensity:null},"ZSNJ":{temp:11,conditions:[],intensity:null},"ZSHC":{temp:13,conditions:[],intensity:null},"ZPPP":{temp:11,conditions:[],intensity:null},"ZBTJ":{temp:-1,conditions:[],intensity:null},"VMMC":{temp:18,conditions:[],intensity:null},"RJTT":{temp:9,conditions:[],intensity:null},"RJAA":{temp:8,conditions:[],intensity:null},
  "RJBB":{temp:9,conditions:[],intensity:null},"RJOO":{temp:6,conditions:[],intensity:null},"RJCC":{temp:-4,conditions:[],intensity:null},"RJFF":{temp:8,conditions:[],intensity:null},"RJGG":{temp:9,conditions:[],intensity:null},"ROAH":{temp:19,conditions:[],intensity:null},"RJSS":{temp:5,conditions:[],intensity:null},"RJSN":{temp:6,conditions:[],intensity:null},"RJOK":{temp:7,conditions:[],intensity:null},"RKSI":{temp:-4,conditions:[],intensity:null},
  ...
  "VTBS":{temp:29,conditions:[],intensity:null},"VTBD":{temp:28,conditions:[],intensity:null},"VTSP":{temp:27,conditions:[],intensity:null},"VTCC":{temp:25,conditions:[],intensity:null},"VTSS":{temp:26,conditions:[],intensity:null},"VTUK":{temp:26,conditions:[],intensity:null},"VVNB":{temp:20,conditions:[],intensity:null},"VVTS":{temp:26,conditions:[],intensity:null},"VVDN":{temp:18,conditions:[],intensity:null},"VVCR":{temp:23,conditions:[],intensity:null},
  "VDPP":{temp:27,conditions:[],intensity:null},"VDSR":{temp:26,conditions:[],intensity:null},"VLVT":{temp:22,conditions:[],intensity:null},"VLLB":{temp:21,conditions:[],intensity:null},"VYYY":{temp:27,conditions:[],intensity:null},"VYMD":{temp:25,conditions:[],intensity:null},"VGHS":{temp:22,conditions:[],intensity:null},"VGCG":{temp:22,conditions:[],intensity:null},"VECC":{temp:22,conditions:[],intensity:null},"VRMM":{temp:28,conditions:[],intensity:null},
  ...
  "RCKH":{temp:21,conditions:[],intensity:null},"RCNN":{temp:18,conditions:[],intensity:null},"YSSY":{temp:21,conditions:[],intensity:null},"YMML":{temp:16,conditions:[],intensity:null},"YBBN":{temp:25,conditions:[],intensity:null},"YPPH":{temp:30,conditions:[],intensity:null},"YPAD":{temp:19,conditions:[],intensity:null},"YBCG":{temp:22,conditions:[],intensity:null},"YBCS":{temp:25,conditions:["thunderstorm"],intensity:null},"YSCB":{temp:20,conditions:[],intensity:null},
