...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:16,conditions:[],intensity:null},"KLAX":{temp:16,conditions:[],intensity:null},"KORD":{temp:6,conditions:[],intensity:null},"KDFW":{temp:18,conditions:[],intensity:null},"KDEN":{temp:14,conditions:[],intensity:null},"KJFK":{temp:1,conditions:[],intensity:null},"KSFO":{temp:12,conditions:[],intensity:null},"KSEA":{temp:6,conditions:[],intensity:null},"KLAS":{temp:16,conditions:[],intensity:null},"KMCO":{temp:22,conditions:[],intensity:null},
  "KEWR":{temp:1,conditions:[],intensity:null},"KMIA":{temp:26,conditions:[],intensity:null},"KPHX":{temp:20,conditions:[],intensity:null},"KIAH":{temp:24,conditions:[],intensity:null},"KBOS":{temp:-4,conditions:[],intensity:null},"KMSP":{temp:-1,conditions:[],intensity:null},"KFLL":{temp:26,conditions:[],intensity:null},"KDTW":{temp:4,conditions:[],intensity:null},"KPHL":{temp:3,conditions:[],intensity:null},"KLGA":{temp:2,conditions:[],intensity:null},
  "KBWI":{temp:4,conditions:[],intensity:null},"KSLC":{temp:7,conditions:[],intensity:null},"KDCA":{temp:4,conditions:[],intensity:null},"KIAD":{temp:4,conditions:[],intensity:null},"KSAN":{temp:17,conditions:[],intensity:null},"KTPA":{temp:22,conditions:[],intensity:null},"KPDX":{temp:8,conditions:[],intensity:null},"KSTL":{temp:15,conditions:[],intensity:null},"KHNL":{temp:25,conditions:[],intensity:null},"KMEM":{temp:16,conditions:[],intensity:null},
  "KAUS":{temp:22,conditions:[],intensity:null},"KBNA":{temp:17,conditions:[],intensity:null},"KRDU":{temp:9,conditions:[],intensity:null},"KCLT":{temp:11,conditions:[],intensity:null},"KSMF":{temp:12,conditions:[],intensity:null},"KSJC":{temp:13,conditions:[],intensity:null},"KOAK":{temp:12,conditions:[],intensity:null},"KCLE":{temp:6,conditions:[],intensity:null},"KMKE":{temp:2,conditions:[],intensity:null},"KPIT":{temp:6,conditions:[],intensity:null},
  ...
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:20,conditions:[],intensity:null},"SBFZ":{temp:28,conditions:[],intensity:null},"SCEL":{temp:19,conditions:[],intensity:null},"SAEZ":{temp:29,conditions:[],intensity:null},"SABE":{temp:28,conditions:[],intensity:null},"SACO":{temp:29,conditions:[],intensity:null},"SAME":{temp:31,conditions:[],intensity:null},"SLLP":{temp:17,conditions:[],intensity:null},"SLVR":{temp:33,conditions:[],intensity:null},
  ...
  "LFRS":{temp:0,conditions:["snow"],intensity:null},"LFSB":{temp:-5,conditions:[],intensity:null},"LFPB":{temp:-1,conditions:[],intensity:null},"EDDF":{temp:-4,conditions:[],intensity:null},"EDDM":{temp:-11,conditions:[],intensity:null},"EDDB":{temp:-5,conditions:[],intensity:null},"EDDL":{temp:-1,conditions:[],intensity:null},"EDDH":{temp:-1,conditions:[],intensity:null},"EDDK":{temp:-1,conditions:[],intensity:null},"EDDS":{temp:-5,conditions:[],intensity:null},
  ...
  "LEZL":{temp:9,conditions:[],intensity:null},"GCLP":{temp:17,conditions:[],intensity:null},"GCTS":{temp:16,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:16,conditions:[],intensity:null},"LPPT":{temp:9,conditions:[],intensity:null},"LPPR":{temp:8,conditions:[],intensity:null},"LPFR":{temp:9,conditions:[],intensity:null},"LPMA":{temp:13,conditions:[],intensity:null},"LIRF":{temp:13,conditions:["thunderstorm"],intensity:null},
  ...
  "EPWR":{temp:-5,conditions:[],intensity:null},"EPPO":{temp:-4,conditions:[],intensity:null},"EKCH":{temp:-1,conditions:[],intensity:null},"ESSA":{temp:-9,conditions:[],intensity:null},"ENGM":{temp:-9,conditions:[],intensity:null},"EFHK":{temp:-16,conditions:[],intensity:null},"BIKF":{temp:0,conditions:[],intensity:null},"ESGG":{temp:-8,conditions:[],intensity:null},"ESMS":{temp:-1,conditions:["snow"],intensity:null},"ENBR":{temp:-8,conditions:[],intensity:null},
  ...
  "LGMK":{temp:16,conditions:[],intensity:null},"LTFM":{temp:13,conditions:[],intensity:null},"LTBA":{temp:12,conditions:[],intensity:null},"LTFJ":{temp:12,conditions:[],intensity:null},"LTAI":{temp:11,conditions:[],intensity:null},"LTAC":{temp:1,conditions:["fog"],intensity:null},"LTBJ":{temp:13,conditions:[],intensity:null},"LTBS":{temp:15,conditions:[],intensity:null},"LTFE":{temp:15,conditions:[],intensity:null},"LCLK":{temp:12,conditions:[],intensity:null},
  ...
  "HEGN":{temp:17,conditions:[],intensity:null},"HESH":{temp:18,conditions:[],intensity:null},"HEBA":{temp:17,conditions:[],intensity:null},"HEAX":{temp:15,conditions:[],intensity:null},"HLLT":{temp:19,conditions:[],intensity:null},"DNMM":{temp:28,conditions:[],intensity:null},"DNAA":{temp:27,conditions:[],intensity:null},"DGAA":{temp:28,conditions:[],intensity:null},"DIAP":{temp:27,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  ...
  "FBSK":{temp:19,conditions:[],intensity:null},"FAOR":{temp:16,conditions:[],intensity:null},"FACT":{temp:22,conditions:[],intensity:null},"FALE":{temp:19,conditions:[],intensity:null},"FAPE":{temp:20,conditions:[],intensity:null},"FQMA":{temp:23,conditions:[],intensity:null},"FWKI":{temp:20,conditions:[],intensity:null},"ZBAA":{temp:-4,conditions:[],intensity:null},"ZBAD":{temp:-6,conditions:[],intensity:null},"ZSPD":{temp:5,conditions:[],intensity:null},
  "ZSSS":{temp:2,conditions:[],intensity:null},"ZGGG":{temp:8,conditions:[],intensity:null},"VHHH":{temp:13,conditions:[],intensity:null},"ZGSZ":{temp:12,conditions:[],intensity:null},"ZUUU":{temp:5,conditions:[],intensity:null},"ZUCK":{temp:7,conditions:[],intensity:null},"ZHCC":{temp:1,conditions:[],intensity:null},"ZLXY":{temp:-2,conditions:[],intensity:null},"ZWSH":{temp:-8,conditions:[],intensity:null},"ZYHB":{temp:-15,conditions:[],intensity:null},
  "ZYTX":{temp:-10,conditions:[],intensity:null},"ZSAM":{temp:13,conditions:[],intensity:null},"ZGKL":{temp:5,conditions:[],intensity:null},"ZSNJ":{temp:2,conditions:[],intensity:null},"ZSHC":{temp:3,conditions:[],intensity:null},"ZPPP":{temp:5,conditions:[],intensity:null},"ZBTJ":{temp:-4,conditions:[],intensity:null},"VMMC":{temp:11,conditions:[],intensity:null},"RJTT":{temp:4,conditions:[],intensity:null},"RJAA":{temp:2,conditions:[],intensity:null},
  ...
  "RCKH":{temp:17,conditions:[],intensity:null},"RCNN":{temp:15,conditions:[],intensity:null},"YSSY":{temp:19,conditions:["fog"],intensity:null},"YMML":{temp:13,conditions:[],intensity:null},"YBBN":{temp:23,conditions:[],intensity:null},"YPPH":{temp:23,conditions:[],intensity:null},"YPAD":{temp:22,conditions:[],intensity:null},"YBCG":{temp:20,conditions:["fog"],intensity:null},"YBCS":{temp:23,conditions:["rain"],intensity:null},"YSCB":{temp:16,conditions:[],intensity:null},
  "YMHB":{temp:17,conditions:[],intensity:null},"NZAA":{temp:20,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:15,conditions:["fog"],intensity:null},"NZQN":{temp:13,conditions:[],intensity:null},"NZDN":{temp:16,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:27,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
