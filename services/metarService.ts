...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KEWR":{temp:2,conditions:[],intensity:null},"KMIA":{temp:27,conditions:[],intensity:null},"KPHX":{temp:17,conditions:[],intensity:null},"KIAH":{temp:26,conditions:[],intensity:null},"KBOS":{temp:1,conditions:["snow"],intensity:null},"KMSP":{temp:-4,conditions:[],intensity:null},"KFLL":{temp:26,conditions:[],intensity:null},"KDTW":{temp:1,conditions:[],intensity:null},"KPHL":{temp:6,conditions:["fog"],intensity:null},"KLGA":{temp:2,conditions:[],intensity:null},
  "KBWI":{temp:9,conditions:[],intensity:null},"KSLC":{temp:2,conditions:[],intensity:null},"KDCA":{temp:12,conditions:[],intensity:null},"KIAD":{temp:12,conditions:[],intensity:null},"KSAN":{temp:16,conditions:[],intensity:null},"KTPA":{temp:27,conditions:[],intensity:null},"KPDX":{temp:8,conditions:[],intensity:null},"KSTL":{temp:6,conditions:[],intensity:null},"KHNL":{temp:26,conditions:[],intensity:null},"KMEM":{temp:15,conditions:[],intensity:null},
  ...
  "KIND":{temp:2,conditions:[],intensity:null},"KCVG":{temp:8,conditions:[],intensity:null},"KMCI":{temp:2,conditions:[],intensity:null},"KSAT":{temp:21,conditions:[],intensity:null},"KHOU":{temp:26,conditions:[],intensity:null},"KDAL":{temp:14,conditions:[],intensity:null},"KMDW":{temp:0,conditions:[],intensity:null},"PANC":{temp:-9,conditions:[],intensity:null},"PAFA":{temp:-22,conditions:[],intensity:null},"CYYZ":{temp:3,conditions:[],intensity:null},
  "CYVR":{temp:3,conditions:[],intensity:null},"CYUL":{temp:-1,conditions:[],intensity:null},"CYYC":{temp:-12,conditions:[],intensity:null},"CYEG":{temp:-18,conditions:[],intensity:null},"CYOW":{temp:-3,conditions:[],intensity:null},"CYWG":{temp:-14,conditions:[],intensity:null},"CYHZ":{temp:-1,conditions:[],intensity:null},"CYQB":{temp:-8,conditions:[],intensity:null},"CYYJ":{temp:4,conditions:[],intensity:null},"CYLW":{temp:-5,conditions:[],intensity:null},
  "CYXE":{temp:-21,conditions:[],intensity:null},"CYQR":{temp:-20,conditions:[],intensity:null},"CYZF":{temp:-25,conditions:[],intensity:null},"CYXY":{temp:-17,conditions:[],intensity:null},"CYQT":{temp:-9,conditions:[],intensity:null},"CYYT":{temp:-2,conditions:[],intensity:null},"MMMX":{temp:29,conditions:[],intensity:null},"MMUN":{temp:28,conditions:[],intensity:null},"MMGL":{temp:30,conditions:[],intensity:null},"MMMY":{temp:35,conditions:[],intensity:null},
  ...
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:25,conditions:["thunderstorm"],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:24,conditions:[],intensity:null},"SAEZ":{temp:29,conditions:[],intensity:null},"SABE":{temp:26,conditions:[],intensity:null},"SACO":{temp:26,conditions:[],intensity:null},"SAME":{temp:22,conditions:[],intensity:null},"SLLP":{temp:14,conditions:[],intensity:null},"SLVR":{temp:30,conditions:[],intensity:null},
  ...
  "LSGG":{temp:5,conditions:[],intensity:null},"LSZB":{temp:5,conditions:[],intensity:null},"LOWW":{temp:-2,conditions:[],intensity:null},"LOWS":{temp:1,conditions:[],intensity:null},"LOWG":{temp:0,conditions:[],intensity:null},"LOWI":{temp:-3,conditions:["fog"],intensity:null},"LKPR":{temp:-2,conditions:[],intensity:null},"EPWA":{temp:-4,conditions:[],intensity:null},"EPKK":{temp:-7,conditions:[],intensity:null},"EPGD":{temp:-5,conditions:[],intensity:null},
  "EPWR":{temp:-4,conditions:[],intensity:null},"EPPO":{temp:-3,conditions:[],intensity:null},"EKCH":{temp:0,conditions:[],intensity:null},"ESSA":{temp:-1,conditions:[],intensity:null},"ENGM":{temp:-3,conditions:["snow"],intensity:null},"EFHK":{temp:-7,conditions:[],intensity:null},"BIKF":{temp:-2,conditions:[],intensity:null},"ESGG":{temp:-3,conditions:["snow"],intensity:null},"ESMS":{temp:-1,conditions:["snow"],intensity:null},"ENBR":{temp:2,conditions:[],intensity:null},
  ...
  "GABS":{temp:21,conditions:[],intensity:null},"GVNP":{temp:22,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:28,conditions:[],intensity:null},"DBBB":{temp:28,conditions:[],intensity:null},"HKJK":{temp:18,conditions:[],intensity:null},"HKMO":{temp:27,conditions:[],intensity:null},"HTDA":{temp:26,conditions:[],intensity:null},"HTKJ":{temp:23,conditions:[],intensity:null},
  ...
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:28,conditions:[],intensity:null},"FKYS":{temp:24,conditions:[],intensity:null},"FOOL":{temp:26,conditions:[],intensity:null},"FZAA":{temp:28,conditions:[],intensity:null},"FCBB":{temp:24,conditions:[],intensity:null},"FLLK":{temp:20,conditions:[],intensity:null},"FVHA":{temp:19,conditions:[],intensity:null},"FLLS":{temp:20,conditions:[],intensity:null},"FYWH":{temp:20,conditions:[],intensity:null},
  "FBSK":{temp:23,conditions:[],intensity:null},"FAOR":{temp:18,conditions:[],intensity:null},"FACT":{temp:22,conditions:[],intensity:null},"FALE":{temp:23,conditions:["fog"],intensity:null},"FAPE":{temp:22,conditions:[],intensity:null},"FQMA":{temp:26,conditions:[],intensity:null},"FWKI":{temp:18,conditions:["fog"],intensity:null},"ZBAA":{temp:0,conditions:[],intensity:null},"ZBAD":{temp:4,conditions:[],intensity:null},"ZSPD":{temp:9,conditions:[],intensity:null},
  ...
  "RJBB":{temp:7,conditions:[],intensity:null},"RJOO":{temp:2,conditions:[],intensity:null},"RJCC":{temp:0,conditions:["freezing"],intensity:null},"RJFF":{temp:5,conditions:[],intensity:null},"RJGG":{temp:5,conditions:[],intensity:null},"ROAH":{temp:19,conditions:[],intensity:null},"RJSS":{temp:-1,conditions:[],intensity:null},"RJSN":{temp:2,conditions:[],intensity:null},"RJOK":{temp:5,conditions:[],intensity:null},"RKSI":{temp:6,conditions:[],intensity:null},
  "RKSS":{temp:2,conditions:[],intensity:null},"RKPK":{temp:6,conditions:[],intensity:null},"RKPC":{temp:8,conditions:[],intensity:null},"RKTN":{temp:1,conditions:[],intensity:null},"ZKPY":{temp:4,conditions:[],intensity:null},"WSSS":{temp:25,conditions:[],intensity:null},"WMKK":{temp:25,conditions:[],intensity:null},"WMKP":{temp:28,conditions:[],intensity:null},"WBKK":{temp:27,conditions:[],intensity:null},"WBGG":{temp:24,conditions:[],intensity:null},
  ...
  "VDPP":{temp:24,conditions:[],intensity:null},"VDSR":{temp:24,conditions:[],intensity:null},"VLVT":{temp:21,conditions:[],intensity:null},"VLLB":{temp:20,conditions:[],intensity:null},"VYYY":{temp:24,conditions:[],intensity:null},"VYMD":{temp:22,conditions:[],intensity:null},"VGHS":{temp:18,conditions:[],intensity:null},"VGCG":{temp:22,conditions:[],intensity:null},"VECC":{temp:22,conditions:[],intensity:null},"VRMM":{temp:28,conditions:[],intensity:null},
  ...
  "VOCL":{temp:27,conditions:[],intensity:null},"VOTV":{temp:29,conditions:[],intensity:null},"VEPT":{temp:21,conditions:[],intensity:null},"VNKT":{temp:14,conditions:[],intensity:null},"OPKC":{temp:23,conditions:[],intensity:null},"OPLA":{temp:16,conditions:[],intensity:null},"OPIS":{temp:11,conditions:[],intensity:null},"RCTP":{temp:15,conditions:[],intensity:null},"RCSS":{temp:15,conditions:[],intensity:null},"RCMQ":{temp:13,conditions:["fog"],intensity:null},
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:16,conditions:[],intensity:null},"YSSY":{temp:22,conditions:["fog"],intensity:null},"YMML":{temp:16,conditions:[],intensity:null},"YBBN":{temp:24,conditions:[],intensity:null},"YPPH":{temp:20,conditions:[],intensity:null},"YPAD":{temp:22,conditions:[],intensity:null},"YBCG":{temp:22,conditions:[],intensity:null},"YBCS":{temp:24,conditions:["fog"],intensity:null},"YSCB":{temp:18,conditions:["fog"],intensity:null},
  "YMHB":{temp:15,conditions:[],intensity:null},"NZAA":{temp:18,conditions:[],intensity:null},"NZWN":{temp:16,conditions:[],intensity:null},"NZCH":{temp:14,conditions:[],intensity:null},"NZQN":{temp:10,conditions:[],intensity:null},"NZDN":{temp:11,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:28,conditions:[],intensity:null},"NTAA":{temp:29,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
