...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LFRS":{temp:-1,conditions:[],intensity:null},"LFSB":{temp:-4,conditions:[],intensity:null},"LFPB":{temp:-1,conditions:[],intensity:null},"EDDF":{temp:-3,conditions:[],intensity:null},"EDDM":{temp:-8,conditions:[],intensity:null},"EDDB":{temp:-8,conditions:[],intensity:null},"EDDL":{temp:-1,conditions:[],intensity:null},"EDDH":{temp:0,conditions:[],intensity:null},"EDDK":{temp:-2,conditions:[],intensity:null},"EDDS":{temp:-4,conditions:[],intensity:null},
  ...
  "LIMF":{temp:-3,conditions:[],intensity:null},"LIEO":{temp:5,conditions:[],intensity:null},"LIEE":{temp:8,conditions:[],intensity:null},"EHAM":{temp:-1,conditions:[],intensity:null},"EHRD":{temp:-1,conditions:[],intensity:null},"EHEH":{temp:-3,conditions:[],intensity:null},"EBBR":{temp:-1,conditions:[],intensity:null},"EBCI":{temp:-2,conditions:[],intensity:null},"ELLX":{temp:-4,conditions:[],intensity:null},"LSZH":{temp:-5,conditions:[],intensity:null},
