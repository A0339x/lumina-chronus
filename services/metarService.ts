...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LIMF":{temp:4,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:12,conditions:[],intensity:null},"EHAM":{temp:4,conditions:[],intensity:null},"EHRD":{temp:5,conditions:[],intensity:null},"EHEH":{temp:4,conditions:[],intensity:null},"EBBR":{temp:5,conditions:[],intensity:null},"EBCI":{temp:3,conditions:[],intensity:null},"ELLX":{temp:1,conditions:[],intensity:null},"LSZH":{temp:2,conditions:[],intensity:null},
