...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:8,conditions:[],intensity:null},"KLAX":{temp:14,conditions:[],intensity:null},"KORD":{temp:-6,conditions:[],intensity:null},"KDFW":{temp:8,conditions:[],intensity:null},"KDEN":{temp:-6,conditions:[],intensity:null},"KJFK":{temp:3,conditions:[],intensity:null},"KSFO":{temp:10,conditions:[],intensity:null},"KSEA":{temp:1,conditions:[],intensity:null},"KLAS":{temp:8,conditions:[],intensity:null},"KMCO":{temp:13,conditions:[],intensity:null},
  "KEWR":{temp:1,conditions:[],intensity:null},"KMIA":{temp:20,conditions:["rain"],intensity:null},"KPHX":{temp:11,conditions:[],intensity:null},"KIAH":{temp:17,conditions:["fog"],intensity:null},"KBOS":{temp:1,conditions:["snow"],intensity:null},"KMSP":{temp:-14,conditions:[],intensity:null},"KFLL":{temp:22,conditions:[],intensity:null},"KDTW":{temp:-3,conditions:[],intensity:null},"KPHL":{temp:3,conditions:[],intensity:null},"KLGA":{temp:2,conditions:[],intensity:null},
  "KBWI":{temp:3,conditions:[],intensity:null},"KSLC":{temp:-1,conditions:[],intensity:null},"KDCA":{temp:4,conditions:[],intensity:null},"KIAD":{temp:3,conditions:[],intensity:null},"KSAN":{temp:13,conditions:[],intensity:null},"KTPA":{temp:14,conditions:[],intensity:null},"KPDX":{temp:0,conditions:[],intensity:null},"KSTL":{temp:-1,conditions:[],intensity:null},"KHNL":{temp:22,conditions:[],intensity:null},"KMEM":{temp:5,conditions:["fog"],intensity:null},
  ...
  "KIND":{temp:-1,conditions:[],intensity:null},"KCVG":{temp:1,conditions:[],intensity:null},"KMCI":{temp:-5,conditions:[],intensity:null},"KSAT":{temp:9,conditions:[],intensity:null},"KHOU":{temp:18,conditions:[],intensity:null},"KDAL":{temp:7,conditions:[],intensity:null},"KMDW":{temp:-5,conditions:[],intensity:null},"PANC":{temp:-4,conditions:[],intensity:null},"PAFA":{temp:-15,conditions:[],intensity:null},"CYYZ":{temp:-4,conditions:[],intensity:null},
  "CYVR":{temp:3,conditions:["fog"],intensity:null},"CYUL":{temp:-4,conditions:[],intensity:null},"CYYC":{temp:-11,conditions:[],intensity:null},"CYEG":{temp:-16,conditions:[],intensity:null},"CYOW":{temp:-3,conditions:[],intensity:null},"CYWG":{temp:-25,conditions:[],intensity:null},"CYHZ":{temp:-2,conditions:["snow"],intensity:null},"CYQB":{temp:-10,conditions:[],intensity:null},"CYYJ":{temp:2,conditions:[],intensity:null},"CYLW":{temp:0,conditions:[],intensity:null},
  "CYXE":{temp:-27,conditions:[],intensity:null},"CYQR":{temp:-23,conditions:[],intensity:null},"CYZF":{temp:-35,conditions:[],intensity:null},"CYXY":{temp:-12,conditions:[],intensity:null},"CYQT":{temp:-24,conditions:[],intensity:null},"CYYT":{temp:-7,conditions:[],intensity:null},"MMMX":{temp:9,conditions:[],intensity:null},"MMUN":{temp:21,conditions:[],intensity:null},"MMGL":{temp:14,conditions:[],intensity:null},"MMMY":{temp:15,conditions:["fog"],intensity:null},
  ...
  "SBPA":{temp:21,conditions:[],intensity:null},"SBCT":{temp:13,conditions:[],intensity:null},"SBFZ":{temp:25,conditions:[],intensity:null},"SCEL":{temp:15,conditions:[],intensity:null},"SAEZ":{temp:20,conditions:[],intensity:null},"SABE":{temp:19,conditions:[],intensity:null},"SACO":{temp:16,conditions:[],intensity:null},"SAME":{temp:23,conditions:[],intensity:null},"SLLP":{temp:4,conditions:["fog"],intensity:null},"SLVR":{temp:22,conditions:[],intensity:null},
  ...
  "EIDW":{temp:9,conditions:[],intensity:null},"EICK":{temp:3,conditions:[],intensity:null},"EINN":{temp:3,conditions:[],intensity:null},"LFPG":{temp:7,conditions:[],intensity:null},"LFPO":{temp:8,conditions:[],intensity:null},"LFML":{temp:10,conditions:[],intensity:null},"LFLL":{temp:6,conditions:[],intensity:null},"LFMN":{temp:9,conditions:[],intensity:null},"LFBD":{temp:9,conditions:["rain"],intensity:null},"LFBO":{temp:8,conditions:[],intensity:null},
  "LFRS":{temp:9,conditions:[],intensity:null},"LFSB":{temp:-3,conditions:["fog"],intensity:null},"LFPB":{temp:8,conditions:[],intensity:null},"EDDF":{temp:-5,conditions:[],intensity:null},"EDDM":{temp:-8,conditions:["fog"],intensity:null},"EDDB":{temp:-7,conditions:[],intensity:null},"EDDL":{temp:2,conditions:[],intensity:null},"EDDH":{temp:-4,conditions:[],intensity:null},"EDDK":{temp:1,conditions:[],intensity:null},"EDDS":{temp:-7,conditions:["fog"],intensity:null},
  "EDDW":{temp:-4,conditions:[],intensity:null},"EDDN":{temp:-8,conditions:[],intensity:null},"EDDV":{temp:-6,conditions:[],intensity:null},"EDDP":{temp:-8,conditions:[],intensity:null},"LEMD":{temp:4,conditions:[],intensity:null},"LEBL":{temp:10,conditions:[],intensity:null},"LEPA":{temp:12,conditions:[],intensity:null},"LEMG":{temp:12,conditions:[],intensity:null},"LEVC":{temp:11,conditions:[],intensity:null},"LEAL":{temp:11,conditions:[],intensity:null},
  "LEZL":{temp:9,conditions:[],intensity:null},"GCLP":{temp:17,conditions:[],intensity:null},"GCTS":{temp:13,conditions:[],intensity:null},"GCLA":{temp:14,conditions:[],intensity:null},"GCFV":{temp:16,conditions:[],intensity:null},"LPPT":{temp:11,conditions:[],intensity:null},"LPPR":{temp:10,conditions:[],intensity:null},"LPFR":{temp:12,conditions:[],intensity:null},"LPMA":{temp:15,conditions:[],intensity:null},"LIRF":{temp:6,conditions:[],intensity:null},
  "LIMC":{temp:-1,conditions:["fog"],intensity:null},"LIME":{temp:-3,conditions:[],intensity:null},"LIPZ":{temp:1,conditions:[],intensity:null},"LIRN":{temp:8,conditions:[],intensity:null},"LIML":{temp:-2,conditions:["fog"],intensity:null},"LIPE":{temp:2,conditions:[],intensity:null},"LICC":{temp:9,conditions:[],intensity:null},"LICJ":{temp:12,conditions:[],intensity:null},"LIRA":{temp:6,conditions:[],intensity:null},"LIRP":{temp:2,conditions:[],intensity:null},
  "LIMF":{temp:-1,conditions:[],intensity:null},"LIEO":{temp:5,conditions:["fog"],intensity:null},"LIEE":{temp:8,conditions:[],intensity:null},"EHAM":{temp:1,conditions:[],intensity:null},"EHRD":{temp:1,conditions:[],intensity:null},"EHEH":{temp:1,conditions:[],intensity:null},"EBBR":{temp:3,conditions:[],intensity:null},"EBCI":{temp:3,conditions:[],intensity:null},"ELLX":{temp:0,conditions:[],intensity:null},"LSZH":{temp:-3,conditions:["fog"],intensity:null},
  "LSGG":{temp:1,conditions:[],intensity:null},"LSZB":{temp:-5,conditions:["fog"],intensity:null},"LOWW":{temp:-6,conditions:[],intensity:null},"LOWS":{temp:-11,conditions:["fog"],intensity:null},"LOWG":{temp:-8,conditions:[],intensity:null},"LOWI":{temp:-4,conditions:[],intensity:null},"LKPR":{temp:-9,conditions:[],intensity:null},"EPWA":{temp:-10,conditions:[],intensity:null},"EPKK":{temp:-8,conditions:[],intensity:null},"EPGD":{temp:-11,conditions:["fog"],intensity:null},
  "EPWR":{temp:-6,conditions:[],intensity:null},"EPPO":{temp:-6,conditions:[],intensity:null},"EKCH":{temp:-1,conditions:[],intensity:null},"ESSA":{temp:-1,conditions:[],intensity:null},"ENGM":{temp:-2,conditions:[],intensity:null},"EFHK":{temp:-5,conditions:[],intensity:null},"BIKF":{temp:5,conditions:[],intensity:null},"ESGG":{temp:0,conditions:[],intensity:null},"ESMS":{temp:-1,conditions:[],intensity:null},"ENBR":{temp:-3,conditions:[],intensity:null},
  "ENZV":{temp:1,conditions:[],intensity:null},"ENTC":{temp:-9,conditions:[],intensity:null},"EFOU":{temp:-9,conditions:[],intensity:null},"EFRO":{temp:-12,conditions:[],intensity:null},"LGAV":{temp:9,conditions:[],intensity:null},"LGTS":{temp:5,conditions:[],intensity:null},"LGIR":{temp:15,conditions:[],intensity:null},"LGKR":{temp:12,conditions:[],intensity:null},"LGRP":{temp:14,conditions:["thunderstorm"],intensity:null},"LGSR":{temp:15,conditions:[],intensity:null},
  "LGMK":{temp:14,conditions:[],intensity:null},"LTFM":{temp:5,conditions:[],intensity:null},"LTBA":{temp:7,conditions:[],intensity:null},"LTFJ":{temp:7,conditions:[],intensity:null},"LTAI":{temp:10,conditions:[],intensity:null},"LTAC":{temp:-2,conditions:[],intensity:null},"LTBJ":{temp:10,conditions:["thunderstorm"],intensity:null},"LTBS":{temp:14,conditions:[],intensity:null},"LTFE":{temp:15,conditions:[],intensity:null},"LCLK":{temp:13,conditions:[],intensity:null},
  "LCPH":{temp:15,conditions:[],intensity:null},"LHBP":{temp:-4,conditions:[],intensity:null},"LROP":{temp:0,conditions:[],intensity:null},"LBSF":{temp:-1,conditions:[],intensity:null},"LYBE":{temp:-3,conditions:[],intensity:null},"LDZA":{temp:-3,conditions:[],intensity:null},"LDDU":{temp:9,conditions:[],intensity:null},"LDSP":{temp:10,conditions:[],intensity:null},"LJLJ":{temp:-7,conditions:[],intensity:null},"LWSK":{temp:-1,conditions:["fog"],intensity:null},
  "LATI":{temp:6,conditions:[],intensity:null},"UKBB":{temp:-6,conditions:[],intensity:null},"UKLL":{temp:-11,conditions:[],intensity:null},"UUEE":{temp:-8,conditions:[],intensity:null},"UUDD":{temp:-8,conditions:[],intensity:null},"UUWW":{temp:-8,conditions:["snow"],intensity:null},"ULLI":{temp:-12,conditions:[],intensity:null},"UWWW":{temp:-16,conditions:[],intensity:null},"USSS":{temp:-32,conditions:[],intensity:null},"UNNT":{temp:-25,conditions:[],intensity:null},
  "UUOB":{temp:-29,conditions:[],intensity:null},"UHWW":{temp:-11,conditions:[],intensity:null},"UEEE":{temp:-31,conditions:[],intensity:null},"OMDB":{temp:18,conditions:[],intensity:null},"OMDW":{temp:19,conditions:[],intensity:null},"OMAA":{temp:20,conditions:[],intensity:null},"OMSJ":{temp:19,conditions:[],intensity:null},"OTHH":{temp:17,conditions:[],intensity:null},"OERK":{temp:8,conditions:[],intensity:null},"OEJN":{temp:28,conditions:[],intensity:null},
  "OEDF":{temp:12,conditions:[],intensity:null},"OEMA":{temp:14,conditions:[],intensity:null},"OKBK":{temp:9,conditions:[],intensity:null},"OBBI":{temp:15,conditions:[],intensity:null},"OOMS":{temp:20,conditions:[],intensity:null},"OYAA":{temp:13,conditions:[],intensity:null},"OIIE":{temp:1,conditions:[],intensity:null},"OIII":{temp:1,conditions:[],intensity:null},"OISS":{temp:2,conditions:[],intensity:null},"OIKB":{temp:16,conditions:[],intensity:null},
  "OIAW":{temp:9,conditions:[],intensity:null},"OIKK":{temp:-1,conditions:[],intensity:null},"OICC":{temp:-1,conditions:[],intensity:null},"LLBG":{temp:17,conditions:[],intensity:null},"OLBA":{temp:16,conditions:[],intensity:null},"OJAM":{temp:5,conditions:[],intensity:null},"ORBI":{temp:7,conditions:[],intensity:null},"ORER":{temp:2,conditions:[],intensity:null},"GMMN":{temp:13,conditions:[],intensity:null},"GMME":{temp:14,conditions:[],intensity:null},
  ...
  "HEGN":{temp:20,conditions:[],intensity:null},"HESH":{temp:21,conditions:[],intensity:null},"HEBA":{temp:19,conditions:[],intensity:null},"HEAX":{temp:16,conditions:[],intensity:null},"HLLT":{temp:13,conditions:[],intensity:null},"DNMM":{temp:27,conditions:[],intensity:null},"DNAA":{temp:22,conditions:[],intensity:null},"DGAA":{temp:25,conditions:[],intensity:null},"DIAP":{temp:27,conditions:[],intensity:null},"GOBD":{temp:17,conditions:[],intensity:null},
  "GABS":{temp:20,conditions:[],intensity:null},"GVNP":{temp:17,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:25,conditions:["thunderstorm"],intensity:null},"DXXX":{temp:26,conditions:[],intensity:null},"DBBB":{temp:27,conditions:[],intensity:null},"HKJK":{temp:21,conditions:[],intensity:null},"HKMO":{temp:30,conditions:[],intensity:null},"HTDA":{temp:30,conditions:[],intensity:null},"HTKJ":{temp:25,conditions:[],intensity:null},
  "HUEN":{temp:26,conditions:[],intensity:null},"HRYR":{temp:21,conditions:[],intensity:null},"HAAB":{temp:19,conditions:[],intensity:null},"HDAM":{temp:26,conditions:[],intensity:null},"HCMM":{temp:29,conditions:[],intensity:null},"OYSN":{temp:25,conditions:[],intensity:null},"FMEE":{temp:31,conditions:[],intensity:null},"FIMP":{temp:27,conditions:[],intensity:null},"FMCH":{temp:29,conditions:[],intensity:null},"FMMI":{temp:24,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:27,conditions:[],intensity:null},"FKYS":{temp:23,conditions:[],intensity:null},"FOOL":{temp:24,conditions:[],intensity:null},"FZAA":{temp:25,conditions:[],intensity:null},"FCBB":{temp:24,conditions:[],intensity:null},"FLLK":{temp:22,conditions:[],intensity:null},"FVHA":{temp:21,conditions:[],intensity:null},"FLLS":{temp:22,conditions:[],intensity:null},"FYWH":{temp:24,conditions:[],intensity:null},
  "FBSK":{temp:19,conditions:[],intensity:null},"FAOR":{temp:17,conditions:[],intensity:null},"FACT":{temp:22,conditions:[],intensity:null},"FALE":{temp:28,conditions:[],intensity:null},"FAPE":{temp:24,conditions:[],intensity:null},"FQMA":{temp:25,conditions:[],intensity:null},"FWKI":{temp:23,conditions:[],intensity:null},"ZBAA":{temp:-2,conditions:[],intensity:null},"ZBAD":{temp:-1,conditions:[],intensity:null},"ZSPD":{temp:4,conditions:[],intensity:null},
  "ZSSS":{temp:4,conditions:[],intensity:null},"ZGGG":{temp:9,conditions:[],intensity:null},"VHHH":{temp:13,conditions:[],intensity:null},"ZGSZ":{temp:12,conditions:[],intensity:null},"ZUUU":{temp:8,conditions:[],intensity:null},"ZUCK":{temp:6,conditions:[],intensity:null},"ZHCC":{temp:2,conditions:[],intensity:null},"ZLXY":{temp:3,conditions:[],intensity:null},"ZWSH":{temp:-19,conditions:[],intensity:null},"ZYHB":{temp:-17,conditions:[],intensity:null},
  "ZYTX":{temp:-10,conditions:[],intensity:null},"ZSAM":{temp:12,conditions:[],intensity:null},"ZGKL":{temp:2,conditions:[],intensity:null},"ZSNJ":{temp:2,conditions:[],intensity:null},"ZSHC":{temp:5,conditions:[],intensity:null},"ZPPP":{temp:17,conditions:[],intensity:null},"ZBTJ":{temp:0,conditions:[],intensity:null},"VMMC":{temp:13,conditions:[],intensity:null},"RJTT":{temp:5,conditions:[],intensity:null},"RJAA":{temp:4,conditions:[],intensity:null},
  "RJBB":{temp:5,conditions:[],intensity:null},"RJOO":{temp:4,conditions:[],intensity:null},"RJCC":{temp:-5,conditions:[],intensity:null},"RJFF":{temp:2,conditions:[],intensity:null},"RJGG":{temp:3,conditions:[],intensity:null},"ROAH":{temp:15,conditions:[],intensity:null},"RJSS":{temp:1,conditions:[],intensity:null},"RJSN":{temp:1,conditions:[],intensity:null},"RJOK":{temp:4,conditions:[],intensity:null},"RKSI":{temp:-4,conditions:[],intensity:null},
  ...
  "RPLL":{temp:29,conditions:[],intensity:null},"RPLC":{temp:29,conditions:[],intensity:null},"RPVM":{temp:27,conditions:[],intensity:null},"RPVD":{temp:32,conditions:[],intensity:null},"RPVK":{temp:25,conditions:[],intensity:null},"WBSB":{temp:29,conditions:[],intensity:null},"WBLL":{temp:27,conditions:[],intensity:null},"VIDP":{temp:22,conditions:[],intensity:null},"VABB":{temp:25,conditions:[],intensity:null},"VOBL":{temp:25,conditions:[],intensity:null},
  "VOMM":{temp:28,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:26,conditions:[],intensity:null},"VAAH":{temp:30,conditions:[],intensity:null},"VOCI":{temp:26,conditions:[],intensity:null},"VAGO":{temp:32,conditions:[],intensity:null},"VOTP":{temp:27,conditions:[],intensity:null},"VIAR":{temp:18,conditions:[],intensity:null},"VIJP":{temp:24,conditions:[],intensity:null},"VELR":{temp:20,conditions:[],intensity:null},
  "VOCL":{temp:31,conditions:[],intensity:null},"VOTV":{temp:27,conditions:[],intensity:null},"VEPT":{temp:24,conditions:[],intensity:null},"VNKT":{temp:20,conditions:[],intensity:null},"OPKC":{temp:23,conditions:[],intensity:null},"OPLA":{temp:19,conditions:[],intensity:null},"OPIS":{temp:16,conditions:[],intensity:null},"RCTP":{temp:13,conditions:[],intensity:null},"RCSS":{temp:13,conditions:[],intensity:null},"RCMQ":{temp:15,conditions:[],intensity:null},
  "RCKH":{temp:19,conditions:[],intensity:null},"RCNN":{temp:20,conditions:[],intensity:null},"YSSY":{temp:19,conditions:[],intensity:null},"YMML":{temp:18,conditions:[],intensity:null},"YBBN":{temp:28,conditions:[],intensity:null},"YPPH":{temp:28,conditions:[],intensity:null},"YPAD":{temp:23,conditions:[],intensity:null},"YBCG":{temp:28,conditions:[],intensity:null},"YBCS":{temp:28,conditions:[],intensity:null},"YSCB":{temp:23,conditions:[],intensity:null},
  "YMHB":{temp:15,conditions:[],intensity:null},"NZAA":{temp:20,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:17,conditions:[],intensity:null},"NZQN":{temp:17,conditions:[],intensity:null},"NZDN":{temp:15,conditions:[],intensity:null},"NFFN":{temp:29,conditions:[],intensity:null},"NWWW":{temp:28,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:29,conditions:["thunderstorm"],intensity:null},
  "NIUE":{temp:28,conditions:[],intensity:null},"PGSN":{temp:27,conditions:["thunderstorm"],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:23,conditions:[],intensity:null},"PHKO":{temp:27,conditions:[],intensity:null},"PHLH":{temp:15,conditions:[],intensity:null}
};
