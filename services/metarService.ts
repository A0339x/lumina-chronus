...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:8,conditions:[],intensity:null},"KLAX":{temp:21,conditions:[],intensity:null},"KORD":{temp:3,conditions:[],intensity:null},"KDFW":{temp:17,conditions:[],intensity:null},"KDEN":{temp:16,conditions:[],intensity:null},"KJFK":{temp:2,conditions:[],intensity:null},"KSFO":{temp:14,conditions:[],intensity:null},"KSEA":{temp:10,conditions:[],intensity:null},"KLAS":{temp:18,conditions:[],intensity:null},"KMCO":{temp:16,conditions:[],intensity:null},
  ...
  "KBWI":{temp:5,conditions:[],intensity:null},"KSLC":{temp:6,conditions:[],intensity:null},"KDCA":{temp:5,conditions:[],intensity:null},"KIAD":{temp:5,conditions:[],intensity:null},"KSAN":{temp:21,conditions:[],intensity:null},"KTPA":{temp:18,conditions:[],intensity:null},"KPDX":{temp:11,conditions:[],intensity:null},"KSTL":{temp:11,conditions:[],intensity:null},"KHNL":{temp:27,conditions:[],intensity:null},"KMEM":{temp:9,conditions:[],intensity:null},
  "KAUS":{temp:17,conditions:[],intensity:null},"KBNA":{temp:7,conditions:[],intensity:null},"KRDU":{temp:7,conditions:[],intensity:null},"KCLT":{temp:7,conditions:[],intensity:null},"KSMF":{temp:14,conditions:[],intensity:null},"KSJC":{temp:15,conditions:[],intensity:null},"KOAK":{temp:16,conditions:[],intensity:null},"KCLE":{temp:1,conditions:[],intensity:null},"KMKE":{temp:3,conditions:[],intensity:null},"KPIT":{temp:0,conditions:[],intensity:null},
  "KIND":{temp:4,conditions:[],intensity:null},"KCVG":{temp:4,conditions:[],intensity:null},"KMCI":{temp:11,conditions:[],intensity:null},"KSAT":{temp:17,conditions:[],intensity:null},"KHOU":{temp:16,conditions:[],intensity:null},"KDAL":{temp:16,conditions:[],intensity:null},"KMDW":{temp:3,conditions:[],intensity:null},"PANC":{temp:-13,conditions:[],intensity:null},"PAFA":{temp:-30,conditions:[],intensity:null},"CYYZ":{temp:0,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:25,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:27,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:24,conditions:[],intensity:null},"SBGL":{temp:32,conditions:[],intensity:null},"SBBR":{temp:22,conditions:["thunderstorm"],intensity:null},"SBCF":{temp:24,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:25,conditions:[],intensity:null},
  "SBPA":{temp:26,conditions:[],intensity:null},"SBCT":{temp:23,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:24,conditions:[],intensity:null},"SAEZ":{temp:32,conditions:[],intensity:null},"SABE":{temp:31,conditions:[],intensity:null},"SACO":{temp:27,conditions:[],intensity:null},"SAME":{temp:26,conditions:[],intensity:null},"SLLP":{temp:12,conditions:[],intensity:null},"SLVR":{temp:27,conditions:[],intensity:null},
  "SPJC":{temp:21,conditions:[],intensity:null},"SEQM":{temp:12,conditions:[],intensity:null},"SEGU":{temp:27,conditions:[],intensity:null},"SKBO":{temp:13,conditions:[],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:19,conditions:["thunderstorm"],intensity:null},"SKMD":{temp:21,conditions:[],intensity:null},"SKRG":{temp:14,conditions:["rain"],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:24,conditions:[],intensity:null},
  ...
  "EDDW":{temp:2,conditions:[],intensity:null},"EDDN":{temp:3,conditions:[],intensity:null},"EDDV":{temp:3,conditions:[],intensity:null},"EDDP":{temp:1,conditions:[],intensity:null},"LEMD":{temp:5,conditions:[],intensity:null},"LEBL":{temp:8,conditions:[],intensity:null},"LEPA":{temp:12,conditions:[],intensity:null},"LEMG":{temp:11,conditions:[],intensity:null},"LEVC":{temp:6,conditions:[],intensity:null},"LEAL":{temp:8,conditions:["fog"],intensity:null},
  ...
  "GABS":{temp:22,conditions:[],intensity:null},"GVNP":{temp:19,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:26,conditions:[],intensity:null},"DXXX":{temp:28,conditions:[],intensity:null},"DBBB":{temp:27,conditions:[],intensity:null},"HKJK":{temp:16,conditions:[],intensity:null},"HKMO":{temp:25,conditions:[],intensity:null},"HTDA":{temp:24,conditions:[],intensity:null},"HTKJ":{temp:19,conditions:[],intensity:null},
  ...
  "ZYTX":{temp:-14,conditions:[],intensity:null},"ZSAM":{temp:9,conditions:[],intensity:null},"ZGKL":{temp:6,conditions:[],intensity:null},"ZSNJ":{temp:4,conditions:[],intensity:null},"ZSHC":{temp:5,conditions:[],intensity:null},"ZPPP":{temp:3,conditions:[],intensity:null},"ZBTJ":{temp:-4,conditions:[],intensity:null},"VMMC":{temp:13,conditions:[],intensity:null},"RJTT":{temp:7,conditions:[],intensity:null},"RJAA":{temp:2,conditions:[],intensity:null},
  "RJBB":{temp:11,conditions:[],intensity:null},"RJOO":{temp:4,conditions:[],intensity:null},"RJCC":{temp:-7,conditions:[],intensity:null},"RJFF":{temp:9,conditions:[],intensity:null},"RJGG":{temp:4,conditions:[],intensity:null},"ROAH":{temp:19,conditions:[],intensity:null},"RJSS":{temp:3,conditions:[],intensity:null},"RJSN":{temp:4,conditions:[],intensity:null},"RJOK":{temp:5,conditions:[],intensity:null},"RKSI":{temp:-2,conditions:[],intensity:null},
  ...
  "RCKH":{temp:19,conditions:[],intensity:null},"RCNN":{temp:17,conditions:[],intensity:null},"YSSY":{temp:22,conditions:[],intensity:null},"YMML":{temp:18,conditions:[],intensity:null},"YBBN":{temp:25,conditions:[],intensity:null},"YPPH":{temp:19,conditions:[],intensity:null},"YPAD":{temp:17,conditions:[],intensity:null},"YBCG":{temp:23,conditions:[],intensity:null},"YBCS":{temp:25,conditions:[],intensity:null},"YSCB":{temp:21,conditions:[],intensity:null},
  "YMHB":{temp:17,conditions:[],intensity:null},"NZAA":{temp:23,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:20,conditions:[],intensity:null},"NZQN":{temp:15,conditions:[],intensity:null},"NZDN":{temp:18,conditions:[],intensity:null},"NFFN":{temp:25,conditions:["rain"],intensity:null},"NWWW":{temp:32,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
