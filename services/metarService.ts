...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:8,conditions:[],intensity:null},"KLAX":{temp:12,conditions:[],intensity:null},"KORD":{temp:-10,conditions:[],intensity:null},"KDFW":{temp:2,conditions:[],intensity:null},"KDEN":{temp:-9,conditions:[],intensity:null},"KJFK":{temp:1,conditions:[],intensity:null},"KSFO":{temp:9,conditions:[],intensity:null},"KSEA":{temp:4,conditions:[],intensity:null},"KLAS":{temp:8,conditions:[],intensity:null},"KMCO":{temp:6,conditions:[],intensity:null},
  ...
  "KAUS":{temp:5,conditions:[],intensity:null},"KBNA":{temp:1,conditions:[],intensity:null},"KRDU":{temp:0,conditions:[],intensity:null},"KCLT":{temp:4,conditions:[],intensity:null},"KSMF":{temp:6,conditions:["fog"],intensity:null},"KSJC":{temp:6,conditions:[],intensity:null},"KOAK":{temp:8,conditions:[],intensity:null},"KCLE":{temp:-1,conditions:[],intensity:null},"KMKE":{temp:-11,conditions:[],intensity:null},"KPIT":{temp:0,conditions:[],intensity:null},
  "KIND":{temp:-3,conditions:[],intensity:null},"KCVG":{temp:1,conditions:[],intensity:null},"KMCI":{temp:-10,conditions:[],intensity:null},"KSAT":{temp:6,conditions:[],intensity:null},"KHOU":{temp:12,conditions:[],intensity:null},"KDAL":{temp:2,conditions:[],intensity:null},"KMDW":{temp:-10,conditions:[],intensity:null},"PANC":{temp:-2,conditions:[],intensity:null},"PAFA":{temp:-12,conditions:[],intensity:null},"CYYZ":{temp:-3,conditions:[],intensity:null},
  ...
  "CYXE":{temp:-23,conditions:[],intensity:null},"CYQR":{temp:-27,conditions:[],intensity:null},"CYZF":{temp:-22,conditions:[],intensity:null},"CYXY":{temp:1,conditions:[],intensity:null},"CYQT":{temp:-12,conditions:[],intensity:null},"CYYT":{temp:-3,conditions:[],intensity:null},"MMMX":{temp:11,conditions:[],intensity:null},"MMUN":{temp:21,conditions:[],intensity:null},"MMGL":{temp:13,conditions:["fog"],intensity:null},"MMMY":{temp:13,conditions:[],intensity:null},
  ...
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:22,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:21,conditions:[],intensity:null},"SAEZ":{temp:24,conditions:[],intensity:null},"SABE":{temp:24,conditions:[],intensity:null},"SACO":{temp:22,conditions:[],intensity:null},"SAME":{temp:24,conditions:[],intensity:null},"SLLP":{temp:4,conditions:["fog"],intensity:null},"SLVR":{temp:23,conditions:[],intensity:null},
  "SPJC":{temp:21,conditions:[],intensity:null},"SEQM":{temp:11,conditions:[],intensity:null},"SEGU":{temp:24,conditions:[],intensity:null},"SKBO":{temp:11,conditions:[],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:22,conditions:[],intensity:null},"SKRG":{temp:13,conditions:[],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:20,conditions:[],intensity:null},
  ...
  "EDDW":{temp:5,conditions:[],intensity:null},"EDDN":{temp:2,conditions:[],intensity:null},"EDDV":{temp:3,conditions:[],intensity:null},"EDDP":{temp:4,conditions:[],intensity:null},"LEMD":{temp:4,conditions:[],intensity:null},"LEBL":{temp:13,conditions:[],intensity:null},"LEPA":{temp:14,conditions:[],intensity:null},"LEMG":{temp:13,conditions:[],intensity:null},"LEVC":{temp:11,conditions:["rain"],intensity:null},"LEAL":{temp:14,conditions:[],intensity:null},
  "LEZL":{temp:10,conditions:[],intensity:null},"GCLP":{temp:20,conditions:[],intensity:null},"GCTS":{temp:17,conditions:[],intensity:null},"GCLA":{temp:20,conditions:[],intensity:null},"GCFV":{temp:19,conditions:[],intensity:null},"LPPT":{temp:11,conditions:[],intensity:null},"LPPR":{temp:9,conditions:[],intensity:null},"LPFR":{temp:11,conditions:[],intensity:null},"LPMA":{temp:16,conditions:[],intensity:null},"LIRF":{temp:14,conditions:[],intensity:null},
  ...
  "LSGG":{temp:6,conditions:[],intensity:null},"LSZB":{temp:5,conditions:[],intensity:null},"LOWW":{temp:2,conditions:[],intensity:null},"LOWS":{temp:-2,conditions:["fog"],intensity:null},"LOWG":{temp:-1,conditions:[],intensity:null},"LOWI":{temp:5,conditions:[],intensity:null},"LKPR":{temp:2,conditions:[],intensity:null},"EPWA":{temp:-5,conditions:[],intensity:null},"EPKK":{temp:-2,conditions:[],intensity:null},"EPGD":{temp:-4,conditions:["fog"],intensity:null},
  "EPWR":{temp:3,conditions:[],intensity:null},"EPPO":{temp:2,conditions:[],intensity:null},"EKCH":{temp:3,conditions:[],intensity:null},"ESSA":{temp:3,conditions:[],intensity:null},"ENGM":{temp:1,conditions:[],intensity:null},"EFHK":{temp:-2,conditions:[],intensity:null},"BIKF":{temp:3,conditions:[],intensity:null},"ESGG":{temp:2,conditions:[],intensity:null},"ESMS":{temp:2,conditions:[],intensity:null},"ENBR":{temp:6,conditions:[],intensity:null},
  ...
  "GMMX":{temp:12,conditions:[],intensity:null},"GMTT":{temp:11,conditions:[],intensity:null},"GMFF":{temp:10,conditions:[],intensity:null},"GMAD":{temp:17,conditions:[],intensity:null},"DAAG":{temp:16,conditions:[],intensity:null},"DAOO":{temp:12,conditions:[],intensity:null},"DTTA":{temp:15,conditions:[],intensity:null},"DTMB":{temp:16,conditions:[],intensity:null},"DTTJ":{temp:15,conditions:[],intensity:null},"HECA":{temp:19,conditions:[],intensity:null},
  ...
  "GABS":{temp:29,conditions:[],intensity:null},"GVNP":{temp:22,conditions:[],intensity:null},"GBYD":{temp:29,conditions:[],intensity:null},"GLRB":{temp:29,conditions:[],intensity:null},"DXXX":{temp:33,conditions:[],intensity:null},"DBBB":{temp:33,conditions:[],intensity:null},"HKJK":{temp:25,conditions:[],intensity:null},"HKMO":{temp:32,conditions:[],intensity:null},"HTDA":{temp:32,conditions:[],intensity:null},"HTKJ":{temp:31,conditions:[],intensity:null},
  ...
  "VTBS":{temp:29,conditions:[],intensity:null},"VTBD":{temp:29,conditions:[],intensity:null},"VTSP":{temp:28,conditions:[],intensity:null},"VTCC":{temp:25,conditions:[],intensity:null},"VTSS":{temp:27,conditions:[],intensity:null},"VTUK":{temp:27,conditions:[],intensity:null},"VVNB":{temp:21,conditions:[],intensity:null},"VVTS":{temp:26,conditions:[],intensity:null},"VVDN":{temp:20,conditions:[],intensity:null},"VVCR":{temp:23,conditions:[],intensity:null},
  ...
  "VOMM":{temp:27,conditions:[],intensity:null},"VEBS":{temp:23,conditions:[],intensity:null},"VOHY":{temp:28,conditions:[],intensity:null},"VAAH":{temp:28,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:29,conditions:[],intensity:null},"VOTP":{temp:26,conditions:[],intensity:null},"VIAR":{temp:15,conditions:[],intensity:null},"VIJP":{temp:25,conditions:[],intensity:null},"VELR":{temp:16,conditions:[],intensity:null},
  ...
  "YMHB":{temp:16,conditions:[],intensity:null},"NZAA":{temp:21,conditions:[],intensity:null},"NZWN":{temp:15,conditions:[],intensity:null},"NZCH":{temp:11,conditions:[],intensity:null},"NZQN":{temp:11,conditions:[],intensity:null},"NZDN":{temp:7,conditions:[],intensity:null},"NFFN":{temp:28,conditions:["thunderstorm"],intensity:null},"NWWW":{temp:31,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
