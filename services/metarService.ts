...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:34,conditions:["thunderstorm"],intensity:null},"KLAX":{temp:21,conditions:[],intensity:null},"KORD":{temp:34,conditions:["thunderstorm"],intensity:null},"KDFW":{temp:35,conditions:[],intensity:null},"KDEN":{temp:30,conditions:[],intensity:null},"KJFK":{temp:27,conditions:[],intensity:null},"KSFO":{temp:22,conditions:[],intensity:null},"KSEA":{temp:17,conditions:[],intensity:null},"KLAS":{temp:35,conditions:[],intensity:null},"KMCO":{temp:24,conditions:[],intensity:null},
  "KEWR":{temp:32,conditions:[],intensity:null},"KMIA":{temp:31,conditions:["thunderstorm"],intensity:null},"KPHX":{temp:38,conditions:[],intensity:null},"KIAH":{temp:32,conditions:["thunderstorm"],intensity:null},"KBOS":{temp:27,conditions:[],intensity:null},"KMSP":{temp:32,conditions:["thunderstorm"],intensity:null},"KFLL":{temp:31,conditions:["thunderstorm"],intensity:null},"KDTW":{temp:35,conditions:["thunderstorm"],intensity:null},"KPHL":{temp:31,conditions:[],intensity:null},"KLGA":{temp:31,conditions:[],intensity:null},
  "KBWI":{temp:31,conditions:[],intensity:null},"KSLC":{temp:27,conditions:[],intensity:null},"KDCA":{temp:32,conditions:[],intensity:null},"KIAD":{temp:32,conditions:[],intensity:null},"KSAN":{temp:22,conditions:[],intensity:null},"KTPA":{temp:28,conditions:["thunderstorm"],intensity:null},"KPDX":{temp:18,conditions:[],intensity:null},"KSTL":{temp:35,conditions:["thunderstorm"],intensity:null},"KHNL":{temp:31,conditions:[],intensity:null},"KMEM":{temp:34,conditions:["thunderstorm"],intensity:null},
  "KAUS":{temp:35,conditions:[],intensity:null},"KBNA":{temp:35,conditions:[],intensity:null},"KRDU":{temp:32,conditions:[],intensity:null},"KCLT":{temp:34,conditions:[],intensity:null},"KSMF":{temp:32,conditions:[],intensity:null},"KSJC":{temp:25,conditions:[],intensity:null},"KOAK":{temp:21,conditions:[],intensity:null},"KCLE":{temp:34,conditions:["thunderstorm"],intensity:null},"KMKE":{temp:34,conditions:["thunderstorm"],intensity:null},"KPIT":{temp:32,conditions:["thunderstorm"],intensity:null},
  "KIND":{temp:33,conditions:["thunderstorm"],intensity:null},"KCVG":{temp:33,conditions:["thunderstorm"],intensity:null},"KMCI":{temp:35,conditions:["thunderstorm"],intensity:null},"KSAT":{temp:34,conditions:[],intensity:null},"KHOU":{temp:33,conditions:["thunderstorm"],intensity:null},"KDAL":{temp:31,conditions:[],intensity:null},"KMDW":{temp:34,conditions:["thunderstorm"],intensity:null},"PANC":{temp:13,conditions:[],intensity:null},"PAFA":{temp:16,conditions:[],intensity:null},"CYYZ":{temp:33,conditions:["thunderstorm"],intensity:null},
  "CYVR":{temp:18,conditions:[],intensity:null},"CYUL":{temp:27,conditions:[],intensity:null},"CYYC":{temp:17,conditions:[],intensity:null},"CYEG":{temp:21,conditions:[],intensity:null},"CYOW":{temp:25,conditions:[],intensity:null},"CYWG":{temp:25,conditions:[],intensity:null},"CYHZ":{temp:24,conditions:[],intensity:null},"CYQB":{temp:25,conditions:[],intensity:null},"CYYJ":{temp:17,conditions:[],intensity:null},"CYLW":{temp:24,conditions:[],intensity:null},
  "CYXE":{temp:19,conditions:[],intensity:null},"CYQR":{temp:18,conditions:[],intensity:null},"CYZF":{temp:28,conditions:[],intensity:null},"CYXY":{temp:15,conditions:[],intensity:null},"CYQT":{temp:28,conditions:[],intensity:null},"CYYT":{temp:18,conditions:[],intensity:null},"MMMX":{temp:18,conditions:[],intensity:null},"MMUN":{temp:29,conditions:["thunderstorm"],intensity:null},"MMGL":{temp:25,conditions:["thunderstorm"],intensity:null},"MMMY":{temp:35,conditions:[],intensity:null},
  "MMTJ":{temp:22,conditions:[],intensity:null},"MMSM":{temp:33,conditions:[],intensity:null},"MMMD":{temp:30,conditions:["thunderstorm"],intensity:null},"MMCZ":{temp:30,conditions:["thunderstorm"],intensity:null},"MMSD":{temp:36,conditions:[],intensity:null},"MGGT":{temp:25,conditions:[],intensity:null},"MSLP":{temp:32,conditions:[],intensity:null},"MHTG":{temp:26,conditions:[],intensity:null},"MNMG":{temp:33,conditions:[],intensity:null},"MROC":{temp:28,conditions:[],intensity:null},
  "MPTO":{temp:31,conditions:[],intensity:null},"MKJP":{temp:30,conditions:["thunderstorm"],intensity:null},"TNCM":{temp:28,conditions:[],intensity:null},"TBPB":{temp:27,conditions:[],intensity:null},"TTPP":{temp:26,conditions:[],intensity:null},"MWCR":{temp:31,conditions:["thunderstorm"],intensity:null},"MUHA":{temp:29,conditions:["thunderstorm"],intensity:null},"MDSD":{temp:28,conditions:["thunderstorm"],intensity:null},"MDPP":{temp:29,conditions:["thunderstorm"],intensity:null},"MTPP":{temp:30,conditions:[],intensity:null},
  "TJSJ":{temp:29,conditions:[],intensity:null},"TIST":{temp:28,conditions:["thunderstorm"],intensity:null},"TLPL":{temp:27,conditions:[],intensity:null},"TAPA":{temp:28,conditions:[],intensity:null},"SBGR":{temp:18,conditions:[],intensity:null},"SBGL":{temp:23,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:20,conditions:[],intensity:null},"SBSV":{temp:25,conditions:[],intensity:null},"SBRF":{temp:24,conditions:[],intensity:null},
  "SBPA":{temp:13,conditions:[],intensity:null},"SBCT":{temp:17,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:7,conditions:[],intensity:null},"SAEZ":{temp:8,conditions:[],intensity:null},"SABE":{temp:10,conditions:[],intensity:null},"SACO":{temp:9,conditions:[],intensity:null},"SAME":{temp:4,conditions:[],intensity:null},"SLLP":{temp:8,conditions:[],intensity:null},"SLVR":{temp:24,conditions:[],intensity:null},
  "SPJC":{temp:22,conditions:[],intensity:null},"SEQM":{temp:20,conditions:[],intensity:null},"SEGU":{temp:30,conditions:[],intensity:null},"SKBO":{temp:15,conditions:[],intensity:null},"SKMR":{temp:28,conditions:[],intensity:null},"SKCL":{temp:28,conditions:[],intensity:null},"SKMD":{temp:24,conditions:[],intensity:null},"SKRG":{temp:17,conditions:[],intensity:null},"SVMI":{temp:29,conditions:[],intensity:null},"SUMU":{temp:8,conditions:[],intensity:null},
  "SGAS":{temp:15,conditions:[],intensity:null},"SBBV":{temp:28,conditions:[],intensity:null},"SMJP":{temp:24,conditions:[],intensity:null},"SYCJ":{temp:26,conditions:[],intensity:null},"EGLL":{temp:19,conditions:[],intensity:null},"EGKK":{temp:17,conditions:[],intensity:null},"EGSS":{temp:18,conditions:[],intensity:null},"EGLC":{temp:21,conditions:[],intensity:null},"EGCC":{temp:14,conditions:[],intensity:null},"EGBB":{temp:17,conditions:[],intensity:null},
  "EGPH":{temp:15,conditions:[],intensity:null},"EGPF":{temp:16,conditions:[],intensity:null},"EGGW":{temp:18,conditions:[],intensity:null},"EGNX":{temp:15,conditions:[],intensity:null},"EGNT":{temp:15,conditions:[],intensity:null},"EGGP":{temp:17,conditions:[],intensity:null},"EGHI":{temp:18,conditions:[],intensity:null},"EGGD":{temp:15,conditions:[],intensity:null},"EGPD":{temp:14,conditions:[],intensity:null},"EGAA":{temp:15,conditions:[],intensity:null},
  "EIDW":{temp:15,conditions:[],intensity:null},"EICK":{temp:14,conditions:[],intensity:null},"EINN":{temp:15,conditions:[],intensity:null},"LFPG":{temp:18,conditions:[],intensity:null},"LFPO":{temp:21,conditions:[],intensity:null},"LFML":{temp:29,conditions:[],intensity:null},"LFLL":{temp:24,conditions:[],intensity:null},"LFMN":{temp:26,conditions:[],intensity:null},"LFBD":{temp:19,conditions:[],intensity:null},"LFBO":{temp:22,conditions:[],intensity:null},
  "LFRS":{temp:18,conditions:[],intensity:null},"LFSB":{temp:23,conditions:[],intensity:null},"LFPB":{temp:19,conditions:[],intensity:null},"EDDF":{temp:24,conditions:[],intensity:null},"EDDM":{temp:20,conditions:[],intensity:null},"EDDB":{temp:19,conditions:[],intensity:null},"EDDL":{temp:20,conditions:[],intensity:null},"EDDH":{temp:16,conditions:[],intensity:null},"EDDK":{temp:21,conditions:[],intensity:null},"EDDS":{temp:20,conditions:[],intensity:null},
  "EDDW":{temp:18,conditions:["fog"],intensity:null},"EDDN":{temp:23,conditions:[],intensity:null},"EDDV":{temp:19,conditions:[],intensity:null},"EDDP":{temp:19,conditions:[],intensity:null},"LEMD":{temp:28,conditions:[],intensity:null},"LEBL":{temp:26,conditions:[],intensity:null},"LEPA":{temp:25,conditions:[],intensity:null},"LEMG":{temp:25,conditions:[],intensity:null},"LEVC":{temp:27,conditions:[],intensity:null},"LEAL":{temp:26,conditions:[],intensity:null},
  "LEZL":{temp:29,conditions:[],intensity:null},"GCLP":{temp:24,conditions:[],intensity:null},"GCTS":{temp:22,conditions:[],intensity:null},"GCLA":{temp:24,conditions:[],intensity:null},"GCFV":{temp:23,conditions:[],intensity:null},"LPPT":{temp:20,conditions:[],intensity:null},"LPPR":{temp:19,conditions:[],intensity:null},"LPFR":{temp:26,conditions:[],intensity:null},"LPMA":{temp:21,conditions:[],intensity:null},"LIRF":{temp:26,conditions:[],intensity:null},
  "LIMC":{temp:25,conditions:[],intensity:null},"LIME":{temp:25,conditions:[],intensity:null},"LIPZ":{temp:26,conditions:[],intensity:null},"LIRN":{temp:26,conditions:[],intensity:null},"LIML":{temp:27,conditions:[],intensity:null},"LIPE":{temp:27,conditions:[],intensity:null},"LICC":{temp:27,conditions:[],intensity:null},"LICJ":{temp:26,conditions:[],intensity:null},"LIRA":{temp:25,conditions:[],intensity:null},"LIRP":{temp:25,conditions:[],intensity:null},
  "LIMF":{temp:26,conditions:[],intensity:null},"LIEO":{temp:26,conditions:[],intensity:null},"LIEE":{temp:27,conditions:[],intensity:null},"EHAM":{temp:18,conditions:[],intensity:null},"EHRD":{temp:16,conditions:[],intensity:null},"EHEH":{temp:18,conditions:[],intensity:null},"EBBR":{temp:19,conditions:[],intensity:null},"EBCI":{temp:18,conditions:[],intensity:null},"ELLX":{temp:20,conditions:[],intensity:null},"LSZH":{temp:20,conditions:[],intensity:null},
  "LSGG":{temp:24,conditions:[],intensity:null},"LSZB":{temp:21,conditions:[],intensity:null},"LOWW":{temp:24,conditions:["thunderstorm"],intensity:null},"LOWS":{temp:23,conditions:[],intensity:null},"LOWG":{temp:21,conditions:[],intensity:null},"LOWI":{temp:20,conditions:[],intensity:null},"LKPR":{temp:20,conditions:[],intensity:null},"EPWA":{temp:27,conditions:[],intensity:null},"EPKK":{temp:26,conditions:["thunderstorm"],intensity:null},"EPGD":{temp:18,conditions:[],intensity:null},
  "EPWR":{temp:23,conditions:[],intensity:null},"EPPO":{temp:19,conditions:["thunderstorm"],intensity:null},"EKCH":{temp:20,conditions:[],intensity:null},"ESSA":{temp:18,conditions:[],intensity:null},"ENGM":{temp:15,conditions:[],intensity:null},"EFHK":{temp:18,conditions:[],intensity:null},"BIKF":{temp:10,conditions:[],intensity:null},"ESGG":{temp:16,conditions:[],intensity:null},"ESMS":{temp:17,conditions:[],intensity:null},"ENBR":{temp:14,conditions:[],intensity:null},
  "ENZV":{temp:15,conditions:[],intensity:null},"ENTC":{temp:11,conditions:[],intensity:null},"EFOU":{temp:15,conditions:[],intensity:null},"EFRO":{temp:13,conditions:[],intensity:null},"LGAV":{temp:24,conditions:[],intensity:null},"LGTS":{temp:24,conditions:[],intensity:null},"LGIR":{temp:23,conditions:[],intensity:null},"LGKR":{temp:27,conditions:[],intensity:null},"LGRP":{temp:25,conditions:[],intensity:null},"LGSR":{temp:25,conditions:[],intensity:null},
  "LGMK":{temp:23,conditions:[],intensity:null},"LTFM":{temp:23,conditions:[],intensity:null},"LTBA":{temp:23,conditions:[],intensity:null},"LTFJ":{temp:23,conditions:[],intensity:null},"LTAI":{temp:25,conditions:[],intensity:null},"LTAC":{temp:20,conditions:[],intensity:null},"LTBJ":{temp:25,conditions:[],intensity:null},"LTBS":{temp:25,conditions:[],intensity:null},"LTFE":{temp:24,conditions:[],intensity:null},"LCLK":{temp:26,conditions:[],intensity:null},
  "LCPH":{temp:24,conditions:[],intensity:null},"LHBP":{temp:28,conditions:[],intensity:null},"LROP":{temp:25,conditions:[],intensity:null},"LBSF":{temp:21,conditions:[],intensity:null},"LYBE":{temp:27,conditions:[],intensity:null},"LDZA":{temp:26,conditions:[],intensity:null},"LDDU":{temp:29,conditions:[],intensity:null},"LDSP":{temp:31,conditions:[],intensity:null},"LJLJ":{temp:20,conditions:[],intensity:null},"LWSK":{temp:24,conditions:[],intensity:null},
  "LATI":{temp:25,conditions:[],intensity:null},"UKBB":{temp:21,conditions:[],intensity:null},"UKLL":{temp:27,conditions:[],intensity:null},"UUEE":{temp:18,conditions:[],intensity:null},"UUDD":{temp:18,conditions:[],intensity:null},"UUWW":{temp:18,conditions:[],intensity:null},"ULLI":{temp:18,conditions:[],intensity:null},"UWWW":{temp:16,conditions:[],intensity:null},"USSS":{temp:11,conditions:["fog"],intensity:null},"UNNT":{temp:16,conditions:[],intensity:null},
  "UUOB":{temp:18,conditions:[],intensity:null},"UHWW":{temp:18,conditions:[],intensity:null},"UEEE":{temp:22,conditions:[],intensity:null},"OMDB":{temp:31,conditions:[],intensity:null},"OMDW":{temp:30,conditions:[],intensity:null},"OMAA":{temp:31,conditions:[],intensity:null},"OMSJ":{temp:30,conditions:[],intensity:null},"OTHH":{temp:33,conditions:[],intensity:null},"OERK":{temp:30,conditions:[],intensity:null},"OEJN":{temp:30,conditions:[],intensity:null},
  "OEDF":{temp:32,conditions:[],intensity:null},"OEMA":{temp:32,conditions:[],intensity:null},"OKBK":{temp:36,conditions:[],intensity:null},"OBBI":{temp:33,conditions:[],intensity:null},"OOMS":{temp:33,conditions:[],intensity:null},"OYAA":{temp:19,conditions:[],intensity:null},"OIIE":{temp:23,conditions:[],intensity:null},"OIII":{temp:25,conditions:[],intensity:null},"OISS":{temp:24,conditions:[],intensity:null},"OIKB":{temp:32,conditions:[],intensity:null},
  "OIAW":{temp:32,conditions:[],intensity:null},"OIKK":{temp:28,conditions:[],intensity:null},"OICC":{temp:23,conditions:[],intensity:null},"LLBG":{temp:23,conditions:[],intensity:null},"OLBA":{temp:25,conditions:[],intensity:null},"OJAM":{temp:22,conditions:[],intensity:null},"ORBI":{temp:32,conditions:[],intensity:null},"ORER":{temp:32,conditions:[],intensity:null},"GMMN":{temp:23,conditions:[],intensity:null},"GMME":{temp:24,conditions:[],intensity:null},
  "GMMX":{temp:29,conditions:[],intensity:null},"GMTT":{temp:27,conditions:[],intensity:null},"GMFF":{temp:28,conditions:[],intensity:null},"GMAD":{temp:21,conditions:[],intensity:null},"DAAG":{temp:24,conditions:[],intensity:null},"DAOO":{temp:25,conditions:[],intensity:null},"DTTA":{temp:26,conditions:[],intensity:null},"DTMB":{temp:27,conditions:[],intensity:null},"DTTJ":{temp:28,conditions:[],intensity:null},"HECA":{temp:25,conditions:[],intensity:null},
  "HEGN":{temp:31,conditions:[],intensity:null},"HESH":{temp:30,conditions:[],intensity:null},"HEBA":{temp:32,conditions:[],intensity:null},"HEAX":{temp:25,conditions:[],intensity:null},"HLLT":{temp:26,conditions:[],intensity:null},"DNMM":{temp:24,conditions:[],intensity:null},"DNAA":{temp:24,conditions:[],intensity:null},"DGAA":{temp:25,conditions:[],intensity:null},"DIAP":{temp:26,conditions:[],intensity:null},"GOBD":{temp:25,conditions:[],intensity:null},
  "GABS":{temp:26,conditions:[],intensity:null},"GVNP":{temp:25,conditions:[],intensity:null},"GBYD":{temp:25,conditions:[],intensity:null},"GLRB":{temp:25,conditions:[],intensity:null},"DXXX":{temp:26,conditions:[],intensity:null},"DBBB":{temp:25,conditions:[],intensity:null},"HKJK":{temp:16,conditions:[],intensity:null},"HKMO":{temp:24,conditions:[],intensity:null},"HTDA":{temp:21,conditions:[],intensity:null},"HTKJ":{temp:17,conditions:[],intensity:null},
  "HUEN":{temp:21,conditions:[],intensity:null},"HRYR":{temp:18,conditions:[],intensity:null},"HAAB":{temp:13,conditions:[],intensity:null},"HDAM":{temp:34,conditions:[],intensity:null},"HCMM":{temp:25,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:19,conditions:[],intensity:null},"FIMP":{temp:19,conditions:[],intensity:null},"FMCH":{temp:23,conditions:[],intensity:null},"FMMI":{temp:13,conditions:[],intensity:null},
  "FSIA":{temp:25,conditions:[],intensity:null},"FKKD":{temp:25,conditions:[],intensity:null},"FKYS":{temp:21,conditions:[],intensity:null},"FOOL":{temp:20,conditions:[],intensity:null},"FZAA":{temp:24,conditions:[],intensity:null},"FCBB":{temp:23,conditions:[],intensity:null},"FLLK":{temp:15,conditions:[],intensity:null},"FVHA":{temp:13,conditions:[],intensity:null},"FLLS":{temp:14,conditions:[],intensity:null},"FYWH":{temp:12,conditions:[],intensity:null},
  "FBSK":{temp:12,conditions:[],intensity:null},"FAOR":{temp:11,conditions:[],intensity:null},"FACT":{temp:10,conditions:[],intensity:null},"FALE":{temp:17,conditions:[],intensity:null},"FAPE":{temp:11,conditions:[],intensity:null},"FQMA":{temp:18,conditions:[],intensity:null},"FWKI":{temp:15,conditions:[],intensity:null},"ZBAA":{temp:21,conditions:[],intensity:null},"ZBAD":{temp:21,conditions:[],intensity:null},"ZSPD":{temp:24,conditions:["thunderstorm"],intensity:null},
  "ZSSS":{temp:24,conditions:["thunderstorm"],intensity:null},"ZGGG":{temp:26,conditions:[],intensity:null},"VHHH":{temp:29,conditions:[],intensity:null},"ZGSZ":{temp:26,conditions:[],intensity:null},"ZUUU":{temp:22,conditions:[],intensity:null},"ZUCK":{temp:22,conditions:[],intensity:null},"ZHCC":{temp:23,conditions:[],intensity:null},"ZLXY":{temp:23,conditions:[],intensity:null},"ZWSH":{temp:26,conditions:[],intensity:null},"ZYHB":{temp:24,conditions:[],intensity:null},
  "ZYTX":{temp:22,conditions:[],intensity:null},"ZSAM":{temp:27,conditions:[],intensity:null},"ZGKL":{temp:24,conditions:[],intensity:null},"ZSNJ":{temp:23,conditions:[],intensity:null},"ZSHC":{temp:24,conditions:[],intensity:null},"ZPPP":{temp:15,conditions:[],intensity:null},"ZBTJ":{temp:21,conditions:[],intensity:null},"VMMC":{temp:27,conditions:["thunderstorm"],intensity:null},"RJTT":{temp:22,conditions:[],intensity:null},"RJAA":{temp:22,conditions:[],intensity:null},
  "RJBB":{temp:23,conditions:[],intensity:null},"RJOO":{temp:23,conditions:[],intensity:null},"RJCC":{temp:18,conditions:[],intensity:null},"RJFF":{temp:24,conditions:[],intensity:null},"RJGG":{temp:22,conditions:[],intensity:null},"ROAH":{temp:28,conditions:[],intensity:null},"RJSS":{temp:20,conditions:[],intensity:null},"RJSN":{temp:21,conditions:[],intensity:null},"RJOK":{temp:22,conditions:["rain"],intensity:null},"RKSI":{temp:22,conditions:[],intensity:null},
  "RKSS":{temp:22,conditions:[],intensity:null},"RKPK":{temp:21,conditions:["rain"],intensity:null},"RKPC":{temp:26,conditions:["rain"],intensity:null},"RKTN":{temp:20,conditions:[],intensity:null},"ZKPY":{temp:21,conditions:[],intensity:null},"WSSS":{temp:27,conditions:[],intensity:null},"WMKK":{temp:24,conditions:[],intensity:null},"WMKP":{temp:27,conditions:[],intensity:null},"WBKK":{temp:27,conditions:[],intensity:null},"WBGG":{temp:24,conditions:[],intensity:null},
  "VTBS":{temp:27,conditions:[],intensity:null},"VTBD":{temp:27,conditions:[],intensity:null},"VTSP":{temp:25,conditions:["rain"],intensity:null},"VTCC":{temp:25,conditions:[],intensity:null},"VTSS":{temp:27,conditions:[],intensity:null},"VTUK":{temp:26,conditions:["thunderstorm"],intensity:null},"VVNB":{temp:25,conditions:[],intensity:null},"VVTS":{temp:26,conditions:[],intensity:null},"VVDN":{temp:28,conditions:[],intensity:null},"VVCR":{temp:28,conditions:[],intensity:null},
  "VDPP":{temp:26,conditions:[],intensity:null},"VDSR":{temp:26,conditions:[],intensity:null},"VLVT":{temp:24,conditions:[],intensity:null},"VLLB":{temp:25,conditions:[],intensity:null},"VYYY":{temp:26,conditions:[],intensity:null},"VYMD":{temp:27,conditions:[],intensity:null},"VGHS":{temp:26,conditions:[],intensity:null},"VGCG":{temp:26,conditions:[],intensity:null},"VECC":{temp:26,conditions:[],intensity:null},"VRMM":{temp:28,conditions:[],intensity:null},
  "VCBI":{temp:27,conditions:[],intensity:null},"WIII":{temp:24,conditions:[],intensity:null},"WADD":{temp:23,conditions:[],intensity:null},"WARR":{temp:22,conditions:[],intensity:null},"WIHH":{temp:25,conditions:[],intensity:null},"WIMM":{temp:24,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:23,conditions:[],intensity:null},"WICC":{temp:17,conditions:[],intensity:null},"WASS":{temp:27,conditions:[],intensity:null},
  "RPLL":{temp:27,conditions:[],intensity:null},"RPLC":{temp:25,conditions:[],intensity:null},"RPVM":{temp:26,conditions:[],intensity:null},"RPVD":{temp:24,conditions:[],intensity:null},"RPVK":{temp:25,conditions:[],intensity:null},"WBSB":{temp:25,conditions:[],intensity:null},"WBLL":{temp:28,conditions:[],intensity:null},"VIDP":{temp:30,conditions:[],intensity:null},"VABB":{temp:27,conditions:["thunderstorm"],intensity:null},"VOBL":{temp:21,conditions:[],intensity:null},
  "VOMM":{temp:28,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:25,conditions:[],intensity:null},"VAAH":{temp:30,conditions:[],intensity:null},"VOCI":{temp:25,conditions:[],intensity:null},"VAGO":{temp:25,conditions:["thunderstorm"],intensity:null},"VOTP":{temp:24,conditions:[],intensity:null},"VIAR":{temp:27,conditions:[],intensity:null},"VIJP":{temp:30,conditions:[],intensity:null},"VELR":{temp:22,conditions:[],intensity:null},
  "VOCL":{temp:23,conditions:[],intensity:null},"VOTV":{temp:24,conditions:[],intensity:null},"VEPT":{temp:27,conditions:["thunderstorm"],intensity:null},"VNKT":{temp:21,conditions:[],intensity:null},"OPKC":{temp:28,conditions:[],intensity:null},"OPLA":{temp:30,conditions:[],intensity:null},"OPIS":{temp:30,conditions:["thunderstorm"],intensity:null},"RCTP":{temp:27,conditions:[],intensity:null},"RCSS":{temp:27,conditions:[],intensity:null},"RCMQ":{temp:27,conditions:[],intensity:null},
  "RCKH":{temp:27,conditions:[],intensity:null},"RCNN":{temp:27,conditions:[],intensity:null},"YSSY":{temp:15,conditions:[],intensity:null},"YMML":{temp:11,conditions:[],intensity:null},"YBBN":{temp:17,conditions:[],intensity:null},"YPPH":{temp:9,conditions:[],intensity:null},"YPAD":{temp:13,conditions:[],intensity:null},"YBCG":{temp:17,conditions:[],intensity:null},"YBCS":{temp:23,conditions:[],intensity:null},"YSCB":{temp:10,conditions:[],intensity:null},
  "YMHB":{temp:8,conditions:[],intensity:null},"NZAA":{temp:10,conditions:[],intensity:null},"NZWN":{temp:9,conditions:[],intensity:null},"NZCH":{temp:6,conditions:[],intensity:null},"NZQN":{temp:3,conditions:[],intensity:null},"NZDN":{temp:4,conditions:[],intensity:null},"NFFN":{temp:25,conditions:[],intensity:null},"NWWW":{temp:22,conditions:[],intensity:null},"NTAA":{temp:31,conditions:[],intensity:null},"NSFA":{temp:26,conditions:[],intensity:null},
  "NIUE":{temp:23,conditions:[],intensity:null},"PGSN":{temp:30,conditions:[],intensity:null},"PGUM":{temp:30,conditions:[],intensity:null},"PHOG":{temp:29,conditions:[],intensity:null},"PHKO":{temp:29,conditions:[],intensity:null},"PHLH":{temp:28,conditions:[],intensity:null}
};
