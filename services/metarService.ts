...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "SBPA":{temp:30,conditions:["thunderstorm"],intensity:null},"SBCT":{temp:27,conditions:[],intensity:null},"SBFZ":{temp:29,conditions:[],intensity:null},"SCEL":{temp:30,conditions:[],intensity:null},"SAEZ":{temp:31,conditions:[],intensity:null},"SABE":{temp:29,conditions:[],intensity:null},"SACO":{temp:29,conditions:[],intensity:null},"SAME":{temp:31,conditions:[],intensity:null},"SLLP":{temp:16,conditions:[],intensity:null},"SLVR":{temp:31,conditions:[],intensity:null},
  ...
  "LEZL":{temp:11,conditions:[],intensity:null},"GCLP":{temp:18,conditions:[],intensity:null},"GCTS":{temp:17,conditions:[],intensity:null},"GCLA":{temp:18,conditions:[],intensity:null},"GCFV":{temp:17,conditions:[],intensity:null},"LPPT":{temp:9,conditions:[],intensity:null},"LPPR":{temp:8,conditions:[],intensity:null},"LPFR":{temp:11,conditions:[],intensity:null},"LPMA":{temp:14,conditions:[],intensity:null},"LIRF":{temp:10,conditions:[],intensity:null},
  ...
  "LIMF":{temp:7,conditions:[],intensity:null},"LIEO":{temp:12,conditions:[],intensity:null},"LIEE":{temp:13,conditions:[],intensity:null},"EHAM":{temp:9,conditions:[],intensity:null},"EHRD":{temp:8,conditions:[],intensity:null},"EHEH":{temp:9,conditions:[],intensity:null},"EBBR":{temp:9,conditions:[],intensity:null},"EBCI":{temp:8,conditions:[],intensity:null},"ELLX":{temp:7,conditions:[],intensity:null},"LSZH":{temp:0,conditions:["fog"],intensity:null},
  "LSGG":{temp:4,conditions:[],intensity:null},"LSZB":{temp:3,conditions:[],intensity:null},"LOWW":{temp:0,conditions:["freezing"],intensity:null},"LOWS":{temp:-1,conditions:[],intensity:null},"LOWG":{temp:-2,conditions:["fog"],intensity:null},"LOWI":{temp:2,conditions:[],intensity:null},"LKPR":{temp:0,conditions:[],intensity:null},"EPWA":{temp:-7,conditions:[],intensity:null},"EPKK":{temp:-4,conditions:[],intensity:null},"EPGD":{temp:-2,conditions:[],intensity:null},
  ...
  "ENZV":{temp:4,conditions:[],intensity:null},"ENTC":{temp:-4,conditions:[],intensity:null},"EFOU":{temp:-1,conditions:["snow"],intensity:null},"EFRO":{temp:-2,conditions:[],intensity:null},"LGAV":{temp:10,conditions:[],intensity:null},"LGTS":{temp:6,conditions:[],intensity:null},"LGIR":{temp:13,conditions:[],intensity:null},"LGKR":{temp:13,conditions:[],intensity:null},"LGRP":{temp:13,conditions:[],intensity:null},"LGSR":{temp:14,conditions:[],intensity:null},
  "LGMK":{temp:12,conditions:[],intensity:null},"LTFM":{temp:2,conditions:[],intensity:null},"LTBA":{temp:3,conditions:[],intensity:null},"LTFJ":{temp:3,conditions:[],intensity:null},"LTAI":{temp:10,conditions:[],intensity:null},"LTAC":{temp:3,conditions:[],intensity:null},"LTBJ":{temp:8,conditions:[],intensity:null},"LTBS":{temp:12,conditions:[],intensity:null},"LTFE":{temp:11,conditions:[],intensity:null},"LCLK":{temp:11,conditions:[],intensity:null},
  ...
  "LATI":{temp:8,conditions:[],intensity:null},"UKBB":{temp:-15,conditions:[],intensity:null},"UKLL":{temp:-10,conditions:[],intensity:null},"UUEE":{temp:-11,conditions:[],intensity:null},"UUDD":{temp:-12,conditions:[],intensity:null},"UUWW":{temp:-14,conditions:[],intensity:null},"ULLI":{temp:-11,conditions:[],intensity:null},"UWWW":{temp:-14,conditions:[],intensity:null},"USSS":{temp:-22,conditions:[],intensity:null},"UNNT":{temp:-36,conditions:[],intensity:null},
  ...
  "GMMX":{temp:12,conditions:[],intensity:null},"GMTT":{temp:13,conditions:[],intensity:null},"GMFF":{temp:10,conditions:["rain"],intensity:null},"GMAD":{temp:15,conditions:[],intensity:null},"DAAG":{temp:10,conditions:[],intensity:null},"DAOO":{temp:14,conditions:[],intensity:null},"DTTA":{temp:13,conditions:[],intensity:null},"DTMB":{temp:13,conditions:[],intensity:null},"DTTJ":{temp:13,conditions:[],intensity:null},"HECA":{temp:15,conditions:[],intensity:null},
  "HEGN":{temp:16,conditions:[],intensity:null},"HESH":{temp:16,conditions:[],intensity:null},"HEBA":{temp:15,conditions:[],intensity:null},"HEAX":{temp:15,conditions:[],intensity:null},"HLLT":{temp:15,conditions:[],intensity:null},"DNMM":{temp:28,conditions:[],intensity:null},"DNAA":{temp:28,conditions:[],intensity:null},"DGAA":{temp:28,conditions:[],intensity:null},"DIAP":{temp:27,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  "GABS":{temp:23,conditions:[],intensity:null},"GVNP":{temp:19,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:28,conditions:[],intensity:null},"DXXX":{temp:28,conditions:[],intensity:null},"DBBB":{temp:28,conditions:[],intensity:null},"HKJK":{temp:18,conditions:[],intensity:null},"HKMO":{temp:26,conditions:[],intensity:null},"HTDA":{temp:26,conditions:[],intensity:null},"HTKJ":{temp:20,conditions:[],intensity:null},
  ...
  "RJBB":{temp:9,conditions:[],intensity:null},"RJOO":{temp:3,conditions:[],intensity:null},"RJCC":{temp:-11,conditions:[],intensity:null},"RJFF":{temp:7,conditions:[],intensity:null},"RJGG":{temp:7,conditions:[],intensity:null},"ROAH":{temp:20,conditions:[],intensity:null},"RJSS":{temp:3,conditions:[],intensity:null},"RJSN":{temp:4,conditions:[],intensity:null},"RJOK":{temp:8,conditions:[],intensity:null},"RKSI":{temp:-2,conditions:[],intensity:null},
  "RKSS":{temp:-4,conditions:[],intensity:null},"RKPK":{temp:3,conditions:[],intensity:null},"RKPC":{temp:6,conditions:[],intensity:null},"RKTN":{temp:0,conditions:[],intensity:null},"ZKPY":{temp:-12,conditions:[],intensity:null},"WSSS":{temp:25,conditions:[],intensity:null},"WMKK":{temp:24,conditions:[],intensity:null},"WMKP":{temp:28,conditions:[],intensity:null},"WBKK":{temp:26,conditions:[],intensity:null},"WBGG":{temp:23,conditions:[],intensity:null},
  "VTBS":{temp:25,conditions:[],intensity:null},"VTBD":{temp:24,conditions:[],intensity:null},"VTSP":{temp:27,conditions:[],intensity:null},"VTCC":{temp:20,conditions:[],intensity:null},"VTSS":{temp:26,conditions:[],intensity:null},"VTUK":{temp:24,conditions:[],intensity:null},"VVNB":{temp:20,conditions:[],intensity:null},"VVTS":{temp:22,conditions:[],intensity:null},"VVDN":{temp:18,conditions:["fog"],intensity:null},"VVCR":{temp:19,conditions:["fog"],intensity:null},
  ...
  "VOMM":{temp:22,conditions:[],intensity:null},"VEBS":{temp:16,conditions:[],intensity:null},"VOHY":{temp:18,conditions:[],intensity:null},"VAAH":{temp:16,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:27,conditions:[],intensity:null},"VOTP":{temp:20,conditions:[],intensity:null},"VIAR":{temp:8,conditions:["fog"],intensity:null},"VIJP":{temp:14,conditions:[],intensity:null},"VELR":{temp:8,conditions:[],intensity:null},
  ...
  "YMHB":{temp:14,conditions:[],intensity:null},"NZAA":{temp:20,conditions:[],intensity:null},"NZWN":{temp:15,conditions:[],intensity:null},"NZCH":{temp:11,conditions:[],intensity:null},"NZQN":{temp:10,conditions:[],intensity:null},"NZDN":{temp:9,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:30,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
