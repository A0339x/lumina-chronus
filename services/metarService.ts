...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LIMF":{temp:4,conditions:[],intensity:null},"LIEO":{temp:12,conditions:[],intensity:null},"LIEE":{temp:12,conditions:[],intensity:null},"EHAM":{temp:4,conditions:[],intensity:null},"EHRD":{temp:4,conditions:[],intensity:null},"EHEH":{temp:4,conditions:[],intensity:null},"EBBR":{temp:6,conditions:[],intensity:null},"EBCI":{temp:3,conditions:["fog"],intensity:null},"ELLX":{temp:4,conditions:[],intensity:null},"LSZH":{temp:2,conditions:["fog"],intensity:null},
