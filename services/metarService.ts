...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:1,conditions:[],intensity:null},"KLAX":{temp:11,conditions:[],intensity:null},"KORD":{temp:-15,conditions:["snow"],intensity:null},"KDFW":{temp:-9,conditions:["snow"],intensity:null},"KDEN":{temp:-13,conditions:[],intensity:null},"KJFK":{temp:-10,conditions:[],intensity:null},"KSFO":{temp:9,conditions:[],intensity:null},"KSEA":{temp:0,conditions:[],intensity:null},"KLAS":{temp:6,conditions:[],intensity:null},"KMCO":{temp:18,conditions:[],intensity:null},
  "KEWR":{temp:-10,conditions:[],intensity:null},"KMIA":{temp:22,conditions:[],intensity:null},"KPHX":{temp:12,conditions:[],intensity:null},"KIAH":{temp:2,conditions:["rain"],intensity:null},"KBOS":{temp:-15,conditions:[],intensity:null},"KMSP":{temp:-23,conditions:[],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:-13,conditions:[],intensity:null},"KPHL":{temp:-8,conditions:[],intensity:null},"KLGA":{temp:-10,conditions:[],intensity:null},
  "KBWI":{temp:-7,conditions:[],intensity:null},"KSLC":{temp:-4,conditions:[],intensity:null},"KDCA":{temp:-8,conditions:["snow"],intensity:null},"KIAD":{temp:-9,conditions:["snow"],intensity:null},"KSAN":{temp:11,conditions:[],intensity:null},"KTPA":{temp:20,conditions:[],intensity:null},"KPDX":{temp:-1,conditions:[],intensity:null},"KSTL":{temp:-13,conditions:["snow"],intensity:null},"KHNL":{temp:24,conditions:[],intensity:null},"KMEM":{temp:-7,conditions:["freezing"],intensity:null},
  "KAUS":{temp:-5,conditions:[],intensity:null},"KBNA":{temp:-4,conditions:["freezing"],intensity:null},"KRDU":{temp:-8,conditions:[],intensity:null},"KCLT":{temp:-6,conditions:[],intensity:null},"KSMF":{temp:5,conditions:[],intensity:null},"KSJC":{temp:8,conditions:[],intensity:null},"KOAK":{temp:9,conditions:[],intensity:null},"KCLE":{temp:-13,conditions:[],intensity:null},"KMKE":{temp:-17,conditions:[],intensity:null},"KPIT":{temp:-11,conditions:[],intensity:null},
  "KIND":{temp:-12,conditions:["snow"],intensity:null},"KCVG":{temp:-11,conditions:["snow"],intensity:null},"KMCI":{temp:-18,conditions:[],intensity:null},"KSAT":{temp:-2,conditions:[],intensity:null},"KHOU":{temp:3,conditions:[],intensity:null},"KDAL":{temp:-8,conditions:["snow"],intensity:null},"KMDW":{temp:-15,conditions:[],intensity:null},"PANC":{temp:-4,conditions:[],intensity:null},"PAFA":{temp:-15,conditions:[],intensity:null},"CYYZ":{temp:-16,conditions:[],intensity:null},
  "CYVR":{temp:-1,conditions:["fog"],intensity:null},"CYUL":{temp:-26,conditions:[],intensity:null},"CYYC":{temp:-20,conditions:[],intensity:null},"CYEG":{temp:-22,conditions:[],intensity:null},"CYOW":{temp:-27,conditions:[],intensity:null},"CYWG":{temp:-34,conditions:[],intensity:null},"CYHZ":{temp:-18,conditions:[],intensity:null},"CYQB":{temp:-27,conditions:[],intensity:null},"CYYJ":{temp:1,conditions:[],intensity:null},"CYLW":{temp:-8,conditions:[],intensity:null},
  "CYXE":{temp:-39,conditions:[],intensity:null},"CYQR":{temp:-34,conditions:[],intensity:null},"CYZF":{temp:-21,conditions:[],intensity:null},"CYXY":{temp:-9,conditions:[],intensity:null},"CYQT":{temp:-29,conditions:[],intensity:null},"CYYT":{temp:-11,conditions:[],intensity:null},"MMMX":{temp:12,conditions:[],intensity:null},"MMUN":{temp:22,conditions:[],intensity:null},"MMGL":{temp:14,conditions:[],intensity:null},"MMMY":{temp:9,conditions:[],intensity:null},
  "MMTJ":{temp:10,conditions:[],intensity:null},"MMSM":{temp:26,conditions:[],intensity:null},"MMMD":{temp:23,conditions:[],intensity:null},"MMCZ":{temp:26,conditions:[],intensity:null},"MMSD":{temp:14,conditions:[],intensity:null},"MGGT":{temp:15,conditions:["fog"],intensity:null},"MSLP":{temp:23,conditions:[],intensity:null},"MHTG":{temp:19,conditions:[],intensity:null},"MNMG":{temp:24,conditions:[],intensity:null},"MROC":{temp:19,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:22,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:19,conditions:["fog"],intensity:null},"SBGL":{temp:23,conditions:["fog"],intensity:null},"SBBR":{temp:18,conditions:["fog"],intensity:null},"SBCF":{temp:19,conditions:[],intensity:null},"SBSV":{temp:25,conditions:[],intensity:null},"SBRF":{temp:24,conditions:[],intensity:null},
  ...
  "EIDW":{temp:5,conditions:[],intensity:null},"EICK":{temp:0,conditions:["fog"],intensity:null},"EINN":{temp:5,conditions:[],intensity:null},"LFPG":{temp:3,conditions:[],intensity:null},"LFPO":{temp:3,conditions:[],intensity:null},"LFML":{temp:5,conditions:[],intensity:null},"LFLL":{temp:3,conditions:[],intensity:null},"LFMN":{temp:8,conditions:[],intensity:null},"LFBD":{temp:7,conditions:[],intensity:null},"LFBO":{temp:5,conditions:[],intensity:null},
  ...
  "EDDW":{temp:-1,conditions:[],intensity:null},"EDDN":{temp:-2,conditions:[],intensity:null},"EDDV":{temp:-2,conditions:[],intensity:null},"EDDP":{temp:-2,conditions:[],intensity:null},"LEMD":{temp:4,conditions:[],intensity:null},"LEBL":{temp:8,conditions:[],intensity:null},"LEPA":{temp:10,conditions:[],intensity:null},"LEMG":{temp:11,conditions:[],intensity:null},"LEVC":{temp:9,conditions:[],intensity:null},"LEAL":{temp:10,conditions:[],intensity:null},
  "LEZL":{temp:10,conditions:[],intensity:null},"GCLP":{temp:16,conditions:[],intensity:null},"GCTS":{temp:13,conditions:[],intensity:null},"GCLA":{temp:14,conditions:[],intensity:null},"GCFV":{temp:13,conditions:[],intensity:null},"LPPT":{temp:13,conditions:[],intensity:null},"LPPR":{temp:12,conditions:[],intensity:null},"LPFR":{temp:14,conditions:[],intensity:null},"LPMA":{temp:13,conditions:[],intensity:null},"LIRF":{temp:9,conditions:[],intensity:null},
  "LIMC":{temp:5,conditions:[],intensity:null},"LIME":{temp:5,conditions:["fog"],intensity:null},"LIPZ":{temp:8,conditions:[],intensity:null},"LIRN":{temp:12,conditions:["rain"],intensity:null},"LIML":{temp:4,conditions:["fog"],intensity:null},"LIPE":{temp:5,conditions:[],intensity:null},"LICC":{temp:14,conditions:[],intensity:null},"LICJ":{temp:11,conditions:[],intensity:null},"LIRA":{temp:8,conditions:[],intensity:null},"LIRP":{temp:8,conditions:[],intensity:null},
  "LIMF":{temp:3,conditions:[],intensity:null},"LIEO":{temp:7,conditions:[],intensity:null},"LIEE":{temp:10,conditions:[],intensity:null},"EHAM":{temp:-1,conditions:[],intensity:null},"EHRD":{temp:-1,conditions:[],intensity:null},"EHEH":{temp:-1,conditions:[],intensity:null},"EBBR":{temp:1,conditions:[],intensity:null},"EBCI":{temp:1,conditions:[],intensity:null},"ELLX":{temp:-2,conditions:[],intensity:null},"LSZH":{temp:1,conditions:["fog"],intensity:null},
  ...
  "ENZV":{temp:-1,conditions:[],intensity:null},"ENTC":{temp:0,conditions:[],intensity:null},"EFOU":{temp:-9,conditions:[],intensity:null},"EFRO":{temp:-16,conditions:[],intensity:null},"LGAV":{temp:12,conditions:[],intensity:null},"LGTS":{temp:8,conditions:[],intensity:null},"LGIR":{temp:14,conditions:[],intensity:null},"LGKR":{temp:15,conditions:[],intensity:null},"LGRP":{temp:15,conditions:[],intensity:null},"LGSR":{temp:16,conditions:[],intensity:null},
  "LGMK":{temp:15,conditions:[],intensity:null},"LTFM":{temp:9,conditions:[],intensity:null},"LTBA":{temp:10,conditions:["fog"],intensity:null},"LTFJ":{temp:10,conditions:[],intensity:null},"LTAI":{temp:12,conditions:[],intensity:null},"LTAC":{temp:3,conditions:["fog"],intensity:null},"LTBJ":{temp:12,conditions:[],intensity:null},"LTBS":{temp:14,conditions:[],intensity:null},"LTFE":{temp:15,conditions:[],intensity:null},"LCLK":{temp:12,conditions:[],intensity:null},
  "LCPH":{temp:13,conditions:[],intensity:null},"LHBP":{temp:1,conditions:[],intensity:null},"LROP":{temp:0,conditions:["fog"],intensity:null},"LBSF":{temp:-1,conditions:[],intensity:null},"LYBE":{temp:6,conditions:[],intensity:null},"LDZA":{temp:3,conditions:[],intensity:null},"LDDU":{temp:13,conditions:[],intensity:null},"LDSP":{temp:14,conditions:[],intensity:null},"LJLJ":{temp:1,conditions:[],intensity:null},"LWSK":{temp:3,conditions:["fog"],intensity:null},
  "LATI":{temp:12,conditions:[],intensity:null},"UKBB":{temp:-12,conditions:[],intensity:null},"UKLL":{temp:-2,conditions:[],intensity:null},"UUEE":{temp:-22,conditions:[],intensity:null},"UUDD":{temp:-25,conditions:[],intensity:null},"UUWW":{temp:-24,conditions:[],intensity:null},"ULLI":{temp:-16,conditions:[],intensity:null},"UWWW":{temp:-29,conditions:[],intensity:null},"USSS":{temp:-22,conditions:[],intensity:null},"UNNT":{temp:-29,conditions:[],intensity:null},
  "UUOB":{temp:-18,conditions:[],intensity:null},"UHWW":{temp:-10,conditions:[],intensity:null},"UEEE":{temp:-30,conditions:[],intensity:null},"OMDB":{temp:22,conditions:[],intensity:null},"OMDW":{temp:21,conditions:[],intensity:null},"OMAA":{temp:21,conditions:[],intensity:null},"OMSJ":{temp:22,conditions:[],intensity:null},"OTHH":{temp:21,conditions:[],intensity:null},"OERK":{temp:15,conditions:[],intensity:null},"OEJN":{temp:25,conditions:[],intensity:null},
  "OEDF":{temp:18,conditions:[],intensity:null},"OEMA":{temp:16,conditions:[],intensity:null},"OKBK":{temp:15,conditions:[],intensity:null},"OBBI":{temp:18,conditions:[],intensity:null},"OOMS":{temp:24,conditions:[],intensity:null},"OYAA":{temp:17,conditions:[],intensity:null},"OIIE":{temp:2,conditions:[],intensity:null},"OIII":{temp:3,conditions:[],intensity:null},"OISS":{temp:1,conditions:["snow"],intensity:null},"OIKB":{temp:15,conditions:[],intensity:null},
  "OIAW":{temp:12,conditions:[],intensity:null},"OIKK":{temp:6,conditions:[],intensity:null},"OICC":{temp:2,conditions:[],intensity:null},"LLBG":{temp:13,conditions:[],intensity:null},"OLBA":{temp:16,conditions:[],intensity:null},"OJAM":{temp:7,conditions:[],intensity:null},"ORBI":{temp:10,conditions:[],intensity:null},"ORER":{temp:6,conditions:[],intensity:null},"GMMN":{temp:9,conditions:[],intensity:null},"GMME":{temp:11,conditions:[],intensity:null},
  "GMMX":{temp:5,conditions:[],intensity:null},"GMTT":{temp:14,conditions:[],intensity:null},"GMFF":{temp:8,conditions:[],intensity:null},"GMAD":{temp:6,conditions:["fog"],intensity:null},"DAAG":{temp:8,conditions:[],intensity:null},"DAOO":{temp:11,conditions:[],intensity:null},"DTTA":{temp:9,conditions:[],intensity:null},"DTMB":{temp:10,conditions:[],intensity:null},"DTTJ":{temp:11,conditions:[],intensity:null},"HECA":{temp:15,conditions:[],intensity:null},
  "HEGN":{temp:17,conditions:[],intensity:null},"HESH":{temp:17,conditions:[],intensity:null},"HEBA":{temp:16,conditions:[],intensity:null},"HEAX":{temp:12,conditions:[],intensity:null},"HLLT":{temp:14,conditions:[],intensity:null},"DNMM":{temp:26,conditions:[],intensity:null},"DNAA":{temp:21,conditions:[],intensity:null},"DGAA":{temp:27,conditions:[],intensity:null},"DIAP":{temp:26,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  "GABS":{temp:21,conditions:[],intensity:null},"GVNP":{temp:19,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:25,conditions:["fog"],intensity:null},"DXXX":{temp:26,conditions:[],intensity:null},"DBBB":{temp:26,conditions:[],intensity:null},"HKJK":{temp:23,conditions:[],intensity:null},"HKMO":{temp:30,conditions:[],intensity:null},"HTDA":{temp:29,conditions:[],intensity:null},"HTKJ":{temp:27,conditions:[],intensity:null},
  "HUEN":{temp:26,conditions:[],intensity:null},"HRYR":{temp:22,conditions:[],intensity:null},"HAAB":{temp:19,conditions:[],intensity:null},"HDAM":{temp:24,conditions:[],intensity:null},"HCMM":{temp:28,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:31,conditions:[],intensity:null},"FIMP":{temp:28,conditions:[],intensity:null},"FMCH":{temp:28,conditions:[],intensity:null},"FMMI":{temp:23,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:26,conditions:[],intensity:null},"FKYS":{temp:23,conditions:[],intensity:null},"FOOL":{temp:25,conditions:[],intensity:null},"FZAA":{temp:27,conditions:[],intensity:null},"FCBB":{temp:26,conditions:["fog"],intensity:null},"FLLK":{temp:22,conditions:[],intensity:null},"FVHA":{temp:21,conditions:[],intensity:null},"FLLS":{temp:22,conditions:[],intensity:null},"FYWH":{temp:22,conditions:[],intensity:null},
  "FBSK":{temp:24,conditions:[],intensity:null},"FAOR":{temp:20,conditions:[],intensity:null},"FACT":{temp:22,conditions:[],intensity:null},"FALE":{temp:27,conditions:[],intensity:null},"FAPE":{temp:23,conditions:[],intensity:null},"FQMA":{temp:28,conditions:[],intensity:null},"FWKI":{temp:21,conditions:[],intensity:null},"ZBAA":{temp:0,conditions:[],intensity:null},"ZBAD":{temp:1,conditions:[],intensity:null},"ZSPD":{temp:9,conditions:[],intensity:null},
  "ZSSS":{temp:11,conditions:[],intensity:null},"ZGGG":{temp:21,conditions:[],intensity:null},"VHHH":{temp:22,conditions:[],intensity:null},"ZGSZ":{temp:19,conditions:[],intensity:null},"ZUUU":{temp:10,conditions:[],intensity:null},"ZUCK":{temp:8,conditions:[],intensity:null},"ZHCC":{temp:3,conditions:[],intensity:null},"ZLXY":{temp:8,conditions:[],intensity:null},"ZWSH":{temp:-12,conditions:[],intensity:null},"ZYHB":{temp:-15,conditions:[],intensity:null},
  "ZYTX":{temp:-11,conditions:[],intensity:null},"ZSAM":{temp:19,conditions:[],intensity:null},"ZGKL":{temp:11,conditions:[],intensity:null},"ZSNJ":{temp:11,conditions:[],intensity:null},"ZSHC":{temp:14,conditions:[],intensity:null},"ZPPP":{temp:18,conditions:[],intensity:null},"ZBTJ":{temp:0,conditions:[],intensity:null},"VMMC":{temp:21,conditions:[],intensity:null},"RJTT":{temp:6,conditions:[],intensity:null},"RJAA":{temp:4,conditions:[],intensity:null},
  "RJBB":{temp:5,conditions:[],intensity:null},"RJOO":{temp:4,conditions:[],intensity:null},"RJCC":{temp:-4,conditions:[],intensity:null},"RJFF":{temp:4,conditions:[],intensity:null},"RJGG":{temp:5,conditions:[],intensity:null},"ROAH":{temp:19,conditions:[],intensity:null},"RJSS":{temp:0,conditions:[],intensity:null},"RJSN":{temp:0,conditions:[],intensity:null},"RJOK":{temp:5,conditions:[],intensity:null},"RKSI":{temp:-4,conditions:[],intensity:null},
  "RKSS":{temp:-3,conditions:[],intensity:null},"RKPK":{temp:3,conditions:[],intensity:null},"RKPC":{temp:4,conditions:[],intensity:null},"RKTN":{temp:0,conditions:[],intensity:null},"ZKPY":{temp:-6,conditions:[],intensity:null},"WSSS":{temp:30,conditions:[],intensity:null},"WMKK":{temp:32,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:27,conditions:[],intensity:null},
  "VTBS":{temp:33,conditions:[],intensity:null},"VTBD":{temp:33,conditions:[],intensity:null},"VTSP":{temp:30,conditions:[],intensity:null},"VTCC":{temp:29,conditions:[],intensity:null},"VTSS":{temp:29,conditions:[],intensity:null},"VTUK":{temp:29,conditions:[],intensity:null},"VVNB":{temp:18,conditions:[],intensity:null},"VVTS":{temp:31,conditions:[],intensity:null},"VVDN":{temp:24,conditions:[],intensity:null},"VVCR":{temp:28,conditions:[],intensity:null},
  "VDPP":{temp:31,conditions:[],intensity:null},"VDSR":{temp:30,conditions:[],intensity:null},"VLVT":{temp:27,conditions:[],intensity:null},"VLLB":{temp:27,conditions:[],intensity:null},"VYYY":{temp:31,conditions:[],intensity:null},"VYMD":{temp:29,conditions:[],intensity:null},"VGHS":{temp:26,conditions:[],intensity:null},"VGCG":{temp:22,conditions:[],intensity:null},"VECC":{temp:26,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  "VCBI":{temp:26,conditions:[],intensity:null},"WIII":{temp:29,conditions:[],intensity:null},"WADD":{temp:29,conditions:[],intensity:null},"WARR":{temp:32,conditions:[],intensity:null},"WIHH":{temp:29,conditions:[],intensity:null},"WIMM":{temp:33,conditions:[],intensity:null},"WIBB":{temp:27,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:25,conditions:[],intensity:null},"WASS":{temp:28,conditions:[],intensity:null},
  "RPLL":{temp:29,conditions:[],intensity:null},"RPLC":{temp:28,conditions:[],intensity:null},"RPVM":{temp:26,conditions:[],intensity:null},"RPVD":{temp:25,conditions:[],intensity:null},"RPVK":{temp:26,conditions:[],intensity:null},"WBSB":{temp:29,conditions:[],intensity:null},"WBLL":{temp:27,conditions:[],intensity:null},"VIDP":{temp:15,conditions:[],intensity:null},"VABB":{temp:24,conditions:[],intensity:null},"VOBL":{temp:25,conditions:[],intensity:null},
  "VOMM":{temp:27,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:27,conditions:[],intensity:null},"VAAH":{temp:24,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:32,conditions:[],intensity:null},"VOTP":{temp:27,conditions:[],intensity:null},"VIAR":{temp:16,conditions:[],intensity:null},"VIJP":{temp:17,conditions:[],intensity:null},"VELR":{temp:20,conditions:[],intensity:null},
  "VOCL":{temp:31,conditions:[],intensity:null},"VOTV":{temp:27,conditions:[],intensity:null},"VEPT":{temp:24,conditions:[],intensity:null},"VNKT":{temp:20,conditions:[],intensity:null},"OPKC":{temp:18,conditions:[],intensity:null},"OPLA":{temp:16,conditions:[],intensity:null},"OPIS":{temp:14,conditions:[],intensity:null},"RCTP":{temp:23,conditions:[],intensity:null},"RCSS":{temp:21,conditions:[],intensity:null},"RCMQ":{temp:20,conditions:[],intensity:null},
  "RCKH":{temp:21,conditions:[],intensity:null},"RCNN":{temp:22,conditions:[],intensity:null},"YSSY":{temp:33,conditions:[],intensity:null},"YMML":{temp:24,conditions:[],intensity:null},"YBBN":{temp:29,conditions:[],intensity:null},"YPPH":{temp:26,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:29,conditions:[],intensity:null},"YBCS":{temp:27,conditions:[],intensity:null},"YSCB":{temp:38,conditions:[],intensity:null},
  "YMHB":{temp:16,conditions:[],intensity:null},"NZAA":{temp:18,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:15,conditions:[],intensity:null},"NZQN":{temp:13,conditions:[],intensity:null},"NZDN":{temp:12,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:29,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
  "NIUE":{temp:28,conditions:["thunderstorm"],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:24,conditions:[],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:19,conditions:["fog"],intensity:null}
};
