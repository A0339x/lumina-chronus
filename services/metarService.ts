...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LIMF":{temp:11,conditions:[],intensity:null},"LIEO":{temp:10,conditions:[],intensity:null},"LIEE":{temp:13,conditions:[],intensity:null},"EHAM":{temp:9,conditions:[],intensity:null},"EHRD":{temp:8,conditions:[],intensity:null},"EHEH":{temp:9,conditions:[],intensity:null},"EBBR":{temp:10,conditions:[],intensity:null},"EBCI":{temp:9,conditions:[],intensity:null},"ELLX":{temp:9,conditions:[],intensity:null},"LSZH":{temp:7,conditions:[],intensity:null},
