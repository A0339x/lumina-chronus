...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LIMC":{temp:5,conditions:[],intensity:null},"LIME":{temp:4,conditions:[],intensity:null},"LIPZ":{temp:3,conditions:[],intensity:null},"LIRN":{temp:9,conditions:[],intensity:null},"LIML":{temp:5,conditions:[],intensity:null},"LIPE":{temp:5,conditions:[],intensity:null},"LICC":{temp:12,conditions:[],intensity:null},"LICJ":{temp:10,conditions:[],intensity:null},"LIRA":{temp:9,conditions:[],intensity:null},"LIRP":{temp:11,conditions:[],intensity:null},
  "LIMF":{temp:4,conditions:[],intensity:null},"LIEO":{temp:6,conditions:["fog"],intensity:null},"LIEE":{temp:7,conditions:["fog"],intensity:null},"EHAM":{temp:7,conditions:[],intensity:null},"EHRD":{temp:9,conditions:[],intensity:null},"EHEH":{temp:8,conditions:[],intensity:null},"EBBR":{temp:10,conditions:[],intensity:null},"EBCI":{temp:9,conditions:[],intensity:null},"ELLX":{temp:6,conditions:[],intensity:null},"LSZH":{temp:0,conditions:["fog"],intensity:null},
  ...
  "OIAW":{temp:10,conditions:[],intensity:null},"OIKK":{temp:4,conditions:[],intensity:null},"OICC":{temp:1,conditions:["snow"],intensity:null},"LLBG":{temp:12,conditions:[],intensity:null},"OLBA":{temp:10,conditions:[],intensity:null},"OJAM":{temp:6,conditions:[],intensity:null},"ORBI":{temp:8,conditions:[],intensity:null},"ORER":{temp:3,conditions:[],intensity:null},"GMMN":{temp:10,conditions:["fog"],intensity:null},"GMME":{temp:11,conditions:[],intensity:null},
  "GMMX":{temp:9,conditions:[],intensity:null},"GMTT":{temp:12,conditions:["fog"],intensity:null},"GMFF":{temp:8,conditions:[],intensity:null},"GMAD":{temp:11,conditions:[],intensity:null},"DAAG":{temp:7,conditions:[],intensity:null},"DAOO":{temp:9,conditions:[],intensity:null},"DTTA":{temp:12,conditions:[],intensity:null},"DTMB":{temp:11,conditions:[],intensity:null},"DTTJ":{temp:13,conditions:[],intensity:null},"HECA":{temp:10,conditions:[],intensity:null},
