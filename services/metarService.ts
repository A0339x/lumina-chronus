...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:15,conditions:["fog"],intensity:null},"KLAX":{temp:11,conditions:[],intensity:null},"KORD":{temp:3,conditions:[],intensity:null},"KDFW":{temp:9,conditions:[],intensity:null},"KDEN":{temp:6,conditions:[],intensity:null},"KJFK":{temp:4,conditions:[],intensity:null},"KSFO":{temp:9,conditions:[],intensity:null},"KSEA":{temp:4,conditions:[],intensity:null},"KLAS":{temp:6,conditions:[],intensity:null},"KMCO":{temp:15,conditions:[],intensity:null},
  "KEWR":{temp:3,conditions:["fog"],intensity:null},"KMIA":{temp:18,conditions:[],intensity:null},"KPHX":{temp:12,conditions:[],intensity:null},"KIAH":{temp:19,conditions:["fog"],intensity:null},"KBOS":{temp:3,conditions:[],intensity:null},"KMSP":{temp:-6,conditions:["fog"],intensity:null},"KFLL":{temp:16,conditions:[],intensity:null},"KDTW":{temp:3,conditions:[],intensity:null},"KPHL":{temp:5,conditions:["fog"],intensity:null},"KLGA":{temp:3,conditions:["fog"],intensity:null},
  "KBWI":{temp:2,conditions:[],intensity:null},"KSLC":{temp:2,conditions:[],intensity:null},"KDCA":{temp:3,conditions:[],intensity:null},"KIAD":{temp:2,conditions:[],intensity:null},"KSAN":{temp:12,conditions:[],intensity:null},"KTPA":{temp:16,conditions:[],intensity:null},"KPDX":{temp:5,conditions:[],intensity:null},"KSTL":{temp:3,conditions:[],intensity:null},"KHNL":{temp:25,conditions:[],intensity:null},"KMEM":{temp:9,conditions:["fog"],intensity:null},
  "KAUS":{temp:11,conditions:[],intensity:null},"KBNA":{temp:11,conditions:[],intensity:null},"KRDU":{temp:9,conditions:[],intensity:null},"KCLT":{temp:10,conditions:[],intensity:null},"KSMF":{temp:7,conditions:["fog"],intensity:null},"KSJC":{temp:9,conditions:[],intensity:null},"KOAK":{temp:8,conditions:[],intensity:null},"KCLE":{temp:5,conditions:[],intensity:null},"KMKE":{temp:2,conditions:[],intensity:null},"KPIT":{temp:6,conditions:[],intensity:null},
  "KIND":{temp:5,conditions:[],intensity:null},"KCVG":{temp:7,conditions:[],intensity:null},"KMCI":{temp:4,conditions:[],intensity:null},"KSAT":{temp:12,conditions:[],intensity:null},"KHOU":{temp:20,conditions:[],intensity:null},"KDAL":{temp:9,conditions:[],intensity:null},"KMDW":{temp:3,conditions:["fog"],intensity:null},"PANC":{temp:-14,conditions:[],intensity:null},"PAFA":{temp:-25,conditions:[],intensity:null},"CYYZ":{temp:0,conditions:[],intensity:null},
  "CYVR":{temp:3,conditions:[],intensity:null},"CYUL":{temp:-4,conditions:["snow"],intensity:null},"CYYC":{temp:-3,conditions:[],intensity:null},"CYEG":{temp:-7,conditions:[],intensity:null},"CYOW":{temp:-5,conditions:["snow"],intensity:null},"CYWG":{temp:-6,conditions:["fog"],intensity:null},"CYHZ":{temp:1,conditions:["fog"],intensity:null},"CYQB":{temp:-8,conditions:[],intensity:null},"CYYJ":{temp:3,conditions:[],intensity:null},"CYLW":{temp:1,conditions:[],intensity:null},
  "CYXE":{temp:-20,conditions:[],intensity:null},"CYQR":{temp:-7,conditions:[],intensity:null},"CYZF":{temp:-31,conditions:[],intensity:null},"CYXY":{temp:-10,conditions:[],intensity:null},"CYQT":{temp:-4,conditions:[],intensity:null},"CYYT":{temp:-2,conditions:[],intensity:null},"MMMX":{temp:8,conditions:[],intensity:null},"MMUN":{temp:21,conditions:[],intensity:null},"MMGL":{temp:14,conditions:[],intensity:null},"MMMY":{temp:17,conditions:[],intensity:null},
  "MMTJ":{temp:11,conditions:[],intensity:null},"MMSM":{temp:26,conditions:[],intensity:null},"MMMD":{temp:20,conditions:[],intensity:null},"MMCZ":{temp:26,conditions:[],intensity:null},"MMSD":{temp:18,conditions:[],intensity:null},"MGGT":{temp:12,conditions:[],intensity:null},"MSLP":{temp:22,conditions:[],intensity:null},"MHTG":{temp:17,conditions:[],intensity:null},"MNMG":{temp:23,conditions:[],intensity:null},"MROC":{temp:19,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:20,conditions:["fog"],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:25,conditions:[],intensity:null},"TAPA":{temp:23,conditions:[],intensity:null},"SBGR":{temp:20,conditions:["fog"],intensity:null},"SBGL":{temp:23,conditions:[],intensity:null},"SBBR":{temp:19,conditions:[],intensity:null},"SBCF":{temp:19,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:25,conditions:[],intensity:null},
  "SBPA":{temp:24,conditions:[],intensity:null},"SBCT":{temp:16,conditions:["fog"],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:15,conditions:[],intensity:null},"SAEZ":{temp:21,conditions:[],intensity:null},"SABE":{temp:21,conditions:[],intensity:null},"SACO":{temp:18,conditions:[],intensity:null},"SAME":{temp:19,conditions:[],intensity:null},"SLLP":{temp:3,conditions:["fog"],intensity:null},"SLVR":{temp:24,conditions:[],intensity:null},
  "SPJC":{temp:20,conditions:[],intensity:null},"SEQM":{temp:10,conditions:[],intensity:null},"SEGU":{temp:23,conditions:[],intensity:null},"SKBO":{temp:11,conditions:["fog"],intensity:null},"SKMR":{temp:23,conditions:["thunderstorm"],intensity:null},"SKCL":{temp:19,conditions:[],intensity:null},"SKMD":{temp:21,conditions:[],intensity:null},"SKRG":{temp:12,conditions:["fog"],intensity:null},"SVMI":{temp:27,conditions:[],intensity:null},"SUMU":{temp:20,conditions:[],intensity:null},
  "SGAS":{temp:25,conditions:[],intensity:null},"SBBV":{temp:25,conditions:[],intensity:null},"SMJP":{temp:23,conditions:[],intensity:null},"SYCJ":{temp:23,conditions:[],intensity:null},"EGLL":{temp:2,conditions:[],intensity:null},"EGKK":{temp:2,conditions:[],intensity:null},"EGSS":{temp:2,conditions:[],intensity:null},"EGLC":{temp:3,conditions:[],intensity:null},"EGCC":{temp:4,conditions:[],intensity:null},"EGBB":{temp:4,conditions:[],intensity:null},
  "EGPH":{temp:3,conditions:[],intensity:null},"EGPF":{temp:3,conditions:[],intensity:null},"EGGW":{temp:1,conditions:[],intensity:null},"EGNX":{temp:3,conditions:[],intensity:null},"EGNT":{temp:2,conditions:[],intensity:null},"EGGP":{temp:6,conditions:[],intensity:null},"EGHI":{temp:3,conditions:[],intensity:null},"EGGD":{temp:3,conditions:[],intensity:null},"EGPD":{temp:3,conditions:[],intensity:null},"EGAA":{temp:3,conditions:[],intensity:null},
  "EIDW":{temp:2,conditions:[],intensity:null},"EICK":{temp:5,conditions:[],intensity:null},"EINN":{temp:5,conditions:[],intensity:null},"LFPG":{temp:-2,conditions:["snow"],intensity:null},"LFPO":{temp:-2,conditions:[],intensity:null},"LFML":{temp:2,conditions:[],intensity:null},"LFLL":{temp:-4,conditions:["fog"],intensity:null},"LFMN":{temp:8,conditions:[],intensity:null},"LFBD":{temp:1,conditions:[],intensity:null},"LFBO":{temp:-3,conditions:[],intensity:null},
  "LFRS":{temp:2,conditions:[],intensity:null},"LFSB":{temp:-5,conditions:[],intensity:null},"LFPB":{temp:-1,conditions:["snow"],intensity:null},"EDDF":{temp:-3,conditions:[],intensity:null},"EDDM":{temp:-5,conditions:[],intensity:null},"EDDB":{temp:-7,conditions:[],intensity:null},"EDDL":{temp:-1,conditions:[],intensity:null},"EDDH":{temp:-2,conditions:[],intensity:null},"EDDK":{temp:-1,conditions:[],intensity:null},"EDDS":{temp:-6,conditions:[],intensity:null},
  "EDDW":{temp:-1,conditions:[],intensity:null},"EDDN":{temp:-5,conditions:[],intensity:null},"EDDV":{temp:-2,conditions:[],intensity:null},"EDDP":{temp:-5,conditions:[],intensity:null},"LEMD":{temp:-1,conditions:[],intensity:null},"LEBL":{temp:5,conditions:[],intensity:null},"LEPA":{temp:7,conditions:[],intensity:null},"LEMG":{temp:8,conditions:[],intensity:null},"LEVC":{temp:5,conditions:[],intensity:null},"LEAL":{temp:7,conditions:[],intensity:null},
  "LEZL":{temp:3,conditions:[],intensity:null},"GCLP":{temp:18,conditions:[],intensity:null},"GCTS":{temp:16,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:17,conditions:[],intensity:null},"LPPT":{temp:12,conditions:[],intensity:null},"LPPR":{temp:8,conditions:["fog"],intensity:null},"LPFR":{temp:8,conditions:[],intensity:null},"LPMA":{temp:14,conditions:[],intensity:null},"LIRF":{temp:7,conditions:[],intensity:null},
  "LIMC":{temp:-1,conditions:[],intensity:null},"LIME":{temp:-1,conditions:[],intensity:null},"LIPZ":{temp:2,conditions:[],intensity:null},"LIRN":{temp:10,conditions:[],intensity:null},"LIML":{temp:0,conditions:[],intensity:null},"LIPE":{temp:1,conditions:[],intensity:null},"LICC":{temp:14,conditions:[],intensity:null},"LICJ":{temp:11,conditions:[],intensity:null},"LIRA":{temp:6,conditions:[],intensity:null},"LIRP":{temp:4,conditions:[],intensity:null},
  "LIMF":{temp:-2,conditions:[],intensity:null},"LIEO":{temp:7,conditions:[],intensity:null},"LIEE":{temp:10,conditions:[],intensity:null},"EHAM":{temp:0,conditions:["snow"],intensity:null},"EHRD":{temp:0,conditions:["snow"],intensity:null},"EHEH":{temp:0,conditions:["snow"],intensity:null},"EBBR":{temp:0,conditions:["snow"],intensity:null},"EBCI":{temp:-2,conditions:["snow"],intensity:null},"ELLX":{temp:-5,conditions:[],intensity:null},"LSZH":{temp:-5,conditions:[],intensity:null},
  "LSGG":{temp:-5,conditions:[],intensity:null},"LSZB":{temp:-7,conditions:[],intensity:null},"LOWW":{temp:-3,conditions:[],intensity:null},"LOWS":{temp:-7,conditions:[],intensity:null},"LOWG":{temp:-3,conditions:[],intensity:null},"LOWI":{temp:-8,conditions:[],intensity:null},"LKPR":{temp:-5,conditions:[],intensity:null},"EPWA":{temp:-5,conditions:[],intensity:null},"EPKK":{temp:-3,conditions:[],intensity:null},"EPGD":{temp:-5,conditions:[],intensity:null},
  "EPWR":{temp:-4,conditions:[],intensity:null},"EPPO":{temp:-4,conditions:[],intensity:null},"EKCH":{temp:1,conditions:[],intensity:null},"ESSA":{temp:-5,conditions:[],intensity:null},"ENGM":{temp:-9,conditions:[],intensity:null},"EFHK":{temp:-7,conditions:[],intensity:null},"BIKF":{temp:-2,conditions:[],intensity:null},"ESGG":{temp:-3,conditions:["snow"],intensity:null},"ESMS":{temp:0,conditions:["snow"],intensity:null},"ENBR":{temp:-9,conditions:[],intensity:null},
  "ENZV":{temp:-3,conditions:[],intensity:null},"ENTC":{temp:-12,conditions:[],intensity:null},"EFOU":{temp:-17,conditions:[],intensity:null},"EFRO":{temp:-26,conditions:[],intensity:null},"LGAV":{temp:19,conditions:[],intensity:null},"LGTS":{temp:18,conditions:[],intensity:null},"LGIR":{temp:21,conditions:[],intensity:null},"LGKR":{temp:16,conditions:["thunderstorm"],intensity:null},"LGRP":{temp:19,conditions:[],intensity:null},"LGSR":{temp:20,conditions:[],intensity:null},
  "LGMK":{temp:19,conditions:[],intensity:null},"LTFM":{temp:16,conditions:[],intensity:null},"LTBA":{temp:16,conditions:[],intensity:null},"LTFJ":{temp:15,conditions:[],intensity:null},"LTAI":{temp:18,conditions:[],intensity:null},"LTAC":{temp:7,conditions:[],intensity:null},"LTBJ":{temp:17,conditions:[],intensity:null},"LTBS":{temp:19,conditions:[],intensity:null},"LTFE":{temp:19,conditions:[],intensity:null},"LCLK":{temp:19,conditions:[],intensity:null},
  "LCPH":{temp:19,conditions:[],intensity:null},"LHBP":{temp:-1,conditions:[],intensity:null},"LROP":{temp:4,conditions:["fog"],intensity:null},"LBSF":{temp:9,conditions:[],intensity:null},"LYBE":{temp:-1,conditions:[],intensity:null},"LDZA":{temp:-2,conditions:[],intensity:null},"LDDU":{temp:10,conditions:[],intensity:null},"LDSP":{temp:7,conditions:[],intensity:null},"LJLJ":{temp:-4,conditions:["fog"],intensity:null},"LWSK":{temp:10,conditions:[],intensity:null},
  "LATI":{temp:16,conditions:[],intensity:null},"UKBB":{temp:-1,conditions:["snow"],intensity:null},"UKLL":{temp:-4,conditions:["snow"],intensity:null},"UUEE":{temp:-5,conditions:[],intensity:null},"UUDD":{temp:-5,conditions:[],intensity:null},"UUWW":{temp:-5,conditions:[],intensity:null},"ULLI":{temp:-7,conditions:["snow"],intensity:null},"UWWW":{temp:-6,conditions:[],intensity:null},"USSS":{temp:-11,conditions:[],intensity:null},"UNNT":{temp:-9,conditions:[],intensity:null},
  "UUOB":{temp:-18,conditions:[],intensity:null},"UHWW":{temp:-9,conditions:[],intensity:null},"UEEE":{temp:-44,conditions:[],intensity:null},"OMDB":{temp:23,conditions:[],intensity:null},"OMDW":{temp:24,conditions:[],intensity:null},"OMAA":{temp:25,conditions:[],intensity:null},"OMSJ":{temp:24,conditions:[],intensity:null},"OTHH":{temp:21,conditions:[],intensity:null},"OERK":{temp:21,conditions:[],intensity:null},"OEJN":{temp:30,conditions:[],intensity:null},
  "OEDF":{temp:19,conditions:[],intensity:null},"OEMA":{temp:24,conditions:[],intensity:null},"OKBK":{temp:18,conditions:[],intensity:null},"OBBI":{temp:19,conditions:[],intensity:null},"OOMS":{temp:26,conditions:[],intensity:null},"OYAA":{temp:18,conditions:[],intensity:null},"OIIE":{temp:10,conditions:[],intensity:null},"OIII":{temp:10,conditions:[],intensity:null},"OISS":{temp:12,conditions:[],intensity:null},"OIKB":{temp:23,conditions:[],intensity:null},
  "OIAW":{temp:18,conditions:[],intensity:null},"OIKK":{temp:9,conditions:[],intensity:null},"OICC":{temp:11,conditions:[],intensity:null},"LLBG":{temp:22,conditions:[],intensity:null},"OLBA":{temp:21,conditions:[],intensity:null},"OJAM":{temp:15,conditions:[],intensity:null},"ORBI":{temp:17,conditions:[],intensity:null},"ORER":{temp:13,conditions:[],intensity:null},"GMMN":{temp:8,conditions:[],intensity:null},"GMME":{temp:10,conditions:[],intensity:null},
  "GMMX":{temp:6,conditions:[],intensity:null},"GMTT":{temp:10,conditions:[],intensity:null},"GMFF":{temp:8,conditions:[],intensity:null},"GMAD":{temp:9,conditions:[],intensity:null},"DAAG":{temp:8,conditions:[],intensity:null},"DAOO":{temp:8,conditions:[],intensity:null},"DTTA":{temp:11,conditions:[],intensity:null},"DTMB":{temp:11,conditions:[],intensity:null},"DTTJ":{temp:14,conditions:[],intensity:null},"HECA":{temp:21,conditions:[],intensity:null},
  "HEGN":{temp:24,conditions:[],intensity:null},"HESH":{temp:25,conditions:[],intensity:null},"HEBA":{temp:23,conditions:[],intensity:null},"HEAX":{temp:21,conditions:[],intensity:null},"HLLT":{temp:20,conditions:[],intensity:null},"DNMM":{temp:31,conditions:[],intensity:null},"DNAA":{temp:30,conditions:[],intensity:null},"DGAA":{temp:29,conditions:[],intensity:null},"DIAP":{temp:28,conditions:[],intensity:null},"GOBD":{temp:21,conditions:[],intensity:null},
  "GABS":{temp:23,conditions:[],intensity:null},"GVNP":{temp:21,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:28,conditions:[],intensity:null},"DXXX":{temp:31,conditions:[],intensity:null},"DBBB":{temp:31,conditions:[],intensity:null},"HKJK":{temp:24,conditions:[],intensity:null},"HKMO":{temp:35,conditions:[],intensity:null},"HTDA":{temp:31,conditions:[],intensity:null},"HTKJ":{temp:31,conditions:[],intensity:null},
  "HUEN":{temp:28,conditions:[],intensity:null},"HRYR":{temp:25,conditions:[],intensity:null},"HAAB":{temp:21,conditions:[],intensity:null},"HDAM":{temp:28,conditions:[],intensity:null},"HCMM":{temp:33,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:32,conditions:[],intensity:null},"FIMP":{temp:28,conditions:[],intensity:null},"FMCH":{temp:31,conditions:[],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  "FSIA":{temp:27,conditions:[],intensity:null},"FKKD":{temp:29,conditions:[],intensity:null},"FKYS":{temp:28,conditions:[],intensity:null},"FOOL":{temp:28,conditions:[],intensity:null},"FZAA":{temp:30,conditions:[],intensity:null},"FCBB":{temp:28,conditions:[],intensity:null},"FLLK":{temp:29,conditions:[],intensity:null},"FVHA":{temp:27,conditions:[],intensity:null},"FLLS":{temp:29,conditions:[],intensity:null},"FYWH":{temp:28,conditions:[],intensity:null},
  "FBSK":{temp:33,conditions:[],intensity:null},"FAOR":{temp:27,conditions:[],intensity:null},"FACT":{temp:23,conditions:[],intensity:null},"FALE":{temp:24,conditions:[],intensity:null},"FAPE":{temp:25,conditions:[],intensity:null},"FQMA":{temp:36,conditions:[],intensity:null},"FWKI":{temp:25,conditions:[],intensity:null},"ZBAA":{temp:1,conditions:[],intensity:null},"ZBAD":{temp:2,conditions:[],intensity:null},"ZSPD":{temp:8,conditions:[],intensity:null},
  "ZSSS":{temp:6,conditions:[],intensity:null},"ZGGG":{temp:13,conditions:[],intensity:null},"VHHH":{temp:17,conditions:[],intensity:null},"ZGSZ":{temp:16,conditions:[],intensity:null},"ZUUU":{temp:11,conditions:[],intensity:null},"ZUCK":{temp:11,conditions:[],intensity:null},"ZHCC":{temp:7,conditions:[],intensity:null},"ZLXY":{temp:7,conditions:[],intensity:null},"ZWSH":{temp:-10,conditions:[],intensity:null},"ZYHB":{temp:-16,conditions:[],intensity:null},
  "ZYTX":{temp:-8,conditions:[],intensity:null},"ZSAM":{temp:14,conditions:[],intensity:null},"ZGKL":{temp:11,conditions:[],intensity:null},"ZSNJ":{temp:7,conditions:[],intensity:null},"ZSHC":{temp:9,conditions:[],intensity:null},"ZPPP":{temp:8,conditions:[],intensity:null},"ZBTJ":{temp:1,conditions:[],intensity:null},"VMMC":{temp:15,conditions:[],intensity:null},"RJTT":{temp:6,conditions:[],intensity:null},"RJAA":{temp:4,conditions:[],intensity:null},
  "RJBB":{temp:11,conditions:[],intensity:null},"RJOO":{temp:7,conditions:[],intensity:null},"RJCC":{temp:3,conditions:[],intensity:null},"RJFF":{temp:9,conditions:[],intensity:null},"RJGG":{temp:9,conditions:[],intensity:null},"ROAH":{temp:16,conditions:[],intensity:null},"RJSS":{temp:5,conditions:[],intensity:null},"RJSN":{temp:5,conditions:[],intensity:null},"RJOK":{temp:8,conditions:[],intensity:null},"RKSI":{temp:-1,conditions:[],intensity:null},
  "RKSS":{temp:-3,conditions:[],intensity:null},"RKPK":{temp:4,conditions:[],intensity:null},"RKPC":{temp:7,conditions:[],intensity:null},"RKTN":{temp:0,conditions:[],intensity:null},"ZKPY":{temp:-7,conditions:[],intensity:null},"WSSS":{temp:26,conditions:["thunderstorm"],intensity:null},"WMKK":{temp:29,conditions:[],intensity:null},"WMKP":{temp:30,conditions:[],intensity:null},"WBKK":{temp:27,conditions:["thunderstorm"],intensity:null},"WBGG":{temp:28,conditions:[],intensity:null},
  "VTBS":{temp:30,conditions:[],intensity:null},"VTBD":{temp:29,conditions:[],intensity:null},"VTSP":{temp:28,conditions:["thunderstorm"],intensity:null},"VTCC":{temp:26,conditions:[],intensity:null},"VTSS":{temp:27,conditions:["thunderstorm"],intensity:null},"VTUK":{temp:29,conditions:[],intensity:null},"VVNB":{temp:18,conditions:[],intensity:null},"VVTS":{temp:29,conditions:[],intensity:null},"VVDN":{temp:17,conditions:[],intensity:null},"VVCR":{temp:23,conditions:[],intensity:null},
  "VDPP":{temp:30,conditions:[],intensity:null},"VDSR":{temp:28,conditions:[],intensity:null},"VLVT":{temp:22,conditions:[],intensity:null},"VLLB":{temp:21,conditions:[],intensity:null},"VYYY":{temp:29,conditions:[],intensity:null},"VYMD":{temp:27,conditions:[],intensity:null},"VGHS":{temp:20,conditions:[],intensity:null},"VGCG":{temp:20,conditions:[],intensity:null},"VECC":{temp:21,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  "VCBI":{temp:28,conditions:[],intensity:null},"WIII":{temp:29,conditions:[],intensity:null},"WADD":{temp:29,conditions:[],intensity:null},"WARR":{temp:31,conditions:[],intensity:null},"WIHH":{temp:30,conditions:[],intensity:null},"WIMM":{temp:30,conditions:[],intensity:null},"WIBB":{temp:27,conditions:["thunderstorm"],intensity:null},"WAFF":{temp:28,conditions:["thunderstorm"],intensity:null},"WICC":{temp:26,conditions:[],intensity:null},"WASS":{temp:29,conditions:[],intensity:null},
  ...
  "VOMM":{temp:27,conditions:[],intensity:null},"VEBS":{temp:21,conditions:[],intensity:null},"VOHY":{temp:26,conditions:[],intensity:null},"VAAH":{temp:27,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:32,conditions:[],intensity:null},"VOTP":{temp:27,conditions:[],intensity:null},"VIAR":{temp:14,conditions:[],intensity:null},"VIJP":{temp:18,conditions:[],intensity:null},"VELR":{temp:15,conditions:[],intensity:null},
  "VOCL":{temp:30,conditions:[],intensity:null},"VOTV":{temp:28,conditions:[],intensity:null},"VEPT":{temp:17,conditions:[],intensity:null},"VNKT":{temp:16,conditions:[],intensity:null},"OPKC":{temp:24,conditions:[],intensity:null},"OPLA":{temp:14,conditions:[],intensity:null},"OPIS":{temp:16,conditions:[],intensity:null},"RCTP":{temp:12,conditions:[],intensity:null},"RCSS":{temp:12,conditions:[],intensity:null},"RCMQ":{temp:12,conditions:[],intensity:null},
  "RCKH":{temp:18,conditions:[],intensity:null},"RCNN":{temp:15,conditions:[],intensity:null},"YSSY":{temp:23,conditions:[],intensity:null},"YMML":{temp:29,conditions:[],intensity:null},"YBBN":{temp:25,conditions:[],intensity:null},"YPPH":{temp:25,conditions:[],intensity:null},"YPAD":{temp:25,conditions:[],intensity:null},"YBCG":{temp:21,conditions:[],intensity:null},"YBCS":{temp:25,conditions:[],intensity:null},"YSCB":{temp:33,conditions:[],intensity:null},
  "YMHB":{temp:16,conditions:[],intensity:null},"NZAA":{temp:21,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:15,conditions:[],intensity:null},"NZQN":{temp:15,conditions:[],intensity:null},"NZDN":{temp:14,conditions:[],intensity:null},"NFFN":{temp:29,conditions:[],intensity:null},"NWWW":{temp:28,conditions:[],intensity:null},"NTAA":{temp:26,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
