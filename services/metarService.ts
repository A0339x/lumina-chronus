...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LIMF":{temp:6,conditions:[],intensity:null},"LIEO":{temp:12,conditions:[],intensity:null},"LIEE":{temp:14,conditions:[],intensity:null},"EHAM":{temp:1,conditions:[],intensity:null},"EHRD":{temp:1,conditions:[],intensity:null},"EHEH":{temp:2,conditions:[],intensity:null},"EBBR":{temp:5,conditions:[],intensity:null},"EBCI":{temp:4,conditions:[],intensity:null},"ELLX":{temp:0,conditions:[],intensity:null},"LSZH":{temp:-1,conditions:["fog"],intensity:null},
