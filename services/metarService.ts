...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:13,conditions:[],intensity:null},"KLAX":{temp:16,conditions:[],intensity:null},"KORD":{temp:0,conditions:[],intensity:null},"KDFW":{temp:15,conditions:[],intensity:null},"KDEN":{temp:12,conditions:[],intensity:null},"KJFK":{temp:0,conditions:[],intensity:null},"KSFO":{temp:12,conditions:[],intensity:null},"KSEA":{temp:8,conditions:[],intensity:null},"KLAS":{temp:23,conditions:[],intensity:null},"KMCO":{temp:18,conditions:[],intensity:null},
  "KEWR":{temp:0,conditions:[],intensity:null},"KMIA":{temp:21,conditions:[],intensity:null},"KPHX":{temp:25,conditions:[],intensity:null},"KIAH":{temp:15,conditions:[],intensity:null},"KBOS":{temp:0,conditions:[],intensity:null},"KMSP":{temp:2,conditions:[],intensity:null},"KFLL":{temp:22,conditions:[],intensity:null},"KDTW":{temp:-3,conditions:[],intensity:null},"KPHL":{temp:2,conditions:[],intensity:null},"KLGA":{temp:0,conditions:[],intensity:null},
  "KBWI":{temp:2,conditions:[],intensity:null},"KSLC":{temp:13,conditions:[],intensity:null},"KDCA":{temp:4,conditions:[],intensity:null},"KIAD":{temp:3,conditions:[],intensity:null},"KSAN":{temp:15,conditions:[],intensity:null},"KTPA":{temp:17,conditions:[],intensity:null},"KPDX":{temp:10,conditions:[],intensity:null},"KSTL":{temp:8,conditions:[],intensity:null},"KHNL":{temp:24,conditions:[],intensity:null},"KMEM":{temp:13,conditions:[],intensity:null},
  "KAUS":{temp:15,conditions:[],intensity:null},"KBNA":{temp:9,conditions:[],intensity:null},"KRDU":{temp:9,conditions:[],intensity:null},"KCLT":{temp:11,conditions:[],intensity:null},"KSMF":{temp:15,conditions:[],intensity:null},"KSJC":{temp:13,conditions:[],intensity:null},"KOAK":{temp:12,conditions:[],intensity:null},"KCLE":{temp:-3,conditions:[],intensity:null},"KMKE":{temp:-1,conditions:[],intensity:null},"KPIT":{temp:-1,conditions:[],intensity:null},
  "KIND":{temp:2,conditions:[],intensity:null},"KCVG":{temp:2,conditions:[],intensity:null},"KMCI":{temp:12,conditions:[],intensity:null},"KSAT":{temp:16,conditions:[],intensity:null},"KHOU":{temp:16,conditions:[],intensity:null},"KDAL":{temp:15,conditions:[],intensity:null},"KMDW":{temp:0,conditions:[],intensity:null},"PANC":{temp:4,conditions:[],intensity:null},"PAFA":{temp:3,conditions:[],intensity:null},"CYYZ":{temp:-4,conditions:[],intensity:null},
  ...
  "CYXE":{temp:-5,conditions:[],intensity:null},"CYQR":{temp:0,conditions:[],intensity:null},"CYZF":{temp:-8,conditions:[],intensity:null},"CYXY":{temp:-1,conditions:[],intensity:null},"CYQT":{temp:-5,conditions:[],intensity:null},"CYYT":{temp:-4,conditions:[],intensity:null},"MMMX":{temp:16,conditions:[],intensity:null},"MMUN":{temp:22,conditions:[],intensity:null},"MMGL":{temp:20,conditions:[],intensity:null},"MMMY":{temp:18,conditions:[],intensity:null},
  "MMTJ":{temp:14,conditions:[],intensity:null},"MMSM":{temp:27,conditions:[],intensity:null},"MMMD":{temp:22,conditions:[],intensity:null},"MMCZ":{temp:25,conditions:[],intensity:null},"MMSD":{temp:23,conditions:[],intensity:null},"MGGT":{temp:17,conditions:[],intensity:null},"MSLP":{temp:26,conditions:["thunderstorm"],intensity:null},"MHTG":{temp:22,conditions:[],intensity:null},"MNMG":{temp:28,conditions:[],intensity:null},"MROC":{temp:23,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:24,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:27,conditions:[],intensity:null},"TAPA":{temp:26,conditions:[],intensity:null},"SBGR":{temp:22,conditions:[],intensity:null},"SBGL":{temp:25,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:19,conditions:[],intensity:null},"SBSV":{temp:25,conditions:[],intensity:null},"SBRF":{temp:24,conditions:[],intensity:null}
};
