...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:8,conditions:[],intensity:null},"KLAX":{temp:12,conditions:[],intensity:null},"KORD":{temp:-9,conditions:[],intensity:null},"KDFW":{temp:2,conditions:[],intensity:null},"KDEN":{temp:-8,conditions:[],intensity:null},"KJFK":{temp:2,conditions:[],intensity:null},"KSFO":{temp:9,conditions:[],intensity:null},"KSEA":{temp:4,conditions:[],intensity:null},"KLAS":{temp:8,conditions:[],intensity:null},"KMCO":{temp:6,conditions:[],intensity:null},
  "KEWR":{temp:0,conditions:[],intensity:null},"KMIA":{temp:16,conditions:[],intensity:null},"KPHX":{temp:10,conditions:[],intensity:null},"KIAH":{temp:10,conditions:[],intensity:null},"KBOS":{temp:0,conditions:[],intensity:null},"KMSP":{temp:-13,conditions:[],intensity:null},"KFLL":{temp:16,conditions:[],intensity:null},"KDTW":{temp:-2,conditions:[],intensity:null},"KPHL":{temp:1,conditions:[],intensity:null},"KLGA":{temp:1,conditions:[],intensity:null},
  "KBWI":{temp:1,conditions:[],intensity:null},"KSLC":{temp:-4,conditions:[],intensity:null},"KDCA":{temp:3,conditions:[],intensity:null},"KIAD":{temp:3,conditions:[],intensity:null},"KSAN":{temp:13,conditions:["fog"],intensity:null},"KTPA":{temp:5,conditions:[],intensity:null},"KPDX":{temp:4,conditions:[],intensity:null},"KSTL":{temp:-4,conditions:[],intensity:null},"KHNL":{temp:20,conditions:[],intensity:null},"KMEM":{temp:0,conditions:[],intensity:null},
  ...
  "KIND":{temp:-1,conditions:[],intensity:null},"KCVG":{temp:1,conditions:[],intensity:null},"KMCI":{temp:-9,conditions:[],intensity:null},"KSAT":{temp:7,conditions:[],intensity:null},"KHOU":{temp:11,conditions:[],intensity:null},"KDAL":{temp:2,conditions:[],intensity:null},"KMDW":{temp:-8,conditions:[],intensity:null},"PANC":{temp:-2,conditions:[],intensity:null},"PAFA":{temp:-11,conditions:[],intensity:null},"CYYZ":{temp:-4,conditions:[],intensity:null},
  ...
  "CYXE":{temp:-26,conditions:[],intensity:null},"CYQR":{temp:-29,conditions:[],intensity:null},"CYZF":{temp:-22,conditions:[],intensity:null},"CYXY":{temp:0,conditions:[],intensity:null},"CYQT":{temp:-11,conditions:[],intensity:null},"CYYT":{temp:-1,conditions:[],intensity:null},"MMMX":{temp:12,conditions:[],intensity:null},"MMUN":{temp:21,conditions:[],intensity:null},"MMGL":{temp:13,conditions:["fog"],intensity:null},"MMMY":{temp:13,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:23,conditions:[],intensity:null},"TIST":{temp:25,conditions:[],intensity:null},"TLPL":{temp:25,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:21,conditions:[],intensity:null},"SBGL":{temp:28,conditions:[],intensity:null},"SBBR":{temp:21,conditions:[],intensity:null},"SBCF":{temp:21,conditions:[],intensity:null},"SBSV":{temp:25,conditions:[],intensity:null},"SBRF":{temp:26,conditions:[],intensity:null},
  "SBPA":{temp:24,conditions:[],intensity:null},"SBCT":{temp:20,conditions:["fog"],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:18,conditions:[],intensity:null},"SAEZ":{temp:20,conditions:[],intensity:null},"SABE":{temp:19,conditions:[],intensity:null},"SACO":{temp:18,conditions:["fog"],intensity:null},"SAME":{temp:21,conditions:[],intensity:null},"SLLP":{temp:3,conditions:["fog"],intensity:null},"SLVR":{temp:22,conditions:[],intensity:null},
  "SPJC":{temp:21,conditions:[],intensity:null},"SEQM":{temp:11,conditions:[],intensity:null},"SEGU":{temp:24,conditions:[],intensity:null},"SKBO":{temp:10,conditions:[],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:21,conditions:[],intensity:null},"SKRG":{temp:13,conditions:[],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:16,conditions:[],intensity:null},
  ...
  "LSGG":{temp:5,conditions:["fog"],intensity:null},"LSZB":{temp:4,conditions:["fog"],intensity:null},"LOWW":{temp:2,conditions:[],intensity:null},"LOWS":{temp:-3,conditions:["fog"],intensity:null},"LOWG":{temp:-1,conditions:[],intensity:null},"LOWI":{temp:4,conditions:[],intensity:null},"LKPR":{temp:2,conditions:[],intensity:null},"EPWA":{temp:-6,conditions:[],intensity:null},"EPKK":{temp:-4,conditions:[],intensity:null},"EPGD":{temp:-5,conditions:["fog"],intensity:null},
  "EPWR":{temp:2,conditions:[],intensity:null},"EPPO":{temp:1,conditions:[],intensity:null},"EKCH":{temp:3,conditions:[],intensity:null},"ESSA":{temp:3,conditions:[],intensity:null},"ENGM":{temp:1,conditions:[],intensity:null},"EFHK":{temp:-3,conditions:[],intensity:null},"BIKF":{temp:1,conditions:[],intensity:null},"ESGG":{temp:2,conditions:[],intensity:null},"ESMS":{temp:2,conditions:[],intensity:null},"ENBR":{temp:5,conditions:[],intensity:null},
  ...
  "LGMK":{temp:12,conditions:[],intensity:null},"LTFM":{temp:4,conditions:[],intensity:null},"LTBA":{temp:6,conditions:[],intensity:null},"LTFJ":{temp:4,conditions:[],intensity:null},"LTAI":{temp:16,conditions:[],intensity:null},"LTAC":{temp:-1,conditions:[],intensity:null},"LTBJ":{temp:11,conditions:[],intensity:null},"LTBS":{temp:16,conditions:[],intensity:null},"LTFE":{temp:15,conditions:[],intensity:null},"LCLK":{temp:17,conditions:[],intensity:null},
  "LCPH":{temp:16,conditions:[],intensity:null},"LHBP":{temp:2,conditions:[],intensity:null},"LROP":{temp:-5,conditions:[],intensity:null},"LBSF":{temp:1,conditions:[],intensity:null},"LYBE":{temp:1,conditions:[],intensity:null},"LDZA":{temp:3,conditions:[],intensity:null},"LDDU":{temp:14,conditions:[],intensity:null},"LDSP":{temp:15,conditions:[],intensity:null},"LJLJ":{temp:3,conditions:[],intensity:null},"LWSK":{temp:4,conditions:[],intensity:null},
  ...
  "OEDF":{temp:16,conditions:[],intensity:null},"OEMA":{temp:21,conditions:[],intensity:null},"OKBK":{temp:14,conditions:[],intensity:null},"OBBI":{temp:16,conditions:[],intensity:null},"OOMS":{temp:24,conditions:[],intensity:null},"OYAA":{temp:18,conditions:[],intensity:null},"OIIE":{temp:7,conditions:[],intensity:null},"OIII":{temp:6,conditions:[],intensity:null},"OISS":{temp:10,conditions:[],intensity:null},"OIKB":{temp:22,conditions:[],intensity:null},
  "OIAW":{temp:16,conditions:[],intensity:null},"OIKK":{temp:10,conditions:[],intensity:null},"OICC":{temp:6,conditions:[],intensity:null},"LLBG":{temp:19,conditions:[],intensity:null},"OLBA":{temp:17,conditions:[],intensity:null},"OJAM":{temp:12,conditions:[],intensity:null},"ORBI":{temp:12,conditions:[],intensity:null},"ORER":{temp:9,conditions:[],intensity:null},"GMMN":{temp:11,conditions:[],intensity:null},"GMME":{temp:11,conditions:[],intensity:null},
  "GMMX":{temp:11,conditions:[],intensity:null},"GMTT":{temp:11,conditions:["thunderstorm"],intensity:null},"GMFF":{temp:9,conditions:[],intensity:null},"GMAD":{temp:15,conditions:[],intensity:null},"DAAG":{temp:15,conditions:[],intensity:null},"DAOO":{temp:12,conditions:[],intensity:null},"DTTA":{temp:14,conditions:[],intensity:null},"DTMB":{temp:14,conditions:[],intensity:null},"DTTJ":{temp:15,conditions:[],intensity:null},"HECA":{temp:18,conditions:[],intensity:null},
  "HEGN":{temp:20,conditions:[],intensity:null},"HESH":{temp:21,conditions:[],intensity:null},"HEBA":{temp:20,conditions:[],intensity:null},"HEAX":{temp:18,conditions:[],intensity:null},"HLLT":{temp:16,conditions:[],intensity:null},"DNMM":{temp:31,conditions:[],intensity:null},"DNAA":{temp:34,conditions:[],intensity:null},"DGAA":{temp:30,conditions:[],intensity:null},"DIAP":{temp:29,conditions:[],intensity:null},"GOBD":{temp:22,conditions:[],intensity:null},
  "GABS":{temp:25,conditions:[],intensity:null},"GVNP":{temp:20,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:31,conditions:[],intensity:null},"DBBB":{temp:31,conditions:[],intensity:null},"HKJK":{temp:25,conditions:[],intensity:null},"HKMO":{temp:33,conditions:[],intensity:null},"HTDA":{temp:32,conditions:[],intensity:null},"HTKJ":{temp:30,conditions:[],intensity:null},
  "HUEN":{temp:30,conditions:[],intensity:null},"HRYR":{temp:26,conditions:[],intensity:null},"HAAB":{temp:21,conditions:[],intensity:null},"HDAM":{temp:26,conditions:[],intensity:null},"HCMM":{temp:33,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:29,conditions:[],intensity:null},"FIMP":{temp:28,conditions:[],intensity:null},"FMCH":{temp:32,conditions:[],intensity:null},"FMMI":{temp:25,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:29,conditions:[],intensity:null},"FKYS":{temp:28,conditions:[],intensity:null},"FOOL":{temp:30,conditions:[],intensity:null},"FZAA":{temp:26,conditions:[],intensity:null},"FCBB":{temp:26,conditions:[],intensity:null},"FLLK":{temp:25,conditions:[],intensity:null},"FVHA":{temp:22,conditions:[],intensity:null},"FLLS":{temp:24,conditions:[],intensity:null},"FYWH":{temp:26,conditions:[],intensity:null},
  ...
  "ZSSS":{temp:10,conditions:[],intensity:null},"ZGGG":{temp:23,conditions:[],intensity:null},"VHHH":{temp:21,conditions:[],intensity:null},"ZGSZ":{temp:21,conditions:[],intensity:null},"ZUUU":{temp:15,conditions:[],intensity:null},"ZUCK":{temp:17,conditions:[],intensity:null},"ZHCC":{temp:0,conditions:[],intensity:null},"ZLXY":{temp:7,conditions:[],intensity:null},"ZWSH":{temp:-17,conditions:[],intensity:null},"ZYHB":{temp:-22,conditions:[],intensity:null},
  "ZYTX":{temp:-13,conditions:[],intensity:null},"ZSAM":{temp:19,conditions:[],intensity:null},"ZGKL":{temp:18,conditions:[],intensity:null},"ZSNJ":{temp:10,conditions:[],intensity:null},"ZSHC":{temp:11,conditions:[],intensity:null},"ZPPP":{temp:13,conditions:[],intensity:null},"ZBTJ":{temp:-4,conditions:[],intensity:null},"VMMC":{temp:21,conditions:[],intensity:null},"RJTT":{temp:11,conditions:[],intensity:null},"RJAA":{temp:8,conditions:[],intensity:null},
  ...
  "RKSS":{temp:-3,conditions:[],intensity:null},"RKPK":{temp:8,conditions:[],intensity:null},"RKPC":{temp:7,conditions:[],intensity:null},"RKTN":{temp:2,conditions:[],intensity:null},"ZKPY":{temp:-8,conditions:[],intensity:null},"WSSS":{temp:28,conditions:[],intensity:null},"WMKK":{temp:30,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:27,conditions:[],intensity:null},"WBGG":{temp:27,conditions:[],intensity:null},
  "VTBS":{temp:30,conditions:[],intensity:null},"VTBD":{temp:32,conditions:[],intensity:null},"VTSP":{temp:28,conditions:[],intensity:null},"VTCC":{temp:28,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:23,conditions:[],intensity:null},"VVTS":{temp:30,conditions:[],intensity:null},"VVDN":{temp:21,conditions:[],intensity:null},"VVCR":{temp:25,conditions:[],intensity:null},
  ...
  "VOMM":{temp:28,conditions:[],intensity:null},"VEBS":{temp:24,conditions:[],intensity:null},"VOHY":{temp:29,conditions:[],intensity:null},"VAAH":{temp:29,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:30,conditions:[],intensity:null},"VOTP":{temp:27,conditions:[],intensity:null},"VIAR":{temp:16,conditions:[],intensity:null},"VIJP":{temp:26,conditions:[],intensity:null},"VELR":{temp:19,conditions:[],intensity:null},
  "VOCL":{temp:29,conditions:[],intensity:null},"VOTV":{temp:28,conditions:[],intensity:null},"VEPT":{temp:22,conditions:[],intensity:null},"VNKT":{temp:19,conditions:[],intensity:null},"OPKC":{temp:25,conditions:[],intensity:null},"OPLA":{temp:17,conditions:[],intensity:null},"OPIS":{temp:19,conditions:[],intensity:null},"RCTP":{temp:17,conditions:[],intensity:null},"RCSS":{temp:18,conditions:[],intensity:null},"RCMQ":{temp:18,conditions:[],intensity:null},
