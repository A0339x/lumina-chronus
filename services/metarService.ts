...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:8,conditions:[],intensity:null},"KLAX":{temp:13,conditions:[],intensity:null},"KORD":{temp:-8,conditions:[],intensity:null},"KDFW":{temp:6,conditions:[],intensity:null},"KDEN":{temp:-7,conditions:[],intensity:null},"KJFK":{temp:3,conditions:[],intensity:null},"KSFO":{temp:10,conditions:[],intensity:null},"KSEA":{temp:2,conditions:["fog"],intensity:null},"KLAS":{temp:8,conditions:[],intensity:null},"KMCO":{temp:12,conditions:[],intensity:null},
  "KEWR":{temp:1,conditions:[],intensity:null},"KMIA":{temp:20,conditions:[],intensity:null},"KPHX":{temp:10,conditions:[],intensity:null},"KIAH":{temp:17,conditions:[],intensity:null},"KBOS":{temp:2,conditions:[],intensity:null},"KMSP":{temp:-15,conditions:[],intensity:null},"KFLL":{temp:22,conditions:["rain"],intensity:null},"KDTW":{temp:-3,conditions:[],intensity:null},"KPHL":{temp:2,conditions:[],intensity:null},"KLGA":{temp:2,conditions:[],intensity:null},
  "KBWI":{temp:2,conditions:[],intensity:null},"KSLC":{temp:-2,conditions:[],intensity:null},"KDCA":{temp:3,conditions:[],intensity:null},"KIAD":{temp:3,conditions:[],intensity:null},"KSAN":{temp:13,conditions:[],intensity:null},"KTPA":{temp:13,conditions:[],intensity:null},"KPDX":{temp:-1,conditions:[],intensity:null},"KSTL":{temp:-4,conditions:[],intensity:null},"KHNL":{temp:22,conditions:[],intensity:null},"KMEM":{temp:5,conditions:[],intensity:null},
  ...
  "KIND":{temp:-3,conditions:[],intensity:null},"KCVG":{temp:0,conditions:[],intensity:null},"KMCI":{temp:-6,conditions:[],intensity:null},"KSAT":{temp:8,conditions:[],intensity:null},"KHOU":{temp:18,conditions:[],intensity:null},"KDAL":{temp:6,conditions:[],intensity:null},"KMDW":{temp:-7,conditions:[],intensity:null},"PANC":{temp:-3,conditions:[],intensity:null},"PAFA":{temp:-15,conditions:[],intensity:null},"CYYZ":{temp:-6,conditions:[],intensity:null},
  "CYVR":{temp:3,conditions:["fog"],intensity:null},"CYUL":{temp:-3,conditions:[],intensity:null},"CYYC":{temp:-12,conditions:[],intensity:null},"CYEG":{temp:-17,conditions:[],intensity:null},"CYOW":{temp:-2,conditions:[],intensity:null},"CYWG":{temp:-26,conditions:[],intensity:null},"CYHZ":{temp:-3,conditions:[],intensity:null},"CYQB":{temp:-8,conditions:["snow"],intensity:null},"CYYJ":{temp:2,conditions:[],intensity:null},"CYLW":{temp:0,conditions:[],intensity:null},
  "CYXE":{temp:-30,conditions:[],intensity:null},"CYQR":{temp:-25,conditions:[],intensity:null},"CYZF":{temp:-36,conditions:[],intensity:null},"CYXY":{temp:-12,conditions:[],intensity:null},"CYQT":{temp:-25,conditions:[],intensity:null},"CYYT":{temp:-7,conditions:[],intensity:null},"MMMX":{temp:8,conditions:[],intensity:null},"MMUN":{temp:21,conditions:[],intensity:null},"MMGL":{temp:13,conditions:[],intensity:null},"MMMY":{temp:14,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:23,conditions:[],intensity:null},"TIST":{temp:25,conditions:[],intensity:null},"TLPL":{temp:25,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:16,conditions:[],intensity:null},"SBGL":{temp:21,conditions:[],intensity:null},"SBBR":{temp:19,conditions:[],intensity:null},"SBCF":{temp:18,conditions:[],intensity:null},"SBSV":{temp:25,conditions:[],intensity:null},"SBRF":{temp:25,conditions:[],intensity:null},
  ...
  "SPJC":{temp:21,conditions:["fog"],intensity:null},"SEQM":{temp:11,conditions:["fog"],intensity:null},"SEGU":{temp:23,conditions:[],intensity:null},"SKBO":{temp:12,conditions:["fog"],intensity:null},"SKMR":{temp:23,conditions:[],intensity:null},"SKCL":{temp:19,conditions:[],intensity:null},"SKMD":{temp:21,conditions:[],intensity:null},"SKRG":{temp:14,conditions:["fog"],intensity:null},"SVMI":{temp:25,conditions:[],intensity:null},"SUMU":{temp:16,conditions:[],intensity:null},
  ...
  "LFRS":{temp:9,conditions:[],intensity:null},"LFSB":{temp:-2,conditions:["fog"],intensity:null},"LFPB":{temp:9,conditions:[],intensity:null},"EDDF":{temp:-3,conditions:[],intensity:null},"EDDM":{temp:-8,conditions:["fog"],intensity:null},"EDDB":{temp:-6,conditions:[],intensity:null},"EDDL":{temp:3,conditions:[],intensity:null},"EDDH":{temp:-3,conditions:[],intensity:null},"EDDK":{temp:2,conditions:[],intensity:null},"EDDS":{temp:-4,conditions:[],intensity:null},
  "EDDW":{temp:-4,conditions:[],intensity:null},"EDDN":{temp:-7,conditions:[],intensity:null},"EDDV":{temp:-5,conditions:[],intensity:null},"EDDP":{temp:-6,conditions:[],intensity:null},"LEMD":{temp:5,conditions:[],intensity:null},"LEBL":{temp:10,conditions:[],intensity:null},"LEPA":{temp:13,conditions:[],intensity:null},"LEMG":{temp:13,conditions:[],intensity:null},"LEVC":{temp:13,conditions:[],intensity:null},"LEAL":{temp:13,conditions:[],intensity:null},
  "LEZL":{temp:10,conditions:[],intensity:null},"GCLP":{temp:17,conditions:[],intensity:null},"GCTS":{temp:15,conditions:[],intensity:null},"GCLA":{temp:15,conditions:[],intensity:null},"GCFV":{temp:17,conditions:[],intensity:null},"LPPT":{temp:11,conditions:[],intensity:null},"LPPR":{temp:11,conditions:[],intensity:null},"LPFR":{temp:13,conditions:[],intensity:null},"LPMA":{temp:15,conditions:[],intensity:null},"LIRF":{temp:9,conditions:[],intensity:null},
  "LIMC":{temp:0,conditions:["fog"],intensity:null},"LIME":{temp:0,conditions:[],intensity:null},"LIPZ":{temp:2,conditions:[],intensity:null},"LIRN":{temp:10,conditions:[],intensity:null},"LIML":{temp:-2,conditions:["fog"],intensity:null},"LIPE":{temp:4,conditions:[],intensity:null},"LICC":{temp:13,conditions:[],intensity:null},"LICJ":{temp:13,conditions:[],intensity:null},"LIRA":{temp:9,conditions:[],intensity:null},"LIRP":{temp:6,conditions:[],intensity:null},
  "LIMF":{temp:0,conditions:[],intensity:null},"LIEO":{temp:9,conditions:["fog"],intensity:null},"LIEE":{temp:11,conditions:[],intensity:null},"EHAM":{temp:2,conditions:[],intensity:null},"EHRD":{temp:1,conditions:[],intensity:null},"EHEH":{temp:2,conditions:[],intensity:null},"EBBR":{temp:5,conditions:[],intensity:null},"EBCI":{temp:4,conditions:[],intensity:null},"ELLX":{temp:0,conditions:[],intensity:null},"LSZH":{temp:-3,conditions:["fog"],intensity:null},
  "LSGG":{temp:1,conditions:[],intensity:null},"LSZB":{temp:-2,conditions:["fog"],intensity:null},"LOWW":{temp:-5,conditions:[],intensity:null},"LOWS":{temp:-10,conditions:["fog"],intensity:null},"LOWG":{temp:-7,conditions:[],intensity:null},"LOWI":{temp:1,conditions:[],intensity:null},"LKPR":{temp:-7,conditions:[],intensity:null},"EPWA":{temp:-8,conditions:[],intensity:null},"EPKK":{temp:-7,conditions:[],intensity:null},"EPGD":{temp:-10,conditions:[],intensity:null},
  "EPWR":{temp:-3,conditions:[],intensity:null},"EPPO":{temp:-3,conditions:[],intensity:null},"EKCH":{temp:-1,conditions:[],intensity:null},"ESSA":{temp:-1,conditions:[],intensity:null},"ENGM":{temp:-2,conditions:[],intensity:null},"EFHK":{temp:-5,conditions:[],intensity:null},"BIKF":{temp:5,conditions:[],intensity:null},"ESGG":{temp:0,conditions:[],intensity:null},"ESMS":{temp:-1,conditions:[],intensity:null},"ENBR":{temp:-3,conditions:[],intensity:null},
  "ENZV":{temp:2,conditions:[],intensity:null},"ENTC":{temp:-9,conditions:[],intensity:null},"EFOU":{temp:-10,conditions:[],intensity:null},"EFRO":{temp:-13,conditions:[],intensity:null},"LGAV":{temp:11,conditions:[],intensity:null},"LGTS":{temp:6,conditions:[],intensity:null},"LGIR":{temp:17,conditions:[],intensity:null},"LGKR":{temp:13,conditions:[],intensity:null},"LGRP":{temp:16,conditions:[],intensity:null},"LGSR":{temp:16,conditions:[],intensity:null},
  "LGMK":{temp:14,conditions:[],intensity:null},"LTFM":{temp:7,conditions:[],intensity:null},"LTBA":{temp:9,conditions:[],intensity:null},"LTFJ":{temp:9,conditions:[],intensity:null},"LTAI":{temp:11,conditions:[],intensity:null},"LTAC":{temp:1,conditions:[],intensity:null},"LTBJ":{temp:13,conditions:[],intensity:null},"LTBS":{temp:15,conditions:[],intensity:null},"LTFE":{temp:15,conditions:["thunderstorm"],intensity:null},"LCLK":{temp:14,conditions:[],intensity:null},
  "LCPH":{temp:16,conditions:[],intensity:null},"LHBP":{temp:-2,conditions:[],intensity:null},"LROP":{temp:1,conditions:[],intensity:null},"LBSF":{temp:1,conditions:[],intensity:null},"LYBE":{temp:1,conditions:[],intensity:null},"LDZA":{temp:-3,conditions:[],intensity:null},"LDDU":{temp:11,conditions:[],intensity:null},"LDSP":{temp:11,conditions:[],intensity:null},"LJLJ":{temp:-5,conditions:[],intensity:null},"LWSK":{temp:0,conditions:["fog"],intensity:null},
  "LATI":{temp:9,conditions:[],intensity:null},"UKBB":{temp:-4,conditions:[],intensity:null},"UKLL":{temp:-8,conditions:[],intensity:null},"UUEE":{temp:-8,conditions:[],intensity:null},"UUDD":{temp:-8,conditions:[],intensity:null},"UUWW":{temp:-8,conditions:[],intensity:null},"ULLI":{temp:-11,conditions:[],intensity:null},"UWWW":{temp:-15,conditions:[],intensity:null},"USSS":{temp:-31,conditions:[],intensity:null},"UNNT":{temp:-24,conditions:[],intensity:null},
  "UUOB":{temp:-30,conditions:[],intensity:null},"UHWW":{temp:-13,conditions:[],intensity:null},"UEEE":{temp:-32,conditions:[],intensity:null},"OMDB":{temp:18,conditions:[],intensity:null},"OMDW":{temp:19,conditions:[],intensity:null},"OMAA":{temp:20,conditions:[],intensity:null},"OMSJ":{temp:19,conditions:[],intensity:null},"OTHH":{temp:19,conditions:[],intensity:null},"OERK":{temp:11,conditions:[],intensity:null},"OEJN":{temp:32,conditions:[],intensity:null},
  "OEDF":{temp:15,conditions:[],intensity:null},"OEMA":{temp:17,conditions:[],intensity:null},"OKBK":{temp:12,conditions:[],intensity:null},"OBBI":{temp:16,conditions:[],intensity:null},"OOMS":{temp:21,conditions:[],intensity:null},"OYAA":{temp:17,conditions:[],intensity:null},"OIIE":{temp:4,conditions:[],intensity:null},"OIII":{temp:3,conditions:[],intensity:null},"OISS":{temp:5,conditions:[],intensity:null},"OIKB":{temp:18,conditions:[],intensity:null},
  "OIAW":{temp:14,conditions:[],intensity:null},"OIKK":{temp:1,conditions:[],intensity:null},"OICC":{temp:2,conditions:[],intensity:null},"LLBG":{temp:19,conditions:[],intensity:null},"OLBA":{temp:17,conditions:[],intensity:null},"OJAM":{temp:8,conditions:[],intensity:null},"ORBI":{temp:11,conditions:[],intensity:null},"ORER":{temp:4,conditions:[],intensity:null},"GMMN":{temp:14,conditions:[],intensity:null},"GMME":{temp:14,conditions:[],intensity:null},
  "GMMX":{temp:13,conditions:[],intensity:null},"GMTT":{temp:15,conditions:[],intensity:null},"GMFF":{temp:11,conditions:[],intensity:null},"GMAD":{temp:13,conditions:["fog"],intensity:null},"DAAG":{temp:12,conditions:["thunderstorm"],intensity:null},"DAOO":{temp:14,conditions:[],intensity:null},"DTTA":{temp:12,conditions:[],intensity:null},"DTMB":{temp:13,conditions:[],intensity:null},"DTTJ":{temp:14,conditions:[],intensity:null},"HECA":{temp:23,conditions:[],intensity:null},
  "HEGN":{temp:24,conditions:[],intensity:null},"HESH":{temp:24,conditions:[],intensity:null},"HEBA":{temp:24,conditions:[],intensity:null},"HEAX":{temp:18,conditions:[],intensity:null},"HLLT":{temp:15,conditions:[],intensity:null},"DNMM":{temp:30,conditions:[],intensity:null},"DNAA":{temp:29,conditions:[],intensity:null},"DGAA":{temp:27,conditions:["thunderstorm"],intensity:null},"DIAP":{temp:28,conditions:[],intensity:null},"GOBD":{temp:18,conditions:[],intensity:null},
  "GABS":{temp:21,conditions:[],intensity:null},"GVNP":{temp:18,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:29,conditions:[],intensity:null},"DBBB":{temp:30,conditions:[],intensity:null},"HKJK":{temp:24,conditions:[],intensity:null},"HKMO":{temp:31,conditions:[],intensity:null},"HTDA":{temp:32,conditions:[],intensity:null},"HTKJ":{temp:29,conditions:[],intensity:null},
  "HUEN":{temp:28,conditions:[],intensity:null},"HRYR":{temp:24,conditions:[],intensity:null},"HAAB":{temp:22,conditions:[],intensity:null},"HDAM":{temp:28,conditions:[],intensity:null},"HCMM":{temp:31,conditions:[],intensity:null},"OYSN":{temp:25,conditions:[],intensity:null},"FMEE":{temp:30,conditions:[],intensity:null},"FIMP":{temp:27,conditions:[],intensity:null},"FMCH":{temp:29,conditions:[],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:28,conditions:[],intensity:null},"FKYS":{temp:26,conditions:[],intensity:null},"FOOL":{temp:26,conditions:[],intensity:null},"FZAA":{temp:27,conditions:[],intensity:null},"FCBB":{temp:26,conditions:[],intensity:null},"FLLK":{temp:26,conditions:[],intensity:null},"FVHA":{temp:23,conditions:[],intensity:null},"FLLS":{temp:25,conditions:[],intensity:null},"FYWH":{temp:29,conditions:[],intensity:null},
  "FBSK":{temp:22,conditions:[],intensity:null},"FAOR":{temp:20,conditions:[],intensity:null},"FACT":{temp:23,conditions:[],intensity:null},"FALE":{temp:33,conditions:[],intensity:null},"FAPE":{temp:27,conditions:[],intensity:null},"FQMA":{temp:26,conditions:[],intensity:null},"FWKI":{temp:25,conditions:[],intensity:null},"ZBAA":{temp:-3,conditions:[],intensity:null},"ZBAD":{temp:-3,conditions:[],intensity:null},"ZSPD":{temp:3,conditions:[],intensity:null},
  "ZSSS":{temp:3,conditions:[],intensity:null},"ZGGG":{temp:9,conditions:[],intensity:null},"VHHH":{temp:14,conditions:[],intensity:null},"ZGSZ":{temp:12,conditions:[],intensity:null},"ZUUU":{temp:8,conditions:[],intensity:null},"ZUCK":{temp:7,conditions:[],intensity:null},"ZHCC":{temp:1,conditions:[],intensity:null},"ZLXY":{temp:2,conditions:[],intensity:null},"ZWSH":{temp:-18,conditions:[],intensity:null},"ZYHB":{temp:-19,conditions:[],intensity:null},
  "ZYTX":{temp:-12,conditions:[],intensity:null},"ZSAM":{temp:12,conditions:[],intensity:null},"ZGKL":{temp:2,conditions:[],intensity:null},"ZSNJ":{temp:1,conditions:[],intensity:null},"ZSHC":{temp:4,conditions:[],intensity:null},"ZPPP":{temp:16,conditions:[],intensity:null},"ZBTJ":{temp:-2,conditions:[],intensity:null},"VMMC":{temp:12,conditions:[],intensity:null},"RJTT":{temp:4,conditions:[],intensity:null},"RJAA":{temp:1,conditions:[],intensity:null},
  "RJBB":{temp:4,conditions:[],intensity:null},"RJOO":{temp:2,conditions:[],intensity:null},"RJCC":{temp:-6,conditions:[],intensity:null},"RJFF":{temp:1,conditions:[],intensity:null},"RJGG":{temp:3,conditions:[],intensity:null},"ROAH":{temp:15,conditions:[],intensity:null},"RJSS":{temp:-1,conditions:[],intensity:null},"RJSN":{temp:1,conditions:[],intensity:null},"RJOK":{temp:2,conditions:[],intensity:null},"RKSI":{temp:-3,conditions:[],intensity:null},
  "RKSS":{temp:-7,conditions:[],intensity:null},"RKPK":{temp:-3,conditions:[],intensity:null},"RKPC":{temp:1,conditions:[],intensity:null},"RKTN":{temp:-6,conditions:[],intensity:null},"ZKPY":{temp:-13,conditions:[],intensity:null},"WSSS":{temp:29,conditions:[],intensity:null},"WMKK":{temp:30,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:29,conditions:[],intensity:null},
  "VTBS":{temp:32,conditions:[],intensity:null},"VTBD":{temp:32,conditions:[],intensity:null},"VTSP":{temp:31,conditions:[],intensity:null},"VTCC":{temp:30,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:11,conditions:[],intensity:null},"VVTS":{temp:31,conditions:[],intensity:null},"VVDN":{temp:20,conditions:[],intensity:null},"VVCR":{temp:25,conditions:[],intensity:null},
  "VDPP":{temp:30,conditions:[],intensity:null},"VDSR":{temp:31,conditions:[],intensity:null},"VLVT":{temp:27,conditions:[],intensity:null},"VLLB":{temp:27,conditions:[],intensity:null},"VYYY":{temp:31,conditions:[],intensity:null},"VYMD":{temp:29,conditions:[],intensity:null},"VGHS":{temp:25,conditions:[],intensity:null},"VGCG":{temp:24,conditions:[],intensity:null},"VECC":{temp:26,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  ...
  "RPLL":{temp:28,conditions:[],intensity:null},"RPLC":{temp:27,conditions:[],intensity:null},"RPVM":{temp:25,conditions:[],intensity:null},"RPVD":{temp:29,conditions:[],intensity:null},"RPVK":{temp:24,conditions:[],intensity:null},"WBSB":{temp:27,conditions:[],intensity:null},"WBLL":{temp:27,conditions:[],intensity:null},"VIDP":{temp:23,conditions:[],intensity:null},"VABB":{temp:26,conditions:[],intensity:null},"VOBL":{temp:26,conditions:[],intensity:null},
  "VOMM":{temp:28,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:27,conditions:[],intensity:null},"VAAH":{temp:31,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:33,conditions:[],intensity:null},"VOTP":{temp:28,conditions:[],intensity:null},"VIAR":{temp:19,conditions:[],intensity:null},"VIJP":{temp:25,conditions:[],intensity:null},"VELR":{temp:19,conditions:[],intensity:null},
  ...
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:18,conditions:[],intensity:null},"YSSY":{temp:18,conditions:[],intensity:null},"YMML":{temp:16,conditions:[],intensity:null},"YBBN":{temp:27,conditions:[],intensity:null},"YPPH":{temp:25,conditions:[],intensity:null},"YPAD":{temp:22,conditions:[],intensity:null},"YBCG":{temp:25,conditions:[],intensity:null},"YBCS":{temp:25,conditions:[],intensity:null},"YSCB":{temp:16,conditions:[],intensity:null},
  "YMHB":{temp:14,conditions:[],intensity:null},"NZAA":{temp:20,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:16,conditions:["fog"],intensity:null},"NZQN":{temp:16,conditions:[],intensity:null},"NZDN":{temp:15,conditions:["fog"],intensity:null},"NFFN":{temp:29,conditions:[],intensity:null},"NWWW":{temp:29,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:29,conditions:["thunderstorm"],intensity:null},
  "NIUE":{temp:28,conditions:[],intensity:null},"PGSN":{temp:27,conditions:["thunderstorm"],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:23,conditions:[],intensity:null},"PHKO":{temp:27,conditions:[],intensity:null},"PHLH":{temp:14,conditions:[],intensity:null}
};
