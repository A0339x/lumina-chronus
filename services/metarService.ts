...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KEWR":{temp:-10,conditions:[],intensity:null},"KMIA":{temp:21,conditions:[],intensity:null},"KPHX":{temp:10,conditions:[],intensity:null},"KIAH":{temp:1,conditions:[],intensity:null},"KBOS":{temp:-15,conditions:[],intensity:null},"KMSP":{temp:-24,conditions:[],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:-12,conditions:[],intensity:null},"KPHL":{temp:-9,conditions:["snow"],intensity:null},"KLGA":{temp:-9,conditions:[],intensity:null},
  "KBWI":{temp:-9,conditions:["snow"],intensity:null},"KSLC":{temp:-6,conditions:[],intensity:null},"KDCA":{temp:-9,conditions:["snow"],intensity:null},"KIAD":{temp:-10,conditions:["snow"],intensity:null},"KSAN":{temp:11,conditions:[],intensity:null},"KTPA":{temp:18,conditions:[],intensity:null},"KPDX":{temp:-2,conditions:[],intensity:null},"KSTL":{temp:-14,conditions:["snow"],intensity:null},"KHNL":{temp:23,conditions:[],intensity:null},"KMEM":{temp:-7,conditions:["freezing"],intensity:null},
  "KAUS":{temp:-5,conditions:[],intensity:null},"KBNA":{temp:-1,conditions:["freezing"],intensity:null},"KRDU":{temp:-8,conditions:["snow"],intensity:null},"KCLT":{temp:-7,conditions:["snow"],intensity:null},"KSMF":{temp:4,conditions:[],intensity:null},"KSJC":{temp:5,conditions:[],intensity:null},"KOAK":{temp:7,conditions:[],intensity:null},"KCLE":{temp:-12,conditions:["snow"],intensity:null},"KMKE":{temp:-16,conditions:[],intensity:null},"KPIT":{temp:-11,conditions:["snow"],intensity:null},
  "KIND":{temp:-12,conditions:["snow"],intensity:null},"KCVG":{temp:-11,conditions:["snow"],intensity:null},"KMCI":{temp:-18,conditions:[],intensity:null},"KSAT":{temp:-3,conditions:[],intensity:null},"KHOU":{temp:2,conditions:[],intensity:null},"KDAL":{temp:-9,conditions:[],intensity:null},"KMDW":{temp:-14,conditions:["snow"],intensity:null},"PANC":{temp:-5,conditions:[],intensity:null},"PAFA":{temp:-16,conditions:[],intensity:null},"CYYZ":{temp:-15,conditions:[],intensity:null},
  "CYVR":{temp:-2,conditions:[],intensity:null},"CYUL":{temp:-23,conditions:[],intensity:null},"CYYC":{temp:-20,conditions:[],intensity:null},"CYEG":{temp:-22,conditions:[],intensity:null},"CYOW":{temp:-28,conditions:[],intensity:null},"CYWG":{temp:-36,conditions:[],intensity:null},"CYHZ":{temp:-20,conditions:[],intensity:null},"CYQB":{temp:-28,conditions:[],intensity:null},"CYYJ":{temp:0,conditions:[],intensity:null},"CYLW":{temp:-9,conditions:[],intensity:null},
  "CYXE":{temp:-40,conditions:[],intensity:null},"CYQR":{temp:-36,conditions:[],intensity:null},"CYZF":{temp:-19,conditions:[],intensity:null},"CYXY":{temp:-11,conditions:[],intensity:null},"CYQT":{temp:-27,conditions:[],intensity:null},"CYYT":{temp:-12,conditions:[],intensity:null},"MMMX":{temp:11,conditions:[],intensity:null},"MMUN":{temp:22,conditions:[],intensity:null},"MMGL":{temp:12,conditions:[],intensity:null},"MMMY":{temp:8,conditions:[],intensity:null},
  "MMTJ":{temp:9,conditions:[],intensity:null},"MMSM":{temp:26,conditions:[],intensity:null},"MMMD":{temp:21,conditions:[],intensity:null},"MMCZ":{temp:26,conditions:[],intensity:null},"MMSD":{temp:14,conditions:[],intensity:null},"MGGT":{temp:14,conditions:["fog"],intensity:null},"MSLP":{temp:21,conditions:[],intensity:null},"MHTG":{temp:18,conditions:[],intensity:null},"MNMG":{temp:23,conditions:[],intensity:null},"MROC":{temp:18,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:22,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:25,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:19,conditions:["fog"],intensity:null},"SBGL":{temp:23,conditions:["fog"],intensity:null},"SBBR":{temp:19,conditions:[],intensity:null},"SBCF":{temp:20,conditions:[],intensity:null},"SBSV":{temp:25,conditions:[],intensity:null},"SBRF":{temp:25,conditions:[],intensity:null},
  "SBPA":{temp:22,conditions:[],intensity:null},"SBCT":{temp:16,conditions:["fog"],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:14,conditions:[],intensity:null},"SAEZ":{temp:23,conditions:[],intensity:null},"SABE":{temp:22,conditions:[],intensity:null},"SACO":{temp:19,conditions:[],intensity:null},"SAME":{temp:20,conditions:[],intensity:null},"SLLP":{temp:5,conditions:["fog"],intensity:null},"SLVR":{temp:23,conditions:[],intensity:null},
  "SPJC":{temp:22,conditions:[],intensity:null},"SEQM":{temp:11,conditions:["fog"],intensity:null},"SEGU":{temp:23,conditions:[],intensity:null},"SKBO":{temp:11,conditions:[],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:22,conditions:[],intensity:null},"SKRG":{temp:13,conditions:["fog"],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:19,conditions:[],intensity:null},
  ...
  "EGPH":{temp:6,conditions:[],intensity:null},"EGPF":{temp:6,conditions:[],intensity:null},"EGGW":{temp:5,conditions:[],intensity:null},"EGNX":{temp:6,conditions:[],intensity:null},"EGNT":{temp:5,conditions:[],intensity:null},"EGGP":{temp:7,conditions:[],intensity:null},"EGHI":{temp:7,conditions:[],intensity:null},"EGGD":{temp:5,conditions:[],intensity:null},"EGPD":{temp:5,conditions:[],intensity:null},"EGAA":{temp:7,conditions:[],intensity:null},
  "EIDW":{temp:7,conditions:[],intensity:null},"EICK":{temp:1,conditions:[],intensity:null},"EINN":{temp:6,conditions:[],intensity:null},"LFPG":{temp:6,conditions:[],intensity:null},"LFPO":{temp:5,conditions:[],intensity:null},"LFML":{temp:7,conditions:[],intensity:null},"LFLL":{temp:5,conditions:[],intensity:null},"LFMN":{temp:10,conditions:[],intensity:null},"LFBD":{temp:7,conditions:[],intensity:null},"LFBO":{temp:8,conditions:[],intensity:null},
  "LFRS":{temp:7,conditions:[],intensity:null},"LFSB":{temp:3,conditions:["fog"],intensity:null},"LFPB":{temp:6,conditions:[],intensity:null},"EDDF":{temp:-1,conditions:[],intensity:null},"EDDM":{temp:-3,conditions:["fog"],intensity:null},"EDDB":{temp:-2,conditions:[],intensity:null},"EDDL":{temp:1,conditions:[],intensity:null},"EDDH":{temp:-2,conditions:[],intensity:null},"EDDK":{temp:1,conditions:[],intensity:null},"EDDS":{temp:-1,conditions:[],intensity:null},
  "EDDW":{temp:-1,conditions:[],intensity:null},"EDDN":{temp:-1,conditions:[],intensity:null},"EDDV":{temp:-1,conditions:[],intensity:null},"EDDP":{temp:-1,conditions:[],intensity:null},"LEMD":{temp:7,conditions:[],intensity:null},"LEBL":{temp:10,conditions:[],intensity:null},"LEPA":{temp:13,conditions:[],intensity:null},"LEMG":{temp:12,conditions:[],intensity:null},"LEVC":{temp:12,conditions:[],intensity:null},"LEAL":{temp:13,conditions:[],intensity:null},
  "LEZL":{temp:12,conditions:[],intensity:null},"GCLP":{temp:17,conditions:[],intensity:null},"GCTS":{temp:15,conditions:[],intensity:null},"GCLA":{temp:15,conditions:[],intensity:null},"GCFV":{temp:15,conditions:[],intensity:null},"LPPT":{temp:13,conditions:[],intensity:null},"LPPR":{temp:13,conditions:[],intensity:null},"LPFR":{temp:14,conditions:[],intensity:null},"LPMA":{temp:15,conditions:[],intensity:null},"LIRF":{temp:9,conditions:[],intensity:null},
  "LIMC":{temp:5,conditions:[],intensity:null},"LIME":{temp:5,conditions:[],intensity:null},"LIPZ":{temp:8,conditions:[],intensity:null},"LIRN":{temp:11,conditions:[],intensity:null},"LIML":{temp:5,conditions:[],intensity:null},"LIPE":{temp:6,conditions:[],intensity:null},"LICC":{temp:15,conditions:[],intensity:null},"LICJ":{temp:12,conditions:[],intensity:null},"LIRA":{temp:9,conditions:[],intensity:null},"LIRP":{temp:10,conditions:[],intensity:null},
  "LIMF":{temp:5,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:11,conditions:[],intensity:null},"EHAM":{temp:0,conditions:[],intensity:null},"EHRD":{temp:1,conditions:[],intensity:null},"EHEH":{temp:1,conditions:[],intensity:null},"EBBR":{temp:4,conditions:[],intensity:null},"EBCI":{temp:3,conditions:[],intensity:null},"ELLX":{temp:-1,conditions:[],intensity:null},"LSZH":{temp:2,conditions:["fog"],intensity:null},
  "LSGG":{temp:3,conditions:[],intensity:null},"LSZB":{temp:2,conditions:[],intensity:null},"LOWW":{temp:2,conditions:[],intensity:null},"LOWS":{temp:-3,conditions:["fog"],intensity:null},"LOWG":{temp:0,conditions:["freezing"],intensity:null},"LOWI":{temp:6,conditions:[],intensity:null},"LKPR":{temp:-1,conditions:[],intensity:null},"EPWA":{temp:-5,conditions:[],intensity:null},"EPKK":{temp:0,conditions:["fog"],intensity:null},"EPGD":{temp:-6,conditions:[],intensity:null},
  "EPWR":{temp:-1,conditions:[],intensity:null},"EPPO":{temp:-3,conditions:[],intensity:null},"EKCH":{temp:1,conditions:[],intensity:null},"ESSA":{temp:-4,conditions:[],intensity:null},"ENGM":{temp:-6,conditions:[],intensity:null},"EFHK":{temp:-8,conditions:[],intensity:null},"BIKF":{temp:3,conditions:[],intensity:null},"ESGG":{temp:-4,conditions:[],intensity:null},"ESMS":{temp:0,conditions:[],intensity:null},"ENBR":{temp:-4,conditions:[],intensity:null},
  "ENZV":{temp:-1,conditions:[],intensity:null},"ENTC":{temp:-1,conditions:[],intensity:null},"EFOU":{temp:-8,conditions:[],intensity:null},"EFRO":{temp:-14,conditions:[],intensity:null},"LGAV":{temp:16,conditions:[],intensity:null},"LGTS":{temp:11,conditions:[],intensity:null},"LGIR":{temp:18,conditions:[],intensity:null},"LGKR":{temp:16,conditions:[],intensity:null},"LGRP":{temp:18,conditions:[],intensity:null},"LGSR":{temp:17,conditions:[],intensity:null},
  "LGMK":{temp:17,conditions:[],intensity:null},"LTFM":{temp:14,conditions:[],intensity:null},"LTBA":{temp:14,conditions:[],intensity:null},"LTFJ":{temp:14,conditions:[],intensity:null},"LTAI":{temp:14,conditions:[],intensity:null},"LTAC":{temp:8,conditions:[],intensity:null},"LTBJ":{temp:15,conditions:[],intensity:null},"LTBS":{temp:16,conditions:[],intensity:null},"LTFE":{temp:17,conditions:[],intensity:null},"LCLK":{temp:16,conditions:[],intensity:null},
  "LCPH":{temp:17,conditions:[],intensity:null},"LHBP":{temp:2,conditions:[],intensity:null},"LROP":{temp:1,conditions:["fog"],intensity:null},"LBSF":{temp:1,conditions:[],intensity:null},"LYBE":{temp:9,conditions:[],intensity:null},"LDZA":{temp:4,conditions:[],intensity:null},"LDDU":{temp:14,conditions:[],intensity:null},"LDSP":{temp:14,conditions:[],intensity:null},"LJLJ":{temp:3,conditions:[],intensity:null},"LWSK":{temp:7,conditions:["fog"],intensity:null},
  "LATI":{temp:16,conditions:[],intensity:null},"UKBB":{temp:-10,conditions:[],intensity:null},"UKLL":{temp:-1,conditions:[],intensity:null},"UUEE":{temp:-19,conditions:[],intensity:null},"UUDD":{temp:-23,conditions:[],intensity:null},"UUWW":{temp:-21,conditions:[],intensity:null},"ULLI":{temp:-13,conditions:[],intensity:null},"UWWW":{temp:-23,conditions:[],intensity:null},"USSS":{temp:-18,conditions:[],intensity:null},"UNNT":{temp:-25,conditions:[],intensity:null},
  "UUOB":{temp:-19,conditions:[],intensity:null},"UHWW":{temp:-12,conditions:[],intensity:null},"UEEE":{temp:-31,conditions:[],intensity:null},"OMDB":{temp:23,conditions:[],intensity:null},"OMDW":{temp:23,conditions:[],intensity:null},"OMAA":{temp:24,conditions:[],intensity:null},"OMSJ":{temp:24,conditions:[],intensity:null},"OTHH":{temp:23,conditions:[],intensity:null},"OERK":{temp:16,conditions:[],intensity:null},"OEJN":{temp:29,conditions:[],intensity:null},
  "OEDF":{temp:20,conditions:[],intensity:null},"OEMA":{temp:20,conditions:[],intensity:null},"OKBK":{temp:15,conditions:[],intensity:null},"OBBI":{temp:20,conditions:[],intensity:null},"OOMS":{temp:27,conditions:[],intensity:null},"OYAA":{temp:21,conditions:[],intensity:null},"OIIE":{temp:8,conditions:[],intensity:null},"OIII":{temp:7,conditions:[],intensity:null},"OISS":{temp:2,conditions:["snow"],intensity:null},"OIKB":{temp:16,conditions:[],intensity:null},
  "OIAW":{temp:14,conditions:[],intensity:null},"OIKK":{temp:3,conditions:[],intensity:null},"OICC":{temp:7,conditions:[],intensity:null},"LLBG":{temp:21,conditions:[],intensity:null},"OLBA":{temp:18,conditions:[],intensity:null},"OJAM":{temp:13,conditions:[],intensity:null},"ORBI":{temp:16,conditions:[],intensity:null},"ORER":{temp:11,conditions:[],intensity:null},"GMMN":{temp:11,conditions:[],intensity:null},"GMME":{temp:12,conditions:[],intensity:null},
  "GMMX":{temp:8,conditions:[],intensity:null},"GMTT":{temp:14,conditions:[],intensity:null},"GMFF":{temp:10,conditions:[],intensity:null},"GMAD":{temp:10,conditions:[],intensity:null},"DAAG":{temp:12,conditions:[],intensity:null},"DAOO":{temp:12,conditions:[],intensity:null},"DTTA":{temp:12,conditions:[],intensity:null},"DTMB":{temp:12,conditions:[],intensity:null},"DTTJ":{temp:12,conditions:[],intensity:null},"HECA":{temp:22,conditions:[],intensity:null},
  "HEGN":{temp:21,conditions:[],intensity:null},"HESH":{temp:22,conditions:[],intensity:null},"HEBA":{temp:21,conditions:[],intensity:null},"HEAX":{temp:20,conditions:[],intensity:null},"HLLT":{temp:14,conditions:[],intensity:null},"DNMM":{temp:29,conditions:[],intensity:null},"DNAA":{temp:33,conditions:[],intensity:null},"DGAA":{temp:30,conditions:[],intensity:null},"DIAP":{temp:29,conditions:[],intensity:null},"GOBD":{temp:21,conditions:[],intensity:null},
  "GABS":{temp:24,conditions:[],intensity:null},"GVNP":{temp:21,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:29,conditions:[],intensity:null},"DXXX":{temp:30,conditions:[],intensity:null},"DBBB":{temp:31,conditions:[],intensity:null},"HKJK":{temp:28,conditions:[],intensity:null},"HKMO":{temp:35,conditions:[],intensity:null},"HTDA":{temp:32,conditions:[],intensity:null},"HTKJ":{temp:32,conditions:[],intensity:null},
  "HUEN":{temp:31,conditions:[],intensity:null},"HRYR":{temp:28,conditions:[],intensity:null},"HAAB":{temp:24,conditions:[],intensity:null},"HDAM":{temp:27,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:30,conditions:[],intensity:null},"FIMP":{temp:29,conditions:[],intensity:null},"FMCH":{temp:28,conditions:["rain"],intensity:null},"FMMI":{temp:25,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:29,conditions:[],intensity:null},"FKYS":{temp:27,conditions:[],intensity:null},"FOOL":{temp:28,conditions:[],intensity:null},"FZAA":{temp:32,conditions:[],intensity:null},"FCBB":{temp:29,conditions:[],intensity:null},"FLLK":{temp:25,conditions:[],intensity:null},"FVHA":{temp:25,conditions:[],intensity:null},"FLLS":{temp:27,conditions:[],intensity:null},"FYWH":{temp:28,conditions:[],intensity:null},
  "FBSK":{temp:29,conditions:[],intensity:null},"FAOR":{temp:25,conditions:[],intensity:null},"FACT":{temp:25,conditions:[],intensity:null},"FALE":{temp:30,conditions:[],intensity:null},"FAPE":{temp:28,conditions:[],intensity:null},"FQMA":{temp:31,conditions:[],intensity:null},"FWKI":{temp:25,conditions:[],intensity:null},"ZBAA":{temp:-1,conditions:[],intensity:null},"ZBAD":{temp:-1,conditions:[],intensity:null},"ZSPD":{temp:9,conditions:[],intensity:null},
  "ZSSS":{temp:9,conditions:[],intensity:null},"ZGGG":{temp:20,conditions:[],intensity:null},"VHHH":{temp:20,conditions:[],intensity:null},"ZGSZ":{temp:20,conditions:[],intensity:null},"ZUUU":{temp:10,conditions:[],intensity:null},"ZUCK":{temp:8,conditions:[],intensity:null},"ZHCC":{temp:1,conditions:[],intensity:null},"ZLXY":{temp:5,conditions:[],intensity:null},"ZWSH":{temp:-11,conditions:[],intensity:null},"ZYHB":{temp:-18,conditions:[],intensity:null},
  "ZYTX":{temp:-12,conditions:[],intensity:null},"ZSAM":{temp:18,conditions:[],intensity:null},"ZGKL":{temp:10,conditions:[],intensity:null},"ZSNJ":{temp:8,conditions:[],intensity:null},"ZSHC":{temp:12,conditions:[],intensity:null},"ZPPP":{temp:16,conditions:[],intensity:null},"ZBTJ":{temp:-3,conditions:[],intensity:null},"VMMC":{temp:19,conditions:[],intensity:null},"RJTT":{temp:4,conditions:[],intensity:null},"RJAA":{temp:2,conditions:[],intensity:null},
  ...
  "RKSS":{temp:-6,conditions:[],intensity:null},"RKPK":{temp:0,conditions:[],intensity:null},"RKPC":{temp:3,conditions:[],intensity:null},"RKTN":{temp:-5,conditions:[],intensity:null},"ZKPY":{temp:-9,conditions:[],intensity:null},"WSSS":{temp:28,conditions:[],intensity:null},"WMKK":{temp:32,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:26,conditions:[],intensity:null},
  "VTBS":{temp:32,conditions:[],intensity:null},"VTBD":{temp:32,conditions:[],intensity:null},"VTSP":{temp:31,conditions:[],intensity:null},"VTCC":{temp:28,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:19,conditions:[],intensity:null},"VVTS":{temp:30,conditions:[],intensity:null},"VVDN":{temp:21,conditions:[],intensity:null},"VVCR":{temp:26,conditions:[],intensity:null},
  "VDPP":{temp:30,conditions:[],intensity:null},"VDSR":{temp:29,conditions:[],intensity:null},"VLVT":{temp:27,conditions:[],intensity:null},"VLLB":{temp:27,conditions:[],intensity:null},"VYYY":{temp:30,conditions:[],intensity:null},"VYMD":{temp:29,conditions:[],intensity:null},"VGHS":{temp:26,conditions:[],intensity:null},"VGCG":{temp:23,conditions:[],intensity:null},"VECC":{temp:26,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  "VCBI":{temp:26,conditions:[],intensity:null},"WIII":{temp:29,conditions:[],intensity:null},"WADD":{temp:29,conditions:[],intensity:null},"WARR":{temp:30,conditions:[],intensity:null},"WIHH":{temp:28,conditions:[],intensity:null},"WIMM":{temp:30,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:24,conditions:[],intensity:null},"WASS":{temp:27,conditions:[],intensity:null},
  "RPLL":{temp:27,conditions:[],intensity:null},"RPLC":{temp:25,conditions:[],intensity:null},"RPVM":{temp:26,conditions:[],intensity:null},"RPVD":{temp:25,conditions:[],intensity:null},"RPVK":{temp:24,conditions:[],intensity:null},"WBSB":{temp:27,conditions:[],intensity:null},"WBLL":{temp:28,conditions:[],intensity:null},"VIDP":{temp:17,conditions:[],intensity:null},"VABB":{temp:24,conditions:[],intensity:null},"VOBL":{temp:26,conditions:[],intensity:null},
  "VOMM":{temp:26,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:29,conditions:[],intensity:null},"VAAH":{temp:26,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:30,conditions:[],intensity:null},"VOTP":{temp:28,conditions:[],intensity:null},"VIAR":{temp:18,conditions:[],intensity:null},"VIJP":{temp:18,conditions:[],intensity:null},"VELR":{temp:18,conditions:[],intensity:null},
  ...
  "RCKH":{temp:22,conditions:[],intensity:null},"RCNN":{temp:20,conditions:[],intensity:null},"YSSY":{temp:26,conditions:[],intensity:null},"YMML":{temp:18,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:23,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:25,conditions:[],intensity:null},"YBCS":{temp:25,conditions:[],intensity:null},"YSCB":{temp:33,conditions:[],intensity:null},
  "YMHB":{temp:15,conditions:[],intensity:null},"NZAA":{temp:18,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:14,conditions:[],intensity:null},"NZQN":{temp:13,conditions:[],intensity:null},"NZDN":{temp:12,conditions:[],intensity:null},"NFFN":{temp:27,conditions:[],intensity:null},"NWWW":{temp:27,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
  "NIUE":{temp:28,conditions:[],intensity:null},"PGSN":{temp:26,conditions:["thunderstorm"],intensity:null},"PGUM":{temp:28,conditions:["thunderstorm"],intensity:null},"PHOG":{temp:24,conditions:[],intensity:null},"PHKO":{temp:27,conditions:[],intensity:null},"PHLH":{temp:18,conditions:["fog"],intensity:null}
};
