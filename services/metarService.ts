...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EPWR":{temp:-1,conditions:[],intensity:null},"EPPO":{temp:-1,conditions:[],intensity:null},"EKCH":{temp:-2,conditions:[],intensity:null},"ESSA":{temp:-6,conditions:[],intensity:null},"ENGM":{temp:-8,conditions:[],intensity:null},"EFHK":{temp:-15,conditions:[],intensity:null},"BIKF":{temp:1,conditions:[],intensity:null},"ESGG":{temp:-5,conditions:[],intensity:null},"ESMS":{temp:-2,conditions:[],intensity:null},"ENBR":{temp:-6,conditions:[],intensity:null},
