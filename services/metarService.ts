...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LIMF":{temp:-3,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:13,conditions:[],intensity:null},"EHAM":{temp:1,conditions:["fog"],intensity:null},"EHRD":{temp:1,conditions:[],intensity:null},"EHEH":{temp:-2,conditions:[],intensity:null},"EBBR":{temp:-1,conditions:[],intensity:null},"EBCI":{temp:-2,conditions:[],intensity:null},"ELLX":{temp:-3,conditions:[],intensity:null},"LSZH":{temp:-7,conditions:[],intensity:null},
