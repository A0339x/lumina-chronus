...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:-1,conditions:[],intensity:null},"KLAX":{temp:9,conditions:[],intensity:null},"KORD":{temp:-15,conditions:[],intensity:null},"KDFW":{temp:-11,conditions:[],intensity:null},"KDEN":{temp:-14,conditions:[],intensity:null},"KJFK":{temp:-11,conditions:["snow"],intensity:null},"KSFO":{temp:7,conditions:[],intensity:null},"KSEA":{temp:-2,conditions:[],intensity:null},"KLAS":{temp:3,conditions:[],intensity:null},"KMCO":{temp:18,conditions:[],intensity:null},
  "KEWR":{temp:-12,conditions:["snow"],intensity:null},"KMIA":{temp:21,conditions:[],intensity:null},"KPHX":{temp:9,conditions:[],intensity:null},"KIAH":{temp:-1,conditions:[],intensity:null},"KBOS":{temp:-15,conditions:[],intensity:null},"KMSP":{temp:-24,conditions:[],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:-12,conditions:[],intensity:null},"KPHL":{temp:-11,conditions:["snow"],intensity:null},"KLGA":{temp:-11,conditions:["snow"],intensity:null},
  "KBWI":{temp:-9,conditions:["snow"],intensity:null},"KSLC":{temp:-7,conditions:[],intensity:null},"KDCA":{temp:-8,conditions:["snow"],intensity:null},"KIAD":{temp:-9,conditions:["snow"],intensity:null},"KSAN":{temp:12,conditions:["fog"],intensity:null},"KTPA":{temp:19,conditions:[],intensity:null},"KPDX":{temp:-5,conditions:[],intensity:null},"KSTL":{temp:-14,conditions:["snow"],intensity:null},"KHNL":{temp:22,conditions:["fog"],intensity:null},"KMEM":{temp:-7,conditions:[],intensity:null},
  "KAUS":{temp:-6,conditions:[],intensity:null},"KBNA":{temp:0,conditions:["freezing"],intensity:null},"KRDU":{temp:-6,conditions:["snow"],intensity:null},"KCLT":{temp:-7,conditions:[],intensity:null},"KSMF":{temp:3,conditions:["fog"],intensity:null},"KSJC":{temp:4,conditions:[],intensity:null},"KOAK":{temp:5,conditions:[],intensity:null},"KCLE":{temp:-11,conditions:["snow"],intensity:null},"KMKE":{temp:-15,conditions:[],intensity:null},"KPIT":{temp:-11,conditions:["snow"],intensity:null},
  "KIND":{temp:-13,conditions:["snow"],intensity:null},"KCVG":{temp:-11,conditions:["snow"],intensity:null},"KMCI":{temp:-16,conditions:[],intensity:null},"KSAT":{temp:-3,conditions:[],intensity:null},"KHOU":{temp:1,conditions:["rain"],intensity:null},"KDAL":{temp:-10,conditions:[],intensity:null},"KMDW":{temp:-14,conditions:[],intensity:null},"PANC":{temp:-5,conditions:[],intensity:null},"PAFA":{temp:-16,conditions:[],intensity:null},"CYYZ":{temp:-11,conditions:[],intensity:null},
  "CYVR":{temp:-3,conditions:[],intensity:null},"CYUL":{temp:-21,conditions:[],intensity:null},"CYYC":{temp:-19,conditions:[],intensity:null},"CYEG":{temp:-20,conditions:[],intensity:null},"CYOW":{temp:-26,conditions:[],intensity:null},"CYWG":{temp:-35,conditions:[],intensity:null},"CYHZ":{temp:-20,conditions:[],intensity:null},"CYQB":{temp:-29,conditions:[],intensity:null},"CYYJ":{temp:0,conditions:[],intensity:null},"CYLW":{temp:-9,conditions:[],intensity:null},
  "CYXE":{temp:-40,conditions:[],intensity:null},"CYQR":{temp:-39,conditions:[],intensity:null},"CYZF":{temp:-18,conditions:[],intensity:null},"CYXY":{temp:-11,conditions:[],intensity:null},"CYQT":{temp:-27,conditions:[],intensity:null},"CYYT":{temp:-12,conditions:[],intensity:null},"MMMX":{temp:11,conditions:[],intensity:null},"MMUN":{temp:22,conditions:[],intensity:null},"MMGL":{temp:12,conditions:[],intensity:null},"MMMY":{temp:7,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:22,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:22,conditions:[],intensity:null},"SBGL":{temp:26,conditions:[],intensity:null},"SBBR":{temp:22,conditions:[],intensity:null},"SBCF":{temp:22,conditions:[],intensity:null},"SBSV":{temp:27,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null},
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:19,conditions:[],intensity:null},"SBFZ":{temp:28,conditions:[],intensity:null},"SCEL":{temp:16,conditions:[],intensity:null},"SAEZ":{temp:27,conditions:[],intensity:null},"SABE":{temp:25,conditions:[],intensity:null},"SACO":{temp:24,conditions:[],intensity:null},"SAME":{temp:22,conditions:[],intensity:null},"SLLP":{temp:6,conditions:["fog"],intensity:null},"SLVR":{temp:25,conditions:[],intensity:null},
  "SPJC":{temp:22,conditions:[],intensity:null},"SEQM":{temp:11,conditions:["fog"],intensity:null},"SEGU":{temp:23,conditions:[],intensity:null},"SKBO":{temp:11,conditions:["fog"],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:22,conditions:[],intensity:null},"SKRG":{temp:13,conditions:["fog"],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:23,conditions:[],intensity:null},
  ...
  "EDDW":{temp:0,conditions:[],intensity:null},"EDDN":{temp:0,conditions:[],intensity:null},"EDDV":{temp:-1,conditions:[],intensity:null},"EDDP":{temp:-1,conditions:[],intensity:null},"LEMD":{temp:9,conditions:[],intensity:null},"LEBL":{temp:13,conditions:[],intensity:null},"LEPA":{temp:15,conditions:[],intensity:null},"LEMG":{temp:14,conditions:[],intensity:null},"LEVC":{temp:16,conditions:[],intensity:null},"LEAL":{temp:15,conditions:[],intensity:null},
  "LEZL":{temp:13,conditions:[],intensity:null},"GCLP":{temp:18,conditions:[],intensity:null},"GCTS":{temp:17,conditions:[],intensity:null},"GCLA":{temp:18,conditions:[],intensity:null},"GCFV":{temp:18,conditions:[],intensity:null},"LPPT":{temp:14,conditions:[],intensity:null},"LPPR":{temp:13,conditions:[],intensity:null},"LPFR":{temp:15,conditions:[],intensity:null},"LPMA":{temp:17,conditions:[],intensity:null},"LIRF":{temp:12,conditions:[],intensity:null},
  ...
  "LCPH":{temp:18,conditions:[],intensity:null},"LHBP":{temp:2,conditions:[],intensity:null},"LROP":{temp:2,conditions:["fog"],intensity:null},"LBSF":{temp:4,conditions:[],intensity:null},"LYBE":{temp:11,conditions:[],intensity:null},"LDZA":{temp:5,conditions:[],intensity:null},"LDDU":{temp:15,conditions:[],intensity:null},"LDSP":{temp:14,conditions:[],intensity:null},"LJLJ":{temp:4,conditions:["rain"],intensity:null},"LWSK":{temp:8,conditions:[],intensity:null},
  "LATI":{temp:18,conditions:[],intensity:null},"UKBB":{temp:-9,conditions:[],intensity:null},"UKLL":{temp:1,conditions:[],intensity:null},"UUEE":{temp:-18,conditions:[],intensity:null},"UUDD":{temp:-21,conditions:[],intensity:null},"UUWW":{temp:-19,conditions:[],intensity:null},"ULLI":{temp:-12,conditions:[],intensity:null},"UWWW":{temp:-22,conditions:[],intensity:null},"USSS":{temp:-18,conditions:[],intensity:null},"UNNT":{temp:-26,conditions:[],intensity:null},
  ...
  "OIAW":{temp:16,conditions:[],intensity:null},"OIKK":{temp:5,conditions:[],intensity:null},"OICC":{temp:8,conditions:[],intensity:null},"LLBG":{temp:21,conditions:[],intensity:null},"OLBA":{temp:18,conditions:[],intensity:null},"OJAM":{temp:14,conditions:[],intensity:null},"ORBI":{temp:16,conditions:[],intensity:null},"ORER":{temp:12,conditions:[],intensity:null},"GMMN":{temp:14,conditions:[],intensity:null},"GMME":{temp:15,conditions:[],intensity:null},
  ...
  "HEGN":{temp:22,conditions:[],intensity:null},"HESH":{temp:22,conditions:[],intensity:null},"HEBA":{temp:25,conditions:[],intensity:null},"HEAX":{temp:21,conditions:[],intensity:null},"HLLT":{temp:16,conditions:[],intensity:null},"DNMM":{temp:33,conditions:[],intensity:null},"DNAA":{temp:36,conditions:[],intensity:null},"DGAA":{temp:33,conditions:[],intensity:null},"DIAP":{temp:33,conditions:[],intensity:null},"GOBD":{temp:25,conditions:[],intensity:null},
  "GABS":{temp:28,conditions:[],intensity:null},"GVNP":{temp:23,conditions:[],intensity:null},"GBYD":{temp:30,conditions:[],intensity:null},"GLRB":{temp:31,conditions:[],intensity:null},"DXXX":{temp:34,conditions:[],intensity:null},"DBBB":{temp:34,conditions:[],intensity:null},"HKJK":{temp:28,conditions:[],intensity:null},"HKMO":{temp:33,conditions:[],intensity:null},"HTDA":{temp:33,conditions:[],intensity:null},"HTKJ":{temp:33,conditions:[],intensity:null},
  "HUEN":{temp:27,conditions:[],intensity:null},"HRYR":{temp:29,conditions:[],intensity:null},"HAAB":{temp:24,conditions:[],intensity:null},"HDAM":{temp:28,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:25,conditions:[],intensity:null},"FMEE":{temp:29,conditions:[],intensity:null},"FIMP":{temp:29,conditions:[],intensity:null},"FMCH":{temp:28,conditions:[],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  ...
  "FBSK":{temp:31,conditions:[],intensity:null},"FAOR":{temp:27,conditions:[],intensity:null},"FACT":{temp:26,conditions:[],intensity:null},"FALE":{temp:29,conditions:[],intensity:null},"FAPE":{temp:28,conditions:[],intensity:null},"FQMA":{temp:32,conditions:[],intensity:null},"FWKI":{temp:26,conditions:[],intensity:null},"ZBAA":{temp:-3,conditions:[],intensity:null},"ZBAD":{temp:-3,conditions:[],intensity:null},"ZSPD":{temp:9,conditions:[],intensity:null},
  "ZSSS":{temp:9,conditions:[],intensity:null},"ZGGG":{temp:16,conditions:[],intensity:null},"VHHH":{temp:20,conditions:[],intensity:null},"ZGSZ":{temp:19,conditions:[],intensity:null},"ZUUU":{temp:8,conditions:[],intensity:null},"ZUCK":{temp:8,conditions:[],intensity:null},"ZHCC":{temp:0,conditions:[],intensity:null},"ZLXY":{temp:3,conditions:[],intensity:null},"ZWSH":{temp:-13,conditions:[],intensity:null},"ZYHB":{temp:-20,conditions:[],intensity:null},
  "ZYTX":{temp:-14,conditions:[],intensity:null},"ZSAM":{temp:17,conditions:[],intensity:null},"ZGKL":{temp:10,conditions:[],intensity:null},"ZSNJ":{temp:8,conditions:[],intensity:null},"ZSHC":{temp:11,conditions:[],intensity:null},"ZPPP":{temp:12,conditions:[],intensity:null},"ZBTJ":{temp:-4,conditions:[],intensity:null},"VMMC":{temp:18,conditions:[],intensity:null},"RJTT":{temp:2,conditions:[],intensity:null},"RJAA":{temp:1,conditions:[],intensity:null},
  ...
  "RKSS":{temp:-7,conditions:[],intensity:null},"RKPK":{temp:-2,conditions:[],intensity:null},"RKPC":{temp:2,conditions:[],intensity:null},"RKTN":{temp:-6,conditions:[],intensity:null},"ZKPY":{temp:-10,conditions:[],intensity:null},"WSSS":{temp:26,conditions:[],intensity:null},"WMKK":{temp:28,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:25,conditions:[],intensity:null},
  "VTBS":{temp:30,conditions:[],intensity:null},"VTBD":{temp:29,conditions:[],intensity:null},"VTSP":{temp:29,conditions:[],intensity:null},"VTCC":{temp:26,conditions:[],intensity:null},"VTSS":{temp:27,conditions:[],intensity:null},"VTUK":{temp:26,conditions:[],intensity:null},"VVNB":{temp:18,conditions:[],intensity:null},"VVTS":{temp:27,conditions:[],intensity:null},"VVDN":{temp:19,conditions:[],intensity:null},"VVCR":{temp:23,conditions:[],intensity:null},
  ...
  "RPLL":{temp:25,conditions:[],intensity:null},"RPLC":{temp:22,conditions:[],intensity:null},"RPVM":{temp:25,conditions:[],intensity:null},"RPVD":{temp:24,conditions:[],intensity:null},"RPVK":{temp:22,conditions:[],intensity:null},"WBSB":{temp:26,conditions:[],intensity:null},"WBLL":{temp:28,conditions:[],intensity:null},"VIDP":{temp:15,conditions:[],intensity:null},"VABB":{temp:24,conditions:[],intensity:null},"VOBL":{temp:24,conditions:[],intensity:null},
  "VOMM":{temp:25,conditions:[],intensity:null},"VEBS":{temp:24,conditions:[],intensity:null},"VOHY":{temp:27,conditions:[],intensity:null},"VAAH":{temp:25,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:29,conditions:[],intensity:null},"VOTP":{temp:26,conditions:[],intensity:null},"VIAR":{temp:17,conditions:[],intensity:null},"VIJP":{temp:17,conditions:[],intensity:null},"VELR":{temp:15,conditions:[],intensity:null},
  "VOCL":{temp:29,conditions:[],intensity:null},"VOTV":{temp:27,conditions:[],intensity:null},"VEPT":{temp:22,conditions:[],intensity:null},"VNKT":{temp:16,conditions:[],intensity:null},"OPKC":{temp:21,conditions:[],intensity:null},"OPLA":{temp:18,conditions:[],intensity:null},"OPIS":{temp:15,conditions:[],intensity:null},"RCTP":{temp:18,conditions:[],intensity:null},"RCSS":{temp:19,conditions:[],intensity:null},"RCMQ":{temp:17,conditions:[],intensity:null},
  "RCKH":{temp:21,conditions:[],intensity:null},"RCNN":{temp:19,conditions:[],intensity:null},"YSSY":{temp:24,conditions:[],intensity:null},"YMML":{temp:16,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:22,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:24,conditions:[],intensity:null},"YBCS":{temp:24,conditions:[],intensity:null},"YSCB":{temp:28,conditions:[],intensity:null},
