...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EDDW":{temp:11,conditions:[],intensity:null},"EDDN":{temp:13,conditions:[],intensity:null},"EDDV":{temp:14,conditions:[],intensity:null},"EDDP":{temp:11,conditions:[],intensity:null},"LEMD":{temp:10,conditions:[],intensity:null},"LEBL":{temp:12,conditions:[],intensity:null},"LEPA":{temp:12,conditions:[],intensity:null},"LEMG":{temp:16,conditions:[],intensity:null},"LEVC":{temp:11,conditions:[],intensity:null},"LEAL":{temp:13,conditions:[],intensity:null},
  "LEZL":{temp:16,conditions:[],intensity:null},"GCLP":{temp:17,conditions:[],intensity:null},"GCTS":{temp:17,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:18,conditions:[],intensity:null},"LPPT":{temp:13,conditions:[],intensity:null},"LPPR":{temp:14,conditions:[],intensity:null},"LPFR":{temp:15,conditions:[],intensity:null},"LPMA":{temp:14,conditions:[],intensity:null},"LIRF":{temp:15,conditions:[],intensity:null},
  ...
  "OIAW":{temp:17,conditions:[],intensity:null},"OIKK":{temp:13,conditions:[],intensity:null},"OICC":{temp:8,conditions:[],intensity:null},"LLBG":{temp:15,conditions:[],intensity:null},"OLBA":{temp:14,conditions:[],intensity:null},"OJAM":{temp:9,conditions:[],intensity:null},"ORBI":{temp:17,conditions:[],intensity:null},"ORER":{temp:12,conditions:[],intensity:null},"GMMN":{temp:14,conditions:[],intensity:null},"GMME":{temp:14,conditions:[],intensity:null},
  "GMMX":{temp:15,conditions:[],intensity:null},"GMTT":{temp:14,conditions:[],intensity:null},"GMFF":{temp:12,conditions:[],intensity:null},"GMAD":{temp:16,conditions:[],intensity:null},"DAAG":{temp:14,conditions:[],intensity:null},"DAOO":{temp:15,conditions:[],intensity:null},"DTTA":{temp:17,conditions:[],intensity:null},"DTMB":{temp:16,conditions:[],intensity:null},"DTTJ":{temp:17,conditions:[],intensity:null},"HECA":{temp:17,conditions:[],intensity:null},
