...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EPWR":{temp:0,conditions:[],intensity:null},"EPPO":{temp:-1,conditions:[],intensity:null},"EKCH":{temp:1,conditions:[],intensity:null},"ESSA":{temp:0,conditions:[],intensity:null},"ENGM":{temp:-1,conditions:[],intensity:null},"EFHK":{temp:-2,conditions:[],intensity:null},"BIKF":{temp:4,conditions:[],intensity:null},"ESGG":{temp:-5,conditions:[],intensity:null},"ESMS":{temp:0,conditions:[],intensity:null},"ENBR":{temp:1,conditions:[],intensity:null},
  "ENZV":{temp:0,conditions:[],intensity:null},"ENTC":{temp:-1,conditions:[],intensity:null},"EFOU":{temp:-2,conditions:[],intensity:null},"EFRO":{temp:-11,conditions:[],intensity:null},"LGAV":{temp:6,conditions:[],intensity:null},"LGTS":{temp:-1,conditions:[],intensity:null},"LGIR":{temp:9,conditions:[],intensity:null},"LGKR":{temp:9,conditions:[],intensity:null},"LGRP":{temp:8,conditions:[],intensity:null},"LGSR":{temp:10,conditions:[],intensity:null},
