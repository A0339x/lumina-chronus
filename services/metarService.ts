...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:18,conditions:[],intensity:null},"KLAX":{temp:14,conditions:[],intensity:null},"KORD":{temp:16,conditions:[],intensity:null},"KDFW":{temp:22,conditions:[],intensity:null},"KDEN":{temp:-2,conditions:[],intensity:null},"KJFK":{temp:2,conditions:[],intensity:null},"KSFO":{temp:13,conditions:[],intensity:null},"KSEA":{temp:9,conditions:[],intensity:null},"KLAS":{temp:11,conditions:[],intensity:null},"KMCO":{temp:20,conditions:[],intensity:null},
  "KEWR":{temp:2,conditions:[],intensity:null},"KMIA":{temp:23,conditions:[],intensity:null},"KPHX":{temp:12,conditions:[],intensity:null},"KIAH":{temp:24,conditions:[],intensity:null},"KBOS":{temp:1,conditions:["fog"],intensity:null},"KMSP":{temp:4,conditions:[],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:13,conditions:[],intensity:null},"KPHL":{temp:4,conditions:[],intensity:null},"KLGA":{temp:2,conditions:[],intensity:null},
  ...
  "SBPA":{temp:24,conditions:[],intensity:null},"SBCT":{temp:18,conditions:[],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:16,conditions:[],intensity:null},"SAEZ":{temp:19,conditions:[],intensity:null},"SABE":{temp:21,conditions:[],intensity:null},"SACO":{temp:17,conditions:["fog"],intensity:null},"SAME":{temp:16,conditions:[],intensity:null},"SLLP":{temp:4,conditions:[],intensity:null},"SLVR":{temp:23,conditions:["thunderstorm"],intensity:null},
  ...
  "EIDW":{temp:4,conditions:[],intensity:null},"EICK":{temp:6,conditions:[],intensity:null},"EINN":{temp:7,conditions:[],intensity:null},"LFPG":{temp:9,conditions:[],intensity:null},"LFPO":{temp:10,conditions:[],intensity:null},"LFML":{temp:13,conditions:[],intensity:null},"LFLL":{temp:8,conditions:[],intensity:null},"LFMN":{temp:13,conditions:[],intensity:null},"LFBD":{temp:11,conditions:[],intensity:null},"LFBO":{temp:11,conditions:[],intensity:null},
  "LFRS":{temp:11,conditions:["rain"],intensity:null},"LFSB":{temp:3,conditions:["fog"],intensity:null},"LFPB":{temp:9,conditions:[],intensity:null},"EDDF":{temp:4,conditions:["fog"],intensity:null},"EDDM":{temp:-3,conditions:["fog"],intensity:null},"EDDB":{temp:2,conditions:[],intensity:null},"EDDL":{temp:9,conditions:[],intensity:null},"EDDH":{temp:4,conditions:[],intensity:null},"EDDK":{temp:8,conditions:[],intensity:null},"EDDS":{temp:2,conditions:["fog"],intensity:null},
  "EDDW":{temp:3,conditions:[],intensity:null},"EDDN":{temp:1,conditions:["fog"],intensity:null},"EDDV":{temp:3,conditions:[],intensity:null},"EDDP":{temp:3,conditions:[],intensity:null},"LEMD":{temp:7,conditions:[],intensity:null},"LEBL":{temp:12,conditions:["fog"],intensity:null},"LEPA":{temp:10,conditions:[],intensity:null},"LEMG":{temp:11,conditions:[],intensity:null},"LEVC":{temp:11,conditions:[],intensity:null},"LEAL":{temp:10,conditions:[],intensity:null},
  ...
  "LIMC":{temp:5,conditions:[],intensity:null},"LIME":{temp:6,conditions:[],intensity:null},"LIPZ":{temp:4,conditions:["fog"],intensity:null},"LIRN":{temp:12,conditions:[],intensity:null},"LIML":{temp:6,conditions:["fog"],intensity:null},"LIPE":{temp:6,conditions:[],intensity:null},"LICC":{temp:14,conditions:[],intensity:null},"LICJ":{temp:14,conditions:[],intensity:null},"LIRA":{temp:11,conditions:[],intensity:null},"LIRP":{temp:9,conditions:[],intensity:null},
  "LIMF":{temp:6,conditions:[],intensity:null},"LIEO":{temp:13,conditions:[],intensity:null},"LIEE":{temp:12,conditions:["fog"],intensity:null},"EHAM":{temp:8,conditions:[],intensity:null},"EHRD":{temp:8,conditions:["fog"],intensity:null},"EHEH":{temp:8,conditions:[],intensity:null},"EBBR":{temp:8,conditions:["fog"],intensity:null},"EBCI":{temp:7,conditions:["fog"],intensity:null},"ELLX":{temp:7,conditions:[],intensity:null},"LSZH":{temp:2,conditions:["fog"],intensity:null},
  "LSGG":{temp:5,conditions:[],intensity:null},"LSZB":{temp:5,conditions:[],intensity:null},"LOWW":{temp:7,conditions:[],intensity:null},"LOWS":{temp:-1,conditions:["fog"],intensity:null},"LOWG":{temp:2,conditions:["fog"],intensity:null},"LOWI":{temp:5,conditions:[],intensity:null},"LKPR":{temp:3,conditions:[],intensity:null},"EPWA":{temp:4,conditions:[],intensity:null},"EPKK":{temp:2,conditions:[],intensity:null},"EPGD":{temp:3,conditions:[],intensity:null},
  "EPWR":{temp:2,conditions:[],intensity:null},"EPPO":{temp:2,conditions:[],intensity:null},"EKCH":{temp:3,conditions:[],intensity:null},"ESSA":{temp:2,conditions:[],intensity:null},"ENGM":{temp:2,conditions:[],intensity:null},"EFHK":{temp:0,conditions:[],intensity:null},"BIKF":{temp:4,conditions:[],intensity:null},"ESGG":{temp:0,conditions:[],intensity:null},"ESMS":{temp:1,conditions:[],intensity:null},"ENBR":{temp:5,conditions:[],intensity:null},
  "ENZV":{temp:5,conditions:[],intensity:null},"ENTC":{temp:3,conditions:[],intensity:null},"EFOU":{temp:-1,conditions:[],intensity:null},"EFRO":{temp:-4,conditions:[],intensity:null},"LGAV":{temp:13,conditions:[],intensity:null},"LGTS":{temp:10,conditions:[],intensity:null},"LGIR":{temp:15,conditions:[],intensity:null},"LGKR":{temp:14,conditions:[],intensity:null},"LGRP":{temp:17,conditions:[],intensity:null},"LGSR":{temp:16,conditions:[],intensity:null},
  "LGMK":{temp:14,conditions:[],intensity:null},"LTFM":{temp:7,conditions:[],intensity:null},"LTBA":{temp:8,conditions:[],intensity:null},"LTFJ":{temp:7,conditions:[],intensity:null},"LTAI":{temp:13,conditions:[],intensity:null},"LTAC":{temp:1,conditions:[],intensity:null},"LTBJ":{temp:11,conditions:[],intensity:null},"LTBS":{temp:16,conditions:[],intensity:null},"LTFE":{temp:15,conditions:[],intensity:null},"LCLK":{temp:15,conditions:[],intensity:null},
  "LCPH":{temp:16,conditions:[],intensity:null},"LHBP":{temp:7,conditions:[],intensity:null},"LROP":{temp:5,conditions:[],intensity:null},"LBSF":{temp:5,conditions:[],intensity:null},"LYBE":{temp:7,conditions:[],intensity:null},"LDZA":{temp:3,conditions:["fog"],intensity:null},"LDDU":{temp:13,conditions:[],intensity:null},"LDSP":{temp:11,conditions:[],intensity:null},"LJLJ":{temp:3,conditions:[],intensity:null},"LWSK":{temp:7,conditions:[],intensity:null},
  "LATI":{temp:9,conditions:[],intensity:null},"UKBB":{temp:0,conditions:[],intensity:null},"UKLL":{temp:4,conditions:[],intensity:null},"UUEE":{temp:-2,conditions:[],intensity:null},"UUDD":{temp:-2,conditions:[],intensity:null},"UUWW":{temp:-2,conditions:[],intensity:null},"ULLI":{temp:2,conditions:[],intensity:null},"UWWW":{temp:-12,conditions:[],intensity:null},"USSS":{temp:-11,conditions:[],intensity:null},"UNNT":{temp:-11,conditions:[],intensity:null},
  ...
  "HEGN":{temp:19,conditions:[],intensity:null},"HESH":{temp:20,conditions:[],intensity:null},"HEBA":{temp:20,conditions:[],intensity:null},"HEAX":{temp:19,conditions:[],intensity:null},"HLLT":{temp:17,conditions:[],intensity:null},"DNMM":{temp:28,conditions:[],intensity:null},"DNAA":{temp:27,conditions:[],intensity:null},"DGAA":{temp:27,conditions:[],intensity:null},"DIAP":{temp:26,conditions:[],intensity:null},"GOBD":{temp:19,conditions:[],intensity:null},
  "GABS":{temp:22,conditions:[],intensity:null},"GVNP":{temp:18,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:25,conditions:["fog"],intensity:null},"DXXX":{temp:28,conditions:[],intensity:null},"DBBB":{temp:28,conditions:[],intensity:null},"HKJK":{temp:20,conditions:[],intensity:null},"HKMO":{temp:29,conditions:[],intensity:null},"HTDA":{temp:29,conditions:[],intensity:null},"HTKJ":{temp:24,conditions:[],intensity:null},
  "HUEN":{temp:23,conditions:[],intensity:null},"HRYR":{temp:20,conditions:[],intensity:null},"HAAB":{temp:18,conditions:[],intensity:null},"HDAM":{temp:28,conditions:[],intensity:null},"HCMM":{temp:31,conditions:[],intensity:null},"OYSN":{temp:29,conditions:[],intensity:null},"FMEE":{temp:31,conditions:[],intensity:null},"FIMP":{temp:27,conditions:[],intensity:null},"FMCH":{temp:30,conditions:[],intensity:null},"FMMI":{temp:24,conditions:[],intensity:null},
  ...
  "FBSK":{temp:22,conditions:[],intensity:null},"FAOR":{temp:19,conditions:[],intensity:null},"FACT":{temp:18,conditions:[],intensity:null},"FALE":{temp:29,conditions:[],intensity:null},"FAPE":{temp:19,conditions:[],intensity:null},"FQMA":{temp:31,conditions:[],intensity:null},"FWKI":{temp:23,conditions:[],intensity:null},"ZBAA":{temp:8,conditions:[],intensity:null},"ZBAD":{temp:9,conditions:[],intensity:null},"ZSPD":{temp:7,conditions:[],intensity:null},
  ...
  "ZYTX":{temp:1,conditions:[],intensity:null},"ZSAM":{temp:19,conditions:[],intensity:null},"ZGKL":{temp:16,conditions:[],intensity:null},"ZSNJ":{temp:11,conditions:[],intensity:null},"ZSHC":{temp:12,conditions:[],intensity:null},"ZPPP":{temp:20,conditions:[],intensity:null},"ZBTJ":{temp:9,conditions:[],intensity:null},"VMMC":{temp:22,conditions:[],intensity:null},"RJTT":{temp:13,conditions:[],intensity:null},"RJAA":{temp:13,conditions:[],intensity:null},
  ...
  "RKSS":{temp:4,conditions:[],intensity:null},"RKPK":{temp:8,conditions:[],intensity:null},"RKPC":{temp:5,conditions:[],intensity:null},"RKTN":{temp:6,conditions:[],intensity:null},"ZKPY":{temp:3,conditions:[],intensity:null},"WSSS":{temp:31,conditions:[],intensity:null},"WMKK":{temp:31,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:28,conditions:[],intensity:null},
  "VTBS":{temp:35,conditions:[],intensity:null},"VTBD":{temp:35,conditions:[],intensity:null},"VTSP":{temp:32,conditions:[],intensity:null},"VTCC":{temp:33,conditions:[],intensity:null},"VTSS":{temp:30,conditions:[],intensity:null},"VTUK":{temp:31,conditions:[],intensity:null},"VVNB":{temp:25,conditions:[],intensity:null},"VVTS":{temp:32,conditions:[],intensity:null},"VVDN":{temp:25,conditions:[],intensity:null},"VVCR":{temp:30,conditions:[],intensity:null},
  "VDPP":{temp:33,conditions:[],intensity:null},"VDSR":{temp:33,conditions:[],intensity:null},"VLVT":{temp:30,conditions:[],intensity:null},"VLLB":{temp:31,conditions:[],intensity:null},"VYYY":{temp:33,conditions:[],intensity:null},"VYMD":{temp:35,conditions:[],intensity:null},"VGHS":{temp:31,conditions:[],intensity:null},"VGCG":{temp:26,conditions:[],intensity:null},"VECC":{temp:31,conditions:[],intensity:null},"VRMM":{temp:28,conditions:[],intensity:null},
  "VCBI":{temp:28,conditions:[],intensity:null},"WIII":{temp:30,conditions:[],intensity:null},"WADD":{temp:29,conditions:[],intensity:null},"WARR":{temp:31,conditions:["thunderstorm"],intensity:null},"WIHH":{temp:29,conditions:["thunderstorm"],intensity:null},"WIMM":{temp:32,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:27,conditions:[],intensity:null},"WASS":{temp:29,conditions:[],intensity:null},
  "RPLL":{temp:30,conditions:[],intensity:null},"RPLC":{temp:32,conditions:[],intensity:null},"RPVM":{temp:30,conditions:[],intensity:null},"RPVD":{temp:34,conditions:[],intensity:null},"RPVK":{temp:28,conditions:[],intensity:null},"WBSB":{temp:26,conditions:[],intensity:null},"WBLL":{temp:27,conditions:[],intensity:null},"VIDP":{temp:31,conditions:[],intensity:null},"VABB":{temp:27,conditions:[],intensity:null},"VOBL":{temp:31,conditions:[],intensity:null},
  "VOMM":{temp:35,conditions:[],intensity:null},"VEBS":{temp:31,conditions:[],intensity:null},"VOHY":{temp:35,conditions:[],intensity:null},"VAAH":{temp:34,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:31,conditions:[],intensity:null},"VOTP":{temp:32,conditions:[],intensity:null},"VIAR":{temp:30,conditions:[],intensity:null},"VIJP":{temp:35,conditions:[],intensity:null},"VELR":{temp:21,conditions:[],intensity:null},
  "VOCL":{temp:30,conditions:[],intensity:null},"VOTV":{temp:28,conditions:[],intensity:null},"VEPT":{temp:32,conditions:[],intensity:null},"VNKT":{temp:23,conditions:[],intensity:null},"OPKC":{temp:30,conditions:[],intensity:null},"OPLA":{temp:31,conditions:[],intensity:null},"OPIS":{temp:29,conditions:[],intensity:null},"RCTP":{temp:17,conditions:[],intensity:null},"RCSS":{temp:16,conditions:[],intensity:null},"RCMQ":{temp:20,conditions:[],intensity:null},
  "RCKH":{temp:24,conditions:[],intensity:null},"RCNN":{temp:24,conditions:[],intensity:null},"YSSY":{temp:24,conditions:[],intensity:null},"YMML":{temp:20,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:37,conditions:[],intensity:null},"YPAD":{temp:21,conditions:[],intensity:null},"YBCG":{temp:24,conditions:[],intensity:null},"YBCS":{temp:26,conditions:["thunderstorm"],intensity:null},"YSCB":{temp:26,conditions:[],intensity:null},
  "YMHB":{temp:14,conditions:[],intensity:null},"NZAA":{temp:19,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:16,conditions:[],intensity:null},"NZQN":{temp:19,conditions:[],intensity:null},"NZDN":{temp:15,conditions:[],intensity:null},"NFFN":{temp:27,conditions:[],intensity:null},"NWWW":{temp:30,conditions:[],intensity:null},"NTAA":{temp:29,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
  "NIUE":{temp:27,conditions:[],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:26,conditions:[],intensity:null},"PHOG":{temp:24,conditions:[],intensity:null},"PHKO":{temp:27,conditions:[],intensity:null},"PHLH":{temp:21,conditions:[],intensity:null}
};
