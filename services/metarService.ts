...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EPWR":{temp:9,conditions:[],intensity:null},"EPPO":{temp:10,conditions:[],intensity:null},"EKCH":{temp:6,conditions:[],intensity:null},"ESSA":{temp:2,conditions:[],intensity:null},"ENGM":{temp:1,conditions:[],intensity:null},"EFHK":{temp:2,conditions:[],intensity:null},"BIKF":{temp:-3,conditions:[],intensity:null},"ESGG":{temp:6,conditions:[],intensity:null},"ESMS":{temp:6,conditions:[],intensity:null},"ENBR":{temp:2,conditions:[],intensity:null},
