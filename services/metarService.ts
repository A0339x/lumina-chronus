...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:3,conditions:[],intensity:null},"KLAX":{temp:18,conditions:[],intensity:null},"KORD":{temp:-13,conditions:[],intensity:null},"KDFW":{temp:-7,conditions:[],intensity:null},"KDEN":{temp:-9,conditions:["snow"],intensity:null},"KJFK":{temp:-6,conditions:["snow"],intensity:null},"KSFO":{temp:12,conditions:[],intensity:null},"KSEA":{temp:5,conditions:[],intensity:null},"KLAS":{temp:15,conditions:[],intensity:null},"KMCO":{temp:26,conditions:[],intensity:null},
  "KEWR":{temp:-8,conditions:["snow"],intensity:null},"KMIA":{temp:24,conditions:[],intensity:null},"KPHX":{temp:18,conditions:[],intensity:null},"KIAH":{temp:-2,conditions:[],intensity:null},"KBOS":{temp:-4,conditions:["snow"],intensity:null},"KMSP":{temp:-17,conditions:[],intensity:null},"KFLL":{temp:24,conditions:[],intensity:null},"KDTW":{temp:-11,conditions:["snow"],intensity:null},"KPHL":{temp:-5,conditions:["freezing"],intensity:null},"KLGA":{temp:-6,conditions:["snow"],intensity:null},
  "KBWI":{temp:-5,conditions:["freezing"],intensity:null},"KSLC":{temp:2,conditions:[],intensity:null},"KDCA":{temp:-5,conditions:["freezing"],intensity:null},"KIAD":{temp:-8,conditions:["freezing"],intensity:null},"KSAN":{temp:18,conditions:[],intensity:null},"KTPA":{temp:22,conditions:[],intensity:null},"KPDX":{temp:7,conditions:[],intensity:null},"KSTL":{temp:-12,conditions:[],intensity:null},"KHNL":{temp:27,conditions:[],intensity:null},"KMEM":{temp:-9,conditions:[],intensity:null},
  "KAUS":{temp:-4,conditions:[],intensity:null},"KBNA":{temp:-9,conditions:[],intensity:null},"KRDU":{temp:-5,conditions:[],intensity:null},"KCLT":{temp:-4,conditions:["freezing"],intensity:null},"KSMF":{temp:10,conditions:[],intensity:null},"KSJC":{temp:15,conditions:[],intensity:null},"KOAK":{temp:13,conditions:[],intensity:null},"KCLE":{temp:-10,conditions:["snow"],intensity:null},"KMKE":{temp:-14,conditions:[],intensity:null},"KPIT":{temp:-5,conditions:[],intensity:null},
  "KIND":{temp:-13,conditions:[],intensity:null},"KCVG":{temp:-10,conditions:[],intensity:null},"KMCI":{temp:-11,conditions:[],intensity:null},"KSAT":{temp:-2,conditions:[],intensity:null},"KHOU":{temp:-1,conditions:[],intensity:null},"KDAL":{temp:-7,conditions:[],intensity:null},"KMDW":{temp:-13,conditions:[],intensity:null},"PANC":{temp:-6,conditions:[],intensity:null},"PAFA":{temp:-18,conditions:[],intensity:null},"CYYZ":{temp:-14,conditions:["snow"],intensity:null},
  "CYVR":{temp:5,conditions:[],intensity:null},"CYUL":{temp:-18,conditions:["snow"],intensity:null},"CYYC":{temp:0,conditions:[],intensity:null},"CYEG":{temp:-5,conditions:[],intensity:null},"CYOW":{temp:-19,conditions:["snow"],intensity:null},"CYWG":{temp:-28,conditions:[],intensity:null},"CYHZ":{temp:-16,conditions:[],intensity:null},"CYQB":{temp:-22,conditions:[],intensity:null},"CYYJ":{temp:5,conditions:[],intensity:null},"CYLW":{temp:-3,conditions:[],intensity:null},
  "CYXE":{temp:-23,conditions:[],intensity:null},"CYQR":{temp:-24,conditions:[],intensity:null},"CYZF":{temp:-23,conditions:[],intensity:null},"CYXY":{temp:-13,conditions:[],intensity:null},"CYQT":{temp:-23,conditions:[],intensity:null},"CYYT":{temp:-9,conditions:[],intensity:null},"MMMX":{temp:23,conditions:[],intensity:null},"MMUN":{temp:26,conditions:[],intensity:null},"MMGL":{temp:21,conditions:[],intensity:null},"MMMY":{temp:10,conditions:[],intensity:null},
  "MMTJ":{temp:17,conditions:[],intensity:null},"MMSM":{temp:28,conditions:[],intensity:null},"MMMD":{temp:31,conditions:[],intensity:null},"MMCZ":{temp:27,conditions:[],intensity:null},"MMSD":{temp:21,conditions:[],intensity:null},"MGGT":{temp:22,conditions:[],intensity:null},"MSLP":{temp:28,conditions:[],intensity:null},"MHTG":{temp:26,conditions:[],intensity:null},"MNMG":{temp:30,conditions:[],intensity:null},"MROC":{temp:26,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:24,conditions:[],intensity:null},"TIST":{temp:27,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:26,conditions:[],intensity:null},"SBGR":{temp:21,conditions:[],intensity:null},"SBGL":{temp:26,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:21,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:25,conditions:[],intensity:null},
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:19,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:18,conditions:[],intensity:null},"SAEZ":{temp:28,conditions:[],intensity:null},"SABE":{temp:27,conditions:[],intensity:null},"SACO":{temp:27,conditions:[],intensity:null},"SAME":{temp:24,conditions:[],intensity:null},"SLLP":{temp:11,conditions:[],intensity:null},"SLVR":{temp:28,conditions:[],intensity:null},
  ...
  "GMMX":{temp:7,conditions:[],intensity:null},"GMTT":{temp:15,conditions:[],intensity:null},"GMFF":{temp:11,conditions:[],intensity:null},"GMAD":{temp:10,conditions:["fog"],intensity:null},"DAAG":{temp:12,conditions:[],intensity:null},"DAOO":{temp:14,conditions:[],intensity:null},"DTTA":{temp:10,conditions:[],intensity:null},"DTMB":{temp:10,conditions:[],intensity:null},"DTTJ":{temp:13,conditions:[],intensity:null},"HECA":{temp:15,conditions:[],intensity:null},
  ...
  "RJBB":{temp:3,conditions:[],intensity:null},"RJOO":{temp:0,conditions:[],intensity:null},"RJCC":{temp:-13,conditions:[],intensity:null},"RJFF":{temp:0,conditions:[],intensity:null},"RJGG":{temp:3,conditions:[],intensity:null},"ROAH":{temp:18,conditions:[],intensity:null},"RJSS":{temp:-1,conditions:[],intensity:null},"RJSN":{temp:0,conditions:[],intensity:null},"RJOK":{temp:1,conditions:[],intensity:null},"RKSI":{temp:-5,conditions:[],intensity:null},
  "RKSS":{temp:-9,conditions:[],intensity:null},"RKPK":{temp:-5,conditions:[],intensity:null},"RKPC":{temp:2,conditions:[],intensity:null},"RKTN":{temp:-9,conditions:[],intensity:null},"ZKPY":{temp:-13,conditions:[],intensity:null},"WSSS":{temp:24,conditions:[],intensity:null},"WMKK":{temp:22,conditions:[],intensity:null},"WMKP":{temp:28,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:24,conditions:["fog"],intensity:null},
  "VTBS":{temp:23,conditions:[],intensity:null},"VTBD":{temp:20,conditions:[],intensity:null},"VTSP":{temp:25,conditions:[],intensity:null},"VTCC":{temp:20,conditions:[],intensity:null},"VTSS":{temp:25,conditions:[],intensity:null},"VTUK":{temp:22,conditions:[],intensity:null},"VVNB":{temp:16,conditions:[],intensity:null},"VVTS":{temp:21,conditions:[],intensity:null},"VVDN":{temp:17,conditions:[],intensity:null},"VVCR":{temp:19,conditions:[],intensity:null},
  ...
  "RCKH":{temp:19,conditions:[],intensity:null},"RCNN":{temp:18,conditions:[],intensity:null},"YSSY":{temp:23,conditions:[],intensity:null},"YMML":{temp:19,conditions:[],intensity:null},"YBBN":{temp:28,conditions:[],intensity:null},"YPPH":{temp:20,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:29,conditions:[],intensity:null},"YBCS":{temp:26,conditions:[],intensity:null},"YSCB":{temp:22,conditions:[],intensity:null},
  "YMHB":{temp:15,conditions:[],intensity:null},"NZAA":{temp:19,conditions:[],intensity:null},"NZWN":{temp:19,conditions:[],intensity:null},"NZCH":{temp:18,conditions:[],intensity:null},"NZQN":{temp:15,conditions:[],intensity:null},"NZDN":{temp:12,conditions:[],intensity:null},"NFFN":{temp:30,conditions:[],intensity:null},"NWWW":{temp:29,conditions:[],intensity:null},"NTAA":{temp:26,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
