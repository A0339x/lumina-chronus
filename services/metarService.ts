...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "CYVR":{temp:10,conditions:[],intensity:null},"CYUL":{temp:-9,conditions:[],intensity:null},"CYYC":{temp:8,conditions:[],intensity:null},"CYEG":{temp:2,conditions:[],intensity:null},"CYOW":{temp:-12,conditions:[],intensity:null},"CYWG":{temp:-12,conditions:[],intensity:null},"CYHZ":{temp:-4,conditions:["snow"],intensity:null},"CYQB":{temp:-14,conditions:[],intensity:null},"CYYJ":{temp:10,conditions:[],intensity:null},"CYLW":{temp:9,conditions:[],intensity:null},
  "CYXE":{temp:-4,conditions:[],intensity:null},"CYQR":{temp:-2,conditions:[],intensity:null},"CYZF":{temp:-28,conditions:[],intensity:null},"CYXY":{temp:-25,conditions:[],intensity:null},"CYQT":{temp:-11,conditions:[],intensity:null},"CYYT":{temp:1,conditions:[],intensity:null},"MMMX":{temp:25,conditions:[],intensity:null},"MMUN":{temp:27,conditions:[],intensity:null},"MMGL":{temp:30,conditions:[],intensity:null},"MMMY":{temp:29,conditions:[],intensity:null},
  "MMTJ":{temp:27,conditions:[],intensity:null},"MMSM":{temp:27,conditions:[],intensity:null},"MMMD":{temp:30,conditions:[],intensity:null},"MMCZ":{temp:26,conditions:[],intensity:null},"MMSD":{temp:32,conditions:[],intensity:null},"MGGT":{temp:26,conditions:[],intensity:null},"MSLP":{temp:31,conditions:[],intensity:null},"MHTG":{temp:29,conditions:[],intensity:null},"MNMG":{temp:34,conditions:[],intensity:null},"MROC":{temp:31,conditions:[],intensity:null},
  ...
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:19,conditions:[],intensity:null},"SBFZ":{temp:25,conditions:["thunderstorm"],intensity:null},"SCEL":{temp:25,conditions:[],intensity:null},"SAEZ":{temp:28,conditions:[],intensity:null},"SABE":{temp:27,conditions:[],intensity:null},"SACO":{temp:27,conditions:[],intensity:null},"SAME":{temp:29,conditions:[],intensity:null},"SLLP":{temp:15,conditions:[],intensity:null},"SLVR":{temp:27,conditions:[],intensity:null},
  "SPJC":{temp:22,conditions:[],intensity:null},"SEQM":{temp:16,conditions:[],intensity:null},"SEGU":{temp:30,conditions:[],intensity:null},"SKBO":{temp:15,conditions:[],intensity:null},"SKMR":{temp:31,conditions:[],intensity:null},"SKCL":{temp:26,conditions:[],intensity:null},"SKMD":{temp:29,conditions:[],intensity:null},"SKRG":{temp:18,conditions:[],intensity:null},"SVMI":{temp:25,conditions:[],intensity:null},"SUMU":{temp:25,conditions:[],intensity:null},
  ...
  "VTBS":{temp:28,conditions:[],intensity:null},"VTBD":{temp:27,conditions:[],intensity:null},"VTSP":{temp:28,conditions:[],intensity:null},"VTCC":{temp:21,conditions:[],intensity:null},"VTSS":{temp:25,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:23,conditions:[],intensity:null},"VVTS":{temp:25,conditions:[],intensity:null},"VVDN":{temp:24,conditions:[],intensity:null},"VVCR":{temp:24,conditions:["fog"],intensity:null},
  ...
  "VCBI":{temp:27,conditions:[],intensity:null},"WIII":{temp:25,conditions:[],intensity:null},"WADD":{temp:28,conditions:["thunderstorm"],intensity:null},"WARR":{temp:25,conditions:[],intensity:null},"WIHH":{temp:27,conditions:[],intensity:null},"WIMM":{temp:24,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:22,conditions:[],intensity:null},"WASS":{temp:28,conditions:[],intensity:null},
  ...
  "VOMM":{temp:23,conditions:[],intensity:null},"VEBS":{temp:24,conditions:[],intensity:null},"VOHY":{temp:23,conditions:[],intensity:null},"VAAH":{temp:22,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:25,conditions:[],intensity:null},"VOTP":{temp:22,conditions:["fog"],intensity:null},"VIAR":{temp:17,conditions:[],intensity:null},"VIJP":{temp:21,conditions:[],intensity:null},"VELR":{temp:14,conditions:[],intensity:null},
  "VOCL":{temp:27,conditions:[],intensity:null},"VOTV":{temp:27,conditions:[],intensity:null},"VEPT":{temp:19,conditions:[],intensity:null},"VNKT":{temp:13,conditions:[],intensity:null},"OPKC":{temp:20,conditions:[],intensity:null},"OPLA":{temp:20,conditions:[],intensity:null},"OPIS":{temp:13,conditions:[],intensity:null},"RCTP":{temp:22,conditions:[],intensity:null},"RCSS":{temp:20,conditions:[],intensity:null},"RCMQ":{temp:21,conditions:[],intensity:null},
  "RCKH":{temp:25,conditions:[],intensity:null},"RCNN":{temp:22,conditions:[],intensity:null},"YSSY":{temp:22,conditions:[],intensity:null},"YMML":{temp:20,conditions:["rain"],intensity:null},"YBBN":{temp:24,conditions:[],intensity:null},"YPPH":{temp:16,conditions:[],intensity:null},"YPAD":{temp:20,conditions:[],intensity:null},"YBCG":{temp:22,conditions:[],intensity:null},"YBCS":{temp:25,conditions:["fog"],intensity:null},"YSCB":{temp:18,conditions:[],intensity:null},
  "YMHB":{temp:19,conditions:[],intensity:null},"NZAA":{temp:17,conditions:[],intensity:null},"NZWN":{temp:12,conditions:[],intensity:null},"NZCH":{temp:9,conditions:[],intensity:null},"NZQN":{temp:8,conditions:[],intensity:null},"NZDN":{temp:8,conditions:[],intensity:null},"NFFN":{temp:28,conditions:["thunderstorm"],intensity:null},"NWWW":{temp:29,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
  "NIUE":{temp:29,conditions:[],intensity:null},"PGSN":{temp:26,conditions:[],intensity:null},"PGUM":{temp:26,conditions:[],intensity:null},"PHOG":{temp:28,conditions:[],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:24,conditions:[],intensity:null}
};
