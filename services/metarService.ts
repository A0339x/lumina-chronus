...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EDDW":{temp:8,conditions:[],intensity:null},"EDDN":{temp:8,conditions:[],intensity:null},"EDDV":{temp:9,conditions:[],intensity:null},"EDDP":{temp:8,conditions:[],intensity:null},"LEMD":{temp:8,conditions:[],intensity:null},"LEBL":{temp:11,conditions:[],intensity:null},"LEPA":{temp:12,conditions:[],intensity:null},"LEMG":{temp:11,conditions:[],intensity:null},"LEVC":{temp:12,conditions:[],intensity:null},"LEAL":{temp:11,conditions:[],intensity:null},
  ...
  "LIMF":{temp:8,conditions:[],intensity:null},"LIEO":{temp:13,conditions:[],intensity:null},"LIEE":{temp:14,conditions:[],intensity:null},"EHAM":{temp:10,conditions:[],intensity:null},"EHRD":{temp:4,conditions:["fog"],intensity:null},"EHEH":{temp:12,conditions:[],intensity:null},"EBBR":{temp:12,conditions:[],intensity:null},"EBCI":{temp:12,conditions:[],intensity:null},"ELLX":{temp:11,conditions:[],intensity:null},"LSZH":{temp:8,conditions:[],intensity:null},
  ...
  "EPWR":{temp:5,conditions:[],intensity:null},"EPPO":{temp:6,conditions:[],intensity:null},"EKCH":{temp:5,conditions:[],intensity:null},"ESSA":{temp:3,conditions:[],intensity:null},"ENGM":{temp:2,conditions:[],intensity:null},"EFHK":{temp:1,conditions:[],intensity:null},"BIKF":{temp:1,conditions:[],intensity:null},"ESGG":{temp:5,conditions:[],intensity:null},"ESMS":{temp:5,conditions:[],intensity:null},"ENBR":{temp:5,conditions:[],intensity:null},
  "ENZV":{temp:5,conditions:[],intensity:null},"ENTC":{temp:2,conditions:[],intensity:null},"EFOU":{temp:-1,conditions:[],intensity:null},"EFRO":{temp:-2,conditions:[],intensity:null},"LGAV":{temp:9,conditions:[],intensity:null},"LGTS":{temp:7,conditions:["fog"],intensity:null},"LGIR":{temp:12,conditions:[],intensity:null},"LGKR":{temp:11,conditions:[],intensity:null},"LGRP":{temp:13,conditions:[],intensity:null},"LGSR":{temp:13,conditions:[],intensity:null},
  "LGMK":{temp:13,conditions:[],intensity:null},"LTFM":{temp:6,conditions:[],intensity:null},"LTBA":{temp:6,conditions:[],intensity:null},"LTFJ":{temp:5,conditions:[],intensity:null},"LTAI":{temp:11,conditions:[],intensity:null},"LTAC":{temp:-1,conditions:[],intensity:null},"LTBJ":{temp:8,conditions:[],intensity:null},"LTBS":{temp:12,conditions:[],intensity:null},"LTFE":{temp:12,conditions:[],intensity:null},"LCLK":{temp:9,conditions:[],intensity:null},
  "LCPH":{temp:10,conditions:[],intensity:null},"LHBP":{temp:9,conditions:[],intensity:null},"LROP":{temp:4,conditions:[],intensity:null},"LBSF":{temp:6,conditions:[],intensity:null},"LYBE":{temp:10,conditions:[],intensity:null},"LDZA":{temp:6,conditions:[],intensity:null},"LDDU":{temp:11,conditions:[],intensity:null},"LDSP":{temp:11,conditions:[],intensity:null},"LJLJ":{temp:5,conditions:[],intensity:null},"LWSK":{temp:9,conditions:[],intensity:null},
  ...
  "OIAW":{temp:16,conditions:[],intensity:null},"OIKK":{temp:12,conditions:[],intensity:null},"OICC":{temp:5,conditions:[],intensity:null},"LLBG":{temp:8,conditions:[],intensity:null},"OLBA":{temp:11,conditions:[],intensity:null},"OJAM":{temp:4,conditions:[],intensity:null},"ORBI":{temp:9,conditions:[],intensity:null},"ORER":{temp:7,conditions:[],intensity:null},"GMMN":{temp:12,conditions:[],intensity:null},"GMME":{temp:12,conditions:[],intensity:null},
  "GMMX":{temp:12,conditions:[],intensity:null},"GMTT":{temp:14,conditions:[],intensity:null},"GMFF":{temp:9,conditions:[],intensity:null},"GMAD":{temp:14,conditions:[],intensity:null},"DAAG":{temp:14,conditions:[],intensity:null},"DAOO":{temp:12,conditions:[],intensity:null},"DTTA":{temp:14,conditions:[],intensity:null},"DTMB":{temp:15,conditions:[],intensity:null},"DTTJ":{temp:17,conditions:[],intensity:null},"HECA":{temp:14,conditions:[],intensity:null},
