...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "SBPA":{temp:22,conditions:[],intensity:null},"SBCT":{temp:18,conditions:[],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:17,conditions:[],intensity:null},"SAEZ":{temp:24,conditions:[],intensity:null},"SABE":{temp:24,conditions:[],intensity:null},"SACO":{temp:17,conditions:[],intensity:null},"SAME":{temp:20,conditions:[],intensity:null},"SLLP":{temp:5,conditions:["fog"],intensity:null},"SLVR":{temp:22,conditions:[],intensity:null},
  "SPJC":{temp:20,conditions:[],intensity:null},"SEQM":{temp:11,conditions:[],intensity:null},"SEGU":{temp:22,conditions:["rain"],intensity:null},"SKBO":{temp:12,conditions:[],intensity:null},"SKMR":{temp:23,conditions:[],intensity:null},"SKCL":{temp:18,conditions:[],intensity:null},"SKMD":{temp:21,conditions:[],intensity:null},"SKRG":{temp:13,conditions:[],intensity:null},"SVMI":{temp:27,conditions:[],intensity:null},"SUMU":{temp:19,conditions:[],intensity:null},
  ...
  "LFRS":{temp:6,conditions:[],intensity:null},"LFSB":{temp:1,conditions:[],intensity:null},"LFPB":{temp:9,conditions:[],intensity:null},"EDDF":{temp:5,conditions:[],intensity:null},"EDDM":{temp:3,conditions:[],intensity:null},"EDDB":{temp:0,conditions:["fog"],intensity:null},"EDDL":{temp:6,conditions:[],intensity:null},"EDDH":{temp:3,conditions:["fog"],intensity:null},"EDDK":{temp:6,conditions:[],intensity:null},"EDDS":{temp:6,conditions:[],intensity:null},
  ...
  "LIMF":{temp:-2,conditions:[],intensity:null},"LIEO":{temp:5,conditions:[],intensity:null},"LIEE":{temp:9,conditions:["fog"],intensity:null},"EHAM":{temp:7,conditions:[],intensity:null},"EHRD":{temp:7,conditions:[],intensity:null},"EHEH":{temp:7,conditions:["fog"],intensity:null},"EBBR":{temp:10,conditions:[],intensity:null},"EBCI":{temp:8,conditions:[],intensity:null},"ELLX":{temp:3,conditions:["fog"],intensity:null},"LSZH":{temp:1,conditions:[],intensity:null},
  "LSGG":{temp:3,conditions:[],intensity:null},"LSZB":{temp:1,conditions:[],intensity:null},"LOWW":{temp:-3,conditions:["freezing"],intensity:null},"LOWS":{temp:1,conditions:[],intensity:null},"LOWG":{temp:-4,conditions:[],intensity:null},"LOWI":{temp:-4,conditions:[],intensity:null},"LKPR":{temp:2,conditions:[],intensity:null},"EPWA":{temp:-6,conditions:[],intensity:null},"EPKK":{temp:-6,conditions:["snow"],intensity:null},"EPGD":{temp:-6,conditions:[],intensity:null},
  ...
  "LGMK":{temp:8,conditions:[],intensity:null},"LTFM":{temp:-1,conditions:[],intensity:null},"LTBA":{temp:-1,conditions:[],intensity:null},"LTFJ":{temp:0,conditions:[],intensity:null},"LTAI":{temp:8,conditions:[],intensity:null},"LTAC":{temp:-2,conditions:[],intensity:null},"LTBJ":{temp:1,conditions:[],intensity:null},"LTBS":{temp:8,conditions:[],intensity:null},"LTFE":{temp:5,conditions:[],intensity:null},"LCLK":{temp:11,conditions:[],intensity:null},
  ...
  "GMMX":{temp:5,conditions:[],intensity:null},"GMTT":{temp:13,conditions:[],intensity:null},"GMFF":{temp:5,conditions:[],intensity:null},"GMAD":{temp:9,conditions:[],intensity:null},"DAAG":{temp:10,conditions:[],intensity:null},"DAOO":{temp:8,conditions:[],intensity:null},"DTTA":{temp:8,conditions:[],intensity:null},"DTMB":{temp:8,conditions:[],intensity:null},"DTTJ":{temp:9,conditions:[],intensity:null},"HECA":{temp:11,conditions:[],intensity:null},
  "HEGN":{temp:15,conditions:[],intensity:null},"HESH":{temp:15,conditions:[],intensity:null},"HEBA":{temp:15,conditions:[],intensity:null},"HEAX":{temp:14,conditions:[],intensity:null},"HLLT":{temp:10,conditions:[],intensity:null},"DNMM":{temp:26,conditions:["fog"],intensity:null},"DNAA":{temp:18,conditions:[],intensity:null},"DGAA":{temp:26,conditions:["fog"],intensity:null},"DIAP":{temp:26,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  "GABS":{temp:21,conditions:[],intensity:null},"GVNP":{temp:18,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:25,conditions:["fog"],intensity:null},"DXXX":{temp:26,conditions:[],intensity:null},"DBBB":{temp:27,conditions:[],intensity:null},"HKJK":{temp:19,conditions:[],intensity:null},"HKMO":{temp:29,conditions:[],intensity:null},"HTDA":{temp:28,conditions:[],intensity:null},"HTKJ":{temp:24,conditions:[],intensity:null},
  "HUEN":{temp:23,conditions:[],intensity:null},"HRYR":{temp:21,conditions:[],intensity:null},"HAAB":{temp:17,conditions:[],intensity:null},"HDAM":{temp:25,conditions:[],intensity:null},"HCMM":{temp:28,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:29,conditions:[],intensity:null},"FIMP":{temp:26,conditions:[],intensity:null},"FMCH":{temp:30,conditions:[],intensity:null},"FMMI":{temp:23,conditions:[],intensity:null},
  "FSIA":{temp:27,conditions:[],intensity:null},"FKKD":{temp:26,conditions:["fog"],intensity:null},"FKYS":{temp:22,conditions:["fog"],intensity:null},"FOOL":{temp:26,conditions:[],intensity:null},"FZAA":{temp:25,conditions:[],intensity:null},"FCBB":{temp:24,conditions:["fog"],intensity:null},"FLLK":{temp:23,conditions:[],intensity:null},"FVHA":{temp:20,conditions:[],intensity:null},"FLLS":{temp:22,conditions:[],intensity:null},"FYWH":{temp:23,conditions:[],intensity:null},
  ...
  "VCBI":{temp:28,conditions:[],intensity:null},"WIII":{temp:29,conditions:[],intensity:null},"WADD":{temp:28,conditions:[],intensity:null},"WARR":{temp:30,conditions:[],intensity:null},"WIHH":{temp:28,conditions:[],intensity:null},"WIMM":{temp:29,conditions:[],intensity:null},"WIBB":{temp:27,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:26,conditions:[],intensity:null},"WASS":{temp:30,conditions:[],intensity:null},
  "RPLL":{temp:28,conditions:[],intensity:null},"RPLC":{temp:30,conditions:[],intensity:null},"RPVM":{temp:29,conditions:[],intensity:null},"RPVD":{temp:30,conditions:[],intensity:null},"RPVK":{temp:27,conditions:[],intensity:null},"WBSB":{temp:28,conditions:[],intensity:null},"WBLL":{temp:27,conditions:[],intensity:null},"VIDP":{temp:15,conditions:[],intensity:null},"VABB":{temp:26,conditions:[],intensity:null},"VOBL":{temp:25,conditions:[],intensity:null},
  "VOMM":{temp:28,conditions:[],intensity:null},"VEBS":{temp:23,conditions:[],intensity:null},"VOHY":{temp:27,conditions:[],intensity:null},"VAAH":{temp:27,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:32,conditions:[],intensity:null},"VOTP":{temp:26,conditions:[],intensity:null},"VIAR":{temp:9,conditions:[],intensity:null},"VIJP":{temp:20,conditions:[],intensity:null},"VELR":{temp:21,conditions:[],intensity:null},
  ...
  "RCKH":{temp:23,conditions:[],intensity:null},"RCNN":{temp:23,conditions:[],intensity:null},"YSSY":{temp:24,conditions:[],intensity:null},"YMML":{temp:20,conditions:[],intensity:null},"YBBN":{temp:27,conditions:[],intensity:null},"YPPH":{temp:33,conditions:[],intensity:null},"YPAD":{temp:22,conditions:[],intensity:null},"YBCG":{temp:26,conditions:[],intensity:null},"YBCS":{temp:26,conditions:[],intensity:null},"YSCB":{temp:31,conditions:[],intensity:null},
  "YMHB":{temp:16,conditions:[],intensity:null},"NZAA":{temp:21,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:19,conditions:[],intensity:null},"NZQN":{temp:13,conditions:[],intensity:null},"NZDN":{temp:15,conditions:[],intensity:null},"NFFN":{temp:27,conditions:["thunderstorm"],intensity:null},"NWWW":{temp:32,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:27,conditions:[],intensity:null},
