...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "VDPP":{temp:25,conditions:["rain"],intensity:null},"VDSR":{temp:26,conditions:[],intensity:null},"VLVT":{temp:25,conditions:[],intensity:null},"VLLB":{temp:23,conditions:[],intensity:null},"VYYY":{temp:27,conditions:[],intensity:null},"VYMD":{temp:24,conditions:[],intensity:null},"VGHS":{temp:22,conditions:[],intensity:null},"VGCG":{temp:22,conditions:[],intensity:null},"VECC":{temp:26,conditions:[],intensity:null},"VRMM":{temp:26,conditions:["rain"],intensity:null},
  ...
  "RPLL":{temp:27,conditions:[],intensity:null},"RPLC":{temp:26,conditions:[],intensity:null},"RPVM":{temp:26,conditions:[],intensity:null},"RPVD":{temp:23,conditions:[],intensity:null},"RPVK":{temp:25,conditions:[],intensity:null},"WBSB":{temp:25,conditions:[],intensity:null},"WBLL":{temp:28,conditions:[],intensity:null},"VIDP":{temp:26,conditions:[],intensity:null},"VABB":{temp:28,conditions:[],intensity:null},"VOBL":{temp:22,conditions:[],intensity:null},
  ...
  "VOCL":{temp:26,conditions:[],intensity:null},"VOTV":{temp:26,conditions:[],intensity:null},"VEPT":{temp:24,conditions:[],intensity:null},"VNKT":{temp:14,conditions:["rain"],intensity:null},"OPKC":{temp:28,conditions:[],intensity:null},"OPLA":{temp:24,conditions:[],intensity:null},"OPIS":{temp:20,conditions:[],intensity:null},"RCTP":{temp:20,conditions:[],intensity:null},"RCSS":{temp:20,conditions:[],intensity:null},"RCMQ":{temp:20,conditions:[],intensity:null},
  "RCKH":{temp:25,conditions:[],intensity:null},"RCNN":{temp:25,conditions:[],intensity:null},"YSSY":{temp:17,conditions:[],intensity:null},"YMML":{temp:12,conditions:[],intensity:null},"YBBN":{temp:20,conditions:[],intensity:null},"YPPH":{temp:10,conditions:[],intensity:null},"YPAD":{temp:14,conditions:[],intensity:null},"YBCG":{temp:19,conditions:[],intensity:null},"YBCS":{temp:24,conditions:[],intensity:null},"YSCB":{temp:14,conditions:[],intensity:null},
  "YMHB":{temp:11,conditions:[],intensity:null},"NZAA":{temp:14,conditions:[],intensity:null},"NZWN":{temp:15,conditions:[],intensity:null},"NZCH":{temp:9,conditions:[],intensity:null},"NZQN":{temp:7,conditions:[],intensity:null},"NZDN":{temp:10,conditions:[],intensity:null},"NFFN":{temp:25,conditions:[],intensity:null},"NWWW":{temp:25,conditions:[],intensity:null},"NTAA":{temp:31,conditions:[],intensity:null},"NSFA":{temp:25,conditions:[],intensity:null},
  "NIUE":{temp:26,conditions:[],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:29,conditions:[],intensity:null},"PHOG":{temp:27,conditions:[],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:25,conditions:[],intensity:null}
};
