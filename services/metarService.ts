...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:22,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:24,conditions:[],intensity:null},"SAEZ":{temp:25,conditions:[],intensity:null},"SABE":{temp:24,conditions:[],intensity:null},"SACO":{temp:24,conditions:[],intensity:null},"SAME":{temp:28,conditions:[],intensity:null},"SLLP":{temp:14,conditions:[],intensity:null},"SLVR":{temp:26,conditions:[],intensity:null},
  "SPJC":{temp:22,conditions:[],intensity:null},"SEQM":{temp:13,conditions:["thunderstorm"],intensity:null},"SEGU":{temp:29,conditions:[],intensity:null},"SKBO":{temp:16,conditions:[],intensity:null},"SKMR":{temp:27,conditions:[],intensity:null},"SKCL":{temp:24,conditions:[],intensity:null},"SKMD":{temp:27,conditions:[],intensity:null},"SKRG":{temp:18,conditions:[],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:25,conditions:[],intensity:null},
  ...
  "EPWR":{temp:-1,conditions:[],intensity:null},"EPPO":{temp:-1,conditions:[],intensity:null},"EKCH":{temp:-2,conditions:[],intensity:null},"ESSA":{temp:-12,conditions:[],intensity:null},"ENGM":{temp:-16,conditions:[],intensity:null},"EFHK":{temp:-19,conditions:[],intensity:null},"BIKF":{temp:-2,conditions:[],intensity:null},"ESGG":{temp:-12,conditions:[],intensity:null},"ESMS":{temp:-7,conditions:[],intensity:null},"ENBR":{temp:-1,conditions:[],intensity:null},
  ...
  "GABS":{temp:23,conditions:[],intensity:null},"GVNP":{temp:21,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:26,conditions:[],intensity:null},"DXXX":{temp:27,conditions:[],intensity:null},"DBBB":{temp:28,conditions:[],intensity:null},"HKJK":{temp:18,conditions:[],intensity:null},"HKMO":{temp:26,conditions:[],intensity:null},"HTDA":{temp:25,conditions:[],intensity:null},"HTKJ":{temp:21,conditions:[],intensity:null},
  ...
  "VTBS":{temp:27,conditions:[],intensity:null},"VTBD":{temp:26,conditions:[],intensity:null},"VTSP":{temp:27,conditions:[],intensity:null},"VTCC":{temp:23,conditions:[],intensity:null},"VTSS":{temp:26,conditions:[],intensity:null},"VTUK":{temp:27,conditions:[],intensity:null},"VVNB":{temp:20,conditions:[],intensity:null},"VVTS":{temp:24,conditions:[],intensity:null},"VVDN":{temp:18,conditions:["fog"],intensity:null},"VVCR":{temp:22,conditions:[],intensity:null},
  "VDPP":{temp:25,conditions:[],intensity:null},"VDSR":{temp:24,conditions:[],intensity:null},"VLVT":{temp:23,conditions:[],intensity:null},"VLLB":{temp:21,conditions:[],intensity:null},"VYYY":{temp:19,conditions:[],intensity:null},"VYMD":{temp:18,conditions:[],intensity:null},"VGHS":{temp:16,conditions:[],intensity:null},"VGCG":{temp:21,conditions:[],intensity:null},"VECC":{temp:19,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  ...
  "VOMM":{temp:21,conditions:[],intensity:null},"VEBS":{temp:19,conditions:[],intensity:null},"VOHY":{temp:18,conditions:[],intensity:null},"VAAH":{temp:18,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:24,conditions:[],intensity:null},"VOTP":{temp:20,conditions:[],intensity:null},"VIAR":{temp:13,conditions:[],intensity:null},"VIJP":{temp:17,conditions:[],intensity:null},"VELR":{temp:13,conditions:[],intensity:null},
  "VOCL":{temp:27,conditions:[],intensity:null},"VOTV":{temp:28,conditions:[],intensity:null},"VEPT":{temp:15,conditions:[],intensity:null},"VNKT":{temp:11,conditions:[],intensity:null},"OPKC":{temp:19,conditions:[],intensity:null},"OPLA":{temp:16,conditions:[],intensity:null},"OPIS":{temp:8,conditions:[],intensity:null},"RCTP":{temp:16,conditions:[],intensity:null},"RCSS":{temp:17,conditions:[],intensity:null},"RCMQ":{temp:15,conditions:[],intensity:null},
  "RCKH":{temp:23,conditions:[],intensity:null},"RCNN":{temp:20,conditions:[],intensity:null},"YSSY":{temp:17,conditions:[],intensity:null},"YMML":{temp:17,conditions:[],intensity:null},"YBBN":{temp:21,conditions:[],intensity:null},"YPPH":{temp:20,conditions:[],intensity:null},"YPAD":{temp:23,conditions:[],intensity:null},"YBCG":{temp:19,conditions:[],intensity:null},"YBCS":{temp:25,conditions:["fog"],intensity:null},"YSCB":{temp:16,conditions:[],intensity:null},
  "YMHB":{temp:17,conditions:[],intensity:null},"NZAA":{temp:20,conditions:[],intensity:null},"NZWN":{temp:15,conditions:[],intensity:null},"NZCH":{temp:15,conditions:[],intensity:null},"NZQN":{temp:12,conditions:[],intensity:null},"NZDN":{temp:12,conditions:[],intensity:null},"NFFN":{temp:29,conditions:[],intensity:null},"NWWW":{temp:31,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
  "NIUE":{temp:28,conditions:[],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:27,conditions:[],intensity:null},"PHOG":{temp:28,conditions:[],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:22,conditions:[],intensity:null}
};
