...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:-3,conditions:[],intensity:null},"KLAX":{temp:12,conditions:["fog"],intensity:null},"KORD":{temp:-4,conditions:[],intensity:null},"KDFW":{temp:11,conditions:[],intensity:null},"KDEN":{temp:-7,conditions:[],intensity:null},"KJFK":{temp:-10,conditions:[],intensity:null},"KSFO":{temp:8,conditions:[],intensity:null},"KSEA":{temp:2,conditions:[],intensity:null},"KLAS":{temp:6,conditions:[],intensity:null},"KMCO":{temp:9,conditions:[],intensity:null},
  "KEWR":{temp:-13,conditions:[],intensity:null},"KMIA":{temp:19,conditions:[],intensity:null},"KPHX":{temp:9,conditions:[],intensity:null},"KIAH":{temp:14,conditions:[],intensity:null},"KBOS":{temp:-11,conditions:[],intensity:null},"KMSP":{temp:-11,conditions:[],intensity:null},"KFLL":{temp:20,conditions:[],intensity:null},"KDTW":{temp:-8,conditions:[],intensity:null},"KPHL":{temp:-12,conditions:[],intensity:null},"KLGA":{temp:-11,conditions:[],intensity:null},
  "KBWI":{temp:-11,conditions:[],intensity:null},"KSLC":{temp:-4,conditions:[],intensity:null},"KDCA":{temp:-9,conditions:[],intensity:null},"KIAD":{temp:-12,conditions:[],intensity:null},"KSAN":{temp:13,conditions:["fog"],intensity:null},"KTPA":{temp:9,conditions:[],intensity:null},"KPDX":{temp:1,conditions:[],intensity:null},"KSTL":{temp:2,conditions:[],intensity:null},"KHNL":{temp:21,conditions:[],intensity:null},"KMEM":{temp:4,conditions:[],intensity:null},
  ...
  "KIND":{temp:-2,conditions:[],intensity:null},"KCVG":{temp:-3,conditions:[],intensity:null},"KMCI":{temp:-1,conditions:[],intensity:null},"KSAT":{temp:15,conditions:[],intensity:null},"KHOU":{temp:14,conditions:[],intensity:null},"KDAL":{temp:11,conditions:[],intensity:null},"KMDW":{temp:-3,conditions:[],intensity:null},"PANC":{temp:-4,conditions:[],intensity:null},"PAFA":{temp:-14,conditions:[],intensity:null},"CYYZ":{temp:-13,conditions:[],intensity:null},
  "CYVR":{temp:3,conditions:["fog"],intensity:null},"CYUL":{temp:-12,conditions:[],intensity:null},"CYYC":{temp:-7,conditions:[],intensity:null},"CYEG":{temp:-9,conditions:[],intensity:null},"CYOW":{temp:-14,conditions:[],intensity:null},"CYWG":{temp:-17,conditions:[],intensity:null},"CYHZ":{temp:-14,conditions:[],intensity:null},"CYQB":{temp:-16,conditions:[],intensity:null},"CYYJ":{temp:2,conditions:[],intensity:null},"CYLW":{temp:0,conditions:[],intensity:null},
  ...
  "MMTJ":{temp:11,conditions:["fog"],intensity:null},"MMSM":{temp:27,conditions:[],intensity:null},"MMMD":{temp:17,conditions:[],intensity:null},"MMCZ":{temp:24,conditions:[],intensity:null},"MMSD":{temp:19,conditions:[],intensity:null},"MGGT":{temp:14,conditions:[],intensity:null},"MSLP":{temp:24,conditions:[],intensity:null},"MHTG":{temp:20,conditions:[],intensity:null},"MNMG":{temp:24,conditions:[],intensity:null},"MROC":{temp:21,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:23,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:25,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:17,conditions:[],intensity:null},"SBGL":{temp:22,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:18,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null},
  "SBPA":{temp:21,conditions:[],intensity:null},"SBCT":{temp:16,conditions:[],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:16,conditions:[],intensity:null},"SAEZ":{temp:21,conditions:[],intensity:null},"SABE":{temp:20,conditions:[],intensity:null},"SACO":{temp:17,conditions:[],intensity:null},"SAME":{temp:21,conditions:[],intensity:null},"SLLP":{temp:6,conditions:["fog"],intensity:null},"SLVR":{temp:24,conditions:[],intensity:null},
  ...
  "LFRS":{temp:8,conditions:[],intensity:null},"LFSB":{temp:2,conditions:[],intensity:null},"LFPB":{temp:9,conditions:[],intensity:null},"EDDF":{temp:-3,conditions:["fog"],intensity:null},"EDDM":{temp:-1,conditions:[],intensity:null},"EDDB":{temp:-2,conditions:[],intensity:null},"EDDL":{temp:6,conditions:[],intensity:null},"EDDH":{temp:-1,conditions:[],intensity:null},"EDDK":{temp:4,conditions:[],intensity:null},"EDDS":{temp:1,conditions:[],intensity:null},
  "EDDW":{temp:1,conditions:[],intensity:null},"EDDN":{temp:-1,conditions:[],intensity:null},"EDDV":{temp:2,conditions:[],intensity:null},"EDDP":{temp:1,conditions:[],intensity:null},"LEMD":{temp:6,conditions:[],intensity:null},"LEBL":{temp:13,conditions:[],intensity:null},"LEPA":{temp:14,conditions:[],intensity:null},"LEMG":{temp:13,conditions:[],intensity:null},"LEVC":{temp:12,conditions:[],intensity:null},"LEAL":{temp:14,conditions:[],intensity:null},
  "LEZL":{temp:10,conditions:[],intensity:null},"GCLP":{temp:19,conditions:[],intensity:null},"GCTS":{temp:16,conditions:[],intensity:null},"GCLA":{temp:18,conditions:[],intensity:null},"GCFV":{temp:18,conditions:[],intensity:null},"LPPT":{temp:16,conditions:[],intensity:null},"LPPR":{temp:15,conditions:[],intensity:null},"LPFR":{temp:14,conditions:["rain"],intensity:null},"LPMA":{temp:16,conditions:[],intensity:null},"LIRF":{temp:11,conditions:[],intensity:null},
  "LIMC":{temp:4,conditions:[],intensity:null},"LIME":{temp:4,conditions:[],intensity:null},"LIPZ":{temp:3,conditions:[],intensity:null},"LIRN":{temp:10,conditions:[],intensity:null},"LIML":{temp:5,conditions:[],intensity:null},"LIPE":{temp:4,conditions:[],intensity:null},"LICC":{temp:15,conditions:[],intensity:null},"LICJ":{temp:14,conditions:[],intensity:null},"LIRA":{temp:11,conditions:[],intensity:null},"LIRP":{temp:11,conditions:[],intensity:null},
  "LIMF":{temp:4,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:13,conditions:[],intensity:null},"EHAM":{temp:5,conditions:[],intensity:null},"EHRD":{temp:6,conditions:[],intensity:null},"EHEH":{temp:5,conditions:[],intensity:null},"EBBR":{temp:7,conditions:[],intensity:null},"EBCI":{temp:7,conditions:[],intensity:null},"ELLX":{temp:2,conditions:[],intensity:null},"LSZH":{temp:-4,conditions:["fog"],intensity:null},
  "LSGG":{temp:1,conditions:["fog"],intensity:null},"LSZB":{temp:1,conditions:[],intensity:null},"LOWW":{temp:-4,conditions:[],intensity:null},"LOWS":{temp:-4,conditions:[],intensity:null},"LOWG":{temp:-6,conditions:[],intensity:null},"LOWI":{temp:5,conditions:[],intensity:null},"LKPR":{temp:-6,conditions:[],intensity:null},"EPWA":{temp:-3,conditions:[],intensity:null},"EPKK":{temp:-1,conditions:[],intensity:null},"EPGD":{temp:-6,conditions:[],intensity:null},
  "EPWR":{temp:3,conditions:[],intensity:null},"EPPO":{temp:-2,conditions:[],intensity:null},"EKCH":{temp:0,conditions:[],intensity:null},"ESSA":{temp:-1,conditions:["snow"],intensity:null},"ENGM":{temp:-2,conditions:[],intensity:null},"EFHK":{temp:-3,conditions:[],intensity:null},"BIKF":{temp:4,conditions:[],intensity:null},"ESGG":{temp:-2,conditions:[],intensity:null},"ESMS":{temp:0,conditions:[],intensity:null},"ENBR":{temp:2,conditions:[],intensity:null},
  "ENZV":{temp:5,conditions:[],intensity:null},"ENTC":{temp:-8,conditions:[],intensity:null},"EFOU":{temp:-9,conditions:[],intensity:null},"EFRO":{temp:-9,conditions:[],intensity:null},"LGAV":{temp:11,conditions:["rain"],intensity:null},"LGTS":{temp:6,conditions:[],intensity:null},"LGIR":{temp:16,conditions:[],intensity:null},"LGKR":{temp:12,conditions:[],intensity:null},"LGRP":{temp:14,conditions:[],intensity:null},"LGSR":{temp:16,conditions:[],intensity:null},
  ...
  "GMMX":{temp:11,conditions:[],intensity:null},"GMTT":{temp:13,conditions:[],intensity:null},"GMFF":{temp:12,conditions:[],intensity:null},"GMAD":{temp:14,conditions:[],intensity:null},"DAAG":{temp:13,conditions:[],intensity:null},"DAOO":{temp:14,conditions:[],intensity:null},"DTTA":{temp:14,conditions:[],intensity:null},"DTMB":{temp:13,conditions:[],intensity:null},"DTTJ":{temp:14,conditions:[],intensity:null},"HECA":{temp:20,conditions:[],intensity:null},
  "HEGN":{temp:21,conditions:[],intensity:null},"HESH":{temp:22,conditions:[],intensity:null},"HEBA":{temp:24,conditions:[],intensity:null},"HEAX":{temp:17,conditions:[],intensity:null},"HLLT":{temp:17,conditions:[],intensity:null},"DNMM":{temp:32,conditions:[],intensity:null},"DNAA":{temp:33,conditions:[],intensity:null},"DGAA":{temp:30,conditions:[],intensity:null},"DIAP":{temp:27,conditions:[],intensity:null},"GOBD":{temp:21,conditions:[],intensity:null},
  "GABS":{temp:24,conditions:[],intensity:null},"GVNP":{temp:20,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:28,conditions:[],intensity:null},"DXXX":{temp:31,conditions:[],intensity:null},"DBBB":{temp:31,conditions:[],intensity:null},"HKJK":{temp:26,conditions:[],intensity:null},"HKMO":{temp:34,conditions:[],intensity:null},"HTDA":{temp:32,conditions:[],intensity:null},"HTKJ":{temp:32,conditions:[],intensity:null},
  ...
  "RKSS":{temp:-11,conditions:[],intensity:null},"RKPK":{temp:-5,conditions:[],intensity:null},"RKPC":{temp:0,conditions:[],intensity:null},"RKTN":{temp:-9,conditions:[],intensity:null},"ZKPY":{temp:-15,conditions:[],intensity:null},"WSSS":{temp:27,conditions:[],intensity:null},"WMKK":{temp:28,conditions:[],intensity:null},"WMKP":{temp:28,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:26,conditions:[],intensity:null},
  "VTBS":{temp:31,conditions:[],intensity:null},"VTBD":{temp:30,conditions:[],intensity:null},"VTSP":{temp:29,conditions:[],intensity:null},"VTCC":{temp:28,conditions:[],intensity:null},"VTSS":{temp:27,conditions:[],intensity:null},"VTUK":{temp:27,conditions:[],intensity:null},"VVNB":{temp:13,conditions:[],intensity:null},"VVTS":{temp:27,conditions:[],intensity:null},"VVDN":{temp:19,conditions:[],intensity:null},"VVCR":{temp:23,conditions:[],intensity:null},
  ...
  "VOMM":{temp:27,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:26,conditions:[],intensity:null},"VAAH":{temp:30,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:28,conditions:[],intensity:null},"VOTP":{temp:27,conditions:[],intensity:null},"VIAR":{temp:20,conditions:[],intensity:null},"VIJP":{temp:24,conditions:[],intensity:null},"VELR":{temp:16,conditions:[],intensity:null},
  ...
  "RCKH":{temp:18,conditions:[],intensity:null},"RCNN":{temp:15,conditions:[],intensity:null},"YSSY":{temp:18,conditions:[],intensity:null},"YMML":{temp:15,conditions:[],intensity:null},"YBBN":{temp:24,conditions:[],intensity:null},"YPPH":{temp:38,conditions:[],intensity:null},"YPAD":{temp:18,conditions:[],intensity:null},"YBCG":{temp:20,conditions:[],intensity:null},"YBCS":{temp:24,conditions:[],intensity:null},"YSCB":{temp:18,conditions:[],intensity:null},
  "YMHB":{temp:12,conditions:[],intensity:null},"NZAA":{temp:22,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:16,conditions:[],intensity:null},"NZQN":{temp:15,conditions:[],intensity:null},"NZDN":{temp:14,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:30,conditions:[],intensity:null},"NTAA":{temp:27,conditions:["thunderstorm"],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
