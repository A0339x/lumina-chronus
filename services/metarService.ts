...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "VDPP":{temp:29,conditions:[],intensity:null},"VDSR":{temp:28,conditions:[],intensity:null},"VLVT":{temp:27,conditions:[],intensity:null},"VLLB":{temp:27,conditions:[],intensity:null},"VYYY":{temp:26,conditions:[],intensity:null},"VYMD":{temp:28,conditions:["thunderstorm"],intensity:null},"VGHS":{temp:28,conditions:[],intensity:null},"VGCG":{temp:28,conditions:[],intensity:null},"VECC":{temp:27,conditions:[],intensity:null},"VRMM":{temp:29,conditions:[],intensity:null},
  "VCBI":{temp:28,conditions:[],intensity:null},"WIII":{temp:29,conditions:[],intensity:null},"WADD":{temp:26,conditions:[],intensity:null},"WARR":{temp:28,conditions:[],intensity:null},"WIHH":{temp:28,conditions:[],intensity:null},"WIMM":{temp:25,conditions:[],intensity:null},"WIBB":{temp:30,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:27,conditions:[],intensity:null},"WASS":{temp:26,conditions:[],intensity:null},
  "RPLL":{temp:29,conditions:[],intensity:null},"RPLC":{temp:26,conditions:[],intensity:null},"RPVM":{temp:29,conditions:[],intensity:null},"RPVD":{temp:27,conditions:[],intensity:null},"RPVK":{temp:29,conditions:[],intensity:null},"WBSB":{temp:26,conditions:[],intensity:null},"WBLL":{temp:29,conditions:[],intensity:null},"VIDP":{temp:33,conditions:[],intensity:null},"VABB":{temp:29,conditions:[],intensity:null},"VOBL":{temp:26,conditions:[],intensity:null},
  "VOMM":{temp:32,conditions:[],intensity:null},"VEBS":{temp:27,conditions:[],intensity:null},"VOHY":{temp:29,conditions:[],intensity:null},"VAAH":{temp:34,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:26,conditions:[],intensity:null},"VOTP":{temp:29,conditions:[],intensity:null},"VIAR":{temp:33,conditions:[],intensity:null},"VIJP":{temp:31,conditions:[],intensity:null},"VELR":{temp:22,conditions:[],intensity:null},
  "VOCL":{temp:28,conditions:[],intensity:null},"VOTV":{temp:28,conditions:[],intensity:null},"VEPT":{temp:28,conditions:[],intensity:null},"VNKT":{temp:22,conditions:["thunderstorm"],intensity:null},"OPKC":{temp:29,conditions:[],intensity:null},"OPLA":{temp:34,conditions:[],intensity:null},"OPIS":{temp:30,conditions:[],intensity:null},"RCTP":{temp:26,conditions:[],intensity:null},"RCSS":{temp:27,conditions:[],intensity:null},"RCMQ":{temp:25,conditions:[],intensity:null},
  "RCKH":{temp:25,conditions:[],intensity:null},"RCNN":{temp:25,conditions:[],intensity:null},"YSSY":{temp:18,conditions:[],intensity:null},"YMML":{temp:15,conditions:[],intensity:null},"YBBN":{temp:17,conditions:[],intensity:null},"YPPH":{temp:12,conditions:[],intensity:null},"YPAD":{temp:14,conditions:[],intensity:null},"YBCG":{temp:15,conditions:[],intensity:null},"YBCS":{temp:20,conditions:[],intensity:null},"YSCB":{temp:11,conditions:[],intensity:null},
  "YMHB":{temp:12,conditions:[],intensity:null},"NZAA":{temp:13,conditions:[],intensity:null},"NZWN":{temp:12,conditions:[],intensity:null},"NZCH":{temp:9,conditions:[],intensity:null},"NZQN":{temp:6,conditions:[],intensity:null},"NZDN":{temp:11,conditions:[],intensity:null},"NFFN":{temp:21,conditions:[],intensity:null},"NWWW":{temp:15,conditions:[],intensity:null},"NTAA":{temp:20,conditions:[],intensity:null},"NSFA":{temp:24,conditions:[],intensity:null},
  "NIUE":{temp:23,conditions:[],intensity:null},"PGSN":{temp:26,conditions:[],intensity:null},"PGUM":{temp:26,conditions:[],intensity:null},"PHOG":{temp:26,conditions:[],intensity:null},"PHKO":{temp:24,conditions:[],intensity:null},"PHLH":{temp:24,conditions:[],intensity:null}
};
