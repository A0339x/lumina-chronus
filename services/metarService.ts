...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LIMF":{temp:2,conditions:[],intensity:null},"LIEO":{temp:7,conditions:[],intensity:null},"LIEE":{temp:8,conditions:[],intensity:null},"EHAM":{temp:1,conditions:[],intensity:null},"EHRD":{temp:2,conditions:[],intensity:null},"EHEH":{temp:1,conditions:[],intensity:null},"EBBR":{temp:1,conditions:[],intensity:null},"EBCI":{temp:1,conditions:[],intensity:null},"ELLX":{temp:3,conditions:[],intensity:null},"LSZH":{temp:1,conditions:[],intensity:null},
  ...
  "EPWR":{temp:1,conditions:[],intensity:null},"EPPO":{temp:0,conditions:["fog"],intensity:null},"EKCH":{temp:0,conditions:["snow"],intensity:null},"ESSA":{temp:-5,conditions:[],intensity:null},"ENGM":{temp:-9,conditions:[],intensity:null},"EFHK":{temp:-8,conditions:[],intensity:null},"BIKF":{temp:4,conditions:[],intensity:null},"ESGG":{temp:-3,conditions:[],intensity:null},"ESMS":{temp:0,conditions:["snow"],intensity:null},"ENBR":{temp:-7,conditions:[],intensity:null},
  ...
  "LATI":{temp:8,conditions:[],intensity:null},"UKBB":{temp:-5,conditions:["freezing"],intensity:null},"UKLL":{temp:1,conditions:[],intensity:null},"UUEE":{temp:-11,conditions:[],intensity:null},"UUDD":{temp:-12,conditions:[],intensity:null},"UUWW":{temp:-11,conditions:[],intensity:null},"ULLI":{temp:-15,conditions:[],intensity:null},"UWWW":{temp:-25,conditions:[],intensity:null},"USSS":{temp:-21,conditions:[],intensity:null},"UNNT":{temp:-22,conditions:[],intensity:null},
