...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:15,conditions:["fog"],intensity:null},"KLAX":{temp:11,conditions:[],intensity:null},"KORD":{temp:3,conditions:[],intensity:null},"KDFW":{temp:9,conditions:[],intensity:null},"KDEN":{temp:4,conditions:[],intensity:null},"KJFK":{temp:4,conditions:["fog"],intensity:null},"KSFO":{temp:9,conditions:[],intensity:null},"KSEA":{temp:4,conditions:[],intensity:null},"KLAS":{temp:7,conditions:[],intensity:null},"KMCO":{temp:15,conditions:[],intensity:null},
  "KEWR":{temp:3,conditions:["fog"],intensity:null},"KMIA":{temp:18,conditions:[],intensity:null},"KPHX":{temp:13,conditions:[],intensity:null},"KIAH":{temp:19,conditions:[],intensity:null},"KBOS":{temp:2,conditions:[],intensity:null},"KMSP":{temp:-4,conditions:[],intensity:null},"KFLL":{temp:16,conditions:[],intensity:null},"KDTW":{temp:3,conditions:[],intensity:null},"KPHL":{temp:5,conditions:[],intensity:null},"KLGA":{temp:3,conditions:["fog"],intensity:null},
  "KBWI":{temp:2,conditions:[],intensity:null},"KSLC":{temp:1,conditions:[],intensity:null},"KDCA":{temp:3,conditions:[],intensity:null},"KIAD":{temp:2,conditions:[],intensity:null},"KSAN":{temp:12,conditions:[],intensity:null},"KTPA":{temp:16,conditions:[],intensity:null},"KPDX":{temp:7,conditions:[],intensity:null},"KSTL":{temp:4,conditions:[],intensity:null},"KHNL":{temp:24,conditions:[],intensity:null},"KMEM":{temp:11,conditions:[],intensity:null},
  ...
  "LIMF":{temp:-4,conditions:[],intensity:null},"LIEO":{temp:6,conditions:[],intensity:null},"LIEE":{temp:8,conditions:[],intensity:null},"EHAM":{temp:0,conditions:["snow"],intensity:null},"EHRD":{temp:0,conditions:["snow"],intensity:null},"EHEH":{temp:-1,conditions:["snow"],intensity:null},"EBBR":{temp:0,conditions:["snow"],intensity:null},"EBCI":{temp:-2,conditions:[],intensity:null},"ELLX":{temp:-6,conditions:[],intensity:null},"LSZH":{temp:-6,conditions:[],intensity:null},
  "LSGG":{temp:-6,conditions:[],intensity:null},"LSZB":{temp:-8,conditions:[],intensity:null},"LOWW":{temp:-3,conditions:[],intensity:null},"LOWS":{temp:-8,conditions:[],intensity:null},"LOWG":{temp:-4,conditions:[],intensity:null},"LOWI":{temp:-9,conditions:[],intensity:null},"LKPR":{temp:-6,conditions:[],intensity:null},"EPWA":{temp:-6,conditions:[],intensity:null},"EPKK":{temp:-4,conditions:[],intensity:null},"EPGD":{temp:-6,conditions:[],intensity:null},
  "EPWR":{temp:-4,conditions:[],intensity:null},"EPPO":{temp:-5,conditions:[],intensity:null},"EKCH":{temp:1,conditions:[],intensity:null},"ESSA":{temp:-5,conditions:[],intensity:null},"ENGM":{temp:-10,conditions:[],intensity:null},"EFHK":{temp:-7,conditions:[],intensity:null},"BIKF":{temp:-1,conditions:[],intensity:null},"ESGG":{temp:-3,conditions:["snow"],intensity:null},"ESMS":{temp:0,conditions:[],intensity:null},"ENBR":{temp:-10,conditions:[],intensity:null},
  "ENZV":{temp:-3,conditions:[],intensity:null},"ENTC":{temp:-12,conditions:[],intensity:null},"EFOU":{temp:-17,conditions:[],intensity:null},"EFRO":{temp:-26,conditions:[],intensity:null},"LGAV":{temp:18,conditions:[],intensity:null},"LGTS":{temp:17,conditions:[],intensity:null},"LGIR":{temp:20,conditions:[],intensity:null},"LGKR":{temp:15,conditions:["thunderstorm"],intensity:null},"LGRP":{temp:19,conditions:[],intensity:null},"LGSR":{temp:20,conditions:[],intensity:null},
  "LGMK":{temp:19,conditions:[],intensity:null},"LTFM":{temp:16,conditions:[],intensity:null},"LTBA":{temp:15,conditions:[],intensity:null},"LTFJ":{temp:15,conditions:[],intensity:null},"LTAI":{temp:16,conditions:[],intensity:null},"LTAC":{temp:5,conditions:[],intensity:null},"LTBJ":{temp:17,conditions:[],intensity:null},"LTBS":{temp:18,conditions:[],intensity:null},"LTFE":{temp:19,conditions:[],intensity:null},"LCLK":{temp:18,conditions:[],intensity:null},
  "LCPH":{temp:19,conditions:[],intensity:null},"LHBP":{temp:-2,conditions:[],intensity:null},"LROP":{temp:4,conditions:["fog"],intensity:null},"LBSF":{temp:8,conditions:[],intensity:null},"LYBE":{temp:-2,conditions:[],intensity:null},"LDZA":{temp:-2,conditions:[],intensity:null},"LDDU":{temp:11,conditions:[],intensity:null},"LDSP":{temp:7,conditions:[],intensity:null},"LJLJ":{temp:-5,conditions:["fog"],intensity:null},"LWSK":{temp:9,conditions:[],intensity:null},
  ...
  "OEDF":{temp:18,conditions:[],intensity:null},"OEMA":{temp:23,conditions:[],intensity:null},"OKBK":{temp:17,conditions:[],intensity:null},"OBBI":{temp:18,conditions:[],intensity:null},"OOMS":{temp:25,conditions:[],intensity:null},"OYAA":{temp:17,conditions:[],intensity:null},"OIIE":{temp:9,conditions:[],intensity:null},"OIII":{temp:9,conditions:[],intensity:null},"OISS":{temp:11,conditions:[],intensity:null},"OIKB":{temp:22,conditions:[],intensity:null},
  "OIAW":{temp:16,conditions:[],intensity:null},"OIKK":{temp:8,conditions:[],intensity:null},"OICC":{temp:9,conditions:[],intensity:null},"LLBG":{temp:20,conditions:[],intensity:null},"OLBA":{temp:21,conditions:[],intensity:null},"OJAM":{temp:14,conditions:[],intensity:null},"ORBI":{temp:15,conditions:[],intensity:null},"ORER":{temp:11,conditions:[],intensity:null},"GMMN":{temp:7,conditions:[],intensity:null},"GMME":{temp:9,conditions:[],intensity:null},
  "GMMX":{temp:5,conditions:[],intensity:null},"GMTT":{temp:8,conditions:[],intensity:null},"GMFF":{temp:6,conditions:[],intensity:null},"GMAD":{temp:6,conditions:[],intensity:null},"DAAG":{temp:8,conditions:[],intensity:null},"DAOO":{temp:6,conditions:[],intensity:null},"DTTA":{temp:11,conditions:[],intensity:null},"DTMB":{temp:11,conditions:[],intensity:null},"DTTJ":{temp:14,conditions:[],intensity:null},"HECA":{temp:19,conditions:[],intensity:null},
  "HEGN":{temp:22,conditions:[],intensity:null},"HESH":{temp:25,conditions:[],intensity:null},"HEBA":{temp:21,conditions:[],intensity:null},"HEAX":{temp:18,conditions:[],intensity:null},"HLLT":{temp:20,conditions:[],intensity:null},"DNMM":{temp:30,conditions:[],intensity:null},"DNAA":{temp:28,conditions:[],intensity:null},"DGAA":{temp:28,conditions:[],intensity:null},"DIAP":{temp:28,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  "GABS":{temp:22,conditions:[],intensity:null},"GVNP":{temp:19,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:26,conditions:[],intensity:null},"DXXX":{temp:30,conditions:[],intensity:null},"DBBB":{temp:30,conditions:[],intensity:null},"HKJK":{temp:23,conditions:[],intensity:null},"HKMO":{temp:34,conditions:[],intensity:null},"HTDA":{temp:31,conditions:[],intensity:null},"HTKJ":{temp:30,conditions:[],intensity:null},
  "HUEN":{temp:28,conditions:[],intensity:null},"HRYR":{temp:24,conditions:[],intensity:null},"HAAB":{temp:20,conditions:[],intensity:null},"HDAM":{temp:28,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:33,conditions:[],intensity:null},"FIMP":{temp:28,conditions:[],intensity:null},"FMCH":{temp:30,conditions:[],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  "FSIA":{temp:27,conditions:[],intensity:null},"FKKD":{temp:28,conditions:[],intensity:null},"FKYS":{temp:26,conditions:[],intensity:null},"FOOL":{temp:28,conditions:[],intensity:null},"FZAA":{temp:28,conditions:[],intensity:null},"FCBB":{temp:27,conditions:[],intensity:null},"FLLK":{temp:28,conditions:[],intensity:null},"FVHA":{temp:26,conditions:[],intensity:null},"FLLS":{temp:28,conditions:[],intensity:null},"FYWH":{temp:27,conditions:[],intensity:null},
  "FBSK":{temp:32,conditions:[],intensity:null},"FAOR":{temp:26,conditions:[],intensity:null},"FACT":{temp:23,conditions:[],intensity:null},"FALE":{temp:25,conditions:[],intensity:null},"FAPE":{temp:25,conditions:[],intensity:null},"FQMA":{temp:35,conditions:[],intensity:null},"FWKI":{temp:25,conditions:[],intensity:null},"ZBAA":{temp:1,conditions:[],intensity:null},"ZBAD":{temp:3,conditions:[],intensity:null},"ZSPD":{temp:8,conditions:[],intensity:null},
  "ZSSS":{temp:8,conditions:[],intensity:null},"ZGGG":{temp:14,conditions:[],intensity:null},"VHHH":{temp:16,conditions:[],intensity:null},"ZGSZ":{temp:16,conditions:[],intensity:null},"ZUUU":{temp:12,conditions:[],intensity:null},"ZUCK":{temp:11,conditions:[],intensity:null},"ZHCC":{temp:8,conditions:[],intensity:null},"ZLXY":{temp:8,conditions:[],intensity:null},"ZWSH":{temp:-11,conditions:[],intensity:null},"ZYHB":{temp:-16,conditions:[],intensity:null},
  "ZYTX":{temp:-8,conditions:[],intensity:null},"ZSAM":{temp:15,conditions:[],intensity:null},"ZGKL":{temp:12,conditions:[],intensity:null},"ZSNJ":{temp:7,conditions:[],intensity:null},"ZSHC":{temp:10,conditions:[],intensity:null},"ZPPP":{temp:8,conditions:[],intensity:null},"ZBTJ":{temp:2,conditions:[],intensity:null},"VMMC":{temp:15,conditions:[],intensity:null},"RJTT":{temp:6,conditions:[],intensity:null},"RJAA":{temp:4,conditions:[],intensity:null},
  "RJBB":{temp:11,conditions:[],intensity:null},"RJOO":{temp:7,conditions:[],intensity:null},"RJCC":{temp:4,conditions:[],intensity:null},"RJFF":{temp:9,conditions:[],intensity:null},"RJGG":{temp:9,conditions:[],intensity:null},"ROAH":{temp:16,conditions:[],intensity:null},"RJSS":{temp:6,conditions:[],intensity:null},"RJSN":{temp:6,conditions:[],intensity:null},"RJOK":{temp:9,conditions:[],intensity:null},"RKSI":{temp:0,conditions:[],intensity:null},
  "RKSS":{temp:-2,conditions:[],intensity:null},"RKPK":{temp:5,conditions:[],intensity:null},"RKPC":{temp:7,conditions:[],intensity:null},"RKTN":{temp:1,conditions:[],intensity:null},"ZKPY":{temp:-6,conditions:[],intensity:null},"WSSS":{temp:26,conditions:[],intensity:null},"WMKK":{temp:28,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:27,conditions:["thunderstorm"],intensity:null},"WBGG":{temp:29,conditions:[],intensity:null},
  "VTBS":{temp:30,conditions:[],intensity:null},"VTBD":{temp:29,conditions:[],intensity:null},"VTSP":{temp:29,conditions:[],intensity:null},"VTCC":{temp:27,conditions:[],intensity:null},"VTSS":{temp:27,conditions:[],intensity:null},"VTUK":{temp:29,conditions:[],intensity:null},"VVNB":{temp:18,conditions:[],intensity:null},"VVTS":{temp:28,conditions:[],intensity:null},"VVDN":{temp:17,conditions:[],intensity:null},"VVCR":{temp:24,conditions:[],intensity:null},
  ...
  "VCBI":{temp:29,conditions:[],intensity:null},"WIII":{temp:31,conditions:[],intensity:null},"WADD":{temp:28,conditions:[],intensity:null},"WARR":{temp:33,conditions:[],intensity:null},"WIHH":{temp:30,conditions:[],intensity:null},"WIMM":{temp:29,conditions:[],intensity:null},"WIBB":{temp:26,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:27,conditions:[],intensity:null},"WASS":{temp:29,conditions:[],intensity:null},
  ...
  "VOMM":{temp:27,conditions:[],intensity:null},"VEBS":{temp:20,conditions:[],intensity:null},"VOHY":{temp:26,conditions:[],intensity:null},"VAAH":{temp:26,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:34,conditions:[],intensity:null},"VOTP":{temp:27,conditions:[],intensity:null},"VIAR":{temp:15,conditions:[],intensity:null},"VIJP":{temp:18,conditions:[],intensity:null},"VELR":{temp:16,conditions:[],intensity:null},
  ...
  "RCKH":{temp:18,conditions:[],intensity:null},"RCNN":{temp:16,conditions:[],intensity:null},"YSSY":{temp:24,conditions:[],intensity:null},"YMML":{temp:35,conditions:[],intensity:null},"YBBN":{temp:25,conditions:[],intensity:null},"YPPH":{temp:26,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:22,conditions:[],intensity:null},"YBCS":{temp:25,conditions:[],intensity:null},"YSCB":{temp:34,conditions:[],intensity:null},
  "YMHB":{temp:17,conditions:[],intensity:null},"NZAA":{temp:20,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:16,conditions:[],intensity:null},"NZQN":{temp:16,conditions:[],intensity:null},"NZDN":{temp:15,conditions:[],intensity:null},"NFFN":{temp:29,conditions:[],intensity:null},"NWWW":{temp:28,conditions:[],intensity:null},"NTAA":{temp:26,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
