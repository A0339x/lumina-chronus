...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EDDW":{temp:23,conditions:[],intensity:null},"EDDN":{temp:35,conditions:[],intensity:null},"EDDV":{temp:26,conditions:[],intensity:null},"EDDP":{temp:34,conditions:[],intensity:null},"LEMD":{temp:31,conditions:[],intensity:null},"LEBL":{temp:31,conditions:[],intensity:null},"LEPA":{temp:33,conditions:[],intensity:null},"LEMG":{temp:31,conditions:[],intensity:null},"LEVC":{temp:32,conditions:[],intensity:null},"LEAL":{temp:32,conditions:[],intensity:null},
  "LEZL":{temp:35,conditions:[],intensity:null},"GCLP":{temp:28,conditions:[],intensity:null},"GCTS":{temp:28,conditions:[],intensity:null},"GCLA":{temp:28,conditions:[],intensity:null},"GCFV":{temp:28,conditions:[],intensity:null},"LPPT":{temp:26,conditions:[],intensity:null},"LPPR":{temp:25,conditions:[],intensity:null},"LPFR":{temp:25,conditions:[],intensity:null},"LPMA":{temp:25,conditions:[],intensity:null},"LIRF":{temp:31,conditions:[],intensity:null},
  ...
  "LIMF":{temp:31,conditions:[],intensity:null},"LIEO":{temp:32,conditions:[],intensity:null},"LIEE":{temp:32,conditions:[],intensity:null},"EHAM":{temp:27,conditions:[],intensity:null},"EHRD":{temp:26,conditions:[],intensity:null},"EHEH":{temp:28,conditions:[],intensity:null},"EBBR":{temp:30,conditions:[],intensity:null},"EBCI":{temp:31,conditions:[],intensity:null},"ELLX":{temp:34,conditions:[],intensity:null},"LSZH":{temp:35,conditions:[],intensity:null},
  ...
  "LGMK":{temp:24,conditions:[],intensity:null},"LTFM":{temp:23,conditions:[],intensity:null},"LTBA":{temp:25,conditions:[],intensity:null},"LTFJ":{temp:24,conditions:[],intensity:null},"LTAI":{temp:30,conditions:[],intensity:null},"LTAC":{temp:24,conditions:[],intensity:null},"LTBJ":{temp:31,conditions:[],intensity:null},"LTBS":{temp:29,conditions:[],intensity:null},"LTFE":{temp:30,conditions:[],intensity:null},"LCLK":{temp:30,conditions:[],intensity:null},
  "LCPH":{temp:28,conditions:[],intensity:null},"LHBP":{temp:33,conditions:[],intensity:null},"LROP":{temp:27,conditions:[],intensity:null},"LBSF":{temp:26,conditions:[],intensity:null},"LYBE":{temp:31,conditions:[],intensity:null},"LDZA":{temp:32,conditions:[],intensity:null},"LDDU":{temp:28,conditions:[],intensity:null},"LDSP":{temp:31,conditions:[],intensity:null},"LJLJ":{temp:33,conditions:[],intensity:null},"LWSK":{temp:31,conditions:[],intensity:null},
  "LATI":{temp:31,conditions:[],intensity:null},"UKBB":{temp:26,conditions:[],intensity:null},"UKLL":{temp:29,conditions:[],intensity:null},"UUEE":{temp:17,conditions:[],intensity:null},"UUDD":{temp:18,conditions:[],intensity:null},"UUWW":{temp:17,conditions:[],intensity:null},"ULLI":{temp:17,conditions:[],intensity:null},"UWWW":{temp:13,conditions:[],intensity:null},"USSS":{temp:13,conditions:[],intensity:null},"UNNT":{temp:19,conditions:[],intensity:null},
  ...
  "OIAW":{temp:43,conditions:[],intensity:null},"OIKK":{temp:30,conditions:[],intensity:null},"OICC":{temp:33,conditions:[],intensity:null},"LLBG":{temp:30,conditions:[],intensity:null},"OLBA":{temp:30,conditions:[],intensity:null},"OJAM":{temp:30,conditions:[],intensity:null},"ORBI":{temp:43,conditions:[],intensity:null},"ORER":{temp:38,conditions:[],intensity:null},"GMMN":{temp:27,conditions:[],intensity:null},"GMME":{temp:27,conditions:[],intensity:null},
  "GMMX":{temp:36,conditions:[],intensity:null},"GMTT":{temp:26,conditions:[],intensity:null},"GMFF":{temp:33,conditions:[],intensity:null},"GMAD":{temp:26,conditions:[],intensity:null},"DAAG":{temp:31,conditions:[],intensity:null},"DAOO":{temp:31,conditions:[],intensity:null},"DTTA":{temp:31,conditions:[],intensity:null},"DTMB":{temp:32,conditions:[],intensity:null},"DTTJ":{temp:33,conditions:[],intensity:null},"HECA":{temp:37,conditions:[],intensity:null},
