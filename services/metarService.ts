...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:11,conditions:[],intensity:null},"KLAX":{temp:14,conditions:[],intensity:null},"KORD":{temp:-1,conditions:[],intensity:null},"KDFW":{temp:11,conditions:[],intensity:null},"KDEN":{temp:-1,conditions:[],intensity:null},"KJFK":{temp:9,conditions:[],intensity:null},"KSFO":{temp:11,conditions:[],intensity:null},"KSEA":{temp:7,conditions:[],intensity:null},"KLAS":{temp:15,conditions:[],intensity:null},"KMCO":{temp:18,conditions:[],intensity:null},
  "KEWR":{temp:9,conditions:[],intensity:null},"KMIA":{temp:21,conditions:[],intensity:null},"KPHX":{temp:18,conditions:[],intensity:null},"KIAH":{temp:10,conditions:[],intensity:null},"KBOS":{temp:2,conditions:[],intensity:null},"KMSP":{temp:-7,conditions:[],intensity:null},"KFLL":{temp:22,conditions:[],intensity:null},"KDTW":{temp:-4,conditions:[],intensity:null},"KPHL":{temp:9,conditions:[],intensity:null},"KLGA":{temp:9,conditions:[],intensity:null},
  "KBWI":{temp:9,conditions:[],intensity:null},"KSLC":{temp:6,conditions:[],intensity:null},"KDCA":{temp:10,conditions:[],intensity:null},"KIAD":{temp:8,conditions:[],intensity:null},"KSAN":{temp:16,conditions:[],intensity:null},"KTPA":{temp:17,conditions:[],intensity:null},"KPDX":{temp:8,conditions:[],intensity:null},"KSTL":{temp:5,conditions:[],intensity:null},"KHNL":{temp:23,conditions:[],intensity:null},"KMEM":{temp:9,conditions:[],intensity:null},
  "KAUS":{temp:9,conditions:[],intensity:null},"KBNA":{temp:8,conditions:[],intensity:null},"KRDU":{temp:9,conditions:[],intensity:null},"KCLT":{temp:10,conditions:[],intensity:null},"KSMF":{temp:9,conditions:[],intensity:null},"KSJC":{temp:11,conditions:[],intensity:null},"KOAK":{temp:12,conditions:[],intensity:null},"KCLE":{temp:-3,conditions:[],intensity:null},"KMKE":{temp:-2,conditions:[],intensity:null},"KPIT":{temp:-1,conditions:[],intensity:null},
  "KIND":{temp:1,conditions:[],intensity:null},"KCVG":{temp:3,conditions:[],intensity:null},"KMCI":{temp:4,conditions:[],intensity:null},"KSAT":{temp:9,conditions:[],intensity:null},"KHOU":{temp:12,conditions:[],intensity:null},"KDAL":{temp:10,conditions:[],intensity:null},"KMDW":{temp:-1,conditions:[],intensity:null},"PANC":{temp:1,conditions:[],intensity:null},"PAFA":{temp:-3,conditions:[],intensity:null},"CYYZ":{temp:-5,conditions:[],intensity:null},
  "CYVR":{temp:5,conditions:[],intensity:null},"CYUL":{temp:-4,conditions:[],intensity:null},"CYYC":{temp:0,conditions:[],intensity:null},"CYEG":{temp:-1,conditions:["snow"],intensity:null},"CYOW":{temp:-3,conditions:[],intensity:null},"CYWG":{temp:-8,conditions:[],intensity:null},"CYHZ":{temp:0,conditions:[],intensity:null},"CYQB":{temp:-8,conditions:[],intensity:null},"CYYJ":{temp:4,conditions:[],intensity:null},"CYLW":{temp:6,conditions:[],intensity:null},
  "CYXE":{temp:-3,conditions:[],intensity:null},"CYQR":{temp:-3,conditions:[],intensity:null},"CYZF":{temp:-14,conditions:[],intensity:null},"CYXY":{temp:-3,conditions:[],intensity:null},"CYQT":{temp:-15,conditions:[],intensity:null},"CYYT":{temp:1,conditions:[],intensity:null},"MMMX":{temp:10,conditions:["fog"],intensity:null},"MMUN":{temp:21,conditions:[],intensity:null},"MMGL":{temp:16,conditions:[],intensity:null},"MMMY":{temp:13,conditions:[],intensity:null},
  "MMTJ":{temp:15,conditions:[],intensity:null},"MMSM":{temp:26,conditions:[],intensity:null},"MMMD":{temp:22,conditions:["fog"],intensity:null},"MMCZ":{temp:24,conditions:[],intensity:null},"MMSD":{temp:24,conditions:[],intensity:null},"MGGT":{temp:17,conditions:[],intensity:null},"MSLP":{temp:25,conditions:[],intensity:null},"MHTG":{temp:22,conditions:[],intensity:null},"MNMG":{temp:25,conditions:[],intensity:null},"MROC":{temp:22,conditions:[],intensity:null},
  "MPTO":{temp:27,conditions:[],intensity:null},"MKJP":{temp:24,conditions:[],intensity:null},"TNCM":{temp:27,conditions:[],intensity:null},"TBPB":{temp:27,conditions:[],intensity:null},"TTPP":{temp:29,conditions:[],intensity:null},"MWCR":{temp:26,conditions:[],intensity:null},"MUHA":{temp:22,conditions:["fog"],intensity:null},"MDSD":{temp:25,conditions:[],intensity:null},"MDPP":{temp:26,conditions:[],intensity:null},"MTPP":{temp:27,conditions:[],intensity:null},
  "TJSJ":{temp:26,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:28,conditions:[],intensity:null},"TAPA":{temp:27,conditions:[],intensity:null},"SBGR":{temp:25,conditions:[],intensity:null},"SBGL":{temp:29,conditions:[],intensity:null},"SBBR":{temp:24,conditions:[],intensity:null},"SBCF":{temp:24,conditions:[],intensity:null},"SBSV":{temp:27,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null}
};
