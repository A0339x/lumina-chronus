...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "ENZV":{temp:-8,conditions:[],intensity:null},"ENTC":{temp:-11,conditions:[],intensity:null},"EFOU":{temp:-20,conditions:[],intensity:null},"EFRO":{temp:-24,conditions:[],intensity:null},"LGAV":{temp:17,conditions:[],intensity:null},"LGTS":{temp:16,conditions:[],intensity:null},"LGIR":{temp:18,conditions:[],intensity:null},"LGKR":{temp:12,conditions:[],intensity:null},"LGRP":{temp:17,conditions:[],intensity:null},"LGSR":{temp:19,conditions:[],intensity:null},
