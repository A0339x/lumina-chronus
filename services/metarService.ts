...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "TJSJ":{temp:24,conditions:[],intensity:null},"TIST":{temp:25,conditions:["thunderstorm"],intensity:null},"TLPL":{temp:25,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:22,conditions:["fog"],intensity:null},"SBGL":{temp:27,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:22,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:25,conditions:[],intensity:null},
  "SBPA":{temp:23,conditions:[],intensity:null},"SBCT":{temp:18,conditions:["fog"],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:14,conditions:[],intensity:null},"SAEZ":{temp:19,conditions:[],intensity:null},"SABE":{temp:21,conditions:[],intensity:null},"SACO":{temp:16,conditions:["fog"],intensity:null},"SAME":{temp:15,conditions:[],intensity:null},"SLLP":{temp:1,conditions:["fog"],intensity:null},"SLVR":{temp:23,conditions:[],intensity:null},
  "SPJC":{temp:21,conditions:[],intensity:null},"SEQM":{temp:11,conditions:[],intensity:null},"SEGU":{temp:24,conditions:["thunderstorm"],intensity:null},"SKBO":{temp:12,conditions:[],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:23,conditions:[],intensity:null},"SKRG":{temp:13,conditions:["fog"],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:19,conditions:[],intensity:null},
  ...
  "EIDW":{temp:9,conditions:[],intensity:null},"EICK":{temp:10,conditions:[],intensity:null},"EINN":{temp:10,conditions:[],intensity:null},"LFPG":{temp:13,conditions:[],intensity:null},"LFPO":{temp:14,conditions:[],intensity:null},"LFML":{temp:16,conditions:[],intensity:null},"LFLL":{temp:15,conditions:[],intensity:null},"LFMN":{temp:15,conditions:[],intensity:null},"LFBD":{temp:16,conditions:[],intensity:null},"LFBO":{temp:16,conditions:[],intensity:null},
  "LFRS":{temp:13,conditions:[],intensity:null},"LFSB":{temp:12,conditions:[],intensity:null},"LFPB":{temp:13,conditions:[],intensity:null},"EDDF":{temp:14,conditions:[],intensity:null},"EDDM":{temp:12,conditions:[],intensity:null},"EDDB":{temp:13,conditions:[],intensity:null},"EDDL":{temp:15,conditions:[],intensity:null},"EDDH":{temp:12,conditions:[],intensity:null},"EDDK":{temp:15,conditions:[],intensity:null},"EDDS":{temp:13,conditions:[],intensity:null},
  "EDDW":{temp:13,conditions:[],intensity:null},"EDDN":{temp:11,conditions:[],intensity:null},"EDDV":{temp:13,conditions:[],intensity:null},"EDDP":{temp:13,conditions:[],intensity:null},"LEMD":{temp:9,conditions:[],intensity:null},"LEBL":{temp:13,conditions:[],intensity:null},"LEPA":{temp:12,conditions:["rain"],intensity:null},"LEMG":{temp:12,conditions:[],intensity:null},"LEVC":{temp:13,conditions:[],intensity:null},"LEAL":{temp:13,conditions:[],intensity:null},
  "LEZL":{temp:13,conditions:[],intensity:null},"GCLP":{temp:17,conditions:[],intensity:null},"GCTS":{temp:17,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:17,conditions:[],intensity:null},"LPPT":{temp:13,conditions:[],intensity:null},"LPPR":{temp:12,conditions:[],intensity:null},"LPFR":{temp:14,conditions:[],intensity:null},"LPMA":{temp:13,conditions:[],intensity:null},"LIRF":{temp:15,conditions:[],intensity:null},
  "LIMC":{temp:14,conditions:[],intensity:null},"LIME":{temp:14,conditions:[],intensity:null},"LIPZ":{temp:12,conditions:[],intensity:null},"LIRN":{temp:15,conditions:[],intensity:null},"LIML":{temp:13,conditions:[],intensity:null},"LIPE":{temp:13,conditions:[],intensity:null},"LICC":{temp:16,conditions:[],intensity:null},"LICJ":{temp:17,conditions:[],intensity:null},"LIRA":{temp:15,conditions:[],intensity:null},"LIRP":{temp:15,conditions:[],intensity:null},
  "LIMF":{temp:13,conditions:[],intensity:null},"LIEO":{temp:14,conditions:[],intensity:null},"LIEE":{temp:16,conditions:[],intensity:null},"EHAM":{temp:9,conditions:[],intensity:null},"EHRD":{temp:9,conditions:[],intensity:null},"EHEH":{temp:13,conditions:[],intensity:null},"EBBR":{temp:12,conditions:[],intensity:null},"EBCI":{temp:12,conditions:[],intensity:null},"ELLX":{temp:14,conditions:[],intensity:null},"LSZH":{temp:11,conditions:[],intensity:null},
  "LSGG":{temp:13,conditions:[],intensity:null},"LSZB":{temp:13,conditions:[],intensity:null},"LOWW":{temp:14,conditions:[],intensity:null},"LOWS":{temp:12,conditions:[],intensity:null},"LOWG":{temp:12,conditions:[],intensity:null},"LOWI":{temp:13,conditions:[],intensity:null},"LKPR":{temp:11,conditions:[],intensity:null},"EPWA":{temp:10,conditions:[],intensity:null},"EPKK":{temp:9,conditions:[],intensity:null},"EPGD":{temp:12,conditions:[],intensity:null},
  "EPWR":{temp:13,conditions:[],intensity:null},"EPPO":{temp:12,conditions:[],intensity:null},"EKCH":{temp:6,conditions:[],intensity:null},"ESSA":{temp:5,conditions:[],intensity:null},"ENGM":{temp:3,conditions:[],intensity:null},"EFHK":{temp:5,conditions:[],intensity:null},"BIKF":{temp:3,conditions:[],intensity:null},"ESGG":{temp:3,conditions:[],intensity:null},"ESMS":{temp:7,conditions:[],intensity:null},"ENBR":{temp:6,conditions:[],intensity:null},
  "ENZV":{temp:5,conditions:[],intensity:null},"ENTC":{temp:3,conditions:[],intensity:null},"EFOU":{temp:2,conditions:[],intensity:null},"EFRO":{temp:-1,conditions:[],intensity:null},"LGAV":{temp:16,conditions:[],intensity:null},"LGTS":{temp:16,conditions:[],intensity:null},"LGIR":{temp:17,conditions:[],intensity:null},"LGKR":{temp:18,conditions:[],intensity:null},"LGRP":{temp:18,conditions:[],intensity:null},"LGSR":{temp:17,conditions:[],intensity:null},
  ...
  "LCPH":{temp:18,conditions:[],intensity:null},"LHBP":{temp:13,conditions:[],intensity:null},"LROP":{temp:11,conditions:[],intensity:null},"LBSF":{temp:13,conditions:[],intensity:null},"LYBE":{temp:15,conditions:[],intensity:null},"LDZA":{temp:15,conditions:[],intensity:null},"LDDU":{temp:15,conditions:[],intensity:null},"LDSP":{temp:15,conditions:[],intensity:null},"LJLJ":{temp:13,conditions:[],intensity:null},"LWSK":{temp:15,conditions:[],intensity:null},
  "LATI":{temp:18,conditions:[],intensity:null},"UKBB":{temp:5,conditions:[],intensity:null},"UKLL":{temp:9,conditions:[],intensity:null},"UUEE":{temp:1,conditions:[],intensity:null},"UUDD":{temp:1,conditions:[],intensity:null},"UUWW":{temp:1,conditions:[],intensity:null},"ULLI":{temp:4,conditions:[],intensity:null},"UWWW":{temp:-7,conditions:[],intensity:null},"USSS":{temp:-7,conditions:[],intensity:null},"UNNT":{temp:-3,conditions:[],intensity:null},
  "UUOB":{temp:-1,conditions:[],intensity:null},"UHWW":{temp:-3,conditions:[],intensity:null},"UEEE":{temp:-19,conditions:[],intensity:null},"OMDB":{temp:24,conditions:[],intensity:null},"OMDW":{temp:26,conditions:[],intensity:null},"OMAA":{temp:26,conditions:[],intensity:null},"OMSJ":{temp:26,conditions:[],intensity:null},"OTHH":{temp:27,conditions:[],intensity:null},"OERK":{temp:23,conditions:[],intensity:null},"OEJN":{temp:26,conditions:[],intensity:null},
  ...
  "OIAW":{temp:23,conditions:[],intensity:null},"OIKK":{temp:19,conditions:[],intensity:null},"OICC":{temp:13,conditions:[],intensity:null},"LLBG":{temp:18,conditions:[],intensity:null},"OLBA":{temp:17,conditions:[],intensity:null},"OJAM":{temp:15,conditions:[],intensity:null},"ORBI":{temp:22,conditions:[],intensity:null},"ORER":{temp:16,conditions:[],intensity:null},"GMMN":{temp:13,conditions:[],intensity:null},"GMME":{temp:14,conditions:[],intensity:null},
  "GMMX":{temp:12,conditions:[],intensity:null},"GMTT":{temp:13,conditions:[],intensity:null},"GMFF":{temp:12,conditions:[],intensity:null},"GMAD":{temp:15,conditions:[],intensity:null},"DAAG":{temp:15,conditions:[],intensity:null},"DAOO":{temp:14,conditions:[],intensity:null},"DTTA":{temp:18,conditions:[],intensity:null},"DTMB":{temp:17,conditions:[],intensity:null},"DTTJ":{temp:18,conditions:[],intensity:null},"HECA":{temp:21,conditions:[],intensity:null},
  "HEGN":{temp:23,conditions:[],intensity:null},"HESH":{temp:22,conditions:[],intensity:null},"HEBA":{temp:27,conditions:[],intensity:null},"HEAX":{temp:20,conditions:[],intensity:null},"HLLT":{temp:21,conditions:[],intensity:null},"DNMM":{temp:33,conditions:[],intensity:null},"DNAA":{temp:35,conditions:[],intensity:null},"DGAA":{temp:32,conditions:[],intensity:null},"DIAP":{temp:31,conditions:[],intensity:null},"GOBD":{temp:23,conditions:[],intensity:null},
  "GABS":{temp:26,conditions:[],intensity:null},"GVNP":{temp:22,conditions:[],intensity:null},"GBYD":{temp:29,conditions:[],intensity:null},"GLRB":{temp:29,conditions:[],intensity:null},"DXXX":{temp:34,conditions:[],intensity:null},"DBBB":{temp:33,conditions:[],intensity:null},"HKJK":{temp:23,conditions:[],intensity:null},"HKMO":{temp:31,conditions:[],intensity:null},"HTDA":{temp:31,conditions:[],intensity:null},"HTKJ":{temp:28,conditions:[],intensity:null},
  "HUEN":{temp:27,conditions:[],intensity:null},"HRYR":{temp:23,conditions:[],intensity:null},"HAAB":{temp:22,conditions:[],intensity:null},"HDAM":{temp:31,conditions:[],intensity:null},"HCMM":{temp:34,conditions:[],intensity:null},"OYSN":{temp:29,conditions:[],intensity:null},"FMEE":{temp:31,conditions:[],intensity:null},"FIMP":{temp:28,conditions:[],intensity:null},"FMCH":{temp:30,conditions:[],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  ...
  "RKSS":{temp:0,conditions:[],intensity:null},"RKPK":{temp:4,conditions:[],intensity:null},"RKPC":{temp:4,conditions:[],intensity:null},"RKTN":{temp:1,conditions:[],intensity:null},"ZKPY":{temp:-2,conditions:[],intensity:null},"WSSS":{temp:29,conditions:[],intensity:null},"WMKK":{temp:30,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:27,conditions:[],intensity:null},
  "VTBS":{temp:34,conditions:[],intensity:null},"VTBD":{temp:34,conditions:[],intensity:null},"VTSP":{temp:28,conditions:[],intensity:null},"VTCC":{temp:33,conditions:[],intensity:null},"VTSS":{temp:29,conditions:[],intensity:null},"VTUK":{temp:30,conditions:[],intensity:null},"VVNB":{temp:23,conditions:[],intensity:null},"VVTS":{temp:28,conditions:[],intensity:null},"VVDN":{temp:22,conditions:[],intensity:null},"VVCR":{temp:26,conditions:[],intensity:null},
  "VDPP":{temp:31,conditions:[],intensity:null},"VDSR":{temp:31,conditions:[],intensity:null},"VLVT":{temp:30,conditions:[],intensity:null},"VLLB":{temp:30,conditions:[],intensity:null},"VYYY":{temp:32,conditions:[],intensity:null},"VYMD":{temp:35,conditions:[],intensity:null},"VGHS":{temp:30,conditions:[],intensity:null},"VGCG":{temp:26,conditions:[],intensity:null},"VECC":{temp:29,conditions:[],intensity:null},"VRMM":{temp:28,conditions:[],intensity:null},
  ...
  "RPLL":{temp:29,conditions:[],intensity:null},"RPLC":{temp:27,conditions:[],intensity:null},"RPVM":{temp:27,conditions:[],intensity:null},"RPVD":{temp:29,conditions:[],intensity:null},"RPVK":{temp:25,conditions:[],intensity:null},"WBSB":{temp:26,conditions:[],intensity:null},"WBLL":{temp:28,conditions:[],intensity:null},"VIDP":{temp:33,conditions:[],intensity:null},"VABB":{temp:27,conditions:[],intensity:null},"VOBL":{temp:32,conditions:[],intensity:null},
  "VOMM":{temp:34,conditions:[],intensity:null},"VEBS":{temp:29,conditions:[],intensity:null},"VOHY":{temp:36,conditions:[],intensity:null},"VAAH":{temp:38,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:30,conditions:[],intensity:null},"VOTP":{temp:34,conditions:[],intensity:null},"VIAR":{temp:31,conditions:[],intensity:null},"VIJP":{temp:37,conditions:[],intensity:null},"VELR":{temp:22,conditions:[],intensity:null},
  ...
  "RCKH":{temp:23,conditions:[],intensity:null},"RCNN":{temp:20,conditions:[],intensity:null},"YSSY":{temp:22,conditions:[],intensity:null},"YMML":{temp:16,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:32,conditions:[],intensity:null},"YPAD":{temp:19,conditions:[],intensity:null},"YBCG":{temp:22,conditions:[],intensity:null},"YBCS":{temp:24,conditions:["thunderstorm"],intensity:null},"YSCB":{temp:19,conditions:[],intensity:null},
  "YMHB":{temp:14,conditions:[],intensity:null},"NZAA":{temp:18,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:14,conditions:[],intensity:null},"NZQN":{temp:15,conditions:[],intensity:null},"NZDN":{temp:13,conditions:[],intensity:null},"NFFN":{temp:27,conditions:[],intensity:null},"NWWW":{temp:29,conditions:[],intensity:null},"NTAA":{temp:29,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
