...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KEWR":{temp:9,conditions:[],intensity:null},"KMIA":{temp:27,conditions:[],intensity:null},"KPHX":{temp:25,conditions:[],intensity:null},"KIAH":{temp:28,conditions:[],intensity:null},"KBOS":{temp:6,conditions:[],intensity:null},"KMSP":{temp:-1,conditions:[],intensity:null},"KFLL":{temp:26,conditions:[],intensity:null},"KDTW":{temp:17,conditions:[],intensity:null},"KPHL":{temp:10,conditions:[],intensity:null},"KLGA":{temp:7,conditions:[],intensity:null},
  "KBWI":{temp:11,conditions:[],intensity:null},"KSLC":{temp:10,conditions:[],intensity:null},"KDCA":{temp:13,conditions:[],intensity:null},"KIAD":{temp:15,conditions:[],intensity:null},"KSAN":{temp:25,conditions:[],intensity:null},"KTPA":{temp:29,conditions:[],intensity:null},"KPDX":{temp:13,conditions:[],intensity:null},"KSTL":{temp:7,conditions:[],intensity:null},"KHNL":{temp:27,conditions:[],intensity:null},"KMEM":{temp:17,conditions:[],intensity:null},
  ...
  "KIND":{temp:17,conditions:[],intensity:null},"KCVG":{temp:17,conditions:["rain"],intensity:null},"KMCI":{temp:7,conditions:[],intensity:null},"KSAT":{temp:19,conditions:["rain"],intensity:null},"KHOU":{temp:29,conditions:[],intensity:null},"KDAL":{temp:13,conditions:[],intensity:null},"KMDW":{temp:8,conditions:[],intensity:null},"PANC":{temp:-6,conditions:[],intensity:null},"PAFA":{temp:-13,conditions:[],intensity:null},"CYYZ":{temp:17,conditions:[],intensity:null},
  "CYVR":{temp:12,conditions:[],intensity:null},"CYUL":{temp:8,conditions:[],intensity:null},"CYYC":{temp:13,conditions:[],intensity:null},"CYEG":{temp:8,conditions:[],intensity:null},"CYOW":{temp:10,conditions:[],intensity:null},"CYWG":{temp:-1,conditions:[],intensity:null},"CYHZ":{temp:2,conditions:["fog"],intensity:null},"CYQB":{temp:1,conditions:["fog"],intensity:null},"CYYJ":{temp:14,conditions:[],intensity:null},"CYLW":{temp:12,conditions:[],intensity:null},
  ...
  "MMTJ":{temp:23,conditions:[],intensity:null},"MMSM":{temp:27,conditions:[],intensity:null},"MMMD":{temp:32,conditions:[],intensity:null},"MMCZ":{temp:27,conditions:[],intensity:null},"MMSD":{temp:26,conditions:[],intensity:null},"MGGT":{temp:26,conditions:[],intensity:null},"MSLP":{temp:31,conditions:[],intensity:null},"MHTG":{temp:30,conditions:[],intensity:null},"MNMG":{temp:33,conditions:[],intensity:null},"MROC":{temp:29,conditions:[],intensity:null},
  ...
  "SBPA":{temp:26,conditions:[],intensity:null},"SBCT":{temp:28,conditions:[],intensity:null},"SBFZ":{temp:29,conditions:[],intensity:null},"SCEL":{temp:23,conditions:[],intensity:null},"SAEZ":{temp:24,conditions:[],intensity:null},"SABE":{temp:24,conditions:[],intensity:null},"SACO":{temp:23,conditions:[],intensity:null},"SAME":{temp:21,conditions:[],intensity:null},"SLLP":{temp:16,conditions:[],intensity:null},"SLVR":{temp:27,conditions:[],intensity:null},
  "SPJC":{temp:22,conditions:[],intensity:null},"SEQM":{temp:16,conditions:[],intensity:null},"SEGU":{temp:29,conditions:[],intensity:null},"SKBO":{temp:17,conditions:[],intensity:null},"SKMR":{temp:28,conditions:[],intensity:null},"SKCL":{temp:26,conditions:[],intensity:null},"SKMD":{temp:28,conditions:[],intensity:null},"SKRG":{temp:19,conditions:[],intensity:null},"SVMI":{temp:25,conditions:[],intensity:null},"SUMU":{temp:21,conditions:[],intensity:null},
  ...
  "LIMF":{temp:8,conditions:[],intensity:null},"LIEO":{temp:12,conditions:[],intensity:null},"LIEE":{temp:14,conditions:[],intensity:null},"EHAM":{temp:8,conditions:[],intensity:null},"EHRD":{temp:9,conditions:[],intensity:null},"EHEH":{temp:11,conditions:[],intensity:null},"EBBR":{temp:12,conditions:[],intensity:null},"EBCI":{temp:11,conditions:[],intensity:null},"ELLX":{temp:10,conditions:[],intensity:null},"LSZH":{temp:8,conditions:[],intensity:null},
  ...
  "EPWR":{temp:6,conditions:[],intensity:null},"EPPO":{temp:6,conditions:[],intensity:null},"EKCH":{temp:5,conditions:[],intensity:null},"ESSA":{temp:2,conditions:[],intensity:null},"ENGM":{temp:3,conditions:[],intensity:null},"EFHK":{temp:1,conditions:[],intensity:null},"BIKF":{temp:2,conditions:[],intensity:null},"ESGG":{temp:3,conditions:[],intensity:null},"ESMS":{temp:5,conditions:[],intensity:null},"ENBR":{temp:5,conditions:[],intensity:null},
  ...
  "GMMX":{temp:12,conditions:[],intensity:null},"GMTT":{temp:13,conditions:[],intensity:null},"GMFF":{temp:9,conditions:[],intensity:null},"GMAD":{temp:12,conditions:[],intensity:null},"DAAG":{temp:12,conditions:[],intensity:null},"DAOO":{temp:12,conditions:[],intensity:null},"DTTA":{temp:15,conditions:[],intensity:null},"DTMB":{temp:15,conditions:[],intensity:null},"DTTJ":{temp:16,conditions:[],intensity:null},"HECA":{temp:14,conditions:[],intensity:null},
  ...
  "VCBI":{temp:28,conditions:[],intensity:null},"WIII":{temp:24,conditions:["thunderstorm"],intensity:null},"WADD":{temp:28,conditions:[],intensity:null},"WARR":{temp:25,conditions:[],intensity:null},"WIHH":{temp:25,conditions:["rain"],intensity:null},"WIMM":{temp:24,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:27,conditions:[],intensity:null},"WICC":{temp:21,conditions:[],intensity:null},"WASS":{temp:27,conditions:[],intensity:null},
  ...
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:17,conditions:[],intensity:null},"YSSY":{temp:20,conditions:[],intensity:null},"YMML":{temp:15,conditions:[],intensity:null},"YBBN":{temp:25,conditions:[],intensity:null},"YPPH":{temp:25,conditions:[],intensity:null},"YPAD":{temp:16,conditions:[],intensity:null},"YBCG":{temp:21,conditions:["fog"],intensity:null},"YBCS":{temp:24,conditions:["fog"],intensity:null},"YSCB":{temp:17,conditions:[],intensity:null},
  "YMHB":{temp:13,conditions:[],intensity:null},"NZAA":{temp:18,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:17,conditions:[],intensity:null},"NZQN":{temp:16,conditions:[],intensity:null},"NZDN":{temp:16,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:29,conditions:[],intensity:null},"NTAA":{temp:29,conditions:[],intensity:null},"NSFA":{temp:28,conditions:["thunderstorm"],intensity:null},
