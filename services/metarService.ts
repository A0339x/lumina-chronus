...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "TJSJ":{temp:26,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:27,conditions:[],intensity:null},"TAPA":{temp:26,conditions:[],intensity:null},"SBGR":{temp:31,conditions:[],intensity:null},"SBGL":{temp:35,conditions:[],intensity:null},"SBBR":{temp:26,conditions:[],intensity:null},"SBCF":{temp:27,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null},
  "SBPA":{temp:26,conditions:[],intensity:null},"SBCT":{temp:27,conditions:[],intensity:null},"SBFZ":{temp:28,conditions:[],intensity:null},"SCEL":{temp:29,conditions:[],intensity:null},"SAEZ":{temp:21,conditions:[],intensity:null},"SABE":{temp:21,conditions:[],intensity:null},"SACO":{temp:25,conditions:[],intensity:null},"SAME":{temp:28,conditions:[],intensity:null},"SLLP":{temp:18,conditions:[],intensity:null},"SLVR":{temp:27,conditions:[],intensity:null},
  ...
  "LIMF":{temp:2,conditions:[],intensity:null},"LIEO":{temp:9,conditions:[],intensity:null},"LIEE":{temp:9,conditions:[],intensity:null},"EHAM":{temp:-2,conditions:[],intensity:null},"EHRD":{temp:-2,conditions:[],intensity:null},"EHEH":{temp:-2,conditions:[],intensity:null},"EBBR":{temp:-2,conditions:[],intensity:null},"EBCI":{temp:-4,conditions:[],intensity:null},"ELLX":{temp:-3,conditions:[],intensity:null},"LSZH":{temp:0,conditions:[],intensity:null},
  ...
  "EPWR":{temp:-6,conditions:[],intensity:null},"EPPO":{temp:-3,conditions:[],intensity:null},"EKCH":{temp:-3,conditions:[],intensity:null},"ESSA":{temp:-7,conditions:[],intensity:null},"ENGM":{temp:-15,conditions:[],intensity:null},"EFHK":{temp:-9,conditions:[],intensity:null},"BIKF":{temp:-4,conditions:[],intensity:null},"ESGG":{temp:-11,conditions:[],intensity:null},"ESMS":{temp:-9,conditions:[],intensity:null},"ENBR":{temp:-2,conditions:[],intensity:null},
  ...
  "GMMX":{temp:11,conditions:[],intensity:null},"GMTT":{temp:13,conditions:[],intensity:null},"GMFF":{temp:10,conditions:["fog"],intensity:null},"GMAD":{temp:11,conditions:[],intensity:null},"DAAG":{temp:9,conditions:[],intensity:null},"DAOO":{temp:11,conditions:[],intensity:null},"DTTA":{temp:12,conditions:[],intensity:null},"DTMB":{temp:12,conditions:[],intensity:null},"DTTJ":{temp:14,conditions:[],intensity:null},"HECA":{temp:14,conditions:[],intensity:null},
  ...
  "GABS":{temp:24,conditions:[],intensity:null},"GVNP":{temp:19,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:27,conditions:[],intensity:null},"DBBB":{temp:28,conditions:[],intensity:null},"HKJK":{temp:17,conditions:[],intensity:null},"HKMO":{temp:24,conditions:[],intensity:null},"HTDA":{temp:25,conditions:[],intensity:null},"HTKJ":{temp:20,conditions:[],intensity:null},
  ...
  "VTBS":{temp:19,conditions:[],intensity:null},"VTBD":{temp:18,conditions:[],intensity:null},"VTSP":{temp:24,conditions:[],intensity:null},"VTCC":{temp:17,conditions:[],intensity:null},"VTSS":{temp:24,conditions:[],intensity:null},"VTUK":{temp:21,conditions:[],intensity:null},"VVNB":{temp:13,conditions:[],intensity:null},"VVTS":{temp:20,conditions:[],intensity:null},"VVDN":{temp:15,conditions:[],intensity:null},"VVCR":{temp:20,conditions:[],intensity:null},
  "VDPP":{temp:20,conditions:[],intensity:null},"VDSR":{temp:18,conditions:[],intensity:null},"VLVT":{temp:15,conditions:[],intensity:null},"VLLB":{temp:11,conditions:[],intensity:null},"VYYY":{temp:20,conditions:[],intensity:null},"VYMD":{temp:18,conditions:[],intensity:null},"VGHS":{temp:15,conditions:[],intensity:null},"VGCG":{temp:17,conditions:["fog"],intensity:null},"VECC":{temp:15,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  ...
  "VOMM":{temp:22,conditions:[],intensity:null},"VEBS":{temp:15,conditions:[],intensity:null},"VOHY":{temp:17,conditions:[],intensity:null},"VAAH":{temp:13,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:24,conditions:[],intensity:null},"VOTP":{temp:21,conditions:[],intensity:null},"VIAR":{temp:6,conditions:[],intensity:null},"VIJP":{temp:11,conditions:[],intensity:null},"VELR":{temp:7,conditions:[],intensity:null},
  "VOCL":{temp:26,conditions:[],intensity:null},"VOTV":{temp:27,conditions:[],intensity:null},"VEPT":{temp:12,conditions:[],intensity:null},"VNKT":{temp:8,conditions:[],intensity:null},"OPKC":{temp:14,conditions:[],intensity:null},"OPLA":{temp:7,conditions:[],intensity:null},"OPIS":{temp:4,conditions:[],intensity:null},"RCTP":{temp:14,conditions:[],intensity:null},"RCSS":{temp:14,conditions:[],intensity:null},"RCMQ":{temp:14,conditions:[],intensity:null},
  "RCKH":{temp:18,conditions:[],intensity:null},"RCNN":{temp:16,conditions:[],intensity:null},"YSSY":{temp:20,conditions:[],intensity:null},"YMML":{temp:12,conditions:[],intensity:null},"YBBN":{temp:25,conditions:[],intensity:null},"YPPH":{temp:18,conditions:[],intensity:null},"YPAD":{temp:17,conditions:[],intensity:null},"YBCG":{temp:24,conditions:[],intensity:null},"YBCS":{temp:24,conditions:[],intensity:null},"YSCB":{temp:17,conditions:[],intensity:null},
  "YMHB":{temp:11,conditions:[],intensity:null},"NZAA":{temp:22,conditions:[],intensity:null},"NZWN":{temp:19,conditions:[],intensity:null},"NZCH":{temp:25,conditions:[],intensity:null},"NZQN":{temp:16,conditions:[],intensity:null},"NZDN":{temp:18,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:30,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
  "NIUE":{temp:26,conditions:["thunderstorm"],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:27,conditions:[],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:24,conditions:[],intensity:null}
};
