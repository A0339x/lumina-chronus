...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:8,conditions:[],intensity:null},"KLAX":{temp:14,conditions:[],intensity:null},"KORD":{temp:-5,conditions:[],intensity:null},"KDFW":{temp:9,conditions:[],intensity:null},"KDEN":{temp:-7,conditions:[],intensity:null},"KJFK":{temp:2,conditions:[],intensity:null},"KSFO":{temp:10,conditions:[],intensity:null},"KSEA":{temp:1,conditions:[],intensity:null},"KLAS":{temp:9,conditions:[],intensity:null},"KMCO":{temp:14,conditions:[],intensity:null},
  "KEWR":{temp:1,conditions:[],intensity:null},"KMIA":{temp:20,conditions:[],intensity:null},"KPHX":{temp:13,conditions:[],intensity:null},"KIAH":{temp:18,conditions:[],intensity:null},"KBOS":{temp:1,conditions:[],intensity:null},"KMSP":{temp:-13,conditions:[],intensity:null},"KFLL":{temp:21,conditions:[],intensity:null},"KDTW":{temp:-3,conditions:[],intensity:null},"KPHL":{temp:3,conditions:[],intensity:null},"KLGA":{temp:2,conditions:[],intensity:null},
  ...
  "KAUS":{temp:13,conditions:[],intensity:null},"KBNA":{temp:7,conditions:[],intensity:null},"KRDU":{temp:3,conditions:[],intensity:null},"KCLT":{temp:4,conditions:[],intensity:null},"KSMF":{temp:7,conditions:[],intensity:null},"KSJC":{temp:10,conditions:[],intensity:null},"KOAK":{temp:10,conditions:[],intensity:null},"KCLE":{temp:0,conditions:[],intensity:null},"KMKE":{temp:-8,conditions:[],intensity:null},"KPIT":{temp:1,conditions:[],intensity:null},
  "KIND":{temp:0,conditions:[],intensity:null},"KCVG":{temp:2,conditions:[],intensity:null},"KMCI":{temp:-5,conditions:[],intensity:null},"KSAT":{temp:10,conditions:[],intensity:null},"KHOU":{temp:19,conditions:[],intensity:null},"KDAL":{temp:9,conditions:[],intensity:null},"KMDW":{temp:-3,conditions:[],intensity:null},"PANC":{temp:-4,conditions:[],intensity:null},"PAFA":{temp:-15,conditions:[],intensity:null},"CYYZ":{temp:-5,conditions:[],intensity:null},
  "CYVR":{temp:2,conditions:["fog"],intensity:null},"CYUL":{temp:-5,conditions:[],intensity:null},"CYYC":{temp:-10,conditions:[],intensity:null},"CYEG":{temp:-15,conditions:[],intensity:null},"CYOW":{temp:-3,conditions:[],intensity:null},"CYWG":{temp:-24,conditions:[],intensity:null},"CYHZ":{temp:-4,conditions:[],intensity:null},"CYQB":{temp:-9,conditions:["snow"],intensity:null},"CYYJ":{temp:2,conditions:[],intensity:null},"CYLW":{temp:0,conditions:[],intensity:null},
  "CYXE":{temp:-25,conditions:[],intensity:null},"CYQR":{temp:-21,conditions:[],intensity:null},"CYZF":{temp:-34,conditions:[],intensity:null},"CYXY":{temp:-12,conditions:[],intensity:null},"CYQT":{temp:-24,conditions:[],intensity:null},"CYYT":{temp:-7,conditions:[],intensity:null},"MMMX":{temp:10,conditions:[],intensity:null},"MMUN":{temp:21,conditions:[],intensity:null},"MMGL":{temp:14,conditions:[],intensity:null},"MMMY":{temp:15,conditions:[],intensity:null},
  "MMTJ":{temp:12,conditions:[],intensity:null},"MMSM":{temp:26,conditions:[],intensity:null},"MMMD":{temp:21,conditions:[],intensity:null},"MMCZ":{temp:26,conditions:[],intensity:null},"MMSD":{temp:21,conditions:[],intensity:null},"MGGT":{temp:16,conditions:[],intensity:null},"MSLP":{temp:27,conditions:[],intensity:null},"MHTG":{temp:20,conditions:[],intensity:null},"MNMG":{temp:24,conditions:[],intensity:null},"MROC":{temp:21,conditions:[],intensity:null},
  ...
  "LIMF":{temp:-1,conditions:[],intensity:null},"LIEO":{temp:5,conditions:[],intensity:null},"LIEE":{temp:8,conditions:[],intensity:null},"EHAM":{temp:2,conditions:[],intensity:null},"EHRD":{temp:1,conditions:[],intensity:null},"EHEH":{temp:1,conditions:[],intensity:null},"EBBR":{temp:3,conditions:[],intensity:null},"EBCI":{temp:4,conditions:[],intensity:null},"ELLX":{temp:0,conditions:[],intensity:null},"LSZH":{temp:-3,conditions:["fog"],intensity:null},
  ...
  "EPWR":{temp:-6,conditions:[],intensity:null},"EPPO":{temp:-6,conditions:[],intensity:null},"EKCH":{temp:-1,conditions:[],intensity:null},"ESSA":{temp:-1,conditions:[],intensity:null},"ENGM":{temp:-2,conditions:[],intensity:null},"EFHK":{temp:-5,conditions:[],intensity:null},"BIKF":{temp:5,conditions:[],intensity:null},"ESGG":{temp:-1,conditions:[],intensity:null},"ESMS":{temp:-1,conditions:[],intensity:null},"ENBR":{temp:-2,conditions:[],intensity:null},
  "ENZV":{temp:1,conditions:[],intensity:null},"ENTC":{temp:-9,conditions:[],intensity:null},"EFOU":{temp:-8,conditions:[],intensity:null},"EFRO":{temp:-11,conditions:[],intensity:null},"LGAV":{temp:8,conditions:[],intensity:null},"LGTS":{temp:5,conditions:[],intensity:null},"LGIR":{temp:14,conditions:[],intensity:null},"LGKR":{temp:12,conditions:[],intensity:null},"LGRP":{temp:14,conditions:["rain"],intensity:null},"LGSR":{temp:14,conditions:[],intensity:null},
  "LGMK":{temp:14,conditions:[],intensity:null},"LTFM":{temp:5,conditions:[],intensity:null},"LTBA":{temp:7,conditions:[],intensity:null},"LTFJ":{temp:6,conditions:[],intensity:null},"LTAI":{temp:9,conditions:[],intensity:null},"LTAC":{temp:-3,conditions:[],intensity:null},"LTBJ":{temp:10,conditions:["thunderstorm"],intensity:null},"LTBS":{temp:15,conditions:[],intensity:null},"LTFE":{temp:14,conditions:["thunderstorm"],intensity:null},"LCLK":{temp:12,conditions:[],intensity:null},
  ...
  "LATI":{temp:6,conditions:[],intensity:null},"UKBB":{temp:-7,conditions:["fog"],intensity:null},"UKLL":{temp:-12,conditions:[],intensity:null},"UUEE":{temp:-8,conditions:["snow"],intensity:null},"UUDD":{temp:-8,conditions:["snow"],intensity:null},"UUWW":{temp:-8,conditions:[],intensity:null},"ULLI":{temp:-12,conditions:[],intensity:null},"UWWW":{temp:-17,conditions:[],intensity:null},"USSS":{temp:-33,conditions:[],intensity:null},"UNNT":{temp:-26,conditions:[],intensity:null},
  ...
  "OIAW":{temp:4,conditions:[],intensity:null},"OIKK":{temp:-4,conditions:[],intensity:null},"OICC":{temp:-4,conditions:[],intensity:null},"LLBG":{temp:16,conditions:[],intensity:null},"OLBA":{temp:15,conditions:[],intensity:null},"OJAM":{temp:4,conditions:[],intensity:null},"ORBI":{temp:3,conditions:[],intensity:null},"ORER":{temp:0,conditions:[],intensity:null},"GMMN":{temp:13,conditions:[],intensity:null},"GMME":{temp:14,conditions:[],intensity:null},
  ...
  "HEGN":{temp:17,conditions:[],intensity:null},"HESH":{temp:18,conditions:[],intensity:null},"HEBA":{temp:16,conditions:[],intensity:null},"HEAX":{temp:14,conditions:[],intensity:null},"HLLT":{temp:13,conditions:[],intensity:null},"DNMM":{temp:27,conditions:[],intensity:null},"DNAA":{temp:21,conditions:[],intensity:null},"DGAA":{temp:26,conditions:[],intensity:null},"DIAP":{temp:27,conditions:[],intensity:null},"GOBD":{temp:17,conditions:[],intensity:null},
