...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:24,conditions:[],intensity:null},"KLAX":{temp:20,conditions:[],intensity:null},"KORD":{temp:3,conditions:[],intensity:null},"KDFW":{temp:23,conditions:[],intensity:null},"KDEN":{temp:21,conditions:[],intensity:null},"KJFK":{temp:11,conditions:[],intensity:null},"KSFO":{temp:17,conditions:[],intensity:null},"KSEA":{temp:10,conditions:[],intensity:null},"KLAS":{temp:31,conditions:[],intensity:null},"KMCO":{temp:19,conditions:[],intensity:null},
  "KEWR":{temp:10,conditions:[],intensity:null},"KMIA":{temp:27,conditions:[],intensity:null},"KPHX":{temp:32,conditions:[],intensity:null},"KIAH":{temp:24,conditions:[],intensity:null},"KBOS":{temp:5,conditions:[],intensity:null},"KMSP":{temp:7,conditions:[],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:5,conditions:[],intensity:null},"KPHL":{temp:12,conditions:[],intensity:null},"KLGA":{temp:10,conditions:[],intensity:null},
  "KBWI":{temp:12,conditions:[],intensity:null},"KSLC":{temp:23,conditions:[],intensity:null},"KDCA":{temp:14,conditions:[],intensity:null},"KIAD":{temp:13,conditions:[],intensity:null},"KSAN":{temp:21,conditions:[],intensity:null},"KTPA":{temp:20,conditions:[],intensity:null},"KPDX":{temp:13,conditions:[],intensity:null},"KSTL":{temp:13,conditions:[],intensity:null},"KHNL":{temp:25,conditions:[],intensity:null},"KMEM":{temp:23,conditions:[],intensity:null},
  "KAUS":{temp:24,conditions:[],intensity:null},"KBNA":{temp:19,conditions:[],intensity:null},"KRDU":{temp:20,conditions:[],intensity:null},"KCLT":{temp:21,conditions:[],intensity:null},"KSMF":{temp:21,conditions:[],intensity:null},"KSJC":{temp:19,conditions:[],intensity:null},"KOAK":{temp:17,conditions:[],intensity:null},"KCLE":{temp:0,conditions:[],intensity:null},"KMKE":{temp:0,conditions:[],intensity:null},"KPIT":{temp:4,conditions:[],intensity:null},
  "KIND":{temp:9,conditions:[],intensity:null},"KCVG":{temp:10,conditions:[],intensity:null},"KMCI":{temp:16,conditions:[],intensity:null},"KSAT":{temp:24,conditions:[],intensity:null},"KHOU":{temp:25,conditions:[],intensity:null},"KDAL":{temp:20,conditions:[],intensity:null},"KMDW":{temp:2,conditions:[],intensity:null},"PANC":{temp:1,conditions:[],intensity:null},"PAFA":{temp:2,conditions:[],intensity:null},"CYYZ":{temp:0,conditions:[],intensity:null},
  ...
  "CYXE":{temp:1,conditions:[],intensity:null},"CYQR":{temp:11,conditions:[],intensity:null},"CYZF":{temp:-5,conditions:[],intensity:null},"CYXY":{temp:1,conditions:[],intensity:null},"CYQT":{temp:1,conditions:[],intensity:null},"CYYT":{temp:1,conditions:[],intensity:null},"MMMX":{temp:24,conditions:[],intensity:null},"MMUN":{temp:31,conditions:[],intensity:null},"MMGL":{temp:30,conditions:[],intensity:null},"MMMY":{temp:25,conditions:[],intensity:null},
  ...
  "MPTO":{temp:31,conditions:[],intensity:null},"MKJP":{temp:31,conditions:[],intensity:null},"TNCM":{temp:27,conditions:[],intensity:null},"TBPB":{temp:28,conditions:[],intensity:null},"TTPP":{temp:30,conditions:[],intensity:null},"MWCR":{temp:27,conditions:[],intensity:null},"MUHA":{temp:27,conditions:["thunderstorm"],intensity:null},"MDSD":{temp:26,conditions:[],intensity:null},"MDPP":{temp:29,conditions:[],intensity:null},"MTPP":{temp:31,conditions:[],intensity:null},
  "TJSJ":{temp:29,conditions:[],intensity:null},"TIST":{temp:27,conditions:[],intensity:null},"TLPL":{temp:28,conditions:[],intensity:null},"TAPA":{temp:28,conditions:[],intensity:null},"SBGR":{temp:27,conditions:[],intensity:null},"SBGL":{temp:29,conditions:[],intensity:null},"SBBR":{temp:24,conditions:[],intensity:null},"SBCF":{temp:26,conditions:[],intensity:null},"SBSV":{temp:28,conditions:[],intensity:null},"SBRF":{temp:25,conditions:[],intensity:null}
};
