...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:31,conditions:["thunderstorm"],intensity:null},"KLAX":{temp:19,conditions:[],intensity:null},"KORD":{temp:31,conditions:["thunderstorm"],intensity:null},"KDFW":{temp:29,conditions:[],intensity:null},"KDEN":{temp:23,conditions:[],intensity:null},"KJFK":{temp:28,conditions:[],intensity:null},"KSFO":{temp:15,conditions:[],intensity:null},"KSEA":{temp:13,conditions:[],intensity:null},"KLAS":{temp:27,conditions:[],intensity:null},"KMCO":{temp:31,conditions:["thunderstorm"],intensity:null},
  "KEWR":{temp:30,conditions:[],intensity:null},"KMIA":{temp:32,conditions:["thunderstorm"],intensity:null},"KPHX":{temp:30,conditions:[],intensity:null},"KIAH":{temp:30,conditions:["thunderstorm"],intensity:null},"KBOS":{temp:26,conditions:[],intensity:null},"KMSP":{temp:28,conditions:[],intensity:null},"KFLL":{temp:31,conditions:["thunderstorm"],intensity:null},"KDTW":{temp:31,conditions:["thunderstorm"],intensity:null},"KPHL":{temp:29,conditions:[],intensity:null},"KLGA":{temp:31,conditions:[],intensity:null},
  "KBWI":{temp:28,conditions:[],intensity:null},"KSLC":{temp:17,conditions:[],intensity:null},"KDCA":{temp:28,conditions:[],intensity:null},"KIAD":{temp:28,conditions:[],intensity:null},"KSAN":{temp:19,conditions:[],intensity:null},"KTPA":{temp:32,conditions:["thunderstorm"],intensity:null},"KPDX":{temp:14,conditions:[],intensity:null},"KSTL":{temp:30,conditions:[],intensity:null},"KHNL":{temp:24,conditions:[],intensity:null},"KMEM":{temp:30,conditions:["thunderstorm"],intensity:null},
  "KAUS":{temp:29,conditions:[],intensity:null},"KBNA":{temp:31,conditions:["thunderstorm"],intensity:null},"KRDU":{temp:28,conditions:[],intensity:null},"KCLT":{temp:29,conditions:[],intensity:null},"KSMF":{temp:18,conditions:[],intensity:null},"KSJC":{temp:16,conditions:[],intensity:null},"KOAK":{temp:15,conditions:[],intensity:null},"KCLE":{temp:31,conditions:["thunderstorm"],intensity:null},"KMKE":{temp:31,conditions:["thunderstorm"],intensity:null},"KPIT":{temp:29,conditions:["thunderstorm"],intensity:null},
  "KIND":{temp:29,conditions:["thunderstorm"],intensity:null},"KCVG":{temp:29,conditions:["thunderstorm"],intensity:null},"KMCI":{temp:31,conditions:[],intensity:null},"KSAT":{temp:28,conditions:[],intensity:null},"KHOU":{temp:31,conditions:["thunderstorm"],intensity:null},"KDAL":{temp:28,conditions:["thunderstorm"],intensity:null},"KMDW":{temp:30,conditions:["thunderstorm"],intensity:null},"PANC":{temp:11,conditions:[],intensity:null},"PAFA":{temp:10,conditions:[],intensity:null},"CYYZ":{temp:28,conditions:[],intensity:null},
  "CYVR":{temp:14,conditions:[],intensity:null},"CYUL":{temp:27,conditions:[],intensity:null},"CYYC":{temp:16,conditions:[],intensity:null},"CYEG":{temp:17,conditions:[],intensity:null},"CYOW":{temp:26,conditions:[],intensity:null},"CYWG":{temp:19,conditions:[],intensity:null},"CYHZ":{temp:24,conditions:[],intensity:null},"CYQB":{temp:23,conditions:[],intensity:null},"CYYJ":{temp:15,conditions:[],intensity:null},"CYLW":{temp:19,conditions:[],intensity:null},
  "CYXE":{temp:17,conditions:[],intensity:null},"CYQR":{temp:16,conditions:[],intensity:null},"CYZF":{temp:20,conditions:[],intensity:null},"CYXY":{temp:10,conditions:[],intensity:null},"CYQT":{temp:16,conditions:["fog"],intensity:null},"CYYT":{temp:20,conditions:[],intensity:null},"MMMX":{temp:16,conditions:[],intensity:null},"MMUN":{temp:30,conditions:["thunderstorm"],intensity:null},"MMGL":{temp:21,conditions:[],intensity:null},"MMMY":{temp:27,conditions:[],intensity:null},
  "MMTJ":{temp:18,conditions:[],intensity:null},"MMSM":{temp:31,conditions:[],intensity:null},"MMMD":{temp:30,conditions:["thunderstorm"],intensity:null},"MMCZ":{temp:30,conditions:["thunderstorm"],intensity:null},"MMSD":{temp:33,conditions:[],intensity:null},"MGGT":{temp:22,conditions:[],intensity:null},"MSLP":{temp:33,conditions:[],intensity:null},"MHTG":{temp:24,conditions:["thunderstorm"],intensity:null},"MNMG":{temp:31,conditions:[],intensity:null},"MROC":{temp:27,conditions:[],intensity:null},
  "MPTO":{temp:32,conditions:["thunderstorm"],intensity:null},"MKJP":{temp:32,conditions:[],intensity:null},"TNCM":{temp:28,conditions:[],intensity:null},"TBPB":{temp:29,conditions:[],intensity:null},"TTPP":{temp:29,conditions:[],intensity:null},"MWCR":{temp:31,conditions:["thunderstorm"],intensity:null},"MUHA":{temp:31,conditions:["thunderstorm"],intensity:null},"MDSD":{temp:30,conditions:[],intensity:null},"MDPP":{temp:33,conditions:["thunderstorm"],intensity:null},"MTPP":{temp:34,conditions:[],intensity:null},
  "TJSJ":{temp:29,conditions:[],intensity:null},"TIST":{temp:28,conditions:[],intensity:null},"TLPL":{temp:29,conditions:[],intensity:null},"TAPA":{temp:30,conditions:[],intensity:null},"SBGR":{temp:25,conditions:[],intensity:null},"SBGL":{temp:25,conditions:[],intensity:null},"SBBR":{temp:23,conditions:[],intensity:null},"SBCF":{temp:24,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null},
  "SBPA":{temp:14,conditions:[],intensity:null},"SBCT":{temp:20,conditions:[],intensity:null},"SBFZ":{temp:30,conditions:[],intensity:null},"SCEL":{temp:13,conditions:[],intensity:null},"SAEZ":{temp:11,conditions:[],intensity:null},"SABE":{temp:10,conditions:[],intensity:null},"SACO":{temp:12,conditions:[],intensity:null},"SAME":{temp:6,conditions:[],intensity:null},"SLLP":{temp:11,conditions:[],intensity:null},"SLVR":{temp:22,conditions:[],intensity:null},
  "SPJC":{temp:23,conditions:[],intensity:null},"SEQM":{temp:21,conditions:[],intensity:null},"SEGU":{temp:28,conditions:[],intensity:null},"SKBO":{temp:17,conditions:[],intensity:null},"SKMR":{temp:32,conditions:[],intensity:null},"SKCL":{temp:25,conditions:[],intensity:null},"SKMD":{temp:27,conditions:[],intensity:null},"SKRG":{temp:20,conditions:[],intensity:null},"SVMI":{temp:32,conditions:[],intensity:null},"SUMU":{temp:8,conditions:[],intensity:null},
  "SGAS":{temp:17,conditions:[],intensity:null},"SBBV":{temp:29,conditions:[],intensity:null},"SMJP":{temp:29,conditions:[],intensity:null},"SYCJ":{temp:30,conditions:[],intensity:null},"EGLL":{temp:24,conditions:[],intensity:null},"EGKK":{temp:22,conditions:[],intensity:null},"EGSS":{temp:23,conditions:[],intensity:null},"EGLC":{temp:25,conditions:[],intensity:null},"EGCC":{temp:20,conditions:[],intensity:null},"EGBB":{temp:21,conditions:[],intensity:null},
  "EGPH":{temp:16,conditions:[],intensity:null},"EGPF":{temp:16,conditions:[],intensity:null},"EGGW":{temp:22,conditions:[],intensity:null},"EGNX":{temp:22,conditions:[],intensity:null},"EGNT":{temp:19,conditions:[],intensity:null},"EGGP":{temp:18,conditions:[],intensity:null},"EGHI":{temp:21,conditions:[],intensity:null},"EGGD":{temp:18,conditions:[],intensity:null},"EGPD":{temp:16,conditions:[],intensity:null},"EGAA":{temp:19,conditions:[],intensity:null},
  "EIDW":{temp:19,conditions:[],intensity:null},"EICK":{temp:19,conditions:[],intensity:null},"EINN":{temp:19,conditions:[],intensity:null},"LFPG":{temp:27,conditions:[],intensity:null},"LFPO":{temp:29,conditions:[],intensity:null},"LFML":{temp:35,conditions:[],intensity:null},"LFLL":{temp:32,conditions:[],intensity:null},"LFMN":{temp:31,conditions:[],intensity:null},"LFBD":{temp:29,conditions:[],intensity:null},"LFBO":{temp:31,conditions:[],intensity:null},
  "LFRS":{temp:28,conditions:[],intensity:null},"LFSB":{temp:32,conditions:[],intensity:null},"LFPB":{temp:28,conditions:[],intensity:null},"EDDF":{temp:31,conditions:[],intensity:null},"EDDM":{temp:28,conditions:[],intensity:null},"EDDB":{temp:26,conditions:[],intensity:null},"EDDL":{temp:27,conditions:[],intensity:null},"EDDH":{temp:24,conditions:[],intensity:null},"EDDK":{temp:24,conditions:[],intensity:null},"EDDS":{temp:30,conditions:[],intensity:null},
  "EDDW":{temp:25,conditions:[],intensity:null},"EDDN":{temp:29,conditions:[],intensity:null},"EDDV":{temp:28,conditions:[],intensity:null},"EDDP":{temp:24,conditions:[],intensity:null},"LEMD":{temp:36,conditions:[],intensity:null},"LEBL":{temp:31,conditions:[],intensity:null},"LEPA":{temp:32,conditions:[],intensity:null},"LEMG":{temp:30,conditions:[],intensity:null},"LEVC":{temp:34,conditions:[],intensity:null},"LEAL":{temp:30,conditions:[],intensity:null},
  "LEZL":{temp:39,conditions:[],intensity:null},"GCLP":{temp:29,conditions:[],intensity:null},"GCTS":{temp:29,conditions:[],intensity:null},"GCLA":{temp:30,conditions:[],intensity:null},"GCFV":{temp:30,conditions:[],intensity:null},"LPPT":{temp:29,conditions:[],intensity:null},"LPPR":{temp:24,conditions:[],intensity:null},"LPFR":{temp:30,conditions:[],intensity:null},"LPMA":{temp:24,conditions:[],intensity:null},"LIRF":{temp:32,conditions:[],intensity:null},
  "LIMC":{temp:33,conditions:[],intensity:null},"LIME":{temp:34,conditions:[],intensity:null},"LIPZ":{temp:33,conditions:[],intensity:null},"LIRN":{temp:34,conditions:[],intensity:null},"LIML":{temp:34,conditions:[],intensity:null},"LIPE":{temp:35,conditions:[],intensity:null},"LICC":{temp:32,conditions:[],intensity:null},"LICJ":{temp:30,conditions:[],intensity:null},"LIRA":{temp:36,conditions:[],intensity:null},"LIRP":{temp:32,conditions:[],intensity:null},
  "LIMF":{temp:31,conditions:[],intensity:null},"LIEO":{temp:33,conditions:[],intensity:null},"LIEE":{temp:31,conditions:[],intensity:null},"EHAM":{temp:21,conditions:[],intensity:null},"EHRD":{temp:20,conditions:[],intensity:null},"EHEH":{temp:22,conditions:[],intensity:null},"EBBR":{temp:21,conditions:[],intensity:null},"EBCI":{temp:20,conditions:[],intensity:null},"ELLX":{temp:28,conditions:[],intensity:null},"LSZH":{temp:32,conditions:[],intensity:null},
  "LSGG":{temp:24,conditions:[],intensity:null},"LSZB":{temp:30,conditions:[],intensity:null},"LOWW":{temp:32,conditions:[],intensity:null},"LOWS":{temp:31,conditions:[],intensity:null},"LOWG":{temp:33,conditions:[],intensity:null},"LOWI":{temp:30,conditions:[],intensity:null},"LKPR":{temp:26,conditions:[],intensity:null},"EPWA":{temp:33,conditions:[],intensity:null},"EPKK":{temp:33,conditions:["thunderstorm"],intensity:null},"EPGD":{temp:21,conditions:[],intensity:null},
  "EPWR":{temp:29,conditions:[],intensity:null},"EPPO":{temp:28,conditions:[],intensity:null},"EKCH":{temp:25,conditions:[],intensity:null},"ESSA":{temp:28,conditions:[],intensity:null},"ENGM":{temp:25,conditions:[],intensity:null},"EFHK":{temp:27,conditions:[],intensity:null},"BIKF":{temp:10,conditions:[],intensity:null},"ESGG":{temp:21,conditions:[],intensity:null},"ESMS":{temp:25,conditions:[],intensity:null},"ENBR":{temp:17,conditions:[],intensity:null},
  "ENZV":{temp:18,conditions:[],intensity:null},"ENTC":{temp:11,conditions:[],intensity:null},"EFOU":{temp:21,conditions:[],intensity:null},"EFRO":{temp:18,conditions:[],intensity:null},"LGAV":{temp:30,conditions:[],intensity:null},"LGTS":{temp:33,conditions:[],intensity:null},"LGIR":{temp:28,conditions:[],intensity:null},"LGKR":{temp:32,conditions:[],intensity:null},"LGRP":{temp:29,conditions:[],intensity:null},"LGSR":{temp:28,conditions:[],intensity:null},
  "LGMK":{temp:26,conditions:[],intensity:null},"LTFM":{temp:25,conditions:[],intensity:null},"LTBA":{temp:28,conditions:[],intensity:null},"LTFJ":{temp:28,conditions:[],intensity:null},"LTAI":{temp:31,conditions:[],intensity:null},"LTAC":{temp:30,conditions:[],intensity:null},"LTBJ":{temp:35,conditions:[],intensity:null},"LTBS":{temp:29,conditions:[],intensity:null},"LTFE":{temp:32,conditions:[],intensity:null},"LCLK":{temp:34,conditions:[],intensity:null},
  "LCPH":{temp:30,conditions:[],intensity:null},"LHBP":{temp:41,conditions:[],intensity:null},"LROP":{temp:34,conditions:[],intensity:null},"LBSF":{temp:29,conditions:[],intensity:null},"LYBE":{temp:39,conditions:[],intensity:null},"LDZA":{temp:35,conditions:[],intensity:null},"LDDU":{temp:32,conditions:[],intensity:null},"LDSP":{temp:39,conditions:[],intensity:null},"LJLJ":{temp:26,conditions:[],intensity:null},"LWSK":{temp:31,conditions:[],intensity:null},
  "LATI":{temp:34,conditions:[],intensity:null},"UKBB":{temp:31,conditions:[],intensity:null},"UKLL":{temp:35,conditions:[],intensity:null},"UUEE":{temp:24,conditions:[],intensity:null},"UUDD":{temp:25,conditions:[],intensity:null},"UUWW":{temp:24,conditions:[],intensity:null},"ULLI":{temp:24,conditions:[],intensity:null},"UWWW":{temp:17,conditions:[],intensity:null},"USSS":{temp:19,conditions:[],intensity:null},"UNNT":{temp:23,conditions:[],intensity:null},
  "UUOB":{temp:18,conditions:[],intensity:null},"UHWW":{temp:16,conditions:[],intensity:null},"UEEE":{temp:21,conditions:[],intensity:null},"OMDB":{temp:34,conditions:[],intensity:null},"OMDW":{temp:34,conditions:[],intensity:null},"OMAA":{temp:35,conditions:[],intensity:null},"OMSJ":{temp:35,conditions:[],intensity:null},"OTHH":{temp:40,conditions:[],intensity:null},"OERK":{temp:40,conditions:[],intensity:null},"OEJN":{temp:35,conditions:[],intensity:null},
  "OEDF":{temp:40,conditions:[],intensity:null},"OEMA":{temp:43,conditions:[],intensity:null},"OKBK":{temp:43,conditions:[],intensity:null},"OBBI":{temp:36,conditions:[],intensity:null},"OOMS":{temp:34,conditions:[],intensity:null},"OYAA":{temp:28,conditions:[],intensity:null},"OIIE":{temp:35,conditions:[],intensity:null},"OIII":{temp:33,conditions:[],intensity:null},"OISS":{temp:35,conditions:[],intensity:null},"OIKB":{temp:36,conditions:[],intensity:null},
  "OIAW":{temp:44,conditions:[],intensity:null},"OIKK":{temp:32,conditions:[],intensity:null},"OICC":{temp:35,conditions:[],intensity:null},"LLBG":{temp:29,conditions:[],intensity:null},"OLBA":{temp:28,conditions:[],intensity:null},"OJAM":{temp:31,conditions:[],intensity:null},"ORBI":{temp:42,conditions:[],intensity:null},"ORER":{temp:42,conditions:[],intensity:null},"GMMN":{temp:32,conditions:[],intensity:null},"GMME":{temp:31,conditions:[],intensity:null},
  "GMMX":{temp:40,conditions:[],intensity:null},"GMTT":{temp:33,conditions:[],intensity:null},"GMFF":{temp:38,conditions:[],intensity:null},"GMAD":{temp:30,conditions:[],intensity:null},"DAAG":{temp:28,conditions:[],intensity:null},"DAOO":{temp:29,conditions:[],intensity:null},"DTTA":{temp:30,conditions:[],intensity:null},"DTMB":{temp:30,conditions:[],intensity:null},"DTTJ":{temp:32,conditions:[],intensity:null},"HECA":{temp:37,conditions:[],intensity:null},
  "HEGN":{temp:36,conditions:[],intensity:null},"HESH":{temp:36,conditions:[],intensity:null},"HEBA":{temp:41,conditions:[],intensity:null},"HEAX":{temp:27,conditions:[],intensity:null},"HLLT":{temp:30,conditions:[],intensity:null},"DNMM":{temp:26,conditions:[],intensity:null},"DNAA":{temp:29,conditions:[],intensity:null},"DGAA":{temp:26,conditions:[],intensity:null},"DIAP":{temp:27,conditions:[],intensity:null},"GOBD":{temp:29,conditions:[],intensity:null},
  "GABS":{temp:30,conditions:[],intensity:null},"GVNP":{temp:30,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:27,conditions:[],intensity:null},"DBBB":{temp:27,conditions:[],intensity:null},"HKJK":{temp:22,conditions:[],intensity:null},"HKMO":{temp:26,conditions:[],intensity:null},"HTDA":{temp:25,conditions:[],intensity:null},"HTKJ":{temp:22,conditions:[],intensity:null},
  "HUEN":{temp:23,conditions:[],intensity:null},"HRYR":{temp:27,conditions:[],intensity:null},"HAAB":{temp:22,conditions:[],intensity:null},"HDAM":{temp:34,conditions:[],intensity:null},"HCMM":{temp:26,conditions:[],intensity:null},"OYSN":{temp:27,conditions:[],intensity:null},"FMEE":{temp:22,conditions:[],intensity:null},"FIMP":{temp:21,conditions:[],intensity:null},"FMCH":{temp:26,conditions:[],intensity:null},"FMMI":{temp:15,conditions:[],intensity:null},
  "FSIA":{temp:25,conditions:[],intensity:null},"FKKD":{temp:27,conditions:[],intensity:null},"FKYS":{temp:28,conditions:[],intensity:null},"FOOL":{temp:26,conditions:[],intensity:null},"FZAA":{temp:30,conditions:[],intensity:null},"FCBB":{temp:30,conditions:[],intensity:null},"FLLK":{temp:23,conditions:[],intensity:null},"FVHA":{temp:19,conditions:[],intensity:null},"FLLS":{temp:22,conditions:[],intensity:null},"FYWH":{temp:22,conditions:[],intensity:null},
  "FBSK":{temp:20,conditions:[],intensity:null},"FAOR":{temp:17,conditions:[],intensity:null},"FACT":{temp:13,conditions:[],intensity:null},"FALE":{temp:19,conditions:[],intensity:null},"FAPE":{temp:15,conditions:[],intensity:null},"FQMA":{temp:22,conditions:[],intensity:null},"FWKI":{temp:20,conditions:[],intensity:null},"ZBAA":{temp:21,conditions:[],intensity:null},"ZBAD":{temp:21,conditions:[],intensity:null},"ZSPD":{temp:24,conditions:[],intensity:null},
  "ZSSS":{temp:25,conditions:[],intensity:null},"ZGGG":{temp:27,conditions:[],intensity:null},"VHHH":{temp:29,conditions:[],intensity:null},"ZGSZ":{temp:27,conditions:[],intensity:null},"ZUUU":{temp:25,conditions:[],intensity:null},"ZUCK":{temp:22,conditions:[],intensity:null},"ZHCC":{temp:24,conditions:[],intensity:null},"ZLXY":{temp:27,conditions:[],intensity:null},"ZWSH":{temp:32,conditions:[],intensity:null},"ZYHB":{temp:23,conditions:[],intensity:null},
  "ZYTX":{temp:21,conditions:[],intensity:null},"ZSAM":{temp:27,conditions:[],intensity:null},"ZGKL":{temp:24,conditions:[],intensity:null},"ZSNJ":{temp:23,conditions:[],intensity:null},"ZSHC":{temp:25,conditions:["thunderstorm"],intensity:null},"ZPPP":{temp:17,conditions:[],intensity:null},"ZBTJ":{temp:22,conditions:[],intensity:null},"VMMC":{temp:29,conditions:[],intensity:null},"RJTT":{temp:23,conditions:[],intensity:null},"RJAA":{temp:21,conditions:[],intensity:null},
  "RJBB":{temp:24,conditions:[],intensity:null},"RJOO":{temp:23,conditions:[],intensity:null},"RJCC":{temp:13,conditions:[],intensity:null},"RJFF":{temp:23,conditions:[],intensity:null},"RJGG":{temp:23,conditions:[],intensity:null},"ROAH":{temp:27,conditions:[],intensity:null},"RJSS":{temp:20,conditions:[],intensity:null},"RJSN":{temp:21,conditions:[],intensity:null},"RJOK":{temp:23,conditions:[],intensity:null},"RKSI":{temp:23,conditions:[],intensity:null},
  "RKSS":{temp:22,conditions:[],intensity:null},"RKPK":{temp:21,conditions:[],intensity:null},"RKPC":{temp:23,conditions:[],intensity:null},"RKTN":{temp:21,conditions:[],intensity:null},"ZKPY":{temp:20,conditions:[],intensity:null},"WSSS":{temp:26,conditions:[],intensity:null},"WMKK":{temp:26,conditions:[],intensity:null},"WMKP":{temp:27,conditions:[],intensity:null},"WBKK":{temp:25,conditions:[],intensity:null},"WBGG":{temp:24,conditions:[],intensity:null},
  "VTBS":{temp:29,conditions:[],intensity:null},"VTBD":{temp:29,conditions:[],intensity:null},"VTSP":{temp:26,conditions:["thunderstorm"],intensity:null},"VTCC":{temp:25,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:29,conditions:[],intensity:null},"VVNB":{temp:25,conditions:["thunderstorm"],intensity:null},"VVTS":{temp:26,conditions:[],intensity:null},"VVDN":{temp:27,conditions:["thunderstorm"],intensity:null},"VVCR":{temp:29,conditions:[],intensity:null},
  "VDPP":{temp:28,conditions:[],intensity:null},"VDSR":{temp:29,conditions:[],intensity:null},"VLVT":{temp:26,conditions:[],intensity:null},"VLLB":{temp:26,conditions:[],intensity:null},"VYYY":{temp:26,conditions:[],intensity:null},"VYMD":{temp:28,conditions:[],intensity:null},"VGHS":{temp:28,conditions:[],intensity:null},"VGCG":{temp:27,conditions:[],intensity:null},"VECC":{temp:27,conditions:[],intensity:null},"VRMM":{temp:28,conditions:[],intensity:null},
  "VCBI":{temp:28,conditions:[],intensity:null},"WIII":{temp:27,conditions:[],intensity:null},"WADD":{temp:25,conditions:[],intensity:null},"WARR":{temp:27,conditions:[],intensity:null},"WIHH":{temp:28,conditions:[],intensity:null},"WIMM":{temp:26,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:25,conditions:[],intensity:null},"WICC":{temp:22,conditions:[],intensity:null},"WASS":{temp:25,conditions:[],intensity:null},
  "RPLL":{temp:27,conditions:[],intensity:null},"RPLC":{temp:25,conditions:[],intensity:null},"RPVM":{temp:26,conditions:[],intensity:null},"RPVD":{temp:24,conditions:["thunderstorm"],intensity:null},"RPVK":{temp:26,conditions:[],intensity:null},"WBSB":{temp:25,conditions:[],intensity:null},"WBLL":{temp:27,conditions:[],intensity:null},"VIDP":{temp:33,conditions:["thunderstorm"],intensity:null},"VABB":{temp:26,conditions:["thunderstorm"],intensity:null},"VOBL":{temp:22,conditions:[],intensity:null},
  "VOMM":{temp:28,conditions:[],intensity:null},"VEBS":{temp:27,conditions:[],intensity:null},"VOHY":{temp:26,conditions:[],intensity:null},"VAAH":{temp:32,conditions:[],intensity:null},"VOCI":{temp:25,conditions:[],intensity:null},"VAGO":{temp:25,conditions:["thunderstorm"],intensity:null},"VOTP":{temp:25,conditions:[],intensity:null},"VIAR":{temp:32,conditions:[],intensity:null},"VIJP":{temp:29,conditions:[],intensity:null},"VELR":{temp:23,conditions:[],intensity:null},
  "VOCL":{temp:24,conditions:[],intensity:null},"VOTV":{temp:26,conditions:[],intensity:null},"VEPT":{temp:30,conditions:["thunderstorm"],intensity:null},"VNKT":{temp:22,conditions:[],intensity:null},"OPKC":{temp:30,conditions:[],intensity:null},"OPLA":{temp:35,conditions:[],intensity:null},"OPIS":{temp:35,conditions:["thunderstorm"],intensity:null},"RCTP":{temp:27,conditions:[],intensity:null},"RCSS":{temp:26,conditions:[],intensity:null},"RCMQ":{temp:26,conditions:[],intensity:null},
  "RCKH":{temp:28,conditions:["thunderstorm"],intensity:null},"RCNN":{temp:28,conditions:[],intensity:null},"YSSY":{temp:14,conditions:[],intensity:null},"YMML":{temp:11,conditions:[],intensity:null},"YBBN":{temp:15,conditions:[],intensity:null},"YPPH":{temp:9,conditions:[],intensity:null},"YPAD":{temp:12,conditions:[],intensity:null},"YBCG":{temp:14,conditions:[],intensity:null},"YBCS":{temp:21,conditions:[],intensity:null},"YSCB":{temp:11,conditions:[],intensity:null},
  "YMHB":{temp:10,conditions:[],intensity:null},"NZAA":{temp:6,conditions:[],intensity:null},"NZWN":{temp:5,conditions:[],intensity:null},"NZCH":{temp:3,conditions:[],intensity:null},"NZQN":{temp:2,conditions:[],intensity:null},"NZDN":{temp:3,conditions:[],intensity:null},"NFFN":{temp:18,conditions:[],intensity:null},"NWWW":{temp:16,conditions:[],intensity:null},"NTAA":{temp:22,conditions:[],intensity:null},"NSFA":{temp:24,conditions:[],intensity:null},
  "NIUE":{temp:22,conditions:[],intensity:null},"PGSN":{temp:28,conditions:[],intensity:null},"PGUM":{temp:27,conditions:[],intensity:null},"PHOG":{temp:24,conditions:[],intensity:null},"PHKO":{temp:24,conditions:[],intensity:null},"PHLH":{temp:24,conditions:[],intensity:null}
};
