...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:9,conditions:[],intensity:null},"KLAX":{temp:20,conditions:[],intensity:null},"KORD":{temp:-9,conditions:[],intensity:null},"KDFW":{temp:5,conditions:[],intensity:null},"KDEN":{temp:1,conditions:[],intensity:null},"KJFK":{temp:1,conditions:[],intensity:null},"KSFO":{temp:16,conditions:[],intensity:null},"KSEA":{temp:9,conditions:[],intensity:null},"KLAS":{temp:20,conditions:[],intensity:null},"KMCO":{temp:20,conditions:[],intensity:null},
  "KEWR":{temp:0,conditions:[],intensity:null},"KMIA":{temp:22,conditions:[],intensity:null},"KPHX":{temp:24,conditions:[],intensity:null},"KIAH":{temp:12,conditions:[],intensity:null},"KBOS":{temp:2,conditions:[],intensity:null},"KMSP":{temp:-17,conditions:[],intensity:null},"KFLL":{temp:21,conditions:[],intensity:null},"KDTW":{temp:-8,conditions:[],intensity:null},"KPHL":{temp:0,conditions:[],intensity:null},"KLGA":{temp:0,conditions:[],intensity:null},
  "KBWI":{temp:0,conditions:[],intensity:null},"KSLC":{temp:5,conditions:[],intensity:null},"KDCA":{temp:3,conditions:[],intensity:null},"KIAD":{temp:3,conditions:[],intensity:null},"KSAN":{temp:25,conditions:[],intensity:null},"KTPA":{temp:18,conditions:[],intensity:null},"KPDX":{temp:9,conditions:[],intensity:null},"KSTL":{temp:-8,conditions:[],intensity:null},"KHNL":{temp:26,conditions:[],intensity:null},"KMEM":{temp:0,conditions:[],intensity:null},
  ...
  "KIND":{temp:-7,conditions:[],intensity:null},"KCVG":{temp:-2,conditions:[],intensity:null},"KMCI":{temp:-11,conditions:[],intensity:null},"KSAT":{temp:12,conditions:[],intensity:null},"KHOU":{temp:12,conditions:[],intensity:null},"KDAL":{temp:3,conditions:[],intensity:null},"KMDW":{temp:-9,conditions:[],intensity:null},"PANC":{temp:-2,conditions:["snow"],intensity:null},"PAFA":{temp:-12,conditions:[],intensity:null},"CYYZ":{temp:-5,conditions:[],intensity:null},
  "CYVR":{temp:6,conditions:[],intensity:null},"CYUL":{temp:-8,conditions:[],intensity:null},"CYYC":{temp:7,conditions:[],intensity:null},"CYEG":{temp:5,conditions:[],intensity:null},"CYOW":{temp:-5,conditions:[],intensity:null},"CYWG":{temp:-25,conditions:[],intensity:null},"CYHZ":{temp:2,conditions:[],intensity:null},"CYQB":{temp:-9,conditions:[],intensity:null},"CYYJ":{temp:8,conditions:[],intensity:null},"CYLW":{temp:1,conditions:[],intensity:null},
  ...
  "MMTJ":{temp:24,conditions:[],intensity:null},"MMSM":{temp:28,conditions:[],intensity:null},"MMMD":{temp:24,conditions:[],intensity:null},"MMCZ":{temp:25,conditions:[],intensity:null},"MMSD":{temp:27,conditions:[],intensity:null},"MGGT":{temp:21,conditions:[],intensity:null},"MSLP":{temp:28,conditions:[],intensity:null},"MHTG":{temp:25,conditions:[],intensity:null},"MNMG":{temp:29,conditions:[],intensity:null},"MROC":{temp:26,conditions:[],intensity:null},
  ...
  "SBPA":{temp:26,conditions:[],intensity:null},"SBCT":{temp:21,conditions:[],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:26,conditions:[],intensity:null},"SAEZ":{temp:29,conditions:[],intensity:null},"SABE":{temp:29,conditions:[],intensity:null},"SACO":{temp:26,conditions:[],intensity:null},"SAME":{temp:25,conditions:[],intensity:null},"SLLP":{temp:10,conditions:[],intensity:null},"SLVR":{temp:25,conditions:[],intensity:null},
  "SPJC":{temp:21,conditions:[],intensity:null},"SEQM":{temp:13,conditions:[],intensity:null},"SEGU":{temp:28,conditions:[],intensity:null},"SKBO":{temp:15,conditions:[],intensity:null},"SKMR":{temp:26,conditions:[],intensity:null},"SKCL":{temp:23,conditions:[],intensity:null},"SKMD":{temp:26,conditions:[],intensity:null},"SKRG":{temp:17,conditions:[],intensity:null},"SVMI":{temp:25,conditions:[],intensity:null},"SUMU":{temp:23,conditions:[],intensity:null},
  ...
  "HEGN":{temp:14,conditions:[],intensity:null},"HESH":{temp:14,conditions:[],intensity:null},"HEBA":{temp:13,conditions:[],intensity:null},"HEAX":{temp:14,conditions:[],intensity:null},"HLLT":{temp:12,conditions:[],intensity:null},"DNMM":{temp:27,conditions:[],intensity:null},"DNAA":{temp:24,conditions:[],intensity:null},"DGAA":{temp:27,conditions:[],intensity:null},"DIAP":{temp:27,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  ...
  "VTBS":{temp:24,conditions:[],intensity:null},"VTBD":{temp:23,conditions:[],intensity:null},"VTSP":{temp:25,conditions:[],intensity:null},"VTCC":{temp:18,conditions:[],intensity:null},"VTSS":{temp:25,conditions:[],intensity:null},"VTUK":{temp:25,conditions:[],intensity:null},"VVNB":{temp:19,conditions:[],intensity:null},"VVTS":{temp:22,conditions:[],intensity:null},"VVDN":{temp:18,conditions:["fog"],intensity:null},"VVCR":{temp:20,conditions:["fog"],intensity:null},
  ...
  "VCBI":{temp:25,conditions:[],intensity:null},"WIII":{temp:24,conditions:["rain"],intensity:null},"WADD":{temp:28,conditions:["thunderstorm"],intensity:null},"WARR":{temp:26,conditions:[],intensity:null},"WIHH":{temp:25,conditions:[],intensity:null},"WIMM":{temp:24,conditions:[],intensity:null},"WIBB":{temp:27,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:21,conditions:[],intensity:null},"WASS":{temp:28,conditions:[],intensity:null},
  ...
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:17,conditions:[],intensity:null},"YSSY":{temp:19,conditions:[],intensity:null},"YMML":{temp:21,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:18,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:23,conditions:[],intensity:null},"YBCS":{temp:27,conditions:[],intensity:null},"YSCB":{temp:16,conditions:[],intensity:null},
