...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:-1,conditions:[],intensity:null},"KLAX":{temp:11,conditions:[],intensity:null},"KORD":{temp:-10,conditions:[],intensity:null},"KDFW":{temp:4,conditions:[],intensity:null},"KDEN":{temp:-4,conditions:["snow"],intensity:null},"KJFK":{temp:-1,conditions:[],intensity:null},"KSFO":{temp:9,conditions:[],intensity:null},"KSEA":{temp:3,conditions:[],intensity:null},"KLAS":{temp:8,conditions:[],intensity:null},"KMCO":{temp:3,conditions:[],intensity:null},
  "KEWR":{temp:-3,conditions:[],intensity:null},"KMIA":{temp:11,conditions:[],intensity:null},"KPHX":{temp:9,conditions:[],intensity:null},"KIAH":{temp:3,conditions:[],intensity:null},"KBOS":{temp:-1,conditions:[],intensity:null},"KMSP":{temp:-21,conditions:[],intensity:null},"KFLL":{temp:10,conditions:[],intensity:null},"KDTW":{temp:-8,conditions:[],intensity:null},"KPHL":{temp:-6,conditions:[],intensity:null},"KLGA":{temp:-3,conditions:[],intensity:null},
  "KBWI":{temp:-7,conditions:[],intensity:null},"KSLC":{temp:-4,conditions:[],intensity:null},"KDCA":{temp:-5,conditions:[],intensity:null},"KIAD":{temp:-8,conditions:[],intensity:null},"KSAN":{temp:12,conditions:[],intensity:null},"KTPA":{temp:2,conditions:[],intensity:null},"KPDX":{temp:2,conditions:[],intensity:null},"KSTL":{temp:-5,conditions:[],intensity:null},"KHNL":{temp:22,conditions:[],intensity:null},"KMEM":{temp:-2,conditions:[],intensity:null},
  ...
  "KIND":{temp:-7,conditions:[],intensity:null},"KCVG":{temp:-5,conditions:[],intensity:null},"KMCI":{temp:-9,conditions:[],intensity:null},"KSAT":{temp:1,conditions:[],intensity:null},"KHOU":{temp:3,conditions:[],intensity:null},"KDAL":{temp:4,conditions:[],intensity:null},"KMDW":{temp:-11,conditions:[],intensity:null},"PANC":{temp:2,conditions:[],intensity:null},"PAFA":{temp:-8,conditions:[],intensity:null},"CYYZ":{temp:-9,conditions:[],intensity:null},
  "CYVR":{temp:3,conditions:[],intensity:null},"CYUL":{temp:-10,conditions:[],intensity:null},"CYYC":{temp:-9,conditions:[],intensity:null},"CYEG":{temp:-13,conditions:[],intensity:null},"CYOW":{temp:-13,conditions:[],intensity:null},"CYWG":{temp:-27,conditions:[],intensity:null},"CYHZ":{temp:0,conditions:["snow"],intensity:null},"CYQB":{temp:-13,conditions:[],intensity:null},"CYYJ":{temp:4,conditions:[],intensity:null},"CYLW":{temp:-1,conditions:[],intensity:null},
  ...
  "SBPA":{temp:22,conditions:[],intensity:null},"SBCT":{temp:19,conditions:[],intensity:null},"SBFZ":{temp:25,conditions:[],intensity:null},"SCEL":{temp:18,conditions:[],intensity:null},"SAEZ":{temp:12,conditions:[],intensity:null},"SABE":{temp:14,conditions:[],intensity:null},"SACO":{temp:14,conditions:[],intensity:null},"SAME":{temp:16,conditions:[],intensity:null},"SLLP":{temp:5,conditions:["fog"],intensity:null},"SLVR":{temp:23,conditions:[],intensity:null},
  "SPJC":{temp:20,conditions:[],intensity:null},"SEQM":{temp:10,conditions:["fog"],intensity:null},"SEGU":{temp:24,conditions:[],intensity:null},"SKBO":{temp:9,conditions:[],intensity:null},"SKMR":{temp:24,conditions:[],intensity:null},"SKCL":{temp:21,conditions:[],intensity:null},"SKMD":{temp:22,conditions:[],intensity:null},"SKRG":{temp:12,conditions:[],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:14,conditions:[],intensity:null},
  ...
  "EGPH":{temp:0,conditions:["fog"],intensity:null},"EGPF":{temp:3,conditions:[],intensity:null},"EGGW":{temp:7,conditions:[],intensity:null},"EGNX":{temp:7,conditions:[],intensity:null},"EGNT":{temp:5,conditions:[],intensity:null},"EGGP":{temp:3,conditions:["fog"],intensity:null},"EGHI":{temp:9,conditions:[],intensity:null},"EGGD":{temp:6,conditions:["fog"],intensity:null},"EGPD":{temp:3,conditions:[],intensity:null},"EGAA":{temp:7,conditions:[],intensity:null},
  "EIDW":{temp:7,conditions:[],intensity:null},"EICK":{temp:5,conditions:[],intensity:null},"EINN":{temp:6,conditions:[],intensity:null},"LFPG":{temp:2,conditions:["fog"],intensity:null},"LFPO":{temp:2,conditions:["fog"],intensity:null},"LFML":{temp:13,conditions:[],intensity:null},"LFLL":{temp:1,conditions:["fog"],intensity:null},"LFMN":{temp:14,conditions:[],intensity:null},"LFBD":{temp:8,conditions:[],intensity:null},"LFBO":{temp:8,conditions:[],intensity:null},
  "LFRS":{temp:9,conditions:[],intensity:null},"LFSB":{temp:0,conditions:[],intensity:null},"LFPB":{temp:3,conditions:[],intensity:null},"EDDF":{temp:0,conditions:[],intensity:null},"EDDM":{temp:-2,conditions:[],intensity:null},"EDDB":{temp:-2,conditions:[],intensity:null},"EDDL":{temp:2,conditions:[],intensity:null},"EDDH":{temp:-1,conditions:[],intensity:null},"EDDK":{temp:2,conditions:[],intensity:null},"EDDS":{temp:-2,conditions:["fog"],intensity:null},
  "EDDW":{temp:-2,conditions:[],intensity:null},"EDDN":{temp:0,conditions:[],intensity:null},"EDDV":{temp:-2,conditions:[],intensity:null},"EDDP":{temp:0,conditions:[],intensity:null},"LEMD":{temp:1,conditions:[],intensity:null},"LEBL":{temp:11,conditions:[],intensity:null},"LEPA":{temp:11,conditions:[],intensity:null},"LEMG":{temp:10,conditions:[],intensity:null},"LEVC":{temp:10,conditions:[],intensity:null},"LEAL":{temp:11,conditions:[],intensity:null},
  "LEZL":{temp:4,conditions:[],intensity:null},"GCLP":{temp:18,conditions:[],intensity:null},"GCTS":{temp:15,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:16,conditions:[],intensity:null},"LPPT":{temp:9,conditions:[],intensity:null},"LPPR":{temp:5,conditions:["fog"],intensity:null},"LPFR":{temp:8,conditions:[],intensity:null},"LPMA":{temp:14,conditions:[],intensity:null},"LIRF":{temp:12,conditions:[],intensity:null},
  "LIMC":{temp:5,conditions:[],intensity:null},"LIME":{temp:5,conditions:[],intensity:null},"LIPZ":{temp:3,conditions:[],intensity:null},"LIRN":{temp:10,conditions:[],intensity:null},"LIML":{temp:5,conditions:[],intensity:null},"LIPE":{temp:5,conditions:[],intensity:null},"LICC":{temp:14,conditions:[],intensity:null},"LICJ":{temp:16,conditions:[],intensity:null},"LIRA":{temp:12,conditions:[],intensity:null},"LIRP":{temp:12,conditions:[],intensity:null},
  "LIMF":{temp:5,conditions:[],intensity:null},"LIEO":{temp:13,conditions:["rain"],intensity:null},"LIEE":{temp:13,conditions:[],intensity:null},"EHAM":{temp:2,conditions:[],intensity:null},"EHRD":{temp:3,conditions:[],intensity:null},"EHEH":{temp:2,conditions:[],intensity:null},"EBBR":{temp:5,conditions:[],intensity:null},"EBCI":{temp:4,conditions:[],intensity:null},"ELLX":{temp:0,conditions:[],intensity:null},"LSZH":{temp:-1,conditions:["fog"],intensity:null},
  "LSGG":{temp:1,conditions:["fog"],intensity:null},"LSZB":{temp:-1,conditions:["fog"],intensity:null},"LOWW":{temp:-5,conditions:[],intensity:null},"LOWS":{temp:-4,conditions:[],intensity:null},"LOWG":{temp:-3,conditions:[],intensity:null},"LOWI":{temp:5,conditions:[],intensity:null},"LKPR":{temp:-2,conditions:[],intensity:null},"EPWA":{temp:-10,conditions:[],intensity:null},"EPKK":{temp:-10,conditions:[],intensity:null},"EPGD":{temp:-9,conditions:[],intensity:null},
  ...
  "LGMK":{temp:8,conditions:[],intensity:null},"LTFM":{temp:1,conditions:[],intensity:null},"LTBA":{temp:2,conditions:[],intensity:null},"LTFJ":{temp:3,conditions:[],intensity:null},"LTAI":{temp:9,conditions:[],intensity:null},"LTAC":{temp:-3,conditions:[],intensity:null},"LTBJ":{temp:5,conditions:[],intensity:null},"LTBS":{temp:11,conditions:[],intensity:null},"LTFE":{temp:8,conditions:[],intensity:null},"LCLK":{temp:11,conditions:[],intensity:null},
  "LCPH":{temp:11,conditions:[],intensity:null},"LHBP":{temp:-4,conditions:[],intensity:null},"LROP":{temp:-5,conditions:[],intensity:null},"LBSF":{temp:-5,conditions:[],intensity:null},"LYBE":{temp:-4,conditions:[],intensity:null},"LDZA":{temp:-4,conditions:[],intensity:null},"LDDU":{temp:8,conditions:[],intensity:null},"LDSP":{temp:9,conditions:[],intensity:null},"LJLJ":{temp:-3,conditions:[],intensity:null},"LWSK":{temp:0,conditions:[],intensity:null},
  ...
  "UUOB":{temp:-27,conditions:[],intensity:null},"UHWW":{temp:-14,conditions:[],intensity:null},"UEEE":{temp:-30,conditions:[],intensity:null},"OMDB":{temp:21,conditions:[],intensity:null},"OMDW":{temp:23,conditions:[],intensity:null},"OMAA":{temp:24,conditions:[],intensity:null},"OMSJ":{temp:24,conditions:[],intensity:null},"OTHH":{temp:21,conditions:[],intensity:null},"OERK":{temp:21,conditions:[],intensity:null},"OEJN":{temp:27,conditions:[],intensity:null},
  "OEDF":{temp:23,conditions:[],intensity:null},"OEMA":{temp:19,conditions:[],intensity:null},"OKBK":{temp:17,conditions:[],intensity:null},"OBBI":{temp:19,conditions:[],intensity:null},"OOMS":{temp:26,conditions:[],intensity:null},"OYAA":{temp:20,conditions:[],intensity:null},"OIIE":{temp:4,conditions:[],intensity:null},"OIII":{temp:1,conditions:[],intensity:null},"OISS":{temp:9,conditions:[],intensity:null},"OIKB":{temp:21,conditions:[],intensity:null},
  ...
  "GMMX":{temp:7,conditions:["fog"],intensity:null},"GMTT":{temp:10,conditions:[],intensity:null},"GMFF":{temp:6,conditions:[],intensity:null},"GMAD":{temp:9,conditions:[],intensity:null},"DAAG":{temp:10,conditions:[],intensity:null},"DAOO":{temp:9,conditions:[],intensity:null},"DTTA":{temp:14,conditions:[],intensity:null},"DTMB":{temp:15,conditions:[],intensity:null},"DTTJ":{temp:15,conditions:[],intensity:null},"HECA":{temp:16,conditions:[],intensity:null},
  ...
  "GABS":{temp:20,conditions:[],intensity:null},"GVNP":{temp:19,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:29,conditions:[],intensity:null},"DBBB":{temp:30,conditions:[],intensity:null},"HKJK":{temp:24,conditions:[],intensity:null},"HKMO":{temp:33,conditions:[],intensity:null},"HTDA":{temp:32,conditions:[],intensity:null},"HTKJ":{temp:29,conditions:[],intensity:null},
  "HUEN":{temp:26,conditions:[],intensity:null},"HRYR":{temp:25,conditions:[],intensity:null},"HAAB":{temp:21,conditions:[],intensity:null},"HDAM":{temp:27,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:27,conditions:[],intensity:null},"FMEE":{temp:29,conditions:[],intensity:null},"FIMP":{temp:28,conditions:[],intensity:null},"FMCH":{temp:31,conditions:[],intensity:null},"FMMI":{temp:25,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:27,conditions:[],intensity:null},"FKYS":{temp:26,conditions:[],intensity:null},"FOOL":{temp:28,conditions:[],intensity:null},"FZAA":{temp:28,conditions:[],intensity:null},"FCBB":{temp:26,conditions:[],intensity:null},"FLLK":{temp:26,conditions:[],intensity:null},"FVHA":{temp:24,conditions:[],intensity:null},"FLLS":{temp:25,conditions:[],intensity:null},"FYWH":{temp:27,conditions:[],intensity:null},
  "FBSK":{temp:27,conditions:[],intensity:null},"FAOR":{temp:19,conditions:[],intensity:null},"FACT":{temp:23,conditions:[],intensity:null},"FALE":{temp:20,conditions:[],intensity:null},"FAPE":{temp:25,conditions:[],intensity:null},"FQMA":{temp:22,conditions:[],intensity:null},"FWKI":{temp:26,conditions:[],intensity:null},"ZBAA":{temp:-6,conditions:[],intensity:null},"ZBAD":{temp:-6,conditions:[],intensity:null},"ZSPD":{temp:6,conditions:[],intensity:null},
  ...
  "ZYTX":{temp:-17,conditions:[],intensity:null},"ZSAM":{temp:21,conditions:[],intensity:null},"ZGKL":{temp:13,conditions:[],intensity:null},"ZSNJ":{temp:0,conditions:[],intensity:null},"ZSHC":{temp:6,conditions:[],intensity:null},"ZPPP":{temp:18,conditions:[],intensity:null},"ZBTJ":{temp:-8,conditions:[],intensity:null},"VMMC":{temp:21,conditions:[],intensity:null},"RJTT":{temp:9,conditions:[],intensity:null},"RJAA":{temp:9,conditions:[],intensity:null},
  ...
  "RKSS":{temp:-7,conditions:[],intensity:null},"RKPK":{temp:3,conditions:[],intensity:null},"RKPC":{temp:3,conditions:[],intensity:null},"RKTN":{temp:-1,conditions:[],intensity:null},"ZKPY":{temp:-13,conditions:[],intensity:null},"WSSS":{temp:29,conditions:[],intensity:null},"WMKK":{temp:30,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:28,conditions:[],intensity:null},
  "VTBS":{temp:32,conditions:[],intensity:null},"VTBD":{temp:33,conditions:[],intensity:null},"VTSP":{temp:30,conditions:[],intensity:null},"VTCC":{temp:29,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:26,conditions:[],intensity:null},"VVTS":{temp:30,conditions:[],intensity:null},"VVDN":{temp:24,conditions:[],intensity:null},"VVCR":{temp:28,conditions:[],intensity:null},
  ...
  "VOMM":{temp:29,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:29,conditions:[],intensity:null},"VAAH":{temp:27,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:29,conditions:[],intensity:null},"VOTP":{temp:29,conditions:[],intensity:null},"VIAR":{temp:19,conditions:[],intensity:null},"VIJP":{temp:25,conditions:[],intensity:null},"VELR":{temp:19,conditions:[],intensity:null},
  ...
  "RCKH":{temp:23,conditions:[],intensity:null},"RCNN":{temp:21,conditions:[],intensity:null},"YSSY":{temp:18,conditions:[],intensity:null},"YMML":{temp:27,conditions:[],intensity:null},"YBBN":{temp:24,conditions:[],intensity:null},"YPPH":{temp:36,conditions:[],intensity:null},"YPAD":{temp:21,conditions:[],intensity:null},"YBCG":{temp:21,conditions:[],intensity:null},"YBCS":{temp:27,conditions:[],intensity:null},"YSCB":{temp:19,conditions:[],intensity:null},
  "YMHB":{temp:18,conditions:[],intensity:null},"NZAA":{temp:20,conditions:[],intensity:null},"NZWN":{temp:16,conditions:[],intensity:null},"NZCH":{temp:12,conditions:[],intensity:null},"NZQN":{temp:17,conditions:[],intensity:null},"NZDN":{temp:11,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:32,conditions:[],intensity:null},"NTAA":{temp:25,conditions:["thunderstorm"],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
