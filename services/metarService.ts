...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LFRS":{temp:9,conditions:["rain"],intensity:null},"LFSB":{temp:-1,conditions:["fog"],intensity:null},"LFPB":{temp:8,conditions:[],intensity:null},"EDDF":{temp:-4,conditions:["fog"],intensity:null},"EDDM":{temp:-4,conditions:[],intensity:null},"EDDB":{temp:-5,conditions:[],intensity:null},"EDDL":{temp:3,conditions:[],intensity:null},"EDDH":{temp:-2,conditions:[],intensity:null},"EDDK":{temp:1,conditions:[],intensity:null},"EDDS":{temp:-2,conditions:[],intensity:null},
  ...
  "LIMF":{temp:0,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:13,conditions:[],intensity:null},"EHAM":{temp:3,conditions:[],intensity:null},"EHRD":{temp:4,conditions:[],intensity:null},"EHEH":{temp:2,conditions:[],intensity:null},"EBBR":{temp:6,conditions:[],intensity:null},"EBCI":{temp:4,conditions:[],intensity:null},"ELLX":{temp:-1,conditions:[],intensity:null},"LSZH":{temp:-4,conditions:["fog"],intensity:null},
  ...
  "EPWR":{temp:-2,conditions:[],intensity:null},"EPPO":{temp:-3,conditions:[],intensity:null},"EKCH":{temp:0,conditions:[],intensity:null},"ESSA":{temp:-2,conditions:[],intensity:null},"ENGM":{temp:-4,conditions:[],intensity:null},"EFHK":{temp:-3,conditions:[],intensity:null},"BIKF":{temp:2,conditions:[],intensity:null},"ESGG":{temp:-3,conditions:[],intensity:null},"ESMS":{temp:-4,conditions:[],intensity:null},"ENBR":{temp:1,conditions:[],intensity:null},
  "ENZV":{temp:0,conditions:[],intensity:null},"ENTC":{temp:-7,conditions:[],intensity:null},"EFOU":{temp:-10,conditions:[],intensity:null},"EFRO":{temp:-13,conditions:[],intensity:null},"LGAV":{temp:9,conditions:[],intensity:null},"LGTS":{temp:0,conditions:[],intensity:null},"LGIR":{temp:10,conditions:[],intensity:null},"LGKR":{temp:10,conditions:[],intensity:null},"LGRP":{temp:12,conditions:[],intensity:null},"LGSR":{temp:13,conditions:[],intensity:null},
