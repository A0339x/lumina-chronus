...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KBWI":{temp:0,conditions:[],intensity:null},"KSLC":{temp:1,conditions:[],intensity:null},"KDCA":{temp:1,conditions:[],intensity:null},"KIAD":{temp:-1,conditions:[],intensity:null},"KSAN":{temp:13,conditions:[],intensity:null},"KTPA":{temp:13,conditions:[],intensity:null},"KPDX":{temp:1,conditions:[],intensity:null},"KSTL":{temp:11,conditions:[],intensity:null},"KHNL":{temp:25,conditions:[],intensity:null},"KMEM":{temp:13,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:23,conditions:["fog"],intensity:null},"TIST":{temp:25,conditions:[],intensity:null},"TLPL":{temp:25,conditions:[],intensity:null},"TAPA":{temp:24,conditions:[],intensity:null},"SBGR":{temp:18,conditions:[],intensity:null},"SBGL":{temp:23,conditions:[],intensity:null},"SBBR":{temp:18,conditions:[],intensity:null},"SBCF":{temp:18,conditions:[],intensity:null},"SBSV":{temp:27,conditions:[],intensity:null},"SBRF":{temp:25,conditions:["fog"],intensity:null},
  "SBPA":{temp:20,conditions:[],intensity:null},"SBCT":{temp:15,conditions:[],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:13,conditions:[],intensity:null},"SAEZ":{temp:19,conditions:[],intensity:null},"SABE":{temp:18,conditions:[],intensity:null},"SACO":{temp:16,conditions:[],intensity:null},"SAME":{temp:21,conditions:[],intensity:null},"SLLP":{temp:4,conditions:["fog"],intensity:null},"SLVR":{temp:21,conditions:[],intensity:null},
  "SPJC":{temp:19,conditions:[],intensity:null},"SEQM":{temp:10,conditions:["fog"],intensity:null},"SEGU":{temp:23,conditions:[],intensity:null},"SKBO":{temp:11,conditions:["fog"],intensity:null},"SKMR":{temp:25,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:22,conditions:["thunderstorm"],intensity:null},"SKRG":{temp:14,conditions:["fog"],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:16,conditions:[],intensity:null},
  "SGAS":{temp:22,conditions:[],intensity:null},"SBBV":{temp:25,conditions:[],intensity:null},"SMJP":{temp:24,conditions:[],intensity:null},"SYCJ":{temp:23,conditions:[],intensity:null},"EGLL":{temp:-2,conditions:[],intensity:null},"EGKK":{temp:-2,conditions:[],intensity:null},"EGSS":{temp:-3,conditions:[],intensity:null},"EGLC":{temp:-1,conditions:[],intensity:null},"EGCC":{temp:-1,conditions:[],intensity:null},"EGBB":{temp:-1,conditions:[],intensity:null},
  "EGPH":{temp:2,conditions:[],intensity:null},"EGPF":{temp:2,conditions:[],intensity:null},"EGGW":{temp:-2,conditions:[],intensity:null},"EGNX":{temp:-1,conditions:[],intensity:null},"EGNT":{temp:-1,conditions:[],intensity:null},"EGGP":{temp:4,conditions:[],intensity:null},"EGHI":{temp:-2,conditions:[],intensity:null},"EGGD":{temp:2,conditions:[],intensity:null},"EGPD":{temp:-1,conditions:["snow"],intensity:null},"EGAA":{temp:2,conditions:[],intensity:null},
  "EIDW":{temp:3,conditions:[],intensity:null},"EICK":{temp:4,conditions:[],intensity:null},"EINN":{temp:5,conditions:[],intensity:null},"LFPG":{temp:-4,conditions:[],intensity:null},"LFPO":{temp:-3,conditions:[],intensity:null},"LFML":{temp:2,conditions:[],intensity:null},"LFLL":{temp:-4,conditions:[],intensity:null},"LFMN":{temp:9,conditions:[],intensity:null},"LFBD":{temp:1,conditions:[],intensity:null},"LFBO":{temp:-5,conditions:[],intensity:null},
  "LFRS":{temp:-1,conditions:[],intensity:null},"LFSB":{temp:-6,conditions:[],intensity:null},"LFPB":{temp:-4,conditions:["fog"],intensity:null},"EDDF":{temp:-3,conditions:[],intensity:null},"EDDM":{temp:-10,conditions:[],intensity:null},"EDDB":{temp:-7,conditions:[],intensity:null},"EDDL":{temp:-1,conditions:[],intensity:null},"EDDH":{temp:-1,conditions:["snow"],intensity:null},"EDDK":{temp:-1,conditions:[],intensity:null},"EDDS":{temp:-5,conditions:[],intensity:null},
  "EDDW":{temp:-1,conditions:[],intensity:null},"EDDN":{temp:-6,conditions:[],intensity:null},"EDDV":{temp:-1,conditions:[],intensity:null},"EDDP":{temp:-4,conditions:[],intensity:null},"LEMD":{temp:2,conditions:[],intensity:null},"LEBL":{temp:5,conditions:[],intensity:null},"LEPA":{temp:8,conditions:[],intensity:null},"LEMG":{temp:7,conditions:[],intensity:null},"LEVC":{temp:5,conditions:[],intensity:null},"LEAL":{temp:7,conditions:[],intensity:null},
  "LEZL":{temp:5,conditions:[],intensity:null},"GCLP":{temp:18,conditions:[],intensity:null},"GCTS":{temp:16,conditions:[],intensity:null},"GCLA":{temp:18,conditions:[],intensity:null},"GCFV":{temp:17,conditions:[],intensity:null},"LPPT":{temp:8,conditions:[],intensity:null},"LPPR":{temp:6,conditions:[],intensity:null},"LPFR":{temp:8,conditions:[],intensity:null},"LPMA":{temp:13,conditions:[],intensity:null},"LIRF":{temp:13,conditions:[],intensity:null},
  "LIMC":{temp:-2,conditions:[],intensity:null},"LIME":{temp:0,conditions:[],intensity:null},"LIPZ":{temp:3,conditions:[],intensity:null},"LIRN":{temp:15,conditions:[],intensity:null},"LIML":{temp:0,conditions:[],intensity:null},"LIPE":{temp:0,conditions:["snow"],intensity:null},"LICC":{temp:16,conditions:[],intensity:null},"LICJ":{temp:17,conditions:[],intensity:null},"LIRA":{temp:11,conditions:["fog"],intensity:null},"LIRP":{temp:3,conditions:[],intensity:null},
  "LIMF":{temp:-1,conditions:[],intensity:null},"LIEO":{temp:9,conditions:[],intensity:null},"LIEE":{temp:13,conditions:[],intensity:null},"EHAM":{temp:1,conditions:[],intensity:null},"EHRD":{temp:1,conditions:[],intensity:null},"EHEH":{temp:-2,conditions:[],intensity:null},"EBBR":{temp:0,conditions:[],intensity:null},"EBCI":{temp:-1,conditions:[],intensity:null},"ELLX":{temp:-2,conditions:[],intensity:null},"LSZH":{temp:-8,conditions:[],intensity:null},
  "LSGG":{temp:-5,conditions:[],intensity:null},"LSZB":{temp:-8,conditions:[],intensity:null},"LOWW":{temp:-2,conditions:[],intensity:null},"LOWS":{temp:-7,conditions:[],intensity:null},"LOWG":{temp:-3,conditions:[],intensity:null},"LOWI":{temp:-8,conditions:[],intensity:null},"LKPR":{temp:-6,conditions:[],intensity:null},"EPWA":{temp:-7,conditions:[],intensity:null},"EPKK":{temp:-4,conditions:[],intensity:null},"EPGD":{temp:-5,conditions:[],intensity:null},
  "EPWR":{temp:-5,conditions:[],intensity:null},"EPPO":{temp:-8,conditions:[],intensity:null},"EKCH":{temp:-1,conditions:[],intensity:null},"ESSA":{temp:-2,conditions:[],intensity:null},"ENGM":{temp:-8,conditions:["snow"],intensity:null},"EFHK":{temp:-10,conditions:[],intensity:null},"BIKF":{temp:-4,conditions:[],intensity:null},"ESGG":{temp:-10,conditions:[],intensity:null},"ESMS":{temp:-4,conditions:[],intensity:null},"ENBR":{temp:-7,conditions:[],intensity:null},
  "ENZV":{temp:-2,conditions:[],intensity:null},"ENTC":{temp:-12,conditions:[],intensity:null},"EFOU":{temp:-25,conditions:[],intensity:null},"EFRO":{temp:-25,conditions:[],intensity:null},"LGAV":{temp:18,conditions:[],intensity:null},"LGTS":{temp:18,conditions:[],intensity:null},"LGIR":{temp:18,conditions:[],intensity:null},"LGKR":{temp:15,conditions:["thunderstorm"],intensity:null},"LGRP":{temp:19,conditions:[],intensity:null},"LGSR":{temp:19,conditions:[],intensity:null},
  "LGMK":{temp:18,conditions:[],intensity:null},"LTFM":{temp:15,conditions:[],intensity:null},"LTBA":{temp:14,conditions:[],intensity:null},"LTFJ":{temp:15,conditions:[],intensity:null},"LTAI":{temp:17,conditions:[],intensity:null},"LTAC":{temp:6,conditions:[],intensity:null},"LTBJ":{temp:16,conditions:[],intensity:null},"LTBS":{temp:18,conditions:[],intensity:null},"LTFE":{temp:18,conditions:[],intensity:null},"LCLK":{temp:18,conditions:[],intensity:null},
  "LCPH":{temp:20,conditions:[],intensity:null},"LHBP":{temp:-1,conditions:[],intensity:null},"LROP":{temp:2,conditions:["fog"],intensity:null},"LBSF":{temp:9,conditions:[],intensity:null},"LYBE":{temp:0,conditions:[],intensity:null},"LDZA":{temp:-2,conditions:[],intensity:null},"LDDU":{temp:13,conditions:[],intensity:null},"LDSP":{temp:11,conditions:[],intensity:null},"LJLJ":{temp:-2,conditions:[],intensity:null},"LWSK":{temp:12,conditions:[],intensity:null},
  ...
  "OIAW":{temp:16,conditions:[],intensity:null},"OIKK":{temp:9,conditions:[],intensity:null},"OICC":{temp:10,conditions:[],intensity:null},"LLBG":{temp:21,conditions:[],intensity:null},"OLBA":{temp:21,conditions:[],intensity:null},"OJAM":{temp:13,conditions:[],intensity:null},"ORBI":{temp:14,conditions:[],intensity:null},"ORER":{temp:11,conditions:[],intensity:null},"GMMN":{temp:11,conditions:[],intensity:null},"GMME":{temp:11,conditions:[],intensity:null},
  "GMMX":{temp:10,conditions:[],intensity:null},"GMTT":{temp:9,conditions:[],intensity:null},"GMFF":{temp:7,conditions:[],intensity:null},"GMAD":{temp:13,conditions:[],intensity:null},"DAAG":{temp:9,conditions:["rain"],intensity:null},"DAOO":{temp:9,conditions:["rain"],intensity:null},"DTTA":{temp:16,conditions:[],intensity:null},"DTMB":{temp:18,conditions:[],intensity:null},"DTTJ":{temp:20,conditions:[],intensity:null},"HECA":{temp:20,conditions:[],intensity:null},
  "HEGN":{temp:23,conditions:[],intensity:null},"HESH":{temp:25,conditions:[],intensity:null},"HEBA":{temp:23,conditions:[],intensity:null},"HEAX":{temp:19,conditions:[],intensity:null},"HLLT":{temp:23,conditions:[],intensity:null},"DNMM":{temp:31,conditions:[],intensity:null},"DNAA":{temp:30,conditions:[],intensity:null},"DGAA":{temp:30,conditions:[],intensity:null},"DIAP":{temp:28,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  "GABS":{temp:22,conditions:[],intensity:null},"GVNP":{temp:21,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:31,conditions:[],intensity:null},"DBBB":{temp:31,conditions:[],intensity:null},"HKJK":{temp:24,conditions:[],intensity:null},"HKMO":{temp:34,conditions:[],intensity:null},"HTDA":{temp:32,conditions:[],intensity:null},"HTKJ":{temp:29,conditions:[],intensity:null},
  "HUEN":{temp:26,conditions:[],intensity:null},"HRYR":{temp:25,conditions:[],intensity:null},"HAAB":{temp:21,conditions:[],intensity:null},"HDAM":{temp:28,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:25,conditions:[],intensity:null},"FMEE":{temp:33,conditions:[],intensity:null},"FIMP":{temp:29,conditions:[],intensity:null},"FMCH":{temp:30,conditions:[],intensity:null},"FMMI":{temp:28,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:30,conditions:[],intensity:null},"FKYS":{temp:28,conditions:[],intensity:null},"FOOL":{temp:28,conditions:[],intensity:null},"FZAA":{temp:27,conditions:[],intensity:null},"FCBB":{temp:25,conditions:[],intensity:null},"FLLK":{temp:25,conditions:[],intensity:null},"FVHA":{temp:25,conditions:[],intensity:null},"FLLS":{temp:27,conditions:[],intensity:null},"FYWH":{temp:26,conditions:[],intensity:null},
  "FBSK":{temp:30,conditions:[],intensity:null},"FAOR":{temp:24,conditions:[],intensity:null},"FACT":{temp:23,conditions:[],intensity:null},"FALE":{temp:34,conditions:[],intensity:null},"FAPE":{temp:30,conditions:[],intensity:null},"FQMA":{temp:32,conditions:[],intensity:null},"FWKI":{temp:23,conditions:[],intensity:null},"ZBAA":{temp:3,conditions:[],intensity:null},"ZBAD":{temp:2,conditions:[],intensity:null},"ZSPD":{temp:6,conditions:[],intensity:null},
  ...
  "ZYTX":{temp:-3,conditions:[],intensity:null},"ZSAM":{temp:14,conditions:[],intensity:null},"ZGKL":{temp:9,conditions:[],intensity:null},"ZSNJ":{temp:3,conditions:[],intensity:null},"ZSHC":{temp:7,conditions:[],intensity:null},"ZPPP":{temp:3,conditions:[],intensity:null},"ZBTJ":{temp:3,conditions:[],intensity:null},"VMMC":{temp:15,conditions:[],intensity:null},"RJTT":{temp:6,conditions:[],intensity:null},"RJAA":{temp:3,conditions:[],intensity:null},
  ...
  "RKSS":{temp:1,conditions:[],intensity:null},"RKPK":{temp:3,conditions:[],intensity:null},"RKPC":{temp:5,conditions:[],intensity:null},"RKTN":{temp:-1,conditions:[],intensity:null},"ZKPY":{temp:0,conditions:[],intensity:null},"WSSS":{temp:27,conditions:[],intensity:null},"WMKK":{temp:30,conditions:[],intensity:null},"WMKP":{temp:28,conditions:[],intensity:null},"WBKK":{temp:29,conditions:[],intensity:null},"WBGG":{temp:29,conditions:[],intensity:null},
  "VTBS":{temp:31,conditions:[],intensity:null},"VTBD":{temp:31,conditions:[],intensity:null},"VTSP":{temp:32,conditions:[],intensity:null},"VTCC":{temp:27,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:30,conditions:[],intensity:null},"VVNB":{temp:14,conditions:[],intensity:null},"VVTS":{temp:28,conditions:[],intensity:null},"VVDN":{temp:19,conditions:[],intensity:null},"VVCR":{temp:24,conditions:[],intensity:null},
  ...
  "RPLL":{temp:27,conditions:[],intensity:null},"RPLC":{temp:27,conditions:[],intensity:null},"RPVM":{temp:26,conditions:[],intensity:null},"RPVD":{temp:28,conditions:[],intensity:null},"RPVK":{temp:24,conditions:[],intensity:null},"WBSB":{temp:27,conditions:[],intensity:null},"WBLL":{temp:28,conditions:[],intensity:null},"VIDP":{temp:16,conditions:[],intensity:null},"VABB":{temp:25,conditions:[],intensity:null},"VOBL":{temp:24,conditions:[],intensity:null},
  "VOMM":{temp:28,conditions:[],intensity:null},"VEBS":{temp:17,conditions:[],intensity:null},"VOHY":{temp:25,conditions:[],intensity:null},"VAAH":{temp:27,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:31,conditions:[],intensity:null},"VOTP":{temp:25,conditions:[],intensity:null},"VIAR":{temp:15,conditions:[],intensity:null},"VIJP":{temp:18,conditions:[],intensity:null},"VELR":{temp:16,conditions:[],intensity:null},
  "VOCL":{temp:30,conditions:[],intensity:null},"VOTV":{temp:28,conditions:[],intensity:null},"VEPT":{temp:16,conditions:[],intensity:null},"VNKT":{temp:15,conditions:[],intensity:null},"OPKC":{temp:26,conditions:[],intensity:null},"OPLA":{temp:15,conditions:[],intensity:null},"OPIS":{temp:14,conditions:[],intensity:null},"RCTP":{temp:13,conditions:[],intensity:null},"RCSS":{temp:12,conditions:[],intensity:null},"RCMQ":{temp:12,conditions:[],intensity:null},
  "RCKH":{temp:18,conditions:[],intensity:null},"RCNN":{temp:15,conditions:[],intensity:null},"YSSY":{temp:21,conditions:[],intensity:null},"YMML":{temp:24,conditions:[],intensity:null},"YBBN":{temp:25,conditions:[],intensity:null},"YPPH":{temp:26,conditions:[],intensity:null},"YPAD":{temp:25,conditions:[],intensity:null},"YBCG":{temp:22,conditions:[],intensity:null},"YBCS":{temp:25,conditions:[],intensity:null},"YSCB":{temp:24,conditions:[],intensity:null},
  "YMHB":{temp:19,conditions:[],intensity:null},"NZAA":{temp:21,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:14,conditions:[],intensity:null},"NZQN":{temp:15,conditions:[],intensity:null},"NZDN":{temp:15,conditions:[],intensity:null},"NFFN":{temp:27,conditions:["thunderstorm"],intensity:null},"NWWW":{temp:29,conditions:[],intensity:null},"NTAA":{temp:26,conditions:["thunderstorm"],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
  "NIUE":{temp:27,conditions:[],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:25,conditions:[],intensity:null},"PHKO":{temp:25,conditions:[],intensity:null},"PHLH":{temp:21,conditions:[],intensity:null}
};
