...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "ENZV":{temp:1,conditions:[],intensity:null},"ENTC":{temp:-3,conditions:[],intensity:null},"EFOU":{temp:-10,conditions:[],intensity:null},"EFRO":{temp:-17,conditions:[],intensity:null},"LGAV":{temp:13,conditions:[],intensity:null},"LGTS":{temp:10,conditions:[],intensity:null},"LGIR":{temp:15,conditions:[],intensity:null},"LGKR":{temp:13,conditions:[],intensity:null},"LGRP":{temp:17,conditions:[],intensity:null},"LGSR":{temp:17,conditions:[],intensity:null},
