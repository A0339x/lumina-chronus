...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:0,conditions:["freezing"],intensity:null},"KLAX":{temp:10,conditions:[],intensity:null},"KORD":{temp:-16,conditions:[],intensity:null},"KDFW":{temp:-10,conditions:["snow"],intensity:null},"KDEN":{temp:-14,conditions:[],intensity:null},"KJFK":{temp:-10,conditions:[],intensity:null},"KSFO":{temp:8,conditions:[],intensity:null},"KSEA":{temp:-2,conditions:[],intensity:null},"KLAS":{temp:6,conditions:[],intensity:null},"KMCO":{temp:17,conditions:[],intensity:null},
  "KEWR":{temp:-10,conditions:[],intensity:null},"KMIA":{temp:22,conditions:[],intensity:null},"KPHX":{temp:11,conditions:[],intensity:null},"KIAH":{temp:1,conditions:[],intensity:null},"KBOS":{temp:-15,conditions:[],intensity:null},"KMSP":{temp:-23,conditions:[],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:-13,conditions:[],intensity:null},"KPHL":{temp:-8,conditions:[],intensity:null},"KLGA":{temp:-10,conditions:[],intensity:null},
  "KBWI":{temp:-8,conditions:["snow"],intensity:null},"KSLC":{temp:-5,conditions:[],intensity:null},"KDCA":{temp:-8,conditions:["snow"],intensity:null},"KIAD":{temp:-9,conditions:["snow"],intensity:null},"KSAN":{temp:12,conditions:["fog"],intensity:null},"KTPA":{temp:19,conditions:[],intensity:null},"KPDX":{temp:-2,conditions:[],intensity:null},"KSTL":{temp:-13,conditions:["snow"],intensity:null},"KHNL":{temp:24,conditions:[],intensity:null},"KMEM":{temp:-7,conditions:["freezing"],intensity:null},
  "KAUS":{temp:-4,conditions:[],intensity:null},"KBNA":{temp:-1,conditions:["freezing"],intensity:null},"KRDU":{temp:-8,conditions:[],intensity:null},"KCLT":{temp:-7,conditions:["snow"],intensity:null},"KSMF":{temp:6,conditions:[],intensity:null},"KSJC":{temp:6,conditions:[],intensity:null},"KOAK":{temp:8,conditions:[],intensity:null},"KCLE":{temp:-12,conditions:["snow"],intensity:null},"KMKE":{temp:-16,conditions:[],intensity:null},"KPIT":{temp:-12,conditions:["snow"],intensity:null},
  "KIND":{temp:-12,conditions:["snow"],intensity:null},"KCVG":{temp:-11,conditions:["snow"],intensity:null},"KMCI":{temp:-17,conditions:[],intensity:null},"KSAT":{temp:-2,conditions:[],intensity:null},"KHOU":{temp:2,conditions:[],intensity:null},"KDAL":{temp:-9,conditions:["snow"],intensity:null},"KMDW":{temp:-14,conditions:[],intensity:null},"PANC":{temp:-3,conditions:[],intensity:null},"PAFA":{temp:-16,conditions:[],intensity:null},"CYYZ":{temp:-15,conditions:[],intensity:null},
  ...
  "EDDW":{temp:-1,conditions:[],intensity:null},"EDDN":{temp:-2,conditions:[],intensity:null},"EDDV":{temp:-2,conditions:[],intensity:null},"EDDP":{temp:-2,conditions:[],intensity:null},"LEMD":{temp:5,conditions:[],intensity:null},"LEBL":{temp:8,conditions:[],intensity:null},"LEPA":{temp:11,conditions:[],intensity:null},"LEMG":{temp:10,conditions:[],intensity:null},"LEVC":{temp:10,conditions:[],intensity:null},"LEAL":{temp:10,conditions:[],intensity:null},
  "LEZL":{temp:11,conditions:[],intensity:null},"GCLP":{temp:16,conditions:[],intensity:null},"GCTS":{temp:14,conditions:[],intensity:null},"GCLA":{temp:14,conditions:[],intensity:null},"GCFV":{temp:13,conditions:[],intensity:null},"LPPT":{temp:13,conditions:[],intensity:null},"LPPR":{temp:12,conditions:[],intensity:null},"LPFR":{temp:14,conditions:[],intensity:null},"LPMA":{temp:13,conditions:[],intensity:null},"LIRF":{temp:9,conditions:[],intensity:null},
  "LIMC":{temp:5,conditions:[],intensity:null},"LIME":{temp:5,conditions:[],intensity:null},"LIPZ":{temp:7,conditions:["rain"],intensity:null},"LIRN":{temp:11,conditions:[],intensity:null},"LIML":{temp:4,conditions:[],intensity:null},"LIPE":{temp:5,conditions:[],intensity:null},"LICC":{temp:15,conditions:[],intensity:null},"LICJ":{temp:11,conditions:[],intensity:null},"LIRA":{temp:8,conditions:[],intensity:null},"LIRP":{temp:9,conditions:[],intensity:null},
  ...
  "LSGG":{temp:2,conditions:[],intensity:null},"LSZB":{temp:0,conditions:["fog"],intensity:null},"LOWW":{temp:2,conditions:[],intensity:null},"LOWS":{temp:-4,conditions:["fog"],intensity:null},"LOWG":{temp:0,conditions:["freezing"],intensity:null},"LOWI":{temp:4,conditions:[],intensity:null},"LKPR":{temp:-1,conditions:[],intensity:null},"EPWA":{temp:-5,conditions:[],intensity:null},"EPKK":{temp:-1,conditions:[],intensity:null},"EPGD":{temp:-7,conditions:[],intensity:null},
  ...
  "ENZV":{temp:-1,conditions:[],intensity:null},"ENTC":{temp:0,conditions:["snow"],intensity:null},"EFOU":{temp:-9,conditions:[],intensity:null},"EFRO":{temp:-15,conditions:[],intensity:null},"LGAV":{temp:15,conditions:[],intensity:null},"LGTS":{temp:9,conditions:[],intensity:null},"LGIR":{temp:17,conditions:[],intensity:null},"LGKR":{temp:15,conditions:[],intensity:null},"LGRP":{temp:17,conditions:[],intensity:null},"LGSR":{temp:17,conditions:[],intensity:null},
  "LGMK":{temp:16,conditions:[],intensity:null},"LTFM":{temp:12,conditions:[],intensity:null},"LTBA":{temp:12,conditions:[],intensity:null},"LTFJ":{temp:12,conditions:[],intensity:null},"LTAI":{temp:13,conditions:[],intensity:null},"LTAC":{temp:6,conditions:[],intensity:null},"LTBJ":{temp:14,conditions:[],intensity:null},"LTBS":{temp:16,conditions:[],intensity:null},"LTFE":{temp:16,conditions:[],intensity:null},"LCLK":{temp:15,conditions:[],intensity:null},
  "LCPH":{temp:16,conditions:[],intensity:null},"LHBP":{temp:2,conditions:[],intensity:null},"LROP":{temp:1,conditions:["fog"],intensity:null},"LBSF":{temp:0,conditions:[],intensity:null},"LYBE":{temp:8,conditions:[],intensity:null},"LDZA":{temp:3,conditions:[],intensity:null},"LDDU":{temp:13,conditions:[],intensity:null},"LDSP":{temp:14,conditions:[],intensity:null},"LJLJ":{temp:2,conditions:[],intensity:null},"LWSK":{temp:5,conditions:["fog"],intensity:null},
  "LATI":{temp:14,conditions:[],intensity:null},"UKBB":{temp:-11,conditions:[],intensity:null},"UKLL":{temp:-1,conditions:[],intensity:null},"UUEE":{temp:-21,conditions:[],intensity:null},"UUDD":{temp:-24,conditions:[],intensity:null},"UUWW":{temp:-22,conditions:[],intensity:null},"ULLI":{temp:-15,conditions:[],intensity:null},"UWWW":{temp:-26,conditions:[],intensity:null},"USSS":{temp:-20,conditions:[],intensity:null},"UNNT":{temp:-28,conditions:[],intensity:null},
  "UUOB":{temp:-17,conditions:[],intensity:null},"UHWW":{temp:-11,conditions:[],intensity:null},"UEEE":{temp:-31,conditions:[],intensity:null},"OMDB":{temp:22,conditions:[],intensity:null},"OMDW":{temp:23,conditions:[],intensity:null},"OMAA":{temp:22,conditions:[],intensity:null},"OMSJ":{temp:23,conditions:[],intensity:null},"OTHH":{temp:22,conditions:[],intensity:null},"OERK":{temp:16,conditions:[],intensity:null},"OEJN":{temp:27,conditions:[],intensity:null},
  "OEDF":{temp:20,conditions:[],intensity:null},"OEMA":{temp:19,conditions:[],intensity:null},"OKBK":{temp:15,conditions:[],intensity:null},"OBBI":{temp:18,conditions:[],intensity:null},"OOMS":{temp:26,conditions:[],intensity:null},"OYAA":{temp:20,conditions:[],intensity:null},"OIIE":{temp:6,conditions:[],intensity:null},"OIII":{temp:6,conditions:[],intensity:null},"OISS":{temp:2,conditions:[],intensity:null},"OIKB":{temp:15,conditions:[],intensity:null},
  "OIAW":{temp:14,conditions:[],intensity:null},"OIKK":{temp:4,conditions:[],intensity:null},"OICC":{temp:5,conditions:[],intensity:null},"LLBG":{temp:19,conditions:[],intensity:null},"OLBA":{temp:18,conditions:[],intensity:null},"OJAM":{temp:11,conditions:[],intensity:null},"ORBI":{temp:14,conditions:[],intensity:null},"ORER":{temp:9,conditions:[],intensity:null},"GMMN":{temp:9,conditions:[],intensity:null},"GMME":{temp:11,conditions:[],intensity:null},
  "GMMX":{temp:5,conditions:[],intensity:null},"GMTT":{temp:14,conditions:[],intensity:null},"GMFF":{temp:9,conditions:[],intensity:null},"GMAD":{temp:7,conditions:["fog"],intensity:null},"DAAG":{temp:9,conditions:[],intensity:null},"DAOO":{temp:12,conditions:[],intensity:null},"DTTA":{temp:10,conditions:[],intensity:null},"DTMB":{temp:11,conditions:[],intensity:null},"DTTJ":{temp:12,conditions:[],intensity:null},"HECA":{temp:20,conditions:[],intensity:null},
  "HEGN":{temp:20,conditions:[],intensity:null},"HESH":{temp:21,conditions:[],intensity:null},"HEBA":{temp:19,conditions:[],intensity:null},"HEAX":{temp:17,conditions:[],intensity:null},"HLLT":{temp:14,conditions:[],intensity:null},"DNMM":{temp:28,conditions:[],intensity:null},"DNAA":{temp:30,conditions:[],intensity:null},"DGAA":{temp:28,conditions:[],intensity:null},"DIAP":{temp:28,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  "GABS":{temp:22,conditions:[],intensity:null},"GVNP":{temp:20,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:27,conditions:["fog"],intensity:null},"DXXX":{temp:29,conditions:[],intensity:null},"DBBB":{temp:29,conditions:[],intensity:null},"HKJK":{temp:27,conditions:[],intensity:null},"HKMO":{temp:33,conditions:[],intensity:null},"HTDA":{temp:31,conditions:[],intensity:null},"HTKJ":{temp:31,conditions:[],intensity:null},
  "HUEN":{temp:30,conditions:[],intensity:null},"HRYR":{temp:26,conditions:[],intensity:null},"HAAB":{temp:22,conditions:[],intensity:null},"HDAM":{temp:26,conditions:[],intensity:null},"HCMM":{temp:31,conditions:[],intensity:null},"OYSN":{temp:27,conditions:[],intensity:null},"FMEE":{temp:30,conditions:[],intensity:null},"FIMP":{temp:30,conditions:[],intensity:null},"FMCH":{temp:27,conditions:[],intensity:null},"FMMI":{temp:24,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:28,conditions:[],intensity:null},"FKYS":{temp:25,conditions:[],intensity:null},"FOOL":{temp:27,conditions:[],intensity:null},"FZAA":{temp:30,conditions:[],intensity:null},"FCBB":{temp:29,conditions:[],intensity:null},"FLLK":{temp:24,conditions:[],intensity:null},"FVHA":{temp:24,conditions:[],intensity:null},"FLLS":{temp:25,conditions:[],intensity:null},"FYWH":{temp:26,conditions:[],intensity:null},
  "FBSK":{temp:27,conditions:[],intensity:null},"FAOR":{temp:23,conditions:[],intensity:null},"FACT":{temp:24,conditions:[],intensity:null},"FALE":{temp:29,conditions:[],intensity:null},"FAPE":{temp:27,conditions:[],intensity:null},"FQMA":{temp:30,conditions:[],intensity:null},"FWKI":{temp:23,conditions:[],intensity:null},"ZBAA":{temp:0,conditions:[],intensity:null},"ZBAD":{temp:1,conditions:[],intensity:null},"ZSPD":{temp:9,conditions:[],intensity:null},
  "ZSSS":{temp:10,conditions:[],intensity:null},"ZGGG":{temp:21,conditions:[],intensity:null},"VHHH":{temp:21,conditions:[],intensity:null},"ZGSZ":{temp:19,conditions:[],intensity:null},"ZUUU":{temp:11,conditions:[],intensity:null},"ZUCK":{temp:8,conditions:[],intensity:null},"ZHCC":{temp:3,conditions:[],intensity:null},"ZLXY":{temp:8,conditions:[],intensity:null},"ZWSH":{temp:-11,conditions:[],intensity:null},"ZYHB":{temp:-16,conditions:[],intensity:null},
  "ZYTX":{temp:-12,conditions:[],intensity:null},"ZSAM":{temp:18,conditions:[],intensity:null},"ZGKL":{temp:11,conditions:[],intensity:null},"ZSNJ":{temp:10,conditions:[],intensity:null},"ZSHC":{temp:14,conditions:[],intensity:null},"ZPPP":{temp:17,conditions:[],intensity:null},"ZBTJ":{temp:-2,conditions:[],intensity:null},"VMMC":{temp:20,conditions:[],intensity:null},"RJTT":{temp:5,conditions:[],intensity:null},"RJAA":{temp:2,conditions:[],intensity:null},
  "RJBB":{temp:5,conditions:[],intensity:null},"RJOO":{temp:2,conditions:[],intensity:null},"RJCC":{temp:-6,conditions:[],intensity:null},"RJFF":{temp:4,conditions:[],intensity:null},"RJGG":{temp:4,conditions:[],intensity:null},"ROAH":{temp:18,conditions:[],intensity:null},"RJSS":{temp:-1,conditions:[],intensity:null},"RJSN":{temp:0,conditions:[],intensity:null},"RJOK":{temp:4,conditions:[],intensity:null},"RKSI":{temp:-3,conditions:[],intensity:null},
  "RKSS":{temp:-4,conditions:[],intensity:null},"RKPK":{temp:2,conditions:[],intensity:null},"RKPC":{temp:3,conditions:[],intensity:null},"RKTN":{temp:-2,conditions:[],intensity:null},"ZKPY":{temp:-7,conditions:[],intensity:null},"WSSS":{temp:29,conditions:[],intensity:null},"WMKK":{temp:33,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:27,conditions:[],intensity:null},
  "VTBS":{temp:33,conditions:[],intensity:null},"VTBD":{temp:33,conditions:[],intensity:null},"VTSP":{temp:31,conditions:[],intensity:null},"VTCC":{temp:29,conditions:[],intensity:null},"VTSS":{temp:29,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:19,conditions:[],intensity:null},"VVTS":{temp:31,conditions:[],intensity:null},"VVDN":{temp:23,conditions:[],intensity:null},"VVCR":{temp:27,conditions:[],intensity:null},
  ...
  "VOMM":{temp:27,conditions:[],intensity:null},"VEBS":{temp:27,conditions:[],intensity:null},"VOHY":{temp:28,conditions:[],intensity:null},"VAAH":{temp:26,conditions:[],intensity:null},"VOCI":{temp:28,conditions:[],intensity:null},"VAGO":{temp:32,conditions:[],intensity:null},"VOTP":{temp:28,conditions:[],intensity:null},"VIAR":{temp:18,conditions:[],intensity:null},"VIJP":{temp:18,conditions:[],intensity:null},"VELR":{temp:19,conditions:[],intensity:null},
  "VOCL":{temp:30,conditions:[],intensity:null},"VOTV":{temp:28,conditions:[],intensity:null},"VEPT":{temp:25,conditions:[],intensity:null},"VNKT":{temp:20,conditions:[],intensity:null},"OPKC":{temp:20,conditions:[],intensity:null},"OPLA":{temp:18,conditions:[],intensity:null},"OPIS":{temp:15,conditions:[],intensity:null},"RCTP":{temp:23,conditions:[],intensity:null},"RCSS":{temp:21,conditions:[],intensity:null},"RCMQ":{temp:19,conditions:[],intensity:null},
  "RCKH":{temp:22,conditions:[],intensity:null},"RCNN":{temp:21,conditions:[],intensity:null},"YSSY":{temp:29,conditions:[],intensity:null},"YMML":{temp:21,conditions:[],intensity:null},"YBBN":{temp:27,conditions:[],intensity:null},"YPPH":{temp:24,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:26,conditions:[],intensity:null},"YBCS":{temp:25,conditions:[],intensity:null},"YSCB":{temp:36,conditions:[],intensity:null},
  ...
  "NIUE":{temp:28,conditions:["thunderstorm"],intensity:null},"PGSN":{temp:26,conditions:[],intensity:null},"PGUM":{temp:28,conditions:["thunderstorm"],intensity:null},"PHOG":{temp:24,conditions:[],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:19,conditions:["fog"],intensity:null}
};
