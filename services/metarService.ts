...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KAUS":{temp:-1,conditions:[],intensity:null},"KBNA":{temp:-7,conditions:["snow"],intensity:null},"KRDU":{temp:-2,conditions:[],intensity:null},"KCLT":{temp:1,conditions:[],intensity:null},"KSMF":{temp:15,conditions:[],intensity:null},"KSJC":{temp:16,conditions:[],intensity:null},"KOAK":{temp:15,conditions:[],intensity:null},"KCLE":{temp:-13,conditions:[],intensity:null},"KMKE":{temp:-16,conditions:[],intensity:null},"KPIT":{temp:-11,conditions:[],intensity:null},
  ...
  "CYVR":{temp:5,conditions:[],intensity:null},"CYUL":{temp:-20,conditions:[],intensity:null},"CYYC":{temp:-11,conditions:[],intensity:null},"CYEG":{temp:-17,conditions:[],intensity:null},"CYOW":{temp:-20,conditions:[],intensity:null},"CYWG":{temp:-22,conditions:[],intensity:null},"CYHZ":{temp:-15,conditions:[],intensity:null},"CYQB":{temp:-21,conditions:[],intensity:null},"CYYJ":{temp:5,conditions:[],intensity:null},"CYLW":{temp:-3,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:28,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:27,conditions:[],intensity:null},"TAPA":{temp:26,conditions:[],intensity:null},"SBGR":{temp:21,conditions:[],intensity:null},"SBGL":{temp:26,conditions:[],intensity:null},"SBBR":{temp:22,conditions:[],intensity:null},"SBCF":{temp:22,conditions:["thunderstorm"],intensity:null},"SBSV":{temp:27,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null},
  "SBPA":{temp:30,conditions:[],intensity:null},"SBCT":{temp:22,conditions:[],intensity:null},"SBFZ":{temp:28,conditions:[],intensity:null},"SCEL":{temp:27,conditions:[],intensity:null},"SAEZ":{temp:33,conditions:[],intensity:null},"SABE":{temp:32,conditions:[],intensity:null},"SACO":{temp:30,conditions:[],intensity:null},"SAME":{temp:28,conditions:[],intensity:null},"SLLP":{temp:15,conditions:[],intensity:null},"SLVR":{temp:31,conditions:[],intensity:null},
  "SPJC":{temp:23,conditions:[],intensity:null},"SEQM":{temp:13,conditions:[],intensity:null},"SEGU":{temp:27,conditions:[],intensity:null},"SKBO":{temp:16,conditions:[],intensity:null},"SKMR":{temp:26,conditions:[],intensity:null},"SKCL":{temp:25,conditions:[],intensity:null},"SKMD":{temp:28,conditions:[],intensity:null},"SKRG":{temp:20,conditions:[],intensity:null},"SVMI":{temp:25,conditions:[],intensity:null},"SUMU":{temp:29,conditions:[],intensity:null},
  ...
  "LEZL":{temp:8,conditions:[],intensity:null},"GCLP":{temp:17,conditions:[],intensity:null},"GCTS":{temp:15,conditions:[],intensity:null},"GCLA":{temp:16,conditions:[],intensity:null},"GCFV":{temp:17,conditions:[],intensity:null},"LPPT":{temp:11,conditions:[],intensity:null},"LPPR":{temp:11,conditions:[],intensity:null},"LPFR":{temp:11,conditions:[],intensity:null},"LPMA":{temp:14,conditions:[],intensity:null},"LIRF":{temp:13,conditions:[],intensity:null},
  ...
  "LIMF":{temp:4,conditions:[],intensity:null},"LIEO":{temp:10,conditions:[],intensity:null},"LIEE":{temp:12,conditions:[],intensity:null},"EHAM":{temp:3,conditions:[],intensity:null},"EHRD":{temp:4,conditions:[],intensity:null},"EHEH":{temp:4,conditions:[],intensity:null},"EBBR":{temp:5,conditions:[],intensity:null},"EBCI":{temp:3,conditions:[],intensity:null},"ELLX":{temp:0,conditions:[],intensity:null},"LSZH":{temp:2,conditions:[],intensity:null},
  ...
  "GABS":{temp:23,conditions:[],intensity:null},"GVNP":{temp:20,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:28,conditions:[],intensity:null},"DBBB":{temp:27,conditions:[],intensity:null},"HKJK":{temp:19,conditions:[],intensity:null},"HKMO":{temp:25,conditions:[],intensity:null},"HTDA":{temp:25,conditions:[],intensity:null},"HTKJ":{temp:20,conditions:[],intensity:null},
  ...
  "FBSK":{temp:23,conditions:[],intensity:null},"FAOR":{temp:21,conditions:[],intensity:null},"FACT":{temp:20,conditions:[],intensity:null},"FALE":{temp:21,conditions:[],intensity:null},"FAPE":{temp:17,conditions:[],intensity:null},"FQMA":{temp:25,conditions:[],intensity:null},"FWKI":{temp:19,conditions:["fog"],intensity:null},"ZBAA":{temp:-8,conditions:[],intensity:null},"ZBAD":{temp:-9,conditions:[],intensity:null},"ZSPD":{temp:7,conditions:[],intensity:null},
  ...
  "RJBB":{temp:5,conditions:[],intensity:null},"RJOO":{temp:0,conditions:[],intensity:null},"RJCC":{temp:-15,conditions:[],intensity:null},"RJFF":{temp:3,conditions:[],intensity:null},"RJGG":{temp:3,conditions:[],intensity:null},"ROAH":{temp:17,conditions:[],intensity:null},"RJSS":{temp:-2,conditions:[],intensity:null},"RJSN":{temp:0,conditions:[],intensity:null},"RJOK":{temp:2,conditions:[],intensity:null},"RKSI":{temp:-6,conditions:[],intensity:null},
  ...
  "RCKH":{temp:19,conditions:[],intensity:null},"RCNN":{temp:17,conditions:[],intensity:null},"YSSY":{temp:19,conditions:["fog"],intensity:null},"YMML":{temp:19,conditions:[],intensity:null},"YBBN":{temp:24,conditions:[],intensity:null},"YPPH":{temp:20,conditions:[],intensity:null},"YPAD":{temp:22,conditions:[],intensity:null},"YBCG":{temp:23,conditions:[],intensity:null},"YBCS":{temp:24,conditions:[],intensity:null},"YSCB":{temp:16,conditions:["fog"],intensity:null},
  "YMHB":{temp:16,conditions:[],intensity:null},"NZAA":{temp:18,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:14,conditions:[],intensity:null},"NZQN":{temp:11,conditions:[],intensity:null},"NZDN":{temp:11,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:28,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:28,conditions:["thunderstorm"],intensity:null},
