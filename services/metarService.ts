...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:11,conditions:[],intensity:null},"KLAX":{temp:20,conditions:[],intensity:null},"KORD":{temp:7,conditions:[],intensity:null},"KDFW":{temp:16,conditions:[],intensity:null},"KDEN":{temp:14,conditions:[],intensity:null},"KJFK":{temp:4,conditions:[],intensity:null},"KSFO":{temp:14,conditions:[],intensity:null},"KSEA":{temp:13,conditions:[],intensity:null},"KLAS":{temp:21,conditions:[],intensity:null},"KMCO":{temp:22,conditions:[],intensity:null},
  "KEWR":{temp:6,conditions:[],intensity:null},"KMIA":{temp:21,conditions:[],intensity:null},"KPHX":{temp:24,conditions:[],intensity:null},"KIAH":{temp:11,conditions:[],intensity:null},"KBOS":{temp:2,conditions:[],intensity:null},"KMSP":{temp:5,conditions:[],intensity:null},"KFLL":{temp:21,conditions:[],intensity:null},"KDTW":{temp:4,conditions:[],intensity:null},"KPHL":{temp:4,conditions:[],intensity:null},"KLGA":{temp:5,conditions:[],intensity:null},
  "KBWI":{temp:5,conditions:[],intensity:null},"KSLC":{temp:7,conditions:[],intensity:null},"KDCA":{temp:8,conditions:[],intensity:null},"KIAD":{temp:8,conditions:[],intensity:null},"KSAN":{temp:23,conditions:[],intensity:null},"KTPA":{temp:17,conditions:[],intensity:null},"KPDX":{temp:9,conditions:[],intensity:null},"KSTL":{temp:14,conditions:[],intensity:null},"KHNL":{temp:27,conditions:[],intensity:null},"KMEM":{temp:14,conditions:[],intensity:null},
  "KAUS":{temp:15,conditions:[],intensity:null},"KBNA":{temp:13,conditions:[],intensity:null},"KRDU":{temp:9,conditions:[],intensity:null},"KCLT":{temp:9,conditions:[],intensity:null},"KSMF":{temp:14,conditions:[],intensity:null},"KSJC":{temp:17,conditions:[],intensity:null},"KOAK":{temp:15,conditions:[],intensity:null},"KCLE":{temp:5,conditions:[],intensity:null},"KMKE":{temp:6,conditions:[],intensity:null},"KPIT":{temp:8,conditions:[],intensity:null},
  "KIND":{temp:8,conditions:[],intensity:null},"KCVG":{temp:10,conditions:[],intensity:null},"KMCI":{temp:11,conditions:[],intensity:null},"KSAT":{temp:15,conditions:[],intensity:null},"KHOU":{temp:12,conditions:[],intensity:null},"KDAL":{temp:13,conditions:[],intensity:null},"KMDW":{temp:6,conditions:[],intensity:null},"PANC":{temp:-12,conditions:[],intensity:null},"PAFA":{temp:-36,conditions:[],intensity:null},"CYYZ":{temp:2,conditions:[],intensity:null},
  "CYVR":{temp:13,conditions:[],intensity:null},"CYUL":{temp:1,conditions:[],intensity:null},"CYYC":{temp:11,conditions:[],intensity:null},"CYEG":{temp:5,conditions:[],intensity:null},"CYOW":{temp:0,conditions:[],intensity:null},"CYWG":{temp:-14,conditions:[],intensity:null},"CYHZ":{temp:0,conditions:[],intensity:null},"CYQB":{temp:-1,conditions:[],intensity:null},"CYYJ":{temp:11,conditions:["fog"],intensity:null},"CYLW":{temp:7,conditions:[],intensity:null},
  "CYXE":{temp:-2,conditions:[],intensity:null},"CYQR":{temp:1,conditions:[],intensity:null},"CYZF":{temp:-15,conditions:[],intensity:null},"CYXY":{temp:3,conditions:[],intensity:null},"CYQT":{temp:-1,conditions:[],intensity:null},"CYYT":{temp:-1,conditions:[],intensity:null},"MMMX":{temp:21,conditions:[],intensity:null},"MMUN":{temp:23,conditions:[],intensity:null},"MMGL":{temp:20,conditions:[],intensity:null},"MMMY":{temp:18,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:25,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:26,conditions:[],intensity:null},"SBGR":{temp:23,conditions:[],intensity:null},"SBGL":{temp:30,conditions:[],intensity:null},"SBBR":{temp:21,conditions:[],intensity:null},"SBCF":{temp:21,conditions:[],intensity:null},"SBSV":{temp:27,conditions:[],intensity:null},"SBRF":{temp:25,conditions:[],intensity:null},
  "SBPA":{temp:28,conditions:[],intensity:null},"SBCT":{temp:22,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:24,conditions:[],intensity:null},"SAEZ":{temp:27,conditions:[],intensity:null},"SABE":{temp:25,conditions:[],intensity:null},"SACO":{temp:22,conditions:[],intensity:null},"SAME":{temp:25,conditions:[],intensity:null},"SLLP":{temp:13,conditions:[],intensity:null},"SLVR":{temp:25,conditions:[],intensity:null},
  ...
  "LFRS":{temp:7,conditions:[],intensity:null},"LFSB":{temp:2,conditions:[],intensity:null},"LFPB":{temp:9,conditions:[],intensity:null},"EDDF":{temp:5,conditions:[],intensity:null},"EDDM":{temp:-1,conditions:["fog"],intensity:null},"EDDB":{temp:2,conditions:[],intensity:null},"EDDL":{temp:8,conditions:[],intensity:null},"EDDH":{temp:4,conditions:[],intensity:null},"EDDK":{temp:8,conditions:[],intensity:null},"EDDS":{temp:6,conditions:[],intensity:null},
  ...
  "LIMF":{temp:2,conditions:[],intensity:null},"LIEO":{temp:5,conditions:["fog"],intensity:null},"LIEE":{temp:9,conditions:[],intensity:null},"EHAM":{temp:8,conditions:[],intensity:null},"EHRD":{temp:9,conditions:[],intensity:null},"EHEH":{temp:9,conditions:[],intensity:null},"EBBR":{temp:10,conditions:[],intensity:null},"EBCI":{temp:8,conditions:[],intensity:null},"ELLX":{temp:5,conditions:[],intensity:null},"LSZH":{temp:0,conditions:["fog"],intensity:null},
  "LSGG":{temp:4,conditions:[],intensity:null},"LSZB":{temp:2,conditions:[],intensity:null},"LOWW":{temp:-1,conditions:[],intensity:null},"LOWS":{temp:-1,conditions:["fog"],intensity:null},"LOWG":{temp:-4,conditions:["fog"],intensity:null},"LOWI":{temp:1,conditions:[],intensity:null},"LKPR":{temp:1,conditions:["fog"],intensity:null},"EPWA":{temp:-5,conditions:[],intensity:null},"EPKK":{temp:-3,conditions:[],intensity:null},"EPGD":{temp:-6,conditions:[],intensity:null},
  ...
  "LCPH":{temp:10,conditions:[],intensity:null},"LHBP":{temp:-8,conditions:[],intensity:null},"LROP":{temp:-6,conditions:[],intensity:null},"LBSF":{temp:-1,conditions:[],intensity:null},"LYBE":{temp:2,conditions:[],intensity:null},"LDZA":{temp:1,conditions:[],intensity:null},"LDDU":{temp:8,conditions:[],intensity:null},"LDSP":{temp:9,conditions:[],intensity:null},"LJLJ":{temp:0,conditions:[],intensity:null},"LWSK":{temp:-2,conditions:[],intensity:null},
  ...
  "ZYTX":{temp:-11,conditions:[],intensity:null},"ZSAM":{temp:8,conditions:[],intensity:null},"ZGKL":{temp:8,conditions:[],intensity:null},"ZSNJ":{temp:7,conditions:[],intensity:null},"ZSHC":{temp:5,conditions:[],intensity:null},"ZPPP":{temp:5,conditions:[],intensity:null},"ZBTJ":{temp:-6,conditions:[],intensity:null},"VMMC":{temp:15,conditions:[],intensity:null},"RJTT":{temp:5,conditions:[],intensity:null},"RJAA":{temp:5,conditions:[],intensity:null},
  "RJBB":{temp:6,conditions:[],intensity:null},"RJOO":{temp:2,conditions:[],intensity:null},"RJCC":{temp:-11,conditions:[],intensity:null},"RJFF":{temp:6,conditions:[],intensity:null},"RJGG":{temp:6,conditions:[],intensity:null},"ROAH":{temp:17,conditions:[],intensity:null},"RJSS":{temp:1,conditions:[],intensity:null},"RJSN":{temp:2,conditions:[],intensity:null},"RJOK":{temp:4,conditions:[],intensity:null},"RKSI":{temp:-6,conditions:[],intensity:null},
  "RKSS":{temp:-10,conditions:[],intensity:null},"RKPK":{temp:-4,conditions:[],intensity:null},"RKPC":{temp:2,conditions:[],intensity:null},"RKTN":{temp:-8,conditions:[],intensity:null},"ZKPY":{temp:-15,conditions:[],intensity:null},"WSSS":{temp:24,conditions:[],intensity:null},"WMKK":{temp:24,conditions:["fog"],intensity:null},"WMKP":{temp:28,conditions:[],intensity:null},"WBKK":{temp:27,conditions:[],intensity:null},"WBGG":{temp:24,conditions:[],intensity:null},
  ...
  "RPLL":{temp:26,conditions:[],intensity:null},"RPLC":{temp:23,conditions:[],intensity:null},"RPVM":{temp:25,conditions:["fog"],intensity:null},"RPVD":{temp:24,conditions:[],intensity:null},"RPVK":{temp:23,conditions:[],intensity:null},"WBSB":{temp:24,conditions:["fog"],intensity:null},"WBLL":{temp:25,conditions:["rain"],intensity:null},"VIDP":{temp:4,conditions:[],intensity:null},"VABB":{temp:25,conditions:[],intensity:null},"VOBL":{temp:16,conditions:[],intensity:null},
  "VOMM":{temp:21,conditions:[],intensity:null},"VEBS":{temp:14,conditions:[],intensity:null},"VOHY":{temp:18,conditions:[],intensity:null},"VAAH":{temp:14,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:26,conditions:[],intensity:null},"VOTP":{temp:20,conditions:[],intensity:null},"VIAR":{temp:5,conditions:[],intensity:null},"VIJP":{temp:9,conditions:[],intensity:null},"VELR":{temp:8,conditions:[],intensity:null},
  ...
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:14,conditions:[],intensity:null},"YSSY":{temp:23,conditions:[],intensity:null},"YMML":{temp:19,conditions:[],intensity:null},"YBBN":{temp:27,conditions:[],intensity:null},"YPPH":{temp:21,conditions:[],intensity:null},"YPAD":{temp:20,conditions:[],intensity:null},"YBCG":{temp:25,conditions:[],intensity:null},"YBCS":{temp:26,conditions:[],intensity:null},"YSCB":{temp:22,conditions:[],intensity:null},
  ...
  "NIUE":{temp:26,conditions:[],intensity:null},"PGSN":{temp:28,conditions:[],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:28,conditions:[],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:23,conditions:[],intensity:null}
};
