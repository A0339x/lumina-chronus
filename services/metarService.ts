...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LFRS":{temp:7,conditions:[],intensity:null},"LFSB":{temp:6,conditions:[],intensity:null},"LFPB":{temp:6,conditions:[],intensity:null},"EDDF":{temp:5,conditions:[],intensity:null},"EDDM":{temp:3,conditions:[],intensity:null},"EDDB":{temp:2,conditions:[],intensity:null},"EDDL":{temp:8,conditions:[],intensity:null},"EDDH":{temp:8,conditions:[],intensity:null},"EDDK":{temp:7,conditions:[],intensity:null},"EDDS":{temp:3,conditions:[],intensity:null},
