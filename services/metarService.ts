...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KBWI":{temp:7,conditions:[],intensity:null},"KSLC":{temp:7,conditions:[],intensity:null},"KDCA":{temp:8,conditions:[],intensity:null},"KIAD":{temp:8,conditions:[],intensity:null},"KSAN":{temp:21,conditions:[],intensity:null},"KTPA":{temp:16,conditions:[],intensity:null},"KPDX":{temp:7,conditions:[],intensity:null},"KSTL":{temp:-1,conditions:[],intensity:null},"KHNL":{temp:25,conditions:[],intensity:null},"KMEM":{temp:6,conditions:[],intensity:null},
  "KAUS":{temp:17,conditions:[],intensity:null},"KBNA":{temp:2,conditions:[],intensity:null},"KRDU":{temp:9,conditions:[],intensity:null},"KCLT":{temp:9,conditions:[],intensity:null},"KSMF":{temp:15,conditions:[],intensity:null},"KSJC":{temp:18,conditions:[],intensity:null},"KOAK":{temp:16,conditions:[],intensity:null},"KCLE":{temp:-2,conditions:["snow"],intensity:null},"KMKE":{temp:-8,conditions:[],intensity:null},"KPIT":{temp:2,conditions:[],intensity:null},
  "KIND":{temp:-6,conditions:[],intensity:null},"KCVG":{temp:-3,conditions:[],intensity:null},"KMCI":{temp:0,conditions:[],intensity:null},"KSAT":{temp:19,conditions:[],intensity:null},"KHOU":{temp:18,conditions:[],intensity:null},"KDAL":{temp:9,conditions:[],intensity:null},"KMDW":{temp:-9,conditions:[],intensity:null},"PANC":{temp:-2,conditions:[],intensity:null},"PAFA":{temp:-28,conditions:[],intensity:null},"CYYZ":{temp:-1,conditions:[],intensity:null},
  ...
  "CYXE":{temp:-1,conditions:[],intensity:null},"CYQR":{temp:0,conditions:[],intensity:null},"CYZF":{temp:-8,conditions:[],intensity:null},"CYXY":{temp:-2,conditions:[],intensity:null},"CYQT":{temp:-17,conditions:[],intensity:null},"CYYT":{temp:4,conditions:[],intensity:null},"MMMX":{temp:18,conditions:[],intensity:null},"MMUN":{temp:23,conditions:[],intensity:null},"MMGL":{temp:22,conditions:[],intensity:null},"MMMY":{temp:23,conditions:[],intensity:null},
  "MMTJ":{temp:23,conditions:[],intensity:null},"MMSM":{temp:29,conditions:[],intensity:null},"MMMD":{temp:23,conditions:[],intensity:null},"MMCZ":{temp:26,conditions:[],intensity:null},"MMSD":{temp:24,conditions:[],intensity:null},"MGGT":{temp:20,conditions:[],intensity:null},"MSLP":{temp:27,conditions:[],intensity:null},"MHTG":{temp:24,conditions:[],intensity:null},"MNMG":{temp:29,conditions:[],intensity:null},"MROC":{temp:24,conditions:[],intensity:null},
  ...
  "SBPA":{temp:28,conditions:[],intensity:null},"SBCT":{temp:21,conditions:[],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:17,conditions:[],intensity:null},"SAEZ":{temp:29,conditions:[],intensity:null},"SABE":{temp:27,conditions:[],intensity:null},"SACO":{temp:25,conditions:[],intensity:null},"SAME":{temp:26,conditions:[],intensity:null},"SLLP":{temp:10,conditions:[],intensity:null},"SLVR":{temp:25,conditions:[],intensity:null},
  ...
  "OIAW":{temp:10,conditions:[],intensity:null},"OIKK":{temp:4,conditions:[],intensity:null},"OICC":{temp:1,conditions:["snow"],intensity:null},"LLBG":{temp:13,conditions:[],intensity:null},"OLBA":{temp:10,conditions:[],intensity:null},"OJAM":{temp:6,conditions:[],intensity:null},"ORBI":{temp:8,conditions:[],intensity:null},"ORER":{temp:3,conditions:[],intensity:null},"GMMN":{temp:10,conditions:["fog"],intensity:null},"GMME":{temp:11,conditions:[],intensity:null},
  "GMMX":{temp:9,conditions:[],intensity:null},"GMTT":{temp:12,conditions:["fog"],intensity:null},"GMFF":{temp:8,conditions:[],intensity:null},"GMAD":{temp:11,conditions:[],intensity:null},"DAAG":{temp:8,conditions:[],intensity:null},"DAOO":{temp:9,conditions:[],intensity:null},"DTTA":{temp:12,conditions:[],intensity:null},"DTMB":{temp:11,conditions:[],intensity:null},"DTTJ":{temp:13,conditions:[],intensity:null},"HECA":{temp:11,conditions:[],intensity:null},
  ...
  "ZYTX":{temp:-4,conditions:[],intensity:null},"ZSAM":{temp:14,conditions:[],intensity:null},"ZGKL":{temp:12,conditions:[],intensity:null},"ZSNJ":{temp:8,conditions:[],intensity:null},"ZSHC":{temp:8,conditions:[],intensity:null},"ZPPP":{temp:4,conditions:[],intensity:null},"ZBTJ":{temp:-4,conditions:[],intensity:null},"VMMC":{temp:14,conditions:[],intensity:null},"RJTT":{temp:4,conditions:[],intensity:null},"RJAA":{temp:2,conditions:[],intensity:null},
  "RJBB":{temp:7,conditions:[],intensity:null},"RJOO":{temp:2,conditions:[],intensity:null},"RJCC":{temp:-8,conditions:[],intensity:null},"RJFF":{temp:7,conditions:[],intensity:null},"RJGG":{temp:5,conditions:[],intensity:null},"ROAH":{temp:19,conditions:[],intensity:null},"RJSS":{temp:3,conditions:[],intensity:null},"RJSN":{temp:3,conditions:[],intensity:null},"RJOK":{temp:6,conditions:[],intensity:null},"RKSI":{temp:7,conditions:[],intensity:null},
  "RKSS":{temp:5,conditions:[],intensity:null},"RKPK":{temp:11,conditions:[],intensity:null},"RKPC":{temp:14,conditions:[],intensity:null},"RKTN":{temp:6,conditions:[],intensity:null},"ZKPY":{temp:-2,conditions:[],intensity:null},"WSSS":{temp:24,conditions:[],intensity:null},"WMKK":{temp:24,conditions:[],intensity:null},"WMKP":{temp:28,conditions:[],intensity:null},"WBKK":{temp:27,conditions:[],intensity:null},"WBGG":{temp:24,conditions:[],intensity:null},
  ...
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:17,conditions:[],intensity:null},"YSSY":{temp:23,conditions:[],intensity:null},"YMML":{temp:21,conditions:[],intensity:null},"YBBN":{temp:27,conditions:[],intensity:null},"YPPH":{temp:22,conditions:[],intensity:null},"YPAD":{temp:18,conditions:[],intensity:null},"YBCG":{temp:25,conditions:[],intensity:null},"YBCS":{temp:28,conditions:[],intensity:null},"YSCB":{temp:23,conditions:[],intensity:null},
