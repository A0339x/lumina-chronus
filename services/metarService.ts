...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:10,conditions:[],intensity:null},"KLAX":{temp:20,conditions:[],intensity:null},"KORD":{temp:-9,conditions:[],intensity:null},"KDFW":{temp:5,conditions:[],intensity:null},"KDEN":{temp:-4,conditions:[],intensity:null},"KJFK":{temp:3,conditions:[],intensity:null},"KSFO":{temp:11,conditions:[],intensity:null},"KSEA":{temp:4,conditions:[],intensity:null},"KLAS":{temp:14,conditions:[],intensity:null},"KMCO":{temp:22,conditions:[],intensity:null},
  "KEWR":{temp:1,conditions:["snow"],intensity:null},"KMIA":{temp:24,conditions:[],intensity:null},"KPHX":{temp:18,conditions:[],intensity:null},"KIAH":{temp:12,conditions:[],intensity:null},"KBOS":{temp:6,conditions:[],intensity:null},"KMSP":{temp:-11,conditions:[],intensity:null},"KFLL":{temp:25,conditions:[],intensity:null},"KDTW":{temp:-2,conditions:[],intensity:null},"KPHL":{temp:2,conditions:["snow"],intensity:null},"KLGA":{temp:2,conditions:[],intensity:null},
  "KBWI":{temp:2,conditions:[],intensity:null},"KSLC":{temp:1,conditions:[],intensity:null},"KDCA":{temp:4,conditions:[],intensity:null},"KIAD":{temp:6,conditions:[],intensity:null},"KSAN":{temp:17,conditions:[],intensity:null},"KTPA":{temp:21,conditions:[],intensity:null},"KPDX":{temp:4,conditions:[],intensity:null},"KSTL":{temp:-5,conditions:[],intensity:null},"KHNL":{temp:21,conditions:[],intensity:null},"KMEM":{temp:2,conditions:[],intensity:null},
  "KAUS":{temp:11,conditions:[],intensity:null},"KBNA":{temp:5,conditions:[],intensity:null},"KRDU":{temp:10,conditions:[],intensity:null},"KCLT":{temp:9,conditions:[],intensity:null},"KSMF":{temp:7,conditions:["fog"],intensity:null},"KSJC":{temp:10,conditions:[],intensity:null},"KOAK":{temp:11,conditions:[],intensity:null},"KCLE":{temp:-1,conditions:[],intensity:null},"KMKE":{temp:-10,conditions:[],intensity:null},"KPIT":{temp:2,conditions:[],intensity:null},
  ...
  "CYXE":{temp:-13,conditions:[],intensity:null},"CYQR":{temp:-18,conditions:[],intensity:null},"CYZF":{temp:-22,conditions:[],intensity:null},"CYXY":{temp:-3,conditions:[],intensity:null},"CYQT":{temp:-12,conditions:[],intensity:null},"CYYT":{temp:-2,conditions:[],intensity:null},"MMMX":{temp:18,conditions:[],intensity:null},"MMUN":{temp:25,conditions:[],intensity:null},"MMGL":{temp:18,conditions:[],intensity:null},"MMMY":{temp:16,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:31,conditions:[],intensity:null},"TIST":{temp:27,conditions:[],intensity:null},"TLPL":{temp:29,conditions:[],intensity:null},"TAPA":{temp:27,conditions:[],intensity:null},"SBGR":{temp:28,conditions:[],intensity:null},"SBGL":{temp:34,conditions:[],intensity:null},"SBBR":{temp:29,conditions:[],intensity:null},"SBCF":{temp:28,conditions:[],intensity:null},"SBSV":{temp:27,conditions:[],intensity:null},"SBRF":{temp:31,conditions:[],intensity:null},
  ...
  "SPJC":{temp:21,conditions:[],intensity:null},"SEQM":{temp:17,conditions:[],intensity:null},"SEGU":{temp:28,conditions:[],intensity:null},"SKBO":{temp:18,conditions:[],intensity:null},"SKMR":{temp:30,conditions:[],intensity:null},"SKCL":{temp:25,conditions:[],intensity:null},"SKMD":{temp:28,conditions:[],intensity:null},"SKRG":{temp:21,conditions:[],intensity:null},"SVMI":{temp:25,conditions:[],intensity:null},"SUMU":{temp:31,conditions:[],intensity:null},
  ...
  "EDDW":{temp:3,conditions:[],intensity:null},"EDDN":{temp:1,conditions:[],intensity:null},"EDDV":{temp:2,conditions:[],intensity:null},"EDDP":{temp:3,conditions:[],intensity:null},"LEMD":{temp:5,conditions:[],intensity:null},"LEBL":{temp:13,conditions:["rain"],intensity:null},"LEPA":{temp:13,conditions:[],intensity:null},"LEMG":{temp:12,conditions:[],intensity:null},"LEVC":{temp:11,conditions:[],intensity:null},"LEAL":{temp:13,conditions:[],intensity:null},
  "LEZL":{temp:11,conditions:[],intensity:null},"GCLP":{temp:19,conditions:[],intensity:null},"GCTS":{temp:17,conditions:[],intensity:null},"GCLA":{temp:20,conditions:[],intensity:null},"GCFV":{temp:18,conditions:[],intensity:null},"LPPT":{temp:10,conditions:[],intensity:null},"LPPR":{temp:8,conditions:[],intensity:null},"LPFR":{temp:12,conditions:[],intensity:null},"LPMA":{temp:15,conditions:[],intensity:null},"LIRF":{temp:12,conditions:[],intensity:null},
  "LIMC":{temp:8,conditions:[],intensity:null},"LIME":{temp:8,conditions:[],intensity:null},"LIPZ":{temp:10,conditions:[],intensity:null},"LIRN":{temp:12,conditions:[],intensity:null},"LIML":{temp:9,conditions:[],intensity:null},"LIPE":{temp:8,conditions:[],intensity:null},"LICC":{temp:14,conditions:[],intensity:null},"LICJ":{temp:14,conditions:[],intensity:null},"LIRA":{temp:11,conditions:[],intensity:null},"LIRP":{temp:10,conditions:[],intensity:null},
  ...
  "LSGG":{temp:5,conditions:[],intensity:null},"LSZB":{temp:3,conditions:[],intensity:null},"LOWW":{temp:1,conditions:[],intensity:null},"LOWS":{temp:-1,conditions:["fog"],intensity:null},"LOWG":{temp:0,conditions:["freezing"],intensity:null},"LOWI":{temp:6,conditions:[],intensity:null},"LKPR":{temp:2,conditions:[],intensity:null},"EPWA":{temp:-5,conditions:[],intensity:null},"EPKK":{temp:-5,conditions:[],intensity:null},"EPGD":{temp:-6,conditions:[],intensity:null},
  "EPWR":{temp:1,conditions:[],intensity:null},"EPPO":{temp:0,conditions:[],intensity:null},"EKCH":{temp:2,conditions:[],intensity:null},"ESSA":{temp:3,conditions:[],intensity:null},"ENGM":{temp:1,conditions:[],intensity:null},"EFHK":{temp:-1,conditions:[],intensity:null},"BIKF":{temp:5,conditions:[],intensity:null},"ESGG":{temp:2,conditions:[],intensity:null},"ESMS":{temp:2,conditions:[],intensity:null},"ENBR":{temp:2,conditions:[],intensity:null},
  ...
  "LCPH":{temp:13,conditions:[],intensity:null},"LHBP":{temp:0,conditions:[],intensity:null},"LROP":{temp:-6,conditions:[],intensity:null},"LBSF":{temp:-1,conditions:[],intensity:null},"LYBE":{temp:-1,conditions:[],intensity:null},"LDZA":{temp:2,conditions:[],intensity:null},"LDDU":{temp:11,conditions:[],intensity:null},"LDSP":{temp:11,conditions:[],intensity:null},"LJLJ":{temp:3,conditions:[],intensity:null},"LWSK":{temp:4,conditions:[],intensity:null},
  ...
  "GABS":{temp:27,conditions:[],intensity:null},"GVNP":{temp:22,conditions:[],intensity:null},"GBYD":{temp:29,conditions:[],intensity:null},"GLRB":{temp:28,conditions:[],intensity:null},"DXXX":{temp:29,conditions:[],intensity:null},"DBBB":{temp:29,conditions:[],intensity:null},"HKJK":{temp:20,conditions:[],intensity:null},"HKMO":{temp:26,conditions:[],intensity:null},"HTDA":{temp:27,conditions:[],intensity:null},"HTKJ":{temp:24,conditions:[],intensity:null},
  ...
  "FSIA":{temp:27,conditions:[],intensity:null},"FKKD":{temp:28,conditions:[],intensity:null},"FKYS":{temp:28,conditions:[],intensity:null},"FOOL":{temp:27,conditions:[],intensity:null},"FZAA":{temp:28,conditions:[],intensity:null},"FCBB":{temp:27,conditions:[],intensity:null},"FLLK":{temp:22,conditions:[],intensity:null},"FVHA":{temp:19,conditions:[],intensity:null},"FLLS":{temp:22,conditions:[],intensity:null},"FYWH":{temp:24,conditions:[],intensity:null},
