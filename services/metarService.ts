...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EPWR":{temp:-5,conditions:[],intensity:null},"EPPO":{temp:-4,conditions:[],intensity:null},"EKCH":{temp:-1,conditions:[],intensity:null},"ESSA":{temp:-9,conditions:[],intensity:null},"ENGM":{temp:-9,conditions:["snow"],intensity:null},"EFHK":{temp:-16,conditions:[],intensity:null},"BIKF":{temp:-1,conditions:[],intensity:null},"ESGG":{temp:-7,conditions:[],intensity:null},"ESMS":{temp:-1,conditions:["snow"],intensity:null},"ENBR":{temp:-7,conditions:[],intensity:null},
  "ENZV":{temp:-4,conditions:["snow"],intensity:null},"ENTC":{temp:-9,conditions:[],intensity:null},"EFOU":{temp:-16,conditions:[],intensity:null},"EFRO":{temp:-22,conditions:[],intensity:null},"LGAV":{temp:13,conditions:[],intensity:null},"LGTS":{temp:14,conditions:[],intensity:null},"LGIR":{temp:16,conditions:[],intensity:null},"LGKR":{temp:15,conditions:[],intensity:null},"LGRP":{temp:15,conditions:[],intensity:null},"LGSR":{temp:17,conditions:[],intensity:null},
