...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LATI":{temp:7,conditions:[],intensity:null},"UKBB":{temp:-1,conditions:[],intensity:null},"UKLL":{temp:1,conditions:[],intensity:null},"UUEE":{temp:1,conditions:[],intensity:null},"UUDD":{temp:1,conditions:[],intensity:null},"UUWW":{temp:1,conditions:[],intensity:null},"ULLI":{temp:2,conditions:[],intensity:null},"UWWW":{temp:-4,conditions:[],intensity:null},"USSS":{temp:-21,conditions:[],intensity:null},"UNNT":{temp:-32,conditions:[],intensity:null},
