...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:7,conditions:[],intensity:null},"KLAX":{temp:13,conditions:[],intensity:null},"KORD":{temp:0,conditions:[],intensity:null},"KDFW":{temp:10,conditions:[],intensity:null},"KDEN":{temp:2,conditions:[],intensity:null},"KJFK":{temp:-3,conditions:[],intensity:null},"KSFO":{temp:9,conditions:[],intensity:null},"KSEA":{temp:5,conditions:[],intensity:null},"KLAS":{temp:10,conditions:[],intensity:null},"KMCO":{temp:14,conditions:["fog"],intensity:null},
  "KEWR":{temp:-3,conditions:[],intensity:null},"KMIA":{temp:17,conditions:[],intensity:null},"KPHX":{temp:15,conditions:[],intensity:null},"KIAH":{temp:8,conditions:["fog"],intensity:null},"KBOS":{temp:-9,conditions:[],intensity:null},"KMSP":{temp:-2,conditions:[],intensity:null},"KFLL":{temp:15,conditions:[],intensity:null},"KDTW":{temp:-2,conditions:[],intensity:null},"KPHL":{temp:-4,conditions:[],intensity:null},"KLGA":{temp:-1,conditions:[],intensity:null},
  "KBWI":{temp:-2,conditions:[],intensity:null},"KSLC":{temp:6,conditions:[],intensity:null},"KDCA":{temp:-4,conditions:[],intensity:null},"KIAD":{temp:-4,conditions:[],intensity:null},"KSAN":{temp:14,conditions:["rain"],intensity:null},"KTPA":{temp:14,conditions:["fog"],intensity:null},"KPDX":{temp:5,conditions:[],intensity:null},"KSTL":{temp:0,conditions:[],intensity:null},"KHNL":{temp:22,conditions:[],intensity:null},"KMEM":{temp:3,conditions:[],intensity:null},
  ...
  "KIND":{temp:0,conditions:[],intensity:null},"KCVG":{temp:-2,conditions:[],intensity:null},"KMCI":{temp:5,conditions:[],intensity:null},"KSAT":{temp:14,conditions:[],intensity:null},"KHOU":{temp:10,conditions:[],intensity:null},"KDAL":{temp:9,conditions:[],intensity:null},"KMDW":{temp:0,conditions:[],intensity:null},"PANC":{temp:-14,conditions:[],intensity:null},"PAFA":{temp:-30,conditions:[],intensity:null},"CYYZ":{temp:-6,conditions:[],intensity:null},
  "CYVR":{temp:5,conditions:[],intensity:null},"CYUL":{temp:-21,conditions:[],intensity:null},"CYYC":{temp:-11,conditions:[],intensity:null},"CYEG":{temp:-19,conditions:["snow"],intensity:null},"CYOW":{temp:-21,conditions:[],intensity:null},"CYWG":{temp:-8,conditions:[],intensity:null},"CYHZ":{temp:-14,conditions:[],intensity:null},"CYQB":{temp:-23,conditions:[],intensity:null},"CYYJ":{temp:5,conditions:[],intensity:null},"CYLW":{temp:3,conditions:[],intensity:null},
  "CYXE":{temp:-15,conditions:[],intensity:null},"CYQR":{temp:-11,conditions:[],intensity:null},"CYZF":{temp:-28,conditions:[],intensity:null},"CYXY":{temp:-32,conditions:[],intensity:null},"CYQT":{temp:-12,conditions:[],intensity:null},"CYYT":{temp:-1,conditions:["snow"],intensity:null},"MMMX":{temp:6,conditions:[],intensity:null},"MMUN":{temp:17,conditions:["fog"],intensity:null},"MMGL":{temp:16,conditions:[],intensity:null},"MMMY":{temp:14,conditions:[],intensity:null},
  "MMTJ":{temp:14,conditions:[],intensity:null},"MMSM":{temp:27,conditions:[],intensity:null},"MMMD":{temp:18,conditions:["fog"],intensity:null},"MMCZ":{temp:23,conditions:[],intensity:null},"MMSD":{temp:17,conditions:[],intensity:null},"MGGT":{temp:12,conditions:[],intensity:null},"MSLP":{temp:22,conditions:[],intensity:null},"MHTG":{temp:17,conditions:[],intensity:null},"MNMG":{temp:23,conditions:[],intensity:null},"MROC":{temp:20,conditions:[],intensity:null},
  "MPTO":{temp:24,conditions:[],intensity:null},"MKJP":{temp:22,conditions:["fog"],intensity:null},"TNCM":{temp:26,conditions:[],intensity:null},"TBPB":{temp:26,conditions:[],intensity:null},"TTPP":{temp:26,conditions:[],intensity:null},"MWCR":{temp:25,conditions:[],intensity:null},"MUHA":{temp:16,conditions:["fog"],intensity:null},"MDSD":{temp:26,conditions:[],intensity:null},"MDPP":{temp:26,conditions:[],intensity:null},"MTPP":{temp:27,conditions:[],intensity:null},
  ...
  "SBPA":{temp:19,conditions:[],intensity:null},"SBCT":{temp:15,conditions:[],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:13,conditions:["fog"],intensity:null},"SAEZ":{temp:15,conditions:[],intensity:null},"SABE":{temp:15,conditions:[],intensity:null},"SACO":{temp:14,conditions:[],intensity:null},"SAME":{temp:18,conditions:[],intensity:null},"SLLP":{temp:5,conditions:[],intensity:null},"SLVR":{temp:22,conditions:[],intensity:null},
  "SPJC":{temp:19,conditions:[],intensity:null},"SEQM":{temp:10,conditions:["fog"],intensity:null},"SEGU":{temp:22,conditions:[],intensity:null},"SKBO":{temp:9,conditions:["fog"],intensity:null},"SKMR":{temp:25,conditions:[],intensity:null},"SKCL":{temp:20,conditions:[],intensity:null},"SKMD":{temp:22,conditions:[],intensity:null},"SKRG":{temp:13,conditions:["fog"],intensity:null},"SVMI":{temp:27,conditions:[],intensity:null},"SUMU":{temp:13,conditions:[],intensity:null},
  ...
  "EGPH":{temp:-3,conditions:[],intensity:null},"EGPF":{temp:-3,conditions:[],intensity:null},"EGGW":{temp:-3,conditions:[],intensity:null},"EGNX":{temp:-3,conditions:[],intensity:null},"EGNT":{temp:-2,conditions:["snow"],intensity:null},"EGGP":{temp:-1,conditions:[],intensity:null},"EGHI":{temp:-1,conditions:[],intensity:null},"EGGD":{temp:-1,conditions:[],intensity:null},"EGPD":{temp:-1,conditions:[],intensity:null},"EGAA":{temp:0,conditions:[],intensity:null},
  "EIDW":{temp:-2,conditions:[],intensity:null},"EICK":{temp:-1,conditions:[],intensity:null},"EINN":{temp:-1,conditions:[],intensity:null},"LFPG":{temp:-3,conditions:[],intensity:null},"LFPO":{temp:-3,conditions:[],intensity:null},"LFML":{temp:2,conditions:[],intensity:null},"LFLL":{temp:-4,conditions:[],intensity:null},"LFMN":{temp:9,conditions:[],intensity:null},"LFBD":{temp:-3,conditions:[],intensity:null},"LFBO":{temp:-3,conditions:[],intensity:null},
  "LFRS":{temp:-2,conditions:[],intensity:null},"LFSB":{temp:-4,conditions:[],intensity:null},"LFPB":{temp:-3,conditions:[],intensity:null},"EDDF":{temp:-5,conditions:[],intensity:null},"EDDM":{temp:-9,conditions:[],intensity:null},"EDDB":{temp:-1,conditions:[],intensity:null},"EDDL":{temp:-1,conditions:[],intensity:null},"EDDH":{temp:0,conditions:[],intensity:null},"EDDK":{temp:-2,conditions:[],intensity:null},"EDDS":{temp:-4,conditions:[],intensity:null},
  "EDDW":{temp:-2,conditions:[],intensity:null},"EDDN":{temp:-3,conditions:[],intensity:null},"EDDV":{temp:-1,conditions:[],intensity:null},"EDDP":{temp:-1,conditions:[],intensity:null},"LEMD":{temp:2,conditions:[],intensity:null},"LEBL":{temp:5,conditions:[],intensity:null},"LEPA":{temp:9,conditions:[],intensity:null},"LEMG":{temp:14,conditions:[],intensity:null},"LEVC":{temp:8,conditions:[],intensity:null},"LEAL":{temp:10,conditions:[],intensity:null},
  "LEZL":{temp:11,conditions:[],intensity:null},"GCLP":{temp:19,conditions:[],intensity:null},"GCTS":{temp:17,conditions:[],intensity:null},"GCLA":{temp:16,conditions:[],intensity:null},"GCFV":{temp:17,conditions:[],intensity:null},"LPPT":{temp:9,conditions:[],intensity:null},"LPPR":{temp:6,conditions:[],intensity:null},"LPFR":{temp:12,conditions:[],intensity:null},"LPMA":{temp:14,conditions:[],intensity:null},"LIRF":{temp:15,conditions:[],intensity:null},
  "LIMC":{temp:-1,conditions:[],intensity:null},"LIME":{temp:-1,conditions:[],intensity:null},"LIPZ":{temp:3,conditions:[],intensity:null},"LIRN":{temp:14,conditions:[],intensity:null},"LIML":{temp:1,conditions:[],intensity:null},"LIPE":{temp:2,conditions:[],intensity:null},"LICC":{temp:18,conditions:[],intensity:null},"LICJ":{temp:18,conditions:[],intensity:null},"LIRA":{temp:13,conditions:[],intensity:null},"LIRP":{temp:7,conditions:[],intensity:null},
  "LIMF":{temp:0,conditions:[],intensity:null},"LIEO":{temp:12,conditions:[],intensity:null},"LIEE":{temp:14,conditions:[],intensity:null},"EHAM":{temp:0,conditions:["snow"],intensity:null},"EHRD":{temp:1,conditions:["snow"],intensity:null},"EHEH":{temp:-1,conditions:[],intensity:null},"EBBR":{temp:-1,conditions:[],intensity:null},"EBCI":{temp:-2,conditions:[],intensity:null},"ELLX":{temp:-5,conditions:[],intensity:null},"LSZH":{temp:-4,conditions:[],intensity:null},
  "LSGG":{temp:-3,conditions:[],intensity:null},"LSZB":{temp:-6,conditions:[],intensity:null},"LOWW":{temp:-3,conditions:[],intensity:null},"LOWS":{temp:-9,conditions:[],intensity:null},"LOWG":{temp:-4,conditions:[],intensity:null},"LOWI":{temp:-10,conditions:[],intensity:null},"LKPR":{temp:-4,conditions:[],intensity:null},"EPWA":{temp:-3,conditions:[],intensity:null},"EPKK":{temp:-3,conditions:[],intensity:null},"EPGD":{temp:-5,conditions:[],intensity:null},
  "EPWR":{temp:-2,conditions:[],intensity:null},"EPPO":{temp:-2,conditions:[],intensity:null},"EKCH":{temp:-2,conditions:["snow"],intensity:null},"ESSA":{temp:-9,conditions:[],intensity:null},"ENGM":{temp:-8,conditions:[],intensity:null},"EFHK":{temp:-17,conditions:[],intensity:null},"BIKF":{temp:2,conditions:[],intensity:null},"ESGG":{temp:-5,conditions:["snow"],intensity:null},"ESMS":{temp:-5,conditions:["snow"],intensity:null},"ENBR":{temp:-6,conditions:[],intensity:null},
  "ENZV":{temp:-3,conditions:[],intensity:null},"ENTC":{temp:-7,conditions:[],intensity:null},"EFOU":{temp:-15,conditions:[],intensity:null},"EFRO":{temp:-21,conditions:[],intensity:null},"LGAV":{temp:16,conditions:[],intensity:null},"LGTS":{temp:16,conditions:[],intensity:null},"LGIR":{temp:17,conditions:[],intensity:null},"LGKR":{temp:16,conditions:[],intensity:null},"LGRP":{temp:17,conditions:[],intensity:null},"LGSR":{temp:18,conditions:[],intensity:null},
  "LGMK":{temp:17,conditions:[],intensity:null},"LTFM":{temp:14,conditions:[],intensity:null},"LTBA":{temp:15,conditions:[],intensity:null},"LTFJ":{temp:15,conditions:[],intensity:null},"LTAI":{temp:16,conditions:[],intensity:null},"LTAC":{temp:6,conditions:[],intensity:null},"LTBJ":{temp:15,conditions:[],intensity:null},"LTBS":{temp:16,conditions:[],intensity:null},"LTFE":{temp:16,conditions:[],intensity:null},"LCLK":{temp:17,conditions:[],intensity:null},
  "LCPH":{temp:19,conditions:[],intensity:null},"LHBP":{temp:-1,conditions:[],intensity:null},"LROP":{temp:0,conditions:[],intensity:null},"LBSF":{temp:8,conditions:[],intensity:null},"LYBE":{temp:1,conditions:[],intensity:null},"LDZA":{temp:-1,conditions:[],intensity:null},"LDDU":{temp:14,conditions:["thunderstorm"],intensity:null},"LDSP":{temp:12,conditions:[],intensity:null},"LJLJ":{temp:-2,conditions:[],intensity:null},"LWSK":{temp:12,conditions:[],intensity:null},
  "LATI":{temp:16,conditions:[],intensity:null},"UKBB":{temp:-4,conditions:[],intensity:null},"UKLL":{temp:-4,conditions:[],intensity:null},"UUEE":{temp:-5,conditions:[],intensity:null},"UUDD":{temp:-4,conditions:[],intensity:null},"UUWW":{temp:-5,conditions:[],intensity:null},"ULLI":{temp:-9,conditions:[],intensity:null},"UWWW":{temp:-4,conditions:[],intensity:null},"USSS":{temp:-4,conditions:[],intensity:null},"UNNT":{temp:-9,conditions:[],intensity:null},
  "UUOB":{temp:-13,conditions:[],intensity:null},"UHWW":{temp:-9,conditions:[],intensity:null},"UEEE":{temp:-44,conditions:[],intensity:null},"OMDB":{temp:24,conditions:[],intensity:null},"OMDW":{temp:25,conditions:[],intensity:null},"OMAA":{temp:24,conditions:[],intensity:null},"OMSJ":{temp:26,conditions:[],intensity:null},"OTHH":{temp:20,conditions:[],intensity:null},"OERK":{temp:16,conditions:[],intensity:null},"OEJN":{temp:30,conditions:[],intensity:null},
  "OEDF":{temp:15,conditions:[],intensity:null},"OEMA":{temp:21,conditions:[],intensity:null},"OKBK":{temp:14,conditions:[],intensity:null},"OBBI":{temp:17,conditions:[],intensity:null},"OOMS":{temp:26,conditions:[],intensity:null},"OYAA":{temp:18,conditions:[],intensity:null},"OIIE":{temp:8,conditions:[],intensity:null},"OIII":{temp:8,conditions:[],intensity:null},"OISS":{temp:11,conditions:[],intensity:null},"OIKB":{temp:24,conditions:[],intensity:null},
  "OIAW":{temp:15,conditions:[],intensity:null},"OIKK":{temp:8,conditions:[],intensity:null},"OICC":{temp:8,conditions:[],intensity:null},"LLBG":{temp:21,conditions:[],intensity:null},"OLBA":{temp:20,conditions:[],intensity:null},"OJAM":{temp:11,conditions:[],intensity:null},"ORBI":{temp:13,conditions:[],intensity:null},"ORER":{temp:10,conditions:[],intensity:null},"GMMN":{temp:14,conditions:[],intensity:null},"GMME":{temp:15,conditions:[],intensity:null},
  "GMMX":{temp:13,conditions:[],intensity:null},"GMTT":{temp:15,conditions:[],intensity:null},"GMFF":{temp:12,conditions:[],intensity:null},"GMAD":{temp:16,conditions:[],intensity:null},"DAAG":{temp:15,conditions:[],intensity:null},"DAOO":{temp:14,conditions:[],intensity:null},"DTTA":{temp:16,conditions:[],intensity:null},"DTMB":{temp:17,conditions:[],intensity:null},"DTTJ":{temp:19,conditions:[],intensity:null},"HECA":{temp:19,conditions:[],intensity:null},
  "HEGN":{temp:23,conditions:[],intensity:null},"HESH":{temp:24,conditions:[],intensity:null},"HEBA":{temp:21,conditions:[],intensity:null},"HEAX":{temp:20,conditions:[],intensity:null},"HLLT":{temp:23,conditions:[],intensity:null},"DNMM":{temp:31,conditions:[],intensity:null},"DNAA":{temp:32,conditions:[],intensity:null},"DGAA":{temp:30,conditions:[],intensity:null},"DIAP":{temp:29,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  "GABS":{temp:23,conditions:[],intensity:null},"GVNP":{temp:21,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:31,conditions:[],intensity:null},"DBBB":{temp:31,conditions:[],intensity:null},"HKJK":{temp:24,conditions:[],intensity:null},"HKMO":{temp:34,conditions:[],intensity:null},"HTDA":{temp:30,conditions:[],intensity:null},"HTKJ":{temp:27,conditions:[],intensity:null},
  "HUEN":{temp:28,conditions:[],intensity:null},"HRYR":{temp:25,conditions:[],intensity:null},"HAAB":{temp:20,conditions:[],intensity:null},"HDAM":{temp:28,conditions:[],intensity:null},"HCMM":{temp:33,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:32,conditions:[],intensity:null},"FIMP":{temp:28,conditions:[],intensity:null},"FMCH":{temp:32,conditions:[],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  ...
  "FBSK":{temp:25,conditions:[],intensity:null},"FAOR":{temp:21,conditions:[],intensity:null},"FACT":{temp:28,conditions:[],intensity:null},"FALE":{temp:27,conditions:[],intensity:null},"FAPE":{temp:27,conditions:[],intensity:null},"FQMA":{temp:25,conditions:[],intensity:null},"FWKI":{temp:22,conditions:[],intensity:null},"ZBAA":{temp:0,conditions:[],intensity:null},"ZBAD":{temp:0,conditions:[],intensity:null},"ZSPD":{temp:7,conditions:[],intensity:null},
  "ZSSS":{temp:7,conditions:[],intensity:null},"ZGGG":{temp:14,conditions:[],intensity:null},"VHHH":{temp:20,conditions:[],intensity:null},"ZGSZ":{temp:18,conditions:[],intensity:null},"ZUUU":{temp:9,conditions:[],intensity:null},"ZUCK":{temp:10,conditions:[],intensity:null},"ZHCC":{temp:7,conditions:[],intensity:null},"ZLXY":{temp:2,conditions:[],intensity:null},"ZWSH":{temp:-10,conditions:[],intensity:null},"ZYHB":{temp:-14,conditions:[],intensity:null},
  "ZYTX":{temp:-9,conditions:[],intensity:null},"ZSAM":{temp:18,conditions:[],intensity:null},"ZGKL":{temp:7,conditions:[],intensity:null},"ZSNJ":{temp:7,conditions:[],intensity:null},"ZSHC":{temp:7,conditions:[],intensity:null},"ZPPP":{temp:12,conditions:[],intensity:null},"ZBTJ":{temp:1,conditions:[],intensity:null},"VMMC":{temp:18,conditions:[],intensity:null},"RJTT":{temp:10,conditions:[],intensity:null},"RJAA":{temp:7,conditions:[],intensity:null},
  "RJBB":{temp:11,conditions:[],intensity:null},"RJOO":{temp:8,conditions:[],intensity:null},"RJCC":{temp:-8,conditions:[],intensity:null},"RJFF":{temp:8,conditions:[],intensity:null},"RJGG":{temp:10,conditions:[],intensity:null},"ROAH":{temp:19,conditions:[],intensity:null},"RJSS":{temp:2,conditions:[],intensity:null},"RJSN":{temp:2,conditions:[],intensity:null},"RJOK":{temp:8,conditions:[],intensity:null},"RKSI":{temp:0,conditions:[],intensity:null},
  "RKSS":{temp:-3,conditions:[],intensity:null},"RKPK":{temp:2,conditions:[],intensity:null},"RKPC":{temp:5,conditions:[],intensity:null},"RKTN":{temp:-2,conditions:[],intensity:null},"ZKPY":{temp:-7,conditions:[],intensity:null},"WSSS":{temp:29,conditions:[],intensity:null},"WMKK":{temp:30,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:["thunderstorm"],intensity:null},"WBGG":{temp:29,conditions:[],intensity:null},
  "VTBS":{temp:30,conditions:[],intensity:null},"VTBD":{temp:30,conditions:[],intensity:null},"VTSP":{temp:31,conditions:[],intensity:null},"VTCC":{temp:27,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:30,conditions:[],intensity:null},"VVNB":{temp:15,conditions:[],intensity:null},"VVTS":{temp:26,conditions:[],intensity:null},"VVDN":{temp:21,conditions:[],intensity:null},"VVCR":{temp:24,conditions:[],intensity:null},
  "VDPP":{temp:30,conditions:[],intensity:null},"VDSR":{temp:30,conditions:[],intensity:null},"VLVT":{temp:25,conditions:[],intensity:null},"VLLB":{temp:25,conditions:[],intensity:null},"VYYY":{temp:29,conditions:[],intensity:null},"VYMD":{temp:28,conditions:[],intensity:null},"VGHS":{temp:19,conditions:[],intensity:null},"VGCG":{temp:21,conditions:[],intensity:null},"VECC":{temp:20,conditions:[],intensity:null},"VRMM":{temp:28,conditions:[],intensity:null},
  "VCBI":{temp:29,conditions:[],intensity:null},"WIII":{temp:29,conditions:[],intensity:null},"WADD":{temp:29,conditions:[],intensity:null},"WARR":{temp:30,conditions:[],intensity:null},"WIHH":{temp:29,conditions:[],intensity:null},"WIMM":{temp:29,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:27,conditions:[],intensity:null},"WICC":{temp:26,conditions:[],intensity:null},"WASS":{temp:29,conditions:[],intensity:null},
  "RPLL":{temp:26,conditions:[],intensity:null},"RPLC":{temp:26,conditions:[],intensity:null},"RPVM":{temp:26,conditions:["thunderstorm"],intensity:null},"RPVD":{temp:28,conditions:[],intensity:null},"RPVK":{temp:24,conditions:[],intensity:null},"WBSB":{temp:28,conditions:[],intensity:null},"WBLL":{temp:28,conditions:[],intensity:null},"VIDP":{temp:16,conditions:[],intensity:null},"VABB":{temp:25,conditions:[],intensity:null},"VOBL":{temp:25,conditions:[],intensity:null},
  "VOMM":{temp:27,conditions:[],intensity:null},"VEBS":{temp:20,conditions:[],intensity:null},"VOHY":{temp:25,conditions:[],intensity:null},"VAAH":{temp:26,conditions:[],intensity:null},"VOCI":{temp:29,conditions:[],intensity:null},"VAGO":{temp:33,conditions:[],intensity:null},"VOTP":{temp:27,conditions:[],intensity:null},"VIAR":{temp:15,conditions:[],intensity:null},"VIJP":{temp:18,conditions:[],intensity:null},"VELR":{temp:15,conditions:[],intensity:null},
  "VOCL":{temp:31,conditions:[],intensity:null},"VOTV":{temp:28,conditions:[],intensity:null},"VEPT":{temp:17,conditions:[],intensity:null},"VNKT":{temp:15,conditions:[],intensity:null},"OPKC":{temp:26,conditions:[],intensity:null},"OPLA":{temp:16,conditions:[],intensity:null},"OPIS":{temp:15,conditions:[],intensity:null},"RCTP":{temp:16,conditions:[],intensity:null},"RCSS":{temp:16,conditions:[],intensity:null},"RCMQ":{temp:16,conditions:[],intensity:null},
  "RCKH":{temp:21,conditions:[],intensity:null},"RCNN":{temp:19,conditions:[],intensity:null},"YSSY":{temp:20,conditions:[],intensity:null},"YMML":{temp:17,conditions:[],intensity:null},"YBBN":{temp:25,conditions:[],intensity:null},"YPPH":{temp:28,conditions:[],intensity:null},"YPAD":{temp:23,conditions:[],intensity:null},"YBCG":{temp:22,conditions:[],intensity:null},"YBCS":{temp:24,conditions:["thunderstorm"],intensity:null},"YSCB":{temp:19,conditions:[],intensity:null},
  "YMHB":{temp:19,conditions:[],intensity:null},"NZAA":{temp:21,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:15,conditions:[],intensity:null},"NZQN":{temp:15,conditions:[],intensity:null},"NZDN":{temp:13,conditions:[],intensity:null},"NFFN":{temp:29,conditions:[],intensity:null},"NWWW":{temp:29,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
