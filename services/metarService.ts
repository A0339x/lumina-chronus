...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:21,conditions:[],intensity:null},"KLAX":{temp:17,conditions:[],intensity:null},"KORD":{temp:2,conditions:[],intensity:null},"KDFW":{temp:9,conditions:[],intensity:null},"KDEN":{temp:4,conditions:[],intensity:null},"KJFK":{temp:7,conditions:[],intensity:null},"KSFO":{temp:9,conditions:[],intensity:null},"KSEA":{temp:7,conditions:[],intensity:null},"KLAS":{temp:11,conditions:[],intensity:null},"KMCO":{temp:27,conditions:[],intensity:null},
  "KEWR":{temp:6,conditions:[],intensity:null},"KMIA":{temp:26,conditions:[],intensity:null},"KPHX":{temp:15,conditions:[],intensity:null},"KIAH":{temp:11,conditions:[],intensity:null},"KBOS":{temp:7,conditions:[],intensity:null},"KMSP":{temp:-6,conditions:[],intensity:null},"KFLL":{temp:25,conditions:[],intensity:null},"KDTW":{temp:3,conditions:[],intensity:null},"KPHL":{temp:7,conditions:["rain"],intensity:null},"KLGA":{temp:8,conditions:[],intensity:null},
  "KBWI":{temp:7,conditions:[],intensity:null},"KSLC":{temp:2,conditions:[],intensity:null},"KDCA":{temp:9,conditions:["rain"],intensity:null},"KIAD":{temp:9,conditions:[],intensity:null},"KSAN":{temp:17,conditions:[],intensity:null},"KTPA":{temp:27,conditions:[],intensity:null},"KPDX":{temp:7,conditions:[],intensity:null},"KSTL":{temp:5,conditions:[],intensity:null},"KHNL":{temp:24,conditions:["fog"],intensity:null},"KMEM":{temp:11,conditions:[],intensity:null},
  ...
  "SBPA":{temp:27,conditions:[],intensity:null},"SBCT":{temp:28,conditions:[],intensity:null},"SBFZ":{temp:30,conditions:[],intensity:null},"SCEL":{temp:31,conditions:[],intensity:null},"SAEZ":{temp:21,conditions:[],intensity:null},"SABE":{temp:20,conditions:[],intensity:null},"SACO":{temp:25,conditions:[],intensity:null},"SAME":{temp:28,conditions:[],intensity:null},"SLLP":{temp:20,conditions:[],intensity:null},"SLVR":{temp:28,conditions:[],intensity:null},
  "SPJC":{temp:21,conditions:[],intensity:null},"SEQM":{temp:15,conditions:[],intensity:null},"SEGU":{temp:26,conditions:[],intensity:null},"SKBO":{temp:18,conditions:[],intensity:null},"SKMR":{temp:26,conditions:[],intensity:null},"SKCL":{temp:24,conditions:[],intensity:null},"SKMD":{temp:25,conditions:[],intensity:null},"SKRG":{temp:18,conditions:[],intensity:null},"SVMI":{temp:25,conditions:[],intensity:null},"SUMU":{temp:19,conditions:["rain"],intensity:null},
  ...
  "EGPH":{temp:1,conditions:[],intensity:null},"EGPF":{temp:3,conditions:[],intensity:null},"EGGW":{temp:1,conditions:[],intensity:null},"EGNX":{temp:-1,conditions:[],intensity:null},"EGNT":{temp:1,conditions:[],intensity:null},"EGGP":{temp:2,conditions:[],intensity:null},"EGHI":{temp:1,conditions:[],intensity:null},"EGGD":{temp:1,conditions:[],intensity:null},"EGPD":{temp:1,conditions:[],intensity:null},"EGAA":{temp:3,conditions:[],intensity:null},
  ...
  "LFRS":{temp:3,conditions:[],intensity:null},"LFSB":{temp:1,conditions:[],intensity:null},"LFPB":{temp:3,conditions:[],intensity:null},"EDDF":{temp:-3,conditions:[],intensity:null},"EDDM":{temp:0,conditions:["snow"],intensity:null},"EDDB":{temp:-2,conditions:[],intensity:null},"EDDL":{temp:-3,conditions:[],intensity:null},"EDDH":{temp:-4,conditions:[],intensity:null},"EDDK":{temp:-2,conditions:[],intensity:null},"EDDS":{temp:0,conditions:[],intensity:null},
  "EDDW":{temp:-3,conditions:[],intensity:null},"EDDN":{temp:-3,conditions:[],intensity:null},"EDDV":{temp:-5,conditions:[],intensity:null},"EDDP":{temp:-8,conditions:[],intensity:null},"LEMD":{temp:6,conditions:[],intensity:null},"LEBL":{temp:11,conditions:[],intensity:null},"LEPA":{temp:13,conditions:[],intensity:null},"LEMG":{temp:13,conditions:[],intensity:null},"LEVC":{temp:11,conditions:[],intensity:null},"LEAL":{temp:11,conditions:[],intensity:null},
  "LEZL":{temp:11,conditions:[],intensity:null},"GCLP":{temp:18,conditions:[],intensity:null},"GCTS":{temp:16,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:17,conditions:[],intensity:null},"LPPT":{temp:12,conditions:[],intensity:null},"LPPR":{temp:11,conditions:[],intensity:null},"LPFR":{temp:13,conditions:[],intensity:null},"LPMA":{temp:15,conditions:[],intensity:null},"LIRF":{temp:9,conditions:[],intensity:null},
  ...
  "LIMF":{temp:1,conditions:[],intensity:null},"LIEO":{temp:9,conditions:[],intensity:null},"LIEE":{temp:9,conditions:[],intensity:null},"EHAM":{temp:-2,conditions:[],intensity:null},"EHRD":{temp:-2,conditions:[],intensity:null},"EHEH":{temp:-2,conditions:[],intensity:null},"EBBR":{temp:-2,conditions:[],intensity:null},"EBCI":{temp:-2,conditions:[],intensity:null},"ELLX":{temp:-3,conditions:[],intensity:null},"LSZH":{temp:0,conditions:[],intensity:null},
  ...
  "HEGN":{temp:16,conditions:[],intensity:null},"HESH":{temp:16,conditions:[],intensity:null},"HEBA":{temp:17,conditions:[],intensity:null},"HEAX":{temp:15,conditions:[],intensity:null},"HLLT":{temp:15,conditions:[],intensity:null},"DNMM":{temp:29,conditions:[],intensity:null},"DNAA":{temp:25,conditions:[],intensity:null},"DGAA":{temp:27,conditions:[],intensity:null},"DIAP":{temp:28,conditions:[],intensity:null},"GOBD":{temp:24,conditions:[],intensity:null},
  "GABS":{temp:27,conditions:[],intensity:null},"GVNP":{temp:21,conditions:[],intensity:null},"GBYD":{temp:29,conditions:[],intensity:null},"GLRB":{temp:28,conditions:[],intensity:null},"DXXX":{temp:28,conditions:[],intensity:null},"DBBB":{temp:28,conditions:[],intensity:null},"HKJK":{temp:19,conditions:[],intensity:null},"HKMO":{temp:25,conditions:[],intensity:null},"HTDA":{temp:25,conditions:[],intensity:null},"HTKJ":{temp:21,conditions:[],intensity:null},
  "HUEN":{temp:21,conditions:[],intensity:null},"HRYR":{temp:19,conditions:[],intensity:null},"HAAB":{temp:15,conditions:[],intensity:null},"HDAM":{temp:21,conditions:[],intensity:null},"HCMM":{temp:23,conditions:[],intensity:null},"OYSN":{temp:22,conditions:[],intensity:null},"FMEE":{temp:26,conditions:["fog"],intensity:null},"FIMP":{temp:23,conditions:[],intensity:null},"FMCH":{temp:28,conditions:[],intensity:null},"FMMI":{temp:20,conditions:[],intensity:null},
  ...
  "RJBB":{temp:10,conditions:[],intensity:null},"RJOO":{temp:8,conditions:[],intensity:null},"RJCC":{temp:3,conditions:[],intensity:null},"RJFF":{temp:5,conditions:[],intensity:null},"RJGG":{temp:11,conditions:[],intensity:null},"ROAH":{temp:18,conditions:[],intensity:null},"RJSS":{temp:7,conditions:[],intensity:null},"RJSN":{temp:8,conditions:[],intensity:null},"RJOK":{temp:8,conditions:[],intensity:null},"RKSI":{temp:-6,conditions:[],intensity:null},
  "RKSS":{temp:-9,conditions:[],intensity:null},"RKPK":{temp:-2,conditions:[],intensity:null},"RKPC":{temp:3,conditions:[],intensity:null},"RKTN":{temp:-5,conditions:[],intensity:null},"ZKPY":{temp:-13,conditions:[],intensity:null},"WSSS":{temp:24,conditions:[],intensity:null},"WMKK":{temp:25,conditions:[],intensity:null},"WMKP":{temp:27,conditions:[],intensity:null},"WBKK":{temp:27,conditions:[],intensity:null},"WBGG":{temp:24,conditions:[],intensity:null},
  ...
  "YMHB":{temp:11,conditions:[],intensity:null},"NZAA":{temp:20,conditions:[],intensity:null},"NZWN":{temp:19,conditions:[],intensity:null},"NZCH":{temp:22,conditions:[],intensity:null},"NZQN":{temp:17,conditions:["rain"],intensity:null},"NZDN":{temp:18,conditions:[],intensity:null},"NFFN":{temp:27,conditions:[],intensity:null},"NWWW":{temp:29,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
  "NIUE":{temp:26,conditions:[],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:24,conditions:["fog"],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:21,conditions:[],intensity:null}
};
