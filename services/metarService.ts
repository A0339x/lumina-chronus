...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:19,conditions:[],intensity:null},"KLAX":{temp:14,conditions:[],intensity:null},"KORD":{temp:7,conditions:[],intensity:null},"KDFW":{temp:21,conditions:[],intensity:null},"KDEN":{temp:-1,conditions:[],intensity:null},"KJFK":{temp:11,conditions:["fog"],intensity:null},"KSFO":{temp:10,conditions:[],intensity:null},"KSEA":{temp:5,conditions:[],intensity:null},"KLAS":{temp:11,conditions:[],intensity:null},"KMCO":{temp:17,conditions:[],intensity:null},
  "KEWR":{temp:15,conditions:[],intensity:null},"KMIA":{temp:22,conditions:[],intensity:null},"KPHX":{temp:17,conditions:[],intensity:null},"KIAH":{temp:22,conditions:[],intensity:null},"KBOS":{temp:12,conditions:[],intensity:null},"KMSP":{temp:1,conditions:["fog"],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:6,conditions:[],intensity:null},"KPHL":{temp:15,conditions:[],intensity:null},"KLGA":{temp:15,conditions:[],intensity:null},
  "KBWI":{temp:17,conditions:[],intensity:null},"KSLC":{temp:0,conditions:[],intensity:null},"KDCA":{temp:20,conditions:[],intensity:null},"KIAD":{temp:19,conditions:[],intensity:null},"KSAN":{temp:12,conditions:[],intensity:null},"KTPA":{temp:20,conditions:[],intensity:null},"KPDX":{temp:5,conditions:[],intensity:null},"KSTL":{temp:16,conditions:["rain"],intensity:null},"KHNL":{temp:22,conditions:[],intensity:null},"KMEM":{temp:20,conditions:[],intensity:null},
  "KAUS":{temp:23,conditions:[],intensity:null},"KBNA":{temp:18,conditions:[],intensity:null},"KRDU":{temp:17,conditions:["fog"],intensity:null},"KCLT":{temp:17,conditions:[],intensity:null},"KSMF":{temp:8,conditions:[],intensity:null},"KSJC":{temp:10,conditions:[],intensity:null},"KOAK":{temp:10,conditions:[],intensity:null},"KCLE":{temp:12,conditions:[],intensity:null},"KMKE":{temp:4,conditions:["fog"],intensity:null},"KPIT":{temp:16,conditions:[],intensity:null},
  "KIND":{temp:20,conditions:[],intensity:null},"KCVG":{temp:18,conditions:[],intensity:null},"KMCI":{temp:3,conditions:[],intensity:null},"KSAT":{temp:22,conditions:[],intensity:null},"KHOU":{temp:24,conditions:[],intensity:null},"KDAL":{temp:21,conditions:[],intensity:null},"KMDW":{temp:9,conditions:[],intensity:null},"PANC":{temp:-3,conditions:["fog"],intensity:null},"PAFA":{temp:-8,conditions:[],intensity:null},"CYYZ":{temp:3,conditions:[],intensity:null},
  "CYVR":{temp:7,conditions:[],intensity:null},"CYUL":{temp:2,conditions:[],intensity:null},"CYYC":{temp:3,conditions:[],intensity:null},"CYEG":{temp:2,conditions:[],intensity:null},"CYOW":{temp:1,conditions:[],intensity:null},"CYWG":{temp:-3,conditions:[],intensity:null},"CYHZ":{temp:1,conditions:[],intensity:null},"CYQB":{temp:-3,conditions:[],intensity:null},"CYYJ":{temp:5,conditions:[],intensity:null},"CYLW":{temp:7,conditions:[],intensity:null},
  "CYXE":{temp:0,conditions:[],intensity:null},"CYQR":{temp:-7,conditions:["fog"],intensity:null},"CYZF":{temp:-15,conditions:[],intensity:null},"CYXY":{temp:-5,conditions:[],intensity:null},"CYQT":{temp:-1,conditions:["snow"],intensity:null},"CYYT":{temp:-3,conditions:[],intensity:null},"MMMX":{temp:14,conditions:[],intensity:null},"MMUN":{temp:23,conditions:[],intensity:null},"MMGL":{temp:16,conditions:[],intensity:null},"MMMY":{temp:22,conditions:[],intensity:null},
  "MMTJ":{temp:12,conditions:[],intensity:null},"MMSM":{temp:26,conditions:[],intensity:null},"MMMD":{temp:22,conditions:[],intensity:null},"MMCZ":{temp:25,conditions:[],intensity:null},"MMSD":{temp:20,conditions:[],intensity:null},"MGGT":{temp:16,conditions:[],intensity:null},"MSLP":{temp:25,conditions:[],intensity:null},"MHTG":{temp:20,conditions:[],intensity:null},"MNMG":{temp:24,conditions:[],intensity:null},"MROC":{temp:21,conditions:[],intensity:null},
  "MPTO":{temp:24,conditions:[],intensity:null},"MKJP":{temp:23,conditions:[],intensity:null},"TNCM":{temp:25,conditions:[],intensity:null},"TBPB":{temp:26,conditions:[],intensity:null},"TTPP":{temp:27,conditions:[],intensity:null},"MWCR":{temp:26,conditions:[],intensity:null},"MUHA":{temp:21,conditions:[],intensity:null},"MDSD":{temp:24,conditions:[],intensity:null},"MDPP":{temp:25,conditions:[],intensity:null},"MTPP":{temp:26,conditions:[],intensity:null},
  "TJSJ":{temp:24,conditions:[],intensity:null},"TIST":{temp:25,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:25,conditions:[],intensity:null},"SBGL":{temp:29,conditions:[],intensity:null},"SBBR":{temp:22,conditions:[],intensity:null},"SBCF":{temp:24,conditions:[],intensity:null},"SBSV":{temp:27,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null},
  "SBPA":{temp:24,conditions:["fog"],intensity:null},"SBCT":{temp:23,conditions:[],intensity:null},"SBFZ":{temp:28,conditions:[],intensity:null},"SCEL":{temp:18,conditions:[],intensity:null},"SAEZ":{temp:14,conditions:[],intensity:null},"SABE":{temp:15,conditions:[],intensity:null},"SACO":{temp:16,conditions:["rain"],intensity:null},"SAME":{temp:15,conditions:[],intensity:null},"SLLP":{temp:2,conditions:["fog"],intensity:null},"SLVR":{temp:24,conditions:["fog"],intensity:null},
  "SPJC":{temp:21,conditions:[],intensity:null},"SEQM":{temp:10,conditions:["fog"],intensity:null},"SEGU":{temp:24,conditions:[],intensity:null},"SKBO":{temp:13,conditions:[],intensity:null},"SKMR":{temp:23,conditions:[],intensity:null},"SKCL":{temp:21,conditions:[],intensity:null},"SKMD":{temp:23,conditions:[],intensity:null},"SKRG":{temp:14,conditions:[],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:18,conditions:[],intensity:null},
  "SGAS":{temp:27,conditions:[],intensity:null},"SBBV":{temp:26,conditions:[],intensity:null},"SMJP":{temp:26,conditions:[],intensity:null},"SYCJ":{temp:25,conditions:[],intensity:null},"EGLL":{temp:14,conditions:[],intensity:null},"EGKK":{temp:13,conditions:[],intensity:null},"EGSS":{temp:13,conditions:[],intensity:null},"EGLC":{temp:14,conditions:[],intensity:null},"EGCC":{temp:11,conditions:[],intensity:null},"EGBB":{temp:13,conditions:[],intensity:null},
  "EGPH":{temp:6,conditions:[],intensity:null},"EGPF":{temp:6,conditions:[],intensity:null},"EGGW":{temp:13,conditions:[],intensity:null},"EGNX":{temp:13,conditions:[],intensity:null},"EGNT":{temp:7,conditions:[],intensity:null},"EGGP":{temp:12,conditions:[],intensity:null},"EGHI":{temp:13,conditions:[],intensity:null},"EGGD":{temp:12,conditions:[],intensity:null},"EGPD":{temp:7,conditions:[],intensity:null},"EGAA":{temp:7,conditions:[],intensity:null},
  "EIDW":{temp:12,conditions:[],intensity:null},"EICK":{temp:11,conditions:[],intensity:null},"EINN":{temp:12,conditions:[],intensity:null},"LFPG":{temp:16,conditions:[],intensity:null},"LFPO":{temp:16,conditions:[],intensity:null},"LFML":{temp:21,conditions:[],intensity:null},"LFLL":{temp:16,conditions:[],intensity:null},"LFMN":{temp:18,conditions:[],intensity:null},"LFBD":{temp:19,conditions:[],intensity:null},"LFBO":{temp:18,conditions:[],intensity:null},
  "LFRS":{temp:17,conditions:[],intensity:null},"LFSB":{temp:16,conditions:[],intensity:null},"LFPB":{temp:17,conditions:[],intensity:null},"EDDF":{temp:16,conditions:[],intensity:null},"EDDM":{temp:13,conditions:[],intensity:null},"EDDB":{temp:14,conditions:[],intensity:null},"EDDL":{temp:12,conditions:[],intensity:null},"EDDH":{temp:12,conditions:[],intensity:null},"EDDK":{temp:15,conditions:[],intensity:null},"EDDS":{temp:13,conditions:[],intensity:null},
  "EDDW":{temp:13,conditions:[],intensity:null},"EDDN":{temp:13,conditions:[],intensity:null},"EDDV":{temp:14,conditions:[],intensity:null},"EDDP":{temp:14,conditions:[],intensity:null},"LEMD":{temp:20,conditions:[],intensity:null},"LEBL":{temp:18,conditions:[],intensity:null},"LEPA":{temp:19,conditions:[],intensity:null},"LEMG":{temp:19,conditions:[],intensity:null},"LEVC":{temp:23,conditions:[],intensity:null},"LEAL":{temp:20,conditions:[],intensity:null},
  "LEZL":{temp:26,conditions:[],intensity:null},"GCLP":{temp:20,conditions:[],intensity:null},"GCTS":{temp:20,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:24,conditions:[],intensity:null},"LPPT":{temp:22,conditions:[],intensity:null},"LPPR":{temp:20,conditions:[],intensity:null},"LPFR":{temp:22,conditions:[],intensity:null},"LPMA":{temp:19,conditions:[],intensity:null},"LIRF":{temp:21,conditions:[],intensity:null},
  "LIMC":{temp:21,conditions:[],intensity:null},"LIME":{temp:19,conditions:[],intensity:null},"LIPZ":{temp:16,conditions:[],intensity:null},"LIRN":{temp:19,conditions:[],intensity:null},"LIML":{temp:20,conditions:[],intensity:null},"LIPE":{temp:21,conditions:[],intensity:null},"LICC":{temp:19,conditions:[],intensity:null},"LICJ":{temp:17,conditions:[],intensity:null},"LIRA":{temp:20,conditions:[],intensity:null},"LIRP":{temp:21,conditions:[],intensity:null},
  "LIMF":{temp:21,conditions:[],intensity:null},"LIEO":{temp:21,conditions:[],intensity:null},"LIEE":{temp:20,conditions:[],intensity:null},"EHAM":{temp:15,conditions:[],intensity:null},"EHRD":{temp:14,conditions:[],intensity:null},"EHEH":{temp:13,conditions:[],intensity:null},"EBBR":{temp:12,conditions:[],intensity:null},"EBCI":{temp:11,conditions:[],intensity:null},"ELLX":{temp:11,conditions:[],intensity:null},"LSZH":{temp:16,conditions:[],intensity:null},
  "LSGG":{temp:17,conditions:[],intensity:null},"LSZB":{temp:16,conditions:[],intensity:null},"LOWW":{temp:14,conditions:[],intensity:null},"LOWS":{temp:10,conditions:[],intensity:null},"LOWG":{temp:18,conditions:[],intensity:null},"LOWI":{temp:13,conditions:[],intensity:null},"LKPR":{temp:12,conditions:[],intensity:null},"EPWA":{temp:10,conditions:[],intensity:null},"EPKK":{temp:14,conditions:[],intensity:null},"EPGD":{temp:9,conditions:[],intensity:null},
  "EPWR":{temp:13,conditions:[],intensity:null},"EPPO":{temp:15,conditions:[],intensity:null},"EKCH":{temp:11,conditions:[],intensity:null},"ESSA":{temp:4,conditions:[],intensity:null},"ENGM":{temp:7,conditions:[],intensity:null},"EFHK":{temp:5,conditions:[],intensity:null},"BIKF":{temp:1,conditions:[],intensity:null},"ESGG":{temp:8,conditions:[],intensity:null},"ESMS":{temp:9,conditions:[],intensity:null},"ENBR":{temp:7,conditions:[],intensity:null},
  "ENZV":{temp:8,conditions:[],intensity:null},"ENTC":{temp:2,conditions:[],intensity:null},"EFOU":{temp:9,conditions:[],intensity:null},"EFRO":{temp:6,conditions:[],intensity:null},"LGAV":{temp:16,conditions:[],intensity:null},"LGTS":{temp:19,conditions:[],intensity:null},"LGIR":{temp:16,conditions:[],intensity:null},"LGKR":{temp:19,conditions:[],intensity:null},"LGRP":{temp:18,conditions:[],intensity:null},"LGSR":{temp:16,conditions:[],intensity:null},
  "LGMK":{temp:15,conditions:["thunderstorm"],intensity:null},"LTFM":{temp:10,conditions:[],intensity:null},"LTBA":{temp:14,conditions:[],intensity:null},"LTFJ":{temp:14,conditions:[],intensity:null},"LTAI":{temp:15,conditions:["thunderstorm"],intensity:null},"LTAC":{temp:12,conditions:[],intensity:null},"LTBJ":{temp:15,conditions:[],intensity:null},"LTBS":{temp:16,conditions:["thunderstorm"],intensity:null},"LTFE":{temp:16,conditions:[],intensity:null},"LCLK":{temp:19,conditions:[],intensity:null},
  "LCPH":{temp:16,conditions:["thunderstorm"],intensity:null},"LHBP":{temp:18,conditions:[],intensity:null},"LROP":{temp:18,conditions:[],intensity:null},"LBSF":{temp:13,conditions:[],intensity:null},"LYBE":{temp:17,conditions:[],intensity:null},"LDZA":{temp:18,conditions:[],intensity:null},"LDDU":{temp:19,conditions:[],intensity:null},"LDSP":{temp:21,conditions:[],intensity:null},"LJLJ":{temp:17,conditions:[],intensity:null},"LWSK":{temp:15,conditions:[],intensity:null},
  "LATI":{temp:21,conditions:[],intensity:null},"UKBB":{temp:15,conditions:[],intensity:null},"UKLL":{temp:14,conditions:[],intensity:null},"UUEE":{temp:13,conditions:[],intensity:null},"UUDD":{temp:14,conditions:[],intensity:null},"UUWW":{temp:14,conditions:[],intensity:null},"ULLI":{temp:4,conditions:[],intensity:null},"UWWW":{temp:13,conditions:[],intensity:null},"USSS":{temp:14,conditions:[],intensity:null},"UNNT":{temp:12,conditions:[],intensity:null},
  "UUOB":{temp:-2,conditions:[],intensity:null},"UHWW":{temp:2,conditions:[],intensity:null},"UEEE":{temp:-6,conditions:[],intensity:null},"OMDB":{temp:24,conditions:[],intensity:null},"OMDW":{temp:25,conditions:[],intensity:null},"OMAA":{temp:28,conditions:[],intensity:null},"OMSJ":{temp:25,conditions:[],intensity:null},"OTHH":{temp:29,conditions:[],intensity:null},"OERK":{temp:36,conditions:[],intensity:null},"OEJN":{temp:32,conditions:[],intensity:null},
  "OEDF":{temp:26,conditions:[],intensity:null},"OEMA":{temp:35,conditions:[],intensity:null},"OKBK":{temp:20,conditions:[],intensity:null},"OBBI":{temp:25,conditions:[],intensity:null},"OOMS":{temp:28,conditions:[],intensity:null},"OYAA":{temp:24,conditions:[],intensity:null},"OIIE":{temp:21,conditions:[],intensity:null},"OIII":{temp:20,conditions:[],intensity:null},"OISS":{temp:18,conditions:[],intensity:null},"OIKB":{temp:25,conditions:[],intensity:null},
  "OIAW":{temp:28,conditions:[],intensity:null},"OIKK":{temp:21,conditions:[],intensity:null},"OICC":{temp:16,conditions:[],intensity:null},"LLBG":{temp:23,conditions:[],intensity:null},"OLBA":{temp:21,conditions:[],intensity:null},"OJAM":{temp:19,conditions:[],intensity:null},"ORBI":{temp:23,conditions:[],intensity:null},"ORER":{temp:19,conditions:[],intensity:null},"GMMN":{temp:27,conditions:[],intensity:null},"GMME":{temp:27,conditions:[],intensity:null},
  "GMMX":{temp:29,conditions:[],intensity:null},"GMTT":{temp:20,conditions:[],intensity:null},"GMFF":{temp:23,conditions:[],intensity:null},"GMAD":{temp:30,conditions:[],intensity:null},"DAAG":{temp:18,conditions:[],intensity:null},"DAOO":{temp:19,conditions:[],intensity:null},"DTTA":{temp:18,conditions:[],intensity:null},"DTMB":{temp:18,conditions:[],intensity:null},"DTTJ":{temp:17,conditions:[],intensity:null},"HECA":{temp:24,conditions:[],intensity:null},
  "HEGN":{temp:26,conditions:[],intensity:null},"HESH":{temp:27,conditions:[],intensity:null},"HEBA":{temp:31,conditions:[],intensity:null},"HEAX":{temp:20,conditions:[],intensity:null},"HLLT":{temp:15,conditions:[],intensity:null},"DNMM":{temp:33,conditions:[],intensity:null},"DNAA":{temp:33,conditions:[],intensity:null},"DGAA":{temp:31,conditions:[],intensity:null},"DIAP":{temp:32,conditions:[],intensity:null},"GOBD":{temp:33,conditions:[],intensity:null},
  "GABS":{temp:34,conditions:[],intensity:null},"GVNP":{temp:28,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:32,conditions:[],intensity:null},"DXXX":{temp:32,conditions:[],intensity:null},"DBBB":{temp:33,conditions:[],intensity:null},"HKJK":{temp:26,conditions:[],intensity:null},"HKMO":{temp:33,conditions:[],intensity:null},"HTDA":{temp:32,conditions:[],intensity:null},"HTKJ":{temp:29,conditions:[],intensity:null},
  "HUEN":{temp:28,conditions:[],intensity:null},"HRYR":{temp:28,conditions:[],intensity:null},"HAAB":{temp:23,conditions:[],intensity:null},"HDAM":{temp:33,conditions:[],intensity:null},"HCMM":{temp:32,conditions:[],intensity:null},"OYSN":{temp:30,conditions:[],intensity:null},"FMEE":{temp:28,conditions:[],intensity:null},"FIMP":{temp:26,conditions:[],intensity:null},"FMCH":{temp:29,conditions:["thunderstorm"],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  "FSIA":{temp:29,conditions:[],intensity:null},"FKKD":{temp:30,conditions:[],intensity:null},"FKYS":{temp:27,conditions:[],intensity:null},"FOOL":{temp:27,conditions:["thunderstorm"],intensity:null},"FZAA":{temp:27,conditions:[],intensity:null},"FCBB":{temp:27,conditions:[],intensity:null},"FLLK":{temp:25,conditions:[],intensity:null},"FVHA":{temp:25,conditions:[],intensity:null},"FLLS":{temp:25,conditions:[],intensity:null},"FYWH":{temp:24,conditions:[],intensity:null},
  "FBSK":{temp:28,conditions:[],intensity:null},"FAOR":{temp:25,conditions:[],intensity:null},"FACT":{temp:22,conditions:[],intensity:null},"FALE":{temp:28,conditions:[],intensity:null},"FAPE":{temp:25,conditions:[],intensity:null},"FQMA":{temp:29,conditions:[],intensity:null},"FWKI":{temp:24,conditions:[],intensity:null},"ZBAA":{temp:14,conditions:[],intensity:null},"ZBAD":{temp:15,conditions:[],intensity:null},"ZSPD":{temp:13,conditions:[],intensity:null},
  "ZSSS":{temp:15,conditions:[],intensity:null},"ZGGG":{temp:24,conditions:[],intensity:null},"VHHH":{temp:25,conditions:[],intensity:null},"ZGSZ":{temp:24,conditions:[],intensity:null},"ZUUU":{temp:23,conditions:[],intensity:null},"ZUCK":{temp:24,conditions:[],intensity:null},"ZHCC":{temp:17,conditions:[],intensity:null},"ZLXY":{temp:15,conditions:[],intensity:null},"ZWSH":{temp:21,conditions:[],intensity:null},"ZYHB":{temp:2,conditions:[],intensity:null},
  "ZYTX":{temp:7,conditions:[],intensity:null},"ZSAM":{temp:21,conditions:[],intensity:null},"ZGKL":{temp:22,conditions:[],intensity:null},"ZSNJ":{temp:18,conditions:[],intensity:null},"ZSHC":{temp:21,conditions:[],intensity:null},"ZPPP":{temp:20,conditions:[],intensity:null},"ZBTJ":{temp:14,conditions:[],intensity:null},"VMMC":{temp:25,conditions:[],intensity:null},"RJTT":{temp:16,conditions:[],intensity:null},"RJAA":{temp:16,conditions:[],intensity:null},
  "RJBB":{temp:18,conditions:[],intensity:null},"RJOO":{temp:16,conditions:[],intensity:null},"RJCC":{temp:7,conditions:[],intensity:null},"RJFF":{temp:15,conditions:[],intensity:null},"RJGG":{temp:17,conditions:["rain"],intensity:null},"ROAH":{temp:22,conditions:[],intensity:null},"RJSS":{temp:13,conditions:[],intensity:null},"RJSN":{temp:14,conditions:[],intensity:null},"RJOK":{temp:19,conditions:[],intensity:null},"RKSI":{temp:9,conditions:[],intensity:null},
  "RKSS":{temp:9,conditions:[],intensity:null},"RKPK":{temp:14,conditions:[],intensity:null},"RKPC":{temp:12,conditions:[],intensity:null},"RKTN":{temp:12,conditions:[],intensity:null},"ZKPY":{temp:5,conditions:[],intensity:null},"WSSS":{temp:28,conditions:[],intensity:null},"WMKK":{temp:29,conditions:[],intensity:null},"WMKP":{temp:31,conditions:[],intensity:null},"WBKK":{temp:28,conditions:["thunderstorm"],intensity:null},"WBGG":{temp:27,conditions:[],intensity:null},
  "VTBS":{temp:30,conditions:[],intensity:null},"VTBD":{temp:31,conditions:[],intensity:null},"VTSP":{temp:30,conditions:[],intensity:null},"VTCC":{temp:35,conditions:[],intensity:null},"VTSS":{temp:29,conditions:[],intensity:null},"VTUK":{temp:29,conditions:[],intensity:null},"VVNB":{temp:27,conditions:[],intensity:null},"VVTS":{temp:29,conditions:[],intensity:null},"VVDN":{temp:28,conditions:[],intensity:null},"VVCR":{temp:28,conditions:[],intensity:null},
  "VDPP":{temp:32,conditions:[],intensity:null},"VDSR":{temp:32,conditions:[],intensity:null},"VLVT":{temp:33,conditions:[],intensity:null},"VLLB":{temp:31,conditions:[],intensity:null},"VYYY":{temp:34,conditions:[],intensity:null},"VYMD":{temp:36,conditions:[],intensity:null},"VGHS":{temp:34,conditions:[],intensity:null},"VGCG":{temp:28,conditions:[],intensity:null},"VECC":{temp:32,conditions:[],intensity:null},"VRMM":{temp:29,conditions:[],intensity:null},
  "VCBI":{temp:29,conditions:[],intensity:null},"WIII":{temp:28,conditions:["thunderstorm"],intensity:null},"WADD":{temp:28,conditions:[],intensity:null},"WARR":{temp:28,conditions:[],intensity:null},"WIHH":{temp:28,conditions:[],intensity:null},"WIMM":{temp:29,conditions:[],intensity:null},"WIBB":{temp:29,conditions:[],intensity:null},"WAFF":{temp:29,conditions:[],intensity:null},"WICC":{temp:24,conditions:["thunderstorm"],intensity:null},"WASS":{temp:28,conditions:[],intensity:null},
  "RPLL":{temp:28,conditions:[],intensity:null},"RPLC":{temp:25,conditions:[],intensity:null},"RPVM":{temp:27,conditions:[],intensity:null},"RPVD":{temp:26,conditions:["thunderstorm"],intensity:null},"RPVK":{temp:24,conditions:[],intensity:null},"WBSB":{temp:27,conditions:[],intensity:null},"WBLL":{temp:28,conditions:[],intensity:null},"VIDP":{temp:27,conditions:[],intensity:null},"VABB":{temp:28,conditions:[],intensity:null},"VOBL":{temp:30,conditions:[],intensity:null},
  "VOMM":{temp:32,conditions:[],intensity:null},"VEBS":{temp:32,conditions:[],intensity:null},"VOHY":{temp:33,conditions:[],intensity:null},"VAAH":{temp:33,conditions:[],intensity:null},"VOCI":{temp:29,conditions:[],intensity:null},"VAGO":{temp:29,conditions:[],intensity:null},"VOTP":{temp:26,conditions:["thunderstorm"],intensity:null},"VIAR":{temp:20,conditions:[],intensity:null},"VIJP":{temp:30,conditions:[],intensity:null},"VELR":{temp:23,conditions:[],intensity:null},
  "VOCL":{temp:29,conditions:[],intensity:null},"VOTV":{temp:29,conditions:[],intensity:null},"VEPT":{temp:34,conditions:[],intensity:null},"VNKT":{temp:25,conditions:[],intensity:null},"OPKC":{temp:28,conditions:[],intensity:null},"OPLA":{temp:21,conditions:[],intensity:null},"OPIS":{temp:19,conditions:[],intensity:null},"RCTP":{temp:20,conditions:[],intensity:null},"RCSS":{temp:20,conditions:[],intensity:null},"RCMQ":{temp:22,conditions:["rain"],intensity:null},
  "RCKH":{temp:25,conditions:[],intensity:null},"RCNN":{temp:24,conditions:["thunderstorm"],intensity:null},"YSSY":{temp:16,conditions:[],intensity:null},"YMML":{temp:11,conditions:[],intensity:null},"YBBN":{temp:22,conditions:[],intensity:null},"YPPH":{temp:22,conditions:[],intensity:null},"YPAD":{temp:21,conditions:[],intensity:null},"YBCG":{temp:20,conditions:[],intensity:null},"YBCS":{temp:22,conditions:[],intensity:null},"YSCB":{temp:12,conditions:[],intensity:null},
  "YMHB":{temp:14,conditions:[],intensity:null},"NZAA":{temp:18,conditions:[],intensity:null},"NZWN":{temp:15,conditions:[],intensity:null},"NZCH":{temp:12,conditions:[],intensity:null},"NZQN":{temp:9,conditions:[],intensity:null},"NZDN":{temp:8,conditions:[],intensity:null},"NFFN":{temp:27,conditions:[],intensity:null},"NWWW":{temp:27,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
  "NIUE":{temp:27,conditions:[],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:21,conditions:[],intensity:null},"PHKO":{temp:25,conditions:[],intensity:null},"PHLH":{temp:18,conditions:[],intensity:null}
};
