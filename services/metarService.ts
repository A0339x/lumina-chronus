...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:6,conditions:[],intensity:null},"KLAX":{temp:13,conditions:[],intensity:null},"KORD":{temp:-7,conditions:[],intensity:null},"KDFW":{temp:4,conditions:[],intensity:null},"KDEN":{temp:-7,conditions:[],intensity:null},"KJFK":{temp:1,conditions:[],intensity:null},"KSFO":{temp:9,conditions:[],intensity:null},"KSEA":{temp:4,conditions:[],intensity:null},"KLAS":{temp:11,conditions:[],intensity:null},"KMCO":{temp:7,conditions:[],intensity:null},
  "KEWR":{temp:0,conditions:[],intensity:null},"KMIA":{temp:16,conditions:[],intensity:null},"KPHX":{temp:13,conditions:[],intensity:null},"KIAH":{temp:13,conditions:[],intensity:null},"KBOS":{temp:-2,conditions:[],intensity:null},"KMSP":{temp:-13,conditions:[],intensity:null},"KFLL":{temp:19,conditions:[],intensity:null},"KDTW":{temp:-1,conditions:[],intensity:null},"KPHL":{temp:1,conditions:[],intensity:null},"KLGA":{temp:0,conditions:[],intensity:null},
  "KBWI":{temp:0,conditions:[],intensity:null},"KSLC":{temp:-1,conditions:[],intensity:null},"KDCA":{temp:2,conditions:[],intensity:null},"KIAD":{temp:3,conditions:[],intensity:null},"KSAN":{temp:14,conditions:["fog"],intensity:null},"KTPA":{temp:5,conditions:[],intensity:null},"KPDX":{temp:4,conditions:[],intensity:null},"KSTL":{temp:-3,conditions:[],intensity:null},"KHNL":{temp:20,conditions:[],intensity:null},"KMEM":{temp:2,conditions:[],intensity:null},
  "KAUS":{temp:8,conditions:[],intensity:null},"KBNA":{temp:4,conditions:[],intensity:null},"KRDU":{temp:1,conditions:[],intensity:null},"KCLT":{temp:2,conditions:[],intensity:null},"KSMF":{temp:5,conditions:["fog"],intensity:null},"KSJC":{temp:9,conditions:[],intensity:null},"KOAK":{temp:9,conditions:[],intensity:null},"KCLE":{temp:-1,conditions:[],intensity:null},"KMKE":{temp:-8,conditions:[],intensity:null},"KPIT":{temp:0,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:23,conditions:[],intensity:null},"TIST":{temp:27,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:18,conditions:["fog"],intensity:null},"SBGL":{temp:26,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:19,conditions:[],intensity:null},"SBSV":{temp:24,conditions:[],intensity:null},"SBRF":{temp:24,conditions:[],intensity:null},
  ...
  "LSGG":{temp:4,conditions:["fog"],intensity:null},"LSZB":{temp:2,conditions:[],intensity:null},"LOWW":{temp:1,conditions:[],intensity:null},"LOWS":{temp:-3,conditions:["fog"],intensity:null},"LOWG":{temp:-2,conditions:[],intensity:null},"LOWI":{temp:2,conditions:[],intensity:null},"LKPR":{temp:1,conditions:[],intensity:null},"EPWA":{temp:-8,conditions:[],intensity:null},"EPKK":{temp:-7,conditions:[],intensity:null},"EPGD":{temp:-4,conditions:["fog"],intensity:null},
  "EPWR":{temp:1,conditions:[],intensity:null},"EPPO":{temp:1,conditions:[],intensity:null},"EKCH":{temp:2,conditions:[],intensity:null},"ESSA":{temp:3,conditions:[],intensity:null},"ENGM":{temp:2,conditions:[],intensity:null},"EFHK":{temp:-4,conditions:[],intensity:null},"BIKF":{temp:-2,conditions:[],intensity:null},"ESGG":{temp:2,conditions:[],intensity:null},"ESMS":{temp:2,conditions:[],intensity:null},"ENBR":{temp:4,conditions:[],intensity:null},
  "ENZV":{temp:5,conditions:[],intensity:null},"ENTC":{temp:-7,conditions:[],intensity:null},"EFOU":{temp:0,conditions:["snow"],intensity:null},"EFRO":{temp:-2,conditions:[],intensity:null},"LGAV":{temp:9,conditions:[],intensity:null},"LGTS":{temp:5,conditions:[],intensity:null},"LGIR":{temp:13,conditions:[],intensity:null},"LGKR":{temp:12,conditions:[],intensity:null},"LGRP":{temp:15,conditions:[],intensity:null},"LGSR":{temp:14,conditions:[],intensity:null},
  "LGMK":{temp:12,conditions:[],intensity:null},"LTFM":{temp:3,conditions:[],intensity:null},"LTBA":{temp:4,conditions:[],intensity:null},"LTFJ":{temp:3,conditions:[],intensity:null},"LTAI":{temp:13,conditions:[],intensity:null},"LTAC":{temp:-3,conditions:[],intensity:null},"LTBJ":{temp:8,conditions:[],intensity:null},"LTBS":{temp:11,conditions:[],intensity:null},"LTFE":{temp:12,conditions:[],intensity:null},"LCLK":{temp:13,conditions:[],intensity:null},
  "LCPH":{temp:14,conditions:[],intensity:null},"LHBP":{temp:1,conditions:[],intensity:null},"LROP":{temp:-7,conditions:[],intensity:null},"LBSF":{temp:-1,conditions:[],intensity:null},"LYBE":{temp:-1,conditions:[],intensity:null},"LDZA":{temp:1,conditions:[],intensity:null},"LDDU":{temp:11,conditions:[],intensity:null},"LDSP":{temp:9,conditions:[],intensity:null},"LJLJ":{temp:3,conditions:["fog"],intensity:null},"LWSK":{temp:1,conditions:["fog"],intensity:null},
  ...
  "HEGN":{temp:17,conditions:[],intensity:null},"HESH":{temp:18,conditions:[],intensity:null},"HEBA":{temp:14,conditions:[],intensity:null},"HEAX":{temp:16,conditions:[],intensity:null},"HLLT":{temp:12,conditions:[],intensity:null},"DNMM":{temp:27,conditions:[],intensity:null},"DNAA":{temp:23,conditions:[],intensity:null},"DGAA":{temp:27,conditions:[],intensity:null},"DIAP":{temp:26,conditions:[],intensity:null},"GOBD":{temp:18,conditions:[],intensity:null},
  "GABS":{temp:20,conditions:[],intensity:null},"GVNP":{temp:18,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:25,conditions:["fog"],intensity:null},"DXXX":{temp:27,conditions:[],intensity:null},"DBBB":{temp:27,conditions:[],intensity:null},"HKJK":{temp:22,conditions:[],intensity:null},"HKMO":{temp:31,conditions:[],intensity:null},"HTDA":{temp:30,conditions:[],intensity:null},"HTKJ":{temp:26,conditions:[],intensity:null},
  "HUEN":{temp:26,conditions:[],intensity:null},"HRYR":{temp:23,conditions:[],intensity:null},"HAAB":{temp:18,conditions:[],intensity:null},"HDAM":{temp:26,conditions:[],intensity:null},"HCMM":{temp:30,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:30,conditions:[],intensity:null},"FIMP":{temp:27,conditions:[],intensity:null},"FMCH":{temp:31,conditions:[],intensity:null},"FMMI":{temp:24,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:27,conditions:[],intensity:null},"FKYS":{temp:23,conditions:[],intensity:null},"FOOL":{temp:27,conditions:[],intensity:null},"FZAA":{temp:25,conditions:["thunderstorm"],intensity:null},"FCBB":{temp:24,conditions:[],intensity:null},"FLLK":{temp:22,conditions:[],intensity:null},"FVHA":{temp:20,conditions:[],intensity:null},"FLLS":{temp:22,conditions:[],intensity:null},"FYWH":{temp:21,conditions:[],intensity:null},
  ...
  "ZYTX":{temp:-12,conditions:[],intensity:null},"ZSAM":{temp:25,conditions:[],intensity:null},"ZGKL":{temp:21,conditions:[],intensity:null},"ZSNJ":{temp:12,conditions:[],intensity:null},"ZSHC":{temp:13,conditions:[],intensity:null},"ZPPP":{temp:15,conditions:[],intensity:null},"ZBTJ":{temp:-3,conditions:[],intensity:null},"VMMC":{temp:25,conditions:[],intensity:null},"RJTT":{temp:12,conditions:[],intensity:null},"RJAA":{temp:11,conditions:[],intensity:null},
  ...
  "RKSS":{temp:1,conditions:[],intensity:null},"RKPK":{temp:10,conditions:[],intensity:null},"RKPC":{temp:8,conditions:[],intensity:null},"RKTN":{temp:7,conditions:[],intensity:null},"ZKPY":{temp:-4,conditions:[],intensity:null},"WSSS":{temp:30,conditions:[],intensity:null},"WMKK":{temp:30,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:27,conditions:[],intensity:null},"WBGG":{temp:29,conditions:[],intensity:null},
  "VTBS":{temp:32,conditions:[],intensity:null},"VTBD":{temp:33,conditions:[],intensity:null},"VTSP":{temp:28,conditions:[],intensity:null},"VTCC":{temp:30,conditions:[],intensity:null},"VTSS":{temp:30,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:23,conditions:[],intensity:null},"VVTS":{temp:31,conditions:[],intensity:null},"VVDN":{temp:24,conditions:[],intensity:null},"VVCR":{temp:29,conditions:[],intensity:null},
  ...
  "RPLL":{temp:27,conditions:[],intensity:null},"RPLC":{temp:30,conditions:[],intensity:null},"RPVM":{temp:27,conditions:[],intensity:null},"RPVD":{temp:31,conditions:[],intensity:null},"RPVK":{temp:24,conditions:[],intensity:null},"WBSB":{temp:28,conditions:[],intensity:null},"WBLL":{temp:26,conditions:[],intensity:null},"VIDP":{temp:20,conditions:[],intensity:null},"VABB":{temp:25,conditions:[],intensity:null},"VOBL":{temp:25,conditions:[],intensity:null},
  ...
  "YMHB":{temp:17,conditions:[],intensity:null},"NZAA":{temp:22,conditions:[],intensity:null},"NZWN":{temp:15,conditions:[],intensity:null},"NZCH":{temp:12,conditions:[],intensity:null},"NZQN":{temp:14,conditions:[],intensity:null},"NZDN":{temp:10,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:31,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
