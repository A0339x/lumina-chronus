...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KEWR":{temp:-10,conditions:[],intensity:null},"KMIA":{temp:21,conditions:[],intensity:null},"KPHX":{temp:12,conditions:[],intensity:null},"KIAH":{temp:2,conditions:[],intensity:null},"KBOS":{temp:-15,conditions:[],intensity:null},"KMSP":{temp:-23,conditions:[],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:-13,conditions:[],intensity:null},"KPHL":{temp:-8,conditions:[],intensity:null},"KLGA":{temp:-10,conditions:[],intensity:null},
  "KBWI":{temp:-8,conditions:["snow"],intensity:null},"KSLC":{temp:-5,conditions:[],intensity:null},"KDCA":{temp:-8,conditions:["snow"],intensity:null},"KIAD":{temp:-9,conditions:["snow"],intensity:null},"KSAN":{temp:10,conditions:[],intensity:null},"KTPA":{temp:19,conditions:[],intensity:null},"KPDX":{temp:-1,conditions:[],intensity:null},"KSTL":{temp:-13,conditions:["snow"],intensity:null},"KHNL":{temp:24,conditions:[],intensity:null},"KMEM":{temp:-7,conditions:["freezing"],intensity:null},
  "KAUS":{temp:-4,conditions:["freezing"],intensity:null},"KBNA":{temp:-3,conditions:["freezing"],intensity:null},"KRDU":{temp:-8,conditions:[],intensity:null},"KCLT":{temp:-6,conditions:["snow"],intensity:null},"KSMF":{temp:6,conditions:[],intensity:null},"KSJC":{temp:7,conditions:[],intensity:null},"KOAK":{temp:10,conditions:[],intensity:null},"KCLE":{temp:-13,conditions:["snow"],intensity:null},"KMKE":{temp:-17,conditions:[],intensity:null},"KPIT":{temp:-11,conditions:["snow"],intensity:null},
  "KIND":{temp:-12,conditions:["snow"],intensity:null},"KCVG":{temp:-11,conditions:["snow"],intensity:null},"KMCI":{temp:-18,conditions:[],intensity:null},"KSAT":{temp:-2,conditions:[],intensity:null},"KHOU":{temp:3,conditions:[],intensity:null},"KDAL":{temp:-9,conditions:["snow"],intensity:null},"KMDW":{temp:-14,conditions:[],intensity:null},"PANC":{temp:-4,conditions:[],intensity:null},"PAFA":{temp:-16,conditions:[],intensity:null},"CYYZ":{temp:-16,conditions:[],intensity:null},
  "CYVR":{temp:-1,conditions:[],intensity:null},"CYUL":{temp:-27,conditions:[],intensity:null},"CYYC":{temp:-20,conditions:[],intensity:null},"CYEG":{temp:-22,conditions:[],intensity:null},"CYOW":{temp:-29,conditions:[],intensity:null},"CYWG":{temp:-35,conditions:[],intensity:null},"CYHZ":{temp:-18,conditions:[],intensity:null},"CYQB":{temp:-27,conditions:[],intensity:null},"CYYJ":{temp:0,conditions:[],intensity:null},"CYLW":{temp:-8,conditions:[],intensity:null},
  "CYXE":{temp:-40,conditions:[],intensity:null},"CYQR":{temp:-35,conditions:[],intensity:null},"CYZF":{temp:-21,conditions:[],intensity:null},"CYXY":{temp:-10,conditions:[],intensity:null},"CYQT":{temp:-29,conditions:[],intensity:null},"CYYT":{temp:-11,conditions:[],intensity:null},"MMMX":{temp:11,conditions:[],intensity:null},"MMUN":{temp:22,conditions:[],intensity:null},"MMGL":{temp:13,conditions:[],intensity:null},"MMMY":{temp:9,conditions:[],intensity:null},
  ...
  "SBPA":{temp:22,conditions:[],intensity:null},"SBCT":{temp:15,conditions:[],intensity:null},"SBFZ":{temp:25,conditions:[],intensity:null},"SCEL":{temp:15,conditions:[],intensity:null},"SAEZ":{temp:24,conditions:[],intensity:null},"SABE":{temp:23,conditions:[],intensity:null},"SACO":{temp:19,conditions:[],intensity:null},"SAME":{temp:21,conditions:[],intensity:null},"SLLP":{temp:6,conditions:[],intensity:null},"SLVR":{temp:24,conditions:[],intensity:null},
  ...
  "LIMC":{temp:5,conditions:[],intensity:null},"LIME":{temp:5,conditions:["fog"],intensity:null},"LIPZ":{temp:8,conditions:[],intensity:null},"LIRN":{temp:11,conditions:[],intensity:null},"LIML":{temp:4,conditions:["fog"],intensity:null},"LIPE":{temp:5,conditions:[],intensity:null},"LICC":{temp:15,conditions:[],intensity:null},"LICJ":{temp:11,conditions:[],intensity:null},"LIRA":{temp:8,conditions:[],intensity:null},"LIRP":{temp:8,conditions:[],intensity:null},
  "LIMF":{temp:3,conditions:["fog"],intensity:null},"LIEO":{temp:8,conditions:[],intensity:null},"LIEE":{temp:10,conditions:[],intensity:null},"EHAM":{temp:-1,conditions:[],intensity:null},"EHRD":{temp:0,conditions:[],intensity:null},"EHEH":{temp:-1,conditions:[],intensity:null},"EBBR":{temp:2,conditions:[],intensity:null},"EBCI":{temp:1,conditions:[],intensity:null},"ELLX":{temp:-2,conditions:[],intensity:null},"LSZH":{temp:1,conditions:["fog"],intensity:null},
  "LSGG":{temp:1,conditions:[],intensity:null},"LSZB":{temp:1,conditions:[],intensity:null},"LOWW":{temp:1,conditions:[],intensity:null},"LOWS":{temp:-5,conditions:[],intensity:null},"LOWG":{temp:-1,conditions:["fog"],intensity:null},"LOWI":{temp:3,conditions:[],intensity:null},"LKPR":{temp:-2,conditions:[],intensity:null},"EPWA":{temp:-5,conditions:[],intensity:null},"EPKK":{temp:-1,conditions:[],intensity:null},"EPGD":{temp:-7,conditions:[],intensity:null},
  ...
  "ENZV":{temp:-1,conditions:[],intensity:null},"ENTC":{temp:0,conditions:["snow"],intensity:null},"EFOU":{temp:-9,conditions:[],intensity:null},"EFRO":{temp:-16,conditions:[],intensity:null},"LGAV":{temp:14,conditions:[],intensity:null},"LGTS":{temp:8,conditions:[],intensity:null},"LGIR":{temp:16,conditions:[],intensity:null},"LGKR":{temp:15,conditions:[],intensity:null},"LGRP":{temp:16,conditions:[],intensity:null},"LGSR":{temp:17,conditions:[],intensity:null},
  "LGMK":{temp:16,conditions:[],intensity:null},"LTFM":{temp:11,conditions:[],intensity:null},"LTBA":{temp:11,conditions:[],intensity:null},"LTFJ":{temp:11,conditions:[],intensity:null},"LTAI":{temp:13,conditions:[],intensity:null},"LTAC":{temp:5,conditions:["fog"],intensity:null},"LTBJ":{temp:13,conditions:[],intensity:null},"LTBS":{temp:16,conditions:[],intensity:null},"LTFE":{temp:16,conditions:[],intensity:null},"LCLK":{temp:14,conditions:[],intensity:null},
  ...
  "LATI":{temp:13,conditions:[],intensity:null},"UKBB":{temp:-12,conditions:[],intensity:null},"UKLL":{temp:-2,conditions:[],intensity:null},"UUEE":{temp:-22,conditions:[],intensity:null},"UUDD":{temp:-24,conditions:[],intensity:null},"UUWW":{temp:-23,conditions:[],intensity:null},"ULLI":{temp:-16,conditions:[],intensity:null},"UWWW":{temp:-27,conditions:[],intensity:null},"USSS":{temp:-21,conditions:[],intensity:null},"UNNT":{temp:-28,conditions:[],intensity:null},
  "UUOB":{temp:-17,conditions:[],intensity:null},"UHWW":{temp:-11,conditions:[],intensity:null},"UEEE":{temp:-31,conditions:[],intensity:null},"OMDB":{temp:22,conditions:[],intensity:null},"OMDW":{temp:22,conditions:[],intensity:null},"OMAA":{temp:22,conditions:[],intensity:null},"OMSJ":{temp:23,conditions:[],intensity:null},"OTHH":{temp:21,conditions:[],intensity:null},"OERK":{temp:16,conditions:[],intensity:null},"OEJN":{temp:26,conditions:[],intensity:null},
  "OEDF":{temp:20,conditions:[],intensity:null},"OEMA":{temp:18,conditions:[],intensity:null},"OKBK":{temp:16,conditions:[],intensity:null},"OBBI":{temp:18,conditions:[],intensity:null},"OOMS":{temp:25,conditions:[],intensity:null},"OYAA":{temp:18,conditions:[],intensity:null},"OIIE":{temp:5,conditions:[],intensity:null},"OIII":{temp:5,conditions:[],intensity:null},"OISS":{temp:2,conditions:["snow"],intensity:null},"OIKB":{temp:15,conditions:[],intensity:null},
  "OIAW":{temp:13,conditions:[],intensity:null},"OIKK":{temp:6,conditions:[],intensity:null},"OICC":{temp:3,conditions:[],intensity:null},"LLBG":{temp:17,conditions:[],intensity:null},"OLBA":{temp:17,conditions:[],intensity:null},"OJAM":{temp:9,conditions:[],intensity:null},"ORBI":{temp:13,conditions:[],intensity:null},"ORER":{temp:8,conditions:[],intensity:null},"GMMN":{temp:9,conditions:[],intensity:null},"GMME":{temp:11,conditions:[],intensity:null},
  "GMMX":{temp:4,conditions:[],intensity:null},"GMTT":{temp:14,conditions:[],intensity:null},"GMFF":{temp:8,conditions:[],intensity:null},"GMAD":{temp:6,conditions:["fog"],intensity:null},"DAAG":{temp:8,conditions:[],intensity:null},"DAOO":{temp:12,conditions:[],intensity:null},"DTTA":{temp:10,conditions:[],intensity:null},"DTMB":{temp:10,conditions:[],intensity:null},"DTTJ":{temp:11,conditions:[],intensity:null},"HECA":{temp:18,conditions:[],intensity:null},
  "HEGN":{temp:19,conditions:[],intensity:null},"HESH":{temp:20,conditions:[],intensity:null},"HEBA":{temp:18,conditions:[],intensity:null},"HEAX":{temp:15,conditions:[],intensity:null},"HLLT":{temp:14,conditions:[],intensity:null},"DNMM":{temp:27,conditions:[],intensity:null},"DNAA":{temp:26,conditions:[],intensity:null},"DGAA":{temp:27,conditions:[],intensity:null},"DIAP":{temp:27,conditions:["fog"],intensity:null},"GOBD":{temp:19,conditions:[],intensity:null},
  "GABS":{temp:21,conditions:[],intensity:null},"GVNP":{temp:20,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:25,conditions:["fog"],intensity:null},"DXXX":{temp:27,conditions:[],intensity:null},"DBBB":{temp:28,conditions:[],intensity:null},"HKJK":{temp:25,conditions:[],intensity:null},"HKMO":{temp:32,conditions:[],intensity:null},"HTDA":{temp:30,conditions:[],intensity:null},"HTKJ":{temp:29,conditions:[],intensity:null},
  "HUEN":{temp:28,conditions:[],intensity:null},"HRYR":{temp:24,conditions:[],intensity:null},"HAAB":{temp:21,conditions:[],intensity:null},"HDAM":{temp:25,conditions:[],intensity:null},"HCMM":{temp:30,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:31,conditions:[],intensity:null},"FIMP":{temp:29,conditions:[],intensity:null},"FMCH":{temp:27,conditions:[],intensity:null},"FMMI":{temp:23,conditions:[],intensity:null},
  ...
  "FBSK":{temp:25,conditions:[],intensity:null},"FAOR":{temp:22,conditions:[],intensity:null},"FACT":{temp:23,conditions:[],intensity:null},"FALE":{temp:28,conditions:[],intensity:null},"FAPE":{temp:25,conditions:[],intensity:null},"FQMA":{temp:29,conditions:[],intensity:null},"FWKI":{temp:22,conditions:[],intensity:null},"ZBAA":{temp:0,conditions:[],intensity:null},"ZBAD":{temp:1,conditions:[],intensity:null},"ZSPD":{temp:9,conditions:[],intensity:null},
  "ZSSS":{temp:10,conditions:[],intensity:null},"ZGGG":{temp:21,conditions:[],intensity:null},"VHHH":{temp:21,conditions:[],intensity:null},"ZGSZ":{temp:19,conditions:[],intensity:null},"ZUUU":{temp:11,conditions:[],intensity:null},"ZUCK":{temp:8,conditions:[],intensity:null},"ZHCC":{temp:3,conditions:[],intensity:null},"ZLXY":{temp:8,conditions:[],intensity:null},"ZWSH":{temp:-11,conditions:[],intensity:null},"ZYHB":{temp:-15,conditions:[],intensity:null},
  "ZYTX":{temp:-11,conditions:[],intensity:null},"ZSAM":{temp:19,conditions:[],intensity:null},"ZGKL":{temp:11,conditions:[],intensity:null},"ZSNJ":{temp:10,conditions:[],intensity:null},"ZSHC":{temp:15,conditions:[],intensity:null},"ZPPP":{temp:18,conditions:[],intensity:null},"ZBTJ":{temp:-1,conditions:[],intensity:null},"VMMC":{temp:20,conditions:[],intensity:null},"RJTT":{temp:5,conditions:[],intensity:null},"RJAA":{temp:3,conditions:[],intensity:null},
  "RJBB":{temp:5,conditions:[],intensity:null},"RJOO":{temp:3,conditions:[],intensity:null},"RJCC":{temp:-5,conditions:[],intensity:null},"RJFF":{temp:4,conditions:[],intensity:null},"RJGG":{temp:4,conditions:[],intensity:null},"ROAH":{temp:18,conditions:[],intensity:null},"RJSS":{temp:0,conditions:[],intensity:null},"RJSN":{temp:0,conditions:[],intensity:null},"RJOK":{temp:5,conditions:[],intensity:null},"RKSI":{temp:-3,conditions:[],intensity:null},
  ...
  "VCBI":{temp:26,conditions:[],intensity:null},"WIII":{temp:30,conditions:[],intensity:null},"WADD":{temp:29,conditions:[],intensity:null},"WARR":{temp:32,conditions:[],intensity:null},"WIHH":{temp:28,conditions:[],intensity:null},"WIMM":{temp:33,conditions:[],intensity:null},"WIBB":{temp:27,conditions:[],intensity:null},"WAFF":{temp:28,conditions:[],intensity:null},"WICC":{temp:25,conditions:[],intensity:null},"WASS":{temp:28,conditions:[],intensity:null},
  ...
  "VOCL":{temp:31,conditions:[],intensity:null},"VOTV":{temp:28,conditions:[],intensity:null},"VEPT":{temp:25,conditions:[],intensity:null},"VNKT":{temp:20,conditions:[],intensity:null},"OPKC":{temp:19,conditions:[],intensity:null},"OPLA":{temp:17,conditions:[],intensity:null},"OPIS":{temp:15,conditions:[],intensity:null},"RCTP":{temp:23,conditions:[],intensity:null},"RCSS":{temp:21,conditions:[],intensity:null},"RCMQ":{temp:20,conditions:[],intensity:null},
  "RCKH":{temp:22,conditions:[],intensity:null},"RCNN":{temp:21,conditions:[],intensity:null},"YSSY":{temp:30,conditions:[],intensity:null},"YMML":{temp:22,conditions:[],intensity:null},"YBBN":{temp:28,conditions:[],intensity:null},"YPPH":{temp:26,conditions:[],intensity:null},"YPAD":{temp:24,conditions:[],intensity:null},"YBCG":{temp:27,conditions:[],intensity:null},"YBCS":{temp:26,conditions:[],intensity:null},"YSCB":{temp:37,conditions:[],intensity:null},
