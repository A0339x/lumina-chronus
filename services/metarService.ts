...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LGMK":{temp:17,conditions:[],intensity:null},"LTFM":{temp:13,conditions:[],intensity:null},"LTBA":{temp:13,conditions:[],intensity:null},"LTFJ":{temp:13,conditions:[],intensity:null},"LTAI":{temp:18,conditions:[],intensity:null},"LTAC":{temp:9,conditions:[],intensity:null},"LTBJ":{temp:17,conditions:[],intensity:null},"LTBS":{temp:18,conditions:[],intensity:null},"LTFE":{temp:18,conditions:[],intensity:null},"LCLK":{temp:20,conditions:[],intensity:null},
  ...
  "LATI":{temp:14,conditions:[],intensity:null},"UKBB":{temp:3,conditions:[],intensity:null},"UKLL":{temp:3,conditions:[],intensity:null},"UUEE":{temp:1,conditions:[],intensity:null},"UUDD":{temp:1,conditions:[],intensity:null},"UUWW":{temp:1,conditions:[],intensity:null},"ULLI":{temp:-12,conditions:[],intensity:null},"UWWW":{temp:-4,conditions:[],intensity:null},"USSS":{temp:0,conditions:[],intensity:null},"UNNT":{temp:-10,conditions:[],intensity:null},
  ...
  "OIAW":{temp:26,conditions:[],intensity:null},"OIKK":{temp:21,conditions:[],intensity:null},"OICC":{temp:17,conditions:[],intensity:null},"LLBG":{temp:20,conditions:[],intensity:null},"OLBA":{temp:17,conditions:[],intensity:null},"OJAM":{temp:17,conditions:[],intensity:null},"ORBI":{temp:26,conditions:[],intensity:null},"ORER":{temp:16,conditions:[],intensity:null},"GMMN":{temp:15,conditions:[],intensity:null},"GMME":{temp:15,conditions:[],intensity:null},
  "GMMX":{temp:15,conditions:[],intensity:null},"GMTT":{temp:14,conditions:[],intensity:null},"GMFF":{temp:11,conditions:[],intensity:null},"GMAD":{temp:18,conditions:[],intensity:null},"DAAG":{temp:13,conditions:[],intensity:null},"DAOO":{temp:16,conditions:[],intensity:null},"DTTA":{temp:16,conditions:[],intensity:null},"DTMB":{temp:16,conditions:[],intensity:null},"DTTJ":{temp:19,conditions:[],intensity:null},"HECA":{temp:24,conditions:[],intensity:null},
