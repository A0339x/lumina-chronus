...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:35,conditions:["thunderstorm"],intensity:null},"KLAX":{temp:21,conditions:[],intensity:null},"KORD":{temp:34,conditions:["thunderstorm"],intensity:null},"KDFW":{temp:34,conditions:[],intensity:null},"KDEN":{temp:30,conditions:[],intensity:null},"KJFK":{temp:29,conditions:[],intensity:null},"KSFO":{temp:21,conditions:[],intensity:null},"KSEA":{temp:15,conditions:[],intensity:null},"KLAS":{temp:33,conditions:[],intensity:null},"KMCO":{temp:26,conditions:[],intensity:null},
  "KEWR":{temp:33,conditions:[],intensity:null},"KMIA":{temp:33,conditions:["thunderstorm"],intensity:null},"KPHX":{temp:36,conditions:[],intensity:null},"KIAH":{temp:34,conditions:["thunderstorm"],intensity:null},"KBOS":{temp:31,conditions:[],intensity:null},"KMSP":{temp:32,conditions:[],intensity:null},"KFLL":{temp:32,conditions:["thunderstorm"],intensity:null},"KDTW":{temp:35,conditions:["thunderstorm"],intensity:null},"KPHL":{temp:33,conditions:[],intensity:null},"KLGA":{temp:31,conditions:[],intensity:null},
  "KBWI":{temp:32,conditions:[],intensity:null},"KSLC":{temp:25,conditions:[],intensity:null},"KDCA":{temp:33,conditions:[],intensity:null},"KIAD":{temp:32,conditions:[],intensity:null},"KSAN":{temp:23,conditions:[],intensity:null},"KTPA":{temp:25,conditions:[],intensity:null},"KPDX":{temp:17,conditions:[],intensity:null},"KSTL":{temp:35,conditions:["thunderstorm"],intensity:null},"KHNL":{temp:28,conditions:[],intensity:null},"KMEM":{temp:35,conditions:["thunderstorm"],intensity:null},
  "KAUS":{temp:34,conditions:[],intensity:null},"KBNA":{temp:34,conditions:["thunderstorm"],intensity:null},"KRDU":{temp:33,conditions:[],intensity:null},"KCLT":{temp:33,conditions:["thunderstorm"],intensity:null},"KSMF":{temp:29,conditions:[],intensity:null},"KSJC":{temp:25,conditions:[],intensity:null},"KOAK":{temp:19,conditions:[],intensity:null},"KCLE":{temp:35,conditions:["thunderstorm"],intensity:null},"KMKE":{temp:34,conditions:["thunderstorm"],intensity:null},"KPIT":{temp:32,conditions:["thunderstorm"],intensity:null},
  "KIND":{temp:34,conditions:["thunderstorm"],intensity:null},"KCVG":{temp:34,conditions:[],intensity:null},"KMCI":{temp:34,conditions:["thunderstorm"],intensity:null},"KSAT":{temp:33,conditions:[],intensity:null},"KHOU":{temp:34,conditions:["thunderstorm"],intensity:null},"KDAL":{temp:31,conditions:["thunderstorm"],intensity:null},"KMDW":{temp:34,conditions:["thunderstorm"],intensity:null},"PANC":{temp:12,conditions:[],intensity:null},"PAFA":{temp:14,conditions:[],intensity:null},"CYYZ":{temp:34,conditions:["thunderstorm"],intensity:null},
  "CYVR":{temp:16,conditions:[],intensity:null},"CYUL":{temp:29,conditions:[],intensity:null},"CYYC":{temp:20,conditions:[],intensity:null},"CYEG":{temp:20,conditions:[],intensity:null},"CYOW":{temp:24,conditions:[],intensity:null},"CYWG":{temp:23,conditions:[],intensity:null},"CYHZ":{temp:27,conditions:[],intensity:null},"CYQB":{temp:26,conditions:[],intensity:null},"CYYJ":{temp:17,conditions:[],intensity:null},"CYLW":{temp:19,conditions:[],intensity:null},
  "CYXE":{temp:18,conditions:[],intensity:null},"CYQR":{temp:16,conditions:[],intensity:null},"CYZF":{temp:24,conditions:[],intensity:null},"CYXY":{temp:14,conditions:[],intensity:null},"CYQT":{temp:22,conditions:[],intensity:null},"CYYT":{temp:22,conditions:[],intensity:null},"MMMX":{temp:21,conditions:[],intensity:null},"MMUN":{temp:31,conditions:["thunderstorm"],intensity:null},"MMGL":{temp:27,conditions:[],intensity:null},"MMMY":{temp:34,conditions:[],intensity:null},
  "MMTJ":{temp:23,conditions:[],intensity:null},"MMSM":{temp:33,conditions:["thunderstorm"],intensity:null},"MMMD":{temp:34,conditions:["thunderstorm"],intensity:null},"MMCZ":{temp:31,conditions:["thunderstorm"],intensity:null},"MMSD":{temp:35,conditions:[],intensity:null},"MGGT":{temp:27,conditions:[],intensity:null},"MSLP":{temp:34,conditions:[],intensity:null},"MHTG":{temp:30,conditions:[],intensity:null},"MNMG":{temp:34,conditions:[],intensity:null},"MROC":{temp:31,conditions:[],intensity:null},
  "MPTO":{temp:34,conditions:["thunderstorm"],intensity:null},"MKJP":{temp:32,conditions:[],intensity:null},"TNCM":{temp:28,conditions:[],intensity:null},"TBPB":{temp:29,conditions:[],intensity:null},"TTPP":{temp:30,conditions:[],intensity:null},"MWCR":{temp:32,conditions:["thunderstorm"],intensity:null},"MUHA":{temp:31,conditions:["thunderstorm"],intensity:null},"MDSD":{temp:30,conditions:["thunderstorm"],intensity:null},"MDPP":{temp:30,conditions:["thunderstorm"],intensity:null},"MTPP":{temp:35,conditions:[],intensity:null},
  "TJSJ":{temp:29,conditions:[],intensity:null},"TIST":{temp:28,conditions:[],intensity:null},"TLPL":{temp:29,conditions:[],intensity:null},"TAPA":{temp:30,conditions:["thunderstorm"],intensity:null},"SBGR":{temp:24,conditions:[],intensity:null},"SBGL":{temp:25,conditions:[],intensity:null},"SBBR":{temp:24,conditions:[],intensity:null},"SBCF":{temp:25,conditions:[],intensity:null},"SBSV":{temp:26,conditions:[],intensity:null},"SBRF":{temp:26,conditions:[],intensity:null},
  "SBPA":{temp:15,conditions:[],intensity:null},"SBCT":{temp:21,conditions:[],intensity:null},"SBFZ":{temp:28,conditions:[],intensity:null},"SCEL":{temp:15,conditions:[],intensity:null},"SAEZ":{temp:13,conditions:[],intensity:null},"SABE":{temp:12,conditions:[],intensity:null},"SACO":{temp:14,conditions:[],intensity:null},"SAME":{temp:9,conditions:[],intensity:null},"SLLP":{temp:13,conditions:[],intensity:null},"SLVR":{temp:26,conditions:[],intensity:null},
  "SPJC":{temp:24,conditions:[],intensity:null},"SEQM":{temp:25,conditions:[],intensity:null},"SEGU":{temp:33,conditions:[],intensity:null},"SKBO":{temp:18,conditions:[],intensity:null},"SKMR":{temp:31,conditions:[],intensity:null},"SKCL":{temp:28,conditions:[],intensity:null},"SKMD":{temp:29,conditions:[],intensity:null},"SKRG":{temp:22,conditions:[],intensity:null},"SVMI":{temp:32,conditions:[],intensity:null},"SUMU":{temp:11,conditions:[],intensity:null},
  "SGAS":{temp:16,conditions:[],intensity:null},"SBBV":{temp:31,conditions:[],intensity:null},"SMJP":{temp:26,conditions:["thunderstorm"],intensity:null},"SYCJ":{temp:29,conditions:[],intensity:null},"EGLL":{temp:21,conditions:[],intensity:null},"EGKK":{temp:19,conditions:[],intensity:null},"EGSS":{temp:22,conditions:[],intensity:null},"EGLC":{temp:23,conditions:[],intensity:null},"EGCC":{temp:15,conditions:[],intensity:null},"EGBB":{temp:19,conditions:[],intensity:null},
  "EGPH":{temp:17,conditions:[],intensity:null},"EGPF":{temp:18,conditions:[],intensity:null},"EGGW":{temp:21,conditions:[],intensity:null},"EGNX":{temp:16,conditions:[],intensity:null},"EGNT":{temp:19,conditions:[],intensity:null},"EGGP":{temp:17,conditions:[],intensity:null},"EGHI":{temp:20,conditions:[],intensity:null},"EGGD":{temp:15,conditions:[],intensity:null},"EGPD":{temp:16,conditions:[],intensity:null},"EGAA":{temp:17,conditions:[],intensity:null},
  "EIDW":{temp:17,conditions:[],intensity:null},"EICK":{temp:16,conditions:[],intensity:null},"EINN":{temp:16,conditions:[],intensity:null},"LFPG":{temp:23,conditions:[],intensity:null},"LFPO":{temp:25,conditions:[],intensity:null},"LFML":{temp:32,conditions:[],intensity:null},"LFLL":{temp:30,conditions:[],intensity:null},"LFMN":{temp:28,conditions:[],intensity:null},"LFBD":{temp:22,conditions:[],intensity:null},"LFBO":{temp:28,conditions:[],intensity:null},
  "LFRS":{temp:22,conditions:[],intensity:null},"LFSB":{temp:26,conditions:[],intensity:null},"LFPB":{temp:24,conditions:[],intensity:null},"EDDF":{temp:28,conditions:[],intensity:null},"EDDM":{temp:24,conditions:[],intensity:null},"EDDB":{temp:21,conditions:[],intensity:null},"EDDL":{temp:21,conditions:[],intensity:null},"EDDH":{temp:17,conditions:[],intensity:null},"EDDK":{temp:22,conditions:[],intensity:null},"EDDS":{temp:22,conditions:[],intensity:null},
  "EDDW":{temp:22,conditions:[],intensity:null},"EDDN":{temp:21,conditions:[],intensity:null},"EDDV":{temp:23,conditions:[],intensity:null},"EDDP":{temp:22,conditions:[],intensity:null},"LEMD":{temp:34,conditions:[],intensity:null},"LEBL":{temp:28,conditions:[],intensity:null},"LEPA":{temp:28,conditions:[],intensity:null},"LEMG":{temp:28,conditions:[],intensity:null},"LEVC":{temp:30,conditions:[],intensity:null},"LEAL":{temp:28,conditions:[],intensity:null},
  "LEZL":{temp:36,conditions:[],intensity:null},"GCLP":{temp:26,conditions:[],intensity:null},"GCTS":{temp:24,conditions:[],intensity:null},"GCLA":{temp:27,conditions:[],intensity:null},"GCFV":{temp:27,conditions:[],intensity:null},"LPPT":{temp:23,conditions:[],intensity:null},"LPPR":{temp:21,conditions:[],intensity:null},"LPFR":{temp:28,conditions:[],intensity:null},"LPMA":{temp:22,conditions:[],intensity:null},"LIRF":{temp:28,conditions:[],intensity:null},
  "LIMC":{temp:29,conditions:[],intensity:null},"LIME":{temp:31,conditions:[],intensity:null},"LIPZ":{temp:30,conditions:[],intensity:null},"LIRN":{temp:29,conditions:[],intensity:null},"LIML":{temp:31,conditions:[],intensity:null},"LIPE":{temp:32,conditions:[],intensity:null},"LICC":{temp:29,conditions:[],intensity:null},"LICJ":{temp:28,conditions:[],intensity:null},"LIRA":{temp:29,conditions:[],intensity:null},"LIRP":{temp:28,conditions:[],intensity:null},
  "LIMF":{temp:28,conditions:[],intensity:null},"LIEO":{temp:29,conditions:[],intensity:null},"LIEE":{temp:28,conditions:[],intensity:null},"EHAM":{temp:20,conditions:[],intensity:null},"EHRD":{temp:20,conditions:[],intensity:null},"EHEH":{temp:21,conditions:[],intensity:null},"EBBR":{temp:22,conditions:[],intensity:null},"EBCI":{temp:20,conditions:[],intensity:null},"ELLX":{temp:23,conditions:[],intensity:null},"LSZH":{temp:23,conditions:[],intensity:null},
  "LSGG":{temp:25,conditions:[],intensity:null},"LSZB":{temp:20,conditions:[],intensity:null},"LOWW":{temp:26,conditions:[],intensity:null},"LOWS":{temp:28,conditions:[],intensity:null},"LOWG":{temp:24,conditions:[],intensity:null},"LOWI":{temp:23,conditions:[],intensity:null},"LKPR":{temp:23,conditions:[],intensity:null},"EPWA":{temp:30,conditions:[],intensity:null},"EPKK":{temp:29,conditions:["thunderstorm"],intensity:null},"EPGD":{temp:18,conditions:[],intensity:null},
  "EPWR":{temp:27,conditions:[],intensity:null},"EPPO":{temp:21,conditions:["thunderstorm"],intensity:null},"EKCH":{temp:22,conditions:[],intensity:null},"ESSA":{temp:22,conditions:[],intensity:null},"ENGM":{temp:20,conditions:[],intensity:null},"EFHK":{temp:23,conditions:[],intensity:null},"BIKF":{temp:10,conditions:[],intensity:null},"ESGG":{temp:18,conditions:[],intensity:null},"ESMS":{temp:20,conditions:[],intensity:null},"ENBR":{temp:15,conditions:[],intensity:null},
  "ENZV":{temp:16,conditions:[],intensity:null},"ENTC":{temp:11,conditions:[],intensity:null},"EFOU":{temp:18,conditions:[],intensity:null},"EFRO":{temp:16,conditions:[],intensity:null},"LGAV":{temp:27,conditions:[],intensity:null},"LGTS":{temp:28,conditions:[],intensity:null},"LGIR":{temp:25,conditions:[],intensity:null},"LGKR":{temp:30,conditions:[],intensity:null},"LGRP":{temp:26,conditions:[],intensity:null},"LGSR":{temp:26,conditions:[],intensity:null},
  "LGMK":{temp:24,conditions:[],intensity:null},"LTFM":{temp:23,conditions:[],intensity:null},"LTBA":{temp:24,conditions:[],intensity:null},"LTFJ":{temp:23,conditions:[],intensity:null},"LTAI":{temp:27,conditions:[],intensity:null},"LTAC":{temp:23,conditions:[],intensity:null},"LTBJ":{temp:28,conditions:[],intensity:null},"LTBS":{temp:27,conditions:[],intensity:null},"LTFE":{temp:27,conditions:[],intensity:null},"LCLK":{temp:30,conditions:[],intensity:null},
  "LCPH":{temp:26,conditions:[],intensity:null},"LHBP":{temp:31,conditions:[],intensity:null},"LROP":{temp:29,conditions:[],intensity:null},"LBSF":{temp:25,conditions:[],intensity:null},"LYBE":{temp:32,conditions:[],intensity:null},"LDZA":{temp:29,conditions:[],intensity:null},"LDDU":{temp:31,conditions:[],intensity:null},"LDSP":{temp:35,conditions:[],intensity:null},"LJLJ":{temp:23,conditions:[],intensity:null},"LWSK":{temp:26,conditions:[],intensity:null},
  "LATI":{temp:28,conditions:[],intensity:null},"UKBB":{temp:24,conditions:[],intensity:null},"UKLL":{temp:32,conditions:[],intensity:null},"UUEE":{temp:20,conditions:[],intensity:null},"UUDD":{temp:19,conditions:[],intensity:null},"UUWW":{temp:20,conditions:[],intensity:null},"ULLI":{temp:22,conditions:[],intensity:null},"UWWW":{temp:16,conditions:[],intensity:null},"USSS":{temp:14,conditions:[],intensity:null},"UNNT":{temp:17,conditions:[],intensity:null},
  "UUOB":{temp:16,conditions:[],intensity:null},"UHWW":{temp:16,conditions:[],intensity:null},"UEEE":{temp:19,conditions:[],intensity:null},"OMDB":{temp:32,conditions:[],intensity:null},"OMDW":{temp:31,conditions:[],intensity:null},"OMAA":{temp:33,conditions:[],intensity:null},"OMSJ":{temp:32,conditions:[],intensity:null},"OTHH":{temp:36,conditions:[],intensity:null},"OERK":{temp:35,conditions:[],intensity:null},"OEJN":{temp:33,conditions:[],intensity:null},
  "OEDF":{temp:34,conditions:[],intensity:null},"OEMA":{temp:36,conditions:[],intensity:null},"OKBK":{temp:39,conditions:[],intensity:null},"OBBI":{temp:34,conditions:[],intensity:null},"OOMS":{temp:33,conditions:[],intensity:null},"OYAA":{temp:22,conditions:[],intensity:null},"OIIE":{temp:30,conditions:[],intensity:null},"OIII":{temp:27,conditions:[],intensity:null},"OISS":{temp:29,conditions:[],intensity:null},"OIKB":{temp:32,conditions:[],intensity:null},
  "OIAW":{temp:36,conditions:[],intensity:null},"OIKK":{temp:30,conditions:[],intensity:null},"OICC":{temp:28,conditions:[],intensity:null},"LLBG":{temp:25,conditions:[],intensity:null},"OLBA":{temp:26,conditions:[],intensity:null},"OJAM":{temp:25,conditions:[],intensity:null},"ORBI":{temp:35,conditions:[],intensity:null},"ORER":{temp:34,conditions:[],intensity:null},"GMMN":{temp:27,conditions:[],intensity:null},"GMME":{temp:28,conditions:[],intensity:null},
  "GMMX":{temp:36,conditions:[],intensity:null},"GMTT":{temp:29,conditions:[],intensity:null},"GMFF":{temp:34,conditions:[],intensity:null},"GMAD":{temp:25,conditions:[],intensity:null},"DAAG":{temp:26,conditions:[],intensity:null},"DAOO":{temp:27,conditions:[],intensity:null},"DTTA":{temp:29,conditions:[],intensity:null},"DTMB":{temp:28,conditions:[],intensity:null},"DTTJ":{temp:29,conditions:[],intensity:null},"HECA":{temp:29,conditions:[],intensity:null},
  "HEGN":{temp:34,conditions:[],intensity:null},"HESH":{temp:34,conditions:[],intensity:null},"HEBA":{temp:36,conditions:[],intensity:null},"HEAX":{temp:26,conditions:[],intensity:null},"HLLT":{temp:27,conditions:[],intensity:null},"DNMM":{temp:25,conditions:[],intensity:null},"DNAA":{temp:24,conditions:[],intensity:null},"DGAA":{temp:25,conditions:[],intensity:null},"DIAP":{temp:26,conditions:[],intensity:null},"GOBD":{temp:26,conditions:[],intensity:null},
  "GABS":{temp:27,conditions:[],intensity:null},"GVNP":{temp:27,conditions:[],intensity:null},"GBYD":{temp:26,conditions:[],intensity:null},"GLRB":{temp:24,conditions:[],intensity:null},"DXXX":{temp:26,conditions:[],intensity:null},"DBBB":{temp:26,conditions:[],intensity:null},"HKJK":{temp:19,conditions:[],intensity:null},"HKMO":{temp:24,conditions:[],intensity:null},"HTDA":{temp:22,conditions:[],intensity:null},"HTKJ":{temp:18,conditions:[],intensity:null},
  "HUEN":{temp:22,conditions:[],intensity:null},"HRYR":{temp:21,conditions:[],intensity:null},"HAAB":{temp:16,conditions:[],intensity:null},"HDAM":{temp:35,conditions:[],intensity:null},"HCMM":{temp:26,conditions:[],intensity:null},"OYSN":{temp:26,conditions:[],intensity:null},"FMEE":{temp:20,conditions:[],intensity:null},"FIMP":{temp:20,conditions:[],intensity:null},"FMCH":{temp:25,conditions:[],intensity:null},"FMMI":{temp:13,conditions:[],intensity:null},
  "FSIA":{temp:25,conditions:[],intensity:null},"FKKD":{temp:26,conditions:[],intensity:null},"FKYS":{temp:22,conditions:[],intensity:null},"FOOL":{temp:23,conditions:[],intensity:null},"FZAA":{temp:27,conditions:[],intensity:null},"FCBB":{temp:25,conditions:[],intensity:null},"FLLK":{temp:18,conditions:[],intensity:null},"FVHA":{temp:15,conditions:[],intensity:null},"FLLS":{temp:16,conditions:[],intensity:null},"FYWH":{temp:15,conditions:[],intensity:null},
  "FBSK":{temp:13,conditions:[],intensity:null},"FAOR":{temp:12,conditions:[],intensity:null},"FACT":{temp:10,conditions:[],intensity:null},"FALE":{temp:17,conditions:[],intensity:null},"FAPE":{temp:14,conditions:[],intensity:null},"FQMA":{temp:19,conditions:[],intensity:null},"FWKI":{temp:16,conditions:[],intensity:null},"ZBAA":{temp:20,conditions:[],intensity:null},"ZBAD":{temp:20,conditions:[],intensity:null},"ZSPD":{temp:24,conditions:[],intensity:null},
  "ZSSS":{temp:24,conditions:[],intensity:null},"ZGGG":{temp:26,conditions:[],intensity:null},"VHHH":{temp:28,conditions:[],intensity:null},"ZGSZ":{temp:26,conditions:[],intensity:null},"ZUUU":{temp:23,conditions:[],intensity:null},"ZUCK":{temp:21,conditions:[],intensity:null},"ZHCC":{temp:23,conditions:[],intensity:null},"ZLXY":{temp:24,conditions:[],intensity:null},"ZWSH":{temp:25,conditions:[],intensity:null},"ZYHB":{temp:20,conditions:[],intensity:null},
  "ZYTX":{temp:20,conditions:[],intensity:null},"ZSAM":{temp:27,conditions:[],intensity:null},"ZGKL":{temp:24,conditions:[],intensity:null},"ZSNJ":{temp:23,conditions:[],intensity:null},"ZSHC":{temp:24,conditions:["thunderstorm"],intensity:null},"ZPPP":{temp:16,conditions:[],intensity:null},"ZBTJ":{temp:21,conditions:[],intensity:null},"VMMC":{temp:28,conditions:[],intensity:null},"RJTT":{temp:22,conditions:[],intensity:null},"RJAA":{temp:21,conditions:[],intensity:null},
  "RJBB":{temp:24,conditions:[],intensity:null},"RJOO":{temp:22,conditions:[],intensity:null},"RJCC":{temp:12,conditions:[],intensity:null},"RJFF":{temp:23,conditions:[],intensity:null},"RJGG":{temp:23,conditions:[],intensity:null},"ROAH":{temp:26,conditions:[],intensity:null},"RJSS":{temp:20,conditions:[],intensity:null},"RJSN":{temp:19,conditions:[],intensity:null},"RJOK":{temp:22,conditions:[],intensity:null},"RKSI":{temp:23,conditions:[],intensity:null},
  "RKSS":{temp:21,conditions:[],intensity:null},"RKPK":{temp:21,conditions:[],intensity:null},"RKPC":{temp:24,conditions:["rain"],intensity:null},"RKTN":{temp:20,conditions:[],intensity:null},"ZKPY":{temp:20,conditions:[],intensity:null},"WSSS":{temp:26,conditions:[],intensity:null},"WMKK":{temp:25,conditions:[],intensity:null},"WMKP":{temp:26,conditions:[],intensity:null},"WBKK":{temp:25,conditions:[],intensity:null},"WBGG":{temp:24,conditions:[],intensity:null},
  "VTBS":{temp:27,conditions:[],intensity:null},"VTBD":{temp:28,conditions:[],intensity:null},"VTSP":{temp:26,conditions:[],intensity:null},"VTCC":{temp:24,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:27,conditions:[],intensity:null},"VVNB":{temp:25,conditions:["thunderstorm"],intensity:null},"VVTS":{temp:26,conditions:[],intensity:null},"VVDN":{temp:27,conditions:[],intensity:null},"VVCR":{temp:28,conditions:[],intensity:null},
  "VDPP":{temp:28,conditions:[],intensity:null},"VDSR":{temp:27,conditions:[],intensity:null},"VLVT":{temp:24,conditions:[],intensity:null},"VLLB":{temp:25,conditions:[],intensity:null},"VYYY":{temp:25,conditions:[],intensity:null},"VYMD":{temp:28,conditions:[],intensity:null},"VGHS":{temp:27,conditions:[],intensity:null},"VGCG":{temp:26,conditions:[],intensity:null},"VECC":{temp:27,conditions:["thunderstorm"],intensity:null},"VRMM":{temp:29,conditions:[],intensity:null},
  "VCBI":{temp:27,conditions:["thunderstorm"],intensity:null},"WIII":{temp:25,conditions:[],intensity:null},"WADD":{temp:23,conditions:[],intensity:null},"WARR":{temp:23,conditions:[],intensity:null},"WIHH":{temp:26,conditions:[],intensity:null},"WIMM":{temp:25,conditions:[],intensity:null},"WIBB":{temp:28,conditions:[],intensity:null},"WAFF":{temp:23,conditions:[],intensity:null},"WICC":{temp:19,conditions:[],intensity:null},"WASS":{temp:24,conditions:[],intensity:null},
  "RPLL":{temp:27,conditions:[],intensity:null},"RPLC":{temp:24,conditions:[],intensity:null},"RPVM":{temp:26,conditions:[],intensity:null},"RPVD":{temp:24,conditions:[],intensity:null},"RPVK":{temp:25,conditions:[],intensity:null},"WBSB":{temp:24,conditions:[],intensity:null},"WBLL":{temp:27,conditions:[],intensity:null},"VIDP":{temp:31,conditions:["thunderstorm"],intensity:null},"VABB":{temp:27,conditions:["thunderstorm"],intensity:null},"VOBL":{temp:22,conditions:[],intensity:null},
  "VOMM":{temp:27,conditions:[],intensity:null},"VEBS":{temp:27,conditions:["thunderstorm"],intensity:null},"VOHY":{temp:24,conditions:[],intensity:null},"VAAH":{temp:30,conditions:[],intensity:null},"VOCI":{temp:25,conditions:[],intensity:null},"VAGO":{temp:25,conditions:["thunderstorm"],intensity:null},"VOTP":{temp:25,conditions:[],intensity:null},"VIAR":{temp:31,conditions:[],intensity:null},"VIJP":{temp:27,conditions:[],intensity:null},"VELR":{temp:23,conditions:[],intensity:null},
  "VOCL":{temp:23,conditions:[],intensity:null},"VOTV":{temp:25,conditions:[],intensity:null},"VEPT":{temp:29,conditions:["thunderstorm"],intensity:null},"VNKT":{temp:21,conditions:[],intensity:null},"OPKC":{temp:29,conditions:[],intensity:null},"OPLA":{temp:32,conditions:[],intensity:null},"OPIS":{temp:31,conditions:["thunderstorm"],intensity:null},"RCTP":{temp:26,conditions:[],intensity:null},"RCSS":{temp:26,conditions:[],intensity:null},"RCMQ":{temp:25,conditions:[],intensity:null},
  "RCKH":{temp:27,conditions:[],intensity:null},"RCNN":{temp:26,conditions:[],intensity:null},"YSSY":{temp:13,conditions:[],intensity:null},"YMML":{temp:11,conditions:[],intensity:null},"YBBN":{temp:14,conditions:[],intensity:null},"YPPH":{temp:9,conditions:[],intensity:null},"YPAD":{temp:12,conditions:[],intensity:null},"YBCG":{temp:13,conditions:[],intensity:null},"YBCS":{temp:20,conditions:[],intensity:null},"YSCB":{temp:10,conditions:[],intensity:null},
  "YMHB":{temp:8,conditions:[],intensity:null},"NZAA":{temp:5,conditions:[],intensity:null},"NZWN":{temp:5,conditions:[],intensity:null},"NZCH":{temp:3,conditions:[],intensity:null},"NZQN":{temp:2,conditions:[],intensity:null},"NZDN":{temp:2,conditions:[],intensity:null},"NFFN":{temp:18,conditions:[],intensity:null},"NWWW":{temp:16,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:24,conditions:[],intensity:null},
  "NIUE":{temp:22,conditions:[],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:27,conditions:[],intensity:null},"PHOG":{temp:28,conditions:[],intensity:null},"PHKO":{temp:28,conditions:[],intensity:null},"PHLH":{temp:27,conditions:[],intensity:null}
};
