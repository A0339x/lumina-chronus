...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "HEGN":{temp:22,conditions:[],intensity:null},"HESH":{temp:23,conditions:[],intensity:null},"HEBA":{temp:21,conditions:[],intensity:null},"HEAX":{temp:17,conditions:[],intensity:null},"HLLT":{temp:14,conditions:[],intensity:null},"DNMM":{temp:28,conditions:[],intensity:null},"DNAA":{temp:25,conditions:[],intensity:null},"DGAA":{temp:26,conditions:[],intensity:null},"DIAP":{temp:27,conditions:[],intensity:null},"GOBD":{temp:17,conditions:[],intensity:null},
  "GABS":{temp:19,conditions:[],intensity:null},"GVNP":{temp:17,conditions:[],intensity:null},"GBYD":{temp:27,conditions:[],intensity:null},"GLRB":{temp:26,conditions:[],intensity:null},"DXXX":{temp:27,conditions:[],intensity:null},"DBBB":{temp:28,conditions:[],intensity:null},"HKJK":{temp:22,conditions:[],intensity:null},"HKMO":{temp:31,conditions:[],intensity:null},"HTDA":{temp:31,conditions:[],intensity:null},"HTKJ":{temp:26,conditions:[],intensity:null},
  "HUEN":{temp:27,conditions:[],intensity:null},"HRYR":{temp:23,conditions:[],intensity:null},"HAAB":{temp:20,conditions:[],intensity:null},"HDAM":{temp:27,conditions:[],intensity:null},"HCMM":{temp:30,conditions:[],intensity:null},"OYSN":{temp:25,conditions:[],intensity:null},"FMEE":{temp:31,conditions:[],intensity:null},"FIMP":{temp:27,conditions:[],intensity:null},"FMCH":{temp:29,conditions:[],intensity:null},"FMMI":{temp:25,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:27,conditions:[],intensity:null},"FKYS":{temp:24,conditions:[],intensity:null},"FOOL":{temp:25,conditions:[],intensity:null},"FZAA":{temp:26,conditions:[],intensity:null},"FCBB":{temp:24,conditions:[],intensity:null},"FLLK":{temp:24,conditions:[],intensity:null},"FVHA":{temp:22,conditions:[],intensity:null},"FLLS":{temp:23,conditions:[],intensity:null},"FYWH":{temp:26,conditions:[],intensity:null},
  "FBSK":{temp:20,conditions:[],intensity:null},"FAOR":{temp:18,conditions:[],intensity:null},"FACT":{temp:22,conditions:[],intensity:null},"FALE":{temp:30,conditions:[],intensity:null},"FAPE":{temp:26,conditions:[],intensity:null},"FQMA":{temp:25,conditions:[],intensity:null},"FWKI":{temp:24,conditions:[],intensity:null},"ZBAA":{temp:-2,conditions:[],intensity:null},"ZBAD":{temp:-1,conditions:[],intensity:null},"ZSPD":{temp:3,conditions:[],intensity:null},
  "ZSSS":{temp:4,conditions:[],intensity:null},"ZGGG":{temp:9,conditions:[],intensity:null},"VHHH":{temp:14,conditions:[],intensity:null},"ZGSZ":{temp:12,conditions:[],intensity:null},"ZUUU":{temp:8,conditions:[],intensity:null},"ZUCK":{temp:6,conditions:[],intensity:null},"ZHCC":{temp:2,conditions:[],intensity:null},"ZLXY":{temp:3,conditions:[],intensity:null},"ZWSH":{temp:-18,conditions:[],intensity:null},"ZYHB":{temp:-17,conditions:[],intensity:null},
  "ZYTX":{temp:-10,conditions:[],intensity:null},"ZSAM":{temp:12,conditions:[],intensity:null},"ZGKL":{temp:2,conditions:[],intensity:null},"ZSNJ":{temp:2,conditions:[],intensity:null},"ZSHC":{temp:4,conditions:[],intensity:null},"ZPPP":{temp:17,conditions:[],intensity:null},"ZBTJ":{temp:0,conditions:[],intensity:null},"VMMC":{temp:12,conditions:[],intensity:null},"RJTT":{temp:5,conditions:[],intensity:null},"RJAA":{temp:3,conditions:[],intensity:null},
  "RJBB":{temp:5,conditions:[],intensity:null},"RJOO":{temp:3,conditions:[],intensity:null},"RJCC":{temp:-5,conditions:[],intensity:null},"RJFF":{temp:1,conditions:[],intensity:null},"RJGG":{temp:3,conditions:[],intensity:null},"ROAH":{temp:15,conditions:[],intensity:null},"RJSS":{temp:0,conditions:[],intensity:null},"RJSN":{temp:1,conditions:[],intensity:null},"RJOK":{temp:3,conditions:[],intensity:null},"RKSI":{temp:-3,conditions:[],intensity:null},
  "RKSS":{temp:-6,conditions:[],intensity:null},"RKPK":{temp:-2,conditions:[],intensity:null},"RKPC":{temp:1,conditions:[],intensity:null},"RKTN":{temp:-5,conditions:[],intensity:null},"ZKPY":{temp:-11,conditions:[],intensity:null},"WSSS":{temp:30,conditions:[],intensity:null},"WMKK":{temp:30,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:27,conditions:[],intensity:null},"WBGG":{temp:30,conditions:[],intensity:null},
  ...
  "VOMM":{temp:28,conditions:[],intensity:null},"VEBS":{temp:26,conditions:[],intensity:null},"VOHY":{temp:27,conditions:[],intensity:null},"VAAH":{temp:31,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:33,conditions:[],intensity:null},"VOTP":{temp:27,conditions:[],intensity:null},"VIAR":{temp:19,conditions:[],intensity:null},"VIJP":{temp:24,conditions:[],intensity:null},"VELR":{temp:20,conditions:[],intensity:null},
  ...
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:19,conditions:[],intensity:null},"YSSY":{temp:19,conditions:[],intensity:null},"YMML":{temp:17,conditions:[],intensity:null},"YBBN":{temp:28,conditions:[],intensity:null},"YPPH":{temp:27,conditions:[],intensity:null},"YPAD":{temp:23,conditions:[],intensity:null},"YBCG":{temp:27,conditions:[],intensity:null},"YBCS":{temp:26,conditions:[],intensity:null},"YSCB":{temp:19,conditions:[],intensity:null},
  "YMHB":{temp:15,conditions:[],intensity:null},"NZAA":{temp:20,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:16,conditions:[],intensity:null},"NZQN":{temp:17,conditions:[],intensity:null},"NZDN":{temp:15,conditions:["fog"],intensity:null},"NFFN":{temp:29,conditions:[],intensity:null},"NWWW":{temp:28,conditions:[],intensity:null},"NTAA":{temp:28,conditions:[],intensity:null},"NSFA":{temp:29,conditions:["thunderstorm"],intensity:null},
  "NIUE":{temp:28,conditions:[],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:23,conditions:[],intensity:null},"PHKO":{temp:27,conditions:[],intensity:null},"PHLH":{temp:15,conditions:[],intensity:null}
};
