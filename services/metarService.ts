...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LEZL":{temp:10,conditions:[],intensity:null},"GCLP":{temp:16,conditions:[],intensity:null},"GCTS":{temp:12,conditions:[],intensity:null},"GCLA":{temp:17,conditions:[],intensity:null},"GCFV":{temp:14,conditions:[],intensity:null},"LPPT":{temp:13,conditions:[],intensity:null},"LPPR":{temp:12,conditions:[],intensity:null},"LPFR":{temp:15,conditions:[],intensity:null},"LPMA":{temp:14,conditions:[],intensity:null},"LIRF":{temp:9,conditions:[],intensity:null},
  ...
  "OIAW":{temp:14,conditions:[],intensity:null},"OIKK":{temp:4,conditions:[],intensity:null},"OICC":{temp:5,conditions:[],intensity:null},"LLBG":{temp:12,conditions:["thunderstorm"],intensity:null},"OLBA":{temp:11,conditions:["thunderstorm"],intensity:null},"OJAM":{temp:6,conditions:[],intensity:null},"ORBI":{temp:13,conditions:[],intensity:null},"ORER":{temp:9,conditions:[],intensity:null},"GMMN":{temp:9,conditions:[],intensity:null},"GMME":{temp:7,conditions:[],intensity:null},
  "GMMX":{temp:6,conditions:[],intensity:null},"GMTT":{temp:11,conditions:[],intensity:null},"GMFF":{temp:5,conditions:[],intensity:null},"GMAD":{temp:9,conditions:[],intensity:null},"DAAG":{temp:10,conditions:[],intensity:null},"DAOO":{temp:8,conditions:[],intensity:null},"DTTA":{temp:9,conditions:[],intensity:null},"DTMB":{temp:8,conditions:[],intensity:null},"DTTJ":{temp:9,conditions:[],intensity:null},"HECA":{temp:10,conditions:[],intensity:null},
