...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LATI":{temp:7,conditions:[],intensity:null},"UKBB":{temp:-15,conditions:[],intensity:null},"UKLL":{temp:-14,conditions:[],intensity:null},"UUEE":{temp:-22,conditions:[],intensity:null},"UUDD":{temp:-21,conditions:[],intensity:null},"UUWW":{temp:-22,conditions:[],intensity:null},"ULLI":{temp:-21,conditions:[],intensity:null},"UWWW":{temp:-9,conditions:[],intensity:null},"USSS":{temp:-15,conditions:[],intensity:null},"UNNT":{temp:-14,conditions:[],intensity:null},
