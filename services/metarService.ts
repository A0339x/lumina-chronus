...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EPWR":{temp:8,conditions:[],intensity:null},"EPPO":{temp:8,conditions:[],intensity:null},"EKCH":{temp:6,conditions:[],intensity:null},"ESSA":{temp:6,conditions:[],intensity:null},"ENGM":{temp:3,conditions:[],intensity:null},"EFHK":{temp:3,conditions:[],intensity:null},"BIKF":{temp:-2,conditions:[],intensity:null},"ESGG":{temp:4,conditions:[],intensity:null},"ESMS":{temp:3,conditions:[],intensity:null},"ENBR":{temp:4,conditions:[],intensity:null},
