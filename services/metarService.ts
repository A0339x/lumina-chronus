...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:19,conditions:[],intensity:null},"KLAX":{temp:7,conditions:[],intensity:null},"KORD":{temp:4,conditions:[],intensity:null},"KDFW":{temp:5,conditions:[],intensity:null},"KDEN":{temp:-8,conditions:[],intensity:null},"KJFK":{temp:7,conditions:[],intensity:null},"KSFO":{temp:6,conditions:[],intensity:null},"KSEA":{temp:4,conditions:[],intensity:null},"KLAS":{temp:1,conditions:[],intensity:null},"KMCO":{temp:17,conditions:[],intensity:null},
  "KEWR":{temp:6,conditions:[],intensity:null},"KMIA":{temp:21,conditions:[],intensity:null},"KPHX":{temp:5,conditions:[],intensity:null},"KIAH":{temp:16,conditions:[],intensity:null},"KBOS":{temp:5,conditions:[],intensity:null},"KMSP":{temp:-3,conditions:[],intensity:null},"KFLL":{temp:23,conditions:[],intensity:null},"KDTW":{temp:2,conditions:[],intensity:null},"KPHL":{temp:8,conditions:[],intensity:null},"KLGA":{temp:6,conditions:[],intensity:null},
  "KBWI":{temp:8,conditions:[],intensity:null},"KSLC":{temp:-2,conditions:[],intensity:null},"KDCA":{temp:10,conditions:[],intensity:null},"KIAD":{temp:8,conditions:[],intensity:null},"KSAN":{temp:8,conditions:[],intensity:null},"KTPA":{temp:17,conditions:[],intensity:null},"KPDX":{temp:3,conditions:[],intensity:null},"KSTL":{temp:3,conditions:[],intensity:null},"KHNL":{temp:25,conditions:[],intensity:null},"KMEM":{temp:13,conditions:["rain"],intensity:null},
  "KAUS":{temp:11,conditions:[],intensity:null},"KBNA":{temp:13,conditions:[],intensity:null},"KRDU":{temp:16,conditions:[],intensity:null},"KCLT":{temp:16,conditions:["fog"],intensity:null},"KSMF":{temp:2,conditions:[],intensity:null},"KSJC":{temp:3,conditions:[],intensity:null},"KOAK":{temp:4,conditions:[],intensity:null},"KCLE":{temp:4,conditions:[],intensity:null},"KMKE":{temp:2,conditions:[],intensity:null},"KPIT":{temp:3,conditions:[],intensity:null},
  "KIND":{temp:3,conditions:[],intensity:null},"KCVG":{temp:5,conditions:[],intensity:null},"KMCI":{temp:1,conditions:[],intensity:null},"KSAT":{temp:12,conditions:[],intensity:null},"KHOU":{temp:18,conditions:[],intensity:null},"KDAL":{temp:6,conditions:[],intensity:null},"KMDW":{temp:4,conditions:[],intensity:null},"PANC":{temp:-7,conditions:[],intensity:null},"PAFA":{temp:-22,conditions:[],intensity:null},"CYYZ":{temp:2,conditions:[],intensity:null},
  "CYVR":{temp:5,conditions:[],intensity:null},"CYUL":{temp:0,conditions:[],intensity:null},"CYYC":{temp:5,conditions:[],intensity:null},"CYEG":{temp:-1,conditions:[],intensity:null},"CYOW":{temp:0,conditions:[],intensity:null},"CYWG":{temp:-10,conditions:[],intensity:null},"CYHZ":{temp:6,conditions:["fog"],intensity:null},"CYQB":{temp:-2,conditions:[],intensity:null},"CYYJ":{temp:5,conditions:[],intensity:null},"CYLW":{temp:1,conditions:[],intensity:null},
  "CYXE":{temp:-17,conditions:[],intensity:null},"CYQR":{temp:-21,conditions:["fog"],intensity:null},"CYZF":{temp:-28,conditions:[],intensity:null},"CYXY":{temp:-1,conditions:[],intensity:null},"CYQT":{temp:-1,conditions:[],intensity:null},"CYYT":{temp:-2,conditions:[],intensity:null},"MMMX":{temp:9,conditions:[],intensity:null},"MMUN":{temp:23,conditions:[],intensity:null},"MMGL":{temp:12,conditions:[],intensity:null},"MMMY":{temp:21,conditions:[],intensity:null},
  "MMTJ":{temp:7,conditions:[],intensity:null},"MMSM":{temp:25,conditions:[],intensity:null},"MMMD":{temp:20,conditions:[],intensity:null},"MMCZ":{temp:26,conditions:[],intensity:null},"MMSD":{temp:13,conditions:[],intensity:null},"MGGT":{temp:14,conditions:[],intensity:null},"MSLP":{temp:22,conditions:[],intensity:null},"MHTG":{temp:20,conditions:[],intensity:null},"MNMG":{temp:23,conditions:[],intensity:null},"MROC":{temp:19,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:21,conditions:["fog"],intensity:null},"TIST":{temp:25,conditions:[],intensity:null},"TLPL":{temp:26,conditions:[],intensity:null},"TAPA":{temp:25,conditions:[],intensity:null},"SBGR":{temp:21,conditions:["fog"],intensity:null},"SBGL":{temp:27,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:20,conditions:[],intensity:null},"SBSV":{temp:25,conditions:[],intensity:null},"SBRF":{temp:25,conditions:[],intensity:null},
  "SBPA":{temp:25,conditions:[],intensity:null},"SBCT":{temp:20,conditions:["fog"],intensity:null},"SBFZ":{temp:26,conditions:[],intensity:null},"SCEL":{temp:18,conditions:[],intensity:null},"SAEZ":{temp:18,conditions:[],intensity:null},"SABE":{temp:19,conditions:[],intensity:null},"SACO":{temp:14,conditions:["fog"],intensity:null},"SAME":{temp:17,conditions:[],intensity:null},"SLLP":{temp:6,conditions:["fog"],intensity:null},"SLVR":{temp:22,conditions:[],intensity:null},
  "SPJC":{temp:20,conditions:["fog"],intensity:null},"SEQM":{temp:9,conditions:["fog"],intensity:null},"SEGU":{temp:22,conditions:[],intensity:null},"SKBO":{temp:9,conditions:[],intensity:null},"SKMR":{temp:22,conditions:[],intensity:null},"SKCL":{temp:19,conditions:[],intensity:null},"SKMD":{temp:21,conditions:["fog"],intensity:null},"SKRG":{temp:12,conditions:["fog"],intensity:null},"SVMI":{temp:26,conditions:[],intensity:null},"SUMU":{temp:17,conditions:["rain"],intensity:null},
  "SGAS":{temp:24,conditions:["fog"],intensity:null},"SBBV":{temp:26,conditions:[],intensity:null},"SMJP":{temp:23,conditions:[],intensity:null},"SYCJ":{temp:24,conditions:[],intensity:null},"EGLL":{temp:1,conditions:[],intensity:null},"EGKK":{temp:1,conditions:[],intensity:null},"EGSS":{temp:1,conditions:["snow"],intensity:null},"EGLC":{temp:2,conditions:[],intensity:null},"EGCC":{temp:-3,conditions:["fog"],intensity:null},"EGBB":{temp:-1,conditions:[],intensity:null},
  "EGPH":{temp:-2,conditions:[],intensity:null},"EGPF":{temp:2,conditions:[],intensity:null},"EGGW":{temp:0,conditions:[],intensity:null},"EGNX":{temp:-1,conditions:[],intensity:null},"EGNT":{temp:-1,conditions:[],intensity:null},"EGGP":{temp:2,conditions:[],intensity:null},"EGHI":{temp:1,conditions:[],intensity:null},"EGGD":{temp:1,conditions:[],intensity:null},"EGPD":{temp:1,conditions:[],intensity:null},"EGAA":{temp:1,conditions:[],intensity:null},
  "EIDW":{temp:1,conditions:[],intensity:null},"EICK":{temp:3,conditions:[],intensity:null},"EINN":{temp:3,conditions:[],intensity:null},"LFPG":{temp:3,conditions:[],intensity:null},"LFPO":{temp:3,conditions:[],intensity:null},"LFML":{temp:7,conditions:[],intensity:null},"LFLL":{temp:4,conditions:[],intensity:null},"LFMN":{temp:12,conditions:[],intensity:null},"LFBD":{temp:7,conditions:[],intensity:null},"LFBO":{temp:7,conditions:[],intensity:null},
  "LFRS":{temp:6,conditions:[],intensity:null},"LFSB":{temp:2,conditions:[],intensity:null},"LFPB":{temp:3,conditions:[],intensity:null},"EDDF":{temp:2,conditions:[],intensity:null},"EDDM":{temp:2,conditions:[],intensity:null},"EDDB":{temp:-7,conditions:[],intensity:null},"EDDL":{temp:-2,conditions:[],intensity:null},"EDDH":{temp:-3,conditions:[],intensity:null},"EDDK":{temp:-1,conditions:[],intensity:null},"EDDS":{temp:1,conditions:[],intensity:null},
  "EDDW":{temp:-3,conditions:[],intensity:null},"EDDN":{temp:1,conditions:[],intensity:null},"EDDV":{temp:-4,conditions:[],intensity:null},"EDDP":{temp:-7,conditions:[],intensity:null},"LEMD":{temp:4,conditions:[],intensity:null},"LEBL":{temp:10,conditions:[],intensity:null},"LEPA":{temp:13,conditions:[],intensity:null},"LEMG":{temp:12,conditions:[],intensity:null},"LEVC":{temp:11,conditions:[],intensity:null},"LEAL":{temp:12,conditions:[],intensity:null},
  "LEZL":{temp:7,conditions:["fog"],intensity:null},"GCLP":{temp:18,conditions:[],intensity:null},"GCTS":{temp:16,conditions:[],intensity:null},"GCLA":{temp:18,conditions:[],intensity:null},"GCFV":{temp:16,conditions:[],intensity:null},"LPPT":{temp:10,conditions:[],intensity:null},"LPPR":{temp:8,conditions:["fog"],intensity:null},"LPFR":{temp:10,conditions:[],intensity:null},"LPMA":{temp:14,conditions:[],intensity:null},"LIRF":{temp:10,conditions:[],intensity:null},
  "LIMC":{temp:-1,conditions:["fog"],intensity:null},"LIME":{temp:0,conditions:[],intensity:null},"LIPZ":{temp:3,conditions:[],intensity:null},"LIRN":{temp:9,conditions:[],intensity:null},"LIML":{temp:-1,conditions:["fog"],intensity:null},"LIPE":{temp:2,conditions:[],intensity:null},"LICC":{temp:15,conditions:[],intensity:null},"LICJ":{temp:14,conditions:[],intensity:null},"LIRA":{temp:8,conditions:[],intensity:null},"LIRP":{temp:9,conditions:[],intensity:null},
  "LIMF":{temp:2,conditions:[],intensity:null},"LIEO":{temp:10,conditions:[],intensity:null},"LIEE":{temp:11,conditions:[],intensity:null},"EHAM":{temp:-2,conditions:[],intensity:null},"EHRD":{temp:-2,conditions:[],intensity:null},"EHEH":{temp:-3,conditions:[],intensity:null},"EBBR":{temp:-2,conditions:[],intensity:null},"EBCI":{temp:-2,conditions:[],intensity:null},"ELLX":{temp:-1,conditions:[],intensity:null},"LSZH":{temp:1,conditions:[],intensity:null},
  "LSGG":{temp:1,conditions:[],intensity:null},"LSZB":{temp:1,conditions:[],intensity:null},"LOWW":{temp:-3,conditions:[],intensity:null},"LOWS":{temp:0,conditions:[],intensity:null},"LOWG":{temp:-2,conditions:["fog"],intensity:null},"LOWI":{temp:0,conditions:[],intensity:null},"LKPR":{temp:-5,conditions:["snow"],intensity:null},"EPWA":{temp:-10,conditions:[],intensity:null},"EPKK":{temp:-9,conditions:[],intensity:null},"EPGD":{temp:-1,conditions:[],intensity:null},
  "EPWR":{temp:-8,conditions:[],intensity:null},"EPPO":{temp:-8,conditions:[],intensity:null},"EKCH":{temp:-2,conditions:[],intensity:null},"ESSA":{temp:-8,conditions:[],intensity:null},"ENGM":{temp:-12,conditions:[],intensity:null},"EFHK":{temp:-12,conditions:[],intensity:null},"BIKF":{temp:-5,conditions:[],intensity:null},"ESGG":{temp:-10,conditions:[],intensity:null},"ESMS":{temp:-4,conditions:[],intensity:null},"ENBR":{temp:-6,conditions:[],intensity:null},
  "ENZV":{temp:-4,conditions:[],intensity:null},"ENTC":{temp:-11,conditions:[],intensity:null},"EFOU":{temp:-23,conditions:[],intensity:null},"EFRO":{temp:-29,conditions:[],intensity:null},"LGAV":{temp:18,conditions:[],intensity:null},"LGTS":{temp:9,conditions:[],intensity:null},"LGIR":{temp:18,conditions:[],intensity:null},"LGKR":{temp:15,conditions:["thunderstorm"],intensity:null},"LGRP":{temp:18,conditions:[],intensity:null},"LGSR":{temp:18,conditions:[],intensity:null},
  "LGMK":{temp:17,conditions:[],intensity:null},"LTFM":{temp:11,conditions:[],intensity:null},"LTBA":{temp:12,conditions:[],intensity:null},"LTFJ":{temp:12,conditions:[],intensity:null},"LTAI":{temp:12,conditions:[],intensity:null},"LTAC":{temp:0,conditions:[],intensity:null},"LTBJ":{temp:12,conditions:[],intensity:null},"LTBS":{temp:15,conditions:[],intensity:null},"LTFE":{temp:16,conditions:["thunderstorm"],intensity:null},"LCLK":{temp:17,conditions:[],intensity:null},
  "LCPH":{temp:15,conditions:[],intensity:null},"LHBP":{temp:-3,conditions:[],intensity:null},"LROP":{temp:3,conditions:[],intensity:null},"LBSF":{temp:1,conditions:[],intensity:null},"LYBE":{temp:1,conditions:["fog"],intensity:null},"LDZA":{temp:1,conditions:["rain"],intensity:null},"LDDU":{temp:9,conditions:["rain"],intensity:null},"LDSP":{temp:9,conditions:[],intensity:null},"LJLJ":{temp:0,conditions:["fog"],intensity:null},"LWSK":{temp:1,conditions:["freezing"],intensity:null},
  "LATI":{temp:11,conditions:[],intensity:null},"UKBB":{temp:-9,conditions:[],intensity:null},"UKLL":{temp:-10,conditions:[],intensity:null},"UUEE":{temp:-5,conditions:[],intensity:null},"UUDD":{temp:-5,conditions:[],intensity:null},"UUWW":{temp:-6,conditions:[],intensity:null},"ULLI":{temp:-10,conditions:[],intensity:null},"UWWW":{temp:-8,conditions:[],intensity:null},"USSS":{temp:-6,conditions:[],intensity:null},"UNNT":{temp:-8,conditions:[],intensity:null},
  "UUOB":{temp:-22,conditions:[],intensity:null},"UHWW":{temp:-10,conditions:[],intensity:null},"UEEE":{temp:-43,conditions:[],intensity:null},"OMDB":{temp:22,conditions:[],intensity:null},"OMDW":{temp:24,conditions:[],intensity:null},"OMAA":{temp:24,conditions:[],intensity:null},"OMSJ":{temp:24,conditions:[],intensity:null},"OTHH":{temp:23,conditions:[],intensity:null},"OERK":{temp:19,conditions:[],intensity:null},"OEJN":{temp:29,conditions:[],intensity:null},
  "OEDF":{temp:23,conditions:[],intensity:null},"OEMA":{temp:21,conditions:[],intensity:null},"OKBK":{temp:20,conditions:[],intensity:null},"OBBI":{temp:19,conditions:[],intensity:null},"OOMS":{temp:27,conditions:[],intensity:null},"OYAA":{temp:19,conditions:[],intensity:null},"OIIE":{temp:9,conditions:[],intensity:null},"OIII":{temp:9,conditions:[],intensity:null},"OISS":{temp:14,conditions:[],intensity:null},"OIKB":{temp:21,conditions:[],intensity:null},
  "OIAW":{temp:20,conditions:[],intensity:null},"OIKK":{temp:12,conditions:[],intensity:null},"OICC":{temp:7,conditions:[],intensity:null},"LLBG":{temp:16,conditions:[],intensity:null},"OLBA":{temp:17,conditions:[],intensity:null},"OJAM":{temp:12,conditions:[],intensity:null},"ORBI":{temp:16,conditions:[],intensity:null},"ORER":{temp:11,conditions:[],intensity:null},"GMMN":{temp:10,conditions:[],intensity:null},"GMME":{temp:11,conditions:[],intensity:null},
  "GMMX":{temp:8,conditions:[],intensity:null},"GMTT":{temp:13,conditions:[],intensity:null},"GMFF":{temp:11,conditions:[],intensity:null},"GMAD":{temp:10,conditions:[],intensity:null},"DAAG":{temp:14,conditions:[],intensity:null},"DAOO":{temp:15,conditions:[],intensity:null},"DTTA":{temp:13,conditions:[],intensity:null},"DTMB":{temp:15,conditions:[],intensity:null},"DTTJ":{temp:13,conditions:[],intensity:null},"HECA":{temp:18,conditions:[],intensity:null},
  "HEGN":{temp:20,conditions:[],intensity:null},"HESH":{temp:21,conditions:[],intensity:null},"HEBA":{temp:21,conditions:[],intensity:null},"HEAX":{temp:19,conditions:[],intensity:null},"HLLT":{temp:15,conditions:[],intensity:null},"DNMM":{temp:29,conditions:[],intensity:null},"DNAA":{temp:29,conditions:[],intensity:null},"DGAA":{temp:29,conditions:[],intensity:null},"DIAP":{temp:29,conditions:[],intensity:null},"GOBD":{temp:21,conditions:[],intensity:null},
  "GABS":{temp:23,conditions:[],intensity:null},"GVNP":{temp:21,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:28,conditions:[],intensity:null},"DXXX":{temp:31,conditions:[],intensity:null},"DBBB":{temp:31,conditions:[],intensity:null},"HKJK":{temp:24,conditions:[],intensity:null},"HKMO":{temp:32,conditions:[],intensity:null},"HTDA":{temp:32,conditions:[],intensity:null},"HTKJ":{temp:28,conditions:[],intensity:null},
  "HUEN":{temp:26,conditions:[],intensity:null},"HRYR":{temp:24,conditions:[],intensity:null},"HAAB":{temp:22,conditions:[],intensity:null},"HDAM":{temp:27,conditions:[],intensity:null},"HCMM":{temp:31,conditions:[],intensity:null},"OYSN":{temp:25,conditions:[],intensity:null},"FMEE":{temp:29,conditions:[],intensity:null},"FIMP":{temp:27,conditions:[],intensity:null},"FMCH":{temp:30,conditions:[],intensity:null},"FMMI":{temp:27,conditions:[],intensity:null},
  "FSIA":{temp:25,conditions:[],intensity:null},"FKKD":{temp:29,conditions:[],intensity:null},"FKYS":{temp:28,conditions:[],intensity:null},"FOOL":{temp:29,conditions:[],intensity:null},"FZAA":{temp:28,conditions:[],intensity:null},"FCBB":{temp:27,conditions:[],intensity:null},"FLLK":{temp:22,conditions:[],intensity:null},"FVHA":{temp:22,conditions:[],intensity:null},"FLLS":{temp:24,conditions:[],intensity:null},"FYWH":{temp:29,conditions:[],intensity:null},
  "FBSK":{temp:29,conditions:[],intensity:null},"FAOR":{temp:24,conditions:[],intensity:null},"FACT":{temp:29,conditions:[],intensity:null},"FALE":{temp:23,conditions:[],intensity:null},"FAPE":{temp:25,conditions:[],intensity:null},"FQMA":{temp:26,conditions:[],intensity:null},"FWKI":{temp:25,conditions:[],intensity:null},"ZBAA":{temp:-2,conditions:[],intensity:null},"ZBAD":{temp:-2,conditions:[],intensity:null},"ZSPD":{temp:10,conditions:[],intensity:null},
  "ZSSS":{temp:9,conditions:[],intensity:null},"ZGGG":{temp:19,conditions:[],intensity:null},"VHHH":{temp:20,conditions:[],intensity:null},"ZGSZ":{temp:20,conditions:[],intensity:null},"ZUUU":{temp:13,conditions:[],intensity:null},"ZUCK":{temp:13,conditions:[],intensity:null},"ZHCC":{temp:6,conditions:[],intensity:null},"ZLXY":{temp:7,conditions:[],intensity:null},"ZWSH":{temp:-12,conditions:[],intensity:null},"ZYHB":{temp:-18,conditions:[],intensity:null},
  "ZYTX":{temp:-12,conditions:[],intensity:null},"ZSAM":{temp:16,conditions:[],intensity:null},"ZGKL":{temp:14,conditions:[],intensity:null},"ZSNJ":{temp:7,conditions:[],intensity:null},"ZSHC":{temp:11,conditions:[],intensity:null},"ZPPP":{temp:13,conditions:[],intensity:null},"ZBTJ":{temp:-1,conditions:[],intensity:null},"VMMC":{temp:20,conditions:[],intensity:null},"RJTT":{temp:12,conditions:[],intensity:null},"RJAA":{temp:11,conditions:[],intensity:null},
  "RJBB":{temp:15,conditions:[],intensity:null},"RJOO":{temp:12,conditions:[],intensity:null},"RJCC":{temp:3,conditions:[],intensity:null},"RJFF":{temp:11,conditions:[],intensity:null},"RJGG":{temp:10,conditions:[],intensity:null},"ROAH":{temp:17,conditions:[],intensity:null},"RJSS":{temp:8,conditions:[],intensity:null},"RJSN":{temp:9,conditions:[],intensity:null},"RJOK":{temp:11,conditions:[],intensity:null},"RKSI":{temp:-1,conditions:[],intensity:null},
  "RKSS":{temp:-2,conditions:[],intensity:null},"RKPK":{temp:4,conditions:[],intensity:null},"RKPC":{temp:6,conditions:[],intensity:null},"RKTN":{temp:1,conditions:[],intensity:null},"ZKPY":{temp:-7,conditions:[],intensity:null},"WSSS":{temp:27,conditions:[],intensity:null},"WMKK":{temp:29,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:26,conditions:[],intensity:null},
  "VTBS":{temp:28,conditions:[],intensity:null},"VTBD":{temp:27,conditions:[],intensity:null},"VTSP":{temp:30,conditions:[],intensity:null},"VTCC":{temp:26,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:27,conditions:[],intensity:null},"VVNB":{temp:21,conditions:[],intensity:null},"VVTS":{temp:28,conditions:[],intensity:null},"VVDN":{temp:19,conditions:[],intensity:null},"VVCR":{temp:25,conditions:[],intensity:null},
  "VDPP":{temp:28,conditions:[],intensity:null},"VDSR":{temp:26,conditions:[],intensity:null},"VLVT":{temp:23,conditions:[],intensity:null},"VLLB":{temp:23,conditions:[],intensity:null},"VYYY":{temp:28,conditions:[],intensity:null},"VYMD":{temp:28,conditions:[],intensity:null},"VGHS":{temp:22,conditions:[],intensity:null},"VGCG":{temp:20,conditions:[],intensity:null},"VECC":{temp:22,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  "VCBI":{temp:26,conditions:[],intensity:null},"WIII":{temp:27,conditions:[],intensity:null},"WADD":{temp:29,conditions:[],intensity:null},"WARR":{temp:28,conditions:[],intensity:null},"WIHH":{temp:27,conditions:[],intensity:null},"WIMM":{temp:28,conditions:[],intensity:null},"WIBB":{temp:27,conditions:[],intensity:null},"WAFF":{temp:28,conditions:["thunderstorm"],intensity:null},"WICC":{temp:25,conditions:[],intensity:null},"WASS":{temp:29,conditions:[],intensity:null},
  "RPLL":{temp:28,conditions:[],intensity:null},"RPLC":{temp:24,conditions:[],intensity:null},"RPVM":{temp:26,conditions:["thunderstorm"],intensity:null},"RPVD":{temp:28,conditions:["thunderstorm"],intensity:null},"RPVK":{temp:25,conditions:[],intensity:null},"WBSB":{temp:26,conditions:[],intensity:null},"WBLL":{temp:27,conditions:[],intensity:null},"VIDP":{temp:18,conditions:[],intensity:null},"VABB":{temp:25,conditions:[],intensity:null},"VOBL":{temp:22,conditions:[],intensity:null},
  "VOMM":{temp:26,conditions:[],intensity:null},"VEBS":{temp:22,conditions:[],intensity:null},"VOHY":{temp:22,conditions:[],intensity:null},"VAAH":{temp:26,conditions:[],intensity:null},"VOCI":{temp:27,conditions:[],intensity:null},"VAGO":{temp:31,conditions:[],intensity:null},"VOTP":{temp:26,conditions:[],intensity:null},"VIAR":{temp:15,conditions:[],intensity:null},"VIJP":{temp:20,conditions:[],intensity:null},"VELR":{temp:17,conditions:[],intensity:null},
  "VOCL":{temp:29,conditions:[],intensity:null},"VOTV":{temp:27,conditions:[],intensity:null},"VEPT":{temp:18,conditions:[],intensity:null},"VNKT":{temp:16,conditions:[],intensity:null},"OPKC":{temp:24,conditions:[],intensity:null},"OPLA":{temp:15,conditions:[],intensity:null},"OPIS":{temp:16,conditions:[],intensity:null},"RCTP":{temp:16,conditions:[],intensity:null},"RCSS":{temp:16,conditions:[],intensity:null},"RCMQ":{temp:16,conditions:[],intensity:null},
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:18,conditions:[],intensity:null},"YSSY":{temp:26,conditions:[],intensity:null},"YMML":{temp:17,conditions:[],intensity:null},"YBBN":{temp:26,conditions:[],intensity:null},"YPPH":{temp:29,conditions:[],intensity:null},"YPAD":{temp:19,conditions:[],intensity:null},"YBCG":{temp:24,conditions:[],intensity:null},"YBCS":{temp:24,conditions:[],intensity:null},"YSCB":{temp:27,conditions:[],intensity:null},
  "YMHB":{temp:13,conditions:[],intensity:null},"NZAA":{temp:21,conditions:[],intensity:null},"NZWN":{temp:19,conditions:[],intensity:null},"NZCH":{temp:20,conditions:[],intensity:null},"NZQN":{temp:18,conditions:[],intensity:null},"NZDN":{temp:16,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:30,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:28,conditions:[],intensity:null},
  "NIUE":{temp:27,conditions:[],intensity:null},"PGSN":{temp:27,conditions:[],intensity:null},"PGUM":{temp:28,conditions:[],intensity:null},"PHOG":{temp:23,conditions:[],intensity:null},"PHKO":{temp:26,conditions:[],intensity:null},"PHLH":{temp:19,conditions:["fog"],intensity:null}
};
