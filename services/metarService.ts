...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "EDDW":{temp:-1,conditions:[],intensity:null},"EDDN":{temp:-3,conditions:[],intensity:null},"EDDV":{temp:0,conditions:[],intensity:null},"EDDP":{temp:-3,conditions:[],intensity:null},"LEMD":{temp:3,conditions:[],intensity:null},"LEBL":{temp:12,conditions:[],intensity:null},"LEPA":{temp:13,conditions:[],intensity:null},"LEMG":{temp:11,conditions:[],intensity:null},"LEVC":{temp:11,conditions:[],intensity:null},"LEAL":{temp:12,conditions:[],intensity:null},
