...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "CYXE":{temp:-12,conditions:[],intensity:null},"CYQR":{temp:-8,conditions:[],intensity:null},"CYZF":{temp:-25,conditions:[],intensity:null},"CYXY":{temp:-16,conditions:[],intensity:null},"CYQT":{temp:-3,conditions:[],intensity:null},"CYYT":{temp:-3,conditions:[],intensity:null},"MMMX":{temp:23,conditions:[],intensity:null},"MMUN":{temp:28,conditions:[],intensity:null},"MMGL":{temp:25,conditions:[],intensity:null},"MMMY":{temp:29,conditions:[],intensity:null},
  ...
  "TJSJ":{temp:27,conditions:[],intensity:null},"TIST":{temp:26,conditions:[],intensity:null},"TLPL":{temp:29,conditions:[],intensity:null},"TAPA":{temp:26,conditions:[],intensity:null},"SBGR":{temp:26,conditions:[],intensity:null},"SBGL":{temp:26,conditions:[],intensity:null},"SBBR":{temp:20,conditions:[],intensity:null},"SBCF":{temp:19,conditions:[],intensity:null},"SBSV":{temp:29,conditions:[],intensity:null},"SBRF":{temp:27,conditions:[],intensity:null},
  "SBPA":{temp:31,conditions:[],intensity:null},"SBCT":{temp:24,conditions:[],intensity:null},"SBFZ":{temp:28,conditions:[],intensity:null},"SCEL":{temp:24,conditions:[],intensity:null},"SAEZ":{temp:32,conditions:[],intensity:null},"SABE":{temp:31,conditions:[],intensity:null},"SACO":{temp:31,conditions:[],intensity:null},"SAME":{temp:27,conditions:[],intensity:null},"SLLP":{temp:17,conditions:[],intensity:null},"SLVR":{temp:32,conditions:[],intensity:null},
  "SPJC":{temp:20,conditions:[],intensity:null},"SEQM":{temp:13,conditions:[],intensity:null},"SEGU":{temp:31,conditions:[],intensity:null},"SKBO":{temp:14,conditions:["thunderstorm"],intensity:null},"SKMR":{temp:26,conditions:[],intensity:null},"SKCL":{temp:24,conditions:["thunderstorm"],intensity:null},"SKMD":{temp:25,conditions:["thunderstorm"],intensity:null},"SKRG":{temp:17,conditions:[],intensity:null},"SVMI":{temp:25,conditions:[],intensity:null},"SUMU":{temp:32,conditions:[],intensity:null},
  ...
  "LSGG":{temp:-4,conditions:[],intensity:null},"LSZB":{temp:-5,conditions:[],intensity:null},"LOWW":{temp:-3,conditions:[],intensity:null},"LOWS":{temp:-9,conditions:[],intensity:null},"LOWG":{temp:-4,conditions:[],intensity:null},"LOWI":{temp:-8,conditions:[],intensity:null},"LKPR":{temp:-5,conditions:[],intensity:null},"EPWA":{temp:-5,conditions:[],intensity:null},"EPKK":{temp:-3,conditions:[],intensity:null},"EPGD":{temp:-6,conditions:[],intensity:null},
  ...
  "GMMX":{temp:8,conditions:[],intensity:null},"GMTT":{temp:12,conditions:[],intensity:null},"GMFF":{temp:4,conditions:[],intensity:null},"GMAD":{temp:12,conditions:[],intensity:null},"DAAG":{temp:8,conditions:[],intensity:null},"DAOO":{temp:7,conditions:[],intensity:null},"DTTA":{temp:12,conditions:[],intensity:null},"DTMB":{temp:15,conditions:[],intensity:null},"DTTJ":{temp:16,conditions:[],intensity:null},"HECA":{temp:15,conditions:[],intensity:null},
  "HEGN":{temp:17,conditions:[],intensity:null},"HESH":{temp:19,conditions:[],intensity:null},"HEBA":{temp:18,conditions:[],intensity:null},"HEAX":{temp:14,conditions:[],intensity:null},"HLLT":{temp:20,conditions:[],intensity:null},"DNMM":{temp:28,conditions:[],intensity:null},"DNAA":{temp:25,conditions:[],intensity:null},"DGAA":{temp:28,conditions:[],intensity:null},"DIAP":{temp:27,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  "GABS":{temp:21,conditions:[],intensity:null},"GVNP":{temp:21,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:27,conditions:[],intensity:null},"DXXX":{temp:27,conditions:[],intensity:null},"DBBB":{temp:28,conditions:[],intensity:null},"HKJK":{temp:18,conditions:[],intensity:null},"HKMO":{temp:26,conditions:[],intensity:null},"HTDA":{temp:27,conditions:[],intensity:null},"HTKJ":{temp:23,conditions:[],intensity:null},
  ...
  "RJBB":{temp:7,conditions:[],intensity:null},"RJOO":{temp:2,conditions:[],intensity:null},"RJCC":{temp:-12,conditions:[],intensity:null},"RJFF":{temp:4,conditions:[],intensity:null},"RJGG":{temp:5,conditions:[],intensity:null},"ROAH":{temp:17,conditions:[],intensity:null},"RJSS":{temp:0,conditions:[],intensity:null},"RJSN":{temp:1,conditions:[],intensity:null},"RJOK":{temp:5,conditions:[],intensity:null},"RKSI":{temp:6,conditions:[],intensity:null},
  ...
  "VDPP":{temp:24,conditions:[],intensity:null},"VDSR":{temp:21,conditions:[],intensity:null},"VLVT":{temp:15,conditions:[],intensity:null},"VLLB":{temp:17,conditions:[],intensity:null},"VYYY":{temp:20,conditions:[],intensity:null},"VYMD":{temp:17,conditions:[],intensity:null},"VGHS":{temp:13,conditions:[],intensity:null},"VGCG":{temp:16,conditions:[],intensity:null},"VECC":{temp:12,conditions:[],intensity:null},"VRMM":{temp:27,conditions:[],intensity:null},
  ...
  "RCKH":{temp:15,conditions:[],intensity:null},"RCNN":{temp:12,conditions:[],intensity:null},"YSSY":{temp:18,conditions:["fog"],intensity:null},"YMML":{temp:23,conditions:[],intensity:null},"YBBN":{temp:23,conditions:[],intensity:null},"YPPH":{temp:21,conditions:[],intensity:null},"YPAD":{temp:25,conditions:[],intensity:null},"YBCG":{temp:20,conditions:[],intensity:null},"YBCS":{temp:23,conditions:[],intensity:null},"YSCB":{temp:16,conditions:["fog"],intensity:null},
  "YMHB":{temp:15,conditions:[],intensity:null},"NZAA":{temp:21,conditions:[],intensity:null},"NZWN":{temp:18,conditions:[],intensity:null},"NZCH":{temp:18,conditions:[],intensity:null},"NZQN":{temp:14,conditions:[],intensity:null},"NZDN":{temp:14,conditions:[],intensity:null},"NFFN":{temp:28,conditions:[],intensity:null},"NWWW":{temp:28,conditions:[],intensity:null},"NTAA":{temp:26,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
