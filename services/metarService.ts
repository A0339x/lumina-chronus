...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "LATI":{temp:11,conditions:["thunderstorm"],intensity:null},"UKBB":{temp:-10,conditions:[],intensity:null},"UKLL":{temp:-11,conditions:[],intensity:null},"UUEE":{temp:-5,conditions:[],intensity:null},"UUDD":{temp:-1,conditions:["snow"],intensity:null},"UUWW":{temp:-4,conditions:[],intensity:null},"ULLI":{temp:-9,conditions:[],intensity:null},"UWWW":{temp:-8,conditions:[],intensity:null},"USSS":{temp:-10,conditions:[],intensity:null},"UNNT":{temp:-10,conditions:[],intensity:null},
