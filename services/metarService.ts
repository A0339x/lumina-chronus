...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  "KATL":{temp:10,conditions:[],intensity:null},"KLAX":{temp:28,conditions:[],intensity:null},"KORD":{temp:-7,conditions:["snow"],intensity:null},"KDFW":{temp:9,conditions:[],intensity:null},"KDEN":{temp:9,conditions:[],intensity:null},"KJFK":{temp:-9,conditions:[],intensity:null},"KSFO":{temp:16,conditions:[],intensity:null},"KSEA":{temp:9,conditions:[],intensity:null},"KLAS":{temp:19,conditions:[],intensity:null},"KMCO":{temp:21,conditions:[],intensity:null},
  "KEWR":{temp:-9,conditions:[],intensity:null},"KMIA":{temp:19,conditions:[],intensity:null},"KPHX":{temp:24,conditions:[],intensity:null},"KIAH":{temp:13,conditions:[],intensity:null},"KBOS":{temp:-11,conditions:[],intensity:null},"KMSP":{temp:-12,conditions:[],intensity:null},"KFLL":{temp:21,conditions:[],intensity:null},"KDTW":{temp:-9,conditions:[],intensity:null},"KPHL":{temp:-9,conditions:[],intensity:null},"KLGA":{temp:-9,conditions:[],intensity:null},
  ...
  "KAUS":{temp:13,conditions:[],intensity:null},"KBNA":{temp:-2,conditions:[],intensity:null},"KRDU":{temp:1,conditions:[],intensity:null},"KCLT":{temp:5,conditions:[],intensity:null},"KSMF":{temp:13,conditions:[],intensity:null},"KSJC":{temp:18,conditions:[],intensity:null},"KOAK":{temp:17,conditions:[],intensity:null},"KCLE":{temp:-11,conditions:[],intensity:null},"KMKE":{temp:-9,conditions:[],intensity:null},"KPIT":{temp:-11,conditions:[],intensity:null},
  "KIND":{temp:-6,conditions:[],intensity:null},"KCVG":{temp:-7,conditions:[],intensity:null},"KMCI":{temp:-9,conditions:[],intensity:null},"KSAT":{temp:15,conditions:[],intensity:null},"KHOU":{temp:14,conditions:[],intensity:null},"KDAL":{temp:8,conditions:[],intensity:null},"KMDW":{temp:-7,conditions:[],intensity:null},"PANC":{temp:2,conditions:[],intensity:null},"PAFA":{temp:-10,conditions:[],intensity:null},"CYYZ":{temp:-11,conditions:[],intensity:null},
  "CYVR":{temp:9,conditions:[],intensity:null},"CYUL":{temp:-18,conditions:[],intensity:null},"CYYC":{temp:11,conditions:[],intensity:null},"CYEG":{temp:1,conditions:[],intensity:null},"CYOW":{temp:-17,conditions:[],intensity:null},"CYWG":{temp:-17,conditions:[],intensity:null},"CYHZ":{temp:-11,conditions:[],intensity:null},"CYQB":{temp:-15,conditions:[],intensity:null},"CYYJ":{temp:10,conditions:[],intensity:null},"CYLW":{temp:7,conditions:[],intensity:null},
  "CYXE":{temp:-6,conditions:[],intensity:null},"CYQR":{temp:-12,conditions:[],intensity:null},"CYZF":{temp:-13,conditions:[],intensity:null},"CYXY":{temp:-4,conditions:[],intensity:null},"CYQT":{temp:-11,conditions:[],intensity:null},"CYYT":{temp:-5,conditions:[],intensity:null},"MMMX":{temp:24,conditions:[],intensity:null},"MMUN":{temp:25,conditions:[],intensity:null},"MMGL":{temp:27,conditions:[],intensity:null},"MMMY":{temp:19,conditions:[],intensity:null},
  ...
  "SBPA":{temp:26,conditions:[],intensity:null},"SBCT":{temp:22,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:26,conditions:[],intensity:null},"SAEZ":{temp:28,conditions:[],intensity:null},"SABE":{temp:27,conditions:[],intensity:null},"SACO":{temp:30,conditions:[],intensity:null},"SAME":{temp:23,conditions:["rain"],intensity:null},"SLLP":{temp:16,conditions:[],intensity:null},"SLVR":{temp:28,conditions:[],intensity:null},
  "SPJC":{temp:21,conditions:[],intensity:null},"SEQM":{temp:13,conditions:[],intensity:null},"SEGU":{temp:29,conditions:[],intensity:null},"SKBO":{temp:16,conditions:[],intensity:null},"SKMR":{temp:26,conditions:[],intensity:null},"SKCL":{temp:24,conditions:[],intensity:null},"SKMD":{temp:24,conditions:["thunderstorm"],intensity:null},"SKRG":{temp:18,conditions:["thunderstorm"],intensity:null},"SVMI":{temp:25,conditions:[],intensity:null},"SUMU":{temp:24,conditions:[],intensity:null},
  ...
  "EDDW":{temp:-1,conditions:[],intensity:null},"EDDN":{temp:1,conditions:[],intensity:null},"EDDV":{temp:-1,conditions:[],intensity:null},"EDDP":{temp:-1,conditions:[],intensity:null},"LEMD":{temp:8,conditions:[],intensity:null},"LEBL":{temp:11,conditions:[],intensity:null},"LEPA":{temp:13,conditions:[],intensity:null},"LEMG":{temp:15,conditions:[],intensity:null},"LEVC":{temp:14,conditions:[],intensity:null},"LEAL":{temp:14,conditions:[],intensity:null},
  ...
  "LIMC":{temp:3,conditions:["fog"],intensity:null},"LIME":{temp:4,conditions:["fog"],intensity:null},"LIPZ":{temp:4,conditions:["fog"],intensity:null},"LIRN":{temp:9,conditions:["fog"],intensity:null},"LIML":{temp:3,conditions:["fog"],intensity:null},"LIPE":{temp:5,conditions:["fog"],intensity:null},"LICC":{temp:13,conditions:[],intensity:null},"LICJ":{temp:13,conditions:[],intensity:null},"LIRA":{temp:9,conditions:[],intensity:null},"LIRP":{temp:9,conditions:[],intensity:null},
  "LIMF":{temp:1,conditions:[],intensity:null},"LIEO":{temp:11,conditions:[],intensity:null},"LIEE":{temp:11,conditions:[],intensity:null},"EHAM":{temp:1,conditions:[],intensity:null},"EHRD":{temp:3,conditions:[],intensity:null},"EHEH":{temp:3,conditions:[],intensity:null},"EBBR":{temp:4,conditions:[],intensity:null},"EBCI":{temp:5,conditions:[],intensity:null},"ELLX":{temp:2,conditions:["fog"],intensity:null},"LSZH":{temp:2,conditions:[],intensity:null},
  "LSGG":{temp:2,conditions:[],intensity:null},"LSZB":{temp:1,conditions:[],intensity:null},"LOWW":{temp:-1,conditions:[],intensity:null},"LOWS":{temp:-3,conditions:["fog"],intensity:null},"LOWG":{temp:1,conditions:["fog"],intensity:null},"LOWI":{temp:1,conditions:[],intensity:null},"LKPR":{temp:-1,conditions:[],intensity:null},"EPWA":{temp:-8,conditions:[],intensity:null},"EPKK":{temp:-3,conditions:[],intensity:null},"EPGD":{temp:-12,conditions:[],intensity:null},
  ...
  "ENZV":{temp:-1,conditions:[],intensity:null},"ENTC":{temp:-5,conditions:[],intensity:null},"EFOU":{temp:-18,conditions:[],intensity:null},"EFRO":{temp:-28,conditions:[],intensity:null},"LGAV":{temp:11,conditions:[],intensity:null},"LGTS":{temp:6,conditions:[],intensity:null},"LGIR":{temp:16,conditions:[],intensity:null},"LGKR":{temp:12,conditions:[],intensity:null},"LGRP":{temp:14,conditions:["rain"],intensity:null},"LGSR":{temp:15,conditions:[],intensity:null},
  ...
  "LCPH":{temp:16,conditions:[],intensity:null},"LHBP":{temp:3,conditions:[],intensity:null},"LROP":{temp:4,conditions:[],intensity:null},"LBSF":{temp:1,conditions:[],intensity:null},"LYBE":{temp:4,conditions:[],intensity:null},"LDZA":{temp:4,conditions:[],intensity:null},"LDDU":{temp:8,conditions:[],intensity:null},"LDSP":{temp:8,conditions:[],intensity:null},"LJLJ":{temp:3,conditions:[],intensity:null},"LWSK":{temp:5,conditions:["fog"],intensity:null},
  ...
  "UUOB":{temp:-28,conditions:[],intensity:null},"UHWW":{temp:-11,conditions:[],intensity:null},"UEEE":{temp:-35,conditions:[],intensity:null},"OMDB":{temp:20,conditions:[],intensity:null},"OMDW":{temp:17,conditions:[],intensity:null},"OMAA":{temp:18,conditions:[],intensity:null},"OMSJ":{temp:19,conditions:[],intensity:null},"OTHH":{temp:14,conditions:[],intensity:null},"OERK":{temp:14,conditions:[],intensity:null},"OEJN":{temp:23,conditions:[],intensity:null},
  ...
  "OIAW":{temp:13,conditions:[],intensity:null},"OIKK":{temp:5,conditions:[],intensity:null},"OICC":{temp:4,conditions:[],intensity:null},"LLBG":{temp:14,conditions:[],intensity:null},"OLBA":{temp:17,conditions:[],intensity:null},"OJAM":{temp:10,conditions:[],intensity:null},"ORBI":{temp:12,conditions:[],intensity:null},"ORER":{temp:8,conditions:[],intensity:null},"GMMN":{temp:16,conditions:[],intensity:null},"GMME":{temp:16,conditions:[],intensity:null},
  "GMMX":{temp:15,conditions:[],intensity:null},"GMTT":{temp:16,conditions:[],intensity:null},"GMFF":{temp:14,conditions:[],intensity:null},"GMAD":{temp:16,conditions:[],intensity:null},"DAAG":{temp:15,conditions:[],intensity:null},"DAOO":{temp:16,conditions:[],intensity:null},"DTTA":{temp:13,conditions:[],intensity:null},"DTMB":{temp:15,conditions:[],intensity:null},"DTTJ":{temp:17,conditions:[],intensity:null},"HECA":{temp:16,conditions:[],intensity:null},
  ...
  "HUEN":{temp:20,conditions:[],intensity:null},"HRYR":{temp:20,conditions:[],intensity:null},"HAAB":{temp:15,conditions:[],intensity:null},"HDAM":{temp:22,conditions:[],intensity:null},"HCMM":{temp:25,conditions:[],intensity:null},"OYSN":{temp:22,conditions:[],intensity:null},"FMEE":{temp:25,conditions:[],intensity:null},"FIMP":{temp:22,conditions:["fog"],intensity:null},"FMCH":{temp:29,conditions:[],intensity:null},"FMMI":{temp:19,conditions:[],intensity:null},
  ...
  "RCKH":{temp:20,conditions:[],intensity:null},"RCNN":{temp:18,conditions:[],intensity:null},"YSSY":{temp:24,conditions:[],intensity:null},"YMML":{temp:19,conditions:[],intensity:null},"YBBN":{temp:24,conditions:[],intensity:null},"YPPH":{temp:22,conditions:[],intensity:null},"YPAD":{temp:22,conditions:[],intensity:null},"YBCG":{temp:22,conditions:[],intensity:null},"YBCS":{temp:23,conditions:[],intensity:null},"YSCB":{temp:25,conditions:[],intensity:null},
  "YMHB":{temp:17,conditions:[],intensity:null},"NZAA":{temp:22,conditions:[],intensity:null},"NZWN":{temp:17,conditions:[],intensity:null},"NZCH":{temp:17,conditions:[],intensity:null},"NZQN":{temp:14,conditions:[],intensity:null},"NZDN":{temp:14,conditions:[],intensity:null},"NFFN":{temp:29,conditions:[],intensity:null},"NWWW":{temp:30,conditions:[],intensity:null},"NTAA":{temp:27,conditions:[],intensity:null},"NSFA":{temp:29,conditions:[],intensity:null},
