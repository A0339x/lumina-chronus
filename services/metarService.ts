...
const HARDCODED_WEATHER: Record<string, AirportWeather> = {
  ...
  "KBWI":{temp:1,conditions:[],intensity:null},"KSLC":{temp:-3,conditions:[],intensity:null},"KDCA":{temp:2,conditions:[],intensity:null},"KIAD":{temp:1,conditions:[],intensity:null},"KSAN":{temp:11,conditions:[],intensity:null},"KTPA":{temp:14,conditions:[],intensity:null},"KPDX":{temp:1,conditions:[],intensity:null},"KSTL":{temp:-11,conditions:[],intensity:null},"KHNL":{temp:22,conditions:[],intensity:null},"KMEM":{temp:-5,conditions:[],intensity:null},
  ...
  "CYVR":{temp:3,conditions:["fog"],intensity:null},"CYUL":{temp:-4,conditions:[],intensity:null},"CYYC":{temp:-2,conditions:[],intensity:null},"CYEG":{temp:-4,conditions:[],intensity:null},"CYOW":{temp:-8,conditions:[],intensity:null},"CYWG":{temp:-16,conditions:["fog"],intensity:null},"CYHZ":{temp:2,conditions:[],intensity:null},"CYQB":{temp:-8,conditions:[],intensity:null},"CYYJ":{temp:3,conditions:[],intensity:null},"CYLW":{temp:-1,conditions:[],intensity:null},
  "CYXE":{temp:-13,conditions:[],intensity:null},"CYQR":{temp:-7,conditions:[],intensity:null},"CYZF":{temp:-32,conditions:[],intensity:null},"CYXY":{temp:-3,conditions:[],intensity:null},"CYQT":{temp:-22,conditions:[],intensity:null},"CYYT":{temp:3,conditions:[],intensity:null},"MMMX":{temp:12,conditions:[],intensity:null},"MMUN":{temp:21,conditions:["fog"],intensity:null},"MMGL":{temp:13,conditions:[],intensity:null},"MMMY":{temp:6,conditions:[],intensity:null},
  ...
  "SBPA":{temp:25,conditions:["thunderstorm"],intensity:null},"SBCT":{temp:21,conditions:[],intensity:null},"SBFZ":{temp:27,conditions:[],intensity:null},"SCEL":{temp:21,conditions:[],intensity:null},"SAEZ":{temp:17,conditions:[],intensity:null},"SABE":{temp:18,conditions:[],intensity:null},"SACO":{temp:22,conditions:[],intensity:null},"SAME":{temp:21,conditions:[],intensity:null},"SLLP":{temp:7,conditions:[],intensity:null},"SLVR":{temp:23,conditions:[],intensity:null},
  ...
  "SGAS":{temp:25,conditions:[],intensity:null},"SBBV":{temp:26,conditions:[],intensity:null},"SMJP":{temp:24,conditions:[],intensity:null},"SYCJ":{temp:23,conditions:["fog"],intensity:null},"EGLL":{temp:8,conditions:[],intensity:null},"EGKK":{temp:9,conditions:[],intensity:null},"EGSS":{temp:8,conditions:[],intensity:null},"EGLC":{temp:8,conditions:[],intensity:null},"EGCC":{temp:5,conditions:[],intensity:null},"EGBB":{temp:6,conditions:[],intensity:null},
  "EGPH":{temp:1,conditions:[],intensity:null},"EGPF":{temp:4,conditions:[],intensity:null},"EGGW":{temp:7,conditions:[],intensity:null},"EGNX":{temp:5,conditions:[],intensity:null},"EGNT":{temp:5,conditions:[],intensity:null},"EGGP":{temp:6,conditions:[],intensity:null},"EGHI":{temp:9,conditions:[],intensity:null},"EGGD":{temp:5,conditions:["fog"],intensity:null},"EGPD":{temp:6,conditions:[],intensity:null},"EGAA":{temp:7,conditions:[],intensity:null},
  "EIDW":{temp:7,conditions:[],intensity:null},"EICK":{temp:4,conditions:[],intensity:null},"EINN":{temp:2,conditions:["fog"],intensity:null},"LFPG":{temp:7,conditions:[],intensity:null},"LFPO":{temp:8,conditions:[],intensity:null},"LFML":{temp:14,conditions:[],intensity:null},"LFLL":{temp:5,conditions:["fog"],intensity:null},"LFMN":{temp:16,conditions:[],intensity:null},"LFBD":{temp:10,conditions:[],intensity:null},"LFBO":{temp:9,conditions:[],intensity:null},
  "LFRS":{temp:10,conditions:[],intensity:null},"LFSB":{temp:3,conditions:[],intensity:null},"LFPB":{temp:8,conditions:[],intensity:null},"EDDF":{temp:4,conditions:[],intensity:null},"EDDM":{temp:0,conditions:["fog"],intensity:null},"EDDB":{temp:1,conditions:[],intensity:null},"EDDL":{temp:5,conditions:[],intensity:null},"EDDH":{temp:3,conditions:[],intensity:null},"EDDK":{temp:4,conditions:[],intensity:null},"EDDS":{temp:1,conditions:[],intensity:null},
  "EDDW":{temp:3,conditions:[],intensity:null},"EDDN":{temp:3,conditions:[],intensity:null},"EDDV":{temp:2,conditions:[],intensity:null},"EDDP":{temp:4,conditions:[],intensity:null},"LEMD":{temp:6,conditions:[],intensity:null},"LEBL":{temp:12,conditions:[],intensity:null},"LEPA":{temp:12,conditions:[],intensity:null},"LEMG":{temp:11,conditions:[],intensity:null},"LEVC":{temp:10,conditions:[],intensity:null},"LEAL":{temp:12,conditions:[],intensity:null},
  ...
  "LGMK":{temp:9,conditions:[],intensity:null},"LTFM":{temp:1,conditions:[],intensity:null},"LTBA":{temp:2,conditions:[],intensity:null},"LTFJ":{temp:2,conditions:[],intensity:null},"LTAI":{temp:11,conditions:[],intensity:null},"LTAC":{temp:-1,conditions:[],intensity:null},"LTBJ":{temp:8,conditions:[],intensity:null},"LTBS":{temp:14,conditions:[],intensity:null},"LTFE":{temp:11,conditions:[],intensity:null},"LCLK":{temp:13,conditions:[],intensity:null},
  "LCPH":{temp:14,conditions:[],intensity:null},"LHBP":{temp:-1,conditions:[],intensity:null},"LROP":{temp:-7,conditions:[],intensity:null},"LBSF":{temp:-1,conditions:[],intensity:null},"LYBE":{temp:0,conditions:[],intensity:null},"LDZA":{temp:0,conditions:[],intensity:null},"LDDU":{temp:12,conditions:[],intensity:null},"LDSP":{temp:13,conditions:[],intensity:null},"LJLJ":{temp:2,conditions:[],intensity:null},"LWSK":{temp:5,conditions:[],intensity:null},
  "LATI":{temp:12,conditions:[],intensity:null},"UKBB":{temp:-14,conditions:[],intensity:null},"UKLL":{temp:-9,conditions:[],intensity:null},"UUEE":{temp:-10,conditions:[],intensity:null},"UUDD":{temp:-12,conditions:[],intensity:null},"UUWW":{temp:-11,conditions:[],intensity:null},"ULLI":{temp:-4,conditions:[],intensity:null},"UWWW":{temp:-14,conditions:[],intensity:null},"USSS":{temp:-11,conditions:[],intensity:null},"UNNT":{temp:-34,conditions:[],intensity:null},
  ...
  "GMMX":{temp:9,conditions:["rain"],intensity:null},"GMTT":{temp:11,conditions:[],intensity:null},"GMFF":{temp:8,conditions:[],intensity:null},"GMAD":{temp:12,conditions:[],intensity:null},"DAAG":{temp:12,conditions:[],intensity:null},"DAOO":{temp:11,conditions:[],intensity:null},"DTTA":{temp:16,conditions:[],intensity:null},"DTMB":{temp:16,conditions:[],intensity:null},"DTTJ":{temp:17,conditions:[],intensity:null},"HECA":{temp:19,conditions:[],intensity:null},
  "HEGN":{temp:21,conditions:[],intensity:null},"HESH":{temp:21,conditions:[],intensity:null},"HEBA":{temp:22,conditions:[],intensity:null},"HEAX":{temp:17,conditions:[],intensity:null},"HLLT":{temp:18,conditions:[],intensity:null},"DNMM":{temp:32,conditions:[],intensity:null},"DNAA":{temp:33,conditions:[],intensity:null},"DGAA":{temp:29,conditions:[],intensity:null},"DIAP":{temp:29,conditions:[],intensity:null},"GOBD":{temp:20,conditions:[],intensity:null},
  "GABS":{temp:25,conditions:[],intensity:null},"GVNP":{temp:21,conditions:[],intensity:null},"GBYD":{temp:28,conditions:[],intensity:null},"GLRB":{temp:29,conditions:[],intensity:null},"DXXX":{temp:32,conditions:[],intensity:null},"DBBB":{temp:32,conditions:[],intensity:null},"HKJK":{temp:26,conditions:[],intensity:null},"HKMO":{temp:33,conditions:[],intensity:null},"HTDA":{temp:31,conditions:[],intensity:null},"HTKJ":{temp:30,conditions:[],intensity:null},
  "HUEN":{temp:28,conditions:[],intensity:null},"HRYR":{temp:26,conditions:[],intensity:null},"HAAB":{temp:23,conditions:[],intensity:null},"HDAM":{temp:28,conditions:[],intensity:null},"HCMM":{temp:31,conditions:[],intensity:null},"OYSN":{temp:27,conditions:[],intensity:null},"FMEE":{temp:28,conditions:[],intensity:null},"FIMP":{temp:27,conditions:[],intensity:null},"FMCH":{temp:32,conditions:[],intensity:null},"FMMI":{temp:26,conditions:[],intensity:null},
  "FSIA":{temp:28,conditions:[],intensity:null},"FKKD":{temp:29,conditions:[],intensity:null},"FKYS":{temp:28,conditions:[],intensity:null},"FOOL":{temp:29,conditions:[],intensity:null},"FZAA":{temp:28,conditions:[],intensity:null},"FCBB":{temp:28,conditions:[],intensity:null},"FLLK":{temp:25,conditions:[],intensity:null},"FVHA":{temp:23,conditions:[],intensity:null},"FLLS":{temp:25,conditions:[],intensity:null},"FYWH":{temp:26,conditions:[],intensity:null},
  "FBSK":{temp:29,conditions:[],intensity:null},"FAOR":{temp:26,conditions:[],intensity:null},"FACT":{temp:23,conditions:[],intensity:null},"FALE":{temp:23,conditions:[],intensity:null},"FAPE":{temp:23,conditions:[],intensity:null},"FQMA":{temp:29,conditions:[],intensity:null},"FWKI":{temp:26,conditions:[],intensity:null},"ZBAA":{temp:-4,conditions:[],intensity:null},"ZBAD":{temp:-5,conditions:[],intensity:null},"ZSPD":{temp:10,conditions:[],intensity:null},
  "ZSSS":{temp:12,conditions:[],intensity:null},"ZGGG":{temp:22,conditions:[],intensity:null},"VHHH":{temp:22,conditions:[],intensity:null},"ZGSZ":{temp:20,conditions:[],intensity:null},"ZUUU":{temp:14,conditions:[],intensity:null},"ZUCK":{temp:15,conditions:[],intensity:null},"ZHCC":{temp:-2,conditions:[],intensity:null},"ZLXY":{temp:3,conditions:[],intensity:null},"ZWSH":{temp:-19,conditions:[],intensity:null},"ZYHB":{temp:-23,conditions:[],intensity:null},
  "ZYTX":{temp:-14,conditions:[],intensity:null},"ZSAM":{temp:18,conditions:[],intensity:null},"ZGKL":{temp:18,conditions:[],intensity:null},"ZSNJ":{temp:11,conditions:[],intensity:null},"ZSHC":{temp:13,conditions:[],intensity:null},"ZPPP":{temp:13,conditions:[],intensity:null},"ZBTJ":{temp:-5,conditions:[],intensity:null},"VMMC":{temp:20,conditions:[],intensity:null},"RJTT":{temp:9,conditions:[],intensity:null},"RJAA":{temp:5,conditions:[],intensity:null},
  ...
  "RKSS":{temp:0,conditions:[],intensity:null},"RKPK":{temp:9,conditions:[],intensity:null},"RKPC":{temp:10,conditions:[],intensity:null},"RKTN":{temp:5,conditions:[],intensity:null},"ZKPY":{temp:-5,conditions:[],intensity:null},"WSSS":{temp:27,conditions:[],intensity:null},"WMKK":{temp:29,conditions:[],intensity:null},"WMKP":{temp:29,conditions:[],intensity:null},"WBKK":{temp:28,conditions:[],intensity:null},"WBGG":{temp:26,conditions:[],intensity:null},
  "VTBS":{temp:30,conditions:[],intensity:null},"VTBD":{temp:31,conditions:[],intensity:null},"VTSP":{temp:28,conditions:[],intensity:null},"VTCC":{temp:26,conditions:[],intensity:null},"VTSS":{temp:28,conditions:[],intensity:null},"VTUK":{temp:28,conditions:[],intensity:null},"VVNB":{temp:24,conditions:[],intensity:null},"VVTS":{temp:27,conditions:[],intensity:null},"VVDN":{temp:20,conditions:[],intensity:null},"VVCR":{temp:25,conditions:[],intensity:null},
  ...
  "RPLL":{temp:27,conditions:[],intensity:null},"RPLC":{temp:25,conditions:[],intensity:null},"RPVM":{temp:27,conditions:[],intensity:null},"RPVD":{temp:28,conditions:[],intensity:null},"RPVK":{temp:25,conditions:[],intensity:null},"WBSB":{temp:25,conditions:[],intensity:null},"WBLL":{temp:27,conditions:[],intensity:null},"VIDP":{temp:22,conditions:[],intensity:null},"VABB":{temp:24,conditions:[],intensity:null},"VOBL":{temp:27,conditions:[],intensity:null},
  ...
  "RCKH":{temp:22,conditions:[],intensity:null},"RCNN":{temp:20,conditions:[],intensity:null},"YSSY":{temp:18,conditions:[],intensity:null},"YMML":{temp:24,conditions:[],intensity:null},"YBBN":{temp:24,conditions:[],intensity:null},"YPPH":{temp:24,conditions:[],intensity:null},"YPAD":{temp:27,conditions:[],intensity:null},"YBCG":{temp:21,conditions:[],intensity:null},"YBCS":{temp:26,conditions:[],intensity:null},"YSCB":{temp:15,conditions:[],intensity:null},
